...
<script>hljs.initHighlightingOnLoad()</script>
        ...
        if self.pagebar.q:
            entries = await self.search(self.pagebar.q)
            self.render('index.html', entries=entries, pagebar=self.pagebar, nodes=json.dumps([]))
...
def main():
    ...
    logging.info(f'Debug: {options.dev}, Running: http://{get_ip()}:{port}')
