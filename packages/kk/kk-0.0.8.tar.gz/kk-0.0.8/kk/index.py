...
class Application(tornado.web.Application):
    ...
    def __init__(self):
        ...
        tornado.ioloop.IOLoop.current().add_timeout(time.time() + 10, self.scan)
    ...
    def scan(self):
        ...
        roots = [x[0] for x in os.walk(self.path)]
        executor.map(self.scan_dir, roots)
        cost = time.time() - start
        logging.info(f'scaning time: {cost:.1f}s')
