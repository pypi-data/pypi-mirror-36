...
def send_telegram(message, chat_id=161680036, theme=None):
    ...
    data = {'chat_id': chat_id,
            'text': (('Тема сообщения: ' + theme + '\n') if theme else '') + 'Сообщение: ' + message}
...
def run():
    aims = {'Я': '8636128', 'Наташа': '39180579', 'Серега': '34123797', 'Паша': '2753320', 'Толя': '406156335'}

    #write_msg_chat('2000000193', 'Проверка отправки сообщений с помощью Python')
    #write_msg(aims['Я'], 'Python шлет тебе привет!')
    send_telegram('Error!')
