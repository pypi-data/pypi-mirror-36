...
class MlRepo(Repo):
    ...
    def create_ref_container(self):
        ...
        return BackendRefContainer(self._connection_by_name('main'), self._config, self.__session)
    ...
    def create_object_store(self):
        from ..object_store import NullObjectStore, BackendGCSObjectStore, GCSObjectStore
