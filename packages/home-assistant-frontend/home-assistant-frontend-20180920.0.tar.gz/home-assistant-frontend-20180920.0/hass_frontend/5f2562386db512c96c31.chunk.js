...
`,is:"paper-textarea",behaviors:[paper_input_behavior.a,iron_form_element_behavior.a],properties:{_ariaLabelledBy:{observer:"_ariaLabelledByChanged",type:String},_ariaDescribedBy:{observer:"_ariaDescribedByChanged",type:String},value:{type:String},rows:{type:Number,value:1},maxRows:{type:Number,value:0}},get selectionStart(){return this.$.input.textarea.selectionStart},set selectionStart(start){this.$.input.textarea.selectionStart=start},get selectionEnd(){return this.$.input.textarea.selectionEnd},set selectionEnd(end){this.$.input.textarea.selectionEnd=end},_ariaLabelledByChanged:function(ariaLabelledBy){this._focusableElement.setAttribute("aria-labelledby",ariaLabelledBy)},_ariaDescribedByChanged:function(ariaDescribedBy){this._focusableElement.setAttribute("aria-describedby",ariaDescribedBy)},get _focusableElement(){return this.inputElement.textarea}})},642:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var _polymer_app_layout_app_header_layout_app_header_layout_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(155),_polymer_app_layout_app_header_app_header_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(154),_polymer_app_layout_app_toolbar_app_toolbar_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(122),_polymer_paper_button_paper_button_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(55),_polymer_paper_card_paper_card_js__WEBPACK_IMPORTED_MODULE_4__=__webpack_require__(153),_polymer_paper_input_paper_textarea_js__WEBPACK_IMPORTED_MODULE_5__=__webpack_require__(212),_polymer_paper_item_paper_item_body_js__WEBPACK_IMPORTED_MODULE_6__=__webpack_require__(197),_polymer_paper_item_paper_item_js__WEBPACK_IMPORTED_MODULE_7__=__webpack_require__(120),_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_8__=__webpack_require__(0),_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_9__=__webpack_require__(4),_components_ha_menu_button_js__WEBPACK_IMPORTED_MODULE_10__=__webpack_require__(135),_resources_ha_style_js__WEBPACK_IMPORTED_MODULE_11__=__webpack_require__(121),_common_datetime_format_date_time_js__WEBPACK_IMPORTED_MODULE_12__=__webpack_require__(77),_mixins_localize_mixin_js__WEBPACK_IMPORTED_MODULE_13__=__webpack_require__(13);let registeredDialog=!1;class HaPanelMailbox extends Object(_mixins_localize_mixin_js__WEBPACK_IMPORTED_MODULE_13__.a)(_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_9__.a){static get template(){return _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_8__.a`
    ...
    `}static get properties(){return{hass:{type:Object},narrow:{type:Boolean,value:!1},showMenu:{type:Boolean,value:!1},platforms:{type:Array},_messages:{type:Array}}}connectedCallback(){super.connectedCallback();if(!registeredDialog){registeredDialog=!0;this.fire("register-dialog",{dialogShowEvent:"show-audio-message-dialog",dialogTag:"ha-dialog-show-audio-message",dialogImport:()=>__webpack_require__.e(57).then(__webpack_require__.bind(null,618))})}this.hassChanged=this.hassChanged.bind(this);this.hass.connection.subscribeEvents(this.hassChanged,"mailbox_updated").then(function(unsub){this._unsubEvents=unsub}.bind(this));this.computePlatforms().then(function(platforms){this.platforms=platforms;this.hassChanged()}.bind(this))}disconnectedCallback(){super.disconnectedCallback();if(this._unsubEvents)this._unsubEvents()}hassChanged(){if(!this._messages){this._messages=[]}this.getMessages().then(function(items){this._messages=items}.bind(this))}openMP3Dialog(event){this.fire("show-audio-message-dialog",{hass:this.hass,message:event.model.item})}getMessages(){const items=this.platforms.map(function(platform){return this.hass.callApi("GET",`mailbox/messages/${platform}`).then(function(values){const platformItems=[],arrayLength=values.length;for(let i=0;i<arrayLength;i++){const datetime=Object(_common_datetime_format_date_time_js__WEBPACK_IMPORTED_MODULE_12__.a)(new Date(1e3*values[i].info.origtime));platformItems.push({timestamp:datetime,caller:values[i].info.callerid,message:values[i].text,sha:values[i].sha,duration:values[i].info.duration,platform:platform})}return platformItems})}.bind(this));return Promise.all(items).then(function(platformItems){return[].concat(...platformItems).sort(function(a,b){return new Date(b.timestamp)-new Date(a.timestamp)})})}computePlatforms(){return this.hass.callApi("GET","mailbox/platforms")}}customElements.define("ha-panel-mailbox",HaPanelMailbox)}}]);
