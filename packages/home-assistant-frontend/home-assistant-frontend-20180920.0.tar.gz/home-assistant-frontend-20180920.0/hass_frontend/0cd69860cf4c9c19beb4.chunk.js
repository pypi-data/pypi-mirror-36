...
*/Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_5__.a`
    ...
    <slot></slot>
`,is:"paper-item-body"})},199:function(module,__webpack_exports__,__webpack_require__){"use strict";var _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(0),_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(4),_resources_ha_style_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(121);class HaConfigSection extends _polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_1__.a{static get template(){return _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_0__.a`
...
`}static get properties(){return{header:String}}_backTapped(){history.back()}}customElements.define("hass-subpage",HassSubpage)},274:function(module,__webpack_exports__,__webpack_require__){"use strict";var _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__(0),_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__(4),_ha_progress_button_js__WEBPACK_IMPORTED_MODULE_2__=__webpack_require__(205),_mixins_events_mixin_js__WEBPACK_IMPORTED_MODULE_3__=__webpack_require__(14);class HaCallApiButton extends Object(_mixins_events_mixin_js__WEBPACK_IMPORTED_MODULE_3__.a)(_polymer_polymer_polymer_element_js__WEBPACK_IMPORTED_MODULE_1__.a){static get template(){return _polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_0__.a`
    <ha-progress-button id="progress" progress="[[progress]]" on-click="buttonTapped" disabled="[[disabled]]"><slot></slot></ha-progress-button>
`}static get properties(){return{hass:Object,progress:{type:Boolean,value:!1},path:String,method:{type:String,value:"POST"},data:{type:Object,value:{}},disabled:{type:Boolean,value:!1}}}buttonTapped(){this.progress=!0;const eventData={method:this.method,path:this.path,data:this.data};this.hass.callApi(this.method,this.path,this.data).then(resp=>{this.progress=!1;this.$.progress.actionSuccess();eventData.success=!0;eventData.response=resp},resp=>{this.progress=!1;this.$.progress.actionError();eventData.success=!1;eventData.response=resp}).then(()=>{this.fire("hass-api-called",eventData)})}}customElements.define("ha-call-api-button",HaCallApiButton)},623:function(module,__webpack_exports__,__webpack_require__){"use strict";__webpack_require__.r(__webpack_exports__);var app_route=__webpack_require__(89),utils_async=__webpack_require__(8),debounce=__webpack_require__(15),html_tag=__webpack_require__(0),polymer_element=__webpack_require__(4),ha_config_section=__webpack_require__(199),paper_button=__webpack_require__(55),paper_card=__webpack_require__(153),paper_item_body=__webpack_require__(197),ha_call_api_button=__webpack_require__(274),hass_subpage=__webpack_require__(207),ha_style=__webpack_require__(121),format_date_time=__webpack_require__(77),events_mixin=__webpack_require__(14);class ha_config_cloud_account_HaConfigCloudAccount extends Object(events_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
    <style include="iron-flex ha-style">
      [slot=introduction] {
        margin: -1em 0;
      }
...
`}static get properties(){return{hass:Object,isWide:Boolean,cloudStatus:Object,_subscription:{type:Object,value:null}}}ready(){super.ready();this._fetchSubscriptionInfo()}async _fetchSubscriptionInfo(){this._subscription=await this.hass.callWS({type:"cloud/subscription"})}handleLogout(){this.hass.callApi("post","cloud/logout").then(()=>this.fire("ha-refresh-cloud-status"))}_formatSubscription(subInfo){if(null===subInfo){return"Fetching subscription\u2026"}const{subscription,source,customer_exists}=subInfo,beforeOct17=15397344e5>Date.now();if(!customer_exists){return`Legacy user. Subscription expire${beforeOct17?"s":"d"} Oct 17, 2018.`}if(!subscription||"canceled"===subscription.status){return"No subscription"}const periodExpires=Object(format_date_time.a)(new Date(1e3*subscription.current_period_end));if("trialing"===subscription.status&&!source){return`Trial user. Trial expires ${periodExpires}.`}if("trialing"===subscription.status){return`Active user. You will be charged on ${periodExpires}.`}if("active"===subscription.status&&subscription.cancel_at_period_end){return`Active user. Scheduled to cancel on ${periodExpires}`}if("active"===subscription.status){return`Active user. You will be charged on ${periodExpires}.`}return"Unable to determine subscription status."}}customElements.define("ha-config-cloud-account",ha_config_cloud_account_HaConfigCloudAccount);var paper_input=__webpack_require__(61),ha_progress_button=__webpack_require__(205);class ha_config_cloud_forgot_password_HaConfigCloudForgotPassword extends Object(events_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
    <style include="iron-flex ha-style">
      .content {
        padding-bottom: 24px;
      }
...
//# sourceMappingURL=0cd69860cf4c9c19beb4.chunk.js.map