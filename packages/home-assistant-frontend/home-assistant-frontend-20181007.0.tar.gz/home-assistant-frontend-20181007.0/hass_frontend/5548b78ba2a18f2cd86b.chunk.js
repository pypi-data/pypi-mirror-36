(window.webpackJsonp=window.webpackJsonp||[]).push([[32],{285:function(){const documentContainer=document.createElement("template");documentContainer.setAttribute("style","display: none;");documentContainer.innerHTML=`<dom-module id="ha-date-picker-vaadin-date-picker-styles" theme-for="vaadin-date-picker">
  <template>
    <style>
...
`}static get properties(){return{hass:{type:Object},entries:{type:Array,value:[]}}}_formatTime(date){return Object(format_time.a)(new Date(date),this.language)}_computeIcon(domain){return Object(domain_icon.a)(domain)}entityClicked(ev){ev.preventDefault();this.fire("hass-more-info",{entityId:ev.model.item.entity_id})}}customElements.define("ha-logbook",ha_logbook_HaLogbook);var format_date=__webpack_require__(141),localize_mixin=__webpack_require__(9);class ha_panel_logbook_HaPanelLogbook extends Object(localize_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
...
//# sourceMappingURL=5548b78ba2a18f2cd86b.chunk.js.map