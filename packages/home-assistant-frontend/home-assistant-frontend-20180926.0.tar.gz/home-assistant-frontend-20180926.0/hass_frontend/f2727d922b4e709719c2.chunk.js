(window.webpackJsonp=window.webpackJsonp||[]).push([[31],{284:function(){const documentContainer=document.createElement("template");documentContainer.setAttribute("style","display: none;");documentContainer.innerHTML=`<dom-module id="ha-date-picker-vaadin-date-picker-styles" theme-for="vaadin-date-picker">
  <template>
    <style>
...
`}static get properties(){return{hass:{type:Object},entries:{type:Array,value:[]}}}_formatTime(date){return Object(format_time.a)(new Date(date))}entityClicked(ev){ev.preventDefault();this.fire("hass-more-info",{entityId:ev.model.item.entity_id})}}customElements.define("ha-logbook",ha_logbook_HaLogbook);var format_date=__webpack_require__(142),localize_mixin=__webpack_require__(13);class ha_panel_logbook_HaPanelLogbook extends Object(localize_mixin.a)(polymer_element.a){static get template(){return html_tag.a`
...
//# sourceMappingURL=f2727d922b4e709719c2.chunk.js.map