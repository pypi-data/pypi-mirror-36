(window.webpackJsonp=window.webpackJsonp||[]).push([[14],{630:function(e,t,a){"use strict";a.r(t),a(157),a(156),a(155),a(200),a(121),a(55),a(124);var s=a(0),r=a(4),o=(a(136),a(122),a(14));a(219),a(126),customElements.define("ha-change-password-card",class extends r.a{static get template(){return s["a"]`
...
`}static get properties(){return{hass:Object,_loading:{type:Boolean,value:!1},_statusMsg:String,_errorMsg:String,mfaModules:Array}}connectedCallback(){super.connectedCallback(),n||(n=!0,this.fire("register-dialog",{dialogShowEvent:"show-mfa-module-setup-flow",dialogTag:"ha-mfa-module-setup-flow",dialogImport:()=>a.e(58).then(a.bind(null,641))}))}_enable(e){this.fire("show-mfa-module-setup-flow",{hass:this.hass,mfaModuleId:e.model.module.id,dialogClosedCallback:()=>this._refreshCurrentUser()})}_disable(e){if(!confirm(`Are you sure you want to disable ${e.model.module.name}?`))return;const t=e.model.module.id;this.hass.callWS({type:"auth/depose_mfa",mfa_module_id:t}).then(()=>{this._refreshCurrentUser()})}_refreshCurrentUser(){this.fire("hass-refresh-current-user")}}),a(63),a(279);var l=a(77);customElements.define("ha-settings-row",class extends r.a{static get template(){return s["a"]`
    <style>
      :host {
        display: flex;
        padding: 0 16px;
...
//# sourceMappingURL=a882297af489d3e22b67.chunk.js.map