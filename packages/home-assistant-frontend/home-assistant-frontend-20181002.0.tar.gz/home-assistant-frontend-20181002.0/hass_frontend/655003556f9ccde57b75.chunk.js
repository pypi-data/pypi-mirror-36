...
*/Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_5__.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[_paper_item_behavior_js__WEBPACK_IMPORTED_MODULE_6__.a]})},255:function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathfloor=Math.floor,_Mathround=Math.round,_Mathabs=Math.abs,_Mathceil=Math.ceil,_Mathmax=Math.max,_Mathmin=Math.min,spacing=__webpack_require__(218),style=__webpack_require__(223),overlay=__webpack_require__(334);const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="lumo-vaadin-overlay" theme-for="vaadin-overlay">
  <template>
...
</dom-module>`;document.head.appendChild(vaadin_combo_box_dropdown_styles_$_documentContainer.content);var color=__webpack_require__(229),font_icons=__webpack_require__(281),sizing=__webpack_require__(230),typography=__webpack_require__(234);const vaadin_item_styles_$_documentContainer=document.createElement("template");vaadin_item_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
</dom-module>`;document.head.appendChild(vaadin_item_styles_$_documentContainer.content);var polymer_element=__webpack_require__(4),vaadin_themable_mixin=__webpack_require__(219);/**
@license
...
</dom-module>`;document.head.appendChild(vaadin_combo_box_item_styles_$_documentContainer.content);var vaadin_theme_property_mixin=__webpack_require__(282),utils_async=__webpack_require__(8),flush=__webpack_require__(20),templatize=__webpack_require__(29),iron_a11y_announcer=__webpack_require__(71),iron_a11y_keys_behavior=__webpack_require__(11),flattened_nodes_observer=__webpack_require__(58);/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
//# sourceMappingURL=655003556f9ccde57b75.chunk.js.map