(window.webpackJsonp=window.webpackJsonp||[]).push([[15],{608:function(e,t,a){"use strict";a.r(t),a(158),a(157),a(156),a(202),a(120),a(55),a(123);var s=a(0),r=a(4),o=(a(136),a(121),a(14));a(214),a(125),customElements.define("ha-change-password-card",class extends r.a{static get template(){return s["a"]`
...
`}static get properties(){return{hass:Object,_loading:{type:Boolean,value:!1},_statusMsg:String,_errorMsg:String,mfaModules:Array}}connectedCallback(){super.connectedCallback(),n||(n=!0,this.fire("register-dialog",{dialogShowEvent:"show-mfa-module-setup-flow",dialogTag:"ha-mfa-module-setup-flow",dialogImport:()=>a.e(48).then(a.bind(null,620))}))}_enable(e){this.fire("show-mfa-module-setup-flow",{hass:this.hass,mfaModuleId:e.model.module.id,dialogClosedCallback:()=>this._refreshCurrentUser()})}_disable(e){if(!confirm(`Are you sure you want to disable ${e.model.module.name}?`))return;const t=e.model.module.id;this.hass.callWS({type:"auth/depose_mfa",mfa_module_id:t}).then(()=>{this._refreshCurrentUser()})}_refreshCurrentUser(){this.fire("hass-refresh-current-user")}}),a(63),a(550);var l=a(77);customElements.define("ha-settings-row",class extends r.a{static get template(){return s["a"]`
    <style>
      :host {
        display: flex;
        padding: 0 16px;
...
//# sourceMappingURL=df06851eea4643632e30.chunk.js.map