...
def get_admin_session():
    ...
    """
    warnings.warn(
        'utils.get_admin_session is a function for backwards compatibility. Please replace it with AdminSession().',
        DeprecationWarning,
    )
    return cloudcix.auth.AdminSession()
...
def get_admin_client():
    ...
    return KeystoneClient(
        ...
        auth_url=cloudcix.conf.settings.CLOUDCIX_AUTH_URL,
        endpoint_override=cloudcix.conf.settings.CLOUDCIX_AUTH_URL,
    )
