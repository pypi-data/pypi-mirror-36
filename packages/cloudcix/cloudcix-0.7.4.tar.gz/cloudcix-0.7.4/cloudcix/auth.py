...
class AdminSession(Session):
    ...
    def __init__(self):
        ...
        self.auth_url = cloudcix.conf.settings.CLOUDCIX_AUTH_URL
        self.username = cloudcix.conf.settings.CLOUDCIX_API_USERNAME
        self.password = cloudcix.conf.settings.CLOUDCIX_API_PASSWORD
        self.domain = cloudcix.conf.settings.CLOUDCIX_API_KEY
