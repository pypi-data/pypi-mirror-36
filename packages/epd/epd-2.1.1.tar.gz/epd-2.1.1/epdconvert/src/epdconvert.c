...
static PyMethodDef module_methods[] = {
   ...
   {"compress", (PyCFunction)compress, METH_VARARGS | METH_KEYWORDS, "Method for EPD data compression according to LZ77 algorythm. Algorythm is based on BCL library, but modified to support smaller RAM footprint on TC."},
   {NULL}
};
