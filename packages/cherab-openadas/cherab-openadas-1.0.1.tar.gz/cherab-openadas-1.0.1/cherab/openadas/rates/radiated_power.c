...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initradiated_power(void); /*proto*/
PyMODINIT_FUNC initradiated_power(void)
#else
PyMODINIT_FUNC PyInit_radiated_power(void); /*proto*/
PyMODINIT_FUNC PyInit_radiated_power(void)
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_radiated_power(void)", 0);
