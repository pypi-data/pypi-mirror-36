...
static PyObject* PyVectorClauseDatabase_PrintFormula(PyVectorClauseDatabase* self, PyObject* args)
{
    ...
    std::ofstream fs;
    fs.open(file_name);
    std::vector<std::vector<int32_t>> formula = ((PyVectorClauseDatabase*)self)->vector_cdb.getClauses();
