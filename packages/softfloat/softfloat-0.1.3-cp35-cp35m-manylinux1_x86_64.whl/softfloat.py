...
class float64_t(_object):
    ...
    def __repr__(self):
        a = float(_softfloat.convertF64ToDouble(self))
        return str(a)
    def __str__(self):
        a = float(_softfloat.convertF64ToDouble(self))
        return str(a)
...
class float64:
   ...
   def toInt(self):
       return int(_softfloat.convertF64ToDouble(self.v))
   def rint(self):
   ...
   def sqrt(self):
       ...
       return self
   def __repr__(self):
       a = float(_softfloat.convertF64ToDouble(self.v))
       return str(a)
   def __str__(self):
       a = float(_softfloat.convertF64ToDouble(self.v))
       return str(a)
   def __int__(self):
       return int(_softfloat.convertF64ToDouble(self.v))
   def __float__(self):
       return float(_softfloat.convertF64ToDouble(self.v))
...
class float32:
   ...
   def __eq__(self, other):
       try:
          if isinstance(other, (int)):
              a.v = _softfloat.f32_eq(self.v, _softfloat.i64_to_f32(other))
          elif isinstance(other, (float)):
              a.v = _softfloat.f32_eq(self.v, _softfloat.convertDoubleToF32(other))
          else:
