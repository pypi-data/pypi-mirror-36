...
#  provides = ['ligo.lvalert'],
  ...
  install_requires = ['sleekxmpp', 'M2Crypto', 'dnspython', 'numpy', 'six'],
...
# 
# pyxmpp          pyxmpp *        python-pyxmpp     py27-pyxmpp
# libxml2 **      libxml2-python  python-libxml2    libxml2-python
# M2Crypto        m2crypto        python-m2crypto   py27-m2crypto
# dnspython       python-dns      python-dnspython  py27-dnspython
#
#   * lscsoft package
# 
