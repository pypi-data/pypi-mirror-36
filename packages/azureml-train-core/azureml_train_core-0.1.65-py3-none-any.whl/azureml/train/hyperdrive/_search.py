...
def search(hyperdrive_run_config, workspace, experiment_name):
    ...
    platform_config['Definition']['TelemetryValues'] = _get_telemetry_values(hyperdrive_run_config, workspace)
    ...
    try:
        with tempfile.TemporaryDirectory() as temporary_config:
            ...
            return HyperDriveRun(experiment=experiment,
                                 ...
                                 run_id=api_response.result.platform_config["ParentRunId"],
