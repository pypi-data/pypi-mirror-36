...
class _TensorFlowRunConfiguration(MMLBaseEstimatorRunConfig):
    ...
    def __init__(self, compute_target, entry_script=None, script_params=None, node_count=None,
                 ...
                 environment_definition=None, inputs=None):
...
class TensorFlow(MMLBaseEstimator):
    ...
    def __init__(self,
        ...
        if pip_requirements_file_path:
            pip_packages = MMLBaseEstimator._merge_pip_packages_and_requirements(pip_requirements_file_path,
                                                                                 pip_packages)
        estimator_config = _TensorFlowRunConfiguration(compute_target, entry_script, script_params,
    ...
    def _add_conda_dependencies(conda_dependencies, framework, use_gpu):
        conda_dependencies.add_tensorflow_conda_package(core_type=GPU if use_gpu else CPU)
...
class PyTorch(MMLBaseEstimator):
    ...
    def __init__(self,
        ...
        estimator_config = _PyTorchRunConfiguration(compute_target, entry_script, script_params,
