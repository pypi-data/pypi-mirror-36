...
var responseTimeChart = new LocustLineChart($(".charts-container"), "Response Times (ms)", ["Avg. Response Time", "95% percentile"], "ms");
...
function updateStats() {
    $.get('./stats/requests', function (report) {
        ...
        if (report.state !== "stopped"){
            ...
            responseTimeChart.addValue([total.avg_response_time, report.current_response_time_percentile_95]);
