...
if H_4d_ligands_hybridization == 1 then
    ...
    e_4d_f = (10 * Delta_4d_Ld_f - NElectrons_4d * (23 + NElectrons_4d) * U_4d_4d_f / 2 - 22 * U_2p_4d_f) / (12 + NElectrons_4d)
    e_2p_f = (10 * Delta_4d_Ld_f + (1 + NElectrons_4d) * (NElectrons_4d * U_4d_4d_f / 2 - (10 + NElectrons_4d) * U_2p_4d_f)) / (12 + NElectrons_4d)
    e_Ld_f = ((1 + NElectrons_4d) * (NElectrons_4d * U_4d_4d_f / 2 + 2 * U_2p_4d_f) - (2 + NElectrons_4d) * Delta_4d_Ld_f) / (12 + NElectrons_4d)
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_4d, N_2p, N_4d, 'dZ'}
header = 'Analysis of the initial Hamiltonian:\n'
header = header .. '=================================================================================================================================\n'
header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>      <Tz>     <l.s>    <N_2p>    <N_4d>          dZ\n'
header = header .. '=================================================================================================================================\n'
footer = '=================================================================================================================================\n'

if H_4d_ligands_hybridization == 1 then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_4d, N_2p, N_4d, N_Ld, 'dZ'}
    header = 'Analysis of the initial Hamiltonian:\n'
    header = header .. '===========================================================================================================================================\n'
    header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>      <Tz>     <l.s>    <N_2p>    <N_4d>    <N_Ld>          dZ\n'
    header = header .. '===========================================================================================================================================\n'
    footer = '===========================================================================================================================================\n'
end
...
Tv_2p_4d = CalculateT(ev, k)
Th_2p_4d = CalculateT(eh, k)
Tr_2p_4d = CalculateT(er, k)
Tl_2p_4d = CalculateT(el, k)
Tk_2p_4d = CalculateT(k, k)
