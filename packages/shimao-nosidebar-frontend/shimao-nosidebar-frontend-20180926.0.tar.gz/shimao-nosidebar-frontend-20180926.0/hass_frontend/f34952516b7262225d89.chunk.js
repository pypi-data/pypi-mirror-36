(window.webpackJsonp=window.webpackJsonp||[]).push([[26],{208:function(t,e,i){"use strict";var s=i(0),a=i(4),n=(i(219),i(14));customElements.define("ha-call-service-button",class extends(Object(n.a)(a.a)){static get template(){return s["a"]`
    <ha-progress-button id="progress" progress="[[progress]]" on-click="buttonTapped"><slot></slot></ha-progress-button>
`}static get properties(){return{hass:{type:Object},progress:{type:Boolean,value:!1},domain:{type:String},service:{type:String},serviceData:{type:Object,value:{}}}}buttonTapped(){this.progress=!0;var t=this,e={domain:this.domain,service:this.service,serviceData:this.serviceData};this.hass.callService(this.domain,this.service,this.serviceData).then(function(){t.progress=!1,t.$.progress.actionSuccess(),e.success=!0},function(){t.progress=!1,t.$.progress.actionError(),e.success=!1}).then(function(){t.fire("hass-service-called",e)})}})},219:function(t,e,i){"use strict";i(55),i(124);var s=i(0),a=i(4);customElements.define("ha-progress-button",class extends a.a{static get template(){return s["a"]`
    <style>
      .container {
        position: relative;
...
`}static get properties(){return{hass:{type:Object},progress:{type:Boolean,value:!1},disabled:{type:Boolean,value:!1}}}tempClass(t){var e=this.$.container.classList;e.add(t),setTimeout(()=>{e.remove(t)},1e3)}ready(){super.ready(),this.addEventListener("click",t=>this.buttonTapped(t))}buttonTapped(t){this.progress&&t.stopPropagation()}actionSuccess(){this.tempClass("success")}actionError(){this.tempClass("error")}computeDisabled(t,e){return t||e}})},279:function(t,e,i){"use strict";i(168);var s=i(0),a=i(4),n=i(14);customElements.define("ha-entity-marker",class extends(Object(n.a)(a.a)){static get template(){return s["a"]`
...
`}static get properties(){return{hass:{type:Object},entityId:{type:String,value:""},entityName:{type:String,value:null},entityPicture:{type:String,value:null}}}ready(){super.ready(),this.addEventListener("click",t=>this.badgeTap(t))}badgeTap(t){t.stopPropagation(),this.entityId&&this.fire("hass-more-info",{entityId:this.entityId})}})},280:function(t,e,i){"use strict";i.d(e,"a",function(){return n});var s=i(257),a=i.n(s);function n(t){const e=a.a.map(t),i=document.createElement("link");return i.setAttribute("href","/static/images/leaflet/leaflet.css"),i.setAttribute("rel","stylesheet"),t.parentNode.appendChild(i),e.setView([51.505,-.09],13),a.a.tileLayer(`https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}${a.a.Browser.retina?"@2x.png":".png"}`,{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>, &copy; <a href="https://carto.com/attributions">CARTO</a>',subdomains:"abcd",minZoom:0,maxZoom:20}).addTo(e),e}},624:function(t,e,i){"use strict";i.r(e);var s=i(0),a=i(4);i(55),i(182),i(170),i(157),i(156),i(175),i(122),i(89),i(62),i(119),i(121),i(127),i(141),i(185);var n=i(14),r=i(81),o=(i(160),i(169),i(87),i(82)),c=i(67);i(109),customElements.define("hui-notification-item-template",class extends a.a{static get template(){return s["a"]`
    <style>
      .contents {
        padding: 16px;
      }
    ...
    `}static get properties(){return{hass:Object,stateObj:Object}}_handleClick(){this.fire("hass-more-info",{entityId:this.stateObj.entity_id})}_localizeState(t){return this.localize(`state.configurator.${t}`)}_getMessage(t){const e=t.attributes.friendly_name;return this.localize("ui.notification_drawer.click_to_configure","entity",e)}});var h=i(28);i(126),customElements.define("hui-persistent_notification-notification-item",class extends(Object(l.a)(a.a)){static get template(){return s["a"]`
    <hui-notification-item-template>
    ...
    `}static get properties(){return{hass:Object,notificationsOpen:{type:Boolean,notify:!0}}}_clicked(){this.notificationsOpen=!0}_hasNotifications(t){return p(t).length>0}});const u=["zone"];var m=i(98);function g(t){return"function"==typeof t.getCardSize?t.getCardSize():1}customElements.define("hui-conditional-card",class extends a.a{static get template(){return s["a"]`
      <style>
        .hidden {
          display: none;
        }
      ...
      <div id="card"></div>
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_config:Object}}ready(){super.ready(),this._config&&this._buildConfig()}setConfig(t){if(!(t&&t.card&&Array.isArray(t.conditions)&&t.conditions.every(t=>t.entity&&(t.state||t.state_not))))throw new Error("Error in card configuration.");this._config=t,this.$&&this._buildConfig()}_buildConfig(){const t=this._config,e=this.$.card;for(;e.lastChild;)e.removeChild(e.lastChild);const i=K(t.card);i.hass=this.hass,e.appendChild(i),this.hass&&this._hassChanged(this.hass)}getCardSize(){const t=this.$.card&&this.$.card.lastChild;return t?g(t):1}_hassChanged(t){const e=this.$.card;if(!e||!e.lastChild)return;e.lastChild.hass=t;const i=this._config.conditions.every(e=>e.entity in t.states&&(e.state?t.states[e.entity].state===e.state:t.states[e.entity].state!==e.state_not));e.classList.toggle("hidden",!i)}}),i(31),i(161);var f=i(39);customElements.define("hui-entities-toggle",class extends a.a{static get template(){return s["a"]`
    <style>
      :host {
        width: 38px;
        display: block;
...
`}static get properties(){return{hass:Object,entities:Array,_toggleEntities:{type:Array,computed:"_computeToggleEntities(hass, entities)"}}}_computeToggleEntities(t,e){return e.filter(e=>e in t.states&&f.e.has(e.split(".",1)[0]))}_computeIsChecked(t,e){return e.some(e=>"on"===t.states[e].state)}_callService(t){const e=t.target.checked;!function(t,e,i=!0){const s={};e.forEach(e=>{if(f.h.includes(t.states[e].state)===i){const t=Object(c.a)(e),i=["cover","lock"].includes(t)?t:"homeassistant";i in s||(s[i]=[]),s[i].push(e)}}),Object.keys(s).forEach(e=>{let a;switch(e){case"lock":a=i?"unlock":"lock";break;case"cover":a=i?"open_cover":"close_cover";break;default:a=i?"turn_on":"turn_off"}const n=s[e];t.callService(e,a,{entity_id:n})})}(this.hass,this._toggleEntities,e)}}),i(177),i(125),i(163),customElements.define("hui-generic-entity-row",class extends a.a{static get template(){return s["a"]`
    ...
    `}static get climateControlTemplate(){return s["a"]`
      <ha-climate-state
        ...
        state-obj="[[_stateObj]]"
      ></ha-climate-state>
    `}static get properties(){return{hass:Object,_config:Object,_stateObj:{type:Object,computed:"_computeStateObj(hass.states, _config.entity)"}}}_computeStateObj(t,e){return t&&e in t?t[e]:null}setConfig(t){if(!t||!t.entity)throw new Error("Entity not configured.");this._config=t}}),i(178),i(167);var _=i(83);customElements.define("hui-cover-entity-row",class extends a.a{static get template(){return s["a"]`
      ${this.styleTemplate}
      <hui-generic-entity-row
        hass="[[hass]]"
        config="[[_config]]"
    ...
    `}static get properties(){return{hass:Object,_config:Object,_stateObj:{type:Object,computed:"_computeStateObj(hass.states, _config.entity)"},_entityObj:{type:Object,computed:"_computeEntityObj(hass, _stateObj)"}}}_computeStateObj(t,e){return t&&e in t?t[e]:null}_computeEntityObj(t,e){return e?new _.a(t,e):null}setConfig(t){if(!t||!t.entity)throw new Error("Entity not configured.");this._config=t}}),i(129);var b=i(110);customElements.define("hui-group-entity-row",class extends(Object(l.a)(a.a)){static get template(){return s["a"]`
      <hui-generic-entity-row
        hass="[[hass]]"
        config="[[_config]]"
      >
    ...
    `}static get properties(){return{hass:Object,_config:Object,_stateObj:{type:Object,computed:"_computeStateObj(hass.states, _config.entity)"},_canToggle:{type:Boolean,computed:"_computeCanToggle(_stateObj.attributes.entity_id)"}}}setConfig(t){if(!t||!t.entity)throw new Error("Entity not configured.");this._config=t}_computeStateObj(t,e){return t&&e in t?t[e]:null}_computeCanToggle(t){return t.some(t=>f.e.has(t.split(".",1)[0]))}_computeState(t){return Object(b.a)(this.localize,t)}}),i(61),i(128);var y=i(45),v=i(38);customElements.define("hui-input-number-entity-row",class extends(Object(v.b)([y.a],a.a)){static get template(){return s["a"]`
      ${this.styleTemplate}
      <hui-generic-entity-row
        hass="[[hass]]"
        config="[[_config]]"
    ...
    `}static get properties(){return{_config:Object}}setConfig(t){if(!(t&&t.icon&&t.name&&t.url))throw new Error("Error in card configuration.");this._config=t}});const O="custom:",x=new Set(["call-service","divider","weblink"]),E={automation:"toggle",climate:"climate",cover:"cover",fan:"toggle",group:"group",input_boolean:"toggle",input_number:"input-number",input_select:"input-select",input_text:"input-text",light:"toggle",lock:"lock",scene:"scene",script:"script",timer:"timer",switch:"toggle",vacuum:"toggle"};function k(t,e){const i=document.createElement(t);try{"setConfig"in i&&i.setConfig(e)}catch(i){return console.error(t,i),S(i.message,e)}return i}function S(t,e){return k("hui-error-card",j(t,e))}function T(t){let e;if(!t||"object"!=typeof t||!t.entity&&!t.type)return S("Invalid config given.",t);const i=t.type||"default";if(x.has(i))return k(`hui-${i}-row`,t);if(i.startsWith(O)){if(e=i.substr(O.length),customElements.get(e))return k(e,t);const s=S(`Custom element doesn't exist: ${e}.`,t);return customElements.whenDefined(e).then(()=>Object(m.a)(s,"rebuild-view")),s}const s=t.entity.split(".",1)[0];return k(e=`hui-${E[s]||"text"}-entity-row`,t)}function $(t){if(!t||!Array.isArray(t))throw new Error("Entities need to be an array");return t.map((t,e)=>{if("object"==typeof t&&!Array.isArray(t)&&t.type)return t;if("string"==typeof t)t={entity:t};else{if("object"!=typeof t||Array.isArray(t))throw new Error(`Invalid entity specified at position ${e}.`);if(!t.entity)throw new Error(`Entity object at position ${e} is missing entity field.`)}if(!function(t){return/^(\w+)\.(\w+)$/.test(t)}(t.entity))throw new Error(`Invalid entity ID at position ${e}: ${t.entity}`);return t})}function I(t,e){!function(t,e,i=!0){const s=Object(c.a)(e),a="group"===s?"homeassistant":s;let n;switch(s){case"lock":n=i?"unlock":"lock";break;case"cover":n=i?"open_cover":"close_cover";break;default:n=i?"turn_on":"turn_off"}t.callService(a,n,{entity_id:e})}(t,e,f.h.includes(t.states[e].state))}customElements.define("hui-entities-card",class extends(Object(n.a)(a.a)){static get template(){return s["a"]`
    <style>
      ha-card {
        padding: 16px;
      }
...
`}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_config:Object}}constructor(){super(),this._elements=[]}ready(){super.ready(),this._config&&this._buildConfig()}getCardSize(){return 1+(this._config?this._config.entities.length:0)}_showHeaderToggle(t){return!1!==t}_showHeader(t){return t.title||t.show_header_toggle}setConfig(t){this._config=t,this._rows=t.entities.map(t=>"string"==typeof t?{entity:t}:t),this.$&&this._buildConfig()}_buildConfig(){const t=this.$.states;for(;t.lastChild;)t.removeChild(t.lastChild);this._elements=[];for(const e of this._rows){const i=e.entity,s=T(e);i&&!f.c.includes(Object(c.a)(i))&&(s.classList.add("state-card-dialog"),s.addEventListener("click",()=>this.fire("hass-more-info",{entityId:i}))),s.hass=this.hass,this._elements.push(s);const a=document.createElement("div");a.appendChild(s),t.appendChild(a)}}_hassChanged(t){this._elements.forEach(e=>{e.hass=t})}_filterEntities(t){return t.filter(t=>"string"==typeof t||t.entity).map(t=>"string"==typeof t?t:t.entity)}}),customElements.define("hui-entity-filter-card",class extends a.a{static get properties(){return{hass:{type:Object,observer:"_hassChanged"}}}getCardSize(){return this.lastChild?this.lastChild.getCardSize():1}setConfig(t){if(!t.state_filter||!Array.isArray(t.state_filter))throw new Error("Incorrect filter config.");this._config=t,this._configEntities=$(t.entities),this.lastChild&&(this.removeChild(this.lastChild),this._element=null);const e="card"in t?Object.assign({},t.card):{};e.type||(e.type="entities"),e.entities=[];const i=K(e);i._filterRawConfig=e,this._updateCardConfig(i),this._element=i}_hassChanged(){this._updateCardConfig(this._element)}_updateCardConfig(t){if(!t||"HUI-ERROR-CARD"===t.tagName||!this.hass)return;const e=function(t,e,i){return i.filter(i=>{const s=t.states[i.entity];return s&&e.includes(s.state)})}(this.hass,this._config.state_filter,this._configEntities);0!==e.length||!1!==this._config.show_empty?(this.style.display="block",t.setConfig(Object.assign({},t._filterRawConfig,{entities:e})),t.isPanel=this.isPanel,t.hass=this.hass,this.lastChild||this.appendChild(t)):this.style.display="none"}}),customElements.define("hui-error-card",class extends a.a{static get template(){return s["a"]`
    ...
    `}static get properties(){return{hass:Object,_config:Object,_configEntities:Array}}getCardSize(){return 3}setConfig(t){this._config=t,this.updateStyles({"--glance-column-width":t&&t.column_width||"20%"}),this._configEntities=$(t.entities)}_computeClasses(t){return`entities ${t?"":"no-header"}`}_showEntity(t,e){return t.entity in e}_showInfo(t){return!1!==t}_computeName(t,e){return"name"in t?t.name:Object(h.a)(e[t.entity])}_computeStateObj(t,e){return e[t.entity]}_computeState(t,e){return Object(b.a)(this.localize,e[t.entity])}_handleClick(t){const e=t.model.item,i=e.entity;switch(e.tap_action){case"toggle":I(this.hass,i);break;case"call-service":{const[t,s]=e.service.split(".",2),a=Object.assign({},{entity_id:i},e.service_data);this.hass.callService(t,s,a);break}default:this.fire("hass-more-info",{entityId:i})}}}),i(166),i(165),customElements.define("hui-history-graph-card",class extends a.a{static get template(){return s["a"]`
      <style>
        ha-card {
          padding: 16px;
        }
    ...
    `}static get properties(){return{hass:Object,_config:Object,_names:Object,_entities:Array,_stateHistory:Object,_stateHistoryLoading:Boolean,_cacheConfig:Object}}getCardSize(){return 4}setConfig(t){const e=$(t.entities);this._config=t;const i=[],s={};for(const t of e)i.push(t.entity),t.name&&(s[t.entity]=t.name);this.setProperties({_cacheConfig:{cacheKey:i.sort().join(),hoursToShow:t.hours_to_show||24,refresh:t.refresh_interval||0},_entities:i,_names:s})}}),customElements.define("hui-horizontal-stack-card",class extends a.a{static get template(){return s["a"]`
      <style>
        #root {
          display: flex;
        }
      ...
      <div id="root"></div>
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"}}}constructor(){super(),this._elements=[]}ready(){super.ready(),this._config&&this._buildConfig()}getCardSize(){let t=1;return this._elements.forEach(e=>{const i=g(e);i>t&&(t=i)}),t}setConfig(t){if(!t||!t.cards||!Array.isArray(t.cards))throw new Error("Card config incorrect.");this._config=t,this.$&&this._buildConfig()}_buildConfig(){const t=this._config;this._elements=[];const e=this.$.root;for(;e.lastChild;)e.removeChild(e.lastChild);const i=[];t.cards.forEach(t=>{const s=K(t);s.hass=this.hass,i.push(s),e.appendChild(s)}),this._elements=i}_hassChanged(t){this._elements.forEach(e=>{e.hass=t})}}),customElements.define("hui-iframe-card",class extends a.a{static get template(){return s["a"]`
      <style>
        ha-card {
          overflow: hidden;
        }
    ...
    `}static get properties(){return{_config:Object}}ready(){super.ready(),this._config&&this._buildConfig()}setConfig(t){this._config=t,this.$&&this._buildConfig()}_buildConfig(){const t=this._config;this.$.root.style.paddingTop=t.aspect_ratio||"50%"}getCardSize(){return 1+this.offsetHeight/50}});var z=i(257),A=i.n(z),L=(i(279),i(280)),N=i(22);function D(t,e,i){let s;return function(...a){const n=this,r=i&&!s;clearTimeout(s),s=setTimeout(()=>{s=null,i||t.apply(n,a)},e),r&&t.apply(n,a)}}A.a.Icon.Default.imagePath="/static/images/leaflet",customElements.define("hui-map-card",class extends a.a{static get template(){return s["a"]`
      <style>
    ...
    `}static get properties(){return{_config:Object,noTitle:{type:Boolean,reflectToAttribute:!0,computed:"_computeNoTitle(_config.title)"}}}setConfig(t){this._config=t}getCardSize(){return this._config.content.split("\n").length}_computeNoTitle(t){return!t}}),i(180);class R extends HTMLElement{constructor(t,e){super(),this._tag=t.toUpperCase(),this._domain=e,this._element=null}getCardSize(){return 3}setConfig(t){if(!t.entity)throw new Error("No entity specified");if(Object(c.a)(t.entity)!==this._domain)throw new Error(`Specified entity needs to be of domain ${this._domain}.`);this._config=t}set hass(t){const e=this._config.entity;e in t.states?(this._ensureElement(this._tag),this.lastChild.hass=t,this.lastChild.stateObj=t.states[e]):(this._ensureElement("HUI-ERROR-CARD"),this.lastChild.setConfig(j(`No state available for ${e}`,this._config)))}_ensureElement(t){this.lastChild&&this.lastChild.tagName===t||(this.lastChild&&this.removeChild(this.lastChild),this.appendChild(document.createElement(t)))}}customElements.define("hui-media-control-card",class extends R{constructor(){super("ha-media_player-card","media_player")}}),customElements.define("hui-picture-card",class extends(Object(r.a)(a.a)){static get template(){return s["a"]`
      <style>
        ha-card {
          overflow: hidden;
        }
...
`}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},entity:String,image:String,stateImage:Object,cameraImage:String,filter:String,stateFilter:Object,_imageSrc:String}}static get observers(){return["_configChanged(image, stateImage, cameraImage)"]}connectedCallback(){super.connectedCallback(),this.cameraImage&&(this.timer=setInterval(()=>this._updateCameraImageSrc(),1e4))}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this.timer)}_configChanged(t,e,i){i?this._updateCameraImageSrc():t&&!e&&(this._imageSrc=t)}_onImageError(){this._imageSrc=null,this.$.image.classList.add("hidden"),this.$.brokenImage.style.setProperty("height",`${this._lastImageHeight||"100"}px`),this.$.brokenImage.classList.remove("hidden")}_onImageLoad(){this.$.image.classList.remove("hidden"),this.$.brokenImage.classList.add("hidden"),this._lastImageHeight=this.$.image.offsetHeight}_hassChanged(t){if(this.cameraImage||!this.entity)return;const e=t.states[this.entity],i=e?e.state:"unavailable";i!==this._currentState&&(this._currentState=i,this._updateStateImage(),this._updateStateFilter(e))}_updateStateImage(){if(!this.stateImage)return void(this._imageFallback=!0);const t=this.stateImage[this._currentState];this._imageSrc=t||this.image,this._imageFallback=!t}_updateStateFilter(t){let e;e=this.stateFilter&&this.stateFilter[this._currentState]||this.filter;const i=!t||f.h.includes(t.state);this.$.image.style.filter=e||i&&this._imageFallback&&"grayscale(100%)"||""}async _updateCameraImageSrc(){try{const{content_type:t,content:e}=await this.hass.callWS({type:"camera_thumbnail",entity_id:this.cameraImage});this._imageSrc=`data:${t};base64, ${e}`,this._onImageLoad()}catch(t){this._onImageError()}}}),customElements.define("hui-image-element",class extends(P(a.a)){static get template(){return s["a"]`
    ...
    `}static get properties(){return{hass:Object,_config:Object,_domain:String,_service:String}}setConfig(t){if(!t||!t.service)throw Error("Error in element configuration");const[e,i]=t.service.split(".",2);this.setProperties({_config:t,_domain:e,_service:i})}}),i(164),customElements.define("hui-state-badge-element",class extends a.a{static get properties(){return{hass:Object,_config:Object}}static get observers(){return["_updateBadge(hass, _config)"]}_updateBadge(t,e){if(!(t&&e&&e.entity in t.states))return;this._badge||(this._badge=document.createElement("ha-state-label-badge"));const i=t.states[e.entity];this._badge.state=i,this._badge.setAttribute("title",Object(h.a)(i)),this.lastChild||this.appendChild(this._badge)}setConfig(t){if(!t||!t.entity)throw Error("Error in element configuration");this.lastChild&&this.removeChild(this.lastChild),this._badge=null,this._config=t}}),customElements.define("hui-state-icon-element",class extends(P(a.a)){static get template(){return s["a"]`
      <style>
        :host {
          cursor: pointer; 
        } 
      ...
      <state-badge 
        ...
        title$="[[computeTooltip(hass, _config)]]"
      ></state-badge> 
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_config:Object,_stateObj:Object}}ready(){super.ready(),this.addEventListener("click",()=>this.handleClick(this.hass,this._config))}setConfig(t){if(!t||!t.entity)throw Error("Error in element configuration");this._config=t}_hassChanged(t){this._stateObj=t.states[this._config.entity]}}),customElements.define("hui-state-label-element",class extends(Object(l.a)(P(a.a))){static get template(){return s["a"]`
      <style>
        :host {
          cursor: pointer;
        }
...
`}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_config:Object}}constructor(){super(),this._elements=[]}ready(){super.ready(),this._config&&this._buildConfig()}getCardSize(){return 4}setConfig(t){if(!t||!t.image||!Array.isArray(t.elements))throw new Error("Invalid card configuration");this._config=t,this.$&&this._buildConfig()}_buildConfig(){const t=this._config,e=this.$.root;for(this._elements=[];e.lastChild;)e.removeChild(e.lastChild);const i=document.createElement("img");i.src=t.image,e.appendChild(i),t.elements.forEach(t=>{const i=function(t){if(!t||"object"!=typeof t||!t.type)return V("No element type configured.",t);if(t.type.startsWith("custom:")){const e=t.type.substr("custom:".length);if(customElements.get(e))return H(e,t);const i=V(`Custom element doesn't exist: ${e}.`,t);return customElements.whenDefined(e).then(()=>Object(m.a)(i,"rebuild-view")),i}return M.has(t.type)?H(`hui-${t.type}-element`,t):V(`Unknown element type encountered: ${t.type}.`,t)}(t);i.hass=this.hass,this._elements.push(i),i.classList.add("element"),Object.keys(t.style).forEach(e=>{i.style.setProperty(e,t.style[e])}),e.appendChild(i)}),this.hass&&this._hassChanged(this.hass)}_hassChanged(t){this._elements.forEach(e=>{e.hass=t})}});customElements.define("hui-picture-entity-card",class extends(Object(n.a)(Object(l.a)(a.a))){static get template(){return s["a"]`
    ...
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_config:Object,_name:String,_state:String}}getCardSize(){return 3}setConfig(t){if(!t||!t.entity)throw new Error("Error in card configuration.");if(this._entityDomain=Object(c.a)(t.entity),"camera"!==this._entityDomain&&!t.image&&!t.state_image&&!t.camera_image)throw new Error("No image source configured.");this._config=t}_hassChanged(t){const e=this._config,i=e.entity,s=t.states[i];if(!s&&"Unavailable"===this._oldState||s&&s.state===this._oldState)return;let a,n,r,o;s?(a=e.name||Object(h.a)(s),n=s.state,r=Object(b.a)(this.localize,s),o=!0):(a=e.name||i,n="Unavailable",r=this.localize("state.default.unavailable"),o=!1),this.setProperties({_name:a,_state:r,_oldState:n}),this.$.card.classList.toggle("canInteract",o)}_showNameAndState(t){return!1!==t.show_name&&!1!==t.show_state}_showName(t){return!1!==t.show_name&&!1===t.show_state}_showState(t){return!1===t.show_name&&!1!==t.show_state}_cardClicked(){const t=this._config,e=t.entity;e in this.hass.states&&("toggle"===t.tap_action?I(this.hass,e):this.fire("hass-more-info",{entityId:e}))}_getCameraImage(t){return"camera"===this._entityDomain?t.entity:t.camera_image}});var q=i(116);const F=new Set(["closed","locked","not_home","off"]);customElements.define("hui-picture-glance-card",class extends(Object(r.a)(Object(l.a)(Object(n.a)(a.a)))){static get template(){return s["a"]`
      <style>
        ha-card {
          position: relative;
          min-height: 48px;
    ...
    `}static get properties(){return{hass:Object,_config:Object,_entitiesDialog:Array,_entitiesToggle:Array}}getCardSize(){return 3}setConfig(t){if(!t||!t.entities||!Array.isArray(t.entities)||!(t.image||t.camera_image||t.state_image)||t.state_image&&!t.entity)throw new Error("Invalid card configuration");const e=[],i=[];$(t.entities).forEach(s=>{t.force_dialog||!f.e.has(Object(c.a)(s.entity))?e.push(s):i.push(s)}),this.setProperties({_config:t,_entitiesDialog:e,_entitiesToggle:i})}_computeVisible(t,e){return t.filter(t=>t.entity in e)}_computeIcon(t,e){return t.icon||Object(q.a)(e[t.entity])}_computeButtonClass(t,e){return F.has(e[t].state)?"":"state-on"}_computeTooltip(t,e){return`${Object(h.a)(e[t])}: ${Object(b.a)(this.localize,e[t])}`}_computeImageClass(t){return t.navigation_path||t.camera_image?"clickable":""}_openDialog(t){this.fire("hass-more-info",{entityId:t.model.item.entity})}_callService(t){I(this.hass,t.model.item.entity)}_handleImageClick(){this._config.navigation_path?this.navigate(this._config.navigation_path):this._config.camera_image&&this.fire("hass-more-info",{entityId:this._config.camera_image})}}),i(181),customElements.define("hui-plant-status-card",class extends R{constructor(){super("ha-plant-card","plant")}}),customElements.define("hui-vertical-stack-card",class extends a.a{static get template(){return s["a"]`
      <style>
        #root {
          display: flex;
          flex-direction: column;
      ...
      <div id="root"></div>
    `}static get properties(){return{hass:{type:Object,observer:"_hassChanged"}}}constructor(){super(),this._elements=[]}ready(){super.ready(),this._config&&this._buildConfig()}getCardSize(){let t=0;return this._elements.forEach(e=>{t+=g(e)}),t}setConfig(t){if(!t||!t.cards||!Array.isArray(t.cards))throw new Error("Card config incorrect");this._config=t,this.$&&this._buildConfig()}_buildConfig(){const t=this._config;this._elements=[];const e=this.$.root;for(;e.lastChild;)e.removeChild(e.lastChild);const i=[];t.cards.forEach(t=>{const s=K(t);s.hass=this.hass,i.push(s),e.appendChild(s)}),this._elements=i}_hassChanged(t){this._elements.forEach(e=>{e.hass=t})}}),i(176),customElements.define("hui-weather-forecast-card",class extends R{constructor(){super("ha-weather-card","weather")}getCardSize(){return 4}});const U=new Set(["conditional","entities","entity-filter","error","glance","history-graph","horizontal-stack","iframe","map","markdown","media-control","picture","picture-elements","picture-entity","picture-glance","plant-status","vertical-stack","weather-forecast"]),W="custom:";function Z(t,e){const i=document.createElement(t);try{i.setConfig(e)}catch(i){return console.error(t,i),J(i.message,e)}return i}function J(t,e){return Z("hui-error-card",j(t,e))}function K(t){let e;if(!t||"object"!=typeof t||!t.type)return J("No card type configured.",t);if(t.type.startsWith(W)){if(e=t.type.substr(W.length),customElements.get(e))return Z(e,t);const i=J(`Custom element doesn't exist: ${e}.`,t);return customElements.whenDefined(e).then(()=>Object(m.a)(i,"rebuild-view")),i}return U.has(t.type)?Z(`hui-${t.type}-card`,t):J(`Unknown card type encountered: ${t.type}.`,t)}customElements.define("hui-unused-entities",class extends a.a{static get template(){return s["a"]`
      <style>
        #root {
          max-width: 600px;
          margin: 0 auto;
