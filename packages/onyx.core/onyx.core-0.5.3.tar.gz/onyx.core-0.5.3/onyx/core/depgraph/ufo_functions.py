...
class RetainedFactory(object):
    ...
    Inputs:
        default - if None use the decorated method to calculate the current
...
class InheritAsProperty(object):
    ...
    Inputs:
        ...
        pt    - a pointer to the instance of the ufo class from which we are
