...
class CamBank (BasicPage.BasicPage):
 ...
 def get_version(self):
  return 'cambank-{} API-{} schema-{}'.format('2.3.2', self.version, self.schema_version)
...
class Operation:
 def __init__(self, cb, oid, data=None):
  ...
  (self.odate, self.olibelle, self.odetail, self.omontant, self.obalance, self.hint_bid) = data
