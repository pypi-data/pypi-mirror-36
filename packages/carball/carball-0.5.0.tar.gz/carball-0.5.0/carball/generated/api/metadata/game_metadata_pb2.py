...
_PLAYLIST = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='UNRANKED_DUELS', index=0, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNRANKED_DOUBLES', index=1, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNRANKED_STANDARD', index=2, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNRANKED_CHAOS', index=3, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CUSTOM_LOBBY', index=4, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_DUELS', index=5, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_DOUBLES', index=6, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_SOLO_STANDARD', index=7, number=12,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_STANDARD', index=8, number=13,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNRANKED_SNOW_DAY', index=9, number=15,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ROCKET_LABS', index=10, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_HOOPS', index=11, number=27,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_RUMBLE', index=12, number=28,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_DROPSHOT', index=13, number=29,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_SNOW_DAY', index=14, number=30,
      options=None,
      type=None),
  ],
