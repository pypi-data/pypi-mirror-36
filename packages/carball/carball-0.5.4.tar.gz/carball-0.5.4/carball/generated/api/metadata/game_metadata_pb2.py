...
_PLAYLIST = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNKNOWN', index=5, number=8,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_DUELS', index=6, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_DOUBLES', index=7, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_SOLO_STANDARD', index=8, number=12,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_STANDARD', index=9, number=13,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNRANKED_SNOW_DAY', index=10, number=15,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ROCKET_LABS', index=11, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_HOOPS', index=12, number=27,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_RUMBLE', index=13, number=28,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_DROPSHOT', index=14, number=29,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKED_SNOW_DAY', index=15, number=30,
      options=None,
      type=None),
  ],
