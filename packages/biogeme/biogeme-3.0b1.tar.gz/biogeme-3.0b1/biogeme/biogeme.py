...
class BIOGEME:
    ...
    def estimate(self,bootstrap=0):
        ...
        if bootstrap > 0:
            ...
            for b in range(bootstrap):
                ...
                br =  minimize(f_and_grad,results.x,bounds=self.bounds,jac=True)
    ...
    def simulate(self,betaValues=None):
        """Applies the formulas to each row of the database.
        
        Args:
            :param betaValues: values of the parameters to be used in
        ...
        if betaValues is None:
            ...
            if len(betaValues) != len(self.betaInitValues):
                raise excep.biogemeError("The number of parameters should be {} and not {}".format(len(self.betaInitValues),len(betaValues)))
    ...
    def confidenceIntervals(self,betaValues,intervalSize=0.9):
        ...
        Args: 
            :param betaValues: array of parameters values to be used
               ...
               a distribution.  
            :type betaValues: list(list(float))
