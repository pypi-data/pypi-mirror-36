...
class PairedCompFile(pc_base.PairedCompFile):
    ...
    NOTE: earlier version used PairedCompRecord structure for the file.
    """
    ...
    def save(self, file_name=None, dir='.'):  # file_path ??? ***************
        ...
        with open(file_path, 'wt') as f:
            json.dump({'PairedCompFile': self_dict}, f, ensure_ascii=False)
