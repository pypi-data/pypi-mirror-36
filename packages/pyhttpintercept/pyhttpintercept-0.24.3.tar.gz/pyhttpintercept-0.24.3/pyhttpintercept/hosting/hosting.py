...
class HostRequest(RequestShared):
    ...
    def host_request(self):
        ...
        try:
            ...
            site = Sites().get_active_item(str(self.request_uri.path))
            ...
            if str(self.request_uri.path) == u'/test':
    ...
    def __handle_host_request(self,
        ...
        # ### Temporary response! ###
        msg = u'Hosting is not yet supported on this server! ({url})'.format(url=self.request_uri.url)
    ...
    def __server_test_page(self):
        ...
        self.response.content = (u'<h1>Server Test Page</h1>'
                                 ...
                                 .format(uri=self.request_uri.url))
