...
logger = logging.getLogger('osqlcli.special')
...
def execute(osqlcliclient, sql):
    ...
    if special_cmd.arg_type == NO_QUERY:
        ...
        return special_cmd.handler(osqlcliclient=osqlcliclient, pattern=pattern, verbose=verbose)
    elif special_cmd.arg_type == RAW_QUERY:
        return special_cmd.handler(osqlcliclient=osqlcliclient, query=sql)
