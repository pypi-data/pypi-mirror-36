...
import osqlcli.jsonrpc.contracts.connectionservice as connection
import osqlcli.jsonrpc.contracts.queryexecutestringservice as query
from .config import config_location

logger = logging.getLogger(u'osqlcli.sqltoolsclient')
