...
def main():
    init()
    if '-' in project_name:
        print(Fore.RED + "ERROR: Choose different name without using hyphen '-'")
        print(Fore.RED + "FAILED to create a new project.")
    else:
        if second_arguement == '.':
        ...
        #     print(Fore.RED + "ERROR: It doesn't take second positional arguement")
            ...
            print(Fore.GREEN +"Executing django-babel version %s." % __version__)
            print(Fore.GREEN +"Creating a project: %s" % project_name)
            print(Fore.CYAN +"HAPPY CODING. :) ")
