...
def main():
    ...
    secret_key = '6h%-xstyn^4@^uji-d++z2dixeh1+47)t6txfr8t_h(f5@g!37'
...
<body>
  <style>
    ...
    <h1 class="creator"><a href="https://www.navaneethnagesh.com/">- Navaneet Nagesh</a></h1>
</body>
</html>
""")
    html.close()
