...
# -*- coding: utf-8 -*-
#
# clustergrammer_widget2 documentation build configuration file
#
...
project = 'clustergrammer_widget2'
copyright = '2018, Nicolas Fernandez'
...
_version_py = os.path.join(repo, 'clustergrammer_widget2', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'clustergrammer_widget2doc'
...
latex_documents = [
    (master_doc, 'clustergrammer_widget2.tex', 'clustergrammer_widget2 Documentation',
     'Nicolas Fernandez', 'manual'),
]
...
man_pages = [
    ...
    'clustergrammer_widget2 Documentation',
     [author], 1)
]
