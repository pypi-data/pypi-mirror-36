...
class BrowserView(QMainWindow):
    ...
    def update_3rd_party_info():
        for browser in BrowserView.instances.values():
            if hasattr(browser, 'view'):
                browser.view.ExecuteFunction('window.python_cef.updateCefConfig', 'nestClientInfo', BrowserView.cid_hwnd_map)
...
def launch_f4_client(application_title,
                     ...
                     launch_params,
                     qt_window):
    launch_params['LoginName'] = '3203401'
    launch_params['Password'] = '1234'
