...
class BasicGrammarCase(unittest.TestCase):
    ...
    #         "grammar test;"
    #         "import <greetings.*>;"
    #         "public <rule> = <greetings.greet>;"
    #     )
    #
    #     expected_grammar = Grammar()
    #     expected_grammar.add_rule(
    #         PublicRule("rule", NamedRuleRef("greetings.greet"))
    #     )
    #     expected_grammar.add_import(Import("greetings.*"))
    #     print(grammar.compile())
    #
    #     self.assertEqual(grammar, g1)
    #     expected_rules = []
    ...
    #     self.assertListEqual(grammar.rules,
    #                          expected_rules)
