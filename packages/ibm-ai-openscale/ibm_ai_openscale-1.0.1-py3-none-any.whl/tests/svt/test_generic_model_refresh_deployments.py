...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_11b_refresh(self):
        TestAIOpenScaleClient.subscription.refresh(deployment_uids=['new_generic'])

    def test_12_check_if_deployments_were_added(self):
        self.assertTrue(len(TestAIOpenScaleClient.subscription.get_deployment_uids()) == 2)
