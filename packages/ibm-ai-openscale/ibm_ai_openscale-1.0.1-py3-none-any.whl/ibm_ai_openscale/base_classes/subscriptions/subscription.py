...
class Subscription:
    ...
    def refresh(self, add_all_deployments=True, deployment_uids=None):
        """
        Refresh deployments for this subscription.
        ...
        for deployment in deployments:
            ...
            if response.status_code == 409:
                if deployment_uids is None:
                    print('Deployment with uid={} is already monitored.'.format(deployment.guid))
            else:
                handle_response(200, 'adding deployment monitoring', response)
                print('Deployment with uid={} successfully added.'.format(deployment.guid))