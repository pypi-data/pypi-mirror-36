...
while True:
    ...
    if i > 50000:
        break
    bit_rate = 0
    quick_play_bound = 1.2
    slow_play_bound = 0.5
    time_interval, send_data_size, chunk_len, rebuf, buffer_size, rtt, end_delay, decision_flag, buffer_flag, end_of_video =   net_env.get_video_frame(bit_rate,1.0, quick_play_bound, slow_play_bound)
    i += 1
