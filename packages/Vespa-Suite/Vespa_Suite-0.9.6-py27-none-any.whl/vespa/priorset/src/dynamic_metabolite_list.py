...
class DynamicMetaboliteList(object):
    ...
    def set_new_values(self):
        ...
        self.full_names  = list(self.priorset.names)
        self.mets_scales = self.priorset.mets_scales
        self.mets_flags  = self.priorset.mets_flags
        self.mets_decays = self.priorset.mets_decays
