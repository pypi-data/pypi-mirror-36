        ...
        if flavor == 'text':
            ...
            if filename:
                try:
                    ...
                    self.output_results_to_csv(voxels, ini_name, filename)
...
#        self.dynamic_macromolecule_list.reset_to_default()
    ...
    def on_output_results_to_csv(self, event):
        """ send current voxel fitting results to CSV file """
    ...
    def output_results_to_csv(self, voxels, ini_name, filename):
        """
        ...
        available allows me to ensure that each GUI triggers the same output
        method, and saves the last successful CSV file as the default for 
        the next call. 
        ...
        Inputs:
          ...
          ini_name - string, path label in INI file where we save the filename
                      used for a successful save to CSV file
          
          filename - string, current path/filename to be used for CSV output
                       note. this will be saved in the INI under ini_name
