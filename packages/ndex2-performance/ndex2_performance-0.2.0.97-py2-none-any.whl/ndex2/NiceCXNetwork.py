...
class NiceCXNetwork():
    ...
    def set_opaque_aspect(self, aspect_name, aspect_elements):
        ...
        :rtype: none
        """
        #TODO move removal code to remove_opaque_aspect()
    ...
    def to_networkx(self):
        ...
        for k, v in node_items:
            ...
            if v.get('r'):
                node_attrs['represents'] = v.get('r')

            G.add_node(v.get('n'), node_attrs)
            #, name=v.get('n'))
        ...
        for k, v in edge_items:
            ...
            G.add_edge(self.nodes.get(v.get('s')).get('n'), self.nodes.get(v.get('t')).get('n'), add_this_dict)
    ...
    def _to_tab_file(self, out_path):
        with open(out_path, 'w') as out_file:
            for e, e_obj in self.get_edges():
                n1 = self.get_node(e_obj.get('s'))
                if n1 is not None:
                    n1 = n1.get('n')

                n2 = self.get_node(e_obj.get('t'))
                if n2 is not None:
                    n2 = n2.get('n')
