...
LOG = logging.getLogger('fd-replay.plugins.http')
...
class FdReplayHttpPlugin(FdReplayPlugBase):
    ...
    def do_replay(self, obj):
        ...
        if method not in _ALLOWED_METHODS:
            raise FdReplayConfigurationError("invalid http method: %r" % method)
...
if __name__ != "__main__":
    def _start():
        PLUGINS.register(FdReplayHttpPlugin)
    _start()
