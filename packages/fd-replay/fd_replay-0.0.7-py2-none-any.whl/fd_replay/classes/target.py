...
LOG = logging.getLogger('fd-replay.target')


class FdReplayTarget(object):
    def __init__(self,
                 name,
                 config,
                 credentials = None):
    ...
    @property
    def config(self):
        return copy.copy(self._FdReplayTarget__config)
    ...
    def credentials(self):
        return copy.copy(self._FdReplayTarget__credentials)
