...
def log_activity(logger, activity_name, activity_type=ActivityType.INTERNALCALL):
    """
    ...
    Args:
        ...
        activity_type (ActivityType). the type of the activty,
    ...
    """
    activity_info = dict(activity_id=str(uuid.uuid4()), activity_name=activity_name, activity_type=activity_type.value)
