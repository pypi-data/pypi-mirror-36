...
class Client(ClientBase):
    def __init__(self, *args, **kwargs):
        super().__init__("glacier", *args, **kwargs)
    ...
    def abort_vault_lock(
        ...
        *,
        ...
        response = self._boto_client.abort_vault_lock(**_request.to_boto())
    ...
    def add_tags_to_vault(
        ...
        *,
        ...
        response = self._boto_client.add_tags_to_vault(**_request.to_boto())
    ...
    def complete_multipart_upload(
        ...
        *,
        ...
        return shapes.ArchiveCreationOutput.from_boto(response)
    ...
    def complete_vault_lock(
        ...
        *,
        ...
        response = self._boto_client.complete_vault_lock(**_request.to_boto())
    ...
    def create_vault(
        ...
        *,
        ...
        response = self._boto_client.create_vault(**_request.to_boto())

        return shapes.CreateVaultOutput.from_boto(response)
    ...
    def delete_archive(
        ...
        *,
        ...
        response = self._boto_client.delete_archive(**_request.to_boto())
    ...
    def delete_vault(
        ...
        *,
        ...
        response = self._boto_client.delete_vault(**_request.to_boto())
    ...
    def describe_job(
        ...
        *,
        ...
        return shapes.GlacierJobDescription.from_boto(response)
    ...
    def describe_vault(
        ...
        *,
        ...
        response = self._boto_client.describe_vault(**_request.to_boto())

        return shapes.DescribeVaultOutput.from_boto(response)
    ...
    def get_data_retrieval_policy(
        ...
        *,
        ...
        return shapes.GetDataRetrievalPolicyOutput.from_boto(response)
    ...
    def get_job_output(
        ...
        *,
        ...
        response = self._boto_client.get_job_output(**_request.to_boto())

        return shapes.GetJobOutputOutput.from_boto(response)
    ...
    def get_vault_access_policy(
        ...
        *,
        ...
        return shapes.GetVaultAccessPolicyOutput.from_boto(response)
    ...
    def get_vault_lock(
        ...
        *,
        ...
        response = self._boto_client.get_vault_lock(**_request.to_boto())

        return shapes.GetVaultLockOutput.from_boto(response)
    ...
    def get_vault_notifications(
        ...
        *,
        ...
        return shapes.GetVaultNotificationsOutput.from_boto(response)
    ...
    def initiate_job(
        ...
        *,
        ...
        response = self._boto_client.initiate_job(**_request.to_boto())

        return shapes.InitiateJobOutput.from_boto(response)
    ...
    def initiate_multipart_upload(
        ...
        *,
        ...
        return shapes.InitiateMultipartUploadOutput.from_boto(response)
    ...
    def initiate_vault_lock(
        ...
        *,
        ...
        response = self._boto_client.initiate_vault_lock(**_request.to_boto())

        return shapes.InitiateVaultLockOutput.from_boto(response)
    ...
    def list_provisioned_capacity(
        ...
        *,
        ...
        return shapes.ListProvisionedCapacityOutput.from_boto(response)
    ...
    def list_tags_for_vault(
        ...
        *,
        ...
        response = self._boto_client.list_tags_for_vault(**_request.to_boto())

        return shapes.ListTagsForVaultOutput.from_boto(response)
    ...
    def list_vaults(
        ...
        *,
        ...
        paginator = self.get_paginator("list_vaults").paginate(
            **_request.to_boto()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListVaultsOutput.from_boto(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListVaultsOutput.from_boto(response)
    ...
    def purchase_provisioned_capacity(
        ...
        *,
        ...
        return shapes.PurchaseProvisionedCapacityOutput.from_boto(response)
    ...
    def upload_archive(
        ...
        *,
        ...
        response = self._boto_client.upload_archive(**_request.to_boto())
    ...
    def upload_multipart_part(
        ...
        *,
        ...
        response = self._boto_client.upload_multipart_part(**_request.to_boto())

        return shapes.UploadMultipartPartOutput.from_boto(response)
