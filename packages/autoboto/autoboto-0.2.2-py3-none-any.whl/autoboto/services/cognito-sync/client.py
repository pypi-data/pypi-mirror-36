...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("cognito-sync", *args, **kwargs)
    ...
    def bulk_publish(
        ...
        *,
        ...
        response = self._boto_client.bulk_publish(**_request.to_boto_dict())

        return shapes.BulkPublishResponse.from_boto_dict(response)
    ...
    def delete_dataset(
        ...
        *,
        ...
        return shapes.DeleteDatasetResponse.from_boto_dict(response)
    ...
    def describe_identity_pool_usage(
        ...
        *,
        ...
        return shapes.DescribeIdentityPoolUsageResponse.from_boto_dict(response)
    ...
    def describe_identity_usage(
        ...
        *,
        ...
        return shapes.DescribeIdentityUsageResponse.from_boto_dict(response)
    ...
    def get_bulk_publish_details(
        ...
        *,
        ...
        return shapes.GetBulkPublishDetailsResponse.from_boto_dict(response)
    ...
    def get_cognito_events(
        ...
        *,
        ...
        response = self._boto_client.get_cognito_events(
            **_request.to_boto_dict()
        )

        return shapes.GetCognitoEventsResponse.from_boto_dict(response)
    ...
    def get_identity_pool_configuration(
        ...
        *,
        ...
        return shapes.GetIdentityPoolConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def list_identity_pool_usage(
        ...
        *,
        ...
        return shapes.ListIdentityPoolUsageResponse.from_boto_dict(response)
    ...
    def list_records(
        ...
        *,
        ...
        response = self._boto_client.list_records(**_request.to_boto_dict())

        return shapes.ListRecordsResponse.from_boto_dict(response)
    ...
    def register_device(
        ...
        *,
        ...
        response = self._boto_client.register_device(**_request.to_boto_dict())

        return shapes.RegisterDeviceResponse.from_boto_dict(response)
    ...
    def set_cognito_events(
        ...
        *,
        ...
        response = self._boto_client.set_cognito_events(
            **_request.to_boto_dict()
        )
    ...
    def set_identity_pool_configuration(
        ...
        *,
        ...
        return shapes.SetIdentityPoolConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def subscribe_to_dataset(
        ...
        *,
        ...
        response = self._boto_client.subscribe_to_dataset(
            **_request.to_boto_dict()
        )

        return shapes.SubscribeToDatasetResponse.from_boto_dict(response)
    ...
    def unsubscribe_from_dataset(
        ...
        *,
        ...
        return shapes.UnsubscribeFromDatasetResponse.from_boto_dict(response)
    ...
    def update_records(
        ...
        *,
        ...
        response = self._boto_client.update_records(**_request.to_boto_dict())

        return shapes.UpdateRecordsResponse.from_boto_dict(response)
