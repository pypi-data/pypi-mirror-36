...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("lightsail", *args, **kwargs)
    ...
    def allocate_static_ip(
        ...
        *,
        ...
        response = self._boto_client.allocate_static_ip(
            **_request.to_boto_dict()
        )

        return shapes.AllocateStaticIpResult.from_boto_dict(response)
    ...
    def attach_disk(
        ...
        *,
        ...
        response = self._boto_client.attach_disk(**_request.to_boto_dict())

        return shapes.AttachDiskResult.from_boto_dict(response)
    ...
    def attach_instances_to_load_balancer(
        ...
        *,
        ...
        return shapes.AttachInstancesToLoadBalancerResult.from_boto_dict(
            response
        )
    ...
    def attach_load_balancer_tls_certificate(
        ...
        *,
        ...
        return shapes.AttachLoadBalancerTlsCertificateResult.from_boto_dict(
            response
        )
    ...
    def attach_static_ip(
        ...
        *,
        ...
        response = self._boto_client.attach_static_ip(**_request.to_boto_dict())

        return shapes.AttachStaticIpResult.from_boto_dict(response)
    ...
    def close_instance_public_ports(
        ...
        *,
        ...
        return shapes.CloseInstancePublicPortsResult.from_boto_dict(response)
    ...
    def create_disk(
        ...
        *,
        ...
        response = self._boto_client.create_disk(**_request.to_boto_dict())

        return shapes.CreateDiskResult.from_boto_dict(response)
    ...
    def create_disk_from_snapshot(
        ...
        *,
        ...
        return shapes.CreateDiskFromSnapshotResult.from_boto_dict(response)
    ...
    def create_disk_snapshot(
        ...
        *,
        ...
        response = self._boto_client.create_disk_snapshot(
            **_request.to_boto_dict()
        )

        return shapes.CreateDiskSnapshotResult.from_boto_dict(response)
    ...
    def create_domain(
        ...
        *,
        ...
        response = self._boto_client.create_domain(**_request.to_boto_dict())

        return shapes.CreateDomainResult.from_boto_dict(response)
    ...
    def create_domain_entry(
        ...
        *,
        ...
        response = self._boto_client.create_domain_entry(
            **_request.to_boto_dict()
        )

        return shapes.CreateDomainEntryResult.from_boto_dict(response)
    ...
    def create_instance_snapshot(
        ...
        *,
        ...
        return shapes.CreateInstanceSnapshotResult.from_boto_dict(response)
    ...
    def create_instances(
        ...
        *,
        ...
        response = self._boto_client.create_instances(**_request.to_boto_dict())

        return shapes.CreateInstancesResult.from_boto_dict(response)
    ...
    def create_instances_from_snapshot(
        ...
        *,
        ...
        instance_snapshot_name: str,
        bundle_id: str,
        attached_disk_mapping: typing.Dict[str, typing.List[shapes.DiskMap]
                                          ] = ShapeBase.NOT_SET,
        user_data: str = ShapeBase.NOT_SET,
        key_pair_name: str = ShapeBase.NOT_SET,
        ...
        return shapes.CreateInstancesFromSnapshotResult.from_boto_dict(response)
    ...
    def create_key_pair(
        ...
        *,
        ...
        return shapes.CreateKeyPairResult.from_boto_dict(response)
    ...
    def create_load_balancer(
        ...
        *,
        ...
        response = self._boto_client.create_load_balancer(
            **_request.to_boto_dict()
        )

        return shapes.CreateLoadBalancerResult.from_boto_dict(response)
    ...
    def create_load_balancer_tls_certificate(
        ...
        *,
        ...
        return shapes.CreateLoadBalancerTlsCertificateResult.from_boto_dict(
            response
        )
    ...
    def delete_disk(
        ...
        *,
        ...
        response = self._boto_client.delete_disk(**_request.to_boto_dict())

        return shapes.DeleteDiskResult.from_boto_dict(response)
    ...
    def delete_disk_snapshot(
        ...
        *,
        ...
        response = self._boto_client.delete_disk_snapshot(
            **_request.to_boto_dict()
        )

        return shapes.DeleteDiskSnapshotResult.from_boto_dict(response)
    ...
    def delete_domain(
        ...
        *,
        ...
        response = self._boto_client.delete_domain(**_request.to_boto_dict())

        return shapes.DeleteDomainResult.from_boto_dict(response)
    ...
    def delete_domain_entry(
        ...
        *,
        ...
        response = self._boto_client.delete_domain_entry(
            **_request.to_boto_dict()
        )

        return shapes.DeleteDomainEntryResult.from_boto_dict(response)
    ...
    def delete_instance(
        ...
        *,
        ...
        response = self._boto_client.delete_instance(**_request.to_boto_dict())

        return shapes.DeleteInstanceResult.from_boto_dict(response)
    ...
    def delete_instance_snapshot(
        ...
        *,
        ...
        return shapes.DeleteInstanceSnapshotResult.from_boto_dict(response)
    ...
    def delete_key_pair(
        ...
        *,
        ...
        return shapes.DeleteKeyPairResult.from_boto_dict(response)
    ...
    def delete_load_balancer(
        ...
        *,
        ...
        response = self._boto_client.delete_load_balancer(
            **_request.to_boto_dict()
        )

        return shapes.DeleteLoadBalancerResult.from_boto_dict(response)
    ...
    def delete_load_balancer_tls_certificate(
        ...
        *,
        ...
        return shapes.DeleteLoadBalancerTlsCertificateResult.from_boto_dict(
            response
        )
    ...
    def detach_disk(
        ...
        *,
        ...
        response = self._boto_client.detach_disk(**_request.to_boto_dict())

        return shapes.DetachDiskResult.from_boto_dict(response)
    ...
    def detach_instances_from_load_balancer(
        ...
        *,
        ...
        return shapes.DetachInstancesFromLoadBalancerResult.from_boto_dict(
            response
        )
    ...
    def detach_static_ip(
        ...
        *,
        ...
        response = self._boto_client.detach_static_ip(**_request.to_boto_dict())

        return shapes.DetachStaticIpResult.from_boto_dict(response)
    ...
    def download_default_key_pair(
        ...
        return shapes.DownloadDefaultKeyPairResult.from_boto_dict(response)
    ...
    def get_active_names(
        ...
        *,
        ...
        response = self._boto_client.get_active_names(**_request.to_boto_dict())

        return shapes.GetActiveNamesResult.from_boto_dict(response)
    ...
    def get_blueprints(
        ...
        *,
        ...
        response = self._boto_client.get_blueprints(**_request.to_boto_dict())

        return shapes.GetBlueprintsResult.from_boto_dict(response)
    ...
    def get_bundles(
        ...
        *,
        ...
        response = self._boto_client.get_bundles(**_request.to_boto_dict())

        return shapes.GetBundlesResult.from_boto_dict(response)
    ...
    def get_disk(
        ...
        *,
        ...
        response = self._boto_client.get_disk(**_request.to_boto_dict())

        return shapes.GetDiskResult.from_boto_dict(response)
    ...
    def get_disk_snapshot(
        ...
        *,
        ...
        response = self._boto_client.get_disk_snapshot(
            **_request.to_boto_dict()
        )

        return shapes.GetDiskSnapshotResult.from_boto_dict(response)
    ...
    def get_disk_snapshots(
        ...
        *,
        ...
        response = self._boto_client.get_disk_snapshots(
            **_request.to_boto_dict()
        )

        return shapes.GetDiskSnapshotsResult.from_boto_dict(response)
    ...
    def get_disks(
        ...
        *,
        ...
        response = self._boto_client.get_disks(**_request.to_boto_dict())

        return shapes.GetDisksResult.from_boto_dict(response)
    ...
    def get_domain(
        ...
        *,
        ...
        response = self._boto_client.get_domain(**_request.to_boto_dict())

        return shapes.GetDomainResult.from_boto_dict(response)
    ...
    def get_domains(
        ...
        *,
        ...
        response = self._boto_client.get_domains(**_request.to_boto_dict())

        return shapes.GetDomainsResult.from_boto_dict(response)
    ...
    def get_instance(
        ...
        *,
        ...
        response = self._boto_client.get_instance(**_request.to_boto_dict())

        return shapes.GetInstanceResult.from_boto_dict(response)
    ...
    def get_instance_access_details(
        ...
        *,
        instance_name: str,
        protocol: shapes.InstanceAccessProtocol = ShapeBase.NOT_SET,
        ...
        return shapes.GetInstanceAccessDetailsResult.from_boto_dict(response)
    ...
    def get_instance_metric_data(
        ...
        *,
        instance_name: str,
        metric_name: shapes.InstanceMetricName,
        period: int,
        start_time: datetime.datetime,
        end_time: datetime.datetime,
        unit: shapes.MetricUnit,
        statistics: typing.List[shapes.MetricStatistic],
        ...
        return shapes.GetInstanceMetricDataResult.from_boto_dict(response)
    ...
    def get_instance_port_states(
        ...
        *,
        ...
        return shapes.GetInstancePortStatesResult.from_boto_dict(response)
    ...
    def get_instance_snapshot(
        ...
        *,
        ...
        response = self._boto_client.get_instance_snapshot(
            **_request.to_boto_dict()
        )

        return shapes.GetInstanceSnapshotResult.from_boto_dict(response)
    ...
    def get_instance_snapshots(
        ...
        *,
        ...
        response = self._boto_client.get_instance_snapshots(
            **_request.to_boto_dict()
        )

        return shapes.GetInstanceSnapshotsResult.from_boto_dict(response)
    ...
    def get_instance_state(
        ...
        *,
        ...
        response = self._boto_client.get_instance_state(
            **_request.to_boto_dict()
        )

        return shapes.GetInstanceStateResult.from_boto_dict(response)
    ...
    def get_instances(
        ...
        *,
        ...
        response = self._boto_client.get_instances(**_request.to_boto_dict())

        return shapes.GetInstancesResult.from_boto_dict(response)
    ...
    def get_key_pair(
        ...
        *,
        ...
        response = self._boto_client.get_key_pair(**_request.to_boto_dict())

        return shapes.GetKeyPairResult.from_boto_dict(response)
    ...
    def get_key_pairs(
        ...
        *,
        ...
        response = self._boto_client.get_key_pairs(**_request.to_boto_dict())

        return shapes.GetKeyPairsResult.from_boto_dict(response)
    ...
    def get_load_balancer(
        ...
        *,
        ...
        response = self._boto_client.get_load_balancer(
            **_request.to_boto_dict()
        )

        return shapes.GetLoadBalancerResult.from_boto_dict(response)
    ...
    def get_load_balancer_metric_data(
        ...
        *,
        load_balancer_name: str,
        metric_name: shapes.LoadBalancerMetricName,
        period: int,
        start_time: datetime.datetime,
        end_time: datetime.datetime,
        unit: shapes.MetricUnit,
        ...
        return shapes.GetLoadBalancerMetricDataResult.from_boto_dict(response)
    ...
    def get_load_balancer_tls_certificates(
        ...
        *,
        ...
        return shapes.GetLoadBalancerTlsCertificatesResult.from_boto_dict(
            response
        )
    ...
    def get_load_balancers(
        ...
        *,
        ...
        response = self._boto_client.get_load_balancers(
            **_request.to_boto_dict()
        )

        return shapes.GetLoadBalancersResult.from_boto_dict(response)
    ...
    def get_operation(
        ...
        *,
        ...
        response = self._boto_client.get_operation(**_request.to_boto_dict())

        return shapes.GetOperationResult.from_boto_dict(response)
    ...
    def get_operations(
        ...
        *,
        ...
        response = self._boto_client.get_operations(**_request.to_boto_dict())

        return shapes.GetOperationsResult.from_boto_dict(response)
    ...
    def get_operations_for_resource(
        ...
        *,
        ...
        return shapes.GetOperationsForResourceResult.from_boto_dict(response)
    ...
    def get_regions(
        ...
        *,
        ...
        response = self._boto_client.get_regions(**_request.to_boto_dict())

        return shapes.GetRegionsResult.from_boto_dict(response)
    ...
    def get_static_ip(
        ...
        *,
        ...
        response = self._boto_client.get_static_ip(**_request.to_boto_dict())

        return shapes.GetStaticIpResult.from_boto_dict(response)
    ...
    def get_static_ips(
        ...
        *,
        ...
        response = self._boto_client.get_static_ips(**_request.to_boto_dict())

        return shapes.GetStaticIpsResult.from_boto_dict(response)
    ...
    def is_vpc_peered(
        ...
        response = self._boto_client.is_vpc_peered(**_request.to_boto_dict())

        return shapes.IsVpcPeeredResult.from_boto_dict(response)
    ...
    def open_instance_public_ports(
        ...
        *,
        ...
        return shapes.OpenInstancePublicPortsResult.from_boto_dict(response)
    ...
    def peer_vpc(
        ...
        response = self._boto_client.peer_vpc(**_request.to_boto_dict())

        return shapes.PeerVpcResult.from_boto_dict(response)
    ...
    def put_instance_public_ports(
        ...
        *,
        ...
        return shapes.PutInstancePublicPortsResult.from_boto_dict(response)
    ...
    def reboot_instance(
        ...
        *,
        ...
        response = self._boto_client.reboot_instance(**_request.to_boto_dict())

        return shapes.RebootInstanceResult.from_boto_dict(response)
    ...
    def release_static_ip(
        ...
        *,
        ...
        response = self._boto_client.release_static_ip(
            **_request.to_boto_dict()
        )

        return shapes.ReleaseStaticIpResult.from_boto_dict(response)
    ...
    def start_instance(
        ...
        *,
        ...
        response = self._boto_client.start_instance(**_request.to_boto_dict())

        return shapes.StartInstanceResult.from_boto_dict(response)
    ...
    def stop_instance(
        ...
        *,
        ...
        response = self._boto_client.stop_instance(**_request.to_boto_dict())

        return shapes.StopInstanceResult.from_boto_dict(response)
    ...
    def unpeer_vpc(
        ...
        response = self._boto_client.unpeer_vpc(**_request.to_boto_dict())

        return shapes.UnpeerVpcResult.from_boto_dict(response)
    ...
    def update_domain_entry(
        ...
        *,
        ...
        response = self._boto_client.update_domain_entry(
            **_request.to_boto_dict()
        )

        return shapes.UpdateDomainEntryResult.from_boto_dict(response)
    ...
    def update_load_balancer_attribute(
        ...
        *,
        load_balancer_name: str,
        attribute_name: shapes.LoadBalancerAttributeName,
        attribute_value: str,
        ...
        return shapes.UpdateLoadBalancerAttributeResult.from_boto_dict(response)
