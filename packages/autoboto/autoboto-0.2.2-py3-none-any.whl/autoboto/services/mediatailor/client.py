...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("mediatailor", *args, **kwargs)
    ...
    def delete_playback_configuration(
        ...
        *,
        ...
        return shapes.DeletePlaybackConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def get_playback_configuration(
        ...
        *,
        ...
        return shapes.GetPlaybackConfigurationResponse.from_boto_dict(response)
    ...
    def list_playback_configurations(
        ...
        *,
        ...
        return shapes.ListPlaybackConfigurationsResponse.from_boto_dict(
            response
        )
    ...
    def put_playback_configuration(
        ...
        *,
        ...
        return shapes.PutPlaybackConfigurationResponse.from_boto_dict(response)
