...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("appstream", *args, **kwargs)
    ...
    def associate_fleet(
        ...
        *,
        ...
        response = self._boto_client.associate_fleet(**_request.to_boto_dict())

        return shapes.AssociateFleetResult.from_boto_dict(response)
    ...
    def copy_image(
        ...
        *,
        ...
        return shapes.CopyImageResponse.from_boto_dict(response)
    ...
    def create_directory_config(
        ...
        *,
        ...
        return shapes.CreateDirectoryConfigResult.from_boto_dict(response)
    ...
    def create_image_builder(
        ...
        *,
        ...
        response = self._boto_client.create_image_builder(
            **_request.to_boto_dict()
        )

        return shapes.CreateImageBuilderResult.from_boto_dict(response)
    ...
    def create_image_builder_streaming_url(
        ...
        *,
        ...
        return shapes.CreateImageBuilderStreamingURLResult.from_boto_dict(
            response
        )
    ...
    def create_streaming_url(
        ...
        *,
        ...
        response = self._boto_client.create_streaming_url(
            **_request.to_boto_dict()
        )

        return shapes.CreateStreamingURLResult.from_boto_dict(response)
    ...
    def delete_directory_config(
        ...
        *,
        ...
        return shapes.DeleteDirectoryConfigResult.from_boto_dict(response)
    ...
    def delete_fleet(
        ...
        *,
        ...
        return shapes.DeleteFleetResult.from_boto_dict(response)
    ...
    def delete_image(
        ...
        *,
        ...
        response = self._boto_client.delete_image(**_request.to_boto_dict())

        return shapes.DeleteImageResult.from_boto_dict(response)
    ...
    def delete_image_builder(
        ...
        *,
        ...
        response = self._boto_client.delete_image_builder(
            **_request.to_boto_dict()
        )

        return shapes.DeleteImageBuilderResult.from_boto_dict(response)
    ...
    def delete_image_permissions(
        ...
        *,
        ...
        return shapes.DeleteImagePermissionsResult.from_boto_dict(response)
    ...
    def delete_stack(
        ...
        *,
        ...
        return shapes.DeleteStackResult.from_boto_dict(response)
    ...
    def describe_directory_configs(
        ...
        *,
        ...
        return shapes.DescribeDirectoryConfigsResult.from_boto_dict(response)
    ...
    def describe_image_builders(
        ...
        *,
        ...
        return shapes.DescribeImageBuildersResult.from_boto_dict(response)
    ...
    def describe_image_permissions(
        ...
        *,
        ...
        return shapes.DescribeImagePermissionsResult.from_boto_dict(response)
    ...
    def describe_images(
        ...
        *,
        ...
        type: shapes.VisibilityType = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
    ...
    def describe_sessions(
        ...
        *,
        ...
        authentication_type: shapes.AuthenticationType = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeSessionsResult.from_boto_dict(response)
    ...
    def disassociate_fleet(
        ...
        *,
        ...
        response = self._boto_client.disassociate_fleet(
            **_request.to_boto_dict()
        )

        return shapes.DisassociateFleetResult.from_boto_dict(response)
    ...
    def expire_session(
        ...
        *,
        ...
        response = self._boto_client.expire_session(**_request.to_boto_dict())

        return shapes.ExpireSessionResult.from_boto_dict(response)
    ...
    def list_associated_fleets(
        ...
        *,
        ...
        return shapes.ListAssociatedFleetsResult.from_boto_dict(response)
    ...
    def list_associated_stacks(
        ...
        *,
        ...
        return shapes.ListAssociatedStacksResult.from_boto_dict(response)
    ...
    def start_fleet(
        ...
        *,
        ...
        response = self._boto_client.start_fleet(**_request.to_boto_dict())

        return shapes.StartFleetResult.from_boto_dict(response)
    ...
    def start_image_builder(
        ...
        *,
        ...
        response = self._boto_client.start_image_builder(
            **_request.to_boto_dict()
        )

        return shapes.StartImageBuilderResult.from_boto_dict(response)
    ...
    def stop_fleet(
        ...
        *,
        ...
        response = self._boto_client.stop_fleet(**_request.to_boto_dict())

        return shapes.StopFleetResult.from_boto_dict(response)
    ...
    def stop_image_builder(
        ...
        *,
        ...
        response = self._boto_client.stop_image_builder(
            **_request.to_boto_dict()
        )

        return shapes.StopImageBuilderResult.from_boto_dict(response)
    ...
    def update_directory_config(
        ...
        *,
        ...
        return shapes.UpdateDirectoryConfigResult.from_boto_dict(response)
    ...
    def update_fleet(
        ...
        *,
        ...
        enable_default_internet_access: bool = ShapeBase.NOT_SET,
        domain_join_info: shapes.DomainJoinInfo = ShapeBase.NOT_SET,
        attributes_to_delete: typing.List[shapes.FleetAttribute
                                         ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.update_fleet(**_request.to_boto_dict())

        return shapes.UpdateFleetResult.from_boto_dict(response)
    ...
    def update_image_permissions(
        ...
        *,
        ...
        return shapes.UpdateImagePermissionsResult.from_boto_dict(response)
    ...
    def update_stack(
        ...
        *,
        ...
        redirect_url: str = ShapeBase.NOT_SET,
        feedback_url: str = ShapeBase.NOT_SET,
        attributes_to_delete: typing.List[shapes.StackAttribute
                                         ] = ShapeBase.NOT_SET,
        user_settings: typing.List[shapes.UserSetting] = ShapeBase.NOT_SET,
        application_settings: shapes.ApplicationSettings = ShapeBase.NOT_SET,
        ...
        return shapes.UpdateStackResult.from_boto_dict(response)
