...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("servicediscovery", *args, **kwargs)
    ...
    def create_private_dns_namespace(
        ...
        *,
        ...
        return shapes.CreatePrivateDnsNamespaceResponse.from_boto_dict(response)
    ...
    def create_public_dns_namespace(
        ...
        *,
        ...
        return shapes.CreatePublicDnsNamespaceResponse.from_boto_dict(response)
    ...
    def delete_namespace(
        ...
        *,
        ...
        response = self._boto_client.delete_namespace(**_request.to_boto_dict())

        return shapes.DeleteNamespaceResponse.from_boto_dict(response)
    ...
    def deregister_instance(
        ...
        *,
        ...
        return shapes.DeregisterInstanceResponse.from_boto_dict(response)
    ...
    def get_instance(
        ...
        *,
        ...
        return shapes.GetInstanceResponse.from_boto_dict(response)
    ...
    def get_instances_health_status(
        ...
        *,
        ...
        return shapes.GetInstancesHealthStatusResponse.from_boto_dict(response)
    ...
    def get_namespace(
        ...
        *,
        ...
        response = self._boto_client.get_namespace(**_request.to_boto_dict())

        return shapes.GetNamespaceResponse.from_boto_dict(response)
    ...
    def get_operation(
        ...
        *,
        ...
        return shapes.GetOperationResponse.from_boto_dict(response)
    ...
    def get_service(
        ...
        *,
        ...
        response = self._boto_client.get_service(**_request.to_boto_dict())

        return shapes.GetServiceResponse.from_boto_dict(response)
    ...
    def list_instances(
        ...
        *,
        ...
        return shapes.ListInstancesResponse.from_boto_dict(response)
    ...
    def list_namespaces(
        ...
        *,
        ...
        response = self._boto_client.list_namespaces(**_request.to_boto_dict())

        return shapes.ListNamespacesResponse.from_boto_dict(response)
    ...
    def register_instance(
        ...
        *,
        ...
        return shapes.RegisterInstanceResponse.from_boto_dict(response)
    ...
    def update_instance_custom_health_status(
        ...
        *,
        service_id: str,
        instance_id: str,
        status: shapes.CustomHealthStatus,
    ) -> None:
        if _request is None:
            _params = {}
            if service_id is not ShapeBase.NOT_SET:
