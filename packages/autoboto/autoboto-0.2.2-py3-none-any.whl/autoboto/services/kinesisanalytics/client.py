...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("kinesisanalytics", *args, **kwargs)
    ...
    def add_application_cloud_watch_logging_option(
        ...
        *,
        ...
        return shapes.AddApplicationCloudWatchLoggingOptionResponse.from_boto_dict(
            response
        )
    ...
    def add_application_input(
        ...
        *,
        ...
        response = self._boto_client.add_application_input(
            **_request.to_boto_dict()
        )

        return shapes.AddApplicationInputResponse.from_boto_dict(response)
    ...
    def add_application_input_processing_configuration(
        ...
        *,
        ...
        return shapes.AddApplicationInputProcessingConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def add_application_output(
        ...
        *,
        ...
        return shapes.AddApplicationOutputResponse.from_boto_dict(response)
    ...
    def add_application_reference_data_source(
        ...
        *,
        ...
        return shapes.AddApplicationReferenceDataSourceResponse.from_boto_dict(
            response
        )
    ...
    def delete_application(
        ...
        *,
        ...
        return shapes.DeleteApplicationResponse.from_boto_dict(response)
    ...
    def delete_application_cloud_watch_logging_option(
        ...
        *,
        ...
        return shapes.DeleteApplicationCloudWatchLoggingOptionResponse.from_boto_dict(
            response
        )
    ...
    def delete_application_input_processing_configuration(
        ...
        *,
        ...
        return shapes.DeleteApplicationInputProcessingConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def delete_application_output(
        ...
        *,
        ...
        return shapes.DeleteApplicationOutputResponse.from_boto_dict(response)
    ...
    def delete_application_reference_data_source(
        ...
        *,
        ...
        return shapes.DeleteApplicationReferenceDataSourceResponse.from_boto_dict(
            response
        )
    ...
    def describe_application(
        ...
        *,
        ...
        response = self._boto_client.describe_application(
            **_request.to_boto_dict()
        )

        return shapes.DescribeApplicationResponse.from_boto_dict(response)
    ...
    def discover_input_schema(
        ...
        *,
        ...
        response = self._boto_client.discover_input_schema(
            **_request.to_boto_dict()
        )

        return shapes.DiscoverInputSchemaResponse.from_boto_dict(response)
    ...
    def list_applications(
        ...
        *,
        ...
        return shapes.ListApplicationsResponse.from_boto_dict(response)
    ...
    def start_application(
        ...
        *,
        ...
        response = self._boto_client.start_application(
            **_request.to_boto_dict()
        )

        return shapes.StartApplicationResponse.from_boto_dict(response)
    ...
    def stop_application(
        ...
        *,
        ...
        response = self._boto_client.stop_application(**_request.to_boto_dict())

        return shapes.StopApplicationResponse.from_boto_dict(response)
