...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("ec2", *args, **kwargs)
    ...
    def accept_reserved_instances_exchange_quote(
        ...
        *,
        ...
        return shapes.AcceptReservedInstancesExchangeQuoteResult.from_boto_dict(
            response
        )
    ...
    def accept_vpc_endpoint_connections(
        ...
        *,
        ...
        return shapes.AcceptVpcEndpointConnectionsResult.from_boto_dict(
            response
        )
    ...
    def accept_vpc_peering_connection(
        ...
        *,
        ...
        return shapes.AcceptVpcPeeringConnectionResult.from_boto_dict(response)

    def allocate_address(
        self,
        _request: shapes.AllocateAddressRequest = None,
        *,
        domain: shapes.DomainType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.allocate_address(**_request.to_boto_dict())

        return shapes.AllocateAddressResult.from_boto_dict(response)
    ...
    def allocate_hosts(
        ...
        *,
        ...
        instance_type: str,
        quantity: int,
        auto_placement: shapes.AutoPlacement = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.allocate_hosts(**_request.to_boto_dict())

        return shapes.AllocateHostsResult.from_boto_dict(response)
    ...
    def assign_ipv6_addresses(
        ...
        *,
        ...
        response = self._boto_client.assign_ipv6_addresses(
            **_request.to_boto_dict()
        )

        return shapes.AssignIpv6AddressesResult.from_boto_dict(response)
    ...
    def associate_address(
        ...
        *,
        ...
        response = self._boto_client.associate_address(
            **_request.to_boto_dict()
        )

        return shapes.AssociateAddressResult.from_boto_dict(response)
    ...
    def associate_iam_instance_profile(
        ...
        *,
        ...
        return shapes.AssociateIamInstanceProfileResult.from_boto_dict(response)
    ...
    def associate_route_table(
        ...
        *,
        ...
        response = self._boto_client.associate_route_table(
            **_request.to_boto_dict()
        )

        return shapes.AssociateRouteTableResult.from_boto_dict(response)
    ...
    def associate_subnet_cidr_block(
        ...
        *,
        ...
        return shapes.AssociateSubnetCidrBlockResult.from_boto_dict(response)
    ...
    def associate_vpc_cidr_block(
        ...
        *,
        ...
        return shapes.AssociateVpcCidrBlockResult.from_boto_dict(response)
    ...
    def attach_classic_link_vpc(
        ...
        *,
        ...
        return shapes.AttachClassicLinkVpcResult.from_boto_dict(response)
    ...
    def attach_network_interface(
        ...
        *,
        ...
        return shapes.AttachNetworkInterfaceResult.from_boto_dict(response)
    ...
    def attach_volume(
        ...
        *,
        ...
        response = self._boto_client.attach_volume(**_request.to_boto_dict())

        return shapes.VolumeAttachment.from_boto_dict(response)
    ...
    def attach_vpn_gateway(
        ...
        *,
        ...
        response = self._boto_client.attach_vpn_gateway(
            **_request.to_boto_dict()
        )

        return shapes.AttachVpnGatewayResult.from_boto_dict(response)
    ...
    def bundle_instance(
        ...
        *,
        ...
        response = self._boto_client.bundle_instance(**_request.to_boto_dict())

        return shapes.BundleInstanceResult.from_boto_dict(response)
    ...
    def cancel_bundle_task(
        ...
        *,
        ...
        response = self._boto_client.cancel_bundle_task(
            **_request.to_boto_dict()
        )

        return shapes.CancelBundleTaskResult.from_boto_dict(response)
    ...
    def cancel_export_task(
        ...
        *,
        ...
        response = self._boto_client.cancel_export_task(
            **_request.to_boto_dict()
        )
    ...
    def cancel_import_task(
        ...
        *,
        ...
        response = self._boto_client.cancel_import_task(
            **_request.to_boto_dict()
        )

        return shapes.CancelImportTaskResult.from_boto_dict(response)
    ...
    def cancel_reserved_instances_listing(
        ...
        *,
        ...
        return shapes.CancelReservedInstancesListingResult.from_boto_dict(
            response
        )
    ...
    def cancel_spot_fleet_requests(
        ...
        *,
        ...
        return shapes.CancelSpotFleetRequestsResponse.from_boto_dict(response)
    ...
    def cancel_spot_instance_requests(
        ...
        *,
        ...
        return shapes.CancelSpotInstanceRequestsResult.from_boto_dict(response)
    ...
    def confirm_product_instance(
        ...
        *,
        ...
        return shapes.ConfirmProductInstanceResult.from_boto_dict(response)
    ...
    def copy_fpga_image(
        ...
        *,
        ...
        response = self._boto_client.copy_fpga_image(**_request.to_boto_dict())

        return shapes.CopyFpgaImageResult.from_boto_dict(response)
    ...
    def copy_image(
        ...
        *,
        ...
        response = self._boto_client.copy_image(**_request.to_boto_dict())

        return shapes.CopyImageResult.from_boto_dict(response)
    ...
    def copy_snapshot(
        ...
        *,
        ...
        response = self._boto_client.copy_snapshot(**_request.to_boto_dict())

        return shapes.CopySnapshotResult.from_boto_dict(response)
    ...
    def create_customer_gateway(
        ...
        *,
        ...
        return shapes.CreateCustomerGatewayResult.from_boto_dict(response)
    ...
    def create_default_subnet(
        ...
        *,
        ...
        response = self._boto_client.create_default_subnet(
            **_request.to_boto_dict()
        )

        return shapes.CreateDefaultSubnetResult.from_boto_dict(response)
    ...
    def create_default_vpc(
        ...
        *,
        ...
        iIf you deleted your previous default VPC, you can create a default VPC. You
        ...
        response = self._boto_client.create_default_vpc(
            **_request.to_boto_dict()
        )

        return shapes.CreateDefaultVpcResult.from_boto_dict(response)
    ...
    def create_dhcp_options(
        ...
        *,
        ...
        response = self._boto_client.create_dhcp_options(
            **_request.to_boto_dict()
        )

        return shapes.CreateDhcpOptionsResult.from_boto_dict(response)
    ...
    def create_egress_only_internet_gateway(
        ...
        *,
        ...
        return shapes.CreateEgressOnlyInternetGatewayResult.from_boto_dict(
            response
        )
    ...
    def create_fleet(
        ...
        *,
        launch_template_configs: typing.List[
            shapes.FleetLaunchTemplateConfigRequest
        ],
        ...
        response = self._boto_client.create_fleet(**_request.to_boto_dict())

        return shapes.CreateFleetResult.from_boto_dict(response)
    ...
    def create_flow_logs(
        ...
        *,
        ...
        resource_type: shapes.FlowLogsResourceType,
        traffic_type: shapes.TrafficType,
        dry_run: bool = ShapeBase.NOT_SET,
        client_token: str = ShapeBase.NOT_SET,
        deliver_logs_permission_arn: str = ShapeBase.NOT_SET,
        log_group_name: str = ShapeBase.NOT_SET,
        log_destination_type: shapes.LogDestinationType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_flow_logs(**_request.to_boto_dict())

        return shapes.CreateFlowLogsResult.from_boto_dict(response)
    ...
    def create_fpga_image(
        ...
        *,
        ...
        response = self._boto_client.create_fpga_image(
            **_request.to_boto_dict()
        )

        return shapes.CreateFpgaImageResult.from_boto_dict(response)
    ...
    def create_image(
        ...
        *,
        ...
        response = self._boto_client.create_image(**_request.to_boto_dict())

        return shapes.CreateImageResult.from_boto_dict(response)
    ...
    def create_instance_export_task(
        ...
        *,
        ...
        NOT_SET,
        target_environment: shapes.ExportEnvironment = ShapeBase.NOT_SET,
        ...
        return shapes.CreateInstanceExportTaskResult.from_boto_dict(response)
    ...
    def create_internet_gateway(
        ...
        *,
        ...
        return shapes.CreateInternetGatewayResult.from_boto_dict(response)
    ...
    def create_key_pair(
        ...
        *,
        ...
        response = self._boto_client.create_key_pair(**_request.to_boto_dict())

        return shapes.KeyPair.from_boto_dict(response)
    ...
    def create_launch_template(
        ...
        *,
        ...
        return shapes.CreateLaunchTemplateResult.from_boto_dict(response)
    ...
    def create_launch_template_version(
        ...
        *,
        ...
        return shapes.CreateLaunchTemplateVersionResult.from_boto_dict(response)
    ...
    def create_nat_gateway(
        ...
        *,
        ...
        response = self._boto_client.create_nat_gateway(
            **_request.to_boto_dict()
        )

        return shapes.CreateNatGatewayResult.from_boto_dict(response)
    ...
    def create_network_acl(
        ...
        *,
        ...
        response = self._boto_client.create_network_acl(
            **_request.to_boto_dict()
        )

        return shapes.CreateNetworkAclResult.from_boto_dict(response)
    ...
    def create_network_interface(
        ...
        *,
        ...
        return shapes.CreateNetworkInterfaceResult.from_boto_dict(response)
    ...
    def create_network_interface_permission(
        ...
        *,
        network_interface_id: str,
        permission: shapes.InterfacePermissionType,
        ...
        return shapes.CreateNetworkInterfacePermissionResult.from_boto_dict(
            response
        )
    ...
    def create_placement_group(
        ...
        *,
        group_name: str,
        strategy: shapes.PlacementStrategy,
        dry_run: bool = ShapeBase.NOT_SET,
    ) -> None:
        """
    ...
    def create_reserved_instances_listing(
        ...
        *,
        ...
        return shapes.CreateReservedInstancesListingResult.from_boto_dict(
            response
        )
    ...
    def create_route(
        ...
        *,
        ...
        response = self._boto_client.create_route(**_request.to_boto_dict())

        return shapes.CreateRouteResult.from_boto_dict(response)
    ...
    def create_route_table(
        ...
        *,
        ...
        response = self._boto_client.create_route_table(
            **_request.to_boto_dict()
        )

        return shapes.CreateRouteTableResult.from_boto_dict(response)
    ...
    def create_security_group(
        ...
        *,
        ...
        response = self._boto_client.create_security_group(
            **_request.to_boto_dict()
        )

        return shapes.CreateSecurityGroupResult.from_boto_dict(response)
    ...
    def create_snapshot(
        ...
        *,
        ...
        response = self._boto_client.create_snapshot(**_request.to_boto_dict())

        return shapes.Snapshot.from_boto_dict(response)
    ...
    def create_spot_datafeed_subscription(
        ...
        *,
        ...
        return shapes.CreateSpotDatafeedSubscriptionResult.from_boto_dict(
            response
        )
    ...
    def create_subnet(
        ...
        *,
        ...
        response = self._boto_client.create_subnet(**_request.to_boto_dict())

        return shapes.CreateSubnetResult.from_boto_dict(response)
    ...
    def create_volume(
        ...
        *,
        ...
        volume_type: shapes.VolumeType = ShapeBase.NOT_SET,
        dry_run: bool = ShapeBase.NOT_SET,
        tag_specifications: typing.List[shapes.TagSpecification
                                       ] = ShapeBase.NOT_SET,
    ) -> shapes.Volume:
        ...
        response = self._boto_client.create_volume(**_request.to_boto_dict())

        return shapes.Volume.from_boto_dict(response)
    ...
    def create_vpc(
        ...
        *,
        ...
        amazon_provided_ipv6_cidr_block: bool = ShapeBase.NOT_SET,
        dry_run: bool = ShapeBase.NOT_SET,
        instance_tenancy: shapes.Tenancy = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_vpc(**_request.to_boto_dict())

        return shapes.CreateVpcResult.from_boto_dict(response)
    ...
    def create_vpc_endpoint(
        ...
        *,
        ...
        service_name: str,
        dry_run: bool = ShapeBase.NOT_SET,
        vpc_endpoint_type: shapes.VpcEndpointType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_vpc_endpoint(
            **_request.to_boto_dict()
        )

        return shapes.CreateVpcEndpointResult.from_boto_dict(response)
    ...
    def create_vpc_endpoint_connection_notification(
        ...
        *,
        ...
        return shapes.CreateVpcEndpointConnectionNotificationResult.from_boto_dict(
            response
        )
    ...
    def create_vpc_endpoint_service_configuration(
        ...
        *,
        ...
        return shapes.CreateVpcEndpointServiceConfigurationResult.from_boto_dict(
            response
        )
    ...
    def create_vpc_peering_connection(
        ...
        *,
        ...
        return shapes.CreateVpcPeeringConnectionResult.from_boto_dict(response)
    ...
    def create_vpn_connection(
        ...
        *,
        ...
        response = self._boto_client.create_vpn_connection(
            **_request.to_boto_dict()
        )

        return shapes.CreateVpnConnectionResult.from_boto_dict(response)
    ...
    def create_vpn_gateway(
        ...
        *,
        ...
        response = self._boto_client.create_vpn_gateway(
            **_request.to_boto_dict()
        )

        return shapes.CreateVpnGatewayResult.from_boto_dict(response)
    ...
    def delete_dhcp_options(
        ...
        *,
        ...
        response = self._boto_client.delete_dhcp_options(
            **_request.to_boto_dict()
        )
    ...
    def delete_egress_only_internet_gateway(
        ...
        *,
        ...
        return shapes.DeleteEgressOnlyInternetGatewayResult.from_boto_dict(
            response
        )
    ...
    def delete_fleets(
        ...
        *,
        ...
        response = self._boto_client.delete_fleets(**_request.to_boto_dict())

        return shapes.DeleteFleetsResult.from_boto_dict(response)
    ...
    def delete_flow_logs(
        ...
        *,
        ...
        response = self._boto_client.delete_flow_logs(**_request.to_boto_dict())

        return shapes.DeleteFlowLogsResult.from_boto_dict(response)
    ...
    def delete_fpga_image(
        ...
        *,
        ...
        response = self._boto_client.delete_fpga_image(
            **_request.to_boto_dict()
        )

        return shapes.DeleteFpgaImageResult.from_boto_dict(response)
    ...
    def delete_key_pair(
        ...
        *,
        ...
        response = self._boto_client.delete_key_pair(**_request.to_boto_dict())
    ...
    def delete_launch_template(
        ...
        *,
        ...
        return shapes.DeleteLaunchTemplateResult.from_boto_dict(response)
    ...
    def delete_launch_template_versions(
        ...
        *,
        ...
        return shapes.DeleteLaunchTemplateVersionsResult.from_boto_dict(
            response
        )
    ...
    def delete_nat_gateway(
        ...
        *,
        ...
        response = self._boto_client.delete_nat_gateway(
            **_request.to_boto_dict()
        )

        return shapes.DeleteNatGatewayResult.from_boto_dict(response)
    ...
    def delete_network_acl(
        ...
        *,
        ...
        response = self._boto_client.delete_network_acl(
            **_request.to_boto_dict()
        )
    ...
    def delete_network_interface_permission(
        ...
        *,
        ...
        return shapes.DeleteNetworkInterfacePermissionResult.from_boto_dict(
            response
        )
    ...
    def delete_route(
        ...
        *,
        ...
        response = self._boto_client.delete_route(**_request.to_boto_dict())
    ...
    def delete_route_table(
        ...
        *,
        ...
        response = self._boto_client.delete_route_table(
            **_request.to_boto_dict()
        )
    ...
    def delete_security_group(
        ...
        *,
        ...
        response = self._boto_client.delete_security_group(
            **_request.to_boto_dict()
        )
    ...
    def delete_snapshot(
        ...
        *,
        ...
        response = self._boto_client.delete_snapshot(**_request.to_boto_dict())
    ...
    def delete_subnet(
        ...
        *,
        ...
        response = self._boto_client.delete_subnet(**_request.to_boto_dict())
    ...
    def delete_volume(
        ...
        *,
        ...
        response = self._boto_client.delete_volume(**_request.to_boto_dict())
    ...
    def delete_vpc(
        ...
        *,
        ...
        response = self._boto_client.delete_vpc(**_request.to_boto_dict())
    ...
    def delete_vpc_endpoint_connection_notifications(
        ...
        *,
        ...
        return shapes.DeleteVpcEndpointConnectionNotificationsResult.from_boto_dict(
            response
        )
    ...
    def delete_vpc_endpoint_service_configurations(
        ...
        *,
        ...
        return shapes.DeleteVpcEndpointServiceConfigurationsResult.from_boto_dict(
            response
        )
    ...
    def delete_vpc_endpoints(
        ...
        *,
        ...
        response = self._boto_client.delete_vpc_endpoints(
            **_request.to_boto_dict()
        )

        return shapes.DeleteVpcEndpointsResult.from_boto_dict(response)
    ...
    def delete_vpc_peering_connection(
        ...
        *,
        ...
        return shapes.DeleteVpcPeeringConnectionResult.from_boto_dict(response)
    ...
    def delete_vpn_connection(
        ...
        *,
        ...
        response = self._boto_client.delete_vpn_connection(
            **_request.to_boto_dict()
        )
    ...
    def delete_vpn_gateway(
        ...
        *,
        ...
        response = self._boto_client.delete_vpn_gateway(
            **_request.to_boto_dict()
        )
    ...
    def deregister_image(
        ...
        *,
        ...
        response = self._boto_client.deregister_image(**_request.to_boto_dict())

    def describe_account_attributes(
        self,
        _request: shapes.DescribeAccountAttributesRequest = None,
        *,
        attribute_names: typing.List[shapes.AccountAttributeName
                                    ] = ShapeBase.NOT_SET,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeAccountAttributesResult.from_boto_dict(response)
    ...
    def describe_addresses(
        ...
        *,
        ...
        response = self._boto_client.describe_addresses(
            **_request.to_boto_dict()
        )

        return shapes.DescribeAddressesResult.from_boto_dict(response)
    ...
    def describe_aggregate_id_format(
        ...
        *,
        ...
        return shapes.DescribeAggregateIdFormatResult.from_boto_dict(response)
    ...
    def describe_availability_zones(
        ...
        *,
        ...
        return shapes.DescribeAvailabilityZonesResult.from_boto_dict(response)
    ...
    def describe_bundle_tasks(
        ...
        *,
        ...
        response = self._boto_client.describe_bundle_tasks(
            **_request.to_boto_dict()
        )

        return shapes.DescribeBundleTasksResult.from_boto_dict(response)
    ...
    def describe_classic_link_instances(
        ...
        *,
        ...
        return shapes.DescribeClassicLinkInstancesResult.from_boto_dict(
            response
        )
    ...
    def describe_conversion_tasks(
        ...
        *,
        ...
        return shapes.DescribeConversionTasksResult.from_boto_dict(response)
    ...
    def describe_customer_gateways(
        ...
        *,
        ...
        return shapes.DescribeCustomerGatewaysResult.from_boto_dict(response)
    ...
    def describe_dhcp_options(
        ...
        *,
        ...
        response = self._boto_client.describe_dhcp_options(
            **_request.to_boto_dict()
        )

        return shapes.DescribeDhcpOptionsResult.from_boto_dict(response)
    ...
    def describe_egress_only_internet_gateways(
        ...
        *,
        ...
        return shapes.DescribeEgressOnlyInternetGatewaysResult.from_boto_dict(
            response
        )
    ...
    def describe_elastic_gpus(
        ...
        *,
        ...
        response = self._boto_client.describe_elastic_gpus(
            **_request.to_boto_dict()
        )

        return shapes.DescribeElasticGpusResult.from_boto_dict(response)
    ...
    def describe_export_tasks(
        ...
        *,
        ...
        response = self._boto_client.describe_export_tasks(
            **_request.to_boto_dict()
        )

        return shapes.DescribeExportTasksResult.from_boto_dict(response)
    ...
    def describe_fleet_history(
        ...
        *,
        ...
        dry_run: bool = ShapeBase.NOT_SET,
        event_type: shapes.FleetEventType = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeFleetHistoryResult.from_boto_dict(response)
    ...
    def describe_fleet_instances(
        ...
        *,
        ...
        return shapes.DescribeFleetInstancesResult.from_boto_dict(response)
    ...
    def describe_fleets(
        ...
        *,
        ...
        response = self._boto_client.describe_fleets(**_request.to_boto_dict())

        return shapes.DescribeFleetsResult.from_boto_dict(response)
    ...
    def describe_flow_logs(
        ...
        *,
        ...
        response = self._boto_client.describe_flow_logs(
            **_request.to_boto_dict()
        )

        return shapes.DescribeFlowLogsResult.from_boto_dict(response)
    ...
    def describe_fpga_image_attribute(
        ...
        *,
        fpga_image_id: str,
        attribute: shapes.FpgaImageAttributeName,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeFpgaImageAttributeResult.from_boto_dict(response)
    ...
    def describe_fpga_images(
        ...
        *,
        ...
        response = self._boto_client.describe_fpga_images(
            **_request.to_boto_dict()
        )

        return shapes.DescribeFpgaImagesResult.from_boto_dict(response)
    ...
    def describe_host_reservation_offerings(
        ...
        *,
        ...
        return shapes.DescribeHostReservationOfferingsResult.from_boto_dict(
            response
        )
    ...
    def describe_host_reservations(
        ...
        *,
        ...
        return shapes.DescribeHostReservationsResult.from_boto_dict(response)
    ...
    def describe_hosts(
        ...
        *,
        ...
        response = self._boto_client.describe_hosts(**_request.to_boto_dict())

        return shapes.DescribeHostsResult.from_boto_dict(response)
    ...
    def describe_iam_instance_profile_associations(
        ...
        *,
        ...
        response = self._boto_client.describe_iam_instance_profile_associations(
            **_request.to_boto_dict()
        )

        return shapes.DescribeIamInstanceProfileAssociationsResult.from_boto_dict(
            response
        )
    ...
    def describe_id_format(
        ...
        *,
        ...
        response = self._boto_client.describe_id_format(
            **_request.to_boto_dict()
        )

        return shapes.DescribeIdFormatResult.from_boto_dict(response)
    ...
    def describe_identity_id_format(
        ...
        *,
        ...
        return shapes.DescribeIdentityIdFormatResult.from_boto_dict(response)

    def describe_image_attribute(
        self,
        _request: shapes.DescribeImageAttributeRequest = None,
        *,
        attribute: shapes.ImageAttributeName,
        image_id: str,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.ImageAttribute.from_boto_dict(response)
    ...
    def describe_images(
        ...
        *,
        ...
        response = self._boto_client.describe_images(**_request.to_boto_dict())

        return shapes.DescribeImagesResult.from_boto_dict(response)
    ...
    def describe_import_image_tasks(
        ...
        *,
        ...
        return shapes.DescribeImportImageTasksResult.from_boto_dict(response)
    ...
    def describe_import_snapshot_tasks(
        ...
        *,
        ...
        return shapes.DescribeImportSnapshotTasksResult.from_boto_dict(response)

    def describe_instance_attribute(
        self,
        _request: shapes.DescribeInstanceAttributeRequest = None,
        *,
        attribute: shapes.InstanceAttributeName,
        instance_id: str,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.InstanceAttribute.from_boto_dict(response)
    ...
    def describe_instance_credit_specifications(
        ...
        *,
        ...
        Amazon EC2 returns the credit option (`standard` or `unlimited`) of those
        instances. If you specify an instance ID that is not valid, such as an instance
        ...
        return shapes.DescribeInstanceCreditSpecificationsResult.from_boto_dict(
            response
        )
    ...
    def describe_instance_status(
        ...
        *,
        ...
        response = self._boto_client.describe_instance_status(
            **_request.to_boto_dict()
        )

        return shapes.DescribeInstanceStatusResult.from_boto_dict(response)
    ...
    def describe_instances(
        ...
        *,
        ...
        response = self._boto_client.describe_instances(
            **_request.to_boto_dict()
        )

        return shapes.DescribeInstancesResult.from_boto_dict(response)
    ...
    def describe_internet_gateways(
        ...
        *,
        ...
        return shapes.DescribeInternetGatewaysResult.from_boto_dict(response)
    ...
    def describe_key_pairs(
        ...
        *,
        ...
        response = self._boto_client.describe_key_pairs(
            **_request.to_boto_dict()
        )

        return shapes.DescribeKeyPairsResult.from_boto_dict(response)
    ...
    def describe_launch_template_versions(
        ...
        *,
        ...
        return shapes.DescribeLaunchTemplateVersionsResult.from_boto_dict(
            response
        )
    ...
    def describe_launch_templates(
        ...
        *,
        ...
        return shapes.DescribeLaunchTemplatesResult.from_boto_dict(response)
    ...
    def describe_moving_addresses(
        ...
        *,
        ...
        return shapes.DescribeMovingAddressesResult.from_boto_dict(response)
    ...
    def describe_nat_gateways(
        ...
        *,
        ...
        response = self._boto_client.describe_nat_gateways(
            **_request.to_boto_dict()
        )

        return shapes.DescribeNatGatewaysResult.from_boto_dict(response)
    ...
    def describe_network_acls(
        ...
        *,
        ...
        response = self._boto_client.describe_network_acls(
            **_request.to_boto_dict()
        )

        return shapes.DescribeNetworkAclsResult.from_boto_dict(response)
    ...
    def describe_network_interface_attribute(
        ...
        *,
        network_interface_id: str,
        attribute: shapes.NetworkInterfaceAttribute = ShapeBase.NOT_SET,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeNetworkInterfaceAttributeResult.from_boto_dict(
            response
        )
    ...
    def describe_network_interface_permissions(
        ...
        *,
        ...
        return shapes.DescribeNetworkInterfacePermissionsResult.from_boto_dict(
            response
        )
    ...
    def describe_network_interfaces(
        ...
        *,
        ...
        response = self._boto_client.describe_network_interfaces(
            **_request.to_boto_dict()
        )

        return shapes.DescribeNetworkInterfacesResult.from_boto_dict(response)
    ...
    def describe_placement_groups(
        ...
        *,
        ...
        return shapes.DescribePlacementGroupsResult.from_boto_dict(response)
    ...
    def describe_prefix_lists(
        ...
        *,
        ...
        response = self._boto_client.describe_prefix_lists(
            **_request.to_boto_dict()
        )

        return shapes.DescribePrefixListsResult.from_boto_dict(response)
    ...
    def describe_principal_id_format(
        ...
        *,
        ...
        return shapes.DescribePrincipalIdFormatResult.from_boto_dict(response)
    ...
    def describe_regions(
        ...
        *,
        ...
        response = self._boto_client.describe_regions(**_request.to_boto_dict())

        return shapes.DescribeRegionsResult.from_boto_dict(response)
    ...
    def describe_reserved_instances(
        ...
        *,
        filters: typing.List[shapes.Filter] = ShapeBase.NOT_SET,
        offering_class: shapes.OfferingClassType = ShapeBase.NOT_SET,
        reserved_instances_ids: typing.List[str] = ShapeBase.NOT_SET,
        dry_run: bool = ShapeBase.NOT_SET,
        offering_type: shapes.OfferingTypeValues = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeReservedInstancesResult.from_boto_dict(response)
    ...
    def describe_reserved_instances_listings(
        ...
        *,
        ...
        return shapes.DescribeReservedInstancesListingsResult.from_boto_dict(
            response
        )
    ...
    def describe_reserved_instances_modifications(
        ...
        *,
        filters: typing.List[shapes.Filter] = ShapeBase.NOT_SET,
        reserved_instances_modification_ids: typing.List[str
                                                        ] = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_reserved_instances_modifications(
            **_request.to_boto_dict()
        )

        return shapes.DescribeReservedInstancesModificationsResult.from_boto_dict(
            response
        )
    ...
    def describe_reserved_instances_offerings(
        ...
        *,
        ...
        min_duration: int = ShapeBase.NOT_SET,
        offering_class: shapes.OfferingClassType = ShapeBase.NOT_SET,
        product_description: shapes.RIProductDescription = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_reserved_instances_offerings(
            **_request.to_boto_dict()
        )

        return shapes.DescribeReservedInstancesOfferingsResult.from_boto_dict(
            response
        )
    ...
    def describe_route_tables(
        ...
        *,
        ...
        response = self._boto_client.describe_route_tables(
            **_request.to_boto_dict()
        )

        return shapes.DescribeRouteTablesResult.from_boto_dict(response)
    ...
    def describe_scheduled_instance_availability(
        ...
        *,
        ...
        return shapes.DescribeScheduledInstanceAvailabilityResult.from_boto_dict(
            response
        )
    ...
    def describe_scheduled_instances(
        ...
        *,
        ...
        return shapes.DescribeScheduledInstancesResult.from_boto_dict(response)
    ...
    def describe_security_group_references(
        ...
        *,
        ...
        return shapes.DescribeSecurityGroupReferencesResult.from_boto_dict(
            response
        )
    ...
    def describe_security_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_security_groups(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSecurityGroupsResult.from_boto_dict(response)

    def describe_snapshot_attribute(
        self,
        _request: shapes.DescribeSnapshotAttributeRequest = None,
        *,
        attribute: shapes.SnapshotAttributeName,
        snapshot_id: str,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeSnapshotAttributeResult.from_boto_dict(response)
    ...
    def describe_snapshots(
        ...
        *,
        ...
        response = self._boto_client.describe_snapshots(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSnapshotsResult.from_boto_dict(response)
    ...
    def describe_spot_datafeed_subscription(
        ...
        *,
        ...
        return shapes.DescribeSpotDatafeedSubscriptionResult.from_boto_dict(
            response
        )
    ...
    def describe_spot_fleet_instances(
        ...
        *,
        ...
        response = self._boto_client.describe_spot_fleet_instances(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSpotFleetInstancesResponse.from_boto_dict(
            response
        )
    ...
    def describe_spot_fleet_request_history(
        ...
        *,
        ...
        start_time: datetime.datetime,
        dry_run: bool = ShapeBase.NOT_SET,
        event_type: shapes.EventType = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeSpotFleetRequestHistoryResponse.from_boto_dict(
            response
        )
    ...
    def describe_spot_fleet_requests(
        ...
        *,
        ...
        response = self._boto_client.describe_spot_fleet_requests(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSpotFleetRequestsResponse.from_boto_dict(response)
    ...
    def describe_spot_instance_requests(
        ...
        *,
        ...
        return shapes.DescribeSpotInstanceRequestsResult.from_boto_dict(
            response
        )
    ...
    def describe_spot_price_history(
        ...
        *,
        ...
        instance_types: typing.List[shapes.InstanceType] = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_spot_price_history(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSpotPriceHistoryResult.from_boto_dict(response)
    ...
    def describe_stale_security_groups(
        ...
        *,
        ...
        return shapes.DescribeStaleSecurityGroupsResult.from_boto_dict(response)
    ...
    def describe_subnets(
        ...
        *,
        ...
        response = self._boto_client.describe_subnets(**_request.to_boto_dict())

        return shapes.DescribeSubnetsResult.from_boto_dict(response)
    ...
    def describe_tags(
        ...
        *,
        ...
        return shapes.DescribeTagsResult.from_boto_dict(response)

    def describe_volume_attribute(
        self,
        _request: shapes.DescribeVolumeAttributeRequest = None,
        *,
        attribute: shapes.VolumeAttributeName,
        volume_id: str,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeVolumeAttributeResult.from_boto_dict(response)
    ...
    def describe_volume_status(
        ...
        *,
        ...
        response = self._boto_client.describe_volume_status(
            **_request.to_boto_dict()
        )

        return shapes.DescribeVolumeStatusResult.from_boto_dict(response)
    ...
    def describe_volumes(
        ...
        *,
        ...
        response = self._boto_client.describe_volumes(**_request.to_boto_dict())

        return shapes.DescribeVolumesResult.from_boto_dict(response)
    ...
    def describe_volumes_modifications(
        ...
        *,
        ...
        return shapes.DescribeVolumesModificationsResult.from_boto_dict(
            response
        )
    ...
    def describe_vpc_attribute(
        ...
        *,
        attribute: shapes.VpcAttributeName,
        vpc_id: str,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeVpcAttributeResult.from_boto_dict(response)
    ...
    def describe_vpc_classic_link(
        ...
        *,
        ...
        return shapes.DescribeVpcClassicLinkResult.from_boto_dict(response)
    ...
    def describe_vpc_classic_link_dns_support(
        ...
        *,
        ...
        return shapes.DescribeVpcClassicLinkDnsSupportResult.from_boto_dict(
            response
        )
    ...
    def describe_vpc_endpoint_connection_notifications(
        ...
        *,
        ...
        return shapes.DescribeVpcEndpointConnectionNotificationsResult.from_boto_dict(
            response
        )
    ...
    def describe_vpc_endpoint_connections(
        ...
        *,
        ...
        return shapes.DescribeVpcEndpointConnectionsResult.from_boto_dict(
            response
        )
    ...
    def describe_vpc_endpoint_service_configurations(
        ...
        *,
        ...
        return shapes.DescribeVpcEndpointServiceConfigurationsResult.from_boto_dict(
            response
        )
    ...
    def describe_vpc_endpoint_service_permissions(
        ...
        *,
        ...
        return shapes.DescribeVpcEndpointServicePermissionsResult.from_boto_dict(
            response
        )
    ...
    def describe_vpc_endpoint_services(
        ...
        *,
        ...
        return shapes.DescribeVpcEndpointServicesResult.from_boto_dict(response)
    ...
    def describe_vpc_endpoints(
        ...
        *,
        ...
        return shapes.DescribeVpcEndpointsResult.from_boto_dict(response)
    ...
    def describe_vpc_peering_connections(
        ...
        *,
        ...
        return shapes.DescribeVpcPeeringConnectionsResult.from_boto_dict(
            response
        )
    ...
    def describe_vpcs(
        ...
        *,
        ...
        response = self._boto_client.describe_vpcs(**_request.to_boto_dict())

        return shapes.DescribeVpcsResult.from_boto_dict(response)
    ...
    def describe_vpn_connections(
        ...
        *,
        ...
        return shapes.DescribeVpnConnectionsResult.from_boto_dict(response)
    ...
    def describe_vpn_gateways(
        ...
        *,
        ...
        response = self._boto_client.describe_vpn_gateways(
            **_request.to_boto_dict()
        )

        return shapes.DescribeVpnGatewaysResult.from_boto_dict(response)
    ...
    def detach_classic_link_vpc(
        ...
        *,
        ...
        return shapes.DetachClassicLinkVpcResult.from_boto_dict(response)
    ...
    def detach_volume(
        ...
        *,
        ...
        response = self._boto_client.detach_volume(**_request.to_boto_dict())
    ...
    def detach_vpn_gateway(
        ...
        *,
        ...
        response = self._boto_client.detach_vpn_gateway(
            **_request.to_boto_dict()
        )
    ...
    def disable_vpc_classic_link(
        ...
        *,
        ...
        return shapes.DisableVpcClassicLinkResult.from_boto_dict(response)
    ...
    def disable_vpc_classic_link_dns_support(
        ...
        *,
        ...
        return shapes.DisableVpcClassicLinkDnsSupportResult.from_boto_dict(
            response
        )
    ...
    def disassociate_address(
        ...
        *,
        ...
        response = self._boto_client.disassociate_address(
            **_request.to_boto_dict()
        )
    ...
    def disassociate_iam_instance_profile(
        ...
        *,
        ...
        return shapes.DisassociateIamInstanceProfileResult.from_boto_dict(
            response
        )
    ...
    def disassociate_subnet_cidr_block(
        ...
        *,
        ...
        return shapes.DisassociateSubnetCidrBlockResult.from_boto_dict(response)
    ...
    def disassociate_vpc_cidr_block(
        ...
        *,
        ...
        return shapes.DisassociateVpcCidrBlockResult.from_boto_dict(response)
    ...
    def enable_volume_io(
        ...
        *,
        ...
        response = self._boto_client.enable_volume_io(**_request.to_boto_dict())
    ...
    def enable_vpc_classic_link(
        ...
        *,
        ...
        return shapes.EnableVpcClassicLinkResult.from_boto_dict(response)
    ...
    def enable_vpc_classic_link_dns_support(
        ...
        *,
        ...
        return shapes.EnableVpcClassicLinkDnsSupportResult.from_boto_dict(
            response
        )
    ...
    def get_console_output(
        ...
        *,
        ...
        response = self._boto_client.get_console_output(
            **_request.to_boto_dict()
        )

        return shapes.GetConsoleOutputResult.from_boto_dict(response)
    ...
    def get_console_screenshot(
        ...
        *,
        ...
        return shapes.GetConsoleScreenshotResult.from_boto_dict(response)
    ...
    def get_host_reservation_purchase_preview(
        ...
        *,
        ...
        return shapes.GetHostReservationPurchasePreviewResult.from_boto_dict(
            response
        )
    ...
    def get_launch_template_data(
        ...
        *,
        ...
        return shapes.GetLaunchTemplateDataResult.from_boto_dict(response)
    ...
    def get_password_data(
        ...
        *,
        ...
        response = self._boto_client.get_password_data(
            **_request.to_boto_dict()
        )

        return shapes.GetPasswordDataResult.from_boto_dict(response)
    ...
    def get_reserved_instances_exchange_quote(
        ...
        *,
        ...
        return shapes.GetReservedInstancesExchangeQuoteResult.from_boto_dict(
            response
        )
    ...
    def import_image(
        ...
        *,
        ...
        response = self._boto_client.import_image(**_request.to_boto_dict())

        return shapes.ImportImageResult.from_boto_dict(response)

    def import_instance(
        self,
        _request: shapes.ImportInstanceRequest = None,
        *,
        platform: shapes.PlatformValues,
        description: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.import_instance(**_request.to_boto_dict())

        return shapes.ImportInstanceResult.from_boto_dict(response)
    ...
    def import_key_pair(
        ...
        *,
        ...
        response = self._boto_client.import_key_pair(**_request.to_boto_dict())

        return shapes.ImportKeyPairResult.from_boto_dict(response)
    ...
    def import_snapshot(
        ...
        *,
        ...
        response = self._boto_client.import_snapshot(**_request.to_boto_dict())

        return shapes.ImportSnapshotResult.from_boto_dict(response)
    ...
    def import_volume(
        ...
        *,
        ...
        response = self._boto_client.import_volume(**_request.to_boto_dict())

        return shapes.ImportVolumeResult.from_boto_dict(response)
    ...
    def modify_fleet(
        ...
        *,
        ...
        response = self._boto_client.modify_fleet(**_request.to_boto_dict())

        return shapes.ModifyFleetResult.from_boto_dict(response)
    ...
    def modify_fpga_image_attribute(
        ...
        *,
        fpga_image_id: str,
        dry_run: bool = ShapeBase.NOT_SET,
        attribute: shapes.FpgaImageAttributeName = ShapeBase.NOT_SET,
        operation_type: shapes.OperationType = ShapeBase.NOT_SET,
        ...
        return shapes.ModifyFpgaImageAttributeResult.from_boto_dict(response)

    def modify_hosts(
        self,
        _request: shapes.ModifyHostsRequest = None,
        *,
        auto_placement: shapes.AutoPlacement,
        ...
        provide a host ID ito have the instance launch onto a specific host. If no host
        ...
        response = self._boto_client.modify_hosts(**_request.to_boto_dict())

        return shapes.ModifyHostsResult.from_boto_dict(response)
    ...
    def modify_id_format(
        ...
        *,
        ...
        response = self._boto_client.modify_id_format(**_request.to_boto_dict())
    ...
    def modify_instance_attribute(
        ...
        *,
        ...
        attribute: shapes.InstanceAttributeName = ShapeBase.NOT_SET,
        block_device_mappings: typing.List[
            shapes.InstanceBlockDeviceMappingSpecification
        ] = ShapeBase.NOT_SET,
    ...
    def modify_instance_credit_specification(
        ...
        *,
        ...
        return shapes.ModifyInstanceCreditSpecificationResult.from_boto_dict(
            response
        )
    ...
    def modify_instance_placement(
        ...
        *,
        instance_id: str,
        affinity: shapes.Affinity = ShapeBase.NOT_SET,
        group_name: str = ShapeBase.NOT_SET,
        host_id: str = ShapeBase.NOT_SET,
        tenancy: shapes.HostTenancy = ShapeBase.NOT_SET,
        ...
        return shapes.ModifyInstancePlacementResult.from_boto_dict(response)
    ...
    def modify_launch_template(
        ...
        *,
        ...
        return shapes.ModifyLaunchTemplateResult.from_boto_dict(response)
    ...
    def modify_reserved_instances(
        ...
        *,
        ...
        return shapes.ModifyReservedInstancesResult.from_boto_dict(response)
    ...
    def modify_snapshot_attribute(
        ...
        *,
        snapshot_id: str,
        attribute: shapes.SnapshotAttributeName = ShapeBase.NOT_SET,
    ...
    def modify_spot_fleet_request(
        ...
        *,
        spot_fleet_request_id: str,
        excess_capacity_termination_policy: shapes.
        ExcessCapacityTerminationPolicy = ShapeBase.NOT_SET,
        ...
        return shapes.ModifySpotFleetRequestResponse.from_boto_dict(response)
    ...
    def modify_volume(
        ...
        *,
        ...
        response = self._boto_client.modify_volume(**_request.to_boto_dict())

        return shapes.ModifyVolumeResult.from_boto_dict(response)
    ...
    def modify_vpc_attribute(
        ...
        *,
        ...
        response = self._boto_client.modify_vpc_attribute(
            **_request.to_boto_dict()
        )
    ...
    def modify_vpc_endpoint(
        ...
        *,
        ...
        response = self._boto_client.modify_vpc_endpoint(
            **_request.to_boto_dict()
        )

        return shapes.ModifyVpcEndpointResult.from_boto_dict(response)
    ...
    def modify_vpc_endpoint_connection_notification(
        ...
        *,
        ...
        return shapes.ModifyVpcEndpointConnectionNotificationResult.from_boto_dict(
            response
        )
    ...
    def modify_vpc_endpoint_service_configuration(
        ...
        *,
        ...
        return shapes.ModifyVpcEndpointServiceConfigurationResult.from_boto_dict(
            response
        )
    ...
    def modify_vpc_endpoint_service_permissions(
        ...
        *,
        ...
        return shapes.ModifyVpcEndpointServicePermissionsResult.from_boto_dict(
            response
        )
    ...
    def modify_vpc_peering_connection_options(
        ...
        *,
        ...
        return shapes.ModifyVpcPeeringConnectionOptionsResult.from_boto_dict(
            response
        )
    ...
    def modify_vpc_tenancy(
        ...
        *,
        vpc_id: str,
        instance_tenancy: shapes.VpcTenancy,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.modify_vpc_tenancy(
            **_request.to_boto_dict()
        )

        return shapes.ModifyVpcTenancyResult.from_boto_dict(response)
    ...
    def monitor_instances(
        ...
        *,
        ...
        response = self._boto_client.monitor_instances(
            **_request.to_boto_dict()
        )

        return shapes.MonitorInstancesResult.from_boto_dict(response)
    ...
    def move_address_to_vpc(
        ...
        *,
        ...
        response = self._boto_client.move_address_to_vpc(
            **_request.to_boto_dict()
        )

        return shapes.MoveAddressToVpcResult.from_boto_dict(response)
    ...
    def purchase_host_reservation(
        ...
        *,
        ...
        offering_id: str,
        client_token: str = ShapeBase.NOT_SET,
        currency_code: shapes.CurrencyCodeValues = ShapeBase.NOT_SET,
        ...
        return shapes.PurchaseHostReservationResult.from_boto_dict(response)
    ...
    def purchase_reserved_instances_offering(
        ...
        *,
        ...
        return shapes.PurchaseReservedInstancesOfferingResult.from_boto_dict(
            response
        )
    ...
    def purchase_scheduled_instances(
        ...
        *,
        ...
        return shapes.PurchaseScheduledInstancesResult.from_boto_dict(response)
    ...
    def reboot_instances(
        ...
        *,
        ...
        response = self._boto_client.reboot_instances(**_request.to_boto_dict())
    ...
    def register_image(
        ...
        *,
        ...
        architecture: shapes.ArchitectureValues = ShapeBase.NOT_SET,
        block_device_mappings: typing.List[shapes.BlockDeviceMapping
                                          ] = ShapeBase.NOT_SET,
        description: str = ShapeBase.NOT_SET,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.register_image(**_request.to_boto_dict())

        return shapes.RegisterImageResult.from_boto_dict(response)
    ...
    def reject_vpc_endpoint_connections(
        ...
        *,
        ...
        return shapes.RejectVpcEndpointConnectionsResult.from_boto_dict(
            response
        )
    ...
    def reject_vpc_peering_connection(
        ...
        *,
        ...
        return shapes.RejectVpcPeeringConnectionResult.from_boto_dict(response)
    ...
    def release_address(
        ...
        *,
        ...
        response = self._boto_client.release_address(**_request.to_boto_dict())
    ...
    def release_hosts(
        ...
        *,
        ...
        another request, for example, ModifyHosts. You must stop or terminate all
        ...
        response = self._boto_client.release_hosts(**_request.to_boto_dict())

        return shapes.ReleaseHostsResult.from_boto_dict(response)
    ...
    def replace_iam_instance_profile_association(
        ...
        *,
        ...
        return shapes.ReplaceIamInstanceProfileAssociationResult.from_boto_dict(
            response
        )
    ...
    def replace_network_acl_association(
        ...
        *,
        ...
        return shapes.ReplaceNetworkAclAssociationResult.from_boto_dict(
            response
        )
    ...
    def replace_route(
        ...
        *,
        ...
        response = self._boto_client.replace_route(**_request.to_boto_dict())
    ...
    def replace_route_table_association(
        ...
        *,
        ...
        return shapes.ReplaceRouteTableAssociationResult.from_boto_dict(
            response
        )
    ...
    def report_instance_status(
        ...
        *,
        ...
        reason_codes: typing.List[shapes.ReportInstanceReasonCodes],
        status: shapes.ReportStatusType,
        description: str = ShapeBase.NOT_SET,
        dry_run: bool = ShapeBase.NOT_SET,
        end_time: datetime.datetime = ShapeBase.NOT_SET,
        start_time: datetime.datetime = ShapeBase.NOT_SET,
    ...
    def request_spot_fleet(
        ...
        *,
        ...
        response = self._boto_client.request_spot_fleet(
            **_request.to_boto_dict()
        )

        return shapes.RequestSpotFleetResponse.from_boto_dict(response)
    ...
    def request_spot_instances(
        ...
        *,
        ...
        type: shapes.SpotInstanceType = ShapeBase.NOT_SET,
        valid_from: datetime.datetime = ShapeBase.NOT_SET,
        valid_until: datetime.datetime = ShapeBase.NOT_SET,
        instance_interruption_behavior: shapes.
        InstanceInterruptionBehavior = ShapeBase.NOT_SET,
        ...
        return shapes.RequestSpotInstancesResult.from_boto_dict(response)
    ...
    def reset_fpga_image_attribute(
        ...
        *,
        fpga_image_id: str,
        dry_run: bool = ShapeBase.NOT_SET,
        attribute: shapes.ResetFpgaImageAttributeName = ShapeBase.NOT_SET,
        ...
        return shapes.ResetFpgaImageAttributeResult.from_boto_dict(response)

    def reset_image_attribute(
        self,
        _request: shapes.ResetImageAttributeRequest = None,
        *,
        attribute: shapes.ResetImageAttributeName,
        image_id: str,
        dry_run: bool = ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        response = self._boto_client.reset_image_attribute(
            **_request.to_boto_dict()
        )
    ...
    def restore_address_to_classic(
        ...
        *,
        ...
        return shapes.RestoreAddressToClassicResult.from_boto_dict(response)
    ...
    def run_instances(
        ...
        *,
        ...
        instance_initiated_shutdown_behavior: shapes.
        ShutdownBehavior = ShapeBase.NOT_SET,
        network_interfaces: typing.List[
            shapes.InstanceNetworkInterfaceSpecification
        ] = ShapeBase.NOT_SET,
        private_ip_address: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.run_instances(**_request.to_boto_dict())

        return shapes.Reservation.from_boto_dict(response)
    ...
    def run_scheduled_instances(
        ...
        *,
        ...
        return shapes.RunScheduledInstancesResult.from_boto_dict(response)
    ...
    def start_instances(
        ...
        *,
        ...
        response = self._boto_client.start_instances(**_request.to_boto_dict())

        return shapes.StartInstancesResult.from_boto_dict(response)
    ...
    def stop_instances(
        ...
        *,
        ...
        response = self._boto_client.stop_instances(**_request.to_boto_dict())

        return shapes.StopInstancesResult.from_boto_dict(response)
    ...
    def terminate_instances(
        ...
        *,
        ...
        response = self._boto_client.terminate_instances(
            **_request.to_boto_dict()
        )

        return shapes.TerminateInstancesResult.from_boto_dict(response)
    ...
    def unassign_ipv6_addresses(
        ...
        *,
        ...
        return shapes.UnassignIpv6AddressesResult.from_boto_dict(response)
    ...
    def unmonitor_instances(
        ...
        *,
        ...
        response = self._boto_client.unmonitor_instances(
            **_request.to_boto_dict()
        )

        return shapes.UnmonitorInstancesResult.from_boto_dict(response)
    ...
    def update_security_group_rule_descriptions_egress(
        ...
        *,
        ...
        return shapes.UpdateSecurityGroupRuleDescriptionsEgressResult.from_boto_dict(
            response
        )
    ...
    def update_security_group_rule_descriptions_ingress(
        ...
        *,
        ...
        return shapes.UpdateSecurityGroupRuleDescriptionsIngressResult.from_boto_dict(
            response
        )
