...
class Hits(ShapeBase):
    ...
    hit: typing.List["Hit"] = dataclasses.field(default_factory=list, )
...
class SearchRequest(ShapeBase):
    ...
    query_parser: "QueryParser" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class SearchResponse(OutputShapeBase):
    ...
    status: "SearchStatus" = dataclasses.field(default_factory=dict, )

    # The documents that match the search criteria.
    hits: "Hits" = dataclasses.field(default_factory=dict, )
...
class SuggestResponse(OutputShapeBase):
    ...
    status: "SuggestStatus" = dataclasses.field(default_factory=dict, )

    # Container for the matching search suggestion information.
    suggest: "SuggestModel" = dataclasses.field(default_factory=dict, )
