...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("ses", *args, **kwargs)
    ...
    def clone_receipt_rule_set(
        ...
        *,
        ...
        return shapes.CloneReceiptRuleSetResponse.from_boto_dict(response)
    ...
    def create_configuration_set(
        ...
        *,
        ...
        return shapes.CreateConfigurationSetResponse.from_boto_dict(response)
    ...
    def create_configuration_set_event_destination(
        ...
        *,
        ...
        return shapes.CreateConfigurationSetEventDestinationResponse.from_boto_dict(
            response
        )
    ...
    def create_configuration_set_tracking_options(
        ...
        *,
        ...
        return shapes.CreateConfigurationSetTrackingOptionsResponse.from_boto_dict(
            response
        )
    ...
    def create_receipt_filter(
        ...
        *,
        ...
        response = self._boto_client.create_receipt_filter(
            **_request.to_boto_dict()
        )

        return shapes.CreateReceiptFilterResponse.from_boto_dict(response)
    ...
    def create_receipt_rule(
        ...
        *,
        ...
        response = self._boto_client.create_receipt_rule(
            **_request.to_boto_dict()
        )

        return shapes.CreateReceiptRuleResponse.from_boto_dict(response)
    ...
    def create_receipt_rule_set(
        ...
        *,
        ...
        return shapes.CreateReceiptRuleSetResponse.from_boto_dict(response)
    ...
    def create_template(
        ...
        *,
        ...
        response = self._boto_client.create_template(**_request.to_boto_dict())

        return shapes.CreateTemplateResponse.from_boto_dict(response)
    ...
    def delete_configuration_set(
        ...
        *,
        ...
        return shapes.DeleteConfigurationSetResponse.from_boto_dict(response)
    ...
    def delete_configuration_set_event_destination(
        ...
        *,
        ...
        return shapes.DeleteConfigurationSetEventDestinationResponse.from_boto_dict(
            response
        )
    ...
    def delete_configuration_set_tracking_options(
        ...
        *,
        ...
        return shapes.DeleteConfigurationSetTrackingOptionsResponse.from_boto_dict(
            response
        )
    ...
    def delete_identity(
        ...
        *,
        ...
        response = self._boto_client.delete_identity(**_request.to_boto_dict())

        return shapes.DeleteIdentityResponse.from_boto_dict(response)
    ...
    def delete_identity_policy(
        ...
        *,
        ...
        return shapes.DeleteIdentityPolicyResponse.from_boto_dict(response)
    ...
    def delete_receipt_filter(
        ...
        *,
        ...
        response = self._boto_client.delete_receipt_filter(
            **_request.to_boto_dict()
        )

        return shapes.DeleteReceiptFilterResponse.from_boto_dict(response)
    ...
    def delete_receipt_rule(
        ...
        *,
        ...
        response = self._boto_client.delete_receipt_rule(
            **_request.to_boto_dict()
        )

        return shapes.DeleteReceiptRuleResponse.from_boto_dict(response)
    ...
    def delete_receipt_rule_set(
        ...
        *,
        ...
        return shapes.DeleteReceiptRuleSetResponse.from_boto_dict(response)
    ...
    def delete_template(
        ...
        *,
        ...
        response = self._boto_client.delete_template(**_request.to_boto_dict())

        return shapes.DeleteTemplateResponse.from_boto_dict(response)
    ...
    def describe_active_receipt_rule_set(
        ...
        return shapes.DescribeActiveReceiptRuleSetResponse.from_boto_dict(
            response
        )
    ...
    def describe_configuration_set(
        ...
        *,
        ...
        configuration_set_attribute_names: typing.List[
            shapes.ConfigurationSetAttribute
        ] = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeConfigurationSetResponse.from_boto_dict(response)
    ...
    def describe_receipt_rule(
        ...
        *,
        ...
        response = self._boto_client.describe_receipt_rule(
            **_request.to_boto_dict()
        )

        return shapes.DescribeReceiptRuleResponse.from_boto_dict(response)
    ...
    def describe_receipt_rule_set(
        ...
        *,
        ...
        return shapes.DescribeReceiptRuleSetResponse.from_boto_dict(response)
    ...
    def get_account_sending_enabled(
        ...
        return shapes.GetAccountSendingEnabledResponse.from_boto_dict(response)
    ...
    def get_custom_verification_email_template(
        ...
        *,
        ...
        return shapes.GetCustomVerificationEmailTemplateResponse.from_boto_dict(
            response
        )
    ...
    def get_identity_dkim_attributes(
        ...
        *,
        ...
        return shapes.GetIdentityDkimAttributesResponse.from_boto_dict(response)
    ...
    def get_identity_mail_from_domain_attributes(
        ...
        *,
        ...
        return shapes.GetIdentityMailFromDomainAttributesResponse.from_boto_dict(
            response
        )
    ...
    def get_identity_notification_attributes(
        ...
        *,
        ...
        return shapes.GetIdentityNotificationAttributesResponse.from_boto_dict(
            response
        )
    ...
    def get_identity_policies(
        ...
        *,
        ...
        response = self._boto_client.get_identity_policies(
            **_request.to_boto_dict()
        )

        return shapes.GetIdentityPoliciesResponse.from_boto_dict(response)
    ...
    def get_identity_verification_attributes(
        ...
        *,
        ...
        return shapes.GetIdentityVerificationAttributesResponse.from_boto_dict(
            response
        )
    ...
    def get_send_quota(self) -> shapes.GetSendQuotaResponse:
        ...
        return shapes.GetSendQuotaResponse.from_boto_dict(response)
    ...
    def get_send_statistics(self, ) -> shapes.GetSendStatisticsResponse:
        ...
        return shapes.GetSendStatisticsResponse.from_boto_dict(response)
    ...
    def get_template(
        ...
        *,
        ...
        response = self._boto_client.get_template(**_request.to_boto_dict())

        return shapes.GetTemplateResponse.from_boto_dict(response)
    ...
    def list_configuration_sets(
        ...
        *,
        ...
        return shapes.ListConfigurationSetsResponse.from_boto_dict(response)
    ...
    def list_custom_verification_email_templates(
        ...
        *,
        ...
        response = self._boto_client.list_custom_verification_email_templates(
            **_request.to_boto_dict()
        )

        return shapes.ListCustomVerificationEmailTemplatesResponse.from_boto_dict(
            response
        )
    ...
    def list_identities(
        ...
        *,
        identity_type: shapes.IdentityType = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        max_items: int = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_identities(**_request.to_boto_dict())

        return shapes.ListIdentitiesResponse.from_boto_dict(response)
    ...
    def list_identity_policies(
        ...
        *,
        ...
        return shapes.ListIdentityPoliciesResponse.from_boto_dict(response)
    ...
    def list_receipt_filters(
        ...
        response = self._boto_client.list_receipt_filters(
            **_request.to_boto_dict()
        )

        return shapes.ListReceiptFiltersResponse.from_boto_dict(response)
    ...
    def list_receipt_rule_sets(
        ...
        *,
        ...
        return shapes.ListReceiptRuleSetsResponse.from_boto_dict(response)
    ...
    def list_templates(
        ...
        *,
        ...
        response = self._boto_client.list_templates(**_request.to_boto_dict())

        return shapes.ListTemplatesResponse.from_boto_dict(response)
    ...
    def list_verified_email_addresses(
        ...
        return shapes.ListVerifiedEmailAddressesResponse.from_boto_dict(
            response
        )
    ...
    def put_identity_policy(
        ...
        *,
        ...
        response = self._boto_client.put_identity_policy(
            **_request.to_boto_dict()
        )

        return shapes.PutIdentityPolicyResponse.from_boto_dict(response)
    ...
    def reorder_receipt_rule_set(
        ...
        *,
        ...
        return shapes.ReorderReceiptRuleSetResponse.from_boto_dict(response)
    ...
    def send_bounce(
        ...
        *,
        ...
        response = self._boto_client.send_bounce(**_request.to_boto_dict())

        return shapes.SendBounceResponse.from_boto_dict(response)
    ...
    def send_bulk_templated_email(
        ...
        *,
        ...
        return shapes.SendBulkTemplatedEmailResponse.from_boto_dict(response)
    ...
    def send_custom_verification_email(
        ...
        *,
        ...
        return shapes.SendCustomVerificationEmailResponse.from_boto_dict(
            response
        )
    ...
    def send_email(
        ...
        *,
        ...
        response = self._boto_client.send_email(**_request.to_boto_dict())

        return shapes.SendEmailResponse.from_boto_dict(response)
    ...
    def send_raw_email(
        ...
        *,
        ...
        `SendRawEmail` operation is particularly useful for sending multipart MIME
        ...
        response = self._boto_client.send_raw_email(**_request.to_boto_dict())

        return shapes.SendRawEmailResponse.from_boto_dict(response)
    ...
    def send_templated_email(
        ...
        *,
        ...
        response = self._boto_client.send_templated_email(
            **_request.to_boto_dict()
        )

        return shapes.SendTemplatedEmailResponse.from_boto_dict(response)
    ...
    def set_active_receipt_rule_set(
        ...
        *,
        ...
        return shapes.SetActiveReceiptRuleSetResponse.from_boto_dict(response)
    ...
    def set_identity_dkim_enabled(
        ...
        *,
        ...
        return shapes.SetIdentityDkimEnabledResponse.from_boto_dict(response)
    ...
    def set_identity_feedback_forwarding_enabled(
        ...
        *,
        ...
        return shapes.SetIdentityFeedbackForwardingEnabledResponse.from_boto_dict(
            response
        )
    ...
    def set_identity_headers_in_notifications_enabled(
        ...
        *,
        identity: str,
        notification_type: shapes.NotificationType,
        enabled: bool,
        ...
        return shapes.SetIdentityHeadersInNotificationsEnabledResponse.from_boto_dict(
            response
        )
    ...
    def set_identity_mail_from_domain(
        ...
        *,
        ...
        behavior_on_mx_failure: shapes.BehaviorOnMXFailure = ShapeBase.NOT_SET,
        ...
        return shapes.SetIdentityMailFromDomainResponse.from_boto_dict(response)
    ...
    def set_identity_notification_topic(
        ...
        *,
        ...
        return shapes.SetIdentityNotificationTopicResponse.from_boto_dict(
            response
        )
    ...
    def set_receipt_rule_position(
        ...
        *,
        ...
        return shapes.SetReceiptRulePositionResponse.from_boto_dict(response)
    ...
    def test_render_template(
        ...
        *,
        ...
        response = self._boto_client.test_render_template(
            **_request.to_boto_dict()
        )

        return shapes.TestRenderTemplateResponse.from_boto_dict(response)
    ...
    def update_configuration_set_event_destination(
        ...
        *,
        ...
        return shapes.UpdateConfigurationSetEventDestinationResponse.from_boto_dict(
            response
        )
    ...
    def update_configuration_set_tracking_options(
        ...
        *,
        ...
        return shapes.UpdateConfigurationSetTrackingOptionsResponse.from_boto_dict(
            response
        )
    ...
    def update_receipt_rule(
        ...
        *,
        ...
        response = self._boto_client.update_receipt_rule(
            **_request.to_boto_dict()
        )

        return shapes.UpdateReceiptRuleResponse.from_boto_dict(response)
    ...
    def update_template(
        ...
        *,
        ...
        response = self._boto_client.update_template(**_request.to_boto_dict())

        return shapes.UpdateTemplateResponse.from_boto_dict(response)
    ...
    def verify_domain_dkim(
        ...
        *,
        ...
        response = self._boto_client.verify_domain_dkim(
            **_request.to_boto_dict()
        )

        return shapes.VerifyDomainDkimResponse.from_boto_dict(response)
    ...
    def verify_domain_identity(
        ...
        *,
        ...
        return shapes.VerifyDomainIdentityResponse.from_boto_dict(response)
    ...
    def verify_email_address(
        ...
        *,
        ...
        response = self._boto_client.verify_email_address(
            **_request.to_boto_dict()
        )
    ...
    def verify_email_identity(
        ...
        *,
        ...
        response = self._boto_client.verify_email_identity(
            **_request.to_boto_dict()
        )

        return shapes.VerifyEmailIdentityResponse.from_boto_dict(response)
