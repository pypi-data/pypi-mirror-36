...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("devicefarm", *args, **kwargs)
    ...
    def get_offering_status(
        ...
        *,
        ...
        response = self._boto_client.get_offering_status(
            **_request.to_boto_dict()
        )
    ...
    def list_artifacts(
        ...
        *,
        ...
        response = self._boto_client.list_artifacts(**_request.to_boto_dict())
    ...
    def list_device_pools(
        ...
        *,
        ...
        response = self._boto_client.list_device_pools(
            **_request.to_boto_dict()
        )
    ...
    def list_offering_transactions(
        ...
        *,
        ...
        response = self._boto_client.list_offering_transactions(
            **_request.to_boto_dict()
        )
    ...
    def list_offerings(
        ...
        *,
        ...
        response = self._boto_client.list_offerings(**_request.to_boto_dict())
    ...
    def list_projects(
        ...
        *,
        ...
        response = self._boto_client.list_projects(**_request.to_boto_dict())
    ...
    def list_runs(
        ...
        *,
        ...
        response = self._boto_client.list_runs(**_request.to_boto_dict())
    ...
    def list_samples(
        ...
        *,
        ...
        response = self._boto_client.list_samples(**_request.to_boto_dict())
    ...
    def list_suites(
        ...
        *,
        ...
        response = self._boto_client.list_suites(**_request.to_boto_dict())
    ...
    def list_tests(
        ...
        *,
        ...
        response = self._boto_client.list_tests(**_request.to_boto_dict())
    ...
    def list_unique_problems(
        ...
        *,
        ...
        response = self._boto_client.list_unique_problems(
            **_request.to_boto_dict()
        )
    ...
    def list_uploads(
        ...
        *,
        ...
        response = self._boto_client.list_uploads(**_request.to_boto_dict())
