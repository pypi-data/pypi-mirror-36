...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("ds", *args, **kwargs)
    ...
    def add_ip_routes(
        ...
        *,
        ...
        response = self._boto_client.add_ip_routes(**_request.to_boto_dict())

        return shapes.AddIpRoutesResult.from_boto_dict(response)
    ...
    def cancel_schema_extension(
        ...
        *,
        ...
        return shapes.CancelSchemaExtensionResult.from_boto_dict(response)
    ...
    def connect_directory(
        ...
        *,
        ...
        response = self._boto_client.connect_directory(
            **_request.to_boto_dict()
        )

        return shapes.ConnectDirectoryResult.from_boto_dict(response)
    ...
    def create_alias(
        ...
        *,
        ...
        return shapes.CreateAliasResult.from_boto_dict(response)
    ...
    def create_computer(
        ...
        *,
        ...
        response = self._boto_client.create_computer(**_request.to_boto_dict())

        return shapes.CreateComputerResult.from_boto_dict(response)
    ...
    def create_conditional_forwarder(
        ...
        *,
        ...
        return shapes.CreateConditionalForwarderResult.from_boto_dict(response)
    ...
    def create_directory(
        ...
        *,
        ...
        return shapes.CreateDirectoryResult.from_boto_dict(response)
    ...
    def create_microsoft_ad(
        ...
        *,
        ...
        short_name: str = ShapeBase.NOT_SET,
        description: str = ShapeBase.NOT_SET,
        edition: shapes.DirectoryEdition = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_microsoft_ad(
            **_request.to_boto_dict()
        )

        return shapes.CreateMicrosoftADResult.from_boto_dict(response)
    ...
    def create_snapshot(
        ...
        *,
        ...
        return shapes.CreateSnapshotResult.from_boto_dict(response)
    ...
    def create_trust(
        ...
        *,
        ...
        remote_domain_name: str,
        trust_password: str,
        trust_direction: shapes.TrustDirection,
        trust_type: shapes.TrustType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_trust(**_request.to_boto_dict())

        return shapes.CreateTrustResult.from_boto_dict(response)
    ...
    def delete_conditional_forwarder(
        ...
        *,
        ...
        return shapes.DeleteConditionalForwarderResult.from_boto_dict(response)
    ...
    def delete_directory(
        ...
        *,
        ...
        return shapes.DeleteDirectoryResult.from_boto_dict(response)
    ...
    def delete_snapshot(
        ...
        *,
        ...
        return shapes.DeleteSnapshotResult.from_boto_dict(response)
    ...
    def delete_trust(
        ...
        *,
        ...
        response = self._boto_client.delete_trust(**_request.to_boto_dict())

        return shapes.DeleteTrustResult.from_boto_dict(response)
    ...
    def deregister_event_topic(
        ...
        *,
        ...
        return shapes.DeregisterEventTopicResult.from_boto_dict(response)
    ...
    def describe_conditional_forwarders(
        ...
        *,
        ...
        return shapes.DescribeConditionalForwardersResult.from_boto_dict(
            response
        )
    ...
    def describe_directories(
        ...
        *,
        ...
        response = self._boto_client.describe_directories(
            **_request.to_boto_dict()
        )

        return shapes.DescribeDirectoriesResult.from_boto_dict(response)
    ...
    def describe_domain_controllers(
        ...
        *,
        ...
        response = self._boto_client.describe_domain_controllers(
            **_request.to_boto_dict()
        )

        return shapes.DescribeDomainControllersResult.from_boto_dict(response)
    ...
    def describe_event_topics(
        ...
        *,
        ...
        response = self._boto_client.describe_event_topics(
            **_request.to_boto_dict()
        )

        return shapes.DescribeEventTopicsResult.from_boto_dict(response)
    ...
    def describe_trusts(
        ...
        *,
        ...
        response = self._boto_client.describe_trusts(**_request.to_boto_dict())

        return shapes.DescribeTrustsResult.from_boto_dict(response)
    ...
    def disable_radius(
        ...
        *,
        ...
        response = self._boto_client.disable_radius(**_request.to_boto_dict())

        return shapes.DisableRadiusResult.from_boto_dict(response)
    ...
    def disable_sso(
        ...
        *,
        ...
        response = self._boto_client.disable_sso(**_request.to_boto_dict())

        return shapes.DisableSsoResult.from_boto_dict(response)
    ...
    def enable_radius(
        ...
        *,
        ...
        response = self._boto_client.enable_radius(**_request.to_boto_dict())

        return shapes.EnableRadiusResult.from_boto_dict(response)
    ...
    def enable_sso(
        ...
        *,
        ...
        response = self._boto_client.enable_sso(**_request.to_boto_dict())

        return shapes.EnableSsoResult.from_boto_dict(response)
    ...
    def get_directory_limits(
        ...
        response = self._boto_client.get_directory_limits(
            **_request.to_boto_dict()
        )

        return shapes.GetDirectoryLimitsResult.from_boto_dict(response)
    ...
    def get_snapshot_limits(
        ...
        *,
        ...
        response = self._boto_client.get_snapshot_limits(
            **_request.to_boto_dict()
        )

        return shapes.GetSnapshotLimitsResult.from_boto_dict(response)
    ...
    def list_ip_routes(
        ...
        *,
        ...
        response = self._boto_client.list_ip_routes(**_request.to_boto_dict())

        return shapes.ListIpRoutesResult.from_boto_dict(response)
    ...
    def list_schema_extensions(
        ...
        *,
        ...
        return shapes.ListSchemaExtensionsResult.from_boto_dict(response)
    ...
    def register_event_topic(
        ...
        *,
        ...
        response = self._boto_client.register_event_topic(
            **_request.to_boto_dict()
        )

        return shapes.RegisterEventTopicResult.from_boto_dict(response)
    ...
    def remove_ip_routes(
        ...
        *,
        ...
        response = self._boto_client.remove_ip_routes(**_request.to_boto_dict())

        return shapes.RemoveIpRoutesResult.from_boto_dict(response)
    ...
    def reset_user_password(
        ...
        *,
        ...
        response = self._boto_client.reset_user_password(
            **_request.to_boto_dict()
        )

        return shapes.ResetUserPasswordResult.from_boto_dict(response)
    ...
    def restore_from_snapshot(
        ...
        *,
        ...
        response = self._boto_client.restore_from_snapshot(
            **_request.to_boto_dict()
        )

        return shapes.RestoreFromSnapshotResult.from_boto_dict(response)
    ...
    def start_schema_extension(
        ...
        *,
        ...
        return shapes.StartSchemaExtensionResult.from_boto_dict(response)
    ...
    def update_conditional_forwarder(
        ...
        *,
        ...
        return shapes.UpdateConditionalForwarderResult.from_boto_dict(response)
    ...
    def update_number_of_domain_controllers(
        ...
        *,
        ...
        return shapes.UpdateNumberOfDomainControllersResult.from_boto_dict(
            response
        )
    ...
    def update_radius(
        ...
        *,
        ...
        response = self._boto_client.update_radius(**_request.to_boto_dict())

        return shapes.UpdateRadiusResult.from_boto_dict(response)
    ...
    def verify_trust(
        ...
        *,
        ...
        response = self._boto_client.verify_trust(**_request.to_boto_dict())

        return shapes.VerifyTrustResult.from_boto_dict(response)
