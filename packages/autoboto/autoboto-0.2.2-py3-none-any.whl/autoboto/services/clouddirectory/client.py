...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("clouddirectory", *args, **kwargs)
    ...
    def list_applied_schema_arns(
        ...
        *,
        ...
        response = self._boto_client.list_applied_schema_arns(
            **_request.to_boto_dict()
        )
    ...
    def list_attached_indices(
        ...
        *,
        ...
        response = self._boto_client.list_attached_indices(
            **_request.to_boto_dict()
        )
    ...
    def list_development_schema_arns(
        ...
        *,
        ...
        response = self._boto_client.list_development_schema_arns(
            **_request.to_boto_dict()
        )
    ...
    def list_directories(
        ...
        *,
        ...
        response = self._boto_client.list_directories(**_request.to_boto_dict())
    ...
    def list_facet_attributes(
        ...
        *,
        ...
        response = self._boto_client.list_facet_attributes(
            **_request.to_boto_dict()
        )
    ...
    def list_facet_names(
        ...
        *,
        ...
        response = self._boto_client.list_facet_names(**_request.to_boto_dict())
    ...
    def list_index(
        ...
        *,
        ...
        response = self._boto_client.list_index(**_request.to_boto_dict())
    ...
    def list_object_attributes(
        ...
        *,
        ...
        response = self._boto_client.list_object_attributes(
            **_request.to_boto_dict()
        )
    ...
    def list_object_parent_paths(
        ...
        *,
        ...
        response = self._boto_client.list_object_parent_paths(
            **_request.to_boto_dict()
        )
    ...
    def list_object_policies(
        ...
        *,
        ...
        response = self._boto_client.list_object_policies(
            **_request.to_boto_dict()
        )
    ...
    def list_policy_attachments(
        ...
        *,
        ...
        response = self._boto_client.list_policy_attachments(
            **_request.to_boto_dict()
        )
    ...
    def list_published_schema_arns(
        ...
        *,
        ...
        response = self._boto_client.list_published_schema_arns(
            **_request.to_boto_dict()
        )
    ...
    def list_typed_link_facet_attributes(
        ...
        *,
        ...
        response = self._boto_client.list_typed_link_facet_attributes(
            **_request.to_boto_dict()
        )
    ...
    def list_typed_link_facet_names(
        ...
        *,
        ...
        response = self._boto_client.list_typed_link_facet_names(
            **_request.to_boto_dict()
        )
    ...
    def lookup_policy(
        ...
        *,
        ...
        response = self._boto_client.lookup_policy(**_request.to_boto_dict())
