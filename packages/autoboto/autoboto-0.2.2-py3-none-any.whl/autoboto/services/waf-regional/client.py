...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("waf-regional", *args, **kwargs)
    ...
    def associate_web_acl(
        ...
        *,
        ...
        response = self._boto_client.associate_web_acl(
            **_request.to_boto_dict()
        )

        return shapes.AssociateWebACLResponse.from_boto_dict(response)
    ...
    def disassociate_web_acl(
        ...
        *,
        ...
        response = self._boto_client.disassociate_web_acl(
            **_request.to_boto_dict()
        )

        return shapes.DisassociateWebACLResponse.from_boto_dict(response)
    ...
    def get_web_acl_for_resource(
        ...
        *,
        ...
        return shapes.GetWebACLForResourceResponse.from_boto_dict(response)
    ...
    def list_byte_match_sets(
        ...
        *,
        ...
        response = self._boto_client.list_byte_match_sets(
            **_request.to_boto_dict()
        )
    ...
    def list_ip_sets(
        ...
        *,
        ...
        response = self._boto_client.list_ip_sets(**_request.to_boto_dict())
    ...
    def list_resources_for_web_acl(
        ...
        *,
        ...
        return shapes.ListResourcesForWebACLResponse.from_boto_dict(response)
    ...
    def list_rules(
        ...
        *,
        ...
        response = self._boto_client.list_rules(**_request.to_boto_dict())
    ...
    def list_web_acls(
        ...
        *,
        ...
        response = self._boto_client.list_web_acls(**_request.to_boto_dict())
    ...
    def list_xss_match_sets(
        ...
        *,
        ...
        response = self._boto_client.list_xss_match_sets(
            **_request.to_boto_dict()
        )
