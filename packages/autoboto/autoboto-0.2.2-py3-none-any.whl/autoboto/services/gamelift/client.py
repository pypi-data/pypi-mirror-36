...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("gamelift", *args, **kwargs)
    ...
    def accept_match(
        ...
        *,
        ...
        acceptance_type: shapes.AcceptanceType,
        ...
        response = self._boto_client.accept_match(**_request.to_boto_dict())

        return shapes.AcceptMatchOutput.from_boto_dict(response)
    ...
    def create_alias(
        ...
        *,
        ...
        response = self._boto_client.create_alias(**_request.to_boto_dict())

        return shapes.CreateAliasOutput.from_boto_dict(response)
    ...
    def create_build(
        ...
        *,
        ...
        response = self._boto_client.create_build(**_request.to_boto_dict())

        return shapes.CreateBuildOutput.from_boto_dict(response)
    ...
    def create_fleet(
        ...
        *,
        name: str,
        build_id: str,
        ec2_instance_type: shapes.EC2InstanceType,
        description: str = ShapeBase.NOT_SET,
        ...
        new_game_session_protection_policy: shapes.ProtectionPolicy = ShapeBase.
        NOT_SET,
        ...
        fleet_type: shapes.FleetType = ShapeBase.NOT_SET,
        ...
        return shapes.CreateFleetOutput.from_boto_dict(response)
    ...
    def create_game_session(
        ...
        **Game session logs.** Logs are retained for all active game sessions for 14
        ...
        response = self._boto_client.create_game_session(
            **_request.to_boto_dict()
        )

        return shapes.CreateGameSessionOutput.from_boto_dict(response)
    ...
    def create_game_session_queue(
        ...
        **Player latency policies.** For placement requests containing player latency
        ...
        return shapes.CreateGameSessionQueueOutput.from_boto_dict(response)
    ...
    def create_matchmaking_configuration(
        ...
        **Matchmaking status notification** \-- There are two ways to track the progress
        ...
        return shapes.CreateMatchmakingConfigurationOutput.from_boto_dict(
            response
        )
    ...
    def create_matchmaking_rule_set(
        ...
        *,
        ...
        return shapes.CreateMatchmakingRuleSetOutput.from_boto_dict(response)
    ...
    def create_player_session(
        ...
        *,
        ...
        response = self._boto_client.create_player_session(
            **_request.to_boto_dict()
        )

        return shapes.CreatePlayerSessionOutput.from_boto_dict(response)
    ...
    def create_player_sessions(
        ...
        *,
        ...
        return shapes.CreatePlayerSessionsOutput.from_boto_dict(response)
    ...
    def create_vpc_peering_authorization(
        ...
        *,
        ...
        return shapes.CreateVpcPeeringAuthorizationOutput.from_boto_dict(
            response
        )
    ...
    def create_vpc_peering_connection(
        ...
        *,
        ...
        return shapes.CreateVpcPeeringConnectionOutput.from_boto_dict(response)
    ...
    def delete_alias(
        ...
        *,
        ...
        response = self._boto_client.delete_alias(**_request.to_boto_dict())
    ...
    def delete_build(
        ...
        *,
        ...
        response = self._boto_client.delete_build(**_request.to_boto_dict())
    ...
    def delete_fleet(
        ...
        *,
        ...
        response = self._boto_client.delete_fleet(**_request.to_boto_dict())
    ...
    def delete_game_session_queue(
        ...
        *,
        ...
        return shapes.DeleteGameSessionQueueOutput.from_boto_dict(response)
    ...
    def delete_matchmaking_configuration(
        ...
        *,
        ...
        return shapes.DeleteMatchmakingConfigurationOutput.from_boto_dict(
            response
        )
    ...
    def delete_scaling_policy(
        ...
        *,
        ...
        response = self._boto_client.delete_scaling_policy(
            **_request.to_boto_dict()
        )
    ...
    def delete_vpc_peering_authorization(
        ...
        *,
        ...
        return shapes.DeleteVpcPeeringAuthorizationOutput.from_boto_dict(
            response
        )
    ...
    def delete_vpc_peering_connection(
        ...
        *,
        ...
        return shapes.DeleteVpcPeeringConnectionOutput.from_boto_dict(response)
    ...
    def describe_alias(
        ...
        *,
        ...
        response = self._boto_client.describe_alias(**_request.to_boto_dict())

        return shapes.DescribeAliasOutput.from_boto_dict(response)
    ...
    def describe_build(
        ...
        *,
        ...
        response = self._boto_client.describe_build(**_request.to_boto_dict())

        return shapes.DescribeBuildOutput.from_boto_dict(response)

    def describe_ec2_instance_limits(
        self,
        _request: shapes.DescribeEC2InstanceLimitsInput = None,
        *,
        ec2_instance_type: shapes.EC2InstanceType = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeEC2InstanceLimitsOutput.from_boto_dict(response)
    ...
    def describe_fleet_attributes(
        ...
        *,
        ...
        return shapes.DescribeFleetAttributesOutput.from_boto_dict(response)
    ...
    def describe_fleet_capacity(
        ...
        *,
        ...
        return shapes.DescribeFleetCapacityOutput.from_boto_dict(response)
    ...
    def describe_fleet_events(
        ...
        *,
        ...
        response = self._boto_client.describe_fleet_events(
            **_request.to_boto_dict()
        )

        return shapes.DescribeFleetEventsOutput.from_boto_dict(response)
    ...
    def describe_fleet_port_settings(
        ...
        *,
        ...
        return shapes.DescribeFleetPortSettingsOutput.from_boto_dict(response)
    ...
    def describe_fleet_utilization(
        ...
        *,
        ...
        return shapes.DescribeFleetUtilizationOutput.from_boto_dict(response)
    ...
    def describe_game_session_details(
        ...
        *,
        ...
        return shapes.DescribeGameSessionDetailsOutput.from_boto_dict(response)
    ...
    def describe_game_session_placement(
        ...
        *,
        ...
        return shapes.DescribeGameSessionPlacementOutput.from_boto_dict(
            response
        )
    ...
    def describe_game_session_queues(
        ...
        *,
        ...
        return shapes.DescribeGameSessionQueuesOutput.from_boto_dict(response)
    ...
    def describe_game_sessions(
        ...
        *,
        ...
        return shapes.DescribeGameSessionsOutput.from_boto_dict(response)
    ...
    def describe_instances(
        ...
        *,
        ...
        return shapes.DescribeInstancesOutput.from_boto_dict(response)
    ...
    def describe_matchmaking(
        ...
        *,
        ...
        response = self._boto_client.describe_matchmaking(
            **_request.to_boto_dict()
        )

        return shapes.DescribeMatchmakingOutput.from_boto_dict(response)
    ...
    def describe_matchmaking_configurations(
        ...
        *,
        ...
        return shapes.DescribeMatchmakingConfigurationsOutput.from_boto_dict(
            response
        )
    ...
    def describe_matchmaking_rule_sets(
        ...
        *,
        ...
        return shapes.DescribeMatchmakingRuleSetsOutput.from_boto_dict(response)
    ...
    def describe_player_sessions(
        ...
        *,
        ...
        return shapes.DescribePlayerSessionsOutput.from_boto_dict(response)
    ...
    def describe_runtime_configuration(
        ...
        *,
        ...
        return shapes.DescribeRuntimeConfigurationOutput.from_boto_dict(
            response
        )
    ...
    def describe_scaling_policies(
        ...
        *,
        fleet_id: str,
        status_filter: shapes.ScalingStatusType = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeScalingPoliciesOutput.from_boto_dict(response)
    ...
    def describe_vpc_peering_authorizations(
        ...
        return shapes.DescribeVpcPeeringAuthorizationsOutput.from_boto_dict(
            response
        )
    ...
    def describe_vpc_peering_connections(
        ...
        *,
        ...
        return shapes.DescribeVpcPeeringConnectionsOutput.from_boto_dict(
            response
        )
    ...
    def get_game_session_log_url(
        ...
        *,
        ...
        return shapes.GetGameSessionLogUrlOutput.from_boto_dict(response)
    ...
    def get_instance_access(
        ...
        *,
        ...
        response = self._boto_client.get_instance_access(
            **_request.to_boto_dict()
        )

        return shapes.GetInstanceAccessOutput.from_boto_dict(response)

    def list_aliases(
        self,
        _request: shapes.ListAliasesInput = None,
        *,
        routing_strategy_type: shapes.RoutingStrategyType = ShapeBase.NOT_SET,
        name: str = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_aliases(**_request.to_boto_dict())

        return shapes.ListAliasesOutput.from_boto_dict(response)

    def list_builds(
        self,
        _request: shapes.ListBuildsInput = None,
        *,
        status: shapes.BuildStatus = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_builds(**_request.to_boto_dict())

        return shapes.ListBuildsOutput.from_boto_dict(response)
    ...
    def list_fleets(
        ...
        *,
        ...
        response = self._boto_client.list_fleets(**_request.to_boto_dict())

        return shapes.ListFleetsOutput.from_boto_dict(response)
    ...
    def put_scaling_policy(
        ...
        *,
        name: str,
        fleet_id: str,
        metric_name: shapes.MetricName,
        scaling_adjustment: int = ShapeBase.NOT_SET,
        scaling_adjustment_type: shapes.ScalingAdjustmentType = ShapeBase.
        NOT_SET,
        threshold: float = ShapeBase.NOT_SET,
        comparison_operator: shapes.ComparisonOperatorType = ShapeBase.NOT_SET,
        evaluation_periods: int = ShapeBase.NOT_SET,
        policy_type: shapes.PolicyType = ShapeBase.NOT_SET,
        ...
        **Rule-based policy**
        ...
        response = self._boto_client.put_scaling_policy(
            **_request.to_boto_dict()
        )

        return shapes.PutScalingPolicyOutput.from_boto_dict(response)
    ...
    def request_upload_credentials(
        ...
        *,
        ...
        return shapes.RequestUploadCredentialsOutput.from_boto_dict(response)
    ...
    def resolve_alias(
        ...
        *,
        ...
        response = self._boto_client.resolve_alias(**_request.to_boto_dict())

        return shapes.ResolveAliasOutput.from_boto_dict(response)
    ...
    def search_game_sessions(
        ...
        *,
        ...
        response = self._boto_client.search_game_sessions(
            **_request.to_boto_dict()
        )

        return shapes.SearchGameSessionsOutput.from_boto_dict(response)
    ...
    def start_fleet_actions(
        ...
        *,
        fleet_id: str,
        actions: typing.List[shapes.FleetAction],
        ...
        response = self._boto_client.start_fleet_actions(
            **_request.to_boto_dict()
        )

        return shapes.StartFleetActionsOutput.from_boto_dict(response)
    ...
    def start_game_session_placement(
        ...
        *,
        ...
        return shapes.StartGameSessionPlacementOutput.from_boto_dict(response)
    ...
    def start_match_backfill(
        ...
        *,
        ...
        response = self._boto_client.start_match_backfill(
            **_request.to_boto_dict()
        )

        return shapes.StartMatchBackfillOutput.from_boto_dict(response)
    ...
    def start_matchmaking(
        ...
        **Processing a matchmaking request** \-- FlexMatch handles a matchmaking request
        ...
        response = self._boto_client.start_matchmaking(
            **_request.to_boto_dict()
        )

        return shapes.StartMatchmakingOutput.from_boto_dict(response)
    ...
    def stop_fleet_actions(
        ...
        *,
        ...
        response = self._boto_client.stop_fleet_actions(
            **_request.to_boto_dict()
        )

        return shapes.StopFleetActionsOutput.from_boto_dict(response)
    ...
    def stop_game_session_placement(
        ...
        *,
        ...
        return shapes.StopGameSessionPlacementOutput.from_boto_dict(response)
    ...
    def stop_matchmaking(
        ...
        *,
        ...
        response = self._boto_client.stop_matchmaking(**_request.to_boto_dict())

        return shapes.StopMatchmakingOutput.from_boto_dict(response)
    ...
    def update_alias(
        ...
        *,
        ...
        response = self._boto_client.update_alias(**_request.to_boto_dict())

        return shapes.UpdateAliasOutput.from_boto_dict(response)
    ...
    def update_build(
        ...
        *,
        ...
        response = self._boto_client.update_build(**_request.to_boto_dict())

        return shapes.UpdateBuildOutput.from_boto_dict(response)
    ...
    def update_fleet_attributes(
        ...
        *,
        ...
        return shapes.UpdateFleetAttributesOutput.from_boto_dict(response)
    ...
    def update_fleet_capacity(
        ...
        *,
        ...
        response = self._boto_client.update_fleet_capacity(
            **_request.to_boto_dict()
        )

        return shapes.UpdateFleetCapacityOutput.from_boto_dict(response)
    ...
    def update_fleet_port_settings(
        ...
        *,
        ...
        return shapes.UpdateFleetPortSettingsOutput.from_boto_dict(response)
    ...
    def update_game_session(
        ...
        *,
        ...
        name: str = ShapeBase.NOT_SET,
        player_session_creation_policy: shapes.
        PlayerSessionCreationPolicy = ShapeBase.NOT_SET,
        protection_policy: shapes.ProtectionPolicy = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.update_game_session(
            **_request.to_boto_dict()
        )

        return shapes.UpdateGameSessionOutput.from_boto_dict(response)
    ...
    def update_game_session_queue(
        ...
        *,
        ...
        return shapes.UpdateGameSessionQueueOutput.from_boto_dict(response)
    ...
    def update_matchmaking_configuration(
        ...
        *,
        ...
        return shapes.UpdateMatchmakingConfigurationOutput.from_boto_dict(
            response
        )
    ...
    def update_runtime_configuration(
        ...
        *,
        ...
        return shapes.UpdateRuntimeConfigurationOutput.from_boto_dict(response)
    ...
    def validate_matchmaking_rule_set(
        ...
        *,
        ...
        return shapes.ValidateMatchmakingRuleSetOutput.from_boto_dict(response)
