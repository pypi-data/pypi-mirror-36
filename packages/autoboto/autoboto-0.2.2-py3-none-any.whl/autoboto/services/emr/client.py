...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("emr", *args, **kwargs)
    ...
    def add_instance_fleet(
        ...
        *,
        ...
        response = self._boto_client.add_instance_fleet(
            **_request.to_boto_dict()
        )

        return shapes.AddInstanceFleetOutput.from_boto_dict(response)
    ...
    def add_instance_groups(
        ...
        *,
        ...
        response = self._boto_client.add_instance_groups(
            **_request.to_boto_dict()
        )

        return shapes.AddInstanceGroupsOutput.from_boto_dict(response)
    ...
    def add_job_flow_steps(
        ...
        *,
        ...
        response = self._boto_client.add_job_flow_steps(
            **_request.to_boto_dict()
        )

        return shapes.AddJobFlowStepsOutput.from_boto_dict(response)
    ...
    def cancel_steps(
        ...
        *,
        ...
        response = self._boto_client.cancel_steps(**_request.to_boto_dict())

        return shapes.CancelStepsOutput.from_boto_dict(response)
    ...
    def create_security_configuration(
        ...
        *,
        ...
        return shapes.CreateSecurityConfigurationOutput.from_boto_dict(response)
    ...
    def delete_security_configuration(
        ...
        *,
        ...
        return shapes.DeleteSecurityConfigurationOutput.from_boto_dict(response)
    ...
    def describe_cluster(
        ...
        *,
        ...
        response = self._boto_client.describe_cluster(**_request.to_boto_dict())

        return shapes.DescribeClusterOutput.from_boto_dict(response)
    ...
    def describe_job_flows(
        ...
        *,
        ...
        job_flow_states: typing.List[shapes.JobFlowExecutionState
                                    ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_job_flows(
            **_request.to_boto_dict()
        )

        return shapes.DescribeJobFlowsOutput.from_boto_dict(response)
    ...
    def describe_security_configuration(
        ...
        *,
        ...
        return shapes.DescribeSecurityConfigurationOutput.from_boto_dict(
            response
        )
    ...
    def describe_step(
        ...
        *,
        ...
        response = self._boto_client.describe_step(**_request.to_boto_dict())

        return shapes.DescribeStepOutput.from_boto_dict(response)
    ...
    def list_bootstrap_actions(
        ...
        *,
        ...
        response = self._boto_client.list_bootstrap_actions(
            **_request.to_boto_dict()
        )

        return shapes.ListBootstrapActionsOutput.from_boto_dict(response)
    ...
    def list_clusters(
        ...
        *,
        created_after: datetime.datetime = ShapeBase.NOT_SET,
        created_before: datetime.datetime = ShapeBase.NOT_SET,
        cluster_states: typing.List[shapes.ClusterState] = ShapeBase.NOT_SET,
        marker: str = ShapeBase.NOT_SET,
        ...
        return shapes.ListClustersOutput.from_boto_dict(response)
    ...
    def list_instance_fleets(
        ...
        *,
        ...
        response = self._boto_client.list_instance_fleets(
            **_request.to_boto_dict()
        )

        return shapes.ListInstanceFleetsOutput.from_boto_dict(response)
    ...
    def list_instance_groups(
        ...
        *,
        ...
        response = self._boto_client.list_instance_groups(
            **_request.to_boto_dict()
        )

        return shapes.ListInstanceGroupsOutput.from_boto_dict(response)
    ...
    def list_instances(
        ...
        *,
        ...
        instance_group_types: typing.List[shapes.InstanceGroupType
                                         ] = ShapeBase.NOT_SET,
        instance_fleet_id: str = ShapeBase.NOT_SET,
        instance_fleet_type: shapes.InstanceFleetType = ShapeBase.NOT_SET,
        instance_states: typing.List[shapes.InstanceState] = ShapeBase.NOT_SET,
        marker: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_instances(**_request.to_boto_dict())

        return shapes.ListInstancesOutput.from_boto_dict(response)
    ...
    def list_security_configurations(
        ...
        *,
        ...
        return shapes.ListSecurityConfigurationsOutput.from_boto_dict(response)
    ...
    def list_steps(
        ...
        *,
        cluster_id: str,
        step_states: typing.List[shapes.StepState] = ShapeBase.NOT_SET,
        step_ids: typing.List[str] = ShapeBase.NOT_SET,
        marker: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_steps(**_request.to_boto_dict())

        return shapes.ListStepsOutput.from_boto_dict(response)
    ...
    def modify_instance_fleet(
        ...
        *,
        ...
        response = self._boto_client.modify_instance_fleet(
            **_request.to_boto_dict()
        )
    ...
    def put_auto_scaling_policy(
        ...
        *,
        ...
        return shapes.PutAutoScalingPolicyOutput.from_boto_dict(response)
    ...
    def remove_auto_scaling_policy(
        ...
        *,
        ...
        return shapes.RemoveAutoScalingPolicyOutput.from_boto_dict(response)
    ...
    def run_job_flow(
        ...
        *,
        ...
        scale_down_behavior: shapes.ScaleDownBehavior = ShapeBase.NOT_SET,
        custom_ami_id: str = ShapeBase.NOT_SET,
        ebs_root_volume_size: int = ShapeBase.NOT_SET,
        repo_upgrade_on_boot: shapes.RepoUpgradeOnBoot = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.run_job_flow(**_request.to_boto_dict())

        return shapes.RunJobFlowOutput.from_boto_dict(response)
    ...
    def terminate_job_flows(
        ...
        *,
        ...
        response = self._boto_client.terminate_job_flows(
            **_request.to_boto_dict()
        )
