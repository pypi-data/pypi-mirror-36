...
class AddJobFlowStepsInput(ShapeBase):
    ...
    steps: typing.List["StepConfig"] = dataclasses.field(default_factory=list, )
...
class AddJobFlowStepsOutput(OutputShapeBase):
    ...
    step_ids: typing.List[str] = dataclasses.field(default_factory=list, )
...
class AutoScalingPolicyStateChangeReason(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "code",
                "Code",
                TypeInfo(AutoScalingPolicyStateChangeReasonCode),
            ),
            (
                "message",
                "Message",
    ...
    code: "AutoScalingPolicyStateChangeReasonCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class AutoScalingPolicyStatus(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "state",
                "State",
                TypeInfo(AutoScalingPolicyState),
            ),
            (
                "state_change_reason",
                "StateChangeReason",
    ...
    state: "AutoScalingPolicyState" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class CancelStepsInfo(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status",
                "Status",
                TypeInfo(CancelStepsRequestStatus),
            ),
            (
                "reason",
                "Reason",
    ...
    status: "CancelStepsRequestStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class Cluster(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                TypeInfo(InstanceCollectionType),
            ),
            (
                "log_uri",
                "LogUri",
    ...
    status: "ClusterStatus" = dataclasses.field(default_factory=dict, )
    ...
    instance_collection_type: "InstanceCollectionType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    scale_down_behavior: "ScaleDownBehavior" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # boots using the AMI.
    repo_upgrade_on_boot: "RepoUpgradeOnBoot" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class ClusterStateChangeReason(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "code",
                "Code",
                TypeInfo(ClusterStateChangeReasonCode),
            ),
            (
                "message",
                "Message",
    ...
    code: "ClusterStateChangeReasonCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class ClusterStatus(ShapeBase):
    ...
    state: "ClusterState" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # cluster.
    timeline: "ClusterTimeline" = dataclasses.field(default_factory=dict, )
...
class DescribeJobFlowsInput(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "job_flow_states",
                "JobFlowStates",
                TypeInfo(typing.List[JobFlowExecutionState]),
            ),
        ]
    ...
    job_flow_ids: typing.List[str] = dataclasses.field(default_factory=list, )

    # Return only job flows whose state is contained in this list.
    job_flow_states: typing.List["JobFlowExecutionState"] = dataclasses.field(
        default_factory=list,
    )
...
class DescribeStepOutput(OutputShapeBase):
    ...
    step: "Step" = dataclasses.field(default_factory=dict, )
...
class Instance(ShapeBase):
    ...
    status: "InstanceStatus" = dataclasses.field(default_factory=dict, )
    ...
    market: "MarketType" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class InstanceFleet(ShapeBase):
    ...
    status: "InstanceFleetStatus" = dataclasses.field(default_factory=dict, )

    # The node type that the instance fleet hosts. Valid values are MASTER, CORE,
    # or TASK.
    instance_fleet_type: "InstanceFleetType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class InstanceFleetStateChangeReason(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "code",
                "Code",
                TypeInfo(InstanceFleetStateChangeReasonCode),
            ),
            (
                "message",
                "Message",
    ...
    code: "InstanceFleetStateChangeReasonCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class InstanceFleetStatus(ShapeBase):
    ...
    state: "InstanceFleetState" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class InstanceGroup(ShapeBase):
    ...
    instance_group_type: "InstanceGroupType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    status: "InstanceGroupStatus" = dataclasses.field(default_factory=dict, )
    ...
    shrink_policy: "ShrinkPolicy" = dataclasses.field(default_factory=dict, )
...
class InstanceGroupConfig(ShapeBase):
    ...
    instance_role: "InstanceRoleType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class InstanceGroupDetail(ShapeBase):
    ...
    state: "InstanceGroupState" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class InstanceGroupStateChangeReason(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "code",
                "Code",
                TypeInfo(InstanceGroupStateChangeReasonCode),
            ),
            (
                "message",
                "Message",
    ...
    code: "InstanceGroupStateChangeReasonCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class InstanceStateChangeReason(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "code",
                "Code",
                TypeInfo(InstanceStateChangeReasonCode),
            ),
            (
                "message",
                "Message",
    ...
    # The programmable code for the state change reason.
    code: "InstanceStateChangeReasonCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class InstanceStatus(ShapeBase):
    ...
    timeline: "InstanceTimeline" = dataclasses.field(default_factory=dict, )
...
class JobFlowDetail(ShapeBase):
    ...
    steps: typing.List["StepDetail"] = dataclasses.field(default_factory=list, )
...
class JobFlowExecutionStatusDetail(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "state",
                "State",
                TypeInfo(JobFlowExecutionState),
            ),
            (
                "creation_date_time",
                "CreationDateTime",
    ...
    state: "JobFlowExecutionState" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class JobFlowInstancesConfig(ShapeBase):
    ...
    placement: "PlacementType" = dataclasses.field(default_factory=dict, )
    ...
    # The instance fleet configuration is available only in Amazon EMR versions
    # 4.8.0 and later, excluding 5.0.x versions.
    ec2_subnet_ids: typing.List[str] = dataclasses.field(default_factory=list, )
...
class ListClustersInput(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "cluster_states",
                "ClusterStates",
                TypeInfo(typing.List[ClusterState]),
            ),
            (
                "marker",
                "Marker",
    ...
    cluster_states: typing.List["ClusterState"] = dataclasses.field(
        default_factory=list,
    )
...
class ListInstancesInput(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                "InstanceGroupTypes",
                TypeInfo(typing.List[InstanceGroupType]),
            ),
            (
                "instance_fleet_id",
                "InstanceFleetId",
    ...
    instance_group_types: typing.List["InstanceGroupType"] = dataclasses.field(
        default_factory=list,
    )
...
class ListStepsInput(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "step_states",
                "StepStates",
                TypeInfo(typing.List[StepState]),
            ),
            (
                "step_ids",
                "StepIds",
    ...
    step_states: typing.List["StepState"] = dataclasses.field(
        default_factory=list,
    )
...
class ScalingRule(ShapeBase):
    ...
    action: "ScalingAction" = dataclasses.field(default_factory=dict, )

    # The CloudWatch alarm definition that determines when automatic scaling
    # activity is triggered.
    trigger: "ScalingTrigger" = dataclasses.field(default_factory=dict, )
...
class SpotProvisioningSpecification(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "timeout_action",
                "TimeoutAction",
                TypeInfo(SpotProvisioningTimeoutAction),
            ),
            (
    ...
    timeout_action: "SpotProvisioningTimeoutAction" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class Step(ShapeBase):
    ...
    config: "HadoopStepConfig" = dataclasses.field(default_factory=dict, )
    ...
    action_on_failure: "ActionOnFailure" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # The current execution status details of the cluster step.
    status: "StepStatus" = dataclasses.field(default_factory=dict, )
...
class StepDetail(ShapeBase):
    ...
    step_config: "StepConfig" = dataclasses.field(default_factory=dict, )
...
class StepExecutionStatusDetail(ShapeBase):
    ...
    state: "StepExecutionState" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class StepStateChangeReason(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "code",
                "Code",
                TypeInfo(StepStateChangeReasonCode),
            ),
            (
                "message",
                "Message",
    ...
    code: "StepStateChangeReasonCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class StepStatus(ShapeBase):
    ...
    state: "StepState" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    timeline: "StepTimeline" = dataclasses.field(default_factory=dict, )
