...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("mgh", *args, **kwargs)
    ...
    def associate_created_artifact(
        ...
        *,
        ...
        return shapes.AssociateCreatedArtifactResult.from_boto_dict(response)
    ...
    def associate_discovered_resource(
        ...
        *,
        ...
        return shapes.AssociateDiscoveredResourceResult.from_boto_dict(response)
    ...
    def create_progress_update_stream(
        ...
        *,
        ...
        return shapes.CreateProgressUpdateStreamResult.from_boto_dict(response)
    ...
    def delete_progress_update_stream(
        ...
        *,
        ...
        return shapes.DeleteProgressUpdateStreamResult.from_boto_dict(response)
    ...
    def describe_application_state(
        ...
        *,
        ...
        return shapes.DescribeApplicationStateResult.from_boto_dict(response)
    ...
    def describe_migration_task(
        ...
        *,
        ...
        return shapes.DescribeMigrationTaskResult.from_boto_dict(response)
    ...
    def disassociate_created_artifact(
        ...
        *,
        ...
        return shapes.DisassociateCreatedArtifactResult.from_boto_dict(response)
    ...
    def disassociate_discovered_resource(
        ...
        *,
        ...
        return shapes.DisassociateDiscoveredResourceResult.from_boto_dict(
            response
        )
    ...
    def import_migration_task(
        ...
        *,
        ...
        response = self._boto_client.import_migration_task(
            **_request.to_boto_dict()
        )

        return shapes.ImportMigrationTaskResult.from_boto_dict(response)
    ...
    def list_created_artifacts(
        ...
        *,
        ...
        return shapes.ListCreatedArtifactsResult.from_boto_dict(response)
    ...
    def list_discovered_resources(
        ...
        *,
        ...
        return shapes.ListDiscoveredResourcesResult.from_boto_dict(response)
    ...
    def list_migration_tasks(
        ...
        *,
        ...
        response = self._boto_client.list_migration_tasks(
            **_request.to_boto_dict()
        )

        return shapes.ListMigrationTasksResult.from_boto_dict(response)
    ...
    def list_progress_update_streams(
        ...
        *,
        ...
        return shapes.ListProgressUpdateStreamsResult.from_boto_dict(response)
    ...
    def notify_application_state(
        ...
        *,
        application_id: str,
        status: shapes.ApplicationStatus,
        dry_run: bool = ShapeBase.NOT_SET,
        ...
        return shapes.NotifyApplicationStateResult.from_boto_dict(response)
    ...
    def notify_migration_task_state(
        ...
        *,
        ...
        return shapes.NotifyMigrationTaskStateResult.from_boto_dict(response)
    ...
    def put_resource_attributes(
        ...
        *,
        ...
        return shapes.PutResourceAttributesResult.from_boto_dict(response)
