...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("signer", *args, **kwargs)
    ...
    def describe_signing_job(
        ...
        *,
        ...
        response = self._boto_client.describe_signing_job(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSigningJobResponse.from_boto_dict(response)
    ...
    def get_signing_platform(
        ...
        *,
        ...
        response = self._boto_client.get_signing_platform(
            **_request.to_boto_dict()
        )

        return shapes.GetSigningPlatformResponse.from_boto_dict(response)
    ...
    def get_signing_profile(
        ...
        *,
        ...
        response = self._boto_client.get_signing_profile(
            **_request.to_boto_dict()
        )

        return shapes.GetSigningProfileResponse.from_boto_dict(response)

    def list_signing_jobs(
        self,
        _request: shapes.ListSigningJobsRequest = None,
        *,
        status: shapes.SigningStatus = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_signing_jobs(
            **_request.to_boto_dict()
        )

        return shapes.ListSigningJobsResponse.from_boto_dict(response)
    ...
    def list_signing_platforms(
        ...
        *,
        ...
        return shapes.ListSigningPlatformsResponse.from_boto_dict(response)
    ...
    def list_signing_profiles(
        ...
        *,
        ...
        response = self._boto_client.list_signing_profiles(
            **_request.to_boto_dict()
        )

        return shapes.ListSigningProfilesResponse.from_boto_dict(response)
    ...
    def put_signing_profile(
        ...
        *,
        ...
        response = self._boto_client.put_signing_profile(
            **_request.to_boto_dict()
        )

        return shapes.PutSigningProfileResponse.from_boto_dict(response)
    ...
    def start_signing_job(
        ...
        *,
        ...
        response = self._boto_client.start_signing_job(
            **_request.to_boto_dict()
        )

        return shapes.StartSigningJobResponse.from_boto_dict(response)
