...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("elasticache", *args, **kwargs)
    ...
    def describe_cache_clusters(
        ...
        *,
        ...
        response = self._boto_client.describe_cache_clusters(
            **_request.to_boto_dict()
        )
    ...
    def describe_cache_engine_versions(
        ...
        *,
        ...
        response = self._boto_client.describe_cache_engine_versions(
            **_request.to_boto_dict()
        )
    ...
    def describe_cache_parameter_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_cache_parameter_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_cache_parameters(
        ...
        *,
        ...
        response = self._boto_client.describe_cache_parameters(
            **_request.to_boto_dict()
        )
    ...
    def describe_cache_security_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_cache_security_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_cache_subnet_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_cache_subnet_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_replication_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_replication_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_reserved_cache_nodes(
        ...
        *,
        ...
        response = self._boto_client.describe_reserved_cache_nodes(
            **_request.to_boto_dict()
        )
    ...
    def describe_reserved_cache_nodes_offerings(
        ...
        *,
        ...
        response = self._boto_client.describe_reserved_cache_nodes_offerings(
            **_request.to_boto_dict()
        )
