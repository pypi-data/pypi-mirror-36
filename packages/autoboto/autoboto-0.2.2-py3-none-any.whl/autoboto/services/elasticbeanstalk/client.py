...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("elasticbeanstalk", *args, **kwargs)
    ...
    def apply_environment_managed_action(
        ...
        *,
        ...
        return shapes.ApplyEnvironmentManagedActionResult.from_boto_dict(
            response
        )
    ...
    def check_dns_availability(
        ...
        *,
        ...
        return shapes.CheckDNSAvailabilityResultMessage.from_boto_dict(response)
    ...
    def compose_environments(
        ...
        *,
        ...
        response = self._boto_client.compose_environments(
            **_request.to_boto_dict()
        )

        return shapes.EnvironmentDescriptionsMessage.from_boto_dict(response)
    ...
    def create_application(
        ...
        *,
        ...
        return shapes.ApplicationDescriptionMessage.from_boto_dict(response)
    ...
    def create_application_version(
        ...
        *,
        ...
        return shapes.ApplicationVersionDescriptionMessage.from_boto_dict(
            response
        )
    ...
    def create_configuration_template(
        ...
        *,
        ...
        return shapes.ConfigurationSettingsDescription.from_boto_dict(response)
    ...
    def create_environment(
        ...
        *,
        ...
        response = self._boto_client.create_environment(
            **_request.to_boto_dict()
        )

        return shapes.EnvironmentDescription.from_boto_dict(response)
    ...
    def create_platform_version(
        ...
        *,
        ...
        return shapes.CreatePlatformVersionResult.from_boto_dict(response)
    ...
    def create_storage_location(
        ...
        return shapes.CreateStorageLocationResultMessage.from_boto_dict(
            response
        )
    ...
    def delete_platform_version(
        ...
        *,
        ...
        return shapes.DeletePlatformVersionResult.from_boto_dict(response)
    ...
    def describe_application_versions(
        ...
        *,
        ...
        return shapes.ApplicationVersionDescriptionsMessage.from_boto_dict(
            response
        )
    ...
    def describe_applications(
        ...
        *,
        ...
        response = self._boto_client.describe_applications(
            **_request.to_boto_dict()
        )

        return shapes.ApplicationDescriptionsMessage.from_boto_dict(response)
    ...
    def describe_configuration_options(
        ...
        *,
        ...
        return shapes.ConfigurationOptionsDescription.from_boto_dict(response)
    ...
    def describe_configuration_settings(
        ...
        *,
        ...
        return shapes.ConfigurationSettingsDescriptions.from_boto_dict(response)
    ...
    def describe_environment_health(
        ...
        *,
        environment_name: str = ShapeBase.NOT_SET,
        environment_id: str = ShapeBase.NOT_SET,
        attribute_names: typing.List[shapes.EnvironmentHealthAttribute
                                    ] = ShapeBase.NOT_SET,
        ...
        **DescribeEnvironmentHealth** operation is only available with AWS Elastic
        ...
        return shapes.DescribeEnvironmentHealthResult.from_boto_dict(response)
    ...
    def describe_environment_managed_action_history(
        ...
        *,
        ...
        return shapes.DescribeEnvironmentManagedActionHistoryResult.from_boto_dict(
            response
        )
    ...
    def describe_environment_managed_actions(
        ...
        *,
        environment_name: str = ShapeBase.NOT_SET,
        environment_id: str = ShapeBase.NOT_SET,
        status: shapes.ActionStatus = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeEnvironmentManagedActionsResult.from_boto_dict(
            response
        )
    ...
    def describe_environment_resources(
        ...
        *,
        ...
        return shapes.EnvironmentResourceDescriptionsMessage.from_boto_dict(
            response
        )
    ...
    def describe_events(
        ...
        *,
        ...
        severity: shapes.EventSeverity = ShapeBase.NOT_SET,
        ...
        return shapes.EventDescriptionsMessage.from_boto_dict(response)
    ...
    def describe_instances_health(
        ...
        *,
        environment_name: str = ShapeBase.NOT_SET,
        environment_id: str = ShapeBase.NOT_SET,
        attribute_names: typing.List[shapes.InstancesHealthAttribute
                                    ] = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeInstancesHealthResult.from_boto_dict(response)
    ...
    def describe_platform_version(
        ...
        *,
        ...
        return shapes.DescribePlatformVersionResult.from_boto_dict(response)
    ...
    def list_available_solution_stacks(
        ...
        return shapes.ListAvailableSolutionStacksResultMessage.from_boto_dict(
            response
        )
    ...
    def list_platform_versions(
        ...
        *,
        ...
        return shapes.ListPlatformVersionsResult.from_boto_dict(response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        return shapes.ResourceTagsDescriptionMessage.from_boto_dict(response)
    ...
    def rebuild_environment(
        ...
        *,
        ...
        response = self._boto_client.rebuild_environment(
            **_request.to_boto_dict()
        )
    ...
    def request_environment_info(
        ...
        *,
        info_type: shapes.EnvironmentInfoType,
        environment_id: str = ShapeBase.NOT_SET,
        environment_name: str = ShapeBase.NOT_SET,
    ) -> None:
        """
    ...
    def restart_app_server(
        ...
        *,
        ...
        response = self._boto_client.restart_app_server(
            **_request.to_boto_dict()
        )
    ...
    def retrieve_environment_info(
        ...
        *,
        ...
        return shapes.RetrieveEnvironmentInfoResultMessage.from_boto_dict(
            response
        )
    ...
    def terminate_environment(
        ...
        *,
        ...
        response = self._boto_client.terminate_environment(
            **_request.to_boto_dict()
        )
    ...
    def update_application_resource_lifecycle(
        ...
        *,
        ...
        return shapes.ApplicationResourceLifecycleDescriptionMessage.from_boto_dict(
            response
        )
    ...
    def validate_configuration_settings(
        ...
        *,
        ...
        return shapes.ConfigurationSettingsValidationMessages.from_boto_dict(
            response
        )
