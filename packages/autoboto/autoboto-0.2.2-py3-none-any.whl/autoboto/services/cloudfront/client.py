...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("cloudfront", *args, **kwargs)
    ...
    def list_cloud_front_origin_access_identities(
        ...
        *,
        ...
        response = self._boto_client.list_cloud_front_origin_access_identities(
            **_request.to_boto_dict()
        )
    ...
    def list_distributions(
        ...
        *,
        ...
        response = self._boto_client.list_distributions(
            **_request.to_boto_dict()
        )
    ...
    def list_invalidations(
        ...
        *,
        ...
        response = self._boto_client.list_invalidations(
            **_request.to_boto_dict()
        )
    ...
    def list_streaming_distributions(
        ...
        *,
        ...
        response = self._boto_client.list_streaming_distributions(
            **_request.to_boto_dict()
        )
