...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("polly", *args, **kwargs)
    ...
    def delete_lexicon(
        ...
        *,
        ...
        response = self._boto_client.delete_lexicon(**_request.to_boto_dict())

        return shapes.DeleteLexiconOutput.from_boto_dict(response)

    def describe_voices(
        self,
        _request: shapes.DescribeVoicesInput = None,
        *,
        language_code: shapes.LanguageCode = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_voices(**_request.to_boto_dict())

        return shapes.DescribeVoicesOutput.from_boto_dict(response)
    ...
    def get_lexicon(
        ...
        *,
        ...
        response = self._boto_client.get_lexicon(**_request.to_boto_dict())

        return shapes.GetLexiconOutput.from_boto_dict(response)
    ...
    def get_speech_synthesis_task(
        ...
        *,
        ...
        return shapes.GetSpeechSynthesisTaskOutput.from_boto_dict(response)
    ...
    def list_lexicons(
        ...
        *,
        ...
        response = self._boto_client.list_lexicons(**_request.to_boto_dict())

        return shapes.ListLexiconsOutput.from_boto_dict(response)
    ...
    def list_speech_synthesis_tasks(
        ...
        *,
        ...
        next_token: str = ShapeBase.NOT_SET,
        status: shapes.TaskStatus = ShapeBase.NOT_SET,
        ...
        return shapes.ListSpeechSynthesisTasksOutput.from_boto_dict(response)
    ...
    def put_lexicon(
        ...
        *,
        ...
        response = self._boto_client.put_lexicon(**_request.to_boto_dict())

        return shapes.PutLexiconOutput.from_boto_dict(response)

    def start_speech_synthesis_task(
        self,
        _request: shapes.StartSpeechSynthesisTaskInput = None,
        *,
        output_format: shapes.OutputFormat,
        output_s3_bucket_name: str,
        text: str,
        voice_id: shapes.VoiceId,
        ...
        speech_mark_types: typing.List[shapes.SpeechMarkType
                                      ] = ShapeBase.NOT_SET,
        text_type: shapes.TextType = ShapeBase.NOT_SET,
        language_code: shapes.LanguageCode = ShapeBase.NOT_SET,
        ...
        return shapes.StartSpeechSynthesisTaskOutput.from_boto_dict(response)
    ...
    def synthesize_speech(
        ...
        *,
        ...
        return shapes.SynthesizeSpeechOutput.from_boto_dict(response)
