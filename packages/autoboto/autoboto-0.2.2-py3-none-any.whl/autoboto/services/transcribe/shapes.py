    ...
    def _get_boto_mapping(cls):
        return [
            (
                "status",
                "Status",
                TypeInfo(TranscriptionJobStatus),
            ),
            (
                "job_name_contains",
                "JobNameContains",
...
class StartTranscriptionJobRequest(ShapeBase):
    ...
    media_format: "MediaFormat" = dataclasses.field(default=ShapeBase.NOT_SET, )
