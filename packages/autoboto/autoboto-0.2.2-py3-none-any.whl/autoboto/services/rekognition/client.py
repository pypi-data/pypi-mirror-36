...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("rekognition", *args, **kwargs)
    ...
    def compare_faces(
        ...
        *,
        ...
        response = self._boto_client.compare_faces(**_request.to_boto_dict())

        return shapes.CompareFacesResponse.from_boto_dict(response)
    ...
    def create_collection(
        ...
        *,
        ...
        response = self._boto_client.create_collection(
            **_request.to_boto_dict()
        )

        return shapes.CreateCollectionResponse.from_boto_dict(response)
    ...
    def create_stream_processor(
        ...
        *,
        ...
        return shapes.CreateStreamProcessorResponse.from_boto_dict(response)
    ...
    def delete_collection(
        ...
        *,
        ...
        response = self._boto_client.delete_collection(
            **_request.to_boto_dict()
        )

        return shapes.DeleteCollectionResponse.from_boto_dict(response)
    ...
    def delete_faces(
        ...
        *,
        ...
        response = self._boto_client.delete_faces(**_request.to_boto_dict())

        return shapes.DeleteFacesResponse.from_boto_dict(response)
    ...
    def delete_stream_processor(
        ...
        *,
        ...
        return shapes.DeleteStreamProcessorResponse.from_boto_dict(response)
    ...
    def describe_collection(
        ...
        *,
        ...
        response = self._boto_client.describe_collection(
            **_request.to_boto_dict()
        )

        return shapes.DescribeCollectionResponse.from_boto_dict(response)
    ...
    def describe_stream_processor(
        ...
        *,
        ...
        return shapes.DescribeStreamProcessorResponse.from_boto_dict(response)
    ...
    def detect_faces(
        ...
        *,
        ...
        response = self._boto_client.detect_faces(**_request.to_boto_dict())

        return shapes.DetectFacesResponse.from_boto_dict(response)
    ...
    def detect_labels(
        ...
        *,
        ...
        response = self._boto_client.detect_labels(**_request.to_boto_dict())

        return shapes.DetectLabelsResponse.from_boto_dict(response)
    ...
    def detect_moderation_labels(
        ...
        *,
        ...
        return shapes.DetectModerationLabelsResponse.from_boto_dict(response)
    ...
    def detect_text(
        ...
        *,
        ...
        response = self._boto_client.detect_text(**_request.to_boto_dict())

        return shapes.DetectTextResponse.from_boto_dict(response)
    ...
    def get_celebrity_info(
        ...
        *,
        ...
        response = self._boto_client.get_celebrity_info(
            **_request.to_boto_dict()
        )

        return shapes.GetCelebrityInfoResponse.from_boto_dict(response)
    ...
    def get_celebrity_recognition(
        ...
        *,
        ...
        sort_by: shapes.CelebrityRecognitionSortBy = ShapeBase.NOT_SET,
        ...
        return shapes.GetCelebrityRecognitionResponse.from_boto_dict(response)
    ...
    def get_content_moderation(
        ...
        *,
        ...
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        sort_by: shapes.ContentModerationSortBy = ShapeBase.NOT_SET,
        ...
        return shapes.GetContentModerationResponse.from_boto_dict(response)
    ...
    def get_face_detection(
        ...
        *,
        ...
        response = self._boto_client.get_face_detection(
            **_request.to_boto_dict()
        )

        return shapes.GetFaceDetectionResponse.from_boto_dict(response)
    ...
    def get_face_search(
        ...
        *,
        ...
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        sort_by: shapes.FaceSearchSortBy = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.get_face_search(**_request.to_boto_dict())

        return shapes.GetFaceSearchResponse.from_boto_dict(response)
    ...
    def get_label_detection(
        ...
        *,
        ...
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        sort_by: shapes.LabelDetectionSortBy = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.get_label_detection(
            **_request.to_boto_dict()
        )

        return shapes.GetLabelDetectionResponse.from_boto_dict(response)
    ...
    def get_person_tracking(
        ...
        *,
        ...
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        sort_by: shapes.PersonTrackingSortBy = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.get_person_tracking(
            **_request.to_boto_dict()
        )

        return shapes.GetPersonTrackingResponse.from_boto_dict(response)
    ...
    def index_faces(
        ...
        *,
        ...
        detection_attributes: typing.List[shapes.Attribute] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.index_faces(**_request.to_boto_dict())

        return shapes.IndexFacesResponse.from_boto_dict(response)
    ...
    def list_collections(
        ...
        *,
        ...
        response = self._boto_client.list_collections(**_request.to_boto_dict())

        return shapes.ListCollectionsResponse.from_boto_dict(response)
    ...
    def list_faces(
        ...
        *,
        ...
        response = self._boto_client.list_faces(**_request.to_boto_dict())

        return shapes.ListFacesResponse.from_boto_dict(response)
    ...
    def list_stream_processors(
        ...
        *,
        ...
        response = self._boto_client.list_stream_processors(
            **_request.to_boto_dict()
        )

        return shapes.ListStreamProcessorsResponse.from_boto_dict(response)
    ...
    def recognize_celebrities(
        ...
        *,
        ...
        response = self._boto_client.recognize_celebrities(
            **_request.to_boto_dict()
        )

        return shapes.RecognizeCelebritiesResponse.from_boto_dict(response)
    ...
    def search_faces(
        ...
        *,
        ...
        response = self._boto_client.search_faces(**_request.to_boto_dict())

        return shapes.SearchFacesResponse.from_boto_dict(response)
    ...
    def search_faces_by_image(
        ...
        *,
        ...
        response = self._boto_client.search_faces_by_image(
            **_request.to_boto_dict()
        )

        return shapes.SearchFacesByImageResponse.from_boto_dict(response)
    ...
    def start_celebrity_recognition(
        ...
        *,
        ...
        return shapes.StartCelebrityRecognitionResponse.from_boto_dict(response)
    ...
    def start_content_moderation(
        ...
        *,
        ...
        return shapes.StartContentModerationResponse.from_boto_dict(response)
    ...
    def start_face_detection(
        ...
        *,
        ...
        client_request_token: str = ShapeBase.NOT_SET,
        notification_channel: shapes.NotificationChannel = ShapeBase.NOT_SET,
        face_attributes: shapes.FaceAttributes = ShapeBase.NOT_SET,
        job_tag: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.start_face_detection(
            **_request.to_boto_dict()
        )

        return shapes.StartFaceDetectionResponse.from_boto_dict(response)
    ...
    def start_face_search(
        ...
        *,
        ...
        response = self._boto_client.start_face_search(
            **_request.to_boto_dict()
        )

        return shapes.StartFaceSearchResponse.from_boto_dict(response)
    ...
    def start_label_detection(
        ...
        *,
        ...
        response = self._boto_client.start_label_detection(
            **_request.to_boto_dict()
        )

        return shapes.StartLabelDetectionResponse.from_boto_dict(response)
    ...
    def start_person_tracking(
        ...
        *,
        ...
        response = self._boto_client.start_person_tracking(
            **_request.to_boto_dict()
        )

        return shapes.StartPersonTrackingResponse.from_boto_dict(response)
    ...
    def start_stream_processor(
        ...
        *,
        ...
        return shapes.StartStreamProcessorResponse.from_boto_dict(response)
    ...
    def stop_stream_processor(
        ...
        *,
        ...
        response = self._boto_client.stop_stream_processor(
            **_request.to_boto_dict()
        )

        return shapes.StopStreamProcessorResponse.from_boto_dict(response)
