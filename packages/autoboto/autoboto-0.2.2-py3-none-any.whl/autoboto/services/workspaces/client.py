...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("workspaces", *args, **kwargs)
    ...
    def describe_workspace_bundles(
        ...
        *,
        ...
        response = self._boto_client.describe_workspace_bundles(
            **_request.to_boto_dict()
        )
    ...
    def describe_workspace_directories(
        ...
        *,
        ...
        response = self._boto_client.describe_workspace_directories(
            **_request.to_boto_dict()
        )
    ...
    def describe_workspaces(
        ...
        *,
        ...
        response = self._boto_client.describe_workspaces(
            **_request.to_boto_dict()
        )
