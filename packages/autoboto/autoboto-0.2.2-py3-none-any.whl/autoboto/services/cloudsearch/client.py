...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("cloudsearch", *args, **kwargs)
    ...
    def build_suggesters(
        ...
        *,
        ...
        response = self._boto_client.build_suggesters(**_request.to_boto_dict())

        return shapes.BuildSuggestersResponse.from_boto_dict(response)
    ...
    def create_domain(
        ...
        *,
        ...
        return shapes.CreateDomainResponse.from_boto_dict(response)
    ...
    def define_analysis_scheme(
        ...
        *,
        ...
        return shapes.DefineAnalysisSchemeResponse.from_boto_dict(response)
    ...
    def define_expression(
        ...
        *,
        ...
        response = self._boto_client.define_expression(
            **_request.to_boto_dict()
        )

        return shapes.DefineExpressionResponse.from_boto_dict(response)
    ...
    def define_index_field(
        ...
        *,
        ...
        response = self._boto_client.define_index_field(
            **_request.to_boto_dict()
        )

        return shapes.DefineIndexFieldResponse.from_boto_dict(response)
    ...
    def define_suggester(
        ...
        *,
        ...
        response = self._boto_client.define_suggester(**_request.to_boto_dict())

        return shapes.DefineSuggesterResponse.from_boto_dict(response)
    ...
    def delete_analysis_scheme(
        ...
        *,
        ...
        return shapes.DeleteAnalysisSchemeResponse.from_boto_dict(response)
    ...
    def delete_domain(
        ...
        *,
        ...
        return shapes.DeleteDomainResponse.from_boto_dict(response)
    ...
    def delete_expression(
        ...
        *,
        ...
        response = self._boto_client.delete_expression(
            **_request.to_boto_dict()
        )

        return shapes.DeleteExpressionResponse.from_boto_dict(response)
    ...
    def delete_index_field(
        ...
        *,
        ...
        response = self._boto_client.delete_index_field(
            **_request.to_boto_dict()
        )

        return shapes.DeleteIndexFieldResponse.from_boto_dict(response)
    ...
    def delete_suggester(
        ...
        *,
        ...
        response = self._boto_client.delete_suggester(**_request.to_boto_dict())

        return shapes.DeleteSuggesterResponse.from_boto_dict(response)
    ...
    def describe_analysis_schemes(
        ...
        *,
        ...
        return shapes.DescribeAnalysisSchemesResponse.from_boto_dict(response)
    ...
    def describe_availability_options(
        ...
        *,
        ...
        return shapes.DescribeAvailabilityOptionsResponse.from_boto_dict(
            response
        )
    ...
    def describe_domains(
        ...
        *,
        ...
        response = self._boto_client.describe_domains(**_request.to_boto_dict())

        return shapes.DescribeDomainsResponse.from_boto_dict(response)
    ...
    def describe_expressions(
        ...
        *,
        ...
        response = self._boto_client.describe_expressions(
            **_request.to_boto_dict()
        )

        return shapes.DescribeExpressionsResponse.from_boto_dict(response)
    ...
    def describe_index_fields(
        ...
        *,
        ...
        response = self._boto_client.describe_index_fields(
            **_request.to_boto_dict()
        )

        return shapes.DescribeIndexFieldsResponse.from_boto_dict(response)
    ...
    def describe_scaling_parameters(
        ...
        *,
        ...
        return shapes.DescribeScalingParametersResponse.from_boto_dict(response)
    ...
    def describe_service_access_policies(
        ...
        *,
        ...
        return shapes.DescribeServiceAccessPoliciesResponse.from_boto_dict(
            response
        )
    ...
    def describe_suggesters(
        ...
        *,
        ...
        response = self._boto_client.describe_suggesters(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSuggestersResponse.from_boto_dict(response)
    ...
    def index_documents(
        ...
        *,
        ...
        response = self._boto_client.index_documents(**_request.to_boto_dict())

        return shapes.IndexDocumentsResponse.from_boto_dict(response)
    ...
    def list_domain_names(self) -> shapes.ListDomainNamesResponse:
        ...
        return shapes.ListDomainNamesResponse.from_boto_dict(response)
    ...
    def update_availability_options(
        ...
        *,
        ...
        return shapes.UpdateAvailabilityOptionsResponse.from_boto_dict(response)
    ...
    def update_scaling_parameters(
        ...
        *,
        ...
        return shapes.UpdateScalingParametersResponse.from_boto_dict(response)
    ...
    def update_service_access_policies(
        ...
        *,
        ...
        return shapes.UpdateServiceAccessPoliciesResponse.from_boto_dict(
            response
        )
