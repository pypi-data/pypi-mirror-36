...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client(
            "marketplacecommerceanalytics", *args, **kwargs
        )
    ...
    def generate_data_set(
        ...
        *,
        data_set_type: shapes.DataSetType,
        ...
        response = self._boto_client.generate_data_set(
            **_request.to_boto_dict()
        )

        return shapes.GenerateDataSetResult.from_boto_dict(response)

    def start_support_data_export(
        self,
        _request: shapes.StartSupportDataExportRequest = None,
        *,
        data_set_type: shapes.SupportDataSetType,
        ...
        return shapes.StartSupportDataExportResult.from_boto_dict(response)
