...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("pi", *args, **kwargs)

    def describe_dimension_keys(
        self,
        _request: shapes.DescribeDimensionKeysRequest = None,
        *,
        service_type: shapes.ServiceType,
        identifier: str,
        ...
        return shapes.DescribeDimensionKeysResponse.from_boto_dict(response)
    ...
    def get_resource_metrics(
        ...
        *,
        ...
        response = self._boto_client.get_resource_metrics(
            **_request.to_boto_dict()
        )

        return shapes.GetResourceMetricsResponse.from_boto_dict(response)
