...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("iot1click-devices", *args, **kwargs)
    ...
    def claim_devices_by_claim_code(
        ...
        *,
        ...
        return shapes.ClaimDevicesByClaimCodeResponse.from_boto_dict(response)
    ...
    def describe_device(
        ...
        *,
        ...
        response = self._boto_client.describe_device(**_request.to_boto_dict())

        return shapes.DescribeDeviceResponse.from_boto_dict(response)
    ...
    def finalize_device_claim(
        ...
        *,
        ...
        response = self._boto_client.finalize_device_claim(
            **_request.to_boto_dict()
        )

        return shapes.FinalizeDeviceClaimResponse.from_boto_dict(response)
    ...
    def get_device_methods(
        ...
        *,
        ...
        response = self._boto_client.get_device_methods(
            **_request.to_boto_dict()
        )

        return shapes.GetDeviceMethodsResponse.from_boto_dict(response)
    ...
    def initiate_device_claim(
        ...
        *,
        ...
        response = self._boto_client.initiate_device_claim(
            **_request.to_boto_dict()
        )

        return shapes.InitiateDeviceClaimResponse.from_boto_dict(response)
    ...
    def invoke_device_method(
        ...
        *,
        ...
        response = self._boto_client.invoke_device_method(
            **_request.to_boto_dict()
        )

        return shapes.InvokeDeviceMethodResponse.from_boto_dict(response)
    ...
    def unclaim_device(
        ...
        *,
        ...
        response = self._boto_client.unclaim_device(**_request.to_boto_dict())

        return shapes.UnclaimDeviceResponse.from_boto_dict(response)
    ...
    def update_device_state(
        ...
        *,
        ...
        response = self._boto_client.update_device_state(
            **_request.to_boto_dict()
        )

        return shapes.UpdateDeviceStateResponse.from_boto_dict(response)
