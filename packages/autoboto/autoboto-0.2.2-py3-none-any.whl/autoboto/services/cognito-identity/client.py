...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("cognito-identity", *args, **kwargs)
    ...
    def create_identity_pool(
        ...
        *,
        ...
        response = self._boto_client.create_identity_pool(
            **_request.to_boto_dict()
        )

        return shapes.IdentityPool.from_boto_dict(response)
    ...
    def delete_identities(
        ...
        *,
        ...
        response = self._boto_client.delete_identities(
            **_request.to_boto_dict()
        )

        return shapes.DeleteIdentitiesResponse.from_boto_dict(response)
    ...
    def delete_identity_pool(
        ...
        *,
        ...
        response = self._boto_client.delete_identity_pool(
            **_request.to_boto_dict()
        )
    ...
    def describe_identity(
        ...
        *,
        ...
        response = self._boto_client.describe_identity(
            **_request.to_boto_dict()
        )

        return shapes.IdentityDescription.from_boto_dict(response)
    ...
    def get_credentials_for_identity(
        ...
        *,
        ...
        return shapes.GetCredentialsForIdentityResponse.from_boto_dict(response)
    ...
    def get_id(
        ...
        *,
        ...
        response = self._boto_client.get_id(**_request.to_boto_dict())

        return shapes.GetIdResponse.from_boto_dict(response)
    ...
    def get_identity_pool_roles(
        ...
        *,
        ...
        return shapes.GetIdentityPoolRolesResponse.from_boto_dict(response)
    ...
    def get_open_id_token(
        ...
        *,
        ...
        response = self._boto_client.get_open_id_token(
            **_request.to_boto_dict()
        )

        return shapes.GetOpenIdTokenResponse.from_boto_dict(response)
    ...
    def get_open_id_token_for_developer_identity(
        ...
        *,
        ...
        return shapes.GetOpenIdTokenForDeveloperIdentityResponse.from_boto_dict(
            response
        )
    ...
    def list_identity_pools(
        ...
        *,
        ...
        response = self._boto_client.list_identity_pools(
            **_request.to_boto_dict()
        )

        return shapes.ListIdentityPoolsResponse.from_boto_dict(response)
    ...
    def lookup_developer_identity(
        ...
        *,
        ...
        return shapes.LookupDeveloperIdentityResponse.from_boto_dict(response)
    ...
    def merge_developer_identities(
        ...
        *,
        ...
        return shapes.MergeDeveloperIdentitiesResponse.from_boto_dict(response)
    ...
    def unlink_identity(
        ...
        *,
        ...
        response = self._boto_client.unlink_identity(**_request.to_boto_dict())
    ...
    def update_identity_pool(
        ...
        *,
        ...
        response = self._boto_client.update_identity_pool(
            **_request.to_boto_dict()
        )
