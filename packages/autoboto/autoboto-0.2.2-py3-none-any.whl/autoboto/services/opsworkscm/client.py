...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("opsworkscm", *args, **kwargs)
    ...
    def associate_node(
        ...
        *,
        ...
        response = self._boto_client.associate_node(**_request.to_boto_dict())

        return shapes.AssociateNodeResponse.from_boto_dict(response)
    ...
    def create_backup(
        ...
        *,
        ...
        return shapes.CreateBackupResponse.from_boto_dict(response)
    ...
    def create_server(
        ...
        *,
        ...
        response = self._boto_client.create_server(**_request.to_boto_dict())

        return shapes.CreateServerResponse.from_boto_dict(response)
    ...
    def delete_backup(
        ...
        *,
        ...
        return shapes.DeleteBackupResponse.from_boto_dict(response)
    ...
    def delete_server(
        ...
        *,
        ...
        response = self._boto_client.delete_server(**_request.to_boto_dict())

        return shapes.DeleteServerResponse.from_boto_dict(response)
    ...
    def describe_backups(
        ...
        *,
        ...
        response = self._boto_client.describe_backups(**_request.to_boto_dict())

        return shapes.DescribeBackupsResponse.from_boto_dict(response)
    ...
    def describe_node_association_status(
        ...
        *,
        ...
        return shapes.DescribeNodeAssociationStatusResponse.from_boto_dict(
            response
        )
    ...
    def describe_servers(
        ...
        *,
        ...
        response = self._boto_client.describe_servers(**_request.to_boto_dict())

        return shapes.DescribeServersResponse.from_boto_dict(response)
    ...
    def disassociate_node(
        ...
        *,
        ...
        response = self._boto_client.disassociate_node(
            **_request.to_boto_dict()
        )

        return shapes.DisassociateNodeResponse.from_boto_dict(response)
    ...
    def restore_server(
        ...
        *,
        ...
        response = self._boto_client.restore_server(**_request.to_boto_dict())

        return shapes.RestoreServerResponse.from_boto_dict(response)
    ...
    def start_maintenance(
        ...
        *,
        ...
        response = self._boto_client.start_maintenance(
            **_request.to_boto_dict()
        )

        return shapes.StartMaintenanceResponse.from_boto_dict(response)
    ...
    def update_server(
        ...
        *,
        ...
        response = self._boto_client.update_server(**_request.to_boto_dict())

        return shapes.UpdateServerResponse.from_boto_dict(response)
    ...
    def update_server_engine_attributes(
        ...
        *,
        ...
        return shapes.UpdateServerEngineAttributesResponse.from_boto_dict(
            response
        )
