...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("codecommit", *args, **kwargs)
    ...
    def describe_pull_request_events(
        ...
        *,
        ...
        response = self._boto_client.describe_pull_request_events(
            **_request.to_boto_dict()
        )
    ...
    def get_comments_for_compared_commit(
        ...
        *,
        ...
        response = self._boto_client.get_comments_for_compared_commit(
            **_request.to_boto_dict()
        )
    ...
    def get_comments_for_pull_request(
        ...
        *,
        ...
        response = self._boto_client.get_comments_for_pull_request(
            **_request.to_boto_dict()
        )
    ...
    def get_differences(
        ...
        *,
        ...
        response = self._boto_client.get_differences(**_request.to_boto_dict())
    ...
    def list_branches(
        ...
        *,
        ...
        response = self._boto_client.list_branches(**_request.to_boto_dict())
    ...
    def list_pull_requests(
        ...
        *,
        ...
        response = self._boto_client.list_pull_requests(
            **_request.to_boto_dict()
        )
    ...
    def list_repositories(
        ...
        *,
        ...
        response = self._boto_client.list_repositories(
            **_request.to_boto_dict()
        )
