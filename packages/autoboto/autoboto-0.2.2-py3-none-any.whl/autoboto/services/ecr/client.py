...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("ecr", *args, **kwargs)
    ...
    def batch_check_layer_availability(
        ...
        *,
        ...
        return shapes.BatchCheckLayerAvailabilityResponse.from_boto_dict(
            response
        )
    ...
    def batch_delete_image(
        ...
        *,
        ...
        response = self._boto_client.batch_delete_image(
            **_request.to_boto_dict()
        )

        return shapes.BatchDeleteImageResponse.from_boto_dict(response)
    ...
    def batch_get_image(
        ...
        *,
        ...
        response = self._boto_client.batch_get_image(**_request.to_boto_dict())

        return shapes.BatchGetImageResponse.from_boto_dict(response)
    ...
    def complete_layer_upload(
        ...
        *,
        ...
        response = self._boto_client.complete_layer_upload(
            **_request.to_boto_dict()
        )

        return shapes.CompleteLayerUploadResponse.from_boto_dict(response)
    ...
    def create_repository(
        ...
        *,
        ...
        return shapes.CreateRepositoryResponse.from_boto_dict(response)
    ...
    def delete_lifecycle_policy(
        ...
        *,
        ...
        return shapes.DeleteLifecyclePolicyResponse.from_boto_dict(response)
    ...
    def delete_repository(
        ...
        *,
        ...
        return shapes.DeleteRepositoryResponse.from_boto_dict(response)
    ...
    def delete_repository_policy(
        ...
        *,
        ...
        return shapes.DeleteRepositoryPolicyResponse.from_boto_dict(response)
    ...
    def describe_images(
        ...
        *,
        ...
        return shapes.DescribeImagesResponse.from_boto_dict(response)
    ...
    def describe_repositories(
        ...
        *,
        ...
        response = self._boto_client.describe_repositories(
            **_request.to_boto_dict()
        )

        return shapes.DescribeRepositoriesResponse.from_boto_dict(response)
    ...
    def get_authorization_token(
        ...
        *,
        ...
        return shapes.GetAuthorizationTokenResponse.from_boto_dict(response)
    ...
    def get_download_url_for_layer(
        ...
        *,
        ...
        return shapes.GetDownloadUrlForLayerResponse.from_boto_dict(response)
    ...
    def get_lifecycle_policy(
        ...
        *,
        ...
        response = self._boto_client.get_lifecycle_policy(
            **_request.to_boto_dict()
        )

        return shapes.GetLifecyclePolicyResponse.from_boto_dict(response)
    ...
    def get_lifecycle_policy_preview(
        ...
        *,
        ...
        return shapes.GetLifecyclePolicyPreviewResponse.from_boto_dict(response)
    ...
    def get_repository_policy(
        ...
        *,
        ...
        response = self._boto_client.get_repository_policy(
            **_request.to_boto_dict()
        )

        return shapes.GetRepositoryPolicyResponse.from_boto_dict(response)
    ...
    def initiate_layer_upload(
        ...
        *,
        ...
        response = self._boto_client.initiate_layer_upload(
            **_request.to_boto_dict()
        )

        return shapes.InitiateLayerUploadResponse.from_boto_dict(response)
    ...
    def list_images(
        ...
        *,
        ...
        response = self._boto_client.list_images(**_request.to_boto_dict())

        return shapes.ListImagesResponse.from_boto_dict(response)
    ...
    def put_image(
        ...
        *,
        ...
        response = self._boto_client.put_image(**_request.to_boto_dict())

        return shapes.PutImageResponse.from_boto_dict(response)
    ...
    def put_lifecycle_policy(
        ...
        *,
        ...
        response = self._boto_client.put_lifecycle_policy(
            **_request.to_boto_dict()
        )

        return shapes.PutLifecyclePolicyResponse.from_boto_dict(response)
    ...
    def set_repository_policy(
        ...
        *,
        ...
        response = self._boto_client.set_repository_policy(
            **_request.to_boto_dict()
        )

        return shapes.SetRepositoryPolicyResponse.from_boto_dict(response)
    ...
    def start_lifecycle_policy_preview(
        ...
        *,
        ...
        return shapes.StartLifecyclePolicyPreviewResponse.from_boto_dict(
            response
        )
    ...
    def upload_layer_part(
        ...
        *,
        ...
        response = self._boto_client.upload_layer_part(
            **_request.to_boto_dict()
        )

        return shapes.UploadLayerPartResponse.from_boto_dict(response)
