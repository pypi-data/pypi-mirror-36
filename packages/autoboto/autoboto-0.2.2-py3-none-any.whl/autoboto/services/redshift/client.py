...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("redshift", *args, **kwargs)
    ...
    def describe_cluster_parameter_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_cluster_parameter_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_cluster_parameters(
        ...
        *,
        ...
        response = self._boto_client.describe_cluster_parameters(
            **_request.to_boto_dict()
        )
    ...
    def describe_cluster_security_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_cluster_security_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_cluster_snapshots(
        ...
        *,
        ...
        response = self._boto_client.describe_cluster_snapshots(
            **_request.to_boto_dict()
        )
    ...
    def describe_cluster_subnet_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_cluster_subnet_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_cluster_versions(
        ...
        *,
        ...
        response = self._boto_client.describe_cluster_versions(
            **_request.to_boto_dict()
        )
    ...
    def describe_clusters(
        ...
        *,
        ...
        response = self._boto_client.describe_clusters(
            **_request.to_boto_dict()
        )
    ...
    def describe_default_cluster_parameters(
        ...
        *,
        ...
        response = self._boto_client.describe_default_cluster_parameters(
            **_request.to_boto_dict()
        )
    ...
    def describe_hsm_client_certificates(
        ...
        *,
        ...
        response = self._boto_client.describe_hsm_client_certificates(
            **_request.to_boto_dict()
        )
    ...
    def describe_hsm_configurations(
        ...
        *,
        ...
        response = self._boto_client.describe_hsm_configurations(
            **_request.to_boto_dict()
        )
    ...
    def describe_orderable_cluster_options(
        ...
        *,
        ...
        response = self._boto_client.describe_orderable_cluster_options(
            **_request.to_boto_dict()
        )
    ...
    def describe_reserved_node_offerings(
        ...
        *,
        ...
        response = self._boto_client.describe_reserved_node_offerings(
            **_request.to_boto_dict()
        )
    ...
    def describe_reserved_nodes(
        ...
        *,
        ...
        response = self._boto_client.describe_reserved_nodes(
            **_request.to_boto_dict()
        )
