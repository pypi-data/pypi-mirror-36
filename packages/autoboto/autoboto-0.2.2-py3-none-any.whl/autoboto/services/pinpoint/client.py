...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("pinpoint", *args, **kwargs)
    ...
    def create_app(
        ...
        *,
        ...
        response = self._boto_client.create_app(**_request.to_boto_dict())

        return shapes.CreateAppResponse.from_boto_dict(response)
    ...
    def create_campaign(
        ...
        *,
        ...
        response = self._boto_client.create_campaign(**_request.to_boto_dict())

        return shapes.CreateCampaignResponse.from_boto_dict(response)
    ...
    def create_export_job(
        ...
        *,
        ...
        response = self._boto_client.create_export_job(
            **_request.to_boto_dict()
        )

        return shapes.CreateExportJobResponse.from_boto_dict(response)
    ...
    def create_import_job(
        ...
        *,
        ...
        response = self._boto_client.create_import_job(
            **_request.to_boto_dict()
        )

        return shapes.CreateImportJobResponse.from_boto_dict(response)
    ...
    def create_segment(
        ...
        *,
        ...
        response = self._boto_client.create_segment(**_request.to_boto_dict())

        return shapes.CreateSegmentResponse.from_boto_dict(response)
    ...
    def delete_adm_channel(
        ...
        *,
        ...
        response = self._boto_client.delete_adm_channel(
            **_request.to_boto_dict()
        )

        return shapes.DeleteAdmChannelResponse.from_boto_dict(response)
    ...
    def delete_apns_channel(
        ...
        *,
        ...
        response = self._boto_client.delete_apns_channel(
            **_request.to_boto_dict()
        )

        return shapes.DeleteApnsChannelResponse.from_boto_dict(response)
    ...
    def delete_apns_sandbox_channel(
        ...
        *,
        ...
        return shapes.DeleteApnsSandboxChannelResponse.from_boto_dict(response)
    ...
    def delete_apns_voip_channel(
        ...
        *,
        ...
        return shapes.DeleteApnsVoipChannelResponse.from_boto_dict(response)
    ...
    def delete_apns_voip_sandbox_channel(
        ...
        *,
        ...
        return shapes.DeleteApnsVoipSandboxChannelResponse.from_boto_dict(
            response
        )
    ...
    def delete_app(
        ...
        *,
        ...
        response = self._boto_client.delete_app(**_request.to_boto_dict())

        return shapes.DeleteAppResponse.from_boto_dict(response)
    ...
    def delete_baidu_channel(
        ...
        *,
        ...
        response = self._boto_client.delete_baidu_channel(
            **_request.to_boto_dict()
        )

        return shapes.DeleteBaiduChannelResponse.from_boto_dict(response)
    ...
    def delete_campaign(
        ...
        *,
        ...
        response = self._boto_client.delete_campaign(**_request.to_boto_dict())

        return shapes.DeleteCampaignResponse.from_boto_dict(response)
    ...
    def delete_email_channel(
        ...
        *,
        ...
        response = self._boto_client.delete_email_channel(
            **_request.to_boto_dict()
        )

        return shapes.DeleteEmailChannelResponse.from_boto_dict(response)
    ...
    def delete_endpoint(
        ...
        *,
        ...
        return shapes.DeleteEndpointResponse.from_boto_dict(response)
    ...
    def delete_event_stream(
        ...
        *,
        ...
        response = self._boto_client.delete_event_stream(
            **_request.to_boto_dict()
        )

        return shapes.DeleteEventStreamResponse.from_boto_dict(response)
    ...
    def delete_gcm_channel(
        ...
        *,
        ...
        response = self._boto_client.delete_gcm_channel(
            **_request.to_boto_dict()
        )

        return shapes.DeleteGcmChannelResponse.from_boto_dict(response)
    ...
    def delete_segment(
        ...
        *,
        ...
        response = self._boto_client.delete_segment(**_request.to_boto_dict())

        return shapes.DeleteSegmentResponse.from_boto_dict(response)
    ...
    def delete_sms_channel(
        ...
        *,
        ...
        response = self._boto_client.delete_sms_channel(
            **_request.to_boto_dict()
        )

        return shapes.DeleteSmsChannelResponse.from_boto_dict(response)
    ...
    def delete_user_endpoints(
        ...
        *,
        ...
        response = self._boto_client.delete_user_endpoints(
            **_request.to_boto_dict()
        )

        return shapes.DeleteUserEndpointsResponse.from_boto_dict(response)
    ...
    def get_adm_channel(
        ...
        *,
        ...
        response = self._boto_client.get_adm_channel(**_request.to_boto_dict())

        return shapes.GetAdmChannelResponse.from_boto_dict(response)
    ...
    def get_apns_channel(
        ...
        *,
        ...
        response = self._boto_client.get_apns_channel(**_request.to_boto_dict())

        return shapes.GetApnsChannelResponse.from_boto_dict(response)
    ...
    def get_apns_sandbox_channel(
        ...
        *,
        ...
        return shapes.GetApnsSandboxChannelResponse.from_boto_dict(response)
    ...
    def get_apns_voip_channel(
        ...
        *,
        ...
        response = self._boto_client.get_apns_voip_channel(
            **_request.to_boto_dict()
        )

        return shapes.GetApnsVoipChannelResponse.from_boto_dict(response)
    ...
    def get_apns_voip_sandbox_channel(
        ...
        *,
        ...
        return shapes.GetApnsVoipSandboxChannelResponse.from_boto_dict(response)
    ...
    def get_app(
        ...
        *,
        ...
        response = self._boto_client.get_app(**_request.to_boto_dict())

        return shapes.GetAppResponse.from_boto_dict(response)
    ...
    def get_application_settings(
        ...
        *,
        ...
        return shapes.GetApplicationSettingsResponse.from_boto_dict(response)
    ...
    def get_apps(
        ...
        *,
        ...
        response = self._boto_client.get_apps(**_request.to_boto_dict())

        return shapes.GetAppsResponse.from_boto_dict(response)
    ...
    def get_baidu_channel(
        ...
        *,
        ...
        response = self._boto_client.get_baidu_channel(
            **_request.to_boto_dict()
        )

        return shapes.GetBaiduChannelResponse.from_boto_dict(response)
    ...
    def get_campaign(
        ...
        *,
        ...
        response = self._boto_client.get_campaign(**_request.to_boto_dict())

        return shapes.GetCampaignResponse.from_boto_dict(response)
    ...
    def get_campaign_activities(
        ...
        *,
        ...
        return shapes.GetCampaignActivitiesResponse.from_boto_dict(response)
    ...
    def get_campaign_version(
        ...
        *,
        ...
        response = self._boto_client.get_campaign_version(
            **_request.to_boto_dict()
        )

        return shapes.GetCampaignVersionResponse.from_boto_dict(response)
    ...
    def get_campaign_versions(
        ...
        *,
        ...
        response = self._boto_client.get_campaign_versions(
            **_request.to_boto_dict()
        )

        return shapes.GetCampaignVersionsResponse.from_boto_dict(response)
    ...
    def get_campaigns(
        ...
        *,
        ...
        response = self._boto_client.get_campaigns(**_request.to_boto_dict())

        return shapes.GetCampaignsResponse.from_boto_dict(response)
    ...
    def get_channels(
        ...
        *,
        ...
        response = self._boto_client.get_channels(**_request.to_boto_dict())

        return shapes.GetChannelsResponse.from_boto_dict(response)
    ...
    def get_email_channel(
        ...
        *,
        ...
        response = self._boto_client.get_email_channel(
            **_request.to_boto_dict()
        )

        return shapes.GetEmailChannelResponse.from_boto_dict(response)
    ...
    def get_endpoint(
        ...
        *,
        ...
        response = self._boto_client.get_endpoint(**_request.to_boto_dict())

        return shapes.GetEndpointResponse.from_boto_dict(response)
    ...
    def get_event_stream(
        ...
        *,
        ...
        response = self._boto_client.get_event_stream(**_request.to_boto_dict())

        return shapes.GetEventStreamResponse.from_boto_dict(response)
    ...
    def get_export_job(
        ...
        *,
        ...
        response = self._boto_client.get_export_job(**_request.to_boto_dict())

        return shapes.GetExportJobResponse.from_boto_dict(response)
    ...
    def get_export_jobs(
        ...
        *,
        ...
        response = self._boto_client.get_export_jobs(**_request.to_boto_dict())

        return shapes.GetExportJobsResponse.from_boto_dict(response)
    ...
    def get_gcm_channel(
        ...
        *,
        ...
        response = self._boto_client.get_gcm_channel(**_request.to_boto_dict())

        return shapes.GetGcmChannelResponse.from_boto_dict(response)
    ...
    def get_import_job(
        ...
        *,
        ...
        response = self._boto_client.get_import_job(**_request.to_boto_dict())

        return shapes.GetImportJobResponse.from_boto_dict(response)
    ...
    def get_import_jobs(
        ...
        *,
        ...
        response = self._boto_client.get_import_jobs(**_request.to_boto_dict())

        return shapes.GetImportJobsResponse.from_boto_dict(response)
    ...
    def get_segment(
        ...
        *,
        ...
        response = self._boto_client.get_segment(**_request.to_boto_dict())

        return shapes.GetSegmentResponse.from_boto_dict(response)
    ...
    def get_segment_export_jobs(
        ...
        *,
        ...
        return shapes.GetSegmentExportJobsResponse.from_boto_dict(response)
    ...
    def get_segment_import_jobs(
        ...
        *,
        ...
        return shapes.GetSegmentImportJobsResponse.from_boto_dict(response)
    ...
    def get_segment_version(
        ...
        *,
        ...
        response = self._boto_client.get_segment_version(
            **_request.to_boto_dict()
        )

        return shapes.GetSegmentVersionResponse.from_boto_dict(response)
    ...
    def get_segment_versions(
        ...
        *,
        ...
        response = self._boto_client.get_segment_versions(
            **_request.to_boto_dict()
        )

        return shapes.GetSegmentVersionsResponse.from_boto_dict(response)
    ...
    def get_segments(
        ...
        *,
        ...
        response = self._boto_client.get_segments(**_request.to_boto_dict())

        return shapes.GetSegmentsResponse.from_boto_dict(response)
    ...
    def get_sms_channel(
        ...
        *,
        ...
        response = self._boto_client.get_sms_channel(**_request.to_boto_dict())

        return shapes.GetSmsChannelResponse.from_boto_dict(response)
    ...
    def get_user_endpoints(
        ...
        *,
        ...
        response = self._boto_client.get_user_endpoints(
            **_request.to_boto_dict()
        )

        return shapes.GetUserEndpointsResponse.from_boto_dict(response)
    ...
    def phone_number_validate(
        ...
        *,
        ...
        response = self._boto_client.phone_number_validate(
            **_request.to_boto_dict()
        )

        return shapes.PhoneNumberValidateResponse.from_boto_dict(response)
    ...
    def put_event_stream(
        ...
        *,
        ...
        response = self._boto_client.put_event_stream(**_request.to_boto_dict())

        return shapes.PutEventStreamResponse.from_boto_dict(response)
    ...
    def put_events(
        ...
        *,
        ...
        response = self._boto_client.put_events(**_request.to_boto_dict())

        return shapes.PutEventsResponse.from_boto_dict(response)
    ...
    def remove_attributes(
        ...
        *,
        ...
        response = self._boto_client.remove_attributes(
            **_request.to_boto_dict()
        )

        return shapes.RemoveAttributesResponse.from_boto_dict(response)
    ...
    def send_messages(
        ...
        *,
        ...
        response = self._boto_client.send_messages(**_request.to_boto_dict())

        return shapes.SendMessagesResponse.from_boto_dict(response)
    ...
    def send_users_messages(
        ...
        *,
        ...
        response = self._boto_client.send_users_messages(
            **_request.to_boto_dict()
        )

        return shapes.SendUsersMessagesResponse.from_boto_dict(response)
    ...
    def update_adm_channel(
        ...
        *,
        ...
        response = self._boto_client.update_adm_channel(
            **_request.to_boto_dict()
        )

        return shapes.UpdateAdmChannelResponse.from_boto_dict(response)
    ...
    def update_apns_channel(
        ...
        *,
        ...
        response = self._boto_client.update_apns_channel(
            **_request.to_boto_dict()
        )

        return shapes.UpdateApnsChannelResponse.from_boto_dict(response)
    ...
    def update_apns_sandbox_channel(
        ...
        *,
        ...
        return shapes.UpdateApnsSandboxChannelResponse.from_boto_dict(response)
    ...
    def update_apns_voip_channel(
        ...
        *,
        ...
        return shapes.UpdateApnsVoipChannelResponse.from_boto_dict(response)
    ...
    def update_apns_voip_sandbox_channel(
        ...
        *,
        ...
        return shapes.UpdateApnsVoipSandboxChannelResponse.from_boto_dict(
            response
        )
    ...
    def update_application_settings(
        ...
        *,
        ...
        return shapes.UpdateApplicationSettingsResponse.from_boto_dict(response)
    ...
    def update_baidu_channel(
        ...
        *,
        ...
        response = self._boto_client.update_baidu_channel(
            **_request.to_boto_dict()
        )

        return shapes.UpdateBaiduChannelResponse.from_boto_dict(response)
    ...
    def update_campaign(
        ...
        *,
        ...
        response = self._boto_client.update_campaign(**_request.to_boto_dict())

        return shapes.UpdateCampaignResponse.from_boto_dict(response)
    ...
    def update_email_channel(
        ...
        *,
        ...
        response = self._boto_client.update_email_channel(
            **_request.to_boto_dict()
        )

        return shapes.UpdateEmailChannelResponse.from_boto_dict(response)
    ...
    def update_endpoint(
        ...
        *,
        ...
        return shapes.UpdateEndpointResponse.from_boto_dict(response)
    ...
    def update_endpoints_batch(
        ...
        *,
        ...
        return shapes.UpdateEndpointsBatchResponse.from_boto_dict(response)
    ...
    def update_gcm_channel(
        ...
        *,
        ...
        response = self._boto_client.update_gcm_channel(
            **_request.to_boto_dict()
        )

        return shapes.UpdateGcmChannelResponse.from_boto_dict(response)
    ...
    def update_segment(
        ...
        *,
        ...
        response = self._boto_client.update_segment(**_request.to_boto_dict())

        return shapes.UpdateSegmentResponse.from_boto_dict(response)
    ...
    def update_sms_channel(
        ...
        *,
        ...
        response = self._boto_client.update_sms_channel(
            **_request.to_boto_dict()
        )

        return shapes.UpdateSmsChannelResponse.from_boto_dict(response)
