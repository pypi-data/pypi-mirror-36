...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("kinesis-video-media", *args, **kwargs)
    ...
    def get_media(
        ...
        *,
        ...
        response = self._boto_client.get_media(**_request.to_boto_dict())

        return shapes.GetMediaOutput.from_boto_dict(response)
