...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("dms", *args, **kwargs)
    ...
    def describe_connections(
        ...
        *,
        ...
        response = self._boto_client.describe_connections(
            **_request.to_boto_dict()
        )
    ...
    def describe_endpoint_types(
        ...
        *,
        ...
        response = self._boto_client.describe_endpoint_types(
            **_request.to_boto_dict()
        )
    ...
    def describe_orderable_replication_instances(
        ...
        *,
        ...
        response = self._boto_client.describe_orderable_replication_instances(
            **_request.to_boto_dict()
        )
    ...
    def describe_replication_instances(
        ...
        *,
        ...
        response = self._boto_client.describe_replication_instances(
            **_request.to_boto_dict()
        )
    ...
    def describe_replication_subnet_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_replication_subnet_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_replication_task_assessment_results(
        ...
        *,
        ...
        response = self._boto_client.describe_replication_task_assessment_results(
            **_request.to_boto_dict()
        )
    ...
    def describe_replication_tasks(
        ...
        *,
        ...
        response = self._boto_client.describe_replication_tasks(
            **_request.to_boto_dict()
        )
    ...
    def describe_schemas(
        ...
        *,
        ...
        response = self._boto_client.describe_schemas(**_request.to_boto_dict())
    ...
    def describe_table_statistics(
        ...
        *,
        ...
        response = self._boto_client.describe_table_statistics(
            **_request.to_boto_dict()
        )
