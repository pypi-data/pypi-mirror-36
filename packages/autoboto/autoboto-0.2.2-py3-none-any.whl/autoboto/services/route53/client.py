...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("route53", *args, **kwargs)
    ...
    def associate_vpc_with_hosted_zone(
        ...
        *,
        ...
        return shapes.AssociateVPCWithHostedZoneResponse.from_boto_dict(
            response
        )
    ...
    def change_resource_record_sets(
        ...
        **Limits on ChangeResourceRecordSets Requests**
        ...
        return shapes.ChangeResourceRecordSetsResponse.from_boto_dict(response)

    def change_tags_for_resource(
        self,
        _request: shapes.ChangeTagsForResourceRequest = None,
        *,
        resource_type: shapes.TagResourceType,
        resource_id: str,
        ...
        return shapes.ChangeTagsForResourceResponse.from_boto_dict(response)
    ...
    def create_health_check(
        ...
        **Private Hosted Zones**
        ...
        response = self._boto_client.create_health_check(
            **_request.to_boto_dict()
        )

        return shapes.CreateHealthCheckResponse.from_boto_dict(response)
    ...
    def create_hosted_zone(
        ...
        *,
        ...
        response = self._boto_client.create_hosted_zone(
            **_request.to_boto_dict()
        )

        return shapes.CreateHostedZoneResponse.from_boto_dict(response)
    ...
    def create_query_logging_config(
        ...
        *,
        ...
        return shapes.CreateQueryLoggingConfigResponse.from_boto_dict(response)
    ...
    def create_reusable_delegation_set(
        ...
        *,
        ...
        return shapes.CreateReusableDelegationSetResponse.from_boto_dict(
            response
        )
    ...
    def create_traffic_policy(
        ...
        *,
        ...
        response = self._boto_client.create_traffic_policy(
            **_request.to_boto_dict()
        )

        return shapes.CreateTrafficPolicyResponse.from_boto_dict(response)
    ...
    def create_traffic_policy_instance(
        ...
        *,
        ...
        return shapes.CreateTrafficPolicyInstanceResponse.from_boto_dict(
            response
        )
    ...
    def create_traffic_policy_version(
        ...
        *,
        ...
        return shapes.CreateTrafficPolicyVersionResponse.from_boto_dict(
            response
        )
    ...
    def create_vpc_association_authorization(
        ...
        *,
        ...
        return shapes.CreateVPCAssociationAuthorizationResponse.from_boto_dict(
            response
        )
    ...
    def delete_health_check(
        ...
        *,
        ...
        response = self._boto_client.delete_health_check(
            **_request.to_boto_dict()
        )

        return shapes.DeleteHealthCheckResponse.from_boto_dict(response)
    ...
    def delete_hosted_zone(
        ...
        *,
        ...
        response = self._boto_client.delete_hosted_zone(
            **_request.to_boto_dict()
        )

        return shapes.DeleteHostedZoneResponse.from_boto_dict(response)
    ...
    def delete_query_logging_config(
        ...
        *,
        ...
        return shapes.DeleteQueryLoggingConfigResponse.from_boto_dict(response)
    ...
    def delete_reusable_delegation_set(
        ...
        *,
        ...
        return shapes.DeleteReusableDelegationSetResponse.from_boto_dict(
            response
        )
    ...
    def delete_traffic_policy(
        ...
        *,
        ...
        response = self._boto_client.delete_traffic_policy(
            **_request.to_boto_dict()
        )

        return shapes.DeleteTrafficPolicyResponse.from_boto_dict(response)
    ...
    def delete_traffic_policy_instance(
        ...
        *,
        ...
        return shapes.DeleteTrafficPolicyInstanceResponse.from_boto_dict(
            response
        )
    ...
    def delete_vpc_association_authorization(
        ...
        *,
        ...
        return shapes.DeleteVPCAssociationAuthorizationResponse.from_boto_dict(
            response
        )
    ...
    def disassociate_vpc_from_hosted_zone(
        ...
        *,
        ...
        return shapes.DisassociateVPCFromHostedZoneResponse.from_boto_dict(
            response
        )
    ...
    def get_account_limit(
        ...
        *,
        ...
        response = self._boto_client.get_account_limit(
            **_request.to_boto_dict()
        )

        return shapes.GetAccountLimitResponse.from_boto_dict(response)
    ...
    def get_change(
        ...
        *,
        ...
        response = self._boto_client.get_change(**_request.to_boto_dict())

        return shapes.GetChangeResponse.from_boto_dict(response)
    ...
    def get_checker_ip_ranges(
        ...
        response = self._boto_client.get_checker_ip_ranges(
            **_request.to_boto_dict()
        )

        return shapes.GetCheckerIpRangesResponse.from_boto_dict(response)
    ...
    def get_geo_location(
        ...
        *,
        ...
        response = self._boto_client.get_geo_location(**_request.to_boto_dict())

        return shapes.GetGeoLocationResponse.from_boto_dict(response)
    ...
    def get_health_check(
        ...
        *,
        ...
        response = self._boto_client.get_health_check(**_request.to_boto_dict())

        return shapes.GetHealthCheckResponse.from_boto_dict(response)
    ...
    def get_health_check_count(
        ...
        return shapes.GetHealthCheckCountResponse.from_boto_dict(response)
    ...
    def get_health_check_last_failure_reason(
        ...
        *,
        ...
        return shapes.GetHealthCheckLastFailureReasonResponse.from_boto_dict(
            response
        )
    ...
    def get_health_check_status(
        ...
        *,
        ...
        return shapes.GetHealthCheckStatusResponse.from_boto_dict(response)
    ...
    def get_hosted_zone(
        ...
        *,
        ...
        response = self._boto_client.get_hosted_zone(**_request.to_boto_dict())

        return shapes.GetHostedZoneResponse.from_boto_dict(response)
    ...
    def get_hosted_zone_count(
        ...
        response = self._boto_client.get_hosted_zone_count(
            **_request.to_boto_dict()
        )

        return shapes.GetHostedZoneCountResponse.from_boto_dict(response)

    def get_hosted_zone_limit(
        self,
        _request: shapes.GetHostedZoneLimitRequest = None,
        *,
        type: shapes.HostedZoneLimitType,
        hosted_zone_id: str,
        ...
        response = self._boto_client.get_hosted_zone_limit(
            **_request.to_boto_dict()
        )

        return shapes.GetHostedZoneLimitResponse.from_boto_dict(response)
    ...
    def get_query_logging_config(
        ...
        *,
        ...
        return shapes.GetQueryLoggingConfigResponse.from_boto_dict(response)
    ...
    def get_reusable_delegation_set(
        ...
        *,
        ...
        return shapes.GetReusableDelegationSetResponse.from_boto_dict(response)

    def get_reusable_delegation_set_limit(
        self,
        _request: shapes.GetReusableDelegationSetLimitRequest = None,
        *,
        type: shapes.ReusableDelegationSetLimitType,
        ...
        return shapes.GetReusableDelegationSetLimitResponse.from_boto_dict(
            response
        )
    ...
    def get_traffic_policy(
        ...
        *,
        ...
        response = self._boto_client.get_traffic_policy(
            **_request.to_boto_dict()
        )

        return shapes.GetTrafficPolicyResponse.from_boto_dict(response)
    ...
    def get_traffic_policy_instance(
        ...
        *,
        ...
        return shapes.GetTrafficPolicyInstanceResponse.from_boto_dict(response)
    ...
    def get_traffic_policy_instance_count(
        ...
        return shapes.GetTrafficPolicyInstanceCountResponse.from_boto_dict(
            response
        )
    ...
    def list_geo_locations(
        ...
        *,
        ...
        response = self._boto_client.list_geo_locations(
            **_request.to_boto_dict()
        )

        return shapes.ListGeoLocationsResponse.from_boto_dict(response)
    ...
    def list_health_checks(
        ...
        *,
        ...
        response = self._boto_client.list_health_checks(
            **_request.to_boto_dict()
        )

        return shapes.ListHealthChecksResponse.from_boto_dict(response)
    ...
    def list_hosted_zones(
        ...
        *,
        ...
        response = self._boto_client.list_hosted_zones(
            **_request.to_boto_dict()
        )

        return shapes.ListHostedZonesResponse.from_boto_dict(response)
    ...
    def list_hosted_zones_by_name(
        ...
        *,
        ...
        return shapes.ListHostedZonesByNameResponse.from_boto_dict(response)
    ...
    def list_query_logging_configs(
        ...
        *,
        ...
        return shapes.ListQueryLoggingConfigsResponse.from_boto_dict(response)
    ...
    def list_resource_record_sets(
        ...
        *,
        ...
        start_record_type: shapes.RRType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_resource_record_sets(
            **_request.to_boto_dict()
        )

        return shapes.ListResourceRecordSetsResponse.from_boto_dict(response)
    ...
    def list_reusable_delegation_sets(
        ...
        *,
        ...
        return shapes.ListReusableDelegationSetsResponse.from_boto_dict(
            response
        )
    ...
    def list_tags_for_resources(
        ...
        *,
        ...
        return shapes.ListTagsForResourcesResponse.from_boto_dict(response)
    ...
    def list_traffic_policies(
        ...
        *,
        ...
        response = self._boto_client.list_traffic_policies(
            **_request.to_boto_dict()
        )

        return shapes.ListTrafficPoliciesResponse.from_boto_dict(response)
    ...
    def list_traffic_policy_instances(
        ...
        *,
        ...
        traffic_policy_instance_type_marker: shapes.RRType = ShapeBase.NOT_SET,
        max_items: str = ShapeBase.NOT_SET,
        ...
        return shapes.ListTrafficPolicyInstancesResponse.from_boto_dict(
            response
        )
    ...
    def list_traffic_policy_instances_by_hosted_zone(
        ...
        *,
        ...
        return shapes.ListTrafficPolicyInstancesByHostedZoneResponse.from_boto_dict(
            response
        )
    ...
    def list_traffic_policy_instances_by_policy(
        ...
        *,
        ...
        return shapes.ListTrafficPolicyInstancesByPolicyResponse.from_boto_dict(
            response
        )
    ...
    def list_traffic_policy_versions(
        ...
        *,
        ...
        return shapes.ListTrafficPolicyVersionsResponse.from_boto_dict(response)
    ...
    def list_vpc_association_authorizations(
        ...
        *,
        ...
        return shapes.ListVPCAssociationAuthorizationsResponse.from_boto_dict(
            response
        )
    ...
    def test_dns_answer(
        ...
        *,
        ...
        response = self._boto_client.test_dns_answer(**_request.to_boto_dict())

        return shapes.TestDNSAnswerResponse.from_boto_dict(response)
    ...
    def update_health_check(
        ...
        *,
        ...
        regions: typing.List[shapes.HealthCheckRegion] = ShapeBase.NOT_SET,
        alarm_identifier: shapes.AlarmIdentifier = ShapeBase.NOT_SET,
        insufficient_data_health_status: shapes.
        InsufficientDataHealthStatus = ShapeBase.NOT_SET,
        reset_elements: typing.List[shapes.ResettableElementName
                                   ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.update_health_check(
            **_request.to_boto_dict()
        )

        return shapes.UpdateHealthCheckResponse.from_boto_dict(response)
    ...
    def update_hosted_zone_comment(
        ...
        *,
        ...
        return shapes.UpdateHostedZoneCommentResponse.from_boto_dict(response)
    ...
    def update_traffic_policy_comment(
        ...
        *,
        ...
        return shapes.UpdateTrafficPolicyCommentResponse.from_boto_dict(
            response
        )
    ...
    def update_traffic_policy_instance(
        ...
        *,
        ...
        return shapes.UpdateTrafficPolicyInstanceResponse.from_boto_dict(
            response
        )
