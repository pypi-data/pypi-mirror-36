...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("iot1click-projects", *args, **kwargs)
    ...
    def associate_device_with_placement(
        ...
        *,
        ...
        return shapes.AssociateDeviceWithPlacementResponse.from_boto_dict(
            response
        )
    ...
    def create_placement(
        ...
        *,
        ...
        response = self._boto_client.create_placement(**_request.to_boto_dict())

        return shapes.CreatePlacementResponse.from_boto_dict(response)
    ...
    def create_project(
        ...
        *,
        ...
        return shapes.CreateProjectResponse.from_boto_dict(response)
    ...
    def delete_placement(
        ...
        *,
        ...
        response = self._boto_client.delete_placement(**_request.to_boto_dict())

        return shapes.DeletePlacementResponse.from_boto_dict(response)
    ...
    def delete_project(
        ...
        *,
        ...
        return shapes.DeleteProjectResponse.from_boto_dict(response)
    ...
    def describe_placement(
        ...
        *,
        ...
        response = self._boto_client.describe_placement(
            **_request.to_boto_dict()
        )

        return shapes.DescribePlacementResponse.from_boto_dict(response)
    ...
    def describe_project(
        ...
        *,
        ...
        return shapes.DescribeProjectResponse.from_boto_dict(response)
    ...
    def disassociate_device_from_placement(
        ...
        *,
        ...
        return shapes.DisassociateDeviceFromPlacementResponse.from_boto_dict(
            response
        )
    ...
    def get_devices_in_placement(
        ...
        *,
        ...
        return shapes.GetDevicesInPlacementResponse.from_boto_dict(response)
    ...
    def list_placements(
        ...
        *,
        ...
        response = self._boto_client.list_placements(**_request.to_boto_dict())

        return shapes.ListPlacementsResponse.from_boto_dict(response)
    ...
    def list_projects(
        ...
        *,
        ...
        return shapes.ListProjectsResponse.from_boto_dict(response)
    ...
    def update_placement(
        ...
        *,
        ...
        response = self._boto_client.update_placement(**_request.to_boto_dict())

        return shapes.UpdatePlacementResponse.from_boto_dict(response)
    ...
    def update_project(
        ...
        *,
        ...
        return shapes.UpdateProjectResponse.from_boto_dict(response)
