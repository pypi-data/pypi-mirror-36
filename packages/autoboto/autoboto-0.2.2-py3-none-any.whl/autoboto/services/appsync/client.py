...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("appsync", *args, **kwargs)
    ...
    def create_api_key(
        ...
        *,
        ...
        return shapes.CreateApiKeyResponse.from_boto_dict(response)
    ...
    def create_data_source(
        ...
        *,
        ...
        response = self._boto_client.create_data_source(
            **_request.to_boto_dict()
        )

        return shapes.CreateDataSourceResponse.from_boto_dict(response)
    ...
    def create_graphql_api(
        ...
        *,
        name: str,
        authentication_type: shapes.AuthenticationType,
        ...
        response = self._boto_client.create_graphql_api(
            **_request.to_boto_dict()
        )

        return shapes.CreateGraphqlApiResponse.from_boto_dict(response)
    ...
    def create_resolver(
        ...
        *,
        ...
        response = self._boto_client.create_resolver(**_request.to_boto_dict())

        return shapes.CreateResolverResponse.from_boto_dict(response)
    ...
    def create_type(
        ...
        *,
        api_id: str,
        definition: str,
        format: shapes.TypeDefinitionFormat,
        ...
        response = self._boto_client.create_type(**_request.to_boto_dict())

        return shapes.CreateTypeResponse.from_boto_dict(response)
    ...
    def delete_api_key(
        ...
        *,
        ...
        return shapes.DeleteApiKeyResponse.from_boto_dict(response)
    ...
    def delete_data_source(
        ...
        *,
        ...
        response = self._boto_client.delete_data_source(
            **_request.to_boto_dict()
        )

        return shapes.DeleteDataSourceResponse.from_boto_dict(response)
    ...
    def delete_graphql_api(
        ...
        *,
        ...
        response = self._boto_client.delete_graphql_api(
            **_request.to_boto_dict()
        )

        return shapes.DeleteGraphqlApiResponse.from_boto_dict(response)
    ...
    def delete_resolver(
        ...
        *,
        ...
        response = self._boto_client.delete_resolver(**_request.to_boto_dict())

        return shapes.DeleteResolverResponse.from_boto_dict(response)
    ...
    def delete_type(
        ...
        *,
        ...
        response = self._boto_client.delete_type(**_request.to_boto_dict())

        return shapes.DeleteTypeResponse.from_boto_dict(response)
    ...
    def get_data_source(
        ...
        *,
        ...
        response = self._boto_client.get_data_source(**_request.to_boto_dict())

        return shapes.GetDataSourceResponse.from_boto_dict(response)
    ...
    def get_graphql_api(
        ...
        *,
        ...
        response = self._boto_client.get_graphql_api(**_request.to_boto_dict())

        return shapes.GetGraphqlApiResponse.from_boto_dict(response)
    ...
    def get_introspection_schema(
        ...
        *,
        ...
        return shapes.GetIntrospectionSchemaResponse.from_boto_dict(response)
    ...
    def get_resolver(
        ...
        *,
        ...
        response = self._boto_client.get_resolver(**_request.to_boto_dict())

        return shapes.GetResolverResponse.from_boto_dict(response)
    ...
    def get_schema_creation_status(
        ...
        *,
        ...
        return shapes.GetSchemaCreationStatusResponse.from_boto_dict(response)
    ...
    def get_type(
        ...
        *,
        ...
        response = self._boto_client.get_type(**_request.to_boto_dict())

        return shapes.GetTypeResponse.from_boto_dict(response)
    ...
    def list_api_keys(
        ...
        *,
        ...
        response = self._boto_client.list_api_keys(**_request.to_boto_dict())

        return shapes.ListApiKeysResponse.from_boto_dict(response)
    ...
    def list_data_sources(
        ...
        *,
        ...
        response = self._boto_client.list_data_sources(
            **_request.to_boto_dict()
        )

        return shapes.ListDataSourcesResponse.from_boto_dict(response)
    ...
    def list_graphql_apis(
        ...
        *,
        ...
        response = self._boto_client.list_graphql_apis(
            **_request.to_boto_dict()
        )

        return shapes.ListGraphqlApisResponse.from_boto_dict(response)
    ...
    def list_resolvers(
        ...
        *,
        ...
        response = self._boto_client.list_resolvers(**_request.to_boto_dict())

        return shapes.ListResolversResponse.from_boto_dict(response)
    ...
    def list_types(
        ...
        *,
        ...
        response = self._boto_client.list_types(**_request.to_boto_dict())

        return shapes.ListTypesResponse.from_boto_dict(response)
    ...
    def start_schema_creation(
        ...
        *,
        ...
        response = self._boto_client.start_schema_creation(
            **_request.to_boto_dict()
        )

        return shapes.StartSchemaCreationResponse.from_boto_dict(response)
    ...
    def update_api_key(
        ...
        *,
        ...
        return shapes.UpdateApiKeyResponse.from_boto_dict(response)
    ...
    def update_data_source(
        ...
        *,
        ...
        response = self._boto_client.update_data_source(
            **_request.to_boto_dict()
        )

        return shapes.UpdateDataSourceResponse.from_boto_dict(response)
    ...
    def update_graphql_api(
        ...
        *,
        ...
        response = self._boto_client.update_graphql_api(
            **_request.to_boto_dict()
        )

        return shapes.UpdateGraphqlApiResponse.from_boto_dict(response)
    ...
    def update_resolver(
        ...
        *,
        ...
        response = self._boto_client.update_resolver(**_request.to_boto_dict())

        return shapes.UpdateResolverResponse.from_boto_dict(response)
    ...
    def update_type(
        ...
        *,
        ...
        response = self._boto_client.update_type(**_request.to_boto_dict())

        return shapes.UpdateTypeResponse.from_boto_dict(response)
