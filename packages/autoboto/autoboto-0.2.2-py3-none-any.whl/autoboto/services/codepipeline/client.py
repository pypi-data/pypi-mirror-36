...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("codepipeline", *args, **kwargs)
    ...
    def acknowledge_job(
        ...
        *,
        ...
        response = self._boto_client.acknowledge_job(**_request.to_boto_dict())

        return shapes.AcknowledgeJobOutput.from_boto_dict(response)
    ...
    def acknowledge_third_party_job(
        ...
        *,
        ...
        return shapes.AcknowledgeThirdPartyJobOutput.from_boto_dict(response)

    def create_custom_action_type(
        self,
        _request: shapes.CreateCustomActionTypeInput = None,
        *,
        category: shapes.ActionCategory,
        provider: str,
        version: str,
        ...
        return shapes.CreateCustomActionTypeOutput.from_boto_dict(response)
    ...
    def create_pipeline(
        ...
        *,
        ...
        return shapes.CreatePipelineOutput.from_boto_dict(response)
    ...
    def delete_webhook(
        ...
        *,
        ...
        response = self._boto_client.delete_webhook(**_request.to_boto_dict())

        return shapes.DeleteWebhookOutput.from_boto_dict(response)
    ...
    def deregister_webhook_with_third_party(
        ...
        *,
        ...
        return shapes.DeregisterWebhookWithThirdPartyOutput.from_boto_dict(
            response
        )
    ...
    def disable_stage_transition(
        ...
        *,
        pipeline_name: str,
        stage_name: str,
        transition_type: shapes.StageTransitionType,
        reason: str,
    ) -> None:
        """
    ...
    def get_job_details(
        ...
        *,
        ...
        response = self._boto_client.get_job_details(**_request.to_boto_dict())

        return shapes.GetJobDetailsOutput.from_boto_dict(response)
    ...
    def get_pipeline(
        ...
        *,
        ...
        response = self._boto_client.get_pipeline(**_request.to_boto_dict())

        return shapes.GetPipelineOutput.from_boto_dict(response)
    ...
    def get_pipeline_execution(
        ...
        *,
        ...
        return shapes.GetPipelineExecutionOutput.from_boto_dict(response)
    ...
    def get_pipeline_state(
        ...
        *,
        ...
        response = self._boto_client.get_pipeline_state(
            **_request.to_boto_dict()
        )

        return shapes.GetPipelineStateOutput.from_boto_dict(response)
    ...
    def get_third_party_job_details(
        ...
        *,
        ...
        return shapes.GetThirdPartyJobDetailsOutput.from_boto_dict(response)

    def list_action_types(
        self,
        _request: shapes.ListActionTypesInput = None,
        *,
        action_owner_filter: shapes.ActionOwner = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_action_types(
            **_request.to_boto_dict()
        )

        return shapes.ListActionTypesOutput.from_boto_dict(response)
    ...
    def list_pipeline_executions(
        ...
        *,
        ...
        return shapes.ListPipelineExecutionsOutput.from_boto_dict(response)
    ...
    def list_pipelines(
        ...
        *,
        ...
        response = self._boto_client.list_pipelines(**_request.to_boto_dict())

        return shapes.ListPipelinesOutput.from_boto_dict(response)
    ...
    def list_webhooks(
        ...
        *,
        ...
        response = self._boto_client.list_webhooks(**_request.to_boto_dict())

        return shapes.ListWebhooksOutput.from_boto_dict(response)
    ...
    def poll_for_jobs(
        ...
        *,
        ...
        response = self._boto_client.poll_for_jobs(**_request.to_boto_dict())

        return shapes.PollForJobsOutput.from_boto_dict(response)
    ...
    def poll_for_third_party_jobs(
        ...
        *,
        ...
        return shapes.PollForThirdPartyJobsOutput.from_boto_dict(response)
    ...
    def put_action_revision(
        ...
        *,
        ...
        response = self._boto_client.put_action_revision(
            **_request.to_boto_dict()
        )

        return shapes.PutActionRevisionOutput.from_boto_dict(response)
    ...
    def put_approval_result(
        ...
        *,
        ...
        response = self._boto_client.put_approval_result(
            **_request.to_boto_dict()
        )

        return shapes.PutApprovalResultOutput.from_boto_dict(response)
    ...
    def put_webhook(
        ...
        *,
        ...
        response = self._boto_client.put_webhook(**_request.to_boto_dict())

        return shapes.PutWebhookOutput.from_boto_dict(response)
    ...
    def register_webhook_with_third_party(
        ...
        *,
        ...
        return shapes.RegisterWebhookWithThirdPartyOutput.from_boto_dict(
            response
        )
    ...
    def retry_stage_execution(
        ...
        *,
        ...
        stage_name: str,
        pipeline_execution_id: str,
        retry_mode: shapes.StageRetryMode,
        ...
        response = self._boto_client.retry_stage_execution(
            **_request.to_boto_dict()
        )

        return shapes.RetryStageExecutionOutput.from_boto_dict(response)
    ...
    def start_pipeline_execution(
        ...
        *,
        ...
        return shapes.StartPipelineExecutionOutput.from_boto_dict(response)
    ...
    def update_pipeline(
        ...
        *,
        ...
        return shapes.UpdatePipelineOutput.from_boto_dict(response)
