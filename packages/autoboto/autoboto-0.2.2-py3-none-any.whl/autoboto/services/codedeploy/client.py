...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("codedeploy", *args, **kwargs)
    ...
    def list_application_revisions(
        ...
        *,
        ...
        response = self._boto_client.list_application_revisions(
            **_request.to_boto_dict()
        )
    ...
    def list_applications(
        ...
        *,
        ...
        response = self._boto_client.list_applications(
            **_request.to_boto_dict()
        )
    ...
    def list_deployment_configs(
        ...
        *,
        ...
        response = self._boto_client.list_deployment_configs(
            **_request.to_boto_dict()
        )
    ...
    def list_deployment_groups(
        ...
        *,
        ...
        response = self._boto_client.list_deployment_groups(
            **_request.to_boto_dict()
        )
    ...
    def list_deployment_instances(
        ...
        *,
        ...
        response = self._boto_client.list_deployment_instances(
            **_request.to_boto_dict()
        )
