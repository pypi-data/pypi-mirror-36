...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("comprehend", *args, **kwargs)
    ...
    def batch_detect_dominant_language(
        ...
        *,
        ...
        return shapes.BatchDetectDominantLanguageResponse.from_boto_dict(
            response
        )
    ...
    def batch_detect_entities(
        ...
        *,
        text_list: typing.List[str],
        language_code: shapes.LanguageCode,
        ...
        response = self._boto_client.batch_detect_entities(
            **_request.to_boto_dict()
        )

        return shapes.BatchDetectEntitiesResponse.from_boto_dict(response)
    ...
    def batch_detect_key_phrases(
        ...
        *,
        ...
        return shapes.BatchDetectKeyPhrasesResponse.from_boto_dict(response)
    ...
    def batch_detect_sentiment(
        ...
        *,
        ...
        return shapes.BatchDetectSentimentResponse.from_boto_dict(response)
    ...
    def batch_detect_syntax(
        ...
        *,
        text_list: typing.List[str],
        language_code: shapes.SyntaxLanguageCode,
        ...
        response = self._boto_client.batch_detect_syntax(
            **_request.to_boto_dict()
        )

        return shapes.BatchDetectSyntaxResponse.from_boto_dict(response)
    ...
    def describe_dominant_language_detection_job(
        ...
        *,
        ...
        return shapes.DescribeDominantLanguageDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def describe_entities_detection_job(
        ...
        *,
        ...
        return shapes.DescribeEntitiesDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def describe_key_phrases_detection_job(
        ...
        *,
        ...
        return shapes.DescribeKeyPhrasesDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def describe_sentiment_detection_job(
        ...
        *,
        ...
        return shapes.DescribeSentimentDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def describe_topics_detection_job(
        ...
        *,
        ...
        return shapes.DescribeTopicsDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def detect_dominant_language(
        ...
        *,
        ...
        return shapes.DetectDominantLanguageResponse.from_boto_dict(response)
    ...
    def detect_entities(
        ...
        *,
        ...
        response = self._boto_client.detect_entities(**_request.to_boto_dict())

        return shapes.DetectEntitiesResponse.from_boto_dict(response)
    ...
    def detect_key_phrases(
        ...
        *,
        ...
        response = self._boto_client.detect_key_phrases(
            **_request.to_boto_dict()
        )

        return shapes.DetectKeyPhrasesResponse.from_boto_dict(response)
    ...
    def detect_sentiment(
        ...
        *,
        ...
        response = self._boto_client.detect_sentiment(**_request.to_boto_dict())

        return shapes.DetectSentimentResponse.from_boto_dict(response)
    ...
    def detect_syntax(
        ...
        *,
        ...
        response = self._boto_client.detect_syntax(**_request.to_boto_dict())

        return shapes.DetectSyntaxResponse.from_boto_dict(response)
    ...
    def list_dominant_language_detection_jobs(
        ...
        *,
        ...
        return shapes.ListDominantLanguageDetectionJobsResponse.from_boto_dict(
            response
        )
    ...
    def list_entities_detection_jobs(
        ...
        *,
        ...
        return shapes.ListEntitiesDetectionJobsResponse.from_boto_dict(response)
    ...
    def list_key_phrases_detection_jobs(
        ...
        *,
        ...
        return shapes.ListKeyPhrasesDetectionJobsResponse.from_boto_dict(
            response
        )
    ...
    def list_sentiment_detection_jobs(
        ...
        *,
        ...
        return shapes.ListSentimentDetectionJobsResponse.from_boto_dict(
            response
        )
    ...
    def list_topics_detection_jobs(
        ...
        *,
        ...
        response = self._boto_client.list_topics_detection_jobs(
            **_request.to_boto_dict()
        )

        return shapes.ListTopicsDetectionJobsResponse.from_boto_dict(response)
    ...
    def start_dominant_language_detection_job(
        ...
        *,
        ...
        return shapes.StartDominantLanguageDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def start_entities_detection_job(
        ...
        *,
        ...
        return shapes.StartEntitiesDetectionJobResponse.from_boto_dict(response)
    ...
    def start_key_phrases_detection_job(
        ...
        *,
        ...
        return shapes.StartKeyPhrasesDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def start_sentiment_detection_job(
        ...
        *,
        ...
        return shapes.StartSentimentDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def start_topics_detection_job(
        ...
        *,
        ...
        return shapes.StartTopicsDetectionJobResponse.from_boto_dict(response)
    ...
    def stop_dominant_language_detection_job(
        ...
        *,
        ...
        return shapes.StopDominantLanguageDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def stop_entities_detection_job(
        ...
        *,
        ...
        return shapes.StopEntitiesDetectionJobResponse.from_boto_dict(response)
    ...
    def stop_key_phrases_detection_job(
        ...
        *,
        ...
        return shapes.StopKeyPhrasesDetectionJobResponse.from_boto_dict(
            response
        )
    ...
    def stop_sentiment_detection_job(
        ...
        *,
        ...
        return shapes.StopSentimentDetectionJobResponse.from_boto_dict(response)
