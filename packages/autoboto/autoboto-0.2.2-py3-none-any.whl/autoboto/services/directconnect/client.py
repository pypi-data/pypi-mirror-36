...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("directconnect", *args, **kwargs)
    ...
    def allocate_connection_on_interconnect(
        ...
        *,
        ...
        return shapes.Connection.from_boto_dict(response)
    ...
    def allocate_private_virtual_interface(
        ...
        *,
        ...
        return shapes.VirtualInterface.from_boto_dict(response)
    ...
    def confirm_connection(
        ...
        *,
        ...
        response = self._boto_client.confirm_connection(
            **_request.to_boto_dict()
        )

        return shapes.ConfirmConnectionResponse.from_boto_dict(response)
    ...
    def confirm_private_virtual_interface(
        ...
        *,
        ...
        return shapes.ConfirmPrivateVirtualInterfaceResponse.from_boto_dict(
            response
        )
    ...
    def confirm_public_virtual_interface(
        ...
        *,
        ...
        return shapes.ConfirmPublicVirtualInterfaceResponse.from_boto_dict(
            response
        )
    ...
    def create_bgp_peer(
        ...
        *,
        ...
        response = self._boto_client.create_bgp_peer(**_request.to_boto_dict())

        return shapes.CreateBGPPeerResponse.from_boto_dict(response)
    ...
    def create_direct_connect_gateway(
        ...
        *,
        ...
        return shapes.CreateDirectConnectGatewayResult.from_boto_dict(response)
    ...
    def create_direct_connect_gateway_association(
        ...
        *,
        ...
        return shapes.CreateDirectConnectGatewayAssociationResult.from_boto_dict(
            response
        )
    ...
    def create_interconnect(
        ...
        *,
        ...
        response = self._boto_client.create_interconnect(
            **_request.to_boto_dict()
        )

        return shapes.Interconnect.from_boto_dict(response)
    ...
    def create_lag(
        ...
        *,
        ...
        response = self._boto_client.create_lag(**_request.to_boto_dict())

        return shapes.Lag.from_boto_dict(response)
    ...
    def delete_bgp_peer(
        ...
        *,
        ...
        response = self._boto_client.delete_bgp_peer(**_request.to_boto_dict())

        return shapes.DeleteBGPPeerResponse.from_boto_dict(response)
    ...
    def delete_direct_connect_gateway(
        ...
        *,
        ...
        return shapes.DeleteDirectConnectGatewayResult.from_boto_dict(response)
    ...
    def delete_direct_connect_gateway_association(
        ...
        *,
        ...
        return shapes.DeleteDirectConnectGatewayAssociationResult.from_boto_dict(
            response
        )
    ...
    def delete_interconnect(
        ...
        *,
        ...
        response = self._boto_client.delete_interconnect(
            **_request.to_boto_dict()
        )

        return shapes.DeleteInterconnectResponse.from_boto_dict(response)
    ...
    def delete_lag(
        ...
        *,
        ...
        response = self._boto_client.delete_lag(**_request.to_boto_dict())
    ...
    def delete_virtual_interface(
        ...
        *,
        ...
        return shapes.DeleteVirtualInterfaceResponse.from_boto_dict(response)
    ...
    def describe_connection_loa(
        ...
        *,
        ...
        loa_content_type: shapes.LoaContentType = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeConnectionLoaResponse.from_boto_dict(response)
    ...
    def describe_connections(
        ...
        *,
        ...
        return shapes.Connections.from_boto_dict(response)
    ...
    def describe_direct_connect_gateway_associations(
        ...
        *,
        ...
        return shapes.DescribeDirectConnectGatewayAssociationsResult.from_boto_dict(
            response
        )
    ...
    def describe_direct_connect_gateway_attachments(
        ...
        *,
        ...
        return shapes.DescribeDirectConnectGatewayAttachmentsResult.from_boto_dict(
            response
        )
    ...
    def describe_direct_connect_gateways(
        ...
        *,
        ...
        return shapes.DescribeDirectConnectGatewaysResult.from_boto_dict(
            response
        )
    ...
    def describe_interconnect_loa(
        ...
        *,
        ...
        return shapes.DescribeInterconnectLoaResponse.from_boto_dict(response)
    ...
    def describe_interconnects(
        ...
        *,
        ...
        return shapes.Interconnects.from_boto_dict(response)
    ...
    def describe_lags(
        ...
        *,
        ...
        response = self._boto_client.describe_lags(**_request.to_boto_dict())

        return shapes.Lags.from_boto_dict(response)
    ...
    def describe_loa(
        ...
        *,
        ...
        response = self._boto_client.describe_loa(**_request.to_boto_dict())

        return shapes.Loa.from_boto_dict(response)
    ...
    def describe_locations(self) -> shapes.Locations:
        ...
        return shapes.Locations.from_boto_dict(response)
    ...
    def describe_virtual_gateways(self) -> shapes.VirtualGateways:
        ...
        return shapes.VirtualGateways.from_boto_dict(response)
    ...
    def describe_virtual_interfaces(
        ...
        *,
        ...
        return shapes.VirtualInterfaces.from_boto_dict(response)
    ...
    def update_lag(
        ...
        *,
        ...
        response = self._boto_client.update_lag(**_request.to_boto_dict())
