...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("sts", *args, **kwargs)
    ...
    def assume_role(
        ...
        **Using MFA with AssumeRole**
        ...
        response = self._boto_client.assume_role(**_request.to_boto_dict())

        return shapes.AssumeRoleResponse.from_boto_dict(response)
    ...
    def assume_role_with_saml(
        ...
        *,
        ...
        response = self._boto_client.assume_role_with_saml(
            **_request.to_boto_dict()
        )

        return shapes.AssumeRoleWithSAMLResponse.from_boto_dict(response)
    ...
    def assume_role_with_web_identity(
        ...
        *,
        ...
        return shapes.AssumeRoleWithWebIdentityResponse.from_boto_dict(response)
    ...
    def decode_authorization_message(
        ...
        *,
        ...
        return shapes.DecodeAuthorizationMessageResponse.from_boto_dict(
            response
        )
    ...
    def get_caller_identity(
        ...
        response = self._boto_client.get_caller_identity(
            **_request.to_boto_dict()
        )

        return shapes.GetCallerIdentityResponse.from_boto_dict(response)
    ...
    def get_session_token(
        ...
        *,
        ...
        response = self._boto_client.get_session_token(
            **_request.to_boto_dict()
        )

        return shapes.GetSessionTokenResponse.from_boto_dict(response)
