...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("ecs", *args, **kwargs)
    ...
    def create_cluster(
        ...
        *,
        ...
        return shapes.CreateClusterResponse.from_boto_dict(response)
    ...
    def create_service(
        ...
        *,
        ...
        launch_type: shapes.LaunchType = ShapeBase.NOT_SET,
        ...
        scheduling_strategy: shapes.SchedulingStrategy = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_service(**_request.to_boto_dict())

        return shapes.CreateServiceResponse.from_boto_dict(response)
    ...
    def delete_attributes(
        ...
        *,
        ...
        response = self._boto_client.delete_attributes(
            **_request.to_boto_dict()
        )

        return shapes.DeleteAttributesResponse.from_boto_dict(response)
    ...
    def delete_cluster(
        ...
        *,
        ...
        return shapes.DeleteClusterResponse.from_boto_dict(response)
    ...
    def delete_service(
        ...
        *,
        ...
        response = self._boto_client.delete_service(**_request.to_boto_dict())

        return shapes.DeleteServiceResponse.from_boto_dict(response)
    ...
    def deregister_container_instance(
        ...
        *,
        ...
        return shapes.DeregisterContainerInstanceResponse.from_boto_dict(
            response
        )
    ...
    def deregister_task_definition(
        ...
        *,
        ...
        return shapes.DeregisterTaskDefinitionResponse.from_boto_dict(response)
    ...
    def describe_clusters(
        ...
        *,
        ...
        include: typing.List[shapes.ClusterField] = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeClustersResponse.from_boto_dict(response)
    ...
    def describe_container_instances(
        ...
        *,
        ...
        return shapes.DescribeContainerInstancesResponse.from_boto_dict(
            response
        )
    ...
    def describe_task_definition(
        ...
        *,
        ...
        return shapes.DescribeTaskDefinitionResponse.from_boto_dict(response)
    ...
    def describe_tasks(
        ...
        *,
        ...
        response = self._boto_client.describe_tasks(**_request.to_boto_dict())

        return shapes.DescribeTasksResponse.from_boto_dict(response)
    ...
    def discover_poll_endpoint(
        ...
        *,
        ...
        return shapes.DiscoverPollEndpointResponse.from_boto_dict(response)

    def list_attributes(
        self,
        _request: shapes.ListAttributesRequest = None,
        *,
        target_type: shapes.TargetType,
        cluster: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_attributes(**_request.to_boto_dict())

        return shapes.ListAttributesResponse.from_boto_dict(response)
    ...
    def list_clusters(
        ...
        *,
        ...
        response = self._boto_client.list_clusters(**_request.to_boto_dict())

        return shapes.ListClustersResponse.from_boto_dict(response)
    ...
    def list_container_instances(
        ...
        *,
        ...
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        status: shapes.ContainerInstanceStatus = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_container_instances(
            **_request.to_boto_dict()
        )

        return shapes.ListContainerInstancesResponse.from_boto_dict(response)
    ...
    def list_services(
        ...
        *,
        ...
        response = self._boto_client.list_services(**_request.to_boto_dict())

        return shapes.ListServicesResponse.from_boto_dict(response)
    ...
    def list_task_definition_families(
        ...
        *,
        ...
        status: shapes.TaskDefinitionFamilyStatus = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_task_definition_families(
            **_request.to_boto_dict()
        )

        return shapes.ListTaskDefinitionFamiliesResponse.from_boto_dict(
            response
        )
    ...
    def list_task_definitions(
        ...
        *,
        family_prefix: str = ShapeBase.NOT_SET,
        status: shapes.TaskDefinitionStatus = ShapeBase.NOT_SET,
        sort: shapes.SortOrder = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_task_definitions(
            **_request.to_boto_dict()
        )

        return shapes.ListTaskDefinitionsResponse.from_boto_dict(response)
    ...
    def list_tasks(
        ...
        *,
        ...
        desired_status: shapes.DesiredStatus = ShapeBase.NOT_SET,
        launch_type: shapes.LaunchType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_tasks(**_request.to_boto_dict())

        return shapes.ListTasksResponse.from_boto_dict(response)
    ...
    def put_attributes(
        ...
        *,
        ...
        response = self._boto_client.put_attributes(**_request.to_boto_dict())

        return shapes.PutAttributesResponse.from_boto_dict(response)
    ...
    def register_container_instance(
        ...
        *,
        ...
        return shapes.RegisterContainerInstanceResponse.from_boto_dict(response)
    ...
    def register_task_definition(
        ...
        *,
        ...
        network_mode: shapes.NetworkMode = ShapeBase.NOT_SET,
        volumes: typing.List[shapes.Volume] = ShapeBase.NOT_SET,
        placement_constraints: typing.List[
            shapes.TaskDefinitionPlacementConstraint
        ] = ShapeBase.NOT_SET,
        requires_compatibilities: typing.List[shapes.Compatibility
                                             ] = ShapeBase.NOT_SET,
        ...
        return shapes.RegisterTaskDefinitionResponse.from_boto_dict(response)
    ...
    def run_task(
        ...
        *,
        ...
        response = self._boto_client.run_task(**_request.to_boto_dict())

        return shapes.RunTaskResponse.from_boto_dict(response)
    ...
    def start_task(
        ...
        *,
        ...
        response = self._boto_client.start_task(**_request.to_boto_dict())

        return shapes.StartTaskResponse.from_boto_dict(response)
    ...
    def stop_task(
        ...
        *,
        ...
        response = self._boto_client.stop_task(**_request.to_boto_dict())

        return shapes.StopTaskResponse.from_boto_dict(response)
    ...
    def submit_container_state_change(
        ...
        *,
        ...
        return shapes.SubmitContainerStateChangeResponse.from_boto_dict(
            response
        )
    ...
    def submit_task_state_change(
        ...
        *,
        ...
        return shapes.SubmitTaskStateChangeResponse.from_boto_dict(response)
    ...
    def update_container_agent(
        ...
        *,
        ...
        return shapes.UpdateContainerAgentResponse.from_boto_dict(response)
    ...
    def update_container_instances_state(
        ...
        *,
        container_instances: typing.List[str],
        status: shapes.ContainerInstanceStatus,
        cluster: str = ShapeBase.NOT_SET,
        ...
        return shapes.UpdateContainerInstancesStateResponse.from_boto_dict(
            response
        )
    ...
    def update_service(
        ...
        *,
        ...
        response = self._boto_client.update_service(**_request.to_boto_dict())

        return shapes.UpdateServiceResponse.from_boto_dict(response)
