...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("batch", *args, **kwargs)
    ...
    def create_compute_environment(
        ...
        *,
        ...
        type: shapes.CEType,
        service_role: str,
        state: shapes.CEState = ShapeBase.NOT_SET,
        ...
        return shapes.CreateComputeEnvironmentResponse.from_boto_dict(response)
    ...
    def create_job_queue(
        ...
        *,
        ...
        state: shapes.JQState = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_job_queue(**_request.to_boto_dict())

        return shapes.CreateJobQueueResponse.from_boto_dict(response)
    ...
    def delete_compute_environment(
        ...
        *,
        ...
        return shapes.DeleteComputeEnvironmentResponse.from_boto_dict(response)
    ...
    def delete_job_queue(
        ...
        *,
        ...
        response = self._boto_client.delete_job_queue(**_request.to_boto_dict())

        return shapes.DeleteJobQueueResponse.from_boto_dict(response)
    ...
    def deregister_job_definition(
        ...
        *,
        ...
        return shapes.DeregisterJobDefinitionResponse.from_boto_dict(response)
    ...
    def describe_compute_environments(
        ...
        *,
        ...
        return shapes.DescribeComputeEnvironmentsResponse.from_boto_dict(
            response
        )
    ...
    def describe_job_definitions(
        ...
        *,
        ...
        return shapes.DescribeJobDefinitionsResponse.from_boto_dict(response)
    ...
    def describe_job_queues(
        ...
        *,
        ...
        response = self._boto_client.describe_job_queues(
            **_request.to_boto_dict()
        )

        return shapes.DescribeJobQueuesResponse.from_boto_dict(response)
    ...
    def describe_jobs(
        ...
        *,
        ...
        response = self._boto_client.describe_jobs(**_request.to_boto_dict())

        return shapes.DescribeJobsResponse.from_boto_dict(response)
    ...
    def list_jobs(
        ...
        *,
        ...
        job_status: shapes.JobStatus = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
    ...
    def register_job_definition(
        ...
        *,
        ...
        return shapes.RegisterJobDefinitionResponse.from_boto_dict(response)
    ...
    def submit_job(
        ...
        *,
        ...
        response = self._boto_client.submit_job(**_request.to_boto_dict())

        return shapes.SubmitJobResponse.from_boto_dict(response)
    ...
    def terminate_job(
        ...
        *,
        ...
        response = self._boto_client.terminate_job(**_request.to_boto_dict())

        return shapes.TerminateJobResponse.from_boto_dict(response)
    ...
    def update_compute_environment(
        ...
        *,
        ...
        return shapes.UpdateComputeEnvironmentResponse.from_boto_dict(response)
    ...
    def update_job_queue(
        ...
        *,
        ...
        response = self._boto_client.update_job_queue(**_request.to_boto_dict())

        return shapes.UpdateJobQueueResponse.from_boto_dict(response)
