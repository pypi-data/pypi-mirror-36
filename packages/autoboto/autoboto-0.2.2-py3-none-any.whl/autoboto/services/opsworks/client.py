...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("opsworks", *args, **kwargs)
    ...
    def assign_instance(
        ...
        **Required Permissions** : To use this action, an AWS Identity and Access
        ...
        response = self._boto_client.assign_instance(**_request.to_boto_dict())
    ...
    def assign_volume(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.assign_volume(**_request.to_boto_dict())
    ...
    def associate_elastic_ip(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.associate_elastic_ip(
    ...
    def clone_stack(
        ...
        *,
        ...
        attributes: typing.Dict[shapes.StackAttributesKeys, str
                               ] = ShapeBase.NOT_SET,
        ...
        default_root_device_type: shapes.RootDeviceType = ShapeBase.NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        response = self._boto_client.clone_stack(**_request.to_boto_dict())

        return shapes.CloneStackResult.from_boto_dict(response)
    ...
    def create_app(
        ...
        *,
        ...
        attributes: typing.Dict[shapes.AppAttributesKeys, str
                               ] = ShapeBase.NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        return shapes.CreateAppResult.from_boto_dict(response)
    ...
    def create_deployment(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Deploy or
        ...
        return shapes.CreateDeploymentResult.from_boto_dict(response)
    ...
    def create_instance(
        ...
        *,
        ...
        layer_ids: typing.List[str],
        instance_type: str,
        auto_scaling_type: shapes.AutoScalingType = ShapeBase.NOT_SET,
        ...
        architecture: shapes.Architecture = ShapeBase.NOT_SET,
        root_device_type: shapes.RootDeviceType = ShapeBase.NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.create_instance(**_request.to_boto_dict())

        return shapes.CreateInstanceResult.from_boto_dict(response)
    ...
    def create_layer(
        ...
        *,
        stack_id: str,
        type: shapes.LayerType,
        name: str,
        shortname: str,
        attributes: typing.Dict[shapes.LayerAttributesKeys, str
                               ] = ShapeBase.NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.create_layer(**_request.to_boto_dict())

        return shapes.CreateLayerResult.from_boto_dict(response)
    ...
    def create_stack(
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        response = self._boto_client.create_stack(**_request.to_boto_dict())

        return shapes.CreateStackResult.from_boto_dict(response)
    ...
    def create_user_profile(
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        response = self._boto_client.create_user_profile(
            **_request.to_boto_dict()
        )

        return shapes.CreateUserProfileResult.from_boto_dict(response)
    ...
    def delete_layer(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.delete_layer(**_request.to_boto_dict())
    ...
    def delete_stack(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.delete_stack(**_request.to_boto_dict())
    ...
    def delete_user_profile(
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        response = self._boto_client.delete_user_profile(
            **_request.to_boto_dict()
        )
    ...
    def deregister_elastic_ip(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.deregister_elastic_ip(
            **_request.to_boto_dict()
        )
    ...
    def deregister_instance(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.deregister_instance(
            **_request.to_boto_dict()
        )
    ...
    def deregister_volume(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.deregister_volume(
            **_request.to_boto_dict()
        )
    ...
    def describe_agent_versions(
        ...
        *,
        ...
        return shapes.DescribeAgentVersionsResult.from_boto_dict(response)
    ...
    def describe_apps(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        response = self._boto_client.describe_apps(**_request.to_boto_dict())

        return shapes.DescribeAppsResult.from_boto_dict(response)
    ...
    def describe_commands(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        response = self._boto_client.describe_commands(
            **_request.to_boto_dict()
        )

        return shapes.DescribeCommandsResult.from_boto_dict(response)
    ...
    def describe_deployments(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        response = self._boto_client.describe_deployments(
            **_request.to_boto_dict()
        )

        return shapes.DescribeDeploymentsResult.from_boto_dict(response)
    ...
    def describe_ecs_clusters(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        response = self._boto_client.describe_ecs_clusters(
            **_request.to_boto_dict()
        )

        return shapes.DescribeEcsClustersResult.from_boto_dict(response)
    ...
    def describe_elastic_ips(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        response = self._boto_client.describe_elastic_ips(
            **_request.to_boto_dict()
        )

        return shapes.DescribeElasticIpsResult.from_boto_dict(response)
    ...
    def describe_elastic_load_balancers(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        return shapes.DescribeElasticLoadBalancersResult.from_boto_dict(
            response
        )
    ...
    def describe_layers(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        response = self._boto_client.describe_layers(**_request.to_boto_dict())

        return shapes.DescribeLayersResult.from_boto_dict(response)
    ...
    def describe_load_based_auto_scaling(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        return shapes.DescribeLoadBasedAutoScalingResult.from_boto_dict(
            response
        )
    ...
    def describe_my_user_profile(self, ) -> shapes.DescribeMyUserProfileResult:
        ...
        **Required Permissions** : To use this action, an IAM user must have self-
        ...
        return shapes.DescribeMyUserProfileResult.from_boto_dict(response)
    ...
    def describe_operating_systems(
        ...
        return shapes.DescribeOperatingSystemsResponse.from_boto_dict(response)
    ...
    def describe_permissions(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.describe_permissions(
            **_request.to_boto_dict()
        )

        return shapes.DescribePermissionsResult.from_boto_dict(response)
    ...
    def describe_raid_arrays(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        response = self._boto_client.describe_raid_arrays(
            **_request.to_boto_dict()
        )

        return shapes.DescribeRaidArraysResult.from_boto_dict(response)
    ...
    def describe_rds_db_instances(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        return shapes.DescribeRdsDbInstancesResult.from_boto_dict(response)
    ...
    def describe_service_errors(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        return shapes.DescribeServiceErrorsResult.from_boto_dict(response)
    ...
    def describe_stack_provisioning_parameters(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        return shapes.DescribeStackProvisioningParametersResult.from_boto_dict(
            response
        )
    ...
    def describe_stack_summary(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        return shapes.DescribeStackSummaryResult.from_boto_dict(response)
    ...
    def describe_stacks(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        response = self._boto_client.describe_stacks(**_request.to_boto_dict())

        return shapes.DescribeStacksResult.from_boto_dict(response)
    ...
    def describe_time_based_auto_scaling(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        return shapes.DescribeTimeBasedAutoScalingResult.from_boto_dict(
            response
        )
    ...
    def describe_user_profiles(
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        return shapes.DescribeUserProfilesResult.from_boto_dict(response)
    ...
    def get_hostname_suggestion(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        return shapes.GetHostnameSuggestionResult.from_boto_dict(response)
    ...
    def grant_access(
        ...
        *,
        ...
        response = self._boto_client.grant_access(**_request.to_boto_dict())

        return shapes.GrantAccessResult.from_boto_dict(response)
    ...
    def list_tags(
        ...
        *,
        ...
        return shapes.ListTagsResult.from_boto_dict(response)
    ...
    def register_ecs_cluster(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.register_ecs_cluster(
            **_request.to_boto_dict()
        )

        return shapes.RegisterEcsClusterResult.from_boto_dict(response)
    ...
    def register_elastic_ip(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.register_elastic_ip(
            **_request.to_boto_dict()
        )

        return shapes.RegisterElasticIpResult.from_boto_dict(response)
    ...
    def register_instance(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.register_instance(
            **_request.to_boto_dict()
        )

        return shapes.RegisterInstanceResult.from_boto_dict(response)
    ...
    def register_volume(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.register_volume(**_request.to_boto_dict())

        return shapes.RegisterVolumeResult.from_boto_dict(response)
    ...
    def set_permission(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.set_permission(**_request.to_boto_dict())
    ...
    def start_stack(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.start_stack(**_request.to_boto_dict())
    ...
    def stop_stack(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.stop_stack(**_request.to_boto_dict())
    ...
    def unassign_instance(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.unassign_instance(
            **_request.to_boto_dict()
        )
    ...
    def unassign_volume(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.unassign_volume(**_request.to_boto_dict())
    ...
    def update_app(
        ...
        *,
        ...
        description: str = ShapeBase.NOT_SET,
        data_sources: typing.List[shapes.DataSource] = ShapeBase.NOT_SET,
        type: shapes.AppType = ShapeBase.NOT_SET,
        app_source: shapes.Source = ShapeBase.NOT_SET,
        domains: typing.List[str] = ShapeBase.NOT_SET,
        enable_ssl: bool = ShapeBase.NOT_SET,
        ssl_configuration: shapes.SslConfiguration = ShapeBase.NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Deploy or
        ...
        response = self._boto_client.update_app(**_request.to_boto_dict())
    ...
    def update_elastic_ip(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.update_elastic_ip(
            **_request.to_boto_dict()
        )
    ...
    def update_instance(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.update_instance(**_request.to_boto_dict())
    ...
    def update_layer(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.update_layer(**_request.to_boto_dict())
    ...
    def update_stack(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.update_stack(**_request.to_boto_dict())
    ...
    def update_user_profile(
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        response = self._boto_client.update_user_profile(
            **_request.to_boto_dict()
        )
    ...
    def update_volume(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        response = self._boto_client.update_volume(**_request.to_boto_dict())
