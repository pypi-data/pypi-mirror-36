...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("iot", *args, **kwargs)
    ...
    def create_security_profile(
        ...
        *,
        ...
        alert_targets: typing.Dict[shapes.AlertTargetType, shapes.AlertTarget
                                  ] = ShapeBase.NOT_SET,
    ...
    def list_ca_certificates(
        ...
        *,
        ...
        response = self._boto_client.list_ca_certificates(
            **_request.to_boto_dict()
        )
    ...
    def list_certificates(
        ...
        *,
        ...
        response = self._boto_client.list_certificates(
            **_request.to_boto_dict()
        )
    ...
    def list_certificates_by_ca(
        ...
        *,
        ...
        response = self._boto_client.list_certificates_by_ca(
            **_request.to_boto_dict()
        )
    ...
    def list_outgoing_certificates(
        ...
        *,
        ...
        response = self._boto_client.list_outgoing_certificates(
            **_request.to_boto_dict()
        )
    ...
    def list_policies(
        ...
        *,
        ...
        response = self._boto_client.list_policies(**_request.to_boto_dict())
    ...
    def list_policy_principals(
        ...
        **Note:** This API is deprecated. Please use ListTargetsForPolicy instead.
        ...
        response = self._boto_client.list_policy_principals(
            **_request.to_boto_dict()
        )
    ...
    def list_principal_policies(
        ...
        **Note:** This API is deprecated. Please use ListAttachedPolicies instead.
        ...
        response = self._boto_client.list_principal_policies(
            **_request.to_boto_dict()
        )
    ...
    def list_principal_things(
        ...
        *,
        ...
        response = self._boto_client.list_principal_things(
            **_request.to_boto_dict()
        )
    ...
    def list_thing_types(
        ...
        *,
        ...
        response = self._boto_client.list_thing_types(**_request.to_boto_dict())
    ...
    def list_things(
        ...
        *,
        ...
        response = self._boto_client.list_things(**_request.to_boto_dict())
    ...
    def list_topic_rules(
        ...
        *,
        ...
        response = self._boto_client.list_topic_rules(**_request.to_boto_dict())
    ...
    def update_account_audit_configuration(
        ...
        *,
        ...
        audit_notification_target_configurations: typing.Dict[
            shapes.AuditNotificationType, shapes.AuditNotificationTarget
        ] = ShapeBase.NOT_SET,
    ...
    def update_event_configurations(
        ...
        *,
        event_configurations: typing.Dict[shapes.EventType, shapes.Configuration
                                         ] = ShapeBase.NOT_SET,
