...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("rds", *args, **kwargs)
    ...
    def describe_db_clusters(
        ...
        *,
        ...
        response = self._boto_client.describe_db_clusters(
            **_request.to_boto_dict()
        )
    ...
    def describe_db_engine_versions(
        ...
        *,
        ...
        response = self._boto_client.describe_db_engine_versions(
            **_request.to_boto_dict()
        )
    ...
    def describe_db_instances(
        ...
        *,
        ...
        response = self._boto_client.describe_db_instances(
            **_request.to_boto_dict()
        )
    ...
    def describe_db_log_files(
        ...
        *,
        ...
        response = self._boto_client.describe_db_log_files(
            **_request.to_boto_dict()
        )
    ...
    def describe_db_parameter_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_db_parameter_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_db_parameters(
        ...
        *,
        ...
        response = self._boto_client.describe_db_parameters(
            **_request.to_boto_dict()
        )
    ...
    def describe_db_security_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_db_security_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_db_snapshots(
        ...
        *,
        ...
        response = self._boto_client.describe_db_snapshots(
            **_request.to_boto_dict()
        )
    ...
    def describe_db_subnet_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_db_subnet_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_engine_default_parameters(
        ...
        *,
        ...
        response = self._boto_client.describe_engine_default_parameters(
            **_request.to_boto_dict()
        )
    ...
    def describe_event_subscriptions(
        ...
        *,
        ...
        response = self._boto_client.describe_event_subscriptions(
            **_request.to_boto_dict()
        )
    ...
    def describe_events(
        ...
        *,
        ...
        response = self._boto_client.describe_events(**_request.to_boto_dict())
    ...
    def describe_option_group_options(
        ...
        *,
        ...
        response = self._boto_client.describe_option_group_options(
            **_request.to_boto_dict()
        )
    ...
    def describe_option_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_option_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_orderable_db_instance_options(
        ...
        *,
        ...
        response = self._boto_client.describe_orderable_db_instance_options(
            **_request.to_boto_dict()
        )
    ...
    def describe_reserved_db_instances(
        ...
        *,
        ...
        response = self._boto_client.describe_reserved_db_instances(
            **_request.to_boto_dict()
        )
    ...
    def describe_reserved_db_instances_offerings(
        ...
        *,
        ...
        response = self._boto_client.describe_reserved_db_instances_offerings(
            **_request.to_boto_dict()
        )
    ...
    def download_db_log_file_portion(
        ...
        *,
        ...
        response = self._boto_client.download_db_log_file_portion(
            **_request.to_boto_dict()
        )
