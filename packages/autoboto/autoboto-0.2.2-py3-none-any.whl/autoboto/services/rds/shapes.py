...
class CopyDBSnapshotResult(OutputShapeBase):
    ...
    # action.
    db_snapshot: "DBSnapshot" = dataclasses.field(default_factory=dict, )
...
class CopyOptionGroupResult(OutputShapeBase):
    ...
    option_group: "OptionGroup" = dataclasses.field(default_factory=dict, )
...
class OptionGroup(ShapeBase):
    ...
    options: typing.List["Option"] = dataclasses.field(default_factory=list, )
...
class Parameter(ShapeBase):
    ...
    apply_method: "ApplyMethod" = dataclasses.field(default=ShapeBase.NOT_SET, )
