...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("s3", *args, **kwargs)
    ...
    def list_object_versions(
        ...
        *,
        ...
        response = self._boto_client.list_object_versions(
            **_request.to_boto_dict()
        )
    ...
    def list_objects(
        ...
        *,
        ...
        response = self._boto_client.list_objects(**_request.to_boto_dict())
    ...
    def list_objects_v2(
        ...
        *,
        ...
        response = self._boto_client.list_objects_v2(**_request.to_boto_dict())
