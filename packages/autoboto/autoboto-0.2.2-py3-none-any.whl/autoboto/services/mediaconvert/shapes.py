...
class ConflictException(ShapeBase):
    """
    The service could not complete your request because there is a conflict with the
...
class QueueStatus(Enum):
    """
    Queues can be ACTIVE or PAUSED. If you pause a queue, jobs in that queue will
    not begin. Jobs running when a queue is paused continue to run until they finish
    or error out.
    """
    ACTIVE = "ACTIVE"
    PAUSED = "PAUSED"
