...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("dynamodb", *args, **kwargs)
    ...
    def batch_get_item(
        ...
        *,
        ...
        return_consumed_capacity: shapes.ReturnConsumedCapacity = ShapeBase.
        NOT_SET,
        ...
        response = self._boto_client.batch_get_item(**_request.to_boto_dict())

        return shapes.BatchGetItemOutput.from_boto_dict(response)
    ...
    def batch_write_item(
        ...
        *,
        ...
        return_consumed_capacity: shapes.ReturnConsumedCapacity = ShapeBase.
        NOT_SET,
        return_item_collection_metrics: shapes.
        ReturnItemCollectionMetrics = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.batch_write_item(**_request.to_boto_dict())

        return shapes.BatchWriteItemOutput.from_boto_dict(response)
    ...
    def create_backup(
        ...
        *,
        ...
        response = self._boto_client.create_backup(**_request.to_boto_dict())

        return shapes.CreateBackupOutput.from_boto_dict(response)
    ...
    def create_global_table(
        ...
        *,
        ...
        response = self._boto_client.create_global_table(
            **_request.to_boto_dict()
        )

        return shapes.CreateGlobalTableOutput.from_boto_dict(response)
    ...
    def create_table(
        ...
        *,
        ...
        return shapes.CreateTableOutput.from_boto_dict(response)
    ...
    def delete_backup(
        ...
        *,
        ...
        response = self._boto_client.delete_backup(**_request.to_boto_dict())

        return shapes.DeleteBackupOutput.from_boto_dict(response)
    ...
    def delete_item(
        ...
        *,
        ...
        expected: typing.Dict[str, shapes.ExpectedAttributeValue
                             ] = ShapeBase.NOT_SET,
        conditional_operator: shapes.ConditionalOperator = ShapeBase.NOT_SET,
        return_values: shapes.ReturnValue = ShapeBase.NOT_SET,
        return_consumed_capacity: shapes.ReturnConsumedCapacity = ShapeBase.
        NOT_SET,
        return_item_collection_metrics: shapes.
        ReturnItemCollectionMetrics = ShapeBase.NOT_SET,
        ...
        expression_attribute_values: typing.Dict[str, shapes.AttributeValue
                                                ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.delete_item(**_request.to_boto_dict())

        return shapes.DeleteItemOutput.from_boto_dict(response)
    ...
    def delete_table(
        ...
        *,
        ...
        return shapes.DeleteTableOutput.from_boto_dict(response)
    ...
    def describe_backup(
        ...
        *,
        ...
        response = self._boto_client.describe_backup(**_request.to_boto_dict())

        return shapes.DescribeBackupOutput.from_boto_dict(response)
    ...
    def describe_continuous_backups(
        ...
        *,
        ...
        return shapes.DescribeContinuousBackupsOutput.from_boto_dict(response)
    ...
    def describe_global_table(
        ...
        *,
        ...
        response = self._boto_client.describe_global_table(
            **_request.to_boto_dict()
        )

        return shapes.DescribeGlobalTableOutput.from_boto_dict(response)
    ...
    def describe_global_table_settings(
        ...
        *,
        ...
        return shapes.DescribeGlobalTableSettingsOutput.from_boto_dict(response)
    ...
    def describe_table(
        ...
        *,
        ...
        response = self._boto_client.describe_table(**_request.to_boto_dict())

        return shapes.DescribeTableOutput.from_boto_dict(response)
    ...
    def describe_time_to_live(
        ...
        *,
        ...
        response = self._boto_client.describe_time_to_live(
            **_request.to_boto_dict()
        )

        return shapes.DescribeTimeToLiveOutput.from_boto_dict(response)
    ...
    def get_item(
        ...
        *,
        ...
        response = self._boto_client.get_item(**_request.to_boto_dict())

        return shapes.GetItemOutput.from_boto_dict(response)
    ...
    def list_backups(
        ...
        *,
        ...
        backup_type: shapes.BackupTypeFilter = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_backups(**_request.to_boto_dict())

        return shapes.ListBackupsOutput.from_boto_dict(response)
    ...
    def list_global_tables(
        ...
        *,
        ...
        response = self._boto_client.list_global_tables(
            **_request.to_boto_dict()
        )

        return shapes.ListGlobalTablesOutput.from_boto_dict(response)
    ...
    def list_tables(
        ...
        *,
        ...
        response = self._boto_client.list_tables(**_request.to_boto_dict())

        return shapes.ListTablesOutput.from_boto_dict(response)
    ...
    def list_tags_of_resource(
        ...
        *,
        ...
        response = self._boto_client.list_tags_of_resource(
            **_request.to_boto_dict()
        )

        return shapes.ListTagsOfResourceOutput.from_boto_dict(response)
    ...
    def put_item(
        ...
        *,
        ...
        response = self._boto_client.put_item(**_request.to_boto_dict())

        return shapes.PutItemOutput.from_boto_dict(response)
    ...
    def query(
        ...
        *,
        ...
        select: shapes.Select = ShapeBase.NOT_SET,
        attributes_to_get: typing.List[str] = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        consistent_read: bool = ShapeBase.NOT_SET,
        ...
        exclusive_start_key: typing.Dict[str, shapes.AttributeValue
                                        ] = ShapeBase.NOT_SET,
        return_consumed_capacity: shapes.ReturnConsumedCapacity = ShapeBase.
        NOT_SET,
        projection_expression: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.query(**_request.to_boto_dict())

        return shapes.QueryOutput.from_boto_dict(response)
    ...
    def restore_table_from_backup(
        ...
        *,
        ...
        return shapes.RestoreTableFromBackupOutput.from_boto_dict(response)
    ...
    def restore_table_to_point_in_time(
        ...
        *,
        ...
        return shapes.RestoreTableToPointInTimeOutput.from_boto_dict(response)
    ...
    def scan(
        ...
        *,
        ...
        response = self._boto_client.scan(**_request.to_boto_dict())

        return shapes.ScanOutput.from_boto_dict(response)
    ...
    def update_continuous_backups(
        ...
        *,
        ...
        return shapes.UpdateContinuousBackupsOutput.from_boto_dict(response)
    ...
    def update_global_table(
        ...
        *,
        ...
        response = self._boto_client.update_global_table(
            **_request.to_boto_dict()
        )

        return shapes.UpdateGlobalTableOutput.from_boto_dict(response)
    ...
    def update_global_table_settings(
        ...
        *,
        ...
        return shapes.UpdateGlobalTableSettingsOutput.from_boto_dict(response)
    ...
    def update_item(
        ...
        *,
        table_name: str,
        key: typing.Dict[str, shapes.AttributeValue],
        attribute_updates: typing.Dict[str, shapes.AttributeValueUpdate
                                      ] = ShapeBase.NOT_SET,
        expected: typing.Dict[str, shapes.ExpectedAttributeValue
                             ] = ShapeBase.NOT_SET,
        conditional_operator: shapes.ConditionalOperator = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.update_item(**_request.to_boto_dict())

        return shapes.UpdateItemOutput.from_boto_dict(response)
    ...
    def update_table(
        ...
        *,
        ...
        global_secondary_index_updates: typing.List[
            shapes.GlobalSecondaryIndexUpdate
        ] = ShapeBase.NOT_SET,
        stream_specification: shapes.StreamSpecification = ShapeBase.NOT_SET,
        sse_specification: shapes.SSESpecification = ShapeBase.NOT_SET,
        ...
        return shapes.UpdateTableOutput.from_boto_dict(response)
    ...
    def update_time_to_live(
        ...
        *,
        ...
        response = self._boto_client.update_time_to_live(
            **_request.to_boto_dict()
        )

        return shapes.UpdateTimeToLiveOutput.from_boto_dict(response)
