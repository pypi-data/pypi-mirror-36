    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                "Responses",
                TypeInfo(
                    typing.Dict[str, typing.List[typing.Dict[str, AttributeValue
                                                            ]]]
                ),
            ),
            (
...
class BatchWriteItemInput(ShapeBase):
    ...
    request_items: typing.Dict[str, typing.List["WriteRequest"]
                              ] = dataclasses.field(
                                  default=ShapeBase.NOT_SET,
                              )
...
class BatchWriteItemOutput(OutputShapeBase):
    ...
    unprocessed_items: typing.Dict[str, typing.List["WriteRequest"]
                                  ] = dataclasses.field(
                                      default=ShapeBase.NOT_SET,
                                  )
    ...
    item_collection_metrics: typing.Dict[
        str, typing.List["ItemCollectionMetrics"]
    ] = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
