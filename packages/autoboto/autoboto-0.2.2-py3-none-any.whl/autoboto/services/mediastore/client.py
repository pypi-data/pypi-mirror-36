...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("mediastore", *args, **kwargs)
    ...
    def create_container(
        ...
        *,
        ...
        response = self._boto_client.create_container(**_request.to_boto_dict())

        return shapes.CreateContainerOutput.from_boto_dict(response)
    ...
    def delete_container(
        ...
        *,
        ...
        response = self._boto_client.delete_container(**_request.to_boto_dict())

        return shapes.DeleteContainerOutput.from_boto_dict(response)
    ...
    def delete_container_policy(
        ...
        *,
        ...
        return shapes.DeleteContainerPolicyOutput.from_boto_dict(response)
    ...
    def delete_cors_policy(
        ...
        *,
        ...
        response = self._boto_client.delete_cors_policy(
            **_request.to_boto_dict()
        )

        return shapes.DeleteCorsPolicyOutput.from_boto_dict(response)
    ...
    def describe_container(
        ...
        *,
        ...
        response = self._boto_client.describe_container(
            **_request.to_boto_dict()
        )

        return shapes.DescribeContainerOutput.from_boto_dict(response)
    ...
    def get_container_policy(
        ...
        *,
        ...
        response = self._boto_client.get_container_policy(
            **_request.to_boto_dict()
        )

        return shapes.GetContainerPolicyOutput.from_boto_dict(response)
    ...
    def get_cors_policy(
        ...
        *,
        ...
        response = self._boto_client.get_cors_policy(**_request.to_boto_dict())

        return shapes.GetCorsPolicyOutput.from_boto_dict(response)
    ...
    def list_containers(
        ...
        *,
        ...
        response = self._boto_client.list_containers(**_request.to_boto_dict())

        return shapes.ListContainersOutput.from_boto_dict(response)
    ...
    def put_container_policy(
        ...
        *,
        ...
        response = self._boto_client.put_container_policy(
            **_request.to_boto_dict()
        )

        return shapes.PutContainerPolicyOutput.from_boto_dict(response)
    ...
    def put_cors_policy(
        ...
        *,
        ...
        response = self._boto_client.put_cors_policy(**_request.to_boto_dict())

        return shapes.PutCorsPolicyOutput.from_boto_dict(response)
