...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("codestar", *args, **kwargs)
    ...
    def associate_team_member(
        ...
        *,
        ...
        response = self._boto_client.associate_team_member(
            **_request.to_boto_dict()
        )

        return shapes.AssociateTeamMemberResult.from_boto_dict(response)
    ...
    def delete_user_profile(
        ...
        *,
        ...
        return shapes.DeleteUserProfileResult.from_boto_dict(response)
    ...
    def describe_project(
        ...
        *,
        ...
        response = self._boto_client.describe_project(**_request.to_boto_dict())

        return shapes.DescribeProjectResult.from_boto_dict(response)
    ...
    def describe_user_profile(
        ...
        *,
        ...
        response = self._boto_client.describe_user_profile(
            **_request.to_boto_dict()
        )

        return shapes.DescribeUserProfileResult.from_boto_dict(response)
    ...
    def disassociate_team_member(
        ...
        *,
        ...
        return shapes.DisassociateTeamMemberResult.from_boto_dict(response)
    ...
    def list_resources(
        ...
        *,
        ...
        return shapes.ListResourcesResult.from_boto_dict(response)
    ...
    def list_tags_for_project(
        ...
        *,
        ...
        response = self._boto_client.list_tags_for_project(
            **_request.to_boto_dict()
        )

        return shapes.ListTagsForProjectResult.from_boto_dict(response)
    ...
    def list_team_members(
        ...
        *,
        ...
        response = self._boto_client.list_team_members(
            **_request.to_boto_dict()
        )

        return shapes.ListTeamMembersResult.from_boto_dict(response)
    ...
    def list_user_profiles(
        ...
        *,
        ...
        response = self._boto_client.list_user_profiles(
            **_request.to_boto_dict()
        )

        return shapes.ListUserProfilesResult.from_boto_dict(response)
    ...
    def tag_project(
        ...
        *,
        ...
        response = self._boto_client.tag_project(**_request.to_boto_dict())

        return shapes.TagProjectResult.from_boto_dict(response)
    ...
    def untag_project(
        ...
        *,
        ...
        response = self._boto_client.untag_project(**_request.to_boto_dict())

        return shapes.UntagProjectResult.from_boto_dict(response)
    ...
    def update_team_member(
        ...
        *,
        ...
        response = self._boto_client.update_team_member(
            **_request.to_boto_dict()
        )

        return shapes.UpdateTeamMemberResult.from_boto_dict(response)
    ...
    def update_user_profile(
        ...
        *,
        ...
        return shapes.UpdateUserProfileResult.from_boto_dict(response)
