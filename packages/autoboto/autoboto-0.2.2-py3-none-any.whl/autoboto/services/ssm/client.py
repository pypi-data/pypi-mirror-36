...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("ssm", *args, **kwargs)
    ...
    def describe_activations(
        ...
        *,
        ...
        response = self._boto_client.describe_activations(
            **_request.to_boto_dict()
        )
    ...
    def describe_instance_information(
        ...
        *,
        instance_information_filter_list: typing.List[
            shapes.InstanceInformationFilter
        ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_instance_information(
            **_request.to_boto_dict()
        )
    ...
    def describe_parameters(
        ...
        *,
        ...
        response = self._boto_client.describe_parameters(
            **_request.to_boto_dict()
        )
    ...
    def get_parameter_history(
        ...
        *,
        ...
        response = self._boto_client.get_parameter_history(
            **_request.to_boto_dict()
        )
    ...
    def get_parameters_by_path(
        ...
        *,
        ...
        response = self._boto_client.get_parameters_by_path(
            **_request.to_boto_dict()
        )
    ...
    def list_associations(
        ...
        *,
        ...
        response = self._boto_client.list_associations(
            **_request.to_boto_dict()
        )
    ...
    def list_command_invocations(
        ...
        *,
        ...
        response = self._boto_client.list_command_invocations(
            **_request.to_boto_dict()
        )
    ...
    def list_commands(
        ...
        *,
        ...
        response = self._boto_client.list_commands(**_request.to_boto_dict())
    ...
    def list_documents(
        ...
        *,
        ...
        response = self._boto_client.list_documents(**_request.to_boto_dict())
    ...
    def register_task_with_maintenance_window(
        ...
        *,
        ...
        task_parameters: typing.Dict[
            str, shapes.MaintenanceWindowTaskParameterValueExpression
        ] = ShapeBase.NOT_SET,
