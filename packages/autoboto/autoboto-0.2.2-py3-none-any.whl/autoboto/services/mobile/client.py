...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("mobile", *args, **kwargs)
    ...
    def describe_bundle(
        ...
        *,
        ...
        response = self._boto_client.describe_bundle(**_request.to_boto_dict())

        return shapes.DescribeBundleResult.from_boto_dict(response)
    ...
    def export_bundle(
        ...
        *,
        ...
        platform: shapes.Platform = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.export_bundle(**_request.to_boto_dict())

        return shapes.ExportBundleResult.from_boto_dict(response)
    ...
    def export_project(
        ...
        *,
        ...
        response = self._boto_client.export_project(**_request.to_boto_dict())

        return shapes.ExportProjectResult.from_boto_dict(response)
    ...
    def list_bundles(
        ...
        *,
        ...
        response = self._boto_client.list_bundles(**_request.to_boto_dict())

        return shapes.ListBundlesResult.from_boto_dict(response)
