...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("iam", *args, **kwargs)
    ...
    def get_account_authorization_details(
        ...
        *,
        ...
        response = self._boto_client.get_account_authorization_details(
            **_request.to_boto_dict()
        )
    ...
    def list_access_keys(
        ...
        *,
        ...
        response = self._boto_client.list_access_keys(**_request.to_boto_dict())
    ...
    def list_account_aliases(
        ...
        *,
        ...
        response = self._boto_client.list_account_aliases(
            **_request.to_boto_dict()
        )
    ...
    def list_attached_group_policies(
        ...
        *,
        ...
        response = self._boto_client.list_attached_group_policies(
            **_request.to_boto_dict()
        )
    ...
    def list_attached_role_policies(
        ...
        *,
        ...
        response = self._boto_client.list_attached_role_policies(
            **_request.to_boto_dict()
        )
    ...
    def list_attached_user_policies(
        ...
        *,
        ...
        response = self._boto_client.list_attached_user_policies(
            **_request.to_boto_dict()
        )
    ...
    def list_entities_for_policy(
        ...
        *,
        ...
        response = self._boto_client.list_entities_for_policy(
            **_request.to_boto_dict()
        )
    ...
    def list_group_policies(
        ...
        *,
        ...
        response = self._boto_client.list_group_policies(
            **_request.to_boto_dict()
        )
    ...
    def list_groups_for_user(
        ...
        *,
        ...
        response = self._boto_client.list_groups_for_user(
            **_request.to_boto_dict()
        )
    ...
    def list_instance_profiles_for_role(
        ...
        *,
        ...
        response = self._boto_client.list_instance_profiles_for_role(
            **_request.to_boto_dict()
        )
    ...
    def list_mfa_devices(
        ...
        *,
        ...
        response = self._boto_client.list_mfa_devices(**_request.to_boto_dict())
    ...
    def list_role_policies(
        ...
        *,
        ...
        response = self._boto_client.list_role_policies(
            **_request.to_boto_dict()
        )
    ...
    def list_roles(
        ...
        *,
        ...
        response = self._boto_client.list_roles(**_request.to_boto_dict())
    ...
    def list_ssh_public_keys(
        ...
        *,
        ...
        response = self._boto_client.list_ssh_public_keys(
            **_request.to_boto_dict()
        )
    ...
    def list_server_certificates(
        ...
        *,
        ...
        response = self._boto_client.list_server_certificates(
            **_request.to_boto_dict()
        )
    ...
    def list_signing_certificates(
        ...
        *,
        ...
        response = self._boto_client.list_signing_certificates(
            **_request.to_boto_dict()
        )
    ...
    def list_user_policies(
        ...
        *,
        ...
        response = self._boto_client.list_user_policies(
            **_request.to_boto_dict()
        )
    ...
    def list_users(
        ...
        *,
        ...
        response = self._boto_client.list_users(**_request.to_boto_dict())
    ...
    def list_virtual_mfa_devices(
        ...
        *,
        ...
        response = self._boto_client.list_virtual_mfa_devices(
            **_request.to_boto_dict()
        )
    ...
    def simulate_custom_policy(
        ...
        *,
        ...
        response = self._boto_client.simulate_custom_policy(
            **_request.to_boto_dict()
        )
    ...
    def simulate_principal_policy(
        ...
        **Note:** This API discloses information about the permissions granted to other
        ...
        response = self._boto_client.simulate_principal_policy(
            **_request.to_boto_dict()
        )
