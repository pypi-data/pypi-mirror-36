...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("swf", *args, **kwargs)
    ...
    def count_closed_workflow_executions(
        ...
        **Access Control**
        ...
        return shapes.WorkflowExecutionCount.from_boto_dict(response)
    ...
    def count_pending_activity_tasks(
        ...
        **Access Control**
        ...
        return shapes.PendingTaskCount.from_boto_dict(response)
    ...
    def deprecate_domain(
        ...
        **Access Control**
        ...
        response = self._boto_client.deprecate_domain(**_request.to_boto_dict())
    ...
    def describe_activity_type(
        ...
        **Access Control**
        ...
        return shapes.ActivityTypeDetail.from_boto_dict(response)
    ...
    def describe_domain(
        ...
        **Access Control**
        ...
        response = self._boto_client.describe_domain(**_request.to_boto_dict())

        return shapes.DomainDetail.from_boto_dict(response)
    ...
    def describe_workflow_execution(
        ...
        **Access Control**
        ...
        return shapes.WorkflowExecutionDetail.from_boto_dict(response)
    ...
    def describe_workflow_type(
        ...
        **Access Control**
        ...
        return shapes.WorkflowTypeDetail.from_boto_dict(response)
    ...
    def get_workflow_execution_history(
        ...
        **Access Control**
        ...
        response = self._boto_client.get_workflow_execution_history(
            **_request.to_boto_dict()
        )

        return shapes.History.from_boto_dict(response)
    ...
    def list_activity_types(
        ...
        *,
        domain: str,
        registration_status: shapes.RegistrationStatus,
        ...
        **Access Control**
        ...
        response = self._boto_client.list_activity_types(
            **_request.to_boto_dict()
        )

        return shapes.ActivityTypeInfos.from_boto_dict(response)
    ...
    def list_closed_workflow_executions(
        ...
        **Access Control**
        ...
        response = self._boto_client.list_closed_workflow_executions(
            **_request.to_boto_dict()
        )

        return shapes.WorkflowExecutionInfos.from_boto_dict(response)
    ...
    def list_domains(
        ...
        **Access Control**
        ...
        return shapes.DomainInfos.from_boto_dict(response)
    ...
    def list_open_workflow_executions(
        ...
        **Access Control**
        ...
        response = self._boto_client.list_open_workflow_executions(
            **_request.to_boto_dict()
        )
    ...
    def list_workflow_types(
        ...
        **Access Control**
        ...
        response = self._boto_client.list_workflow_types(
            **_request.to_boto_dict()
        )

        return shapes.WorkflowTypeInfos.from_boto_dict(response)
    ...
    def poll_for_activity_task(
        ...
        **Access Control**
        ...
        return shapes.ActivityTask.from_boto_dict(response)
    ...
    def poll_for_decision_task(
        ...
        **Access Control**
        ...
        response = self._boto_client.poll_for_decision_task(
            **_request.to_boto_dict()
        )

        return shapes.DecisionTask.from_boto_dict(response)
    ...
    def record_activity_task_heartbeat(
        ...
        **Access Control**
        ...
        return shapes.ActivityTaskStatus.from_boto_dict(response)
    ...
    def register_workflow_type(
        ...
        *,
        ...
        default_task_list: shapes.TaskList = ShapeBase.NOT_SET,
        default_task_priority: str = ShapeBase.NOT_SET,
        default_child_policy: shapes.ChildPolicy = ShapeBase.NOT_SET,
    ...
    def start_workflow_execution(
        ...
        *,
        ...
        child_policy: shapes.ChildPolicy = ShapeBase.NOT_SET,
        ...
        **Access Control**
        ...
        return shapes.Run.from_boto_dict(response)
