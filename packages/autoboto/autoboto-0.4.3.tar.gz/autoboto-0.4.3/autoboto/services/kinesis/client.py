...
class Client(ClientBase):
    def __init__(self, *args, **kwargs):
        super().__init__("kinesis", *args, **kwargs)
    ...
    def add_tags_to_stream(
        ...
        *,
        ...
        response = self._boto_client.add_tags_to_stream(**_request.to_boto())
    ...
    def describe_stream(
        ...
        *,
        ...
        paginator = self.get_paginator("describe_stream").paginate(
            **_request.to_boto()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeStreamOutput.from_boto(first_page)
    ...
    def describe_stream_consumer(
        ...
        *,
        ...
        return shapes.DescribeStreamConsumerOutput.from_boto(response)
    ...
    def describe_stream_summary(
        ...
        *,
        ...
        return shapes.DescribeStreamSummaryOutput.from_boto(response)
    ...
    def disable_enhanced_monitoring(
        ...
        *,
        stream_name: str,
        shard_level_metrics: typing.List[typing.Union[str, shapes.MetricsName]],
        ...
        return shapes.EnhancedMonitoringOutput.from_boto(response)
    ...
    def list_shards(
        ...
        *,
        ...
        response = self._boto_client.list_shards(**_request.to_boto())

        return shapes.ListShardsOutput.from_boto(response)
    ...
    def list_stream_consumers(
        ...
        *,
        ...
        response = self._boto_client.list_stream_consumers(**_request.to_boto())

        return shapes.ListStreamConsumersOutput.from_boto(response)
    ...
    def list_streams(
        ...
        *,
        ...
        paginator = self.get_paginator("list_streams").paginate(
            **_request.to_boto()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListStreamsOutput.from_boto(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def merge_shards(
        ...
        *,
        ...
        response = self._boto_client.merge_shards(**_request.to_boto())
    ...
    def put_records(
        ...
        *,
        ...
        response = self._boto_client.put_records(**_request.to_boto())

        return shapes.PutRecordsOutput.from_boto(response)
    ...
    def register_stream_consumer(
        ...
        *,
        ...
        return shapes.RegisterStreamConsumerOutput.from_boto(response)
    ...
    def split_shard(
        ...
        *,
        ...
        response = self._boto_client.split_shard(**_request.to_boto())
    ...
    def start_stream_encryption(
        ...
        *,
        stream_name: str,
        encryption_type: typing.Union[str, shapes.EncryptionType],
        key_id: str,
    ) -> None:
        """
    ...
    def subscribe_to_shard(
        ...
        *,
        ...
        response = self._boto_client.subscribe_to_shard(**_request.to_boto())

        return shapes.SubscribeToShardOutput.from_boto(response)
    ...
    def update_shard_count(
        ...
        *,
        ...
        scaling_type: typing.Union[str, shapes.ScalingType],
        ...
        response = self._boto_client.update_shard_count(**_request.to_boto())

        return shapes.UpdateShardCountOutput.from_boto(response)
