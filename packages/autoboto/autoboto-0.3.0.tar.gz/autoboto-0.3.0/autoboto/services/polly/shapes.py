...
class DeleteLexiconInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteLexiconInput", None, None]:
...
class DeleteLexiconOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteLexiconOutput", None, None]:
        yield from super().paginate()
...
class DescribeVoicesInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DescribeVoicesInput", None, None]:
        yield from super().paginate()
...
class DescribeVoicesOutput(OutputShapeBase):
    ...
    voices: typing.List["Voice"] = dataclasses.field(default_factory=list, )
...
class GetLexiconInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetLexiconInput", None, None]:
        yield from super().paginate()
...
class GetLexiconOutput(OutputShapeBase):
    ...
    lexicon: "Lexicon" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["GetLexiconOutput", None, None]:
        yield from super().paginate()
...
class GetSpeechSynthesisTaskInput(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetSpeechSynthesisTaskInput", None, None]:
        yield from super().paginate()
...
class GetSpeechSynthesisTaskOutput(OutputShapeBase):
    ...
    synthesis_task: "SynthesisTask" = dataclasses.field(default_factory=dict, )

    def paginate(
        self,
    ) -> typing.Generator["GetSpeechSynthesisTaskOutput", None, None]:
        yield from super().paginate()
...
class InvalidLexiconException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidLexiconException", None, None]:
        yield from super().paginate()
...
class InvalidS3BucketException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidS3BucketException", None, None]:
        yield from super().paginate()
...
class InvalidS3KeyException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidS3KeyException", None, None]:
        yield from super().paginate()
...
class InvalidSampleRateException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidSampleRateException", None, None]:
        yield from super().paginate()
...
class InvalidSsmlException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidSsmlException", None, None]:
        yield from super().paginate()
...
class InvalidTaskIdException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidTaskIdException", None, None]:
        yield from super().paginate()
...
class LanguageNotSupportedException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["LanguageNotSupportedException", None, None]:
        yield from super().paginate()
...
class Lexicon(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Lexicon", None, None]:
        yield from super().paginate()
...
class LexiconAttributes(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["LexiconAttributes", None, None]:
        yield from super().paginate()
...
class LexiconDescription(ShapeBase):
    ...
    attributes: "LexiconAttributes" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["LexiconDescription", None, None]:
        yield from super().paginate()
...
class LexiconNotFoundException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["LexiconNotFoundException", None, None]:
        yield from super().paginate()
...
class LexiconSizeExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["LexiconSizeExceededException", None, None]:
        yield from super().paginate()
...
class ListLexiconsInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListLexiconsInput", None, None]:
        yield from super().paginate()
...
class ListLexiconsOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListLexiconsOutput", None, None]:
        yield from super().paginate()
...
class ListSpeechSynthesisTasksInput(ShapeBase):
    ...
    status: "TaskStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(
        self,
    ) -> typing.Generator["ListSpeechSynthesisTasksInput", None, None]:
        yield from super().paginate()
...
class ListSpeechSynthesisTasksOutput(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListSpeechSynthesisTasksOutput", None, None]:
        yield from super().paginate()
...
class MarksNotSupportedForFormatException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["MarksNotSupportedForFormatException", None, None]:
        yield from super().paginate()
...
class MaxLexemeLengthExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["MaxLexemeLengthExceededException", None, None]:
        yield from super().paginate()
...
class MaxLexiconsNumberExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["MaxLexiconsNumberExceededException", None, None]:
        yield from super().paginate()
...
class PutLexiconInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutLexiconInput", None, None]:
        yield from super().paginate()
...
class PutLexiconOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutLexiconOutput", None, None]:
        yield from super().paginate()
...
class SsmlMarksNotSupportedForTextTypeException(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "SsmlMarksNotSupportedForTextTypeException", None, None]:
        yield from super().paginate()
...
class StartSpeechSynthesisTaskInput(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "speech_mark_types",
                "SpeechMarkTypes",
                TypeInfo(typing.List[SpeechMarkType]),
            ),
            (
                "text_type",
                "TextType",
    ...
    output_format: "OutputFormat" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    voice_id: "VoiceId" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # List of one or more pronunciation lexicon names you want the service to
    # apply during synthesis. Lexicons are applied only if the language of the
    # lexicon is the same as the language of the voice.
    lexicon_names: typing.List[str] = dataclasses.field(default_factory=list, )
    ...
    speech_mark_types: typing.List["SpeechMarkType"] = dataclasses.field(
        default_factory=list,
    )

    # Specifies whether the input text is plain text or SSML. The default value
    # is plain text.
    text_type: "TextType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(
        self,
    ) -> typing.Generator["StartSpeechSynthesisTaskInput", None, None]:
        yield from super().paginate()
...
class StartSpeechSynthesisTaskOutput(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StartSpeechSynthesisTaskOutput", None, None]:
        yield from super().paginate()
...
class SynthesisTask(ShapeBase):
    ...
    task_status: "TaskStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["SynthesisTask", None, None]:
        yield from super().paginate()
...
class SynthesisTaskNotFoundException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["SynthesisTaskNotFoundException", None, None]:
        yield from super().paginate()
...
class SynthesizeSpeechInput(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SynthesizeSpeechInput", None, None]:
        yield from super().paginate()
...
class SynthesizeSpeechOutput(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SynthesizeSpeechOutput", None, None]:
        yield from super().paginate()
...
class TextLengthExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["TextLengthExceededException", None, None]:
        yield from super().paginate()
...
class UnsupportedPlsAlphabetException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnsupportedPlsAlphabetException", None, None]:
        yield from super().paginate()
...
class UnsupportedPlsLanguageException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnsupportedPlsLanguageException", None, None]:
        yield from super().paginate()
...
class Voice(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                TypeInfo(typing.List[LanguageCode]),
            ),
        ]
    ...
    id: "VoiceId" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # `hi-IN`.
    additional_language_codes: typing.List["LanguageCode"] = dataclasses.field(
        default_factory=list,
    )

    def paginate(self, ) -> typing.Generator["Voice", None, None]:
        yield from super().paginate()
