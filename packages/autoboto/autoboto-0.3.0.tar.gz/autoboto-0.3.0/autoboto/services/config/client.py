...
class Client(ClientBase):
    ...
    def batch_get_resource_config(
        ...
        *,
        ...
        return shapes.BatchGetResourceConfigResponse.from_boto_dict(response)
    ...
    def delete_config_rule(
        ...
        *,
        ...
        response = self._boto_client.delete_config_rule(
            **_request.to_boto_dict()
        )
    ...
    def delete_evaluation_results(
        ...
        *,
        ...
        return shapes.DeleteEvaluationResultsResponse.from_boto_dict(response)
    ...
    def deliver_config_snapshot(
        ...
        *,
        ...
        return shapes.DeliverConfigSnapshotResponse.from_boto_dict(response)
    ...
    def describe_aggregate_compliance_by_config_rules(
        ...
        *,
        ...
        return shapes.DescribeAggregateComplianceByConfigRulesResponse.from_boto_dict(
            response
        )
    ...
    def describe_aggregation_authorizations(
        ...
        *,
        ...
        return shapes.DescribeAggregationAuthorizationsResponse.from_boto_dict(
            response
        )
    ...
    def describe_compliance_by_config_rule(
        ...
        *,
        ...
        compliance_types: typing.List[shapes.ComplianceType
                                     ] = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        result = shapes.DescribeComplianceByConfigRuleResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.DescribeComplianceByConfigRuleResponse.from_boto_dict(
            response
        )
    ...
    def describe_compliance_by_resource(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeComplianceByResourceResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.DescribeComplianceByResourceResponse.from_boto_dict(
            response
        )
    ...
    def describe_config_rule_evaluation_status(
        ...
        *,
        ...
        return shapes.DescribeConfigRuleEvaluationStatusResponse.from_boto_dict(
            response
        )
    ...
    def describe_config_rules(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeConfigRulesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeConfigRulesResponse.from_boto_dict(response)
    ...
    def describe_configuration_aggregator_sources_status(
        ...
        *,
        configuration_aggregator_name: str,
        update_status: typing.List[shapes.AggregatedSourceStatusType
                                  ] = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeConfigurationAggregatorSourcesStatusResponse.from_boto_dict(
            response
        )
    ...
    def describe_configuration_aggregators(
        ...
        *,
        ...
        return shapes.DescribeConfigurationAggregatorsResponse.from_boto_dict(
            response
        )
    ...
    def describe_configuration_recorder_status(
        ...
        *,
        ...
        return shapes.DescribeConfigurationRecorderStatusResponse.from_boto_dict(
            response
        )
    ...
    def describe_configuration_recorders(
        ...
        *,
        ...
        return shapes.DescribeConfigurationRecordersResponse.from_boto_dict(
            response
        )
    ...
    def describe_delivery_channel_status(
        ...
        *,
        ...
        return shapes.DescribeDeliveryChannelStatusResponse.from_boto_dict(
            response
        )
    ...
    def describe_delivery_channels(
        ...
        *,
        ...
        return shapes.DescribeDeliveryChannelsResponse.from_boto_dict(response)
    ...
    def describe_pending_aggregation_requests(
        ...
        *,
        ...
        return shapes.DescribePendingAggregationRequestsResponse.from_boto_dict(
            response
        )
    ...
    def describe_retention_configurations(
        ...
        *,
        ...
        return shapes.DescribeRetentionConfigurationsResponse.from_boto_dict(
            response
        )
    ...
    def get_aggregate_compliance_details_by_config_rule(
        ...
        *,
        ...
        account_id: str,
        aws_region: str,
        compliance_type: shapes.ComplianceType = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        return shapes.GetAggregateComplianceDetailsByConfigRuleResponse.from_boto_dict(
            response
        )
    ...
    def get_aggregate_config_rule_compliance_summary(
        ...
        *,
        ...
        group_by_key: shapes.ConfigRuleComplianceSummaryGroupKey = ShapeBase.
        NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        return shapes.GetAggregateConfigRuleComplianceSummaryResponse.from_boto_dict(
            response
        )
    ...
    def get_compliance_details_by_config_rule(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetComplianceDetailsByConfigRuleResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.GetComplianceDetailsByConfigRuleResponse.from_boto_dict(
            response
        )
    ...
    def get_compliance_details_by_resource(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetComplianceDetailsByResourceResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.GetComplianceDetailsByResourceResponse.from_boto_dict(
            response
        )
    ...
    def get_compliance_summary_by_config_rule(
        ...
        return shapes.GetComplianceSummaryByConfigRuleResponse.from_boto_dict(
            response
        )
    ...
    def get_compliance_summary_by_resource_type(
        ...
        *,
        ...
        return shapes.GetComplianceSummaryByResourceTypeResponse.from_boto_dict(
            response
        )
    ...
    def get_discovered_resource_counts(
        ...
        **Example**
        ...
        return shapes.GetDiscoveredResourceCountsResponse.from_boto_dict(
            response
        )
    ...
    def get_resource_config_history(
        ...
        *,
        ...
        chronological_order: shapes.ChronologicalOrder = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetResourceConfigHistoryResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.GetResourceConfigHistoryResponse.from_boto_dict(response)
    ...
    def list_discovered_resources(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDiscoveredResourcesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListDiscoveredResourcesResponse.from_boto_dict(response)
    ...
    def put_aggregation_authorization(
        ...
        *,
        ...
        return shapes.PutAggregationAuthorizationResponse.from_boto_dict(
            response
        )
    ...
    def put_config_rule(
        ...
        *,
        ...
        response = self._boto_client.put_config_rule(**_request.to_boto_dict())
    ...
    def put_configuration_aggregator(
        ...
        *,
        ...
        return shapes.PutConfigurationAggregatorResponse.from_boto_dict(
            response
        )
    ...
    def put_delivery_channel(
        ...
        *,
        ...
        response = self._boto_client.put_delivery_channel(
            **_request.to_boto_dict()
        )
    ...
    def put_evaluations(
        ...
        *,
        ...
        response = self._boto_client.put_evaluations(**_request.to_boto_dict())

        return shapes.PutEvaluationsResponse.from_boto_dict(response)
    ...
    def put_retention_configuration(
        ...
        **default**. When you have a `RetentionConfiguration` object named **default** ,
        ...
        return shapes.PutRetentionConfigurationResponse.from_boto_dict(response)
    ...
    def start_config_rules_evaluation(
        ...
        *,
        ...
        return shapes.StartConfigRulesEvaluationResponse.from_boto_dict(
            response
        )
