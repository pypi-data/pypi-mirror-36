...
class Client(ClientBase):
    ...
    def accept_portfolio_share(
        ...
        *,
        ...
        return shapes.AcceptPortfolioShareOutput.from_boto_dict(response)
    ...
    def associate_principal_with_portfolio(
        ...
        *,
        portfolio_id: str,
        principal_arn: str,
        principal_type: shapes.PrincipalType,
        accept_language: str = ShapeBase.NOT_SET,
        ...
        return shapes.AssociatePrincipalWithPortfolioOutput.from_boto_dict(
            response
        )
    ...
    def associate_product_with_portfolio(
        ...
        *,
        ...
        return shapes.AssociateProductWithPortfolioOutput.from_boto_dict(
            response
        )
    ...
    def associate_tag_option_with_resource(
        ...
        *,
        ...
        return shapes.AssociateTagOptionWithResourceOutput.from_boto_dict(
            response
        )
    ...
    def copy_product(
        ...
        *,
        ...
        List[typing.Dict[shapes.ProvisioningArtifactPropertyName, str]
            ] = ShapeBase.NOT_SET,
        copy_options: typing.List[shapes.CopyOption] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.copy_product(**_request.to_boto_dict())

        return shapes.CopyProductOutput.from_boto_dict(response)
    ...
    def create_constraint(
        ...
        *,
        ...
        response = self._boto_client.create_constraint(
            **_request.to_boto_dict()
        )

        return shapes.CreateConstraintOutput.from_boto_dict(response)
    ...
    def create_portfolio(
        ...
        *,
        ...
        response = self._boto_client.create_portfolio(**_request.to_boto_dict())

        return shapes.CreatePortfolioOutput.from_boto_dict(response)
    ...
    def create_portfolio_share(
        ...
        *,
        ...
        return shapes.CreatePortfolioShareOutput.from_boto_dict(response)
    ...
    def create_product(
        ...
        *,
        name: str,
        owner: str,
        product_type: shapes.ProductType,
        ...
        response = self._boto_client.create_product(**_request.to_boto_dict())

        return shapes.CreateProductOutput.from_boto_dict(response)
    ...
    def create_provisioned_product_plan(
        ...
        *,
        plan_name: str,
        plan_type: shapes.ProvisionedProductPlanType,
        product_id: str,
        ...
        return shapes.CreateProvisionedProductPlanOutput.from_boto_dict(
            response
        )
    ...
    def create_provisioning_artifact(
        ...
        *,
        ...
        return shapes.CreateProvisioningArtifactOutput.from_boto_dict(response)
    ...
    def create_tag_option(
        ...
        *,
        ...
        response = self._boto_client.create_tag_option(
            **_request.to_boto_dict()
        )

        return shapes.CreateTagOptionOutput.from_boto_dict(response)
    ...
    def delete_constraint(
        ...
        *,
        ...
        response = self._boto_client.delete_constraint(
            **_request.to_boto_dict()
        )

        return shapes.DeleteConstraintOutput.from_boto_dict(response)
    ...
    def delete_portfolio(
        ...
        *,
        ...
        response = self._boto_client.delete_portfolio(**_request.to_boto_dict())

        return shapes.DeletePortfolioOutput.from_boto_dict(response)
    ...
    def delete_portfolio_share(
        ...
        *,
        ...
        return shapes.DeletePortfolioShareOutput.from_boto_dict(response)
    ...
    def delete_product(
        ...
        *,
        ...
        response = self._boto_client.delete_product(**_request.to_boto_dict())

        return shapes.DeleteProductOutput.from_boto_dict(response)
    ...
    def delete_provisioned_product_plan(
        ...
        *,
        ...
        return shapes.DeleteProvisionedProductPlanOutput.from_boto_dict(
            response
        )
    ...
    def delete_provisioning_artifact(
        ...
        *,
        ...
        return shapes.DeleteProvisioningArtifactOutput.from_boto_dict(response)
    ...
    def delete_tag_option(
        ...
        *,
        ...
        response = self._boto_client.delete_tag_option(
            **_request.to_boto_dict()
        )

        return shapes.DeleteTagOptionOutput.from_boto_dict(response)
    ...
    def describe_constraint(
        ...
        *,
        ...
        response = self._boto_client.describe_constraint(
            **_request.to_boto_dict()
        )

        return shapes.DescribeConstraintOutput.from_boto_dict(response)
    ...
    def describe_copy_product_status(
        ...
        *,
        ...
        return shapes.DescribeCopyProductStatusOutput.from_boto_dict(response)
    ...
    def describe_portfolio(
        ...
        *,
        ...
        response = self._boto_client.describe_portfolio(
            **_request.to_boto_dict()
        )

        return shapes.DescribePortfolioOutput.from_boto_dict(response)
    ...
    def describe_product(
        ...
        *,
        ...
        response = self._boto_client.describe_product(**_request.to_boto_dict())

        return shapes.DescribeProductOutput.from_boto_dict(response)
    ...
    def describe_product_as_admin(
        ...
        *,
        ...
        return shapes.DescribeProductAsAdminOutput.from_boto_dict(response)
    ...
    def describe_product_view(
        ...
        *,
        ...
        response = self._boto_client.describe_product_view(
            **_request.to_boto_dict()
        )

        return shapes.DescribeProductViewOutput.from_boto_dict(response)
    ...
    def describe_provisioned_product(
        ...
        *,
        ...
        return shapes.DescribeProvisionedProductOutput.from_boto_dict(response)
    ...
    def describe_provisioned_product_plan(
        ...
        *,
        ...
        return shapes.DescribeProvisionedProductPlanOutput.from_boto_dict(
            response
        )
    ...
    def describe_provisioning_artifact(
        ...
        *,
        ...
        return shapes.DescribeProvisioningArtifactOutput.from_boto_dict(
            response
        )
    ...
    def describe_provisioning_parameters(
        ...
        *,
        ...
        return shapes.DescribeProvisioningParametersOutput.from_boto_dict(
            response
        )
    ...
    def describe_record(
        ...
        *,
        ...
        response = self._boto_client.describe_record(**_request.to_boto_dict())

        return shapes.DescribeRecordOutput.from_boto_dict(response)
    ...
    def describe_tag_option(
        ...
        *,
        ...
        response = self._boto_client.describe_tag_option(
            **_request.to_boto_dict()
        )

        return shapes.DescribeTagOptionOutput.from_boto_dict(response)
    ...
    def disassociate_principal_from_portfolio(
        ...
        *,
        ...
        return shapes.DisassociatePrincipalFromPortfolioOutput.from_boto_dict(
            response
        )
    ...
    def disassociate_product_from_portfolio(
        ...
        *,
        ...
        return shapes.DisassociateProductFromPortfolioOutput.from_boto_dict(
            response
        )
    ...
    def disassociate_tag_option_from_resource(
        ...
        *,
        ...
        return shapes.DisassociateTagOptionFromResourceOutput.from_boto_dict(
            response
        )
    ...
    def execute_provisioned_product_plan(
        ...
        *,
        ...
        return shapes.ExecuteProvisionedProductPlanOutput.from_boto_dict(
            response
        )
    ...
    def list_accepted_portfolio_shares(
        ...
        *,
        ...
        page_token: str = ShapeBase.NOT_SET,
        page_size: int = ShapeBase.NOT_SET,
        portfolio_share_type: shapes.PortfolioShareType = ShapeBase.NOT_SET,
        ...
        result = shapes.ListAcceptedPortfolioSharesOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListAcceptedPortfolioSharesOutput.from_boto_dict(response)
    ...
    def list_constraints_for_portfolio(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListConstraintsForPortfolioOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListConstraintsForPortfolioOutput.from_boto_dict(response)
    ...
    def list_launch_paths(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListLaunchPathsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListLaunchPathsOutput.from_boto_dict(response)
    ...
    def list_portfolio_access(
        ...
        *,
        ...
        response = self._boto_client.list_portfolio_access(
            **_request.to_boto_dict()
        )

        return shapes.ListPortfolioAccessOutput.from_boto_dict(response)
    ...
    def list_portfolios(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPortfoliosOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListPortfoliosOutput.from_boto_dict(response)
    ...
    def list_portfolios_for_product(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPortfoliosForProductOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListPortfoliosForProductOutput.from_boto_dict(response)
    ...
    def list_principals_for_portfolio(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPrincipalsForPortfolioOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListPrincipalsForPortfolioOutput.from_boto_dict(response)
    ...
    def list_provisioned_product_plans(
        ...
        *,
        ...
        return shapes.ListProvisionedProductPlansOutput.from_boto_dict(response)
    ...
    def list_provisioning_artifacts(
        ...
        *,
        ...
        return shapes.ListProvisioningArtifactsOutput.from_boto_dict(response)
    ...
    def list_record_history(
        ...
        *,
        ...
        response = self._boto_client.list_record_history(
            **_request.to_boto_dict()
        )

        return shapes.ListRecordHistoryOutput.from_boto_dict(response)
    ...
    def list_resources_for_tag_option(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListResourcesForTagOptionOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListResourcesForTagOptionOutput.from_boto_dict(response)
    ...
    def list_tag_options(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTagOptionsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListTagOptionsOutput.from_boto_dict(response)
    ...
    def provision_product(
        ...
        *,
        ...
        response = self._boto_client.provision_product(
            **_request.to_boto_dict()
        )

        return shapes.ProvisionProductOutput.from_boto_dict(response)
    ...
    def reject_portfolio_share(
        ...
        *,
        ...
        return shapes.RejectPortfolioShareOutput.from_boto_dict(response)
    ...
    def scan_provisioned_products(
        ...
        *,
        ...
        return shapes.ScanProvisionedProductsOutput.from_boto_dict(response)
    ...
    def search_products(
        ...
        *,
        accept_language: str = ShapeBase.NOT_SET,
        filters: typing.Dict[shapes.ProductViewFilterBy, typing.
                             List[str]] = ShapeBase.NOT_SET,
        page_size: int = ShapeBase.NOT_SET,
        sort_by: shapes.ProductViewSortBy = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.search_products(**_request.to_boto_dict())

        return shapes.SearchProductsOutput.from_boto_dict(response)
    ...
    def search_products_as_admin(
        ...
        *,
        ...
        page_token: str = ShapeBase.NOT_SET,
        page_size: int = ShapeBase.NOT_SET,
        product_source: shapes.ProductSource = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.SearchProductsAsAdminOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.SearchProductsAsAdminOutput.from_boto_dict(response)
    ...
    def search_provisioned_products(
        ...
        *,
        accept_language: str = ShapeBase.NOT_SET,
        access_level_filter: shapes.AccessLevelFilter = ShapeBase.NOT_SET,
        filters: typing.Dict[shapes.ProvisionedProductViewFilterBy, typing.
                             List[str]] = ShapeBase.NOT_SET,
        ...
        return shapes.SearchProvisionedProductsOutput.from_boto_dict(response)
    ...
    def terminate_provisioned_product(
        ...
        *,
        ...
        return shapes.TerminateProvisionedProductOutput.from_boto_dict(response)
    ...
    def update_constraint(
        ...
        *,
        ...
        response = self._boto_client.update_constraint(
            **_request.to_boto_dict()
        )

        return shapes.UpdateConstraintOutput.from_boto_dict(response)
    ...
    def update_portfolio(
        ...
        *,
        ...
        response = self._boto_client.update_portfolio(**_request.to_boto_dict())

        return shapes.UpdatePortfolioOutput.from_boto_dict(response)
    ...
    def update_product(
        ...
        *,
        ...
        response = self._boto_client.update_product(**_request.to_boto_dict())

        return shapes.UpdateProductOutput.from_boto_dict(response)
    ...
    def update_provisioned_product(
        ...
        *,
        ...
        return shapes.UpdateProvisionedProductOutput.from_boto_dict(response)
    ...
    def update_provisioning_artifact(
        ...
        *,
        ...
        return shapes.UpdateProvisioningArtifactOutput.from_boto_dict(response)
    ...
    def update_tag_option(
        ...
        *,
        ...
        response = self._boto_client.update_tag_option(
            **_request.to_boto_dict()
        )

        return shapes.UpdateTagOptionOutput.from_boto_dict(response)
