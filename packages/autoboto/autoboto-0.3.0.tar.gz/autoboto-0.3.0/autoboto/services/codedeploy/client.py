...
class Client(ClientBase):
    ...
    def batch_get_application_revisions(
        ...
        *,
        ...
        return shapes.BatchGetApplicationRevisionsOutput.from_boto_dict(
            response
        )
    ...
    def batch_get_applications(
        ...
        *,
        ...
        return shapes.BatchGetApplicationsOutput.from_boto_dict(response)
    ...
    def batch_get_deployment_groups(
        ...
        *,
        ...
        return shapes.BatchGetDeploymentGroupsOutput.from_boto_dict(response)
    ...
    def batch_get_deployment_instances(
        ...
        *,
        ...
        return shapes.BatchGetDeploymentInstancesOutput.from_boto_dict(response)
    ...
    def batch_get_deployments(
        ...
        *,
        ...
        response = self._boto_client.batch_get_deployments(
            **_request.to_boto_dict()
        )

        return shapes.BatchGetDeploymentsOutput.from_boto_dict(response)
    ...
    def batch_get_on_premises_instances(
        ...
        *,
        ...
        return shapes.BatchGetOnPremisesInstancesOutput.from_boto_dict(response)
    ...
    def continue_deployment(
        ...
        *,
        ...
        response = self._boto_client.continue_deployment(
            **_request.to_boto_dict()
        )
    ...
    def create_application(
        ...
        *,
        application_name: str,
        compute_platform: shapes.ComputePlatform = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_application(
            **_request.to_boto_dict()
        )

        return shapes.CreateApplicationOutput.from_boto_dict(response)
    ...
    def create_deployment(
        ...
        *,
        ...
        file_exists_behavior: shapes.FileExistsBehavior = ShapeBase.NOT_SET,
        ...
        return shapes.CreateDeploymentOutput.from_boto_dict(response)
    ...
    def create_deployment_config(
        ...
        *,
        ...
        return shapes.CreateDeploymentConfigOutput.from_boto_dict(response)
    ...
    def create_deployment_group(
        ...
        *,
        ...
        return shapes.CreateDeploymentGroupOutput.from_boto_dict(response)
    ...
    def delete_application(
        ...
        *,
        ...
        response = self._boto_client.delete_application(
            **_request.to_boto_dict()
        )
    ...
    def delete_deployment_group(
        ...
        *,
        ...
        return shapes.DeleteDeploymentGroupOutput.from_boto_dict(response)
    ...
    def delete_git_hub_account_token(
        ...
        *,
        ...
        return shapes.DeleteGitHubAccountTokenOutput.from_boto_dict(response)
    ...
    def get_application(
        ...
        *,
        ...
        response = self._boto_client.get_application(**_request.to_boto_dict())

        return shapes.GetApplicationOutput.from_boto_dict(response)
    ...
    def get_application_revision(
        ...
        *,
        ...
        return shapes.GetApplicationRevisionOutput.from_boto_dict(response)
    ...
    def get_deployment(
        ...
        *,
        ...
        return shapes.GetDeploymentOutput.from_boto_dict(response)
    ...
    def get_deployment_config(
        ...
        *,
        ...
        response = self._boto_client.get_deployment_config(
            **_request.to_boto_dict()
        )

        return shapes.GetDeploymentConfigOutput.from_boto_dict(response)
    ...
    def get_deployment_group(
        ...
        *,
        ...
        response = self._boto_client.get_deployment_group(
            **_request.to_boto_dict()
        )

        return shapes.GetDeploymentGroupOutput.from_boto_dict(response)
    ...
    def get_deployment_instance(
        ...
        *,
        ...
        return shapes.GetDeploymentInstanceOutput.from_boto_dict(response)
    ...
    def get_on_premises_instance(
        ...
        *,
        ...
        return shapes.GetOnPremisesInstanceOutput.from_boto_dict(response)
    ...
    def list_application_revisions(
        ...
        *,
        application_name: str,
        sort_by: shapes.ApplicationRevisionSortBy = ShapeBase.NOT_SET,
        sort_order: shapes.SortOrder = ShapeBase.NOT_SET,
        s3_bucket: str = ShapeBase.NOT_SET,
        s3_key_prefix: str = ShapeBase.NOT_SET,
        deployed: shapes.ListStateFilterAction = ShapeBase.NOT_SET,
        ...
        result = shapes.ListApplicationRevisionsOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListApplicationRevisionsOutput.from_boto_dict(response)
    ...
    def list_applications(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListApplicationsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListApplicationsOutput.from_boto_dict(response)
    ...
    def list_deployment_configs(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDeploymentConfigsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListDeploymentConfigsOutput.from_boto_dict(response)
    ...
    def list_deployment_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDeploymentGroupsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListDeploymentGroupsOutput.from_boto_dict(response)
    ...
    def list_deployment_instances(
        ...
        *,
        deployment_id: str,
        next_token: str = ShapeBase.NOT_SET,
        instance_status_filter: typing.List[shapes.InstanceStatus
                                           ] = ShapeBase.NOT_SET,
        instance_type_filter: typing.List[shapes.InstanceType
                                         ] = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDeploymentInstancesOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListDeploymentInstancesOutput.from_boto_dict(response)
    ...
    def list_deployments(
        ...
        *,
        ...
        deployment_group_name: str = ShapeBase.NOT_SET,
        include_only_statuses: typing.List[shapes.DeploymentStatus
                                          ] = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDeploymentsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListDeploymentsOutput.from_boto_dict(response)
    ...
    def list_git_hub_account_token_names(
        ...
        *,
        ...
        return shapes.ListGitHubAccountTokenNamesOutput.from_boto_dict(response)

    def list_on_premises_instances(
        self,
        _request: shapes.ListOnPremisesInstancesInput = None,
        *,
        registration_status: shapes.RegistrationStatus = ShapeBase.NOT_SET,
        ...
        return shapes.ListOnPremisesInstancesOutput.from_boto_dict(response)
    ...
    def put_lifecycle_event_hook_execution_status(
        ...
        *,
        ...
        status: shapes.LifecycleEventStatus = ShapeBase.NOT_SET,
        ...
        return shapes.PutLifecycleEventHookExecutionStatusOutput.from_boto_dict(
            response
        )
    ...
    def stop_deployment(
        ...
        *,
        ...
        response = self._boto_client.stop_deployment(**_request.to_boto_dict())

        return shapes.StopDeploymentOutput.from_boto_dict(response)
    ...
    def update_application(
        ...
        *,
        ...
        response = self._boto_client.update_application(
            **_request.to_boto_dict()
        )
    ...
    def update_deployment_group(
        ...
        *,
        ...
        return shapes.UpdateDeploymentGroupOutput.from_boto_dict(response)
