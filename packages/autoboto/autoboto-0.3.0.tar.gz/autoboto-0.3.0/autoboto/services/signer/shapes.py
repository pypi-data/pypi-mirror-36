...
class CancelSigningProfileRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CancelSigningProfileRequest", None, None]:
        yield from super().paginate()
...
class DescribeSigningJobRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeSigningJobRequest", None, None]:
        yield from super().paginate()
...
class DescribeSigningJobResponse(OutputShapeBase):
    ...
    status: "SigningStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeSigningJobResponse", None, None]:
        yield from super().paginate()
...
class EncryptionAlgorithmOptions(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "allowed_values",
                "allowedValues",
                TypeInfo(typing.List[EncryptionAlgorithm]),
            ),
            (
                "default_value",
                "defaultValue",
                TypeInfo(EncryptionAlgorithm),
            ),
        ]
    ...
    def paginate(self,
                ) -> typing.Generator["EncryptionAlgorithmOptions", None, None]:
        yield from super().paginate()
...
class GetSigningPlatformRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetSigningPlatformRequest", None, None]:
        yield from super().paginate()
...
class GetSigningPlatformResponse(OutputShapeBase):
    ...
    category: "Category" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self,
                ) -> typing.Generator["GetSigningPlatformResponse", None, None]:
        yield from super().paginate()
...
class GetSigningProfileRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetSigningProfileRequest", None, None]:
        yield from super().paginate()
...
class GetSigningProfileResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetSigningProfileResponse", None, None]:
        yield from super().paginate()
...
class HashAlgorithmOptions(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "allowed_values",
                "allowedValues",
                TypeInfo(typing.List[HashAlgorithm]),
            ),
            (
                "default_value",
                "defaultValue",
                TypeInfo(HashAlgorithm),
            ),
        ]
    ...
    def paginate(self,
                ) -> typing.Generator["HashAlgorithmOptions", None, None]:
        yield from super().paginate()
...
class InternalServiceErrorException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InternalServiceErrorException", None, None]:
        yield from super().paginate()
...
class ListSigningJobsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListSigningJobsRequest", None, None]:
        yield from super().paginate()
...
class ListSigningJobsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListSigningJobsResponse", None, None]:
        yield from super().paginate()
...
class ListSigningPlatformsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListSigningPlatformsRequest", None, None]:
        yield from super().paginate()
...
class ListSigningPlatformsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListSigningPlatformsResponse", None, None]:
        yield from super().paginate()
...
class ListSigningProfilesRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListSigningProfilesRequest", None, None]:
        yield from super().paginate()
...
class ListSigningProfilesResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListSigningProfilesResponse", None, None]:
        yield from super().paginate()
...
class PutSigningProfileRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutSigningProfileRequest", None, None]:
        yield from super().paginate()
...
class PutSigningProfileResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutSigningProfileResponse", None, None]:
        yield from super().paginate()
...
class S3SignedObject(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["S3SignedObject", None, None]:
        yield from super().paginate()
...
class S3Source(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["S3Source", None, None]:
        yield from super().paginate()
...
class SignedObject(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SignedObject", None, None]:
        yield from super().paginate()
...
class SigningConfiguration(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SigningConfiguration", None, None]:
        yield from super().paginate()
...
class SigningConfigurationOverrides(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["SigningConfigurationOverrides", None, None]:
        yield from super().paginate()
...
class SigningImageFormat(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "supported_formats",
                "supportedFormats",
                TypeInfo(typing.List[ImageFormat]),
            ),
            (
                "default_format",
                "defaultFormat",
                TypeInfo(ImageFormat),
            ),
        ]
    ...
    def paginate(self, ) -> typing.Generator["SigningImageFormat", None, None]:
        yield from super().paginate()
...
class SigningJob(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SigningJob", None, None]:
        yield from super().paginate()
...
class SigningMaterial(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SigningMaterial", None, None]:
        yield from super().paginate()
...
class SigningPlatform(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SigningPlatform", None, None]:
        yield from super().paginate()
...
class SigningPlatformOverrides(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SigningPlatformOverrides", None, None]:
        yield from super().paginate()
...
class SigningProfile(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SigningProfile", None, None]:
        yield from super().paginate()
...
class StartSigningJobRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["StartSigningJobRequest", None, None]:
        yield from super().paginate()
...
class StartSigningJobResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["StartSigningJobResponse", None, None]:
        yield from super().paginate()
