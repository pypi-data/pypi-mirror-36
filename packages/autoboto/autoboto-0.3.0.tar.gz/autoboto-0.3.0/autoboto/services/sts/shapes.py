...
class AssumeRoleRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AssumeRoleRequest", None, None]:
...
class AssumeRoleResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AssumeRoleResponse", None, None]:
        yield from super().paginate()
...
class AssumeRoleWithSAMLRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AssumeRoleWithSAMLRequest", None, None]:
        yield from super().paginate()
...
class AssumeRoleWithSAMLResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AssumeRoleWithSAMLResponse", None, None]:
        yield from super().paginate()
...
class AssumeRoleWithWebIdentityRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AssumeRoleWithWebIdentityRequest", None, None]:
        yield from super().paginate()
...
class AssumeRoleWithWebIdentityResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AssumeRoleWithWebIdentityResponse", None, None]:
        yield from super().paginate()
...
class AssumedRoleUser(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AssumedRoleUser", None, None]:
        yield from super().paginate()
...
class DecodeAuthorizationMessageRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DecodeAuthorizationMessageRequest", None, None]:
        yield from super().paginate()
...
class DecodeAuthorizationMessageResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DecodeAuthorizationMessageResponse", None, None]:
        yield from super().paginate()
...
class ExpiredTokenException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ExpiredTokenException", None, None]:
        yield from super().paginate()
...
class FederatedUser(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["FederatedUser", None, None]:
        yield from super().paginate()
...
class GetCallerIdentityRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetCallerIdentityRequest", None, None]:
        yield from super().paginate()
...
class GetCallerIdentityResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetCallerIdentityResponse", None, None]:
        yield from super().paginate()
...
class GetFederationTokenResponse(OutputShapeBase):
    ...
    federated_user: "FederatedUser" = dataclasses.field(default_factory=dict, )
...
class GetSessionTokenRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetSessionTokenRequest", None, None]:
        yield from super().paginate()
...
class GetSessionTokenResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetSessionTokenResponse", None, None]:
        yield from super().paginate()
...
class IDPCommunicationErrorException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["IDPCommunicationErrorException", None, None]:
        yield from super().paginate()
...
class IDPRejectedClaimException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["IDPRejectedClaimException", None, None]:
        yield from super().paginate()
...
class InvalidAuthorizationMessageException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidAuthorizationMessageException", None, None]:
        yield from super().paginate()
...
class InvalidIdentityTokenException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidIdentityTokenException", None, None]:
        yield from super().paginate()
...
class PackedPolicyTooLargeException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["PackedPolicyTooLargeException", None, None]:
        yield from super().paginate()
...
class RegionDisabledException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RegionDisabledException", None, None]:
        yield from super().paginate()
