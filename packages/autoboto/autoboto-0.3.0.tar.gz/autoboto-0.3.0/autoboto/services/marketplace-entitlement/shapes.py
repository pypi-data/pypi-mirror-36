...
class Entitlement(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Entitlement", None, None]:
...
class EntitlementValue(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EntitlementValue", None, None]:
        yield from super().paginate()
...
class GetEntitlementsRequest(ShapeBase):
    ...
    filter: typing.Dict["GetEntitlementFilterName", typing.
    ...
    def paginate(self,
                ) -> typing.Generator["GetEntitlementsRequest", None, None]:
        yield from super().paginate()
...
class GetEntitlementsResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetEntitlementsResult", None, None]:
        yield from super().paginate()
