...
class BucketPermissionException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["BucketPermissionException", None, None]:
        yield from super().paginate()
...
class CancelJobInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CancelJobInput", None, None]:
        yield from super().paginate()
...
class CancelJobOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CancelJobOutput", None, None]:
        yield from super().paginate()
...
class CanceledJobIdException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CanceledJobIdException", None, None]:
        yield from super().paginate()
...
class CreateJobInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateJobInput", None, None]:
        yield from super().paginate()
...
class CreateJobQuotaExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateJobQuotaExceededException", None, None]:
        yield from super().paginate()
...
class ExpiredJobIdException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ExpiredJobIdException", None, None]:
        yield from super().paginate()
...
class GetShippingLabelInput(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetShippingLabelInput", None, None]:
        yield from super().paginate()
...
class GetShippingLabelOutput(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetShippingLabelOutput", None, None]:
        yield from super().paginate()
...
class GetStatusInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetStatusInput", None, None]:
        yield from super().paginate()
...
class GetStatusOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetStatusOutput", None, None]:
        yield from super().paginate()
...
class InvalidAccessKeyIdException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidAccessKeyIdException", None, None]:
        yield from super().paginate()
...
class InvalidCustomsException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidCustomsException", None, None]:
        yield from super().paginate()
...
class InvalidFileSystemException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidFileSystemException", None, None]:
        yield from super().paginate()
...
class InvalidJobIdException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidJobIdException", None, None]:
        yield from super().paginate()
...
class InvalidManifestFieldException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidManifestFieldException", None, None]:
        yield from super().paginate()
...
class InvalidVersionException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidVersionException", None, None]:
        yield from super().paginate()
...
class MalformedManifestException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["MalformedManifestException", None, None]:
        yield from super().paginate()
...
class MissingCustomsException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["MissingCustomsException", None, None]:
        yield from super().paginate()
...
class MissingManifestFieldException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["MissingManifestFieldException", None, None]:
        yield from super().paginate()
...
class MissingParameterException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["MissingParameterException", None, None]:
        yield from super().paginate()
...
class MultipleRegionsException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["MultipleRegionsException", None, None]:
        yield from super().paginate()
...
class UnableToCancelJobIdException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnableToCancelJobIdException", None, None]:
        yield from super().paginate()
...
class UnableToUpdateJobIdException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnableToUpdateJobIdException", None, None]:
        yield from super().paginate()
...
class UpdateJobInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdateJobInput", None, None]:
        yield from super().paginate()
...
class UpdateJobOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdateJobOutput", None, None]:
        yield from super().paginate()
