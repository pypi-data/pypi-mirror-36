...
class Client(ClientBase):
    ...
    def clone_stack(
        ...
        *,
        ...
        attributes: typing.Dict[shapes.
                                StackAttributesKeys, str] = ShapeBase.NOT_SET,
    ...
    def create_app(
        ...
        *,
        ...
        attributes: typing.Dict[shapes.AppAttributesKeys, str] = ShapeBase.
        NOT_SET,
    ...
    def create_layer(
        ...
        *,
        ...
        shortname: str,
        attributes: typing.Dict[shapes.
                                LayerAttributesKeys, str] = ShapeBase.NOT_SET,
    ...
    def describe_ecs_clusters(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        result = shapes.DescribeEcsClustersResult.from_boto_dict(first_page)
