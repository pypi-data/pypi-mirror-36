...
class BillExpirationException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["BillExpirationException", None, None]:
...
class Coverage(ShapeBase):
    ...
    coverage_hours: "CoverageHours" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["Coverage", None, None]:
        yield from super().paginate()
...
class CoverageByTime(ShapeBase):
    ...
    time_period: "DateInterval" = dataclasses.field(default_factory=dict, )
    ...
    total: "Coverage" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["CoverageByTime", None, None]:
        yield from super().paginate()
...
class CoverageHours(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CoverageHours", None, None]:
        yield from super().paginate()
...
class DataUnavailableException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DataUnavailableException", None, None]:
        yield from super().paginate()
...
class DateInterval(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DateInterval", None, None]:
        yield from super().paginate()
...
class DimensionValues(ShapeBase):
    ...
    key: "Dimension" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["DimensionValues", None, None]:
        yield from super().paginate()
...
class DimensionValuesWithAttributes(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DimensionValuesWithAttributes", None, None]:
        yield from super().paginate()
...
class EC2InstanceDetails(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EC2InstanceDetails", None, None]:
        yield from super().paginate()
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "offering_class",
                "OfferingClass",
                TypeInfo(OfferingClass),
            ),
        ]

    # Whether you want a recommendation for standard or convertible reservations.
    offering_class: "OfferingClass" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["EC2Specification", None, None]:
        yield from super().paginate()
...
class ESInstanceDetails(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ESInstanceDetails", None, None]:
        yield from super().paginate()
...
class ElastiCacheInstanceDetails(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ElastiCacheInstanceDetails", None, None]:
        yield from super().paginate()
...
class Expression(ShapeBase):
    ...
    or_: typing.List["Expression"] = dataclasses.field(default_factory=list, )

    # Return results that match both `Dimension` objects.
    and_: typing.List["Expression"] = dataclasses.field(default_factory=list, )

    # Return results that don't match a `Dimension` object.
    not_: "Expression" = dataclasses.field(default_factory=dict, )

    # The specific `Dimension` to use for `Expression`.
    dimensions: "DimensionValues" = dataclasses.field(default_factory=dict, )

    # The specific `Tag` to use for `Expression`.
    tags: "TagValues" = dataclasses.field(default_factory=dict, )
...
class GetCostAndUsageRequest(ShapeBase):
    ...
    # `MONTHLY` or `DAILY`.
    granularity: "Granularity" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    filter: "Expression" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self,
                ) -> typing.Generator["GetCostAndUsageRequest", None, None]:
        yield from super().paginate()
...
class GetCostAndUsageResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetCostAndUsageResponse", None, None]:
        yield from super().paginate()
...
class GetDimensionValuesRequest(ShapeBase):
    ...
    dimension: "Dimension" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    context: "Context" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self,
                ) -> typing.Generator["GetDimensionValuesRequest", None, None]:
        yield from super().paginate()
...
class GetDimensionValuesResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetDimensionValuesResponse", None, None]:
        yield from super().paginate()
...
class GetReservationCoverageRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetReservationCoverageRequest", None, None]:
        yield from super().paginate()
...
class GetReservationCoverageResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetReservationCoverageResponse", None, None]:
        yield from super().paginate()
...
class GetReservationPurchaseRecommendationRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "account_scope",
                "AccountScope",
                TypeInfo(AccountScope),
            ),
            (
                "lookback_period_in_days",
                "LookbackPeriodInDays",
                TypeInfo(LookbackPeriodInDays),
            ),
            (
                "term_in_years",
                "TermInYears",
                TypeInfo(TermInYears),
            ),
            (
                "payment_option",
                "PaymentOption",
    ...
    account_scope: "AccountScope" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # The number of previous days that you want AWS to consider when it
    # calculates your recommendations.
    lookback_period_in_days: "LookbackPeriodInDays" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # The reservation term that you want recommendations for.
    term_in_years: "TermInYears" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator[
        "GetReservationPurchaseRecommendationRequest", None, None]:
        yield from super().paginate()
...
class GetReservationPurchaseRecommendationResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "GetReservationPurchaseRecommendationResponse", None, None]:
        yield from super().paginate()
...
class GetReservationUtilizationRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetReservationUtilizationRequest", None, None]:
        yield from super().paginate()
...
class GetReservationUtilizationResponse(OutputShapeBase):
    ...
    total: "ReservationAggregates" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetReservationUtilizationResponse", None, None]:
        yield from super().paginate()
...
class GetTagsResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetTagsResponse", None, None]:
        yield from super().paginate()
...
class GroupDefinition(ShapeBase):
    ...
    type: "GroupDefinitionType" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # The string that represents a key for a specified group.
    key: str = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["GroupDefinition", None, None]:
        yield from super().paginate()
...
class RDSInstanceDetails(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["RDSInstanceDetails", None, None]:
        yield from super().paginate()
...
class RedshiftInstanceDetails(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RedshiftInstanceDetails", None, None]:
        yield from super().paginate()
...
class RequestChangedException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RequestChangedException", None, None]:
        yield from super().paginate()
...
class ReservationAggregates(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ReservationAggregates", None, None]:
        yield from super().paginate()
...
class ReservationCoverageGroup(ShapeBase):
    ...
    coverage: "Coverage" = dataclasses.field(default_factory=dict, )

    def paginate(self,
                ) -> typing.Generator["ReservationCoverageGroup", None, None]:
        yield from super().paginate()
...
class ReservationPurchaseRecommendation(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ReservationPurchaseRecommendation", None, None]:
        yield from super().paginate()
...
class ReservationPurchaseRecommendationDetail(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "ReservationPurchaseRecommendationDetail", None, None]:
        yield from super().paginate()
...
class ReservationPurchaseRecommendationMetadata(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "ReservationPurchaseRecommendationMetadata", None, None]:
        yield from super().paginate()
...
class ReservationPurchaseRecommendationSummary(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "ReservationPurchaseRecommendationSummary", None, None]:
        yield from super().paginate()
...
class ReservationUtilizationGroup(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ReservationUtilizationGroup", None, None]:
        yield from super().paginate()
...
class ResultByTime(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ResultByTime", None, None]:
        yield from super().paginate()
...
class ServiceSpecification(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ServiceSpecification", None, None]:
        yield from super().paginate()
...
class TagValues(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TagValues", None, None]:
        yield from super().paginate()
...
class UtilizationByTime(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UtilizationByTime", None, None]:
        yield from super().paginate()
