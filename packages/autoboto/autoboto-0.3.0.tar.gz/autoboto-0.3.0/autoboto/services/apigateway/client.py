...
class Client(ClientBase):
    ...
    def get_api_keys(
        ...
        *,
        ...
        result = shapes.ApiKeys.from_boto_dict(first_page)
    ...
    def get_base_path_mappings(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.BasePathMappings.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_client_certificates(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ClientCertificates.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_deployments(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.Deployments.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_domain_names(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DomainNames.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_models(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.Models.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_resources(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.Resources.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_rest_apis(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.RestApis.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_usage(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.Usage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_usage_plan_keys(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.UsagePlanKeys.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_usage_plans(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.UsagePlans.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_vpc_links(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.VpcLinks.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
