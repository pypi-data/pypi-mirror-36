...
class Client(ClientBase):
    ...
    def apply_security_groups_to_load_balancer(
        ...
        *,
        ...
        return shapes.ApplySecurityGroupsToLoadBalancerOutput.from_boto_dict(
            response
        )
    ...
    def attach_load_balancer_to_subnets(
        ...
        *,
        ...
        return shapes.AttachLoadBalancerToSubnetsOutput.from_boto_dict(response)
    ...
    def configure_health_check(
        ...
        *,
        ...
        return shapes.ConfigureHealthCheckOutput.from_boto_dict(response)
    ...
    def create_app_cookie_stickiness_policy(
        ...
        *,
        ...
        return shapes.CreateAppCookieStickinessPolicyOutput.from_boto_dict(
            response
        )
    ...
    def create_lb_cookie_stickiness_policy(
        ...
        *,
        ...
        return shapes.CreateLBCookieStickinessPolicyOutput.from_boto_dict(
            response
        )
    ...
    def create_load_balancer(
        ...
        *,
        ...
        return shapes.CreateAccessPointOutput.from_boto_dict(response)
    ...
    def create_load_balancer_listeners(
        ...
        *,
        ...
        return shapes.CreateLoadBalancerListenerOutput.from_boto_dict(response)
    ...
    def create_load_balancer_policy(
        ...
        *,
        ...
        return shapes.CreateLoadBalancerPolicyOutput.from_boto_dict(response)
    ...
    def delete_load_balancer(
        ...
        *,
        ...
        return shapes.DeleteAccessPointOutput.from_boto_dict(response)
    ...
    def delete_load_balancer_listeners(
        ...
        *,
        ...
        return shapes.DeleteLoadBalancerListenerOutput.from_boto_dict(response)
    ...
    def delete_load_balancer_policy(
        ...
        *,
        ...
        return shapes.DeleteLoadBalancerPolicyOutput.from_boto_dict(response)
    ...
    def deregister_instances_from_load_balancer(
        ...
        *,
        ...
        return shapes.DeregisterEndPointsOutput.from_boto_dict(response)
    ...
    def describe_instance_health(
        ...
        *,
        ...
        return shapes.DescribeEndPointStateOutput.from_boto_dict(response)
    ...
    def describe_load_balancer_policies(
        ...
        *,
        ...
        return shapes.DescribeLoadBalancerPoliciesOutput.from_boto_dict(
            response
        )
    ...
    def describe_load_balancer_policy_types(
        ...
        *,
        ...
        return shapes.DescribeLoadBalancerPolicyTypesOutput.from_boto_dict(
            response
        )
    ...
    def describe_load_balancers(
        ...
        *,
        ...
        result = shapes.DescribeAccessPointsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeAccessPointsOutput.from_boto_dict(response)
    ...
    def detach_load_balancer_from_subnets(
        ...
        *,
        ...
        return shapes.DetachLoadBalancerFromSubnetsOutput.from_boto_dict(
            response
        )
    ...
    def disable_availability_zones_for_load_balancer(
        ...
        *,
        ...
        return shapes.RemoveAvailabilityZonesOutput.from_boto_dict(response)
    ...
    def enable_availability_zones_for_load_balancer(
        ...
        *,
        ...
        return shapes.AddAvailabilityZonesOutput.from_boto_dict(response)
    ...
    def register_instances_with_load_balancer(
        ...
        *,
        ...
        return shapes.RegisterEndPointsOutput.from_boto_dict(response)
    ...
    def set_load_balancer_listener_ssl_certificate(
        ...
        *,
        ...
        return shapes.SetLoadBalancerListenerSSLCertificateOutput.from_boto_dict(
            response
        )
    ...
    def set_load_balancer_policies_for_backend_server(
        ...
        *,
        ...
        return shapes.SetLoadBalancerPoliciesForBackendServerOutput.from_boto_dict(
            response
        )
    ...
    def set_load_balancer_policies_of_listener(
        ...
        *,
        ...
        return shapes.SetLoadBalancerPoliciesOfListenerOutput.from_boto_dict(
            response
        )
