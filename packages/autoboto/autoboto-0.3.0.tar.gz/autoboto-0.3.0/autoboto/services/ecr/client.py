...
class Client(ClientBase):
    ...
    def describe_images(
        ...
        *,
        ...
        result = shapes.DescribeImagesResponse.from_boto_dict(first_page)
    ...
    def describe_repositories(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeRepositoriesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_images(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListImagesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
