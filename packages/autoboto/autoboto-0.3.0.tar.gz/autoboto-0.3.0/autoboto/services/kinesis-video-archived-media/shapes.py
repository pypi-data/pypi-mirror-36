...
class Fragment(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Fragment", None, None]:
        yield from super().paginate()
...
class FragmentSelector(ShapeBase):
    ...
    fragment_selector_type: "FragmentSelectorType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["FragmentSelector", None, None]:
        yield from super().paginate()
...
class GetHLSStreamingSessionURLInput(ShapeBase):
    ...
    # The default is `LIVE`.
    playback_mode: "PlaybackMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    discontinuity_mode: "DiscontinuityMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetHLSStreamingSessionURLInput", None, None]:
        yield from super().paginate()
...
class GetHLSStreamingSessionURLOutput(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetHLSStreamingSessionURLOutput", None, None]:
        yield from super().paginate()
...
class GetMediaForFragmentListInput(ShapeBase):
    ...
    fragments: typing.List[str] = dataclasses.field(default_factory=list, )

    def paginate(
        self,
    ) -> typing.Generator["GetMediaForFragmentListInput", None, None]:
        yield from super().paginate()
...
class GetMediaForFragmentListOutput(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetMediaForFragmentListOutput", None, None]:
        yield from super().paginate()
...
class HLSFragmentSelector(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "fragment_selector_type",
                "FragmentSelectorType",
                TypeInfo(HLSFragmentSelectorType),
            ),
            (
                "timestamp_range",
                "TimestampRange",
    ...
    fragment_selector_type: "HLSFragmentSelectorType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["HLSFragmentSelector", None, None]:
        yield from super().paginate()
...
class HLSTimestampRange(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["HLSTimestampRange", None, None]:
        yield from super().paginate()
...
class InvalidCodecPrivateDataException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidCodecPrivateDataException", None, None]:
        yield from super().paginate()
...
class ListFragmentsInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListFragmentsInput", None, None]:
        yield from super().paginate()
...
class ListFragmentsOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListFragmentsOutput", None, None]:
        yield from super().paginate()
...
class MissingCodecPrivateDataException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["MissingCodecPrivateDataException", None, None]:
        yield from super().paginate()
...
class NoDataRetentionException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["NoDataRetentionException", None, None]:
        yield from super().paginate()
...
class UnsupportedStreamMediaTypeException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnsupportedStreamMediaTypeException", None, None]:
        yield from super().paginate()
