...
class Client(ClientBase):
    ...
    def add_facet_to_object(
        ...
        *,
        ...
        response = self._boto_client.add_facet_to_object(
            **_request.to_boto_dict()
        )

        return shapes.AddFacetToObjectResponse.from_boto_dict(response)
    ...
    def apply_schema(
        ...
        *,
        ...
        response = self._boto_client.apply_schema(**_request.to_boto_dict())

        return shapes.ApplySchemaResponse.from_boto_dict(response)
    ...
    def attach_object(
        ...
        *,
        ...
        response = self._boto_client.attach_object(**_request.to_boto_dict())

        return shapes.AttachObjectResponse.from_boto_dict(response)
    ...
    def attach_policy(
        ...
        *,
        ...
        return shapes.AttachPolicyResponse.from_boto_dict(response)
    ...
    def attach_to_index(
        ...
        *,
        ...
        response = self._boto_client.attach_to_index(**_request.to_boto_dict())

        return shapes.AttachToIndexResponse.from_boto_dict(response)
    ...
    def attach_typed_link(
        ...
        *,
        ...
        response = self._boto_client.attach_typed_link(
            **_request.to_boto_dict()
        )

        return shapes.AttachTypedLinkResponse.from_boto_dict(response)
    ...
    def batch_read(
        ...
        *,
        ...
        consistency_level: shapes.ConsistencyLevel = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.batch_read(**_request.to_boto_dict())

        return shapes.BatchReadResponse.from_boto_dict(response)
    ...
    def batch_write(
        ...
        *,
        ...
        response = self._boto_client.batch_write(**_request.to_boto_dict())

        return shapes.BatchWriteResponse.from_boto_dict(response)
    ...
    def create_directory(
        ...
        *,
        ...
        response = self._boto_client.create_directory(**_request.to_boto_dict())

        return shapes.CreateDirectoryResponse.from_boto_dict(response)
    ...
    def create_facet(
        ...
        *,
        ...
        object_type: shapes.ObjectType = ShapeBase.NOT_SET,
        facet_style: shapes.FacetStyle = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_facet(**_request.to_boto_dict())

        return shapes.CreateFacetResponse.from_boto_dict(response)
    ...
    def create_index(
        ...
        *,
        ...
        response = self._boto_client.create_index(**_request.to_boto_dict())

        return shapes.CreateIndexResponse.from_boto_dict(response)
    ...
    def create_object(
        ...
        *,
        ...
        response = self._boto_client.create_object(**_request.to_boto_dict())

        return shapes.CreateObjectResponse.from_boto_dict(response)
    ...
    def create_schema(
        ...
        *,
        ...
        response = self._boto_client.create_schema(**_request.to_boto_dict())

        return shapes.CreateSchemaResponse.from_boto_dict(response)
    ...
    def create_typed_link_facet(
        ...
        *,
        ...
        return shapes.CreateTypedLinkFacetResponse.from_boto_dict(response)
    ...
    def delete_directory(
        ...
        *,
        ...
        response = self._boto_client.delete_directory(**_request.to_boto_dict())

        return shapes.DeleteDirectoryResponse.from_boto_dict(response)
    ...
    def delete_facet(
        ...
        *,
        ...
        response = self._boto_client.delete_facet(**_request.to_boto_dict())

        return shapes.DeleteFacetResponse.from_boto_dict(response)
    ...
    def delete_schema(
        ...
        *,
        ...
        response = self._boto_client.delete_schema(**_request.to_boto_dict())

        return shapes.DeleteSchemaResponse.from_boto_dict(response)
    ...
    def delete_typed_link_facet(
        ...
        *,
        ...
        return shapes.DeleteTypedLinkFacetResponse.from_boto_dict(response)
    ...
    def detach_from_index(
        ...
        *,
        ...
        response = self._boto_client.detach_from_index(
            **_request.to_boto_dict()
        )

        return shapes.DetachFromIndexResponse.from_boto_dict(response)
    ...
    def detach_object(
        ...
        *,
        ...
        response = self._boto_client.detach_object(**_request.to_boto_dict())

        return shapes.DetachObjectResponse.from_boto_dict(response)
    ...
    def detach_policy(
        ...
        *,
        ...
        return shapes.DetachPolicyResponse.from_boto_dict(response)
    ...
    def detach_typed_link(
        ...
        *,
        ...
        response = self._boto_client.detach_typed_link(
            **_request.to_boto_dict()
        )
    ...
    def disable_directory(
        ...
        *,
        ...
        response = self._boto_client.disable_directory(
            **_request.to_boto_dict()
        )

        return shapes.DisableDirectoryResponse.from_boto_dict(response)
    ...
    def enable_directory(
        ...
        *,
        ...
        response = self._boto_client.enable_directory(**_request.to_boto_dict())

        return shapes.EnableDirectoryResponse.from_boto_dict(response)
    ...
    def get_applied_schema_version(
        ...
        *,
        ...
        return shapes.GetAppliedSchemaVersionResponse.from_boto_dict(response)
    ...
    def get_directory(
        ...
        *,
        ...
        response = self._boto_client.get_directory(**_request.to_boto_dict())

        return shapes.GetDirectoryResponse.from_boto_dict(response)
    ...
    def get_facet(
        ...
        *,
        ...
        response = self._boto_client.get_facet(**_request.to_boto_dict())

        return shapes.GetFacetResponse.from_boto_dict(response)
    ...
    def get_link_attributes(
        ...
        *,
        ...
        response = self._boto_client.get_link_attributes(
            **_request.to_boto_dict()
        )

        return shapes.GetLinkAttributesResponse.from_boto_dict(response)
    ...
    def get_object_attributes(
        ...
        *,
        ...
        response = self._boto_client.get_object_attributes(
            **_request.to_boto_dict()
        )

        return shapes.GetObjectAttributesResponse.from_boto_dict(response)
    ...
    def get_object_information(
        ...
        *,
        ...
        return shapes.GetObjectInformationResponse.from_boto_dict(response)
    ...
    def get_schema_as_json(
        ...
        *,
        ...
        response = self._boto_client.get_schema_as_json(
            **_request.to_boto_dict()
        )

        return shapes.GetSchemaAsJsonResponse.from_boto_dict(response)
    ...
    def get_typed_link_facet_information(
        ...
        *,
        ...
        return shapes.GetTypedLinkFacetInformationResponse.from_boto_dict(
            response
        )
    ...
    def list_applied_schema_arns(
        ...
        *,
        ...
        result = shapes.ListAppliedSchemaArnsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListAppliedSchemaArnsResponse.from_boto_dict(response)
    ...
    def list_attached_indices(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListAttachedIndicesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListAttachedIndicesResponse.from_boto_dict(response)
    ...
    def list_development_schema_arns(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDevelopmentSchemaArnsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListDevelopmentSchemaArnsResponse.from_boto_dict(response)
    ...
    def list_directories(
        ...
        *,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        state: shapes.DirectoryState = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDirectoriesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListDirectoriesResponse.from_boto_dict(response)
    ...
    def list_facet_attributes(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListFacetAttributesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListFacetAttributesResponse.from_boto_dict(response)
    ...
    def list_facet_names(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListFacetNamesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListFacetNamesResponse.from_boto_dict(response)
    ...
    def list_incoming_typed_links(
        ...
        *,
        ...
        return shapes.ListIncomingTypedLinksResponse.from_boto_dict(response)
    ...
    def list_index(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListIndexResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListIndexResponse.from_boto_dict(response)
    ...
    def list_managed_schema_arns(
        ...
        *,
        ...
        return shapes.ListManagedSchemaArnsResponse.from_boto_dict(response)
    ...
    def list_object_attributes(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListObjectAttributesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListObjectAttributesResponse.from_boto_dict(response)
    ...
    def list_object_children(
        ...
        *,
        ...
        response = self._boto_client.list_object_children(
            **_request.to_boto_dict()
        )

        return shapes.ListObjectChildrenResponse.from_boto_dict(response)
    ...
    def list_object_parent_paths(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListObjectParentPathsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListObjectParentPathsResponse.from_boto_dict(response)
    ...
    def list_object_parents(
        ...
        *,
        ...
        response = self._boto_client.list_object_parents(
            **_request.to_boto_dict()
        )

        return shapes.ListObjectParentsResponse.from_boto_dict(response)
    ...
    def list_object_policies(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListObjectPoliciesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListObjectPoliciesResponse.from_boto_dict(response)
    ...
    def list_outgoing_typed_links(
        ...
        *,
        ...
        return shapes.ListOutgoingTypedLinksResponse.from_boto_dict(response)
    ...
    def list_policy_attachments(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPolicyAttachmentsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListPolicyAttachmentsResponse.from_boto_dict(response)
    ...
    def list_published_schema_arns(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPublishedSchemaArnsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListPublishedSchemaArnsResponse.from_boto_dict(response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTagsForResourceResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_typed_link_facet_attributes(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTypedLinkFacetAttributesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListTypedLinkFacetAttributesResponse.from_boto_dict(
            response
        )
    ...
    def list_typed_link_facet_names(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTypedLinkFacetNamesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListTypedLinkFacetNamesResponse.from_boto_dict(response)
    ...
    def lookup_policy(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.LookupPolicyResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.LookupPolicyResponse.from_boto_dict(response)
    ...
    def publish_schema(
        ...
        *,
        ...
        response = self._boto_client.publish_schema(**_request.to_boto_dict())

        return shapes.PublishSchemaResponse.from_boto_dict(response)
    ...
    def put_schema_from_json(
        ...
        *,
        ...
        response = self._boto_client.put_schema_from_json(
            **_request.to_boto_dict()
        )

        return shapes.PutSchemaFromJsonResponse.from_boto_dict(response)
    ...
    def remove_facet_from_object(
        ...
        *,
        ...
        return shapes.RemoveFacetFromObjectResponse.from_boto_dict(response)
    ...
    def update_facet(
        ...
        *,
        ...
        response = self._boto_client.update_facet(**_request.to_boto_dict())

        return shapes.UpdateFacetResponse.from_boto_dict(response)
    ...
    def update_link_attributes(
        ...
        *,
        ...
        return shapes.UpdateLinkAttributesResponse.from_boto_dict(response)
    ...
    def update_object_attributes(
        ...
        *,
        ...
        return shapes.UpdateObjectAttributesResponse.from_boto_dict(response)
    ...
    def update_schema(
        ...
        *,
        ...
        response = self._boto_client.update_schema(**_request.to_boto_dict())

        return shapes.UpdateSchemaResponse.from_boto_dict(response)
    ...
    def update_typed_link_facet(
        ...
        *,
        ...
        return shapes.UpdateTypedLinkFacetResponse.from_boto_dict(response)
    ...
    def upgrade_applied_schema(
        ...
        *,
        ...
        return shapes.UpgradeAppliedSchemaResponse.from_boto_dict(response)
    ...
    def upgrade_published_schema(
        ...
        *,
        ...
        return shapes.UpgradePublishedSchemaResponse.from_boto_dict(response)
