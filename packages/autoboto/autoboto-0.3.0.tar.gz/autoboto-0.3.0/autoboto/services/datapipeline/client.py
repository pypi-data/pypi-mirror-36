...
class Client(ClientBase):
    ...
    def describe_objects(
        ...
        *,
        ...
        result = shapes.DescribeObjectsOutput.from_boto_dict(first_page)
    ...
    def list_pipelines(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPipelinesOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def query_objects(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.QueryObjectsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
