...
class Client(ClientBase):
    ...
    def describe_document_versions(
        ...
        *,
        ...
        result = shapes.DescribeDocumentVersionsResponse.from_boto_dict(
            first_page
        )
    ...
    def describe_folder_contents(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeFolderContentsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result
    ...
    def describe_users(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeUsersResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
