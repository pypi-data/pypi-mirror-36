...
class Client(ClientBase):
    ...
    def associate_ip_groups(
        ...
        *,
        ...
        response = self._boto_client.associate_ip_groups(
            **_request.to_boto_dict()
        )

        return shapes.AssociateIpGroupsResult.from_boto_dict(response)
    ...
    def authorize_ip_rules(
        ...
        *,
        ...
        response = self._boto_client.authorize_ip_rules(
            **_request.to_boto_dict()
        )

        return shapes.AuthorizeIpRulesResult.from_boto_dict(response)
    ...
    def create_ip_group(
        ...
        *,
        ...
        response = self._boto_client.create_ip_group(**_request.to_boto_dict())

        return shapes.CreateIpGroupResult.from_boto_dict(response)
    ...
    def create_tags(
        ...
        *,
        ...
        return shapes.CreateTagsResult.from_boto_dict(response)
    ...
    def create_workspaces(
        ...
        *,
        ...
        response = self._boto_client.create_workspaces(
            **_request.to_boto_dict()
        )

        return shapes.CreateWorkspacesResult.from_boto_dict(response)
    ...
    def delete_ip_group(
        ...
        *,
        ...
        response = self._boto_client.delete_ip_group(**_request.to_boto_dict())

        return shapes.DeleteIpGroupResult.from_boto_dict(response)
    ...
    def delete_tags(
        ...
        *,
        ...
        return shapes.DeleteTagsResult.from_boto_dict(response)
    ...
    def describe_ip_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_ip_groups(
            **_request.to_boto_dict()
        )

        return shapes.DescribeIpGroupsResult.from_boto_dict(response)
    ...
    def describe_workspace_bundles(
        ...
        *,
        ...
        result = shapes.DescribeWorkspaceBundlesResult.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.DescribeWorkspaceBundlesResult.from_boto_dict(response)
    ...
    def describe_workspace_directories(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeWorkspaceDirectoriesResult.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.DescribeWorkspaceDirectoriesResult.from_boto_dict(
            response
        )
    ...
    def describe_workspaces(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeWorkspacesResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeWorkspacesResult.from_boto_dict(response)
    ...
    def describe_workspaces_connection_status(
        ...
        *,
        ...
        return shapes.DescribeWorkspacesConnectionStatusResult.from_boto_dict(
            response
        )
    ...
    def disassociate_ip_groups(
        ...
        *,
        ...
        return shapes.DisassociateIpGroupsResult.from_boto_dict(response)
    ...
    def modify_workspace_properties(
        ...
        *,
        ...
        return shapes.ModifyWorkspacePropertiesResult.from_boto_dict(response)
    ...
    def modify_workspace_state(
        ...
        *,
        workspace_id: str,
        workspace_state: shapes.TargetWorkspaceState,
        ...
        return shapes.ModifyWorkspaceStateResult.from_boto_dict(response)
    ...
    def reboot_workspaces(
        ...
        *,
        ...
        response = self._boto_client.reboot_workspaces(
            **_request.to_boto_dict()
        )

        return shapes.RebootWorkspacesResult.from_boto_dict(response)
    ...
    def rebuild_workspaces(
        ...
        *,
        ...
        response = self._boto_client.rebuild_workspaces(
            **_request.to_boto_dict()
        )

        return shapes.RebuildWorkspacesResult.from_boto_dict(response)
    ...
    def revoke_ip_rules(
        ...
        *,
        ...
        response = self._boto_client.revoke_ip_rules(**_request.to_boto_dict())

        return shapes.RevokeIpRulesResult.from_boto_dict(response)
    ...
    def start_workspaces(
        ...
        *,
        ...
        response = self._boto_client.start_workspaces(**_request.to_boto_dict())

        return shapes.StartWorkspacesResult.from_boto_dict(response)
    ...
    def stop_workspaces(
        ...
        *,
        ...
        response = self._boto_client.stop_workspaces(**_request.to_boto_dict())

        return shapes.StopWorkspacesResult.from_boto_dict(response)
    ...
    def terminate_workspaces(
        ...
        *,
        ...
        response = self._boto_client.terminate_workspaces(
            **_request.to_boto_dict()
        )

        return shapes.TerminateWorkspacesResult.from_boto_dict(response)
    ...
    def update_rules_of_ip_group(
        ...
        *,
        ...
        return shapes.UpdateRulesOfIpGroupResult.from_boto_dict(response)
