...
class AffectedEntity(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AffectedEntity", None, None]:
...
class DateTimeRange(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DateTimeRange", None, None]:
        yield from super().paginate()
...
class DescribeAffectedEntitiesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeAffectedEntitiesRequest", None, None]:
        yield from super().paginate()
...
class DescribeEntityAggregatesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeEntityAggregatesRequest", None, None]:
        yield from super().paginate()
...
class DescribeEntityAggregatesResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeEntityAggregatesResponse", None, None]:
        yield from super().paginate()
...
class DescribeEventAggregatesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeEventAggregatesRequest", None, None]:
        yield from super().paginate()
...
class DescribeEventDetailsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeEventDetailsRequest", None, None]:
        yield from super().paginate()
...
class DescribeEventDetailsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeEventDetailsResponse", None, None]:
        yield from super().paginate()
...
class DescribeEventTypesRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeEventTypesRequest", None, None]:
        yield from super().paginate()
...
class EntityAggregate(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EntityAggregate", None, None]:
        yield from super().paginate()
...
class EntityFilter(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status_codes",
                "statusCodes",
                TypeInfo(typing.List[entityStatusCode]),
            ),
        ]
    ...
    def paginate(self, ) -> typing.Generator["EntityFilter", None, None]:
        yield from super().paginate()
...
class EventAggregate(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EventAggregate", None, None]:
        yield from super().paginate()
...
class EventDetails(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EventDetails", None, None]:
        yield from super().paginate()
...
class EventDetailsErrorItem(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["EventDetailsErrorItem", None, None]:
        yield from super().paginate()
...
class EventFilter(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                "eventTypeCategories",
                TypeInfo(typing.List[eventTypeCategory]),
            ),
            (
                "tags",
                "tags",
            ...
            (
                "event_status_codes",
                "eventStatusCodes",
                TypeInfo(typing.List[eventStatusCode]),
            ),
        ]
    ...
    def paginate(self, ) -> typing.Generator["EventFilter", None, None]:
        yield from super().paginate()
...
class EventType(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EventType", None, None]:
        yield from super().paginate()
...
class EventTypeFilter(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EventTypeFilter", None, None]:
        yield from super().paginate()
...
class UnsupportedLocale(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UnsupportedLocale", None, None]:
        yield from super().paginate()
