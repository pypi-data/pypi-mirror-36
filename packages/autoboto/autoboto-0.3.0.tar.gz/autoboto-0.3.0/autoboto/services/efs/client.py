...
class Client(ClientBase):
    ...
    def describe_file_systems(
        ...
        *,
        ...
        result = shapes.DescribeFileSystemsResponse.from_boto_dict(first_page)
    ...
    def describe_mount_targets(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeMountTargetsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def describe_tags(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeTagsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
