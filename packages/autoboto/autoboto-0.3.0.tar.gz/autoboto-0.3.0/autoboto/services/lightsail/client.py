...
class Client(ClientBase):
    ...
    def get_active_names(
        ...
        *,
        ...
        result = shapes.GetActiveNamesResult.from_boto_dict(first_page)
    ...
    def get_blueprints(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetBlueprintsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_bundles(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetBundlesResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_domains(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetDomainsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_instance_snapshots(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetInstanceSnapshotsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_instances(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetInstancesResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_key_pairs(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetKeyPairsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_operations(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetOperationsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_static_ips(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetStaticIpsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
