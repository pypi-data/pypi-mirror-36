...
class Client(ClientBase):
    ...
    def get_classifiers(
        ...
        *,
        ...
        result = shapes.GetClassifiersResponse.from_boto_dict(first_page)
    ...
    def get_connections(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetConnectionsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_crawler_metrics(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetCrawlerMetricsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_crawlers(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetCrawlersResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_databases(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetDatabasesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_dev_endpoints(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetDevEndpointsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_job_runs(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetJobRunsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_jobs(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetJobsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_partitions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetPartitionsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_table_versions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetTableVersionsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_tables(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetTablesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_triggers(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetTriggersResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def get_user_defined_functions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetUserDefinedFunctionsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result
