...
class BatchEntryIdsNotDistinct(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["BatchEntryIdsNotDistinct", None, None]:
        yield from super().paginate()
...
class BatchRequestTooLong(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["BatchRequestTooLong", None, None]:
        yield from super().paginate()
...
class BatchResultErrorEntry(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["BatchResultErrorEntry", None, None]:
        yield from super().paginate()
...
class ChangeMessageVisibilityBatchRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ChangeMessageVisibilityBatchRequest", None, None]:
        yield from super().paginate()
...
class ChangeMessageVisibilityBatchRequestEntry(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "ChangeMessageVisibilityBatchRequestEntry", None, None]:
        yield from super().paginate()
...
class ChangeMessageVisibilityBatchResult(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ChangeMessageVisibilityBatchResult", None, None]:
        yield from super().paginate()
...
class ChangeMessageVisibilityBatchResultEntry(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "ChangeMessageVisibilityBatchResultEntry", None, None]:
        yield from super().paginate()
...
class ChangeMessageVisibilityRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ChangeMessageVisibilityRequest", None, None]:
        yield from super().paginate()
...
class CreateQueueRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "attributes",
                "Attributes",
                TypeInfo(typing.Dict[QueueAttributeName, str]),
            ),
        ]
    ...
    #   * `QueueArn`
    attributes: typing.Dict["QueueAttributeName", str] = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class CreateQueueResult(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateQueueResult", None, None]:
        yield from super().paginate()
...
class DeleteMessageBatchRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteMessageBatchRequest", None, None]:
        yield from super().paginate()
...
class DeleteMessageBatchRequestEntry(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteMessageBatchRequestEntry", None, None]:
        yield from super().paginate()
...
class DeleteMessageBatchResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteMessageBatchResult", None, None]:
        yield from super().paginate()
...
class DeleteMessageBatchResultEntry(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteMessageBatchResultEntry", None, None]:
        yield from super().paginate()
...
class DeleteMessageRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteMessageRequest", None, None]:
        yield from super().paginate()
...
class EmptyBatchRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EmptyBatchRequest", None, None]:
        yield from super().paginate()
...
class GetQueueAttributesRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "attribute_names",
                "AttributeNames",
                TypeInfo(typing.List[QueueAttributeName]),
            ),
        ]
    ...
    attribute_names: typing.List["QueueAttributeName"] = dataclasses.field(
        default_factory=list,
    )

    def paginate(self,
                ) -> typing.Generator["GetQueueAttributesRequest", None, None]:
        yield from super().paginate()
...
class GetQueueAttributesResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetQueueAttributesResult", None, None]:
        yield from super().paginate()
...
class GetQueueUrlRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetQueueUrlRequest", None, None]:
        yield from super().paginate()
...
class GetQueueUrlResult(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetQueueUrlResult", None, None]:
        yield from super().paginate()
...
class InvalidAttributeName(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidAttributeName", None, None]:
        yield from super().paginate()
...
class InvalidBatchEntryId(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InvalidBatchEntryId", None, None]:
        yield from super().paginate()
...
class InvalidIdFormat(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InvalidIdFormat", None, None]:
        yield from super().paginate()
...
class InvalidMessageContents(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidMessageContents", None, None]:
        yield from super().paginate()
...
class ListDeadLetterSourceQueuesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListDeadLetterSourceQueuesRequest", None, None]:
        yield from super().paginate()
...
class ListDeadLetterSourceQueuesResult(OutputShapeBase):
    ...
    queue_urls: typing.List[str] = dataclasses.field(default_factory=list, )

    def paginate(
        self,
    ) -> typing.Generator["ListDeadLetterSourceQueuesResult", None, None]:
        yield from super().paginate()
...
class ListQueueTagsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListQueueTagsRequest", None, None]:
        yield from super().paginate()
...
class ListQueueTagsResult(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListQueueTagsResult", None, None]:
        yield from super().paginate()
...
class ListQueuesResult(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListQueuesResult", None, None]:
        yield from super().paginate()
...
class Message(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "attributes",
                "Attributes",
                TypeInfo(typing.Dict[MessageSystemAttributeName, str]),
            ),
            (
    ...
    # milliseconds.
    attributes: typing.Dict["MessageSystemAttributeName", str
                           ] = dataclasses.field(
                               default=ShapeBase.NOT_SET,
                           )
...
class MessageNotInflight(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["MessageNotInflight", None, None]:
        yield from super().paginate()
...
class OverLimit(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["OverLimit", None, None]:
        yield from super().paginate()
...
class PurgeQueueInProgress(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PurgeQueueInProgress", None, None]:
        yield from super().paginate()
...
class PurgeQueueRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PurgeQueueRequest", None, None]:
        yield from super().paginate()
...
class QueueDeletedRecently(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["QueueDeletedRecently", None, None]:
        yield from super().paginate()
...
class QueueDoesNotExist(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["QueueDoesNotExist", None, None]:
        yield from super().paginate()
...
class QueueNameExists(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["QueueNameExists", None, None]:
        yield from super().paginate()
...
class ReceiptHandleIsInvalid(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ReceiptHandleIsInvalid", None, None]:
        yield from super().paginate()
...
class ReceiveMessageRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ReceiveMessageRequest", None, None]:
        yield from super().paginate()
...
class ReceiveMessageResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ReceiveMessageResult", None, None]:
        yield from super().paginate()
...
class SendMessageBatchRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SendMessageBatchRequest", None, None]:
        yield from super().paginate()
...
class SendMessageBatchRequestEntry(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["SendMessageBatchRequestEntry", None, None]:
        yield from super().paginate()
...
class SendMessageBatchResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SendMessageBatchResult", None, None]:
        yield from super().paginate()
...
class SendMessageBatchResultEntry(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["SendMessageBatchResultEntry", None, None]:
        yield from super().paginate()
...
class SendMessageRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SendMessageRequest", None, None]:
        yield from super().paginate()
...
class SendMessageResult(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SendMessageResult", None, None]:
        yield from super().paginate()
...
class SetQueueAttributesRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SetQueueAttributesRequest", None, None]:
        yield from super().paginate()
...
class TagQueueRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TagQueueRequest", None, None]:
        yield from super().paginate()
...
class TooManyEntriesInBatchRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["TooManyEntriesInBatchRequest", None, None]:
        yield from super().paginate()
...
class UnsupportedOperation(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UnsupportedOperation", None, None]:
        yield from super().paginate()
...
class UntagQueueRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UntagQueueRequest", None, None]:
        yield from super().paginate()
