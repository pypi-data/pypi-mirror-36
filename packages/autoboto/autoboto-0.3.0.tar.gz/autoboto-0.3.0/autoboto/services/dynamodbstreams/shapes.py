...
class Identity(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Identity", None, None]:
        yield from super().paginate()
...
class ListStreamsOutput(OutputShapeBase):
    ...
    # endpoint.
    streams: typing.List["Stream"] = dataclasses.field(default_factory=list, )
...
class Record(ShapeBase):
    ...
    event_name: "OperationType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # fields.
    dynamodb: "StreamRecord" = dataclasses.field(default_factory=dict, )
    ...
    user_identity: "Identity" = dataclasses.field(default_factory=dict, )
...
class StreamRecord(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["StreamRecord", None, None]:
        yield from super().paginate()
...
class TrimmedDataAccessException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["TrimmedDataAccessException", None, None]:
        yield from super().paginate()
