...
class Client(ClientBase):
    ...
    def list_backups(
        ...
        *,
        ...
        result = shapes.ListBackupsOutput.from_boto_dict(first_page)
    ...
    def list_tables(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTablesOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def query(
        ...
        *,
        ...
        paginator = self.get_paginator("query").paginate(
            **_request.to_boto_dict()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.QueryOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def scan(
        ...
        *,
        ...
        paginator = self.get_paginator("scan").paginate(
            **_request.to_boto_dict()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ScanOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
