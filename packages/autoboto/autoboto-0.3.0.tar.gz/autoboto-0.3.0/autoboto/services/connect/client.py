...
class Client(ClientBase):
    ...
    def describe_user_hierarchy_group(
        ...
        *,
        ...
        return shapes.DescribeUserHierarchyGroupResponse.from_boto_dict(
            response
        )
    ...
    def describe_user_hierarchy_structure(
        ...
        *,
        ...
        return shapes.DescribeUserHierarchyStructureResponse.from_boto_dict(
            response
        )
    ...
    def get_federation_token(
        ...
        *,
        ...
        response = self._boto_client.get_federation_token(
            **_request.to_boto_dict()
        )

        return shapes.GetFederationTokenResponse.from_boto_dict(response)
    ...
    def list_routing_profiles(
        ...
        *,
        ...
        response = self._boto_client.list_routing_profiles(
            **_request.to_boto_dict()
        )

        return shapes.ListRoutingProfilesResponse.from_boto_dict(response)
    ...
    def list_user_hierarchy_groups(
        ...
        *,
        ...
        return shapes.ListUserHierarchyGroupsResponse.from_boto_dict(response)
    ...
    def start_outbound_voice_contact(
        ...
        *,
        ...
        return shapes.StartOutboundVoiceContactResponse.from_boto_dict(response)
    ...
    def stop_contact(
        ...
        *,
        ...
        response = self._boto_client.stop_contact(**_request.to_boto_dict())

        return shapes.StopContactResponse.from_boto_dict(response)
    ...
    def update_contact_attributes(
        ...
        *,
        ...
        return shapes.UpdateContactAttributesResponse.from_boto_dict(response)
    ...
    def update_user_hierarchy(
        ...
        *,
        ...
        response = self._boto_client.update_user_hierarchy(
            **_request.to_boto_dict()
        )
