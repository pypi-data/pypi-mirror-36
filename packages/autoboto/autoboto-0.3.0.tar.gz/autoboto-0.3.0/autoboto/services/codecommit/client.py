...
class Client(ClientBase):
    ...
    def batch_get_repositories(
        ...
        *,
        ...
        return shapes.BatchGetRepositoriesOutput.from_boto_dict(response)
    ...
    def create_branch(
        ...
        *,
        ...
        response = self._boto_client.create_branch(**_request.to_boto_dict())
    ...
    def create_pull_request(
        ...
        *,
        ...
        response = self._boto_client.create_pull_request(
            **_request.to_boto_dict()
        )

        return shapes.CreatePullRequestOutput.from_boto_dict(response)
    ...
    def create_repository(
        ...
        *,
        ...
        response = self._boto_client.create_repository(
            **_request.to_boto_dict()
        )

        return shapes.CreateRepositoryOutput.from_boto_dict(response)
    ...
    def delete_branch(
        ...
        *,
        ...
        response = self._boto_client.delete_branch(**_request.to_boto_dict())

        return shapes.DeleteBranchOutput.from_boto_dict(response)
    ...
    def delete_comment_content(
        ...
        *,
        ...
        return shapes.DeleteCommentContentOutput.from_boto_dict(response)
    ...
    def delete_repository(
        ...
        *,
        ...
        response = self._boto_client.delete_repository(
            **_request.to_boto_dict()
        )

        return shapes.DeleteRepositoryOutput.from_boto_dict(response)
    ...
    def describe_pull_request_events(
        ...
        *,
        pull_request_id: str,
        pull_request_event_type: shapes.PullRequestEventType = ShapeBase.
        NOT_SET,
        ...
        result = shapes.DescribePullRequestEventsOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.DescribePullRequestEventsOutput.from_boto_dict(response)
    ...
    def get_blob(
        ...
        *,
        ...
        response = self._boto_client.get_blob(**_request.to_boto_dict())

        return shapes.GetBlobOutput.from_boto_dict(response)
    ...
    def get_branch(
        ...
        *,
        ...
        response = self._boto_client.get_branch(**_request.to_boto_dict())

        return shapes.GetBranchOutput.from_boto_dict(response)
    ...
    def get_comment(
        ...
        *,
        ...
        response = self._boto_client.get_comment(**_request.to_boto_dict())

        return shapes.GetCommentOutput.from_boto_dict(response)
    ...
    def get_comments_for_compared_commit(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetCommentsForComparedCommitOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.GetCommentsForComparedCommitOutput.from_boto_dict(
            response
        )
    ...
    def get_comments_for_pull_request(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetCommentsForPullRequestOutput.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.GetCommentsForPullRequestOutput.from_boto_dict(response)
    ...
    def get_commit(
        ...
        *,
        ...
        response = self._boto_client.get_commit(**_request.to_boto_dict())

        return shapes.GetCommitOutput.from_boto_dict(response)
    ...
    def get_differences(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetDifferencesOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.GetDifferencesOutput.from_boto_dict(response)
    ...
    def get_merge_conflicts(
        ...
        *,
        ...
        merge_option: shapes.MergeOptionTypeEnum,
        ...
        response = self._boto_client.get_merge_conflicts(
            **_request.to_boto_dict()
        )

        return shapes.GetMergeConflictsOutput.from_boto_dict(response)
    ...
    def get_pull_request(
        ...
        *,
        ...
        response = self._boto_client.get_pull_request(**_request.to_boto_dict())

        return shapes.GetPullRequestOutput.from_boto_dict(response)
    ...
    def get_repository(
        ...
        *,
        ...
        response = self._boto_client.get_repository(**_request.to_boto_dict())

        return shapes.GetRepositoryOutput.from_boto_dict(response)
    ...
    def get_repository_triggers(
        ...
        *,
        ...
        return shapes.GetRepositoryTriggersOutput.from_boto_dict(response)
    ...
    def list_branches(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListBranchesOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListBranchesOutput.from_boto_dict(response)
    ...
    def list_pull_requests(
        ...
        *,
        ...
        pull_request_status: shapes.PullRequestStatusEnum = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPullRequestsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListPullRequestsOutput.from_boto_dict(response)
    ...
    def list_repositories(
        ...
        *,
        next_token: str = ShapeBase.NOT_SET,
        sort_by: shapes.SortByEnum = ShapeBase.NOT_SET,
        order: shapes.OrderEnum = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListRepositoriesOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListRepositoriesOutput.from_boto_dict(response)
    ...
    def merge_pull_request_by_fast_forward(
        ...
        *,
        ...
        return shapes.MergePullRequestByFastForwardOutput.from_boto_dict(
            response
        )
    ...
    def post_comment_for_compared_commit(
        ...
        *,
        ...
        return shapes.PostCommentForComparedCommitOutput.from_boto_dict(
            response
        )
    ...
    def post_comment_for_pull_request(
        ...
        *,
        ...
        return shapes.PostCommentForPullRequestOutput.from_boto_dict(response)
    ...
    def post_comment_reply(
        ...
        *,
        ...
        response = self._boto_client.post_comment_reply(
            **_request.to_boto_dict()
        )

        return shapes.PostCommentReplyOutput.from_boto_dict(response)
    ...
    def put_file(
        ...
        *,
        ...
        file_path: str,
        file_mode: shapes.FileModeTypeEnum = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.put_file(**_request.to_boto_dict())

        return shapes.PutFileOutput.from_boto_dict(response)
    ...
    def put_repository_triggers(
        ...
        *,
        ...
        return shapes.PutRepositoryTriggersOutput.from_boto_dict(response)
    ...
    def test_repository_triggers(
        ...
        *,
        ...
        return shapes.TestRepositoryTriggersOutput.from_boto_dict(response)
    ...
    def update_comment(
        ...
        *,
        ...
        response = self._boto_client.update_comment(**_request.to_boto_dict())

        return shapes.UpdateCommentOutput.from_boto_dict(response)
    ...
    def update_default_branch(
        ...
        *,
        ...
        response = self._boto_client.update_default_branch(
            **_request.to_boto_dict()
        )
    ...
    def update_pull_request_description(
        ...
        *,
        ...
        return shapes.UpdatePullRequestDescriptionOutput.from_boto_dict(
            response
        )
    ...
    def update_pull_request_status(
        ...
        *,
        pull_request_id: str,
        pull_request_status: shapes.PullRequestStatusEnum,
        ...
        return shapes.UpdatePullRequestStatusOutput.from_boto_dict(response)
    ...
    def update_pull_request_title(
        ...
        *,
        ...
        return shapes.UpdatePullRequestTitleOutput.from_boto_dict(response)
