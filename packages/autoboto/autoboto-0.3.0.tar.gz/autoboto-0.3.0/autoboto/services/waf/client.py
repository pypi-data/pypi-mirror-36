...
class Client(ClientBase):
    def __init__(self, *args, **kwargs):
        super().__init__("waf", *args, **kwargs)
    ...
    def create_byte_match_set(
        ...
        *,
        ...
        response = self._boto_client.create_byte_match_set(
            **_request.to_boto_dict()
        )

        return shapes.CreateByteMatchSetResponse.from_boto_dict(response)
    ...
    def create_geo_match_set(
        ...
        *,
        ...
        response = self._boto_client.create_geo_match_set(
            **_request.to_boto_dict()
        )

        return shapes.CreateGeoMatchSetResponse.from_boto_dict(response)
    ...
    def create_ip_set(
        ...
        *,
        ...
        response = self._boto_client.create_ip_set(**_request.to_boto_dict())

        return shapes.CreateIPSetResponse.from_boto_dict(response)
    ...
    def create_rate_based_rule(
        ...
        *,
        ...
        return shapes.CreateRateBasedRuleResponse.from_boto_dict(response)
    ...
    def create_regex_match_set(
        ...
        *,
        ...
        return shapes.CreateRegexMatchSetResponse.from_boto_dict(response)
    ...
    def create_regex_pattern_set(
        ...
        *,
        ...
        return shapes.CreateRegexPatternSetResponse.from_boto_dict(response)
    ...
    def create_rule(
        ...
        *,
        ...
        response = self._boto_client.create_rule(**_request.to_boto_dict())

        return shapes.CreateRuleResponse.from_boto_dict(response)
    ...
    def create_rule_group(
        ...
        *,
        ...
        response = self._boto_client.create_rule_group(
            **_request.to_boto_dict()
        )

        return shapes.CreateRuleGroupResponse.from_boto_dict(response)
    ...
    def create_size_constraint_set(
        ...
        *,
        ...
        return shapes.CreateSizeConstraintSetResponse.from_boto_dict(response)
    ...
    def create_sql_injection_match_set(
        ...
        *,
        ...
        return shapes.CreateSqlInjectionMatchSetResponse.from_boto_dict(
            response
        )
    ...
    def create_web_acl(
        ...
        *,
        ...
        response = self._boto_client.create_web_acl(**_request.to_boto_dict())

        return shapes.CreateWebACLResponse.from_boto_dict(response)
    ...
    def create_xss_match_set(
        ...
        *,
        ...
        response = self._boto_client.create_xss_match_set(
            **_request.to_boto_dict()
        )

        return shapes.CreateXssMatchSetResponse.from_boto_dict(response)
    ...
    def delete_byte_match_set(
        ...
        *,
        ...
        response = self._boto_client.delete_byte_match_set(
            **_request.to_boto_dict()
        )

        return shapes.DeleteByteMatchSetResponse.from_boto_dict(response)
    ...
    def delete_geo_match_set(
        ...
        *,
        ...
        response = self._boto_client.delete_geo_match_set(
            **_request.to_boto_dict()
        )

        return shapes.DeleteGeoMatchSetResponse.from_boto_dict(response)
    ...
    def delete_ip_set(
        ...
        *,
        ...
        response = self._boto_client.delete_ip_set(**_request.to_boto_dict())

        return shapes.DeleteIPSetResponse.from_boto_dict(response)
    ...
    def delete_logging_configuration(
        ...
        *,
        ...
        return shapes.DeleteLoggingConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def delete_permission_policy(
        ...
        *,
        ...
        return shapes.DeletePermissionPolicyResponse.from_boto_dict(response)
    ...
    def delete_rate_based_rule(
        ...
        *,
        ...
        return shapes.DeleteRateBasedRuleResponse.from_boto_dict(response)
    ...
    def delete_regex_match_set(
        ...
        *,
        ...
        return shapes.DeleteRegexMatchSetResponse.from_boto_dict(response)
    ...
    def delete_regex_pattern_set(
        ...
        *,
        ...
        return shapes.DeleteRegexPatternSetResponse.from_boto_dict(response)
    ...
    def delete_rule(
        ...
        *,
        ...
        response = self._boto_client.delete_rule(**_request.to_boto_dict())

        return shapes.DeleteRuleResponse.from_boto_dict(response)
    ...
    def delete_rule_group(
        ...
        *,
        ...
        response = self._boto_client.delete_rule_group(
            **_request.to_boto_dict()
        )

        return shapes.DeleteRuleGroupResponse.from_boto_dict(response)
    ...
    def delete_size_constraint_set(
        ...
        *,
        ...
        return shapes.DeleteSizeConstraintSetResponse.from_boto_dict(response)
    ...
    def delete_sql_injection_match_set(
        ...
        *,
        ...
        return shapes.DeleteSqlInjectionMatchSetResponse.from_boto_dict(
            response
        )
    ...
    def delete_web_acl(
        ...
        *,
        ...
        response = self._boto_client.delete_web_acl(**_request.to_boto_dict())

        return shapes.DeleteWebACLResponse.from_boto_dict(response)
    ...
    def delete_xss_match_set(
        ...
        *,
        ...
        response = self._boto_client.delete_xss_match_set(
            **_request.to_boto_dict()
        )

        return shapes.DeleteXssMatchSetResponse.from_boto_dict(response)
    ...
    def get_byte_match_set(
        ...
        *,
        ...
        response = self._boto_client.get_byte_match_set(
            **_request.to_boto_dict()
        )

        return shapes.GetByteMatchSetResponse.from_boto_dict(response)
    ...
    def get_change_token(
        ...
        response = self._boto_client.get_change_token(**_request.to_boto_dict())

        return shapes.GetChangeTokenResponse.from_boto_dict(response)
    ...
    def get_change_token_status(
        ...
        *,
        ...
        return shapes.GetChangeTokenStatusResponse.from_boto_dict(response)
    ...
    def get_geo_match_set(
        ...
        *,
        ...
        response = self._boto_client.get_geo_match_set(
            **_request.to_boto_dict()
        )

        return shapes.GetGeoMatchSetResponse.from_boto_dict(response)
    ...
    def get_ip_set(
        ...
        *,
        ...
        response = self._boto_client.get_ip_set(**_request.to_boto_dict())

        return shapes.GetIPSetResponse.from_boto_dict(response)
    ...
    def get_logging_configuration(
        ...
        *,
        ...
        return shapes.GetLoggingConfigurationResponse.from_boto_dict(response)
    ...
    def get_permission_policy(
        ...
        *,
        ...
        response = self._boto_client.get_permission_policy(
            **_request.to_boto_dict()
        )

        return shapes.GetPermissionPolicyResponse.from_boto_dict(response)
    ...
    def get_rate_based_rule(
        ...
        *,
        ...
        response = self._boto_client.get_rate_based_rule(
            **_request.to_boto_dict()
        )

        return shapes.GetRateBasedRuleResponse.from_boto_dict(response)
    ...
    def get_rate_based_rule_managed_keys(
        ...
        *,
        ...
        return shapes.GetRateBasedRuleManagedKeysResponse.from_boto_dict(
            response
        )
    ...
    def get_regex_match_set(
        ...
        *,
        ...
        response = self._boto_client.get_regex_match_set(
            **_request.to_boto_dict()
        )

        return shapes.GetRegexMatchSetResponse.from_boto_dict(response)
    ...
    def get_regex_pattern_set(
        ...
        *,
        ...
        response = self._boto_client.get_regex_pattern_set(
            **_request.to_boto_dict()
        )

        return shapes.GetRegexPatternSetResponse.from_boto_dict(response)
    ...
    def get_rule(
        ...
        *,
        ...
        response = self._boto_client.get_rule(**_request.to_boto_dict())

        return shapes.GetRuleResponse.from_boto_dict(response)
    ...
    def get_rule_group(
        ...
        *,
        ...
        response = self._boto_client.get_rule_group(**_request.to_boto_dict())

        return shapes.GetRuleGroupResponse.from_boto_dict(response)
    ...
    def get_sampled_requests(
        ...
        *,
        ...
        response = self._boto_client.get_sampled_requests(
            **_request.to_boto_dict()
        )

        return shapes.GetSampledRequestsResponse.from_boto_dict(response)
    ...
    def get_size_constraint_set(
        ...
        *,
        ...
        return shapes.GetSizeConstraintSetResponse.from_boto_dict(response)
    ...
    def get_sql_injection_match_set(
        ...
        *,
        ...
        return shapes.GetSqlInjectionMatchSetResponse.from_boto_dict(response)
    ...
    def get_web_acl(
        ...
        *,
        ...
        response = self._boto_client.get_web_acl(**_request.to_boto_dict())

        return shapes.GetWebACLResponse.from_boto_dict(response)
    ...
    def get_xss_match_set(
        ...
        *,
        ...
        response = self._boto_client.get_xss_match_set(
            **_request.to_boto_dict()
        )

        return shapes.GetXssMatchSetResponse.from_boto_dict(response)
    ...
    def list_activated_rules_in_rule_group(
        ...
        *,
        ...
        return shapes.ListActivatedRulesInRuleGroupResponse.from_boto_dict(
            response
        )
    ...
    def list_byte_match_sets(
        ...
        *,
        ...
        paginator = self.get_paginator("list_byte_match_sets").paginate(
            **_request.to_boto_dict()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListByteMatchSetsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListByteMatchSetsResponse.from_boto_dict(response)
    ...
    def list_geo_match_sets(
        ...
        *,
        ...
        response = self._boto_client.list_geo_match_sets(
            **_request.to_boto_dict()
        )

        return shapes.ListGeoMatchSetsResponse.from_boto_dict(response)
    ...
    def list_ip_sets(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListIPSetsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListIPSetsResponse.from_boto_dict(response)
    ...
    def list_logging_configurations(
        ...
        *,
        ...
        return shapes.ListLoggingConfigurationsResponse.from_boto_dict(response)
    ...
    def list_rate_based_rules(
        ...
        *,
        ...
        response = self._boto_client.list_rate_based_rules(
            **_request.to_boto_dict()
        )

        return shapes.ListRateBasedRulesResponse.from_boto_dict(response)
    ...
    def list_regex_match_sets(
        ...
        *,
        ...
        response = self._boto_client.list_regex_match_sets(
            **_request.to_boto_dict()
        )

        return shapes.ListRegexMatchSetsResponse.from_boto_dict(response)
    ...
    def list_regex_pattern_sets(
        ...
        *,
        ...
        return shapes.ListRegexPatternSetsResponse.from_boto_dict(response)
    ...
    def list_rule_groups(
        ...
        *,
        ...
        response = self._boto_client.list_rule_groups(**_request.to_boto_dict())

        return shapes.ListRuleGroupsResponse.from_boto_dict(response)
    ...
    def list_rules(
        ...
        *,
        ...
        paginator = self.get_paginator("list_rules").paginate(
            **_request.to_boto_dict()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListRulesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListRulesResponse.from_boto_dict(response)
    ...
    def list_size_constraint_sets(
        ...
        *,
        ...
        paginator = self.get_paginator("list_size_constraint_sets").paginate(
            **_request.to_boto_dict()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSizeConstraintSetsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListSizeConstraintSetsResponse.from_boto_dict(response)
    ...
    def list_sql_injection_match_sets(
        ...
        *,
        ...
        paginator = self.get_paginator("list_sql_injection_match_sets"
                                      ).paginate(**_request.to_boto_dict())
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSqlInjectionMatchSetsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListSqlInjectionMatchSetsResponse.from_boto_dict(response)
    ...
    def list_subscribed_rule_groups(
        ...
        *,
        ...
        return shapes.ListSubscribedRuleGroupsResponse.from_boto_dict(response)
    ...
    def list_web_acls(
        ...
        *,
        ...
        paginator = self.get_paginator("list_web_acls").paginate(
            **_request.to_boto_dict()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListWebACLsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListWebACLsResponse.from_boto_dict(response)
    ...
    def list_xss_match_sets(
        ...
        *,
        ...
        paginator = self.get_paginator("list_xss_match_sets").paginate(
            **_request.to_boto_dict()
        )
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListXssMatchSetsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListXssMatchSetsResponse.from_boto_dict(response)
    ...
    def put_logging_configuration(
        ...
        *,
        ...
        return shapes.PutLoggingConfigurationResponse.from_boto_dict(response)
    ...
    def put_permission_policy(
        ...
        *,
        ...
        response = self._boto_client.put_permission_policy(
            **_request.to_boto_dict()
        )

        return shapes.PutPermissionPolicyResponse.from_boto_dict(response)
    ...
    def update_byte_match_set(
        ...
        *,
        ...
        response = self._boto_client.update_byte_match_set(
            **_request.to_boto_dict()
        )

        return shapes.UpdateByteMatchSetResponse.from_boto_dict(response)
    ...
    def update_geo_match_set(
        ...
        *,
        ...
        response = self._boto_client.update_geo_match_set(
            **_request.to_boto_dict()
        )

        return shapes.UpdateGeoMatchSetResponse.from_boto_dict(response)
    ...
    def update_ip_set(
        ...
        *,
        ...
        response = self._boto_client.update_ip_set(**_request.to_boto_dict())

        return shapes.UpdateIPSetResponse.from_boto_dict(response)
    ...
    def update_rate_based_rule(
        ...
        *,
        ...
        return shapes.UpdateRateBasedRuleResponse.from_boto_dict(response)
    ...
    def update_regex_match_set(
        ...
        *,
        ...
        return shapes.UpdateRegexMatchSetResponse.from_boto_dict(response)
    ...
    def update_regex_pattern_set(
        ...
        *,
        ...
        return shapes.UpdateRegexPatternSetResponse.from_boto_dict(response)
    ...
    def update_rule(
        ...
        *,
        ...
        response = self._boto_client.update_rule(**_request.to_boto_dict())

        return shapes.UpdateRuleResponse.from_boto_dict(response)
    ...
    def update_rule_group(
        ...
        *,
        ...
        response = self._boto_client.update_rule_group(
            **_request.to_boto_dict()
        )

        return shapes.UpdateRuleGroupResponse.from_boto_dict(response)
    ...
    def update_size_constraint_set(
        ...
        *,
        ...
        return shapes.UpdateSizeConstraintSetResponse.from_boto_dict(response)
    ...
    def update_sql_injection_match_set(
        ...
        *,
        ...
        return shapes.UpdateSqlInjectionMatchSetResponse.from_boto_dict(
            response
        )
    ...
    def update_web_acl(
        ...
        *,
        ...
        response = self._boto_client.update_web_acl(**_request.to_boto_dict())

        return shapes.UpdateWebACLResponse.from_boto_dict(response)
    ...
    def update_xss_match_set(
        ...
        *,
        ...
        response = self._boto_client.update_xss_match_set(
            **_request.to_boto_dict()
        )

        return shapes.UpdateXssMatchSetResponse.from_boto_dict(response)
