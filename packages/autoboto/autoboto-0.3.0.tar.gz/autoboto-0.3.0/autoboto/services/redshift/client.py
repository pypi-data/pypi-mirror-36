...
class Client(ClientBase):
    ...
    def accept_reserved_node_exchange(
        ...
        *,
        ...
        return shapes.AcceptReservedNodeExchangeOutputMessage.from_boto_dict(
            response
        )
    ...
    def authorize_cluster_security_group_ingress(
        ...
        *,
        ...
        return shapes.AuthorizeClusterSecurityGroupIngressResult.from_boto_dict(
            response
        )
    ...
    def authorize_snapshot_access(
        ...
        *,
        ...
        return shapes.AuthorizeSnapshotAccessResult.from_boto_dict(response)
    ...
    def copy_cluster_snapshot(
        ...
        *,
        ...
        response = self._boto_client.copy_cluster_snapshot(
            **_request.to_boto_dict()
        )

        return shapes.CopyClusterSnapshotResult.from_boto_dict(response)
    ...
    def create_cluster(
        ...
        *,
        ...
        response = self._boto_client.create_cluster(**_request.to_boto_dict())

        return shapes.CreateClusterResult.from_boto_dict(response)
    ...
    def create_cluster_parameter_group(
        ...
        *,
        ...
        return shapes.CreateClusterParameterGroupResult.from_boto_dict(response)
    ...
    def create_cluster_security_group(
        ...
        *,
        ...
        return shapes.CreateClusterSecurityGroupResult.from_boto_dict(response)
    ...
    def create_cluster_snapshot(
        ...
        *,
        ...
        return shapes.CreateClusterSnapshotResult.from_boto_dict(response)
    ...
    def create_cluster_subnet_group(
        ...
        *,
        ...
        return shapes.CreateClusterSubnetGroupResult.from_boto_dict(response)
    ...
    def create_hsm_client_certificate(
        ...
        *,
        ...
        return shapes.CreateHsmClientCertificateResult.from_boto_dict(response)
    ...
    def create_hsm_configuration(
        ...
        *,
        ...
        return shapes.CreateHsmConfigurationResult.from_boto_dict(response)
    ...
    def create_snapshot_copy_grant(
        ...
        *,
        ...
        return shapes.CreateSnapshotCopyGrantResult.from_boto_dict(response)
    ...
    def delete_cluster(
        ...
        *,
        ...
        response = self._boto_client.delete_cluster(**_request.to_boto_dict())

        return shapes.DeleteClusterResult.from_boto_dict(response)
    ...
    def delete_cluster_snapshot(
        ...
        *,
        ...
        return shapes.DeleteClusterSnapshotResult.from_boto_dict(response)
    ...
    def describe_cluster_db_revisions(
        ...
        *,
        ...
        return shapes.ClusterDbRevisionsMessage.from_boto_dict(response)
    ...
    def describe_cluster_parameter_groups(
        ...
        *,
        ...
        result = shapes.ClusterParameterGroupsMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ClusterParameterGroupsMessage.from_boto_dict(response)
    ...
    def describe_cluster_parameters(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ClusterParameterGroupDetails.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ClusterParameterGroupDetails.from_boto_dict(response)
    ...
    def describe_cluster_security_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ClusterSecurityGroupMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ClusterSecurityGroupMessage.from_boto_dict(response)
    ...
    def describe_cluster_snapshots(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.SnapshotMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.SnapshotMessage.from_boto_dict(response)
    ...
    def describe_cluster_subnet_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ClusterSubnetGroupMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ClusterSubnetGroupMessage.from_boto_dict(response)
    ...
    def describe_cluster_tracks(
        ...
        *,
        ...
        return shapes.TrackListMessage.from_boto_dict(response)
    ...
    def describe_cluster_versions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ClusterVersionsMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ClusterVersionsMessage.from_boto_dict(response)
    ...
    def describe_clusters(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ClustersMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ClustersMessage.from_boto_dict(response)
    ...
    def describe_default_cluster_parameters(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeDefaultClusterParametersResult.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.DescribeDefaultClusterParametersResult.from_boto_dict(
            response
        )
    ...
    def describe_hsm_client_certificates(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.HsmClientCertificateMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.HsmClientCertificateMessage.from_boto_dict(response)
    ...
    def describe_hsm_configurations(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.HsmConfigurationMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.HsmConfigurationMessage.from_boto_dict(response)
    ...
    def describe_logging_status(
        ...
        *,
        ...
        return shapes.LoggingStatus.from_boto_dict(response)
    ...
    def describe_orderable_cluster_options(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.OrderableClusterOptionsMessage.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.OrderableClusterOptionsMessage.from_boto_dict(response)
    ...
    def describe_reserved_node_offerings(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ReservedNodeOfferingsMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ReservedNodeOfferingsMessage.from_boto_dict(response)
    ...
    def describe_reserved_nodes(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ReservedNodesMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ReservedNodesMessage.from_boto_dict(response)
    ...
    def describe_resize(
        ...
        *,
        ...
        response = self._boto_client.describe_resize(**_request.to_boto_dict())

        return shapes.ResizeProgressMessage.from_boto_dict(response)
    ...
    def describe_snapshot_copy_grants(
        ...
        *,
        ...
        return shapes.SnapshotCopyGrantMessage.from_boto_dict(response)
    ...
    def describe_table_restore_status(
        ...
        *,
        ...
        return shapes.TableRestoreStatusMessage.from_boto_dict(response)
    ...
    def describe_tags(
        ...
        *,
        ...
        return shapes.TaggedResourceListMessage.from_boto_dict(response)
    ...
    def disable_logging(
        ...
        *,
        ...
        response = self._boto_client.disable_logging(**_request.to_boto_dict())
    ...
    def disable_snapshot_copy(
        ...
        *,
        ...
        response = self._boto_client.disable_snapshot_copy(
            **_request.to_boto_dict()
        )

        return shapes.DisableSnapshotCopyResult.from_boto_dict(response)
    ...
    def enable_logging(
        ...
        *,
        ...
        response = self._boto_client.enable_logging(**_request.to_boto_dict())
    ...
    def enable_snapshot_copy(
        ...
        *,
        ...
        response = self._boto_client.enable_snapshot_copy(
            **_request.to_boto_dict()
        )

        return shapes.EnableSnapshotCopyResult.from_boto_dict(response)
    ...
    def get_cluster_credentials(
        ...
        *,
        ...
        return shapes.ClusterCredentials.from_boto_dict(response)
    ...
    def get_reserved_node_exchange_offerings(
        ...
        *,
        ...
        return shapes.GetReservedNodeExchangeOfferingsOutputMessage.from_boto_dict(
            response
        )
    ...
    def modify_cluster(
        ...
        *,
        ...
        response = self._boto_client.modify_cluster(**_request.to_boto_dict())

        return shapes.ModifyClusterResult.from_boto_dict(response)
    ...
    def modify_cluster_db_revision(
        ...
        *,
        ...
        return shapes.ModifyClusterDbRevisionResult.from_boto_dict(response)
    ...
    def modify_cluster_iam_roles(
        ...
        *,
        ...
        return shapes.ModifyClusterIamRolesResult.from_boto_dict(response)
    ...
    def modify_cluster_parameter_group(
        ...
        *,
        ...
        return shapes.ClusterParameterGroupNameMessage.from_boto_dict(response)
    ...
    def modify_cluster_subnet_group(
        ...
        *,
        ...
        return shapes.ModifyClusterSubnetGroupResult.from_boto_dict(response)
    ...
    def modify_snapshot_copy_retention_period(
        ...
        *,
        ...
        return shapes.ModifySnapshotCopyRetentionPeriodResult.from_boto_dict(
            response
        )
    ...
    def purchase_reserved_node_offering(
        ...
        *,
        ...
        return shapes.PurchaseReservedNodeOfferingResult.from_boto_dict(
            response
        )
    ...
    def reboot_cluster(
        ...
        *,
        ...
        response = self._boto_client.reboot_cluster(**_request.to_boto_dict())

        return shapes.RebootClusterResult.from_boto_dict(response)
    ...
    def resize_cluster(
        ...
        *,
        ...
        response = self._boto_client.resize_cluster(**_request.to_boto_dict())

        return shapes.ResizeClusterResult.from_boto_dict(response)
    ...
    def restore_from_cluster_snapshot(
        ...
        *,
        ...
        return shapes.RestoreFromClusterSnapshotResult.from_boto_dict(response)
    ...
    def restore_table_from_cluster_snapshot(
        ...
        *,
        ...
        return shapes.RestoreTableFromClusterSnapshotResult.from_boto_dict(
            response
        )
    ...
    def revoke_cluster_security_group_ingress(
        ...
        *,
        ...
        return shapes.RevokeClusterSecurityGroupIngressResult.from_boto_dict(
            response
        )
    ...
    def revoke_snapshot_access(
        ...
        *,
        ...
        return shapes.RevokeSnapshotAccessResult.from_boto_dict(response)
    ...
    def rotate_encryption_key(
        ...
        *,
        ...
        response = self._boto_client.rotate_encryption_key(
            **_request.to_boto_dict()
        )

        return shapes.RotateEncryptionKeyResult.from_boto_dict(response)
