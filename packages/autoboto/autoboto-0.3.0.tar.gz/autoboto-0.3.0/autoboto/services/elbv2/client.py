...
class Client(ClientBase):
    ...
    def add_listener_certificates(
        ...
        *,
        ...
        return shapes.AddListenerCertificatesOutput.from_boto_dict(response)
    ...
    def create_listener(
        ...
        *,
        ...
        response = self._boto_client.create_listener(**_request.to_boto_dict())

        return shapes.CreateListenerOutput.from_boto_dict(response)
    ...
    def create_load_balancer(
        ...
        *,
        ...
        scheme: shapes.LoadBalancerSchemeEnum = ShapeBase.NOT_SET,
        tags: typing.List[shapes.Tag] = ShapeBase.NOT_SET,
        type: shapes.LoadBalancerTypeEnum = ShapeBase.NOT_SET,
        ip_address_type: shapes.IpAddressType = ShapeBase.NOT_SET,
        ...
        return shapes.CreateLoadBalancerOutput.from_boto_dict(response)
    ...
    def create_rule(
        ...
        *,
        ...
        return shapes.CreateRuleOutput.from_boto_dict(response)
    ...
    def create_target_group(
        ...
        *,
        ...
        port: int,
        vpc_id: str,
        health_check_protocol: shapes.ProtocolEnum = ShapeBase.NOT_SET,
        ...
        target_type: shapes.TargetTypeEnum = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_target_group(
            **_request.to_boto_dict()
        )

        return shapes.CreateTargetGroupOutput.from_boto_dict(response)
    ...
    def delete_listener(
        ...
        *,
        ...
        response = self._boto_client.delete_listener(**_request.to_boto_dict())

        return shapes.DeleteListenerOutput.from_boto_dict(response)
    ...
    def delete_load_balancer(
        ...
        *,
        ...
        return shapes.DeleteLoadBalancerOutput.from_boto_dict(response)
    ...
    def delete_rule(
        ...
        *,
        ...
        return shapes.DeleteRuleOutput.from_boto_dict(response)
    ...
    def delete_target_group(
        ...
        *,
        ...
        response = self._boto_client.delete_target_group(
            **_request.to_boto_dict()
        )

        return shapes.DeleteTargetGroupOutput.from_boto_dict(response)
    ...
    def deregister_targets(
        ...
        *,
        ...
        response = self._boto_client.deregister_targets(
            **_request.to_boto_dict()
        )

        return shapes.DeregisterTargetsOutput.from_boto_dict(response)
    ...
    def describe_listener_certificates(
        ...
        *,
        ...
        return shapes.DescribeListenerCertificatesOutput.from_boto_dict(
            response
        )
    ...
    def describe_listeners(
        ...
        *,
        ...
        result = shapes.DescribeListenersOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeListenersOutput.from_boto_dict(response)
    ...
    def describe_load_balancer_attributes(
        ...
        *,
        ...
        return shapes.DescribeLoadBalancerAttributesOutput.from_boto_dict(
            response
        )
    ...
    def describe_load_balancers(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeLoadBalancersOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeLoadBalancersOutput.from_boto_dict(response)
    ...
    def describe_rules(
        ...
        *,
        ...
        response = self._boto_client.describe_rules(**_request.to_boto_dict())

        return shapes.DescribeRulesOutput.from_boto_dict(response)
    ...
    def describe_ssl_policies(
        ...
        *,
        ...
        response = self._boto_client.describe_ssl_policies(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSSLPoliciesOutput.from_boto_dict(response)
    ...
    def describe_tags(
        ...
        *,
        ...
        return shapes.DescribeTagsOutput.from_boto_dict(response)
    ...
    def describe_target_group_attributes(
        ...
        *,
        ...
        return shapes.DescribeTargetGroupAttributesOutput.from_boto_dict(
            response
        )
    ...
    def describe_target_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeTargetGroupsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeTargetGroupsOutput.from_boto_dict(response)
    ...
    def describe_target_health(
        ...
        *,
        ...
        return shapes.DescribeTargetHealthOutput.from_boto_dict(response)
    ...
    def modify_listener(
        ...
        *,
        ...
        protocol: shapes.ProtocolEnum = ShapeBase.NOT_SET,
        ssl_policy: str = ShapeBase.NOT_SET,
        certificates: typing.List[shapes.Certificate] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.modify_listener(**_request.to_boto_dict())

        return shapes.ModifyListenerOutput.from_boto_dict(response)
    ...
    def modify_load_balancer_attributes(
        ...
        *,
        ...
        return shapes.ModifyLoadBalancerAttributesOutput.from_boto_dict(
            response
        )
    ...
    def modify_rule(
        ...
        *,
        ...
        response = self._boto_client.modify_rule(**_request.to_boto_dict())

        return shapes.ModifyRuleOutput.from_boto_dict(response)
    ...
    def modify_target_group(
        ...
        *,
        ...
        response = self._boto_client.modify_target_group(
            **_request.to_boto_dict()
        )

        return shapes.ModifyTargetGroupOutput.from_boto_dict(response)
    ...
    def modify_target_group_attributes(
        ...
        *,
        ...
        return shapes.ModifyTargetGroupAttributesOutput.from_boto_dict(response)
    ...
    def register_targets(
        ...
        *,
        ...
        response = self._boto_client.register_targets(**_request.to_boto_dict())

        return shapes.RegisterTargetsOutput.from_boto_dict(response)
    ...
    def remove_listener_certificates(
        ...
        *,
        ...
        return shapes.RemoveListenerCertificatesOutput.from_boto_dict(response)
    ...
    def remove_tags(
        ...
        *,
        ...
        response = self._boto_client.remove_tags(**_request.to_boto_dict())

        return shapes.RemoveTagsOutput.from_boto_dict(response)
    ...
    def set_ip_address_type(
        ...
        *,
        load_balancer_arn: str,
        ip_address_type: shapes.IpAddressType,
        ...
        response = self._boto_client.set_ip_address_type(
            **_request.to_boto_dict()
        )

        return shapes.SetIpAddressTypeOutput.from_boto_dict(response)
    ...
    def set_rule_priorities(
        ...
        *,
        ...
        response = self._boto_client.set_rule_priorities(
            **_request.to_boto_dict()
        )

        return shapes.SetRulePrioritiesOutput.from_boto_dict(response)
    ...
    def set_security_groups(
        ...
        *,
        ...
        response = self._boto_client.set_security_groups(
            **_request.to_boto_dict()
        )

        return shapes.SetSecurityGroupsOutput.from_boto_dict(response)
    ...
    def set_subnets(
        ...
        *,
        ...
        response = self._boto_client.set_subnets(**_request.to_boto_dict())

        return shapes.SetSubnetsOutput.from_boto_dict(response)
