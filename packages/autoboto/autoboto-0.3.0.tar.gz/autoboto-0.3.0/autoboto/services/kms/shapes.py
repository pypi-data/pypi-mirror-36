...
class AliasListEntry(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AliasListEntry", None, None]:
...
class CancelKeyDeletionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CancelKeyDeletionRequest", None, None]:
        yield from super().paginate()
...
class CancelKeyDeletionResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CancelKeyDeletionResponse", None, None]:
        yield from super().paginate()
...
class CreateGrantRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "operations",
                "Operations",
                TypeInfo(typing.List[GrantOperation]),
            ),
            (
                "retiring_principal",
                "RetiringPrincipal",
    ...
    operations: typing.List["GrantOperation"] = dataclasses.field(
    ...
    constraints: "GrantConstraints" = dataclasses.field(default_factory=dict, )
    ...
    grant_tokens: typing.List[str] = dataclasses.field(default_factory=list, )
    ...
    def paginate(self, ) -> typing.Generator["CreateGrantRequest", None, None]:
        yield from super().paginate()
...
class CreateGrantResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateGrantResponse", None, None]:
        yield from super().paginate()
...
class CreateKeyRequest(ShapeBase):
    ...
    key_usage: "KeyUsageType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    origin: "OriginType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["CreateKeyRequest", None, None]:
        yield from super().paginate()
...
class CreateKeyResponse(OutputShapeBase):
    ...
    key_metadata: "KeyMetadata" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["CreateKeyResponse", None, None]:
        yield from super().paginate()
...
class DecryptRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DecryptRequest", None, None]:
        yield from super().paginate()
...
class DecryptResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DecryptResponse", None, None]:
        yield from super().paginate()
...
class DeleteImportedKeyMaterialRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteImportedKeyMaterialRequest", None, None]:
        yield from super().paginate()
...
class DependencyTimeoutException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DependencyTimeoutException", None, None]:
        yield from super().paginate()
...
class DescribeKeyRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DescribeKeyRequest", None, None]:
        yield from super().paginate()
...
class DescribeKeyResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DescribeKeyResponse", None, None]:
        yield from super().paginate()
...
class DisableKeyRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DisableKeyRequest", None, None]:
        yield from super().paginate()
...
class DisableKeyRotationRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DisableKeyRotationRequest", None, None]:
        yield from super().paginate()
...
class DisabledException(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DisabledException", None, None]:
        yield from super().paginate()
...
class EnableKeyRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EnableKeyRequest", None, None]:
        yield from super().paginate()
...
class EnableKeyRotationRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["EnableKeyRotationRequest", None, None]:
        yield from super().paginate()
...
class EncryptRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EncryptRequest", None, None]:
        yield from super().paginate()
...
class EncryptResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EncryptResponse", None, None]:
        yield from super().paginate()
...
class ExpiredImportTokenException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ExpiredImportTokenException", None, None]:
        yield from super().paginate()
...
class GenerateDataKeyRequest(ShapeBase):
    ...
    key_spec: "DataKeySpec" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self,
                ) -> typing.Generator["GenerateDataKeyRequest", None, None]:
        yield from super().paginate()
...
class GenerateDataKeyResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GenerateDataKeyResponse", None, None]:
        yield from super().paginate()
...
class GenerateDataKeyWithoutPlaintextRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GenerateDataKeyWithoutPlaintextRequest", None, None]:
        yield from super().paginate()
...
class GenerateDataKeyWithoutPlaintextResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "GenerateDataKeyWithoutPlaintextResponse", None, None]:
        yield from super().paginate()
...
class GenerateRandomRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GenerateRandomRequest", None, None]:
        yield from super().paginate()
...
class GenerateRandomResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GenerateRandomResponse", None, None]:
        yield from super().paginate()
...
class GetKeyPolicyRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetKeyPolicyRequest", None, None]:
        yield from super().paginate()
...
class GetKeyPolicyResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetKeyPolicyResponse", None, None]:
        yield from super().paginate()
...
class GetKeyRotationStatusRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetKeyRotationStatusRequest", None, None]:
        yield from super().paginate()
...
class GetKeyRotationStatusResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetKeyRotationStatusResponse", None, None]:
        yield from super().paginate()
...
class GetParametersForImportRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "wrapping_algorithm",
                "WrappingAlgorithm",
                TypeInfo(AlgorithmSpec),
            ),
            (
                "wrapping_key_spec",
                "WrappingKeySpec",
                TypeInfo(WrappingKeySpec),
            ),
        ]
    ...
    # Developer Guide_.
    wrapping_algorithm: "AlgorithmSpec" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # The type of wrapping key (public key) to return in the response. Only
    # 2048-bit RSA public keys are supported.
    wrapping_key_spec: "WrappingKeySpec" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(
        self,
    ) -> typing.Generator["GetParametersForImportRequest", None, None]:
        yield from super().paginate()
...
class GetParametersForImportResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetParametersForImportResponse", None, None]:
        yield from super().paginate()
...
class GrantConstraints(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GrantConstraints", None, None]:
        yield from super().paginate()
...
class GrantListEntry(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GrantListEntry", None, None]:
        yield from super().paginate()
...
class ImportKeyMaterialRequest(ShapeBase):
    ...
    expiration_model: "ExpirationModelType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self,
                ) -> typing.Generator["ImportKeyMaterialRequest", None, None]:
        yield from super().paginate()
...
class ImportKeyMaterialResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ImportKeyMaterialResponse", None, None]:
        yield from super().paginate()
...
class IncorrectKeyMaterialException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["IncorrectKeyMaterialException", None, None]:
        yield from super().paginate()
...
class InvalidAliasNameException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidAliasNameException", None, None]:
        yield from super().paginate()
...
class InvalidCiphertextException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidCiphertextException", None, None]:
        yield from super().paginate()
...
class InvalidGrantIdException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidGrantIdException", None, None]:
        yield from super().paginate()
...
class InvalidGrantTokenException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidGrantTokenException", None, None]:
        yield from super().paginate()
...
class InvalidImportTokenException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidImportTokenException", None, None]:
        yield from super().paginate()
...
class InvalidKeyUsageException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidKeyUsageException", None, None]:
        yield from super().paginate()
...
class InvalidMarkerException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidMarkerException", None, None]:
        yield from super().paginate()
...
class KMSInternalException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["KMSInternalException", None, None]:
        yield from super().paginate()
...
class KeyListEntry(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["KeyListEntry", None, None]:
        yield from super().paginate()
...
class KeyMetadata(ShapeBase):
    ...
    # in the _AWS Key Management Service Developer Guide_.
    key_state: "KeyState" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # in the _AWS Key Management Service Developer Guide_.
    key_manager: "KeyManagerType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["KeyMetadata", None, None]:
        yield from super().paginate()
...
class KeyUnavailableException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["KeyUnavailableException", None, None]:
        yield from super().paginate()
...
class ListGrantsRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListGrantsRequest", None, None]:
        yield from super().paginate()
...
class ListKeyPoliciesRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListKeyPoliciesRequest", None, None]:
        yield from super().paginate()
...
class ListKeysRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListKeysRequest", None, None]:
        yield from super().paginate()
...
class ListResourceTagsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListResourceTagsRequest", None, None]:
        yield from super().paginate()
...
class ListResourceTagsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListResourceTagsResponse", None, None]:
        yield from super().paginate()
...
class ListRetirableGrantsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListRetirableGrantsRequest", None, None]:
        yield from super().paginate()
...
class PutKeyPolicyRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutKeyPolicyRequest", None, None]:
        yield from super().paginate()
...
class ReEncryptRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ReEncryptRequest", None, None]:
        yield from super().paginate()
...
class ReEncryptResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ReEncryptResponse", None, None]:
        yield from super().paginate()
...
class RetireGrantRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["RetireGrantRequest", None, None]:
        yield from super().paginate()
...
class RevokeGrantRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["RevokeGrantRequest", None, None]:
        yield from super().paginate()
...
class ScheduleKeyDeletionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ScheduleKeyDeletionRequest", None, None]:
        yield from super().paginate()
...
class ScheduleKeyDeletionResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ScheduleKeyDeletionResponse", None, None]:
        yield from super().paginate()
...
class TagException(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TagException", None, None]:
        yield from super().paginate()
...
class UpdateKeyDescriptionRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateKeyDescriptionRequest", None, None]:
        yield from super().paginate()
