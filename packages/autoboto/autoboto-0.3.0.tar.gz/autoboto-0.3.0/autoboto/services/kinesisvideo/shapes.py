...
class AccountStreamLimitExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AccountStreamLimitExceededException", None, None]:
...
class ClientLimitExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ClientLimitExceededException", None, None]:
        yield from super().paginate()
...
class CreateStreamOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateStreamOutput", None, None]:
        yield from super().paginate()
...
class DeleteStreamOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteStreamOutput", None, None]:
        yield from super().paginate()
...
class DeviceStreamLimitExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeviceStreamLimitExceededException", None, None]:
        yield from super().paginate()
...
class GetDataEndpointInput(ShapeBase):
    ...
    api_name: "APIName" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self,
                ) -> typing.Generator["GetDataEndpointInput", None, None]:
        yield from super().paginate()
...
class GetDataEndpointOutput(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetDataEndpointOutput", None, None]:
        yield from super().paginate()
...
class InvalidDeviceException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidDeviceException", None, None]:
        yield from super().paginate()
...
class InvalidResourceFormatException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidResourceFormatException", None, None]:
        yield from super().paginate()
...
class StreamNameCondition(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["StreamNameCondition", None, None]:
        yield from super().paginate()
...
class TagStreamInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TagStreamInput", None, None]:
        yield from super().paginate()
...
class TagStreamOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TagStreamOutput", None, None]:
        yield from super().paginate()
...
class TagsPerResourceExceededLimitException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["TagsPerResourceExceededLimitException", None, None]:
        yield from super().paginate()
...
class UntagStreamInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UntagStreamInput", None, None]:
        yield from super().paginate()
...
class UntagStreamOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UntagStreamOutput", None, None]:
        yield from super().paginate()
...
class UpdateDataRetentionInput(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "operation",
                "Operation",
                TypeInfo(UpdateDataRetentionOperation),
            ),
            (
    ...
    operation: "UpdateDataRetentionOperation" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateDataRetentionInput", None, None]:
        yield from super().paginate()
...
class UpdateDataRetentionOutput(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateDataRetentionOutput", None, None]:
        yield from super().paginate()
...
class UpdateStreamInput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdateStreamInput", None, None]:
        yield from super().paginate()
...
class UpdateStreamOutput(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdateStreamOutput", None, None]:
        yield from super().paginate()
