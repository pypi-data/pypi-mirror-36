...
class Client(ClientBase):
    ...
    def list_byte_match_sets(
        ...
        *,
        ...
        result = shapes.ListByteMatchSetsResponse.from_boto(first_page)
    ...
    def list_rules(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListRulesResponse.from_boto(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_size_constraint_sets(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSizeConstraintSetsResponse.from_boto(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_sql_injection_match_sets(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSqlInjectionMatchSetsResponse.from_boto(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_web_acls(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListWebACLsResponse.from_boto(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_xss_match_sets(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListXssMatchSetsResponse.from_boto(first_page)
        result._page_iterator = page_generator
        return result
