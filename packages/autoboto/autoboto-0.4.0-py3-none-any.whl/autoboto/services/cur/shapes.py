...
class DeleteReportDefinitionRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteReportDefinitionRequest", None, None]:
...
class DeleteReportDefinitionResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteReportDefinitionResponse", None, None]:
        yield from super().paginate()
...
class DescribeReportDefinitionsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeReportDefinitionsRequest", None, None]:
        yield from super().paginate()
...
class DuplicateReportNameException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DuplicateReportNameException", None, None]:
        yield from super().paginate()
...
class PutReportDefinitionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutReportDefinitionRequest", None, None]:
        yield from super().paginate()
...
class PutReportDefinitionResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["PutReportDefinitionResponse", None, None]:
        yield from super().paginate()
...
class ReportDefinition(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ReportDefinition", None, None]:
        yield from super().paginate()
...
class ReportLimitReachedException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ReportLimitReachedException", None, None]:
        yield from super().paginate()
