...
class DescribeClusterResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeClusterResponse", None, None]:
        yield from super().paginate()
...
class UnsupportedAvailabilityZoneException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnsupportedAvailabilityZoneException", None, None]:
        yield from super().paginate()
...
class VpcConfigRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["VpcConfigRequest", None, None]:
        yield from super().paginate()
