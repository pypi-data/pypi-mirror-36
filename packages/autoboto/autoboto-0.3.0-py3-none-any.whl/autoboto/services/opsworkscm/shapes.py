...
class AccountAttribute(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AccountAttribute", None, None]:
...
class AssociateNodeRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AssociateNodeRequest", None, None]:
        yield from super().paginate()
...
class AssociateNodeResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AssociateNodeResponse", None, None]:
        yield from super().paginate()
...
class Backup(ShapeBase):
    ...
    status: "BackupStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["Backup", None, None]:
        yield from super().paginate()
...
class CreateBackupRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateBackupRequest", None, None]:
        yield from super().paginate()
...
class CreateBackupResponse(OutputShapeBase):
    ...
    backup: "Backup" = dataclasses.field(default_factory=dict, )

    def paginate(self,
                ) -> typing.Generator["CreateBackupResponse", None, None]:
        yield from super().paginate()
...
class CreateServerRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateServerRequest", None, None]:
        yield from super().paginate()
...
class CreateServerResponse(OutputShapeBase):
    ...
    server: "Server" = dataclasses.field(default_factory=dict, )

    def paginate(self,
                ) -> typing.Generator["CreateServerResponse", None, None]:
        yield from super().paginate()
...
class DeleteBackupRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteBackupRequest", None, None]:
        yield from super().paginate()
...
class DeleteBackupResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteBackupResponse", None, None]:
        yield from super().paginate()
...
class DeleteServerRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteServerRequest", None, None]:
        yield from super().paginate()
...
class DeleteServerResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteServerResponse", None, None]:
        yield from super().paginate()
...
class DescribeAccountAttributesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeAccountAttributesRequest", None, None]:
        yield from super().paginate()
...
class DescribeBackupsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeBackupsRequest", None, None]:
        yield from super().paginate()
...
class DescribeBackupsResponse(OutputShapeBase):
    ...
    backups: typing.List["Backup"] = dataclasses.field(default_factory=list, )
...
class DescribeNodeAssociationStatusRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeNodeAssociationStatusRequest", None, None]:
        yield from super().paginate()
...
class DescribeNodeAssociationStatusResponse(OutputShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                TypeInfo(NodeAssociationStatus),
            ),
            (
                "engine_attributes",
                "EngineAttributes",
    ...
    node_association_status: "NodeAssociationStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeNodeAssociationStatusResponse", None, None]:
        yield from super().paginate()
...
class DescribeServersRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeServersRequest", None, None]:
        yield from super().paginate()
...
class DescribeServersResponse(OutputShapeBase):
    ...
    servers: typing.List["Server"] = dataclasses.field(default_factory=list, )

    # This is not currently implemented for `DescribeServers` requests.
    next_token: str = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self,
                ) -> typing.Generator["DescribeServersResponse", None, None]:
        yield from super().paginate()
...
class DisassociateNodeRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DisassociateNodeRequest", None, None]:
        yield from super().paginate()
...
class DisassociateNodeResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DisassociateNodeResponse", None, None]:
        yield from super().paginate()
...
class EngineAttribute(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EngineAttribute", None, None]:
        yield from super().paginate()
...
class RestoreServerRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RestoreServerRequest", None, None]:
        yield from super().paginate()
...
class RestoreServerResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RestoreServerResponse", None, None]:
        yield from super().paginate()
...
class Server(ShapeBase):
    ...
    # `FAILED`.
    maintenance_status: "MaintenanceStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    status: "ServerStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["Server", None, None]:
        yield from super().paginate()
...
class ServerEvent(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ServerEvent", None, None]:
        yield from super().paginate()
...
class StartMaintenanceRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["StartMaintenanceRequest", None, None]:
        yield from super().paginate()
...
class StartMaintenanceResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["StartMaintenanceResponse", None, None]:
        yield from super().paginate()
...
class UpdateServerEngineAttributesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateServerEngineAttributesRequest", None, None]:
        yield from super().paginate()
...
class UpdateServerEngineAttributesResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateServerEngineAttributesResponse", None, None]:
        yield from super().paginate()
...
class UpdateServerRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdateServerRequest", None, None]:
        yield from super().paginate()
...
class UpdateServerResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateServerResponse", None, None]:
        yield from super().paginate()
