...
class BadRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["BadRequest", None, None]:
...
class CreateFileSystemRequest(ShapeBase):
    ...
    # created.
    performance_mode: "PerformanceMode" = dataclasses.field(
    ...
    throughput_mode: "ThroughputMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["CreateFileSystemRequest", None, None]:
        yield from super().paginate()
...
class CreateMountTargetRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CreateMountTargetRequest", None, None]:
        yield from super().paginate()
...
class DeleteFileSystemRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteFileSystemRequest", None, None]:
        yield from super().paginate()
...
class DeleteMountTargetRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteMountTargetRequest", None, None]:
        yield from super().paginate()
...
class DependencyTimeout(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DependencyTimeout", None, None]:
        yield from super().paginate()
...
class DescribeFileSystemsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeFileSystemsRequest", None, None]:
        yield from super().paginate()
...
class DescribeMountTargetSecurityGroupsRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "DescribeMountTargetSecurityGroupsRequest", None, None]:
        yield from super().paginate()
...
class DescribeMountTargetSecurityGroupsResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "DescribeMountTargetSecurityGroupsResponse", None, None]:
        yield from super().paginate()
...
class DescribeMountTargetsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeMountTargetsRequest", None, None]:
        yield from super().paginate()
...
class FileSystemAlreadyExists(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["FileSystemAlreadyExists", None, None]:
        yield from super().paginate()
...
class FileSystemDescription(OutputShapeBase):
    ...
    life_cycle_state: "LifeCycleState" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    size_in_bytes: "FileSystemSize" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self,
                ) -> typing.Generator["FileSystemDescription", None, None]:
        yield from super().paginate()
...
class FileSystemInUse(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["FileSystemInUse", None, None]:
        yield from super().paginate()
...
class FileSystemLimitExceeded(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["FileSystemLimitExceeded", None, None]:
        yield from super().paginate()
...
class FileSystemNotFound(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["FileSystemNotFound", None, None]:
        yield from super().paginate()
...
class FileSystemSize(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["FileSystemSize", None, None]:
        yield from super().paginate()
...
class IncorrectFileSystemLifeCycleState(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["IncorrectFileSystemLifeCycleState", None, None]:
        yield from super().paginate()
...
class IncorrectMountTargetState(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["IncorrectMountTargetState", None, None]:
        yield from super().paginate()
...
class InsufficientThroughputCapacity(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InsufficientThroughputCapacity", None, None]:
        yield from super().paginate()
...
class IpAddressInUse(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["IpAddressInUse", None, None]:
        yield from super().paginate()
...
class ModifyMountTargetSecurityGroupsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ModifyMountTargetSecurityGroupsRequest", None, None]:
        yield from super().paginate()
...
class MountTargetConflict(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["MountTargetConflict", None, None]:
        yield from super().paginate()
...
class MountTargetDescription(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["MountTargetDescription", None, None]:
        yield from super().paginate()
...
class MountTargetNotFound(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["MountTargetNotFound", None, None]:
        yield from super().paginate()
...
class NetworkInterfaceLimitExceeded(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["NetworkInterfaceLimitExceeded", None, None]:
        yield from super().paginate()
...
class NoFreeAddressesInSubnet(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["NoFreeAddressesInSubnet", None, None]:
        yield from super().paginate()
...
class SecurityGroupLimitExceeded(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SecurityGroupLimitExceeded", None, None]:
        yield from super().paginate()
...
class SecurityGroupNotFound(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SecurityGroupNotFound", None, None]:
        yield from super().paginate()
...
class SubnetNotFound(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SubnetNotFound", None, None]:
        yield from super().paginate()
...
class ThroughputLimitExceeded(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ThroughputLimitExceeded", None, None]:
        yield from super().paginate()
...
class TooManyRequests(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TooManyRequests", None, None]:
        yield from super().paginate()
...
class UnsupportedAvailabilityZone(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnsupportedAvailabilityZone", None, None]:
        yield from super().paginate()
...
class UpdateFileSystemRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateFileSystemRequest", None, None]:
        yield from super().paginate()
