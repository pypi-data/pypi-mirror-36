...
class Client(ClientBase):
    ...
    def list_collections(
        ...
        *,
        ...
        result = shapes.ListCollectionsResponse.from_boto_dict(first_page)
    ...
    def list_faces(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListFacesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_stream_processors(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListStreamProcessorsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
