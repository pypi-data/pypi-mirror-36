...
class Client(ClientBase):
    ...
    def associate_contact_with_address_book(
        ...
        *,
        ...
        return shapes.AssociateContactWithAddressBookResponse.from_boto_dict(
            response
        )
    ...
    def associate_device_with_room(
        ...
        *,
        ...
        return shapes.AssociateDeviceWithRoomResponse.from_boto_dict(response)
    ...
    def associate_skill_group_with_room(
        ...
        *,
        ...
        return shapes.AssociateSkillGroupWithRoomResponse.from_boto_dict(
            response
        )
    ...
    def create_address_book(
        ...
        *,
        ...
        response = self._boto_client.create_address_book(
            **_request.to_boto_dict()
        )

        return shapes.CreateAddressBookResponse.from_boto_dict(response)
    ...
    def create_contact(
        ...
        *,
        ...
        response = self._boto_client.create_contact(**_request.to_boto_dict())

        return shapes.CreateContactResponse.from_boto_dict(response)
    ...
    def create_profile(
        ...
        *,
        ...
        timezone: str,
        address: str,
        distance_unit: shapes.DistanceUnit,
        temperature_unit: shapes.TemperatureUnit,
        wake_word: shapes.WakeWord,
        client_request_token: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_profile(**_request.to_boto_dict())

        return shapes.CreateProfileResponse.from_boto_dict(response)
    ...
    def create_room(
        ...
        *,
        ...
        response = self._boto_client.create_room(**_request.to_boto_dict())

        return shapes.CreateRoomResponse.from_boto_dict(response)
    ...
    def create_skill_group(
        ...
        *,
        ...
        response = self._boto_client.create_skill_group(
            **_request.to_boto_dict()
        )

        return shapes.CreateSkillGroupResponse.from_boto_dict(response)
    ...
    def delete_address_book(
        ...
        *,
        ...
        response = self._boto_client.delete_address_book(
            **_request.to_boto_dict()
        )

        return shapes.DeleteAddressBookResponse.from_boto_dict(response)
    ...
    def delete_contact(
        ...
        *,
        ...
        response = self._boto_client.delete_contact(**_request.to_boto_dict())

        return shapes.DeleteContactResponse.from_boto_dict(response)
    ...
    def delete_profile(
        ...
        *,
        ...
        response = self._boto_client.delete_profile(**_request.to_boto_dict())

        return shapes.DeleteProfileResponse.from_boto_dict(response)
    ...
    def delete_room(
        ...
        *,
        ...
        response = self._boto_client.delete_room(**_request.to_boto_dict())

        return shapes.DeleteRoomResponse.from_boto_dict(response)
    ...
    def delete_room_skill_parameter(
        ...
        *,
        ...
        return shapes.DeleteRoomSkillParameterResponse.from_boto_dict(response)
    ...
    def delete_skill_group(
        ...
        *,
        ...
        response = self._boto_client.delete_skill_group(
            **_request.to_boto_dict()
        )

        return shapes.DeleteSkillGroupResponse.from_boto_dict(response)
    ...
    def delete_user(
        ...
        *,
        ...
        return shapes.DeleteUserResponse.from_boto_dict(response)
    ...
    def disassociate_contact_from_address_book(
        ...
        *,
        ...
        return shapes.DisassociateContactFromAddressBookResponse.from_boto_dict(
            response
        )
    ...
    def disassociate_device_from_room(
        ...
        *,
        ...
        return shapes.DisassociateDeviceFromRoomResponse.from_boto_dict(
            response
        )
    ...
    def disassociate_skill_group_from_room(
        ...
        *,
        ...
        return shapes.DisassociateSkillGroupFromRoomResponse.from_boto_dict(
            response
        )
    ...
    def get_address_book(
        ...
        *,
        ...
        response = self._boto_client.get_address_book(**_request.to_boto_dict())

        return shapes.GetAddressBookResponse.from_boto_dict(response)
    ...
    def get_contact(
        ...
        *,
        ...
        response = self._boto_client.get_contact(**_request.to_boto_dict())

        return shapes.GetContactResponse.from_boto_dict(response)
    ...
    def get_profile(
        ...
        *,
        ...
        response = self._boto_client.get_profile(**_request.to_boto_dict())

        return shapes.GetProfileResponse.from_boto_dict(response)
    ...
    def get_room(
        ...
        *,
        ...
        response = self._boto_client.get_room(**_request.to_boto_dict())

        return shapes.GetRoomResponse.from_boto_dict(response)
    ...
    def get_room_skill_parameter(
        ...
        *,
        ...
        return shapes.GetRoomSkillParameterResponse.from_boto_dict(response)
    ...
    def get_skill_group(
        ...
        *,
        ...
        response = self._boto_client.get_skill_group(**_request.to_boto_dict())

        return shapes.GetSkillGroupResponse.from_boto_dict(response)
    ...
    def list_device_events(
        ...
        *,
        device_arn: str,
        event_type: shapes.DeviceEventType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_device_events(
            **_request.to_boto_dict()
        )

        return shapes.ListDeviceEventsResponse.from_boto_dict(response)
    ...
    def list_skills(
        ...
        *,
        ...
        result = shapes.ListSkillsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListSkillsResponse.from_boto_dict(response)
    ...
    def list_tags(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTagsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListTagsResponse.from_boto_dict(response)
    ...
    def put_room_skill_parameter(
        ...
        *,
        ...
        return shapes.PutRoomSkillParameterResponse.from_boto_dict(response)
    ...
    def resolve_room(
        ...
        *,
        ...
        response = self._boto_client.resolve_room(**_request.to_boto_dict())

        return shapes.ResolveRoomResponse.from_boto_dict(response)
    ...
    def revoke_invitation(
        ...
        *,
        ...
        response = self._boto_client.revoke_invitation(
            **_request.to_boto_dict()
        )

        return shapes.RevokeInvitationResponse.from_boto_dict(response)
    ...
    def search_address_books(
        ...
        *,
        ...
        response = self._boto_client.search_address_books(
            **_request.to_boto_dict()
        )

        return shapes.SearchAddressBooksResponse.from_boto_dict(response)
    ...
    def search_contacts(
        ...
        *,
        ...
        response = self._boto_client.search_contacts(**_request.to_boto_dict())

        return shapes.SearchContactsResponse.from_boto_dict(response)
    ...
    def search_devices(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.SearchDevicesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.SearchDevicesResponse.from_boto_dict(response)
    ...
    def search_profiles(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.SearchProfilesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.SearchProfilesResponse.from_boto_dict(response)
    ...
    def search_rooms(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.SearchRoomsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.SearchRoomsResponse.from_boto_dict(response)
    ...
    def search_skill_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.SearchSkillGroupsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.SearchSkillGroupsResponse.from_boto_dict(response)
    ...
    def search_users(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.SearchUsersResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.SearchUsersResponse.from_boto_dict(response)
    ...
    def send_invitation(
        ...
        *,
        ...
        response = self._boto_client.send_invitation(**_request.to_boto_dict())

        return shapes.SendInvitationResponse.from_boto_dict(response)

    def start_device_sync(
        self,
        _request: shapes.StartDeviceSyncRequest = None,
        *,
        features: typing.List[shapes.Feature],
        room_arn: str = ShapeBase.NOT_SET,
        device_arn: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.start_device_sync(
            **_request.to_boto_dict()
        )

        return shapes.StartDeviceSyncResponse.from_boto_dict(response)
    ...
    def update_address_book(
        ...
        *,
        ...
        response = self._boto_client.update_address_book(
            **_request.to_boto_dict()
        )

        return shapes.UpdateAddressBookResponse.from_boto_dict(response)
    ...
    def update_contact(
        ...
        *,
        ...
        response = self._boto_client.update_contact(**_request.to_boto_dict())

        return shapes.UpdateContactResponse.from_boto_dict(response)
    ...
    def update_device(
        ...
        *,
        ...
        response = self._boto_client.update_device(**_request.to_boto_dict())

        return shapes.UpdateDeviceResponse.from_boto_dict(response)
    ...
    def update_profile(
        ...
        *,
        ...
        distance_unit: shapes.DistanceUnit = ShapeBase.NOT_SET,
        temperature_unit: shapes.TemperatureUnit = ShapeBase.NOT_SET,
        wake_word: shapes.WakeWord = ShapeBase.NOT_SET,
        setup_mode_disabled: bool = ShapeBase.NOT_SET,
        max_volume_limit: int = ShapeBase.NOT_SET,
        pstn_enabled: bool = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.update_profile(**_request.to_boto_dict())

        return shapes.UpdateProfileResponse.from_boto_dict(response)
    ...
    def update_room(
        ...
        *,
        ...
        response = self._boto_client.update_room(**_request.to_boto_dict())

        return shapes.UpdateRoomResponse.from_boto_dict(response)
    ...
    def update_skill_group(
        ...
        *,
        ...
        response = self._boto_client.update_skill_group(
            **_request.to_boto_dict()
        )

        return shapes.UpdateSkillGroupResponse.from_boto_dict(response)
