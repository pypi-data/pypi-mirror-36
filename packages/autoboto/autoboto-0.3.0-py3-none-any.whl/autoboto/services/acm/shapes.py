...
class AddTagsToCertificateRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AddTagsToCertificateRequest", None, None]:
...
class CertificateDetail(ShapeBase):
    ...
    revocation_reason: "RevocationReason" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    key_algorithm: "KeyAlgorithm" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    in_use_by: typing.List[str] = dataclasses.field(default_factory=list, )
    ...
    failure_reason: "FailureReason" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    type: "CertificateType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    renewal_eligibility: "RenewalEligibility" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    options: "CertificateOptions" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["CertificateDetail", None, None]:
        yield from super().paginate()
    ...
    def _get_boto_mapping(cls):
        return [
            (
                ...
                TypeInfo(CertificateTransparencyLoggingPreference),
            ),
        ]

    # You can opt out of certificate transparency logging by specifying the
    # `DISABLED` option. Opt in by specifying `ENABLED`.
    certificate_transparency_logging_preference: "CertificateTransparencyLoggingPreference" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["CertificateOptions", None, None]:
        yield from super().paginate()
...
class CertificateSummary(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CertificateSummary", None, None]:
        yield from super().paginate()
...
class DescribeCertificateResponse(OutputShapeBase):
    ...
    certificate: "CertificateDetail" = dataclasses.field(default_factory=dict, )
...
class DomainValidation(ShapeBase):
    ...
    #   * ``FAILED
    validation_status: "DomainStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    validation_method: "ValidationMethod" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["DomainValidation", None, None]:
        yield from super().paginate()
...
class DomainValidationOption(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DomainValidationOption", None, None]:
        yield from super().paginate()
...
class ExportCertificateRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ExportCertificateRequest", None, None]:
        yield from super().paginate()
...
class ExportCertificateResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ExportCertificateResponse", None, None]:
        yield from super().paginate()
...
class ExtendedKeyUsage(ShapeBase):
    ...
    name: "ExtendedKeyUsageName" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["ExtendedKeyUsage", None, None]:
        yield from super().paginate()
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "extended_key_usage",
                "extendedKeyUsage",
                TypeInfo(typing.List[ExtendedKeyUsageName]),
            ),
            (
                "key_usage",
                "keyUsage",
                TypeInfo(typing.List[KeyUsageName]),
            ),
            (
                "key_types",
                "keyTypes",
                TypeInfo(typing.List[KeyAlgorithm]),
            ),
        ]

    # Specify one or more ExtendedKeyUsage extension values.
    extended_key_usage: typing.List["ExtendedKeyUsageName"] = dataclasses.field(
        default_factory=list,
    )

    # Specify one or more KeyUsage extension values.
    key_usage: typing.List["KeyUsageName"] = dataclasses.field(
        default_factory=list,
    )

    # Specify one or more algorithms that can be used to generate key pairs.
    key_types: typing.List["KeyAlgorithm"] = dataclasses.field(
        default_factory=list,
    )

    def paginate(self, ) -> typing.Generator["Filters", None, None]:
        yield from super().paginate()
...
class GetCertificateRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetCertificateRequest", None, None]:
        yield from super().paginate()
...
class GetCertificateResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetCertificateResponse", None, None]:
        yield from super().paginate()
...
class ImportCertificateRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ImportCertificateRequest", None, None]:
        yield from super().paginate()
...
class InvalidDomainValidationOptionsException(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "InvalidDomainValidationOptionsException", None, None]:
        yield from super().paginate()
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "name",
                "Name",
                TypeInfo(KeyUsageName),
            ),
        ]

    # A string value that contains a Key Usage extension name.
    name: "KeyUsageName" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["KeyUsage", None, None]:
        yield from super().paginate()
...
class ListCertificatesRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                ...
                "CertificateStatuses",
                TypeInfo(typing.List[CertificateStatus]),
            ),
            (
                "includes",
                "Includes",
    ...
    certificate_statuses: typing.List["CertificateStatus"] = dataclasses.field(
        default_factory=list,
    )

    # Filter the certificate list. For more information, see the Filters
    # structure.
    includes: "Filters" = dataclasses.field(default_factory=dict, )
...
class ListTagsForCertificateRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListTagsForCertificateRequest", None, None]:
        yield from super().paginate()
...
class ListTagsForCertificateResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListTagsForCertificateResponse", None, None]:
        yield from super().paginate()
...
class RemoveTagsFromCertificateRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["RemoveTagsFromCertificateRequest", None, None]:
        yield from super().paginate()
...
class RenewalSummary(ShapeBase):
    ...
    # renewal](http://docs.aws.amazon.com/acm/latest/userguide/acm-renewal.html)
    # of the certificate.
    renewal_status: "RenewalStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["RenewalSummary", None, None]:
        yield from super().paginate()
...
class RequestCertificateRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RequestCertificateRequest", None, None]:
        yield from super().paginate()
...
class RequestCertificateResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RequestCertificateResponse", None, None]:
        yield from super().paginate()
...
class RequestInProgressException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RequestInProgressException", None, None]:
        yield from super().paginate()
...
class ResendValidationEmailRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ResendValidationEmailRequest", None, None]:
        yield from super().paginate()
...
class UpdateCertificateOptionsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateCertificateOptionsRequest", None, None]:
        yield from super().paginate()
