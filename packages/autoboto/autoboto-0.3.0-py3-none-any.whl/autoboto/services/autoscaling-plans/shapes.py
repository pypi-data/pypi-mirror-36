...
class ApplicationSource(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ApplicationSource", None, None]:
...
class CreateScalingPlanRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CreateScalingPlanRequest", None, None]:
        yield from super().paginate()
...
class CreateScalingPlanResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CreateScalingPlanResponse", None, None]:
        yield from super().paginate()
...
class CustomizedScalingMetricSpecification(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CustomizedScalingMetricSpecification", None, None]:
        yield from super().paginate()
...
class DeleteScalingPlanRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteScalingPlanRequest", None, None]:
        yield from super().paginate()
...
class DeleteScalingPlanResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteScalingPlanResponse", None, None]:
        yield from super().paginate()
...
class DescribeScalingPlanResourcesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScalingPlanResourcesRequest", None, None]:
        yield from super().paginate()
...
class DescribeScalingPlanResourcesResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScalingPlanResourcesResponse", None, None]:
        yield from super().paginate()
...
class DescribeScalingPlansRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScalingPlansRequest", None, None]:
        yield from super().paginate()
...
class DescribeScalingPlansResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScalingPlansResponse", None, None]:
        yield from super().paginate()
...
class PredefinedScalingMetricSpecification(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["PredefinedScalingMetricSpecification", None, None]:
        yield from super().paginate()
...
class ScalingInstruction(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ScalingInstruction", None, None]:
        yield from super().paginate()
...
class ScalingPlan(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status_code",
                "StatusCode",
                TypeInfo(ScalingPlanStatusCode),
            ),
            (
                "status_message",
                "StatusMessage",
    ...
    def paginate(self, ) -> typing.Generator["ScalingPlan", None, None]:
        yield from super().paginate()
...
class ScalingPlanResource(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ScalingPlanResource", None, None]:
        yield from super().paginate()
...
class UpdateScalingPlanRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateScalingPlanRequest", None, None]:
        yield from super().paginate()
...
class UpdateScalingPlanResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateScalingPlanResponse", None, None]:
        yield from super().paginate()
