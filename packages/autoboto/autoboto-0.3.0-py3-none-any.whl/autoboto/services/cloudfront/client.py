...
class Client(ClientBase):
    ...
    def create_cloud_front_origin_access_identity(
        ...
        *,
        ...
        return shapes.CreateCloudFrontOriginAccessIdentityResult.from_boto_dict(
            response
        )
    ...
    def create_distribution(
        ...
        *,
        ...
        response = self._boto_client.create_distribution(
            **_request.to_boto_dict()
        )

        return shapes.CreateDistributionResult.from_boto_dict(response)
    ...
    def create_distribution_with_tags(
        ...
        *,
        ...
        return shapes.CreateDistributionWithTagsResult.from_boto_dict(response)
    ...
    def create_field_level_encryption_config(
        ...
        *,
        ...
        return shapes.CreateFieldLevelEncryptionConfigResult.from_boto_dict(
            response
        )
    ...
    def create_field_level_encryption_profile(
        ...
        *,
        ...
        return shapes.CreateFieldLevelEncryptionProfileResult.from_boto_dict(
            response
        )
    ...
    def create_invalidation(
        ...
        *,
        ...
        response = self._boto_client.create_invalidation(
            **_request.to_boto_dict()
        )

        return shapes.CreateInvalidationResult.from_boto_dict(response)
    ...
    def create_public_key(
        ...
        *,
        ...
        response = self._boto_client.create_public_key(
            **_request.to_boto_dict()
        )

        return shapes.CreatePublicKeyResult.from_boto_dict(response)
    ...
    def create_streaming_distribution(
        ...
        *,
        ...
        return shapes.CreateStreamingDistributionResult.from_boto_dict(response)
    ...
    def create_streaming_distribution_with_tags(
        ...
        *,
        ...
        return shapes.CreateStreamingDistributionWithTagsResult.from_boto_dict(
            response
        )
    ...
    def delete_distribution(
        ...
        *,
        ...
        response = self._boto_client.delete_distribution(
            **_request.to_boto_dict()
        )
    ...
    def delete_public_key(
        ...
        *,
        ...
        response = self._boto_client.delete_public_key(
            **_request.to_boto_dict()
        )
    ...
    def get_cloud_front_origin_access_identity(
        ...
        *,
        ...
        return shapes.GetCloudFrontOriginAccessIdentityResult.from_boto_dict(
            response
        )
    ...
    def get_cloud_front_origin_access_identity_config(
        ...
        *,
        ...
        return shapes.GetCloudFrontOriginAccessIdentityConfigResult.from_boto_dict(
            response
        )
    ...
    def get_distribution(
        ...
        *,
        ...
        response = self._boto_client.get_distribution(**_request.to_boto_dict())

        return shapes.GetDistributionResult.from_boto_dict(response)
    ...
    def get_distribution_config(
        ...
        *,
        ...
        return shapes.GetDistributionConfigResult.from_boto_dict(response)
    ...
    def get_field_level_encryption(
        ...
        *,
        ...
        return shapes.GetFieldLevelEncryptionResult.from_boto_dict(response)
    ...
    def get_field_level_encryption_config(
        ...
        *,
        ...
        return shapes.GetFieldLevelEncryptionConfigResult.from_boto_dict(
            response
        )
    ...
    def get_field_level_encryption_profile(
        ...
        *,
        ...
        return shapes.GetFieldLevelEncryptionProfileResult.from_boto_dict(
            response
        )
    ...
    def get_field_level_encryption_profile_config(
        ...
        *,
        ...
        return shapes.GetFieldLevelEncryptionProfileConfigResult.from_boto_dict(
            response
        )
    ...
    def get_invalidation(
        ...
        *,
        ...
        response = self._boto_client.get_invalidation(**_request.to_boto_dict())

        return shapes.GetInvalidationResult.from_boto_dict(response)
    ...
    def get_public_key(
        ...
        *,
        ...
        response = self._boto_client.get_public_key(**_request.to_boto_dict())

        return shapes.GetPublicKeyResult.from_boto_dict(response)
    ...
    def get_public_key_config(
        ...
        *,
        ...
        response = self._boto_client.get_public_key_config(
            **_request.to_boto_dict()
        )

        return shapes.GetPublicKeyConfigResult.from_boto_dict(response)
    ...
    def get_streaming_distribution(
        ...
        *,
        ...
        return shapes.GetStreamingDistributionResult.from_boto_dict(response)
    ...
    def get_streaming_distribution_config(
        ...
        *,
        ...
        return shapes.GetStreamingDistributionConfigResult.from_boto_dict(
            response
        )
    ...
    def list_cloud_front_origin_access_identities(
        ...
        *,
        ...
        result = shapes.ListCloudFrontOriginAccessIdentitiesResult.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListCloudFrontOriginAccessIdentitiesResult.from_boto_dict(
            response
        )
    ...
    def list_distributions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDistributionsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListDistributionsResult.from_boto_dict(response)
    ...
    def list_distributions_by_web_acl_id(
        ...
        *,
        ...
        return shapes.ListDistributionsByWebACLIdResult.from_boto_dict(response)
    ...
    def list_field_level_encryption_configs(
        ...
        *,
        ...
        return shapes.ListFieldLevelEncryptionConfigsResult.from_boto_dict(
            response
        )
    ...
    def list_field_level_encryption_profiles(
        ...
        *,
        ...
        return shapes.ListFieldLevelEncryptionProfilesResult.from_boto_dict(
            response
        )
    ...
    def list_invalidations(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListInvalidationsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListInvalidationsResult.from_boto_dict(response)
    ...
    def list_public_keys(
        ...
        *,
        ...
        response = self._boto_client.list_public_keys(**_request.to_boto_dict())

        return shapes.ListPublicKeysResult.from_boto_dict(response)
    ...
    def list_streaming_distributions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListStreamingDistributionsResult.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListStreamingDistributionsResult.from_boto_dict(response)
    ...
    def update_cloud_front_origin_access_identity(
        ...
        *,
        ...
        return shapes.UpdateCloudFrontOriginAccessIdentityResult.from_boto_dict(
            response
        )
    ...
    def update_distribution(
        ...
        **To update a web distribution using the CloudFront API**
        ...
        response = self._boto_client.update_distribution(
            **_request.to_boto_dict()
        )

        return shapes.UpdateDistributionResult.from_boto_dict(response)
    ...
    def update_field_level_encryption_config(
        ...
        *,
        ...
        return shapes.UpdateFieldLevelEncryptionConfigResult.from_boto_dict(
            response
        )
    ...
    def update_field_level_encryption_profile(
        ...
        *,
        ...
        return shapes.UpdateFieldLevelEncryptionProfileResult.from_boto_dict(
            response
        )
    ...
    def update_public_key(
        ...
        *,
        ...
        response = self._boto_client.update_public_key(
            **_request.to_boto_dict()
        )

        return shapes.UpdatePublicKeyResult.from_boto_dict(response)
    ...
    def update_streaming_distribution(
        ...
        *,
        ...
        return shapes.UpdateStreamingDistributionResult.from_boto_dict(response)
