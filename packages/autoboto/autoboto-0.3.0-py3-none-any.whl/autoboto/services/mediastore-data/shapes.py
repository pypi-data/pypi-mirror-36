...
class DescribeObjectRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeObjectRequest", None, None]:
        yield from super().paginate()
...
class DescribeObjectResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeObjectResponse", None, None]:
        yield from super().paginate()
...
class GetObjectResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetObjectResponse", None, None]:
        yield from super().paginate()
...
class Item(ShapeBase):
    ...
    type: "ItemType" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class ListItemsRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListItemsRequest", None, None]:
        yield from super().paginate()
...
class ListItemsResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListItemsResponse", None, None]:
        yield from super().paginate()
...
class PutObjectResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutObjectResponse", None, None]:
        yield from super().paginate()
...
class RequestedRangeNotSatisfiableException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["RequestedRangeNotSatisfiableException", None, None]:
        yield from super().paginate()
