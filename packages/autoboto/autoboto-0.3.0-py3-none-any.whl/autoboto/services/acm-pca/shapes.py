...
class ASN1Subject(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ASN1Subject", None, None]:
...
class CertificateAuthority(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "type",
                "Type",
                TypeInfo(CertificateAuthorityType),
            ),
            (
                "serial",
                "Serial",
            ...
            (
                "status",
                "Status",
                TypeInfo(CertificateAuthorityStatus),
            ),
            (
                "not_before",
                "NotBefore",
    ...
    type: "CertificateAuthorityType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    status: "CertificateAuthorityStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["CertificateAuthority", None, None]:
        yield from super().paginate()
...
class CertificateAuthorityConfiguration(ShapeBase):
    ...
    signing_algorithm: "SigningAlgorithm" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Structure that contains X.500 distinguished name information for your
    # private CA.
    subject: "ASN1Subject" = dataclasses.field(default_factory=dict, )

    def paginate(
        self,
    ) -> typing.Generator["CertificateAuthorityConfiguration", None, None]:
        yield from super().paginate()
...
class CertificateMismatchException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CertificateMismatchException", None, None]:
        yield from super().paginate()
...
class CreateCertificateAuthorityAuditReportRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                TypeInfo(AuditReportResponseFormat),
            ),
        ]
    ...
    # **CSV**.
    audit_report_response_format: "AuditReportResponseFormat" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator[
        "CreateCertificateAuthorityAuditReportRequest", None, None]:
        yield from super().paginate()
...
class CreateCertificateAuthorityAuditReportResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "CreateCertificateAuthorityAuditReportResponse", None, None]:
        yield from super().paginate()
...
class CreateCertificateAuthorityRequest(ShapeBase):
    ...
    # **SUBORDINATE**.
    certificate_authority_type: "CertificateAuthorityType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateCertificateAuthorityRequest", None, None]:
        yield from super().paginate()
...
class CreateCertificateAuthorityResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateCertificateAuthorityResponse", None, None]:
        yield from super().paginate()
...
class CrlConfiguration(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CrlConfiguration", None, None]:
        yield from super().paginate()
...
class DeleteCertificateAuthorityRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteCertificateAuthorityRequest", None, None]:
        yield from super().paginate()
...
class DescribeCertificateAuthorityAuditReportRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "DescribeCertificateAuthorityAuditReportRequest", None, None]:
        yield from super().paginate()
...
class DescribeCertificateAuthorityAuditReportResponse(OutputShapeBase):
    ...
    # failed.
    audit_report_status: "AuditReportStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator[
        "DescribeCertificateAuthorityAuditReportResponse", None, None]:
        yield from super().paginate()
...
class DescribeCertificateAuthorityRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeCertificateAuthorityRequest", None, None]:
        yield from super().paginate()
...
class DescribeCertificateAuthorityResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeCertificateAuthorityResponse", None, None]:
        yield from super().paginate()
...
class GetCertificateAuthorityCertificateRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "GetCertificateAuthorityCertificateRequest", None, None]:
        yield from super().paginate()
...
class GetCertificateAuthorityCertificateResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "GetCertificateAuthorityCertificateResponse", None, None]:
        yield from super().paginate()
...
class GetCertificateAuthorityCsrRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetCertificateAuthorityCsrRequest", None, None]:
        yield from super().paginate()
...
class GetCertificateAuthorityCsrResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetCertificateAuthorityCsrResponse", None, None]:
        yield from super().paginate()
...
class ImportCertificateAuthorityCertificateRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "ImportCertificateAuthorityCertificateRequest", None, None]:
        yield from super().paginate()
...
class InvalidArgsException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidArgsException", None, None]:
        yield from super().paginate()
...
class IssueCertificateRequest(ShapeBase):
    ...
    validity: "Validity" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self,
                ) -> typing.Generator["IssueCertificateRequest", None, None]:
        yield from super().paginate()
...
class IssueCertificateResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["IssueCertificateResponse", None, None]:
        yield from super().paginate()
...
class ListCertificateAuthoritiesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListCertificateAuthoritiesRequest", None, None]:
        yield from super().paginate()
...
class ListCertificateAuthoritiesResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListCertificateAuthoritiesResponse", None, None]:
        yield from super().paginate()
...
class MalformedCSRException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["MalformedCSRException", None, None]:
        yield from super().paginate()
...
class RequestAlreadyProcessedException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["RequestAlreadyProcessedException", None, None]:
        yield from super().paginate()
...
class RequestFailedException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RequestFailedException", None, None]:
        yield from super().paginate()
...
class RestoreCertificateAuthorityRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["RestoreCertificateAuthorityRequest", None, None]:
        yield from super().paginate()
...
class RevocationConfiguration(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RevocationConfiguration", None, None]:
        yield from super().paginate()
...
class RevokeCertificateRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RevokeCertificateRequest", None, None]:
        yield from super().paginate()
...
class TagCertificateAuthorityRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["TagCertificateAuthorityRequest", None, None]:
        yield from super().paginate()
...
class UntagCertificateAuthorityRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UntagCertificateAuthorityRequest", None, None]:
        yield from super().paginate()
...
class UpdateCertificateAuthorityRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateCertificateAuthorityRequest", None, None]:
        yield from super().paginate()
...
class Validity(ShapeBase):
    ...
    type: "ValidityPeriodType" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["Validity", None, None]:
        yield from super().paginate()
