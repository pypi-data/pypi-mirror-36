...
class Client(ClientBase):
    ...
    def describe_configuration_set(
        ...
        *,
        ...
        configuration_set_attribute_names: typing.List[
            shapes.ConfigurationSetAttribute] = ShapeBase.NOT_SET,
    ...
    def list_custom_verification_email_templates(
        ...
        *,
        ...
        result = shapes.ListCustomVerificationEmailTemplatesResponse.from_boto_dict(
            first_page
        )
    ...
    def list_identities(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListIdentitiesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
