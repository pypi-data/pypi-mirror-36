...
class Client(ClientBase):
    ...
    def add_user_to_group(
        ...
        *,
        ...
        response = self._boto_client.add_user_to_group(
            **_request.to_boto_dict()
        )
    ...
    def attach_group_policy(
        ...
        *,
        ...
        response = self._boto_client.attach_group_policy(
            **_request.to_boto_dict()
        )
    ...
    def attach_role_policy(
        ...
        *,
        ...
        response = self._boto_client.attach_role_policy(
            **_request.to_boto_dict()
        )
    ...
    def attach_user_policy(
        ...
        *,
        ...
        response = self._boto_client.attach_user_policy(
            **_request.to_boto_dict()
        )
    ...
    def change_password(
        ...
        *,
        ...
        response = self._boto_client.change_password(**_request.to_boto_dict())
    ...
    def create_access_key(
        ...
        *,
        ...
        response = self._boto_client.create_access_key(
            **_request.to_boto_dict()
        )

        return shapes.CreateAccessKeyResponse.from_boto_dict(response)
    ...
    def create_account_alias(
        ...
        *,
        ...
        response = self._boto_client.create_account_alias(
            **_request.to_boto_dict()
        )
    ...
    def create_group(
        ...
        *,
        ...
        return shapes.CreateGroupResponse.from_boto_dict(response)
    ...
    def create_instance_profile(
        ...
        *,
        ...
        return shapes.CreateInstanceProfileResponse.from_boto_dict(response)
    ...
    def create_login_profile(
        ...
        *,
        ...
        response = self._boto_client.create_login_profile(
            **_request.to_boto_dict()
        )

        return shapes.CreateLoginProfileResponse.from_boto_dict(response)
    ...
    def create_open_id_connect_provider(
        ...
        *,
        ...
        return shapes.CreateOpenIDConnectProviderResponse.from_boto_dict(
            response
        )
    ...
    def create_role(
        ...
        *,
        ...
        response = self._boto_client.create_role(**_request.to_boto_dict())

        return shapes.CreateRoleResponse.from_boto_dict(response)
    ...
    def create_saml_provider(
        ...
        *,
        ...
        response = self._boto_client.create_saml_provider(
            **_request.to_boto_dict()
        )

        return shapes.CreateSAMLProviderResponse.from_boto_dict(response)
    ...
    def create_service_linked_role(
        ...
        *,
        ...
        return shapes.CreateServiceLinkedRoleResponse.from_boto_dict(response)
    ...
    def create_service_specific_credential(
        ...
        *,
        ...
        return shapes.CreateServiceSpecificCredentialResponse.from_boto_dict(
            response
        )
    ...
    def create_user(
        ...
        *,
        ...
        response = self._boto_client.create_user(**_request.to_boto_dict())

        return shapes.CreateUserResponse.from_boto_dict(response)
    ...
    def create_virtual_mfa_device(
        ...
        *,
        ...
        return shapes.CreateVirtualMFADeviceResponse.from_boto_dict(response)
    ...
    def deactivate_mfa_device(
        ...
        *,
        ...
        response = self._boto_client.deactivate_mfa_device(
            **_request.to_boto_dict()
        )
    ...
    def delete_access_key(
        ...
        *,
        ...
        response = self._boto_client.delete_access_key(
            **_request.to_boto_dict()
        )
    ...
    def delete_account_alias(
        ...
        *,
        ...
        response = self._boto_client.delete_account_alias(
            **_request.to_boto_dict()
        )
    ...
    def delete_group_policy(
        ...
        *,
        ...
        response = self._boto_client.delete_group_policy(
            **_request.to_boto_dict()
        )
    ...
    def delete_login_profile(
        ...
        *,
        ...
        response = self._boto_client.delete_login_profile(
            **_request.to_boto_dict()
        )
    ...
    def delete_role(
        ...
        *,
        ...
        response = self._boto_client.delete_role(**_request.to_boto_dict())
    ...
    def delete_role_policy(
        ...
        *,
        ...
        response = self._boto_client.delete_role_policy(
            **_request.to_boto_dict()
        )
    ...
    def delete_saml_provider(
        ...
        *,
        ...
        response = self._boto_client.delete_saml_provider(
            **_request.to_boto_dict()
        )
    ...
    def delete_ssh_public_key(
        ...
        *,
        ...
        response = self._boto_client.delete_ssh_public_key(
            **_request.to_boto_dict()
        )
    ...
    def delete_service_linked_role(
        ...
        *,
        ...
        return shapes.DeleteServiceLinkedRoleResponse.from_boto_dict(response)
    ...
    def delete_user(
        ...
        *,
        ...
        response = self._boto_client.delete_user(**_request.to_boto_dict())
    ...
    def delete_user_policy(
        ...
        *,
        ...
        response = self._boto_client.delete_user_policy(
            **_request.to_boto_dict()
        )
    ...
    def detach_group_policy(
        ...
        *,
        ...
        response = self._boto_client.detach_group_policy(
            **_request.to_boto_dict()
        )
    ...
    def detach_role_policy(
        ...
        *,
        ...
        response = self._boto_client.detach_role_policy(
            **_request.to_boto_dict()
        )
    ...
    def detach_user_policy(
        ...
        *,
        ...
        response = self._boto_client.detach_user_policy(
            **_request.to_boto_dict()
        )
    ...
    def enable_mfa_device(
        ...
        *,
        ...
        response = self._boto_client.enable_mfa_device(
            **_request.to_boto_dict()
        )
    ...
    def generate_credential_report(
        ...
        return shapes.GenerateCredentialReportResponse.from_boto_dict(response)
    ...
    def get_access_key_last_used(
        ...
        *,
        ...
        return shapes.GetAccessKeyLastUsedResponse.from_boto_dict(response)

    def get_account_authorization_details(
        self,
        _request: shapes.GetAccountAuthorizationDetailsRequest = None,
        *,
        filter: typing.List[shapes.EntityType] = ShapeBase.NOT_SET,
        ...
        result = shapes.GetAccountAuthorizationDetailsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.GetAccountAuthorizationDetailsResponse.from_boto_dict(
            response
        )
    ...
    def get_account_password_policy(
        ...
        return shapes.GetAccountPasswordPolicyResponse.from_boto_dict(response)
    ...
    def get_account_summary(self, ) -> shapes.GetAccountSummaryResponse:
        ...
        return shapes.GetAccountSummaryResponse.from_boto_dict(response)
    ...
    def get_context_keys_for_custom_policy(
        ...
        *,
        ...
        return shapes.GetContextKeysForPolicyResponse.from_boto_dict(response)
    ...
    def get_credential_report(self, ) -> shapes.GetCredentialReportResponse:
        ...
        return shapes.GetCredentialReportResponse.from_boto_dict(response)
    ...
    def get_group(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.GetGroupResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.GetGroupResponse.from_boto_dict(response)
    ...
    def get_group_policy(
        ...
        *,
        ...
        response = self._boto_client.get_group_policy(**_request.to_boto_dict())

        return shapes.GetGroupPolicyResponse.from_boto_dict(response)
    ...
    def get_instance_profile(
        ...
        *,
        ...
        response = self._boto_client.get_instance_profile(
            **_request.to_boto_dict()
        )

        return shapes.GetInstanceProfileResponse.from_boto_dict(response)
    ...
    def get_login_profile(
        ...
        *,
        ...
        response = self._boto_client.get_login_profile(
            **_request.to_boto_dict()
        )

        return shapes.GetLoginProfileResponse.from_boto_dict(response)
    ...
    def get_open_id_connect_provider(
        ...
        *,
        ...
        return shapes.GetOpenIDConnectProviderResponse.from_boto_dict(response)
    ...
    def get_role(
        ...
        *,
        ...
        response = self._boto_client.get_role(**_request.to_boto_dict())

        return shapes.GetRoleResponse.from_boto_dict(response)
    ...
    def get_role_policy(
        ...
        *,
        ...
        response = self._boto_client.get_role_policy(**_request.to_boto_dict())

        return shapes.GetRolePolicyResponse.from_boto_dict(response)
    ...
    def get_saml_provider(
        ...
        *,
        ...
        response = self._boto_client.get_saml_provider(
            **_request.to_boto_dict()
        )

        return shapes.GetSAMLProviderResponse.from_boto_dict(response)
    ...
    def get_ssh_public_key(
        ...
        *,
        ...
        response = self._boto_client.get_ssh_public_key(
            **_request.to_boto_dict()
        )

        return shapes.GetSSHPublicKeyResponse.from_boto_dict(response)
    ...
    def get_server_certificate(
        ...
        *,
        ...
        return shapes.GetServerCertificateResponse.from_boto_dict(response)
    ...
    def get_service_linked_role_deletion_status(
        ...
        *,
        ...
        return shapes.GetServiceLinkedRoleDeletionStatusResponse.from_boto_dict(
            response
        )
    ...
    def get_user(
        ...
        *,
        ...
        response = self._boto_client.get_user(**_request.to_boto_dict())

        return shapes.GetUserResponse.from_boto_dict(response)
    ...
    def get_user_policy(
        ...
        *,
        ...
        response = self._boto_client.get_user_policy(**_request.to_boto_dict())

        return shapes.GetUserPolicyResponse.from_boto_dict(response)
    ...
    def list_access_keys(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListAccessKeysResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListAccessKeysResponse.from_boto_dict(response)
    ...
    def list_account_aliases(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListAccountAliasesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListAccountAliasesResponse.from_boto_dict(response)
    ...
    def list_attached_group_policies(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListAttachedGroupPoliciesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListAttachedGroupPoliciesResponse.from_boto_dict(response)
    ...
    def list_attached_role_policies(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListAttachedRolePoliciesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListAttachedRolePoliciesResponse.from_boto_dict(response)
    ...
    def list_attached_user_policies(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListAttachedUserPoliciesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListAttachedUserPoliciesResponse.from_boto_dict(response)
    ...
    def list_entities_for_policy(
        ...
        *,
        policy_arn: str,
        entity_filter: shapes.EntityType = ShapeBase.NOT_SET,
        path_prefix: str = ShapeBase.NOT_SET,
        policy_usage_filter: shapes.PolicyUsageType = ShapeBase.NOT_SET,
        marker: str = ShapeBase.NOT_SET,
        max_items: int = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListEntitiesForPolicyResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListEntitiesForPolicyResponse.from_boto_dict(response)
    ...
    def list_group_policies(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListGroupPoliciesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListGroupPoliciesResponse.from_boto_dict(response)
    ...
    def list_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListGroupsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListGroupsResponse.from_boto_dict(response)
    ...
    def list_groups_for_user(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListGroupsForUserResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListGroupsForUserResponse.from_boto_dict(response)
    ...
    def list_instance_profiles(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListInstanceProfilesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListInstanceProfilesResponse.from_boto_dict(response)
    ...
    def list_instance_profiles_for_role(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListInstanceProfilesForRoleResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListInstanceProfilesForRoleResponse.from_boto_dict(
            response
        )
    ...
    def list_mfa_devices(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListMFADevicesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListMFADevicesResponse.from_boto_dict(response)
    ...
    def list_open_id_connect_providers(
        ...
        return shapes.ListOpenIDConnectProvidersResponse.from_boto_dict(
            response
        )
    ...
    def list_policies(
        ...
        *,
        scope: shapes.policyScopeType = ShapeBase.NOT_SET,
    ...
    def list_policy_versions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPolicyVersionsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_role_policies(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListRolePoliciesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListRolePoliciesResponse.from_boto_dict(response)
    ...
    def list_roles(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListRolesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListRolesResponse.from_boto_dict(response)
    ...
    def list_saml_providers(
        ...
        response = self._boto_client.list_saml_providers(
            **_request.to_boto_dict()
        )

        return shapes.ListSAMLProvidersResponse.from_boto_dict(response)
    ...
    def list_ssh_public_keys(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSSHPublicKeysResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListSSHPublicKeysResponse.from_boto_dict(response)
    ...
    def list_server_certificates(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListServerCertificatesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListServerCertificatesResponse.from_boto_dict(response)
    ...
    def list_service_specific_credentials(
        ...
        *,
        ...
        return shapes.ListServiceSpecificCredentialsResponse.from_boto_dict(
            response
        )
    ...
    def list_signing_certificates(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSigningCertificatesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListSigningCertificatesResponse.from_boto_dict(response)
    ...
    def list_user_policies(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListUserPoliciesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListUserPoliciesResponse.from_boto_dict(response)
    ...
    def list_users(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListUsersResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListUsersResponse.from_boto_dict(response)

    def list_virtual_mfa_devices(
        self,
        _request: shapes.ListVirtualMFADevicesRequest = None,
        *,
        assignment_status: shapes.assignmentStatusType = ShapeBase.NOT_SET,
        marker: str = ShapeBase.NOT_SET,
        max_items: int = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListVirtualMFADevicesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListVirtualMFADevicesResponse.from_boto_dict(response)
    ...
    def put_group_policy(
        ...
        *,
        ...
        response = self._boto_client.put_group_policy(**_request.to_boto_dict())
    ...
    def put_role_policy(
        ...
        *,
        ...
        response = self._boto_client.put_role_policy(**_request.to_boto_dict())
    ...
    def put_user_policy(
        ...
        *,
        ...
        response = self._boto_client.put_user_policy(**_request.to_boto_dict())
    ...
    def reset_service_specific_credential(
        ...
        *,
        ...
        return shapes.ResetServiceSpecificCredentialResponse.from_boto_dict(
            response
        )
    ...
    def resync_mfa_device(
        ...
        *,
        ...
        response = self._boto_client.resync_mfa_device(
            **_request.to_boto_dict()
        )
    ...
    def simulate_custom_policy(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.SimulatePolicyResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.SimulatePolicyResponse.from_boto_dict(response)
    ...
    def update_access_key(
        ...
        *,
        ...
        response = self._boto_client.update_access_key(
            **_request.to_boto_dict()
        )
    ...
    def update_login_profile(
        ...
        *,
        ...
        response = self._boto_client.update_login_profile(
            **_request.to_boto_dict()
        )
    ...
    def update_role(
        ...
        *,
        ...
        response = self._boto_client.update_role(**_request.to_boto_dict())

        return shapes.UpdateRoleResponse.from_boto_dict(response)
    ...
    def update_role_description(
        ...
        *,
        ...
        return shapes.UpdateRoleDescriptionResponse.from_boto_dict(response)
    ...
    def update_saml_provider(
        ...
        *,
        ...
        response = self._boto_client.update_saml_provider(
            **_request.to_boto_dict()
        )

        return shapes.UpdateSAMLProviderResponse.from_boto_dict(response)
    ...
    def update_ssh_public_key(
        ...
        *,
        ...
        response = self._boto_client.update_ssh_public_key(
            **_request.to_boto_dict()
        )
    ...
    def update_user(
        ...
        *,
        ...
        response = self._boto_client.update_user(**_request.to_boto_dict())
    ...
    def upload_ssh_public_key(
        ...
        *,
        ...
        response = self._boto_client.upload_ssh_public_key(
            **_request.to_boto_dict()
        )

        return shapes.UploadSSHPublicKeyResponse.from_boto_dict(response)
    ...
    def upload_server_certificate(
        ...
        *,
        ...
        return shapes.UploadServerCertificateResponse.from_boto_dict(response)
    ...
    def upload_signing_certificate(
        ...
        *,
        ...
        return shapes.UploadSigningCertificateResponse.from_boto_dict(response)
