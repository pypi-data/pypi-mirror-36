...
class AssociateAdminAccountRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AssociateAdminAccountRequest", None, None]:
...
class ComplianceViolator(ShapeBase):
    ...
    violation_reason: "ViolationReason" = dataclasses.field(
    ...
    def paginate(self, ) -> typing.Generator["ComplianceViolator", None, None]:
        yield from super().paginate()
...
class DeleteNotificationChannelRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteNotificationChannelRequest", None, None]:
        yield from super().paginate()
...
class DisassociateAdminAccountRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DisassociateAdminAccountRequest", None, None]:
        yield from super().paginate()
...
class EvaluationResult(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "compliance_status",
                "ComplianceStatus",
                TypeInfo(PolicyComplianceStatusType),
            ),
            (
                "violator_count",
                "ViolatorCount",
    ...
    compliance_status: "PolicyComplianceStatusType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class GetAdminAccountRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetAdminAccountRequest", None, None]:
        yield from super().paginate()
...
class GetAdminAccountResponse(OutputShapeBase):
    ...
    # administrator.
    role_status: "AccountRoleStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self,
                ) -> typing.Generator["GetAdminAccountResponse", None, None]:
        yield from super().paginate()
...
class GetComplianceDetailRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetComplianceDetailRequest", None, None]:
        yield from super().paginate()
...
class GetComplianceDetailResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetComplianceDetailResponse", None, None]:
        yield from super().paginate()
...
class GetNotificationChannelRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetNotificationChannelRequest", None, None]:
        yield from super().paginate()
...
class GetNotificationChannelResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetNotificationChannelResponse", None, None]:
        yield from super().paginate()
...
class ListComplianceStatusRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListComplianceStatusRequest", None, None]:
        yield from super().paginate()
...
class ListComplianceStatusResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListComplianceStatusResponse", None, None]:
        yield from super().paginate()
...
class ListMemberAccountsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListMemberAccountsRequest", None, None]:
        yield from super().paginate()
...
class ListMemberAccountsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListMemberAccountsResponse", None, None]:
        yield from super().paginate()
...
class Policy(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                "IncludeMap",
                TypeInfo(
                    typing.Dict[CustomerPolicyScopeIdType, typing.List[str]]
                ),
            ),
            (
                "exclude_map",
    ...
    include_map: typing.Dict["CustomerPolicyScopeIdType", typing.
    ...
    # `{“ACCOUNT” : [“accountID1”, “accountID2”]}`.
    exclude_map: typing.Dict["CustomerPolicyScopeIdType", typing.
                             List[str]] = dataclasses.field(
                                 default=ShapeBase.NOT_SET,
                             )
...
class PolicyComplianceDetail(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "issue_info_map",
                "IssueInfoMap",
                TypeInfo(typing.Dict[DependentServiceName, str]),
            ),
        ]
    ...
    issue_info_map: typing.Dict["DependentServiceName", str
                               ] = dataclasses.field(
                                   default=ShapeBase.NOT_SET,
                               )

    def paginate(self,
                ) -> typing.Generator["PolicyComplianceDetail", None, None]:
        yield from super().paginate()
...
class PolicyComplianceStatus(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PolicyComplianceStatus", None, None]:
        yield from super().paginate()
...
class PolicySummary(ShapeBase):
    ...
    # is `WAF`.
    security_service_type: "SecurityServiceType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class PutNotificationChannelRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["PutNotificationChannelRequest", None, None]:
        yield from super().paginate()
...
class PutPolicyRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutPolicyRequest", None, None]:
        yield from super().paginate()
...
class PutPolicyResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutPolicyResponse", None, None]:
        yield from super().paginate()
...
class SecurityServicePolicyData(ShapeBase):
    ...
    # The service that the policy is using to protect the resources. This value
    # is `WAF`.
    type: "SecurityServiceType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self,
                ) -> typing.Generator["SecurityServicePolicyData", None, None]:
        yield from super().paginate()
