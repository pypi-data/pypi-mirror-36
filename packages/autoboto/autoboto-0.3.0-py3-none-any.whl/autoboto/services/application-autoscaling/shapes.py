...
class ConcurrentUpdateException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ConcurrentUpdateException", None, None]:
        yield from super().paginate()
...
class DeleteScalingPolicyRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteScalingPolicyRequest", None, None]:
        yield from super().paginate()
...
class DeleteScalingPolicyResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteScalingPolicyResponse", None, None]:
        yield from super().paginate()
...
class DeleteScheduledActionRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteScheduledActionRequest", None, None]:
        yield from super().paginate()
...
class DeleteScheduledActionResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteScheduledActionResponse", None, None]:
        yield from super().paginate()
...
class DeregisterScalableTargetRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeregisterScalableTargetRequest", None, None]:
        yield from super().paginate()
...
class DeregisterScalableTargetResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeregisterScalableTargetResponse", None, None]:
        yield from super().paginate()
...
class DescribeScalableTargetsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScalableTargetsRequest", None, None]:
        yield from super().paginate()
...
class DescribeScalingActivitiesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScalingActivitiesRequest", None, None]:
        yield from super().paginate()
...
class DescribeScalingPoliciesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScalingPoliciesRequest", None, None]:
        yield from super().paginate()
...
class DescribeScheduledActionsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScheduledActionsRequest", None, None]:
        yield from super().paginate()
...
class DescribeScheduledActionsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeScheduledActionsResponse", None, None]:
        yield from super().paginate()
...
class FailedResourceAccessException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["FailedResourceAccessException", None, None]:
        yield from super().paginate()
...
class ObjectNotFoundException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ObjectNotFoundException", None, None]:
        yield from super().paginate()
...
class PutScalingPolicyRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutScalingPolicyRequest", None, None]:
        yield from super().paginate()
...
class PutScalingPolicyResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutScalingPolicyResponse", None, None]:
        yield from super().paginate()
...
class PutScheduledActionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutScheduledActionRequest", None, None]:
        yield from super().paginate()
...
class PutScheduledActionResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutScheduledActionResponse", None, None]:
        yield from super().paginate()
...
class RegisterScalableTargetRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["RegisterScalableTargetRequest", None, None]:
        yield from super().paginate()
...
class RegisterScalableTargetResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["RegisterScalableTargetResponse", None, None]:
        yield from super().paginate()
...
class ScalableTarget(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ScalableTarget", None, None]:
        yield from super().paginate()
...
class ScalableTargetAction(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ScalableTargetAction", None, None]:
        yield from super().paginate()
...
class ScalingActivity(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ScalingActivity", None, None]:
        yield from super().paginate()
...
class ScheduledAction(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ScheduledAction", None, None]:
        yield from super().paginate()
...
class StepScalingPolicyConfiguration(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                TypeInfo(MetricAggregationType),
            ),
        ]
    ...
    def paginate(
        self,
    ) -> typing.Generator["StepScalingPolicyConfiguration", None, None]:
        yield from super().paginate()
...
class TargetTrackingScalingPolicyConfiguration(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "TargetTrackingScalingPolicyConfiguration", None, None]:
        yield from super().paginate()
