...
class Client(ClientBase):
    ...
    def list_health_checks(
        ...
        *,
        ...
        result = shapes.ListHealthChecksResponse.from_boto_dict(first_page)
    ...
    def list_hosted_zones(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListHostedZonesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_resource_record_sets(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListResourceRecordSetsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result
