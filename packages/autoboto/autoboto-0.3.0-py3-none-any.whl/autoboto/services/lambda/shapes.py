...
class AccountUsage(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AccountUsage", None, None]:
        yield from super().paginate()
...
class AddPermissionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AddPermissionRequest", None, None]:
        yield from super().paginate()
...
class AddPermissionResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AddPermissionResponse", None, None]:
        yield from super().paginate()
...
class AliasConfiguration(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AliasConfiguration", None, None]:
        yield from super().paginate()
...
class AliasRoutingConfiguration(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AliasRoutingConfiguration", None, None]:
        yield from super().paginate()
...
class CodeStorageExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CodeStorageExceededException", None, None]:
        yield from super().paginate()
...
class Concurrency(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Concurrency", None, None]:
        yield from super().paginate()
...
class CreateEventSourceMappingRequest(ShapeBase):
    ...
    # streams.html).
    starting_position: "EventSourcePosition" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateEventSourceMappingRequest", None, None]:
        yield from super().paginate()
...
class CreateFunctionRequest(ShapeBase):
    ...
    runtime: "Runtime" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    code: "FunctionCode" = dataclasses.field(default_factory=dict, )
    ...
    environment: "Environment" = dataclasses.field(default_factory=dict, )
    ...
    tracing_config: "TracingConfig" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self,
                ) -> typing.Generator["CreateFunctionRequest", None, None]:
        yield from super().paginate()
...
class DeadLetterConfig(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeadLetterConfig", None, None]:
        yield from super().paginate()
...
class DeleteAliasRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteAliasRequest", None, None]:
        yield from super().paginate()
...
class DeleteEventSourceMappingRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteEventSourceMappingRequest", None, None]:
        yield from super().paginate()
...
class DeleteFunctionConcurrencyRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteFunctionConcurrencyRequest", None, None]:
        yield from super().paginate()
...
class DeleteFunctionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteFunctionRequest", None, None]:
        yield from super().paginate()
...
class EC2AccessDeniedException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["EC2AccessDeniedException", None, None]:
        yield from super().paginate()
...
class EC2ThrottledException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["EC2ThrottledException", None, None]:
        yield from super().paginate()
...
class EC2UnexpectedException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["EC2UnexpectedException", None, None]:
        yield from super().paginate()
...
class ENILimitReachedException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ENILimitReachedException", None, None]:
        yield from super().paginate()
...
class Environment(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Environment", None, None]:
        yield from super().paginate()
...
class EnvironmentError(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EnvironmentError", None, None]:
        yield from super().paginate()
...
class EnvironmentResponse(ShapeBase):
    ...
    # The parent object that contains error information associated with your
    # configuration settings.
    error: "EnvironmentError" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["EnvironmentResponse", None, None]:
        yield from super().paginate()
...
class EventSourceMappingConfiguration(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["EventSourceMappingConfiguration", None, None]:
        yield from super().paginate()
...
class FunctionCode(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["FunctionCode", None, None]:
        yield from super().paginate()
...
class FunctionCodeLocation(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["FunctionCodeLocation", None, None]:
        yield from super().paginate()
...
class FunctionConfiguration(OutputShapeBase):
    ...
    vpc_config: "VpcConfigResponse" = dataclasses.field(default_factory=dict, )
...
class GetAccountSettingsResponse(OutputShapeBase):
    ...
    # account and region.
    account_limit: "AccountLimit" = dataclasses.field(default_factory=dict, )

    # Provides code size usage and function count associated with the current
    # account and region.
    account_usage: "AccountUsage" = dataclasses.field(default_factory=dict, )

    def paginate(self,
                ) -> typing.Generator["GetAccountSettingsResponse", None, None]:
        yield from super().paginate()
...
class GetAliasRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetAliasRequest", None, None]:
        yield from super().paginate()
...
class GetEventSourceMappingRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetEventSourceMappingRequest", None, None]:
        yield from super().paginate()
...
class GetFunctionConfigurationRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetFunctionConfigurationRequest", None, None]:
        yield from super().paginate()
...
class GetFunctionRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetFunctionRequest", None, None]:
        yield from super().paginate()
...
class GetFunctionResponse(OutputShapeBase):
    ...
    # The object for the Lambda function location.
    code: "FunctionCodeLocation" = dataclasses.field(default_factory=dict, )
    ...
    concurrency: "Concurrency" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["GetFunctionResponse", None, None]:
        yield from super().paginate()
...
class InvalidRequestContentException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidRequestContentException", None, None]:
        yield from super().paginate()
...
class InvalidRuntimeException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidRuntimeException", None, None]:
        yield from super().paginate()
...
class InvalidSecurityGroupIDException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidSecurityGroupIDException", None, None]:
        yield from super().paginate()
...
class InvalidSubnetIDException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidSubnetIDException", None, None]:
        yield from super().paginate()
...
class InvalidZipFileException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InvalidZipFileException", None, None]:
        yield from super().paginate()
...
class InvocationRequest(ShapeBase):
    ...
    log_type: "LogType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["InvocationRequest", None, None]:
        yield from super().paginate()
...
class InvocationResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InvocationResponse", None, None]:
        yield from super().paginate()
...
class InvokeAsyncRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InvokeAsyncRequest", None, None]:
        yield from super().paginate()
...
class InvokeAsyncResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InvokeAsyncResponse", None, None]:
        yield from super().paginate()
...
class KMSAccessDeniedException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["KMSAccessDeniedException", None, None]:
        yield from super().paginate()
...
class KMSDisabledException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["KMSDisabledException", None, None]:
        yield from super().paginate()
...
class KMSInvalidStateException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["KMSInvalidStateException", None, None]:
        yield from super().paginate()
...
class KMSNotFoundException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["KMSNotFoundException", None, None]:
        yield from super().paginate()
...
class ListAliasesRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListAliasesRequest", None, None]:
        yield from super().paginate()
...
class ListEventSourceMappingsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListEventSourceMappingsRequest", None, None]:
        yield from super().paginate()
...
class ListFunctionsRequest(ShapeBase):
    ...
    function_version: "FunctionVersion" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["ListFunctionsRequest", None, None]:
        yield from super().paginate()
...
class ListVersionsByFunctionRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListVersionsByFunctionRequest", None, None]:
        yield from super().paginate()
...
class ListVersionsByFunctionResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListVersionsByFunctionResponse", None, None]:
        yield from super().paginate()
...
class PolicyLengthExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["PolicyLengthExceededException", None, None]:
        yield from super().paginate()
...
class PublishVersionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PublishVersionRequest", None, None]:
        yield from super().paginate()
...
class PutFunctionConcurrencyRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["PutFunctionConcurrencyRequest", None, None]:
        yield from super().paginate()
...
class RemovePermissionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RemovePermissionRequest", None, None]:
        yield from super().paginate()
...
class RequestTooLargeException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RequestTooLargeException", None, None]:
        yield from super().paginate()
...
class ResourceConflictException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ResourceConflictException", None, None]:
        yield from super().paginate()
...
class SubnetIPAddressLimitReachedException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["SubnetIPAddressLimitReachedException", None, None]:
        yield from super().paginate()
...
class TooManyRequestsException(ShapeBase):
    ...
    type: str = dataclasses.field(default=ShapeBase.NOT_SET, )
    message: str = dataclasses.field(default=ShapeBase.NOT_SET, )
    reason: "ThrottleReason" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class TracingConfig(ShapeBase):
    ...
    mode: "TracingMode" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["TracingConfig", None, None]:
        yield from super().paginate()
...
class TracingConfigResponse(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["TracingConfigResponse", None, None]:
        yield from super().paginate()
...
class UnsupportedMediaTypeException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnsupportedMediaTypeException", None, None]:
        yield from super().paginate()
...
class UpdateAliasRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdateAliasRequest", None, None]:
        yield from super().paginate()
...
class UpdateEventSourceMappingRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateEventSourceMappingRequest", None, None]:
        yield from super().paginate()
...
class UpdateFunctionCodeRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateFunctionCodeRequest", None, None]:
        yield from super().paginate()
...
class UpdateFunctionConfigurationRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateFunctionConfigurationRequest", None, None]:
        yield from super().paginate()
...
class VpcConfigResponse(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["VpcConfigResponse", None, None]:
        yield from super().paginate()
