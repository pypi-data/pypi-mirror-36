...
class Client(ClientBase):
    ...
    def accept_handshake(
        ...
        *,
        ...
        response = self._boto_client.accept_handshake(**_request.to_boto_dict())

        return shapes.AcceptHandshakeResponse.from_boto_dict(response)
    ...
    def cancel_handshake(
        ...
        *,
        ...
        response = self._boto_client.cancel_handshake(**_request.to_boto_dict())

        return shapes.CancelHandshakeResponse.from_boto_dict(response)
    ...
    def create_account(
        ...
        *,
        ...
        iam_user_access_to_billing: shapes.IAMUserAccessToBilling = ShapeBase.
        NOT_SET,
        ...
        response = self._boto_client.create_account(**_request.to_boto_dict())

        return shapes.CreateAccountResponse.from_boto_dict(response)

    def create_organization(
        self,
        _request: shapes.CreateOrganizationRequest = None,
        *,
        feature_set: shapes.OrganizationFeatureSet = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_organization(
            **_request.to_boto_dict()
        )

        return shapes.CreateOrganizationResponse.from_boto_dict(response)
    ...
    def create_organizational_unit(
        ...
        *,
        ...
        return shapes.CreateOrganizationalUnitResponse.from_boto_dict(response)
    ...
    def decline_handshake(
        ...
        *,
        ...
        response = self._boto_client.decline_handshake(
            **_request.to_boto_dict()
        )

        return shapes.DeclineHandshakeResponse.from_boto_dict(response)
    ...
    def describe_account(
        ...
        *,
        ...
        response = self._boto_client.describe_account(**_request.to_boto_dict())

        return shapes.DescribeAccountResponse.from_boto_dict(response)
    ...
    def describe_create_account_status(
        ...
        *,
        ...
        return shapes.DescribeCreateAccountStatusResponse.from_boto_dict(
            response
        )
    ...
    def describe_handshake(
        ...
        *,
        ...
        response = self._boto_client.describe_handshake(
            **_request.to_boto_dict()
        )

        return shapes.DescribeHandshakeResponse.from_boto_dict(response)
    ...
    def describe_organization(self, ) -> shapes.DescribeOrganizationResponse:
        ...
        return shapes.DescribeOrganizationResponse.from_boto_dict(response)
    ...
    def describe_organizational_unit(
        ...
        *,
        ...
        return shapes.DescribeOrganizationalUnitResponse.from_boto_dict(
            response
        )
    ...
    def describe_policy(
        ...
        *,
        ...
        response = self._boto_client.describe_policy(**_request.to_boto_dict())

        return shapes.DescribePolicyResponse.from_boto_dict(response)
    ...
    def disable_policy_type(
        ...
        *,
        ...
        response = self._boto_client.disable_policy_type(
            **_request.to_boto_dict()
        )

        return shapes.DisablePolicyTypeResponse.from_boto_dict(response)
    ...
    def enable_all_features(
        ...
        response = self._boto_client.enable_all_features(
            **_request.to_boto_dict()
        )

        return shapes.EnableAllFeaturesResponse.from_boto_dict(response)
    ...
    def enable_policy_type(
        ...
        *,
        ...
        response = self._boto_client.enable_policy_type(
            **_request.to_boto_dict()
        )

        return shapes.EnablePolicyTypeResponse.from_boto_dict(response)
    ...
    def invite_account_to_organization(
        ...
        *,
        ...
        return shapes.InviteAccountToOrganizationResponse.from_boto_dict(
            response
        )
    ...
    def list_aws_service_access_for_organization(
        ...
        *,
        ...
        result = shapes.ListAWSServiceAccessForOrganizationResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListAWSServiceAccessForOrganizationResponse.from_boto_dict(
            response
        )
    ...
    def list_accounts(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListAccountsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListAccountsResponse.from_boto_dict(response)
    ...
    def list_accounts_for_parent(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListAccountsForParentResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListAccountsForParentResponse.from_boto_dict(response)
    ...
    def list_children(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListChildrenResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListChildrenResponse.from_boto_dict(response)

    def list_create_account_status(
        self,
        _request: shapes.ListCreateAccountStatusRequest = None,
        *,
        states: typing.List[shapes.CreateAccountState] = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListCreateAccountStatusResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListCreateAccountStatusResponse.from_boto_dict(response)
    ...
    def list_handshakes_for_account(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListHandshakesForAccountResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListHandshakesForAccountResponse.from_boto_dict(response)
    ...
    def list_handshakes_for_organization(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListHandshakesForOrganizationResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListHandshakesForOrganizationResponse.from_boto_dict(
            response
        )
    ...
    def list_organizational_units_for_parent(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListOrganizationalUnitsForParentResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListOrganizationalUnitsForParentResponse.from_boto_dict(
            response
        )
    ...
    def list_parents(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListParentsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListParentsResponse.from_boto_dict(response)

    def list_policies(
        self,
        _request: shapes.ListPoliciesRequest = None,
        *,
        filter: shapes.PolicyType,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
    ...
    def list_policies_for_target(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPoliciesForTargetResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListPoliciesForTargetResponse.from_boto_dict(response)
    ...
    def list_roots(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListRootsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListRootsResponse.from_boto_dict(response)
    ...
    def list_targets_for_policy(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTargetsForPolicyResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def move_account(
        ...
        *,
        ...
        response = self._boto_client.move_account(**_request.to_boto_dict())
    ...
    def update_organizational_unit(
        ...
        *,
        ...
        return shapes.UpdateOrganizationalUnitResponse.from_boto_dict(response)
    ...
    def update_policy(
        ...
        *,
        ...
        response = self._boto_client.update_policy(**_request.to_boto_dict())

        return shapes.UpdatePolicyResponse.from_boto_dict(response)
