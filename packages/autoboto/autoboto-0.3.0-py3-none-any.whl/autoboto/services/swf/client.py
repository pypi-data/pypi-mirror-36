...
class Client(ClientBase):
    ...
    def get_workflow_execution_history(
        ...
        **Access Control**
        ...
        result = shapes.History.from_boto_dict(first_page)
    ...
    def list_activity_types(
        ...
        **Access Control**
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ActivityTypeInfos.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_closed_workflow_executions(
        ...
        **Access Control**
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.WorkflowExecutionInfos.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_domains(
        ...
        **Access Control**
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DomainInfos.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_workflow_types(
        ...
        **Access Control**
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.WorkflowTypeInfos.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def poll_for_decision_task(
        ...
        **Access Control**
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DecisionTask.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
