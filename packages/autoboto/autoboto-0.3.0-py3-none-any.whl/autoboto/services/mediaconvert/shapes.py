...
class AacSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                ...
                TypeInfo(AacAudioDescriptionBroadcasterMix),
            ),
            (
                "bitrate",
                "Bitrate",
            ...
            (
                "codec_profile",
                "CodecProfile",
                TypeInfo(AacCodecProfile),
            ),
            (
                "coding_mode",
                "CodingMode",
                TypeInfo(AacCodingMode),
            ),
            (
                "rate_control_mode",
                "RateControlMode",
                TypeInfo(AacRateControlMode),
            ),
            (
                "raw_format",
                "RawFormat",
                TypeInfo(AacRawFormat),
            ),
            (
                "sample_rate",
                "SampleRate",
            ...
            (
                "specification",
                "Specification",
                TypeInfo(AacSpecification),
            ),
            (
                "vbr_quality",
                "VbrQuality",
                TypeInfo(AacVbrQuality),
            ),
        ]
    ...
    audio_description_broadcaster_mix: "AacAudioDescriptionBroadcasterMix" = dataclasses.field(
    ...
    # AAC Profile.
    codec_profile: "AacCodecProfile" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    coding_mode: "AacCodingMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Rate Control Mode.
    rate_control_mode: "AacRateControlMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    raw_format: "AacRawFormat" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # Stream containers.
    specification: "AacSpecification" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # VBR Quality Level - Only used if rate_control_mode is VBR.
    vbr_quality: "AacVbrQuality" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["AacSettings", None, None]:
...
class Ac3Settings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "bitstream_mode",
                "BitstreamMode",
                TypeInfo(Ac3BitstreamMode),
            ),
            (
                "coding_mode",
                "CodingMode",
                TypeInfo(Ac3CodingMode),
            ),
            (
                "dialnorm",
                "Dialnorm",
            ...
            (
                ...
                TypeInfo(Ac3DynamicRangeCompressionProfile),
            ),
            (
                "lfe_filter",
                "LfeFilter",
                TypeInfo(Ac3LfeFilter),
            ),
            (
                "metadata_control",
                "MetadataControl",
                TypeInfo(Ac3MetadataControl),
            ),
            (
                "sample_rate",
                "SampleRate",
    ...
    bitstream_mode: "Ac3BitstreamMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Dolby Digital coding mode. Determines number of channels.
    coding_mode: "Ac3CodingMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    dynamic_range_compression_profile: "Ac3DynamicRangeCompressionProfile" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Applies a 120Hz lowpass filter to the LFE channel prior to encoding. Only
    # valid with 3_2_LFE coding mode.
    lfe_filter: "Ac3LfeFilter" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # be used.
    metadata_control: "Ac3MetadataControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["Ac3Settings", None, None]:
        yield from super().paginate()
...
class AiffSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AiffSettings", None, None]:
        yield from super().paginate()
...
class AncillarySourceSettings(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AncillarySourceSettings", None, None]:
        yield from super().paginate()
...
class AudioCodecSettings(ShapeBase):
    ...
    aac_settings: "AacSettings" = dataclasses.field(default_factory=dict, )

    # Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to
    # the value AC3.
    ac3_settings: "Ac3Settings" = dataclasses.field(default_factory=dict, )

    # Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to
    # the value AIFF.
    aiff_settings: "AiffSettings" = dataclasses.field(default_factory=dict, )

    # Type of Audio codec.
    codec: "AudioCodec" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to
    # the value EAC3.
    eac3_settings: "Eac3Settings" = dataclasses.field(default_factory=dict, )

    # Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to
    # the value MP2.
    mp2_settings: "Mp2Settings" = dataclasses.field(default_factory=dict, )

    # Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to
    # the value WAV.
    wav_settings: "WavSettings" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["AudioCodecSettings", None, None]:
        yield from super().paginate()
...
class AudioDescription(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "language_code",
                "LanguageCode",
                TypeInfo(LanguageCode),
            ),
            (
                "language_code_control",
                "LanguageCodeControl",
                TypeInfo(AudioLanguageCodeControl),
            ),
            (
                "remix_settings",
                "RemixSettings",
    ...
    audio_type_control: "AudioTypeControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # the input.
    language_code_control: "AudioLanguageCodeControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Advanced audio remixing settings.
    remix_settings: "RemixSettings" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["AudioDescription", None, None]:
        yield from super().paginate()
...
class AudioNormalizationSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "algorithm",
                "Algorithm",
                TypeInfo(AudioNormalizationAlgorithm),
            ),
            (
                "algorithm_control",
                "AlgorithmControl",
                TypeInfo(AudioNormalizationAlgorithmControl),
            ),
            (
            ...
            (
                "loudness_logging",
                "LoudnessLogging",
                TypeInfo(AudioNormalizationLoudnessLogging),
            ),
            (
                "peak_calculation",
                "PeakCalculation",
                TypeInfo(AudioNormalizationPeakCalculation),
            ),
            (
                "target_lkfs",
                "TargetLkfs",
    ...
    # Audio normalization algorithm to use. 1770-1 conforms to the CALM Act
    # specification, 1770-2 conforms to the EBU R-128 specification.
    algorithm: "AudioNormalizationAlgorithm" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When enabled the output audio is corrected using the chosen algorithm. If
    # disabled, the audio will be measured but not adjusted.
    algorithm_control: "AudioNormalizationAlgorithmControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # If set to LOG, log each output's audio track loudness to a CSV file.
    loudness_logging: "AudioNormalizationLoudnessLogging" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # If set to TRUE_PEAK, calculate and log the TruePeak for each output's audio
    # track loudness.
    peak_calculation: "AudioNormalizationPeakCalculation" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["AudioNormalizationSettings", None, None]:
        yield from super().paginate()
...
class AudioSelector(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "default_selection",
                "DefaultSelection",
                TypeInfo(AudioDefaultSelection),
            ),
            (
    ...
    # audio.
    default_selection: "AudioDefaultSelection" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # 0x101).
    pids: typing.List[int] = dataclasses.field(default_factory=list, )
    ...
    selector_type: "AudioSelectorType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    tracks: typing.List[int] = dataclasses.field(default_factory=list, )

    def paginate(self, ) -> typing.Generator["AudioSelector", None, None]:
        yield from super().paginate()
...
class AudioSelectorGroup(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AudioSelectorGroup", None, None]:
        yield from super().paginate()
...
class AvailBlanking(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AvailBlanking", None, None]:
        yield from super().paginate()
...
class BurninDestinationSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "alignment",
                "Alignment",
                TypeInfo(BurninSubtitleAlignment),
            ),
            (
                "background_color",
                "BackgroundColor",
                TypeInfo(BurninSubtitleBackgroundColor),
            ),
            (
                "background_opacity",
                "BackgroundOpacity",
            ...
            (
                "font_color",
                "FontColor",
                TypeInfo(BurninSubtitleFontColor),
            ),
            (
                "font_opacity",
                "FontOpacity",
            ...
            (
                "outline_color",
                "OutlineColor",
                TypeInfo(BurninSubtitleOutlineColor),
            ),
            (
                "outline_size",
                "OutlineSize",
            ...
            (
                "shadow_color",
                "ShadowColor",
                TypeInfo(BurninSubtitleShadowColor),
            ),
            (
                "shadow_opacity",
                "ShadowOpacity",
            ...
            (
                "teletext_spacing",
                "TeletextSpacing",
                TypeInfo(BurninSubtitleTeletextSpacing),
            ),
            (
                "x_position",
                "XPosition",
    ...
    # must match.
    alignment: "BurninSubtitleAlignment" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Specifies the color of the rectangle behind the captions. All burn-in and
    # DVB-Sub font settings must match.
    background_color: "BurninSubtitleBackgroundColor" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # DVB-Sub font settings must match.
    font_color: "BurninSubtitleFontColor" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # pre-defined by the caption stream. All burn-in and DVB-Sub font settings
    # must match.
    outline_color: "BurninSubtitleOutlineColor" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # DVB-Sub font settings must match.
    shadow_color: "BurninSubtitleShadowColor" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # closed caption.
    teletext_spacing: "BurninSubtitleTeletextSpacing" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["BurninDestinationSettings", None, None]:
        yield from super().paginate()
...
class CancelJobRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CancelJobRequest", None, None]:
        yield from super().paginate()
...
class CancelJobResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CancelJobResponse", None, None]:
        yield from super().paginate()
...
class CaptionDescription(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CaptionDescription", None, None]:
        yield from super().paginate()
...
class CaptionDescriptionPreset(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CaptionDescriptionPreset", None, None]:
        yield from super().paginate()
...
class CaptionDestinationSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "destination_type",
                "DestinationType",
                TypeInfo(CaptionDestinationType),
            ),
            (
    ...
    destination_type: "CaptionDestinationType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["CaptionDestinationSettings", None, None]:
        yield from super().paginate()
...
class CaptionSelector(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CaptionSelector", None, None]:
        yield from super().paginate()
...
class CaptionSourceSettings(ShapeBase):
    ...
    source_type: "CaptionSourceType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["CaptionSourceSettings", None, None]:
        yield from super().paginate()
...
class ChannelMapping(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ChannelMapping", None, None]:
        yield from super().paginate()
...
class CmafEncryptionSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "encryption_method",
                "EncryptionMethod",
                TypeInfo(CmafEncryptionType),
            ),
            (
                "initialization_vector_in_manifest",
                "InitializationVectorInManifest",
                TypeInfo(CmafInitializationVectorInManifest),
            ),
            (
                "static_key_provider",
                "StaticKeyProvider",
    ...
    # encryption.
    encryption_method: "CmafEncryptionType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # manifest.
    initialization_vector_in_manifest: "CmafInitializationVectorInManifest" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    type: "CmafKeyProviderType" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self,
                ) -> typing.Generator["CmafEncryptionSettings", None, None]:
        yield from super().paginate()
...
class CmafGroupSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "client_cache",
                "ClientCache",
                TypeInfo(CmafClientCache),
            ),
            (
                "codec_specification",
                "CodecSpecification",
                TypeInfo(CmafCodecSpecification),
            ),
            (
                "destination",
                "Destination",
            ...
            (
                ...
                "ManifestCompression",
                TypeInfo(CmafManifestCompression),
            ),
            (
                "manifest_duration_format",
                "ManifestDurationFormat",
                TypeInfo(CmafManifestDurationFormat),
            ),
            (
                "min_buffer_time",
                "MinBufferTime",
            ...
            (
                ...
                "StreamInfResolution",
                TypeInfo(CmafStreamInfResolution),
            ),
            (
                "write_dash_manifest",
                "WriteDashManifest",
                TypeInfo(CmafWriteDASHManifest),
            ),
            (
                "write_hls_manifest",
                "WriteHlsManifest",
                TypeInfo(CmafWriteHLSManifest),
            ),
        ]
    ...
    client_cache: "CmafClientCache" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Specification to use (RFC-6381 or the default RFC-4281) during m3u8
    # playlist generation.
    codec_specification: "CmafCodecSpecification" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    manifest_compression: "CmafManifestCompression" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Indicates whether the output manifest should use floating point values for
    # segment duration.
    manifest_duration_format: "CmafManifestDurationFormat" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    segment_control: "CmafSegmentControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # of variant manifest.
    stream_inf_resolution: "CmafStreamInfResolution" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When set to ENABLED, a DASH MPD manifest will be generated for this output.
    write_dash_manifest: "CmafWriteDASHManifest" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When set to ENABLED, an Apple HLS manifest will be generated for this
    # output.
    write_hls_manifest: "CmafWriteHLSManifest" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["CmafGroupSettings", None, None]:
        yield from super().paginate()
...
class ColorCorrector(ShapeBase):
    ...
    color_space_conversion: "ColorSpaceConversion" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    hdr10_metadata: "Hdr10Metadata" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["ColorCorrector", None, None]:
        yield from super().paginate()
...
class ContainerSettings(ShapeBase):
    ...
    container: "ContainerType" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Settings for F4v container
    f4v_settings: "F4vSettings" = dataclasses.field(default_factory=dict, )

    # Settings for M2TS Container.
    m2ts_settings: "M2tsSettings" = dataclasses.field(default_factory=dict, )

    # Settings for TS segments in HLS
    m3u8_settings: "M3u8Settings" = dataclasses.field(default_factory=dict, )

    # Settings for MOV Container.
    mov_settings: "MovSettings" = dataclasses.field(default_factory=dict, )

    # Settings for MP4 Container
    mp4_settings: "Mp4Settings" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["ContainerSettings", None, None]:
        yield from super().paginate()
...
class CreateJobRequest(ShapeBase):
    ...
    settings: "JobSettings" = dataclasses.field(default_factory=dict, )
    ...
    # unsorted.
    billing_tags_source: "BillingTagsSource" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["CreateJobRequest", None, None]:
        yield from super().paginate()
...
class CreateJobResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateJobResponse", None, None]:
        yield from super().paginate()
...
class CreateJobTemplateRequest(ShapeBase):
    ...
    settings: "JobTemplateSettings" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self,
                ) -> typing.Generator["CreateJobTemplateRequest", None, None]:
        yield from super().paginate()
...
class CreateJobTemplateResponse(OutputShapeBase):
    ...
    job_template: "JobTemplate" = dataclasses.field(default_factory=dict, )

    def paginate(self,
                ) -> typing.Generator["CreateJobTemplateResponse", None, None]:
        yield from super().paginate()
...
class CreatePresetRequest(ShapeBase):
    ...
    # Settings for preset
    settings: "PresetSettings" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["CreatePresetRequest", None, None]:
        yield from super().paginate()
...
class CreatePresetResponse(OutputShapeBase):
    ...
    preset: "Preset" = dataclasses.field(default_factory=dict, )

    def paginate(self,
                ) -> typing.Generator["CreatePresetResponse", None, None]:
        yield from super().paginate()
...
class CreateQueueRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateQueueRequest", None, None]:
        yield from super().paginate()
...
class CreateQueueResponse(OutputShapeBase):
    ...
    queue: "Queue" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["CreateQueueResponse", None, None]:
        yield from super().paginate()
...
class DashIsoEncryptionSettings(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DashIsoEncryptionSettings", None, None]:
        yield from super().paginate()
...
class DashIsoGroupSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "hbbtv_compliance",
                "HbbtvCompliance",
                TypeInfo(DashIsoHbbtvCompliance),
            ),
            (
                "min_buffer_time",
                "MinBufferTime",
            ...
            (
                "segment_control",
                "SegmentControl",
                TypeInfo(DashIsoSegmentControl),
            ),
            (
                "segment_length",
                "SegmentLength",
            ...
            (
                ...
                TypeInfo(DashIsoWriteSegmentTimelineInRepresentation),
            ),
        ]
    ...
    hbbtv_compliance: "DashIsoHbbtvCompliance" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # internally segmented using the Fragment Length and Segment Length. When set
    # to SEGMENTED_FILES, separate segment files will be created.
    segment_control: "DashIsoSegmentControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    write_segment_timeline_in_representation: "DashIsoWriteSegmentTimelineInRepresentation" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self,
                ) -> typing.Generator["DashIsoGroupSettings", None, None]:
        yield from super().paginate()
...
class Deinterlacer(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "algorithm",
                "Algorithm",
                TypeInfo(DeinterlaceAlgorithm),
            ),
            (
                "control",
                "Control",
                TypeInfo(DeinterlacerControl),
            ),
            (
                "mode",
                "Mode",
                TypeInfo(DeinterlacerMode),
            ),
        ]
    ...
    # frame.
    algorithm: "DeinterlaceAlgorithm" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    control: "DeinterlacerControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    mode: "DeinterlacerMode" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["Deinterlacer", None, None]:
        yield from super().paginate()
...
class DeleteJobTemplateRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteJobTemplateRequest", None, None]:
        yield from super().paginate()
...
class DeleteJobTemplateResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteJobTemplateResponse", None, None]:
        yield from super().paginate()
...
class DeletePresetRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeletePresetRequest", None, None]:
        yield from super().paginate()
...
class DeletePresetResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeletePresetResponse", None, None]:
        yield from super().paginate()
...
class DeleteQueueRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteQueueRequest", None, None]:
        yield from super().paginate()
...
class DeleteQueueResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteQueueResponse", None, None]:
        yield from super().paginate()
...
class DescribeEndpointsRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "mode",
                "Mode",
                TypeInfo(DescribeEndpointsMode),
            ),
            (
                "next_token",
                "NextToken",
    ...
    mode: "DescribeEndpointsMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class DvbNitSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DvbNitSettings", None, None]:
        yield from super().paginate()
...
class DvbSdtSettings(ShapeBase):
    ...
    # SDT information.
    output_sdt: "OutputSdt" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["DvbSdtSettings", None, None]:
        yield from super().paginate()
...
class DvbSubDestinationSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "alignment",
                "Alignment",
                TypeInfo(DvbSubtitleAlignment),
            ),
            (
                "background_color",
                "BackgroundColor",
                TypeInfo(DvbSubtitleBackgroundColor),
            ),
            (
                "background_opacity",
                "BackgroundOpacity",
            ...
            (
                "outline_color",
                "OutlineColor",
                TypeInfo(DvbSubtitleOutlineColor),
            ),
            (
                "outline_size",
                "OutlineSize",
            ...
            (
                "shadow_color",
                "ShadowColor",
                TypeInfo(DvbSubtitleShadowColor),
            ),
            (
                "shadow_opacity",
                "ShadowOpacity",
            ...
            (
                "teletext_spacing",
                "TeletextSpacing",
                TypeInfo(DvbSubtitleTeletextSpacing),
            ),
            (
                "x_position",
                "XPosition",
    ...
    # pre-defined by the caption stream. All burn-in and DVB-Sub font settings
    # must match.
    alignment: "DvbSubtitleAlignment" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Specifies the color of the rectangle behind the captions. All burn-in and
    # DVB-Sub font settings must match.
    background_color: "DvbSubtitleBackgroundColor" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # settings are already pre-defined by the caption stream. All burn-in and
    # DVB-Sub font settings must match.
    font_color: "DvbSubtitleFontColor" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # pre-defined by the caption stream. All burn-in and DVB-Sub font settings
    # must match.
    outline_color: "DvbSubtitleOutlineColor" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Specifies the color of the shadow cast by the captions. All burn-in and
    # DVB-Sub font settings must match.
    shadow_color: "DvbSubtitleShadowColor" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Choose proportional to make the text easier to read if the captions are
    # closed caption.
    teletext_spacing: "DvbSubtitleTeletextSpacing" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["DvbSubDestinationSettings", None, None]:
        yield from super().paginate()
...
class DvbSubSourceSettings(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DvbSubSourceSettings", None, None]:
        yield from super().paginate()
...
class DvbTdtSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DvbTdtSettings", None, None]:
        yield from super().paginate()
...
class Eac3Settings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "attenuation_control",
                "AttenuationControl",
                TypeInfo(Eac3AttenuationControl),
            ),
            (
                "bitrate",
                "Bitrate",
            ...
            (
                "bitstream_mode",
                "BitstreamMode",
                TypeInfo(Eac3BitstreamMode),
            ),
            (
                "coding_mode",
                "CodingMode",
                TypeInfo(Eac3CodingMode),
            ),
            (
                "dc_filter",
                "DcFilter",
                TypeInfo(Eac3DcFilter),
            ),
            (
                "dialnorm",
                "Dialnorm",
            ...
            (
                ...
                TypeInfo(Eac3DynamicRangeCompressionLine),
            ),
            (
                "dynamic_range_compression_rf",
                "DynamicRangeCompressionRf",
                TypeInfo(Eac3DynamicRangeCompressionRf),
            ),
            (
                "lfe_control",
                "LfeControl",
                TypeInfo(Eac3LfeControl),
            ),
            (
                "lfe_filter",
                "LfeFilter",
                TypeInfo(Eac3LfeFilter),
            ),
            (
            ...
            (
                "metadata_control",
                "MetadataControl",
                TypeInfo(Eac3MetadataControl),
            ),
            (
                "passthrough_control",
                "PassthroughControl",
                TypeInfo(Eac3PassthroughControl),
            ),
            (
                "phase_control",
                "PhaseControl",
                TypeInfo(Eac3PhaseControl),
            ),
            (
                "sample_rate",
                "SampleRate",
            ...
            (
                "stereo_downmix",
                "StereoDownmix",
                TypeInfo(Eac3StereoDownmix),
            ),
            (
                "surround_ex_mode",
                "SurroundExMode",
                TypeInfo(Eac3SurroundExMode),
            ),
            (
                "surround_mode",
                "SurroundMode",
                TypeInfo(Eac3SurroundMode),
            ),
        ]

    # If set to ATTENUATE_3_DB, applies a 3 dB attenuation to the surround
    # channels. Only used for 3/2 coding mode.
    attenuation_control: "Eac3AttenuationControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    bitstream_mode: "Eac3BitstreamMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Dolby Digital Plus coding mode. Determines number of channels.
    coding_mode: "Eac3CodingMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Activates a DC highpass filter for all input channels.
    dc_filter: "Eac3DcFilter" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # for a signal.
    dynamic_range_compression_line: "Eac3DynamicRangeCompressionLine" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Enables Heavy Dynamic Range Compression, ensures that the instantaneous
    # signal peaks do not exceed specified levels.
    dynamic_range_compression_rf: "Eac3DynamicRangeCompressionRf" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When encoding 3/2 audio, controls whether the LFE channel is enabled
    lfe_control: "Eac3LfeControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Applies a 120Hz lowpass filter to the LFE channel prior to encoding. Only
    # valid with 3_2_LFE coding mode.
    lfe_filter: "Eac3LfeFilter" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # supplied from one of these streams, then the static metadata settings will
    # be used.
    metadata_control: "Eac3MetadataControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # encoding.
    passthrough_control: "Eac3PassthroughControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Controls the amount of phase-shift applied to the surround channels. Only
    # used for 3/2 coding mode.
    phase_control: "Eac3PhaseControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    stereo_downmix: "Eac3StereoDownmix" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    surround_ex_mode: "Eac3SurroundExMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When encoding 2/0 audio, sets whether Dolby Surround is matrix encoded into
    # the two channels.
    surround_mode: "Eac3SurroundMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["Eac3Settings", None, None]:
        yield from super().paginate()
...
class EmbeddedSourceSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "convert608_to708",
                "Convert608To708",
                TypeInfo(EmbeddedConvert608To708),
            ),
            (
    ...
    convert608_to708: "EmbeddedConvert608To708" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["EmbeddedSourceSettings", None, None]:
        yield from super().paginate()
...
class ExceptionBody(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ExceptionBody", None, None]:
        yield from super().paginate()
...
class F4vSettings(ShapeBase):
    ...
    moov_placement: "F4vMoovPlacement" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["F4vSettings", None, None]:
        yield from super().paginate()
...
class FileGroupSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["FileGroupSettings", None, None]:
        yield from super().paginate()
...
class FileSourceSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "convert608_to708",
                "Convert608To708",
                TypeInfo(FileSourceConvert608To708),
            ),
            (
                "source_file",
                "SourceFile",
    ...
    # compatibility bytes" fields of the 708 wrapper as well as translated into
    # 708. 708 data present in the source content will be discarded.
    convert608_to708: "FileSourceConvert608To708" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["FileSourceSettings", None, None]:
        yield from super().paginate()
...
class ForbiddenException(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ForbiddenException", None, None]:
        yield from super().paginate()
...
class FrameCaptureSettings(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["FrameCaptureSettings", None, None]:
        yield from super().paginate()
...
class GetJobRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetJobRequest", None, None]:
        yield from super().paginate()
...
class GetJobResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetJobResponse", None, None]:
        yield from super().paginate()
...
class GetJobTemplateRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetJobTemplateRequest", None, None]:
        yield from super().paginate()
...
class GetJobTemplateResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetJobTemplateResponse", None, None]:
        yield from super().paginate()
...
class GetPresetRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetPresetRequest", None, None]:
        yield from super().paginate()
...
class GetPresetResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetPresetResponse", None, None]:
        yield from super().paginate()
...
class GetQueueRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetQueueRequest", None, None]:
        yield from super().paginate()
...
class GetQueueResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetQueueResponse", None, None]:
        yield from super().paginate()
...
class H264QvbrSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["H264QvbrSettings", None, None]:
        yield from super().paginate()
...
class H264Settings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                ...
                TypeInfo(H264AdaptiveQuantization),
            ),
            (
                "bitrate",
                "Bitrate",
            ...
            (
                "codec_level",
                "CodecLevel",
                TypeInfo(H264CodecLevel),
            ),
            (
                "codec_profile",
                "CodecProfile",
                TypeInfo(H264CodecProfile),
            ),
            (
                "dynamic_sub_gop",
                "DynamicSubGop",
                TypeInfo(H264DynamicSubGop),
            ),
            (
                "entropy_encoding",
                "EntropyEncoding",
                TypeInfo(H264EntropyEncoding),
            ),
            (
                "field_encoding",
                "FieldEncoding",
                TypeInfo(H264FieldEncoding),
            ),
            (
                "flicker_adaptive_quantization",
                "FlickerAdaptiveQuantization",
                TypeInfo(H264FlickerAdaptiveQuantization),
            ),
            (
                "framerate_control",
                "FramerateControl",
                TypeInfo(H264FramerateControl),
            ),
            (
                "framerate_conversion_algorithm",
                "FramerateConversionAlgorithm",
                TypeInfo(H264FramerateConversionAlgorithm),
            ),
            (
                "framerate_denominator",
                "FramerateDenominator",
            ...
            (
                ...
                "QualityTuningLevel",
                TypeInfo(H264QualityTuningLevel),
            ),
            (
                "qvbr_settings",
                "QvbrSettings",
            ...
            (
                "rate_control_mode",
                "RateControlMode",
                TypeInfo(H264RateControlMode),
            ),
            (
                "repeat_pps",
                "RepeatPps",
                TypeInfo(H264RepeatPps),
            ),
            (
                "scene_change_detect",
                "SceneChangeDetect",
                TypeInfo(H264SceneChangeDetect),
            ),
            (
                "slices",
                "Slices",
            ...
            (
                ...
                TypeInfo(H264SpatialAdaptiveQuantization),
            ),
            (
                "syntax",
                "Syntax",
            ...
            (
                "telecine",
                "Telecine",
                TypeInfo(H264Telecine),
            ),
            (
                "temporal_adaptive_quantization",
                "TemporalAdaptiveQuantization",
                TypeInfo(H264TemporalAdaptiveQuantization),
            ),
            (
                "unregistered_sei_timecode",
                "UnregisteredSeiTimecode",
                TypeInfo(H264UnregisteredSeiTimecode),
            ),
        ]

    # Adaptive quantization. Allows intra-frame quantizers to vary to improve
    # visual quality.
    adaptive_quantization: "H264AdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # H.264 Level.
    codec_level: "H264CodecLevel" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # H.264 Profile. High 4:2:2 and 10-bit profiles are only available with the
    # AVC-I License.
    codec_profile: "H264CodecProfile" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    dynamic_sub_gop: "H264DynamicSubGop" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Entropy encoding mode. Use CABAC (must be in Main or High profile) or
    # CAVLC.
    entropy_encoding: "H264EntropyEncoding" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Choosing FORCE_FIELD disables PAFF encoding for interlaced outputs.
    field_encoding: "H264FieldEncoding" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Adjust quantization within each frame to reduce flicker or 'pop' on
    # I-frames.
    flicker_adaptive_quantization: "H264FlickerAdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # FramerateDenominator.
    framerate_control: "H264FramerateControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When set to INTERPOLATE, produces smoother motion during framerate
    # conversion.
    framerate_conversion_algorithm: "H264FramerateConversionAlgorithm" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # 1.
    gop_b_reference: "H264GopBReference" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # time.
    gop_size_units: "H264GopSizeUnits" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    interlace_mode: "H264InterlaceMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    par_control: "H264ParControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # video encoding.
    quality_tuning_level: "H264QualityTuningLevel" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    rate_control_mode: "H264RateControlMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Places a PPS header on each encoded picture, even if repeated.
    repeat_pps: "H264RepeatPps" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Scene change detection (inserts I-frames on scene changes).
    scene_change_detect: "H264SceneChangeDetect" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    slow_pal: "H264SlowPal" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # complexity.
    spatial_adaptive_quantization: "H264SpatialAdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Produces a bitstream compliant with SMPTE RP-2027.
    syntax: "H264Syntax" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    telecine: "H264Telecine" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Adjust quantization within each frame based on temporal variation of
    # content complexity.
    temporal_adaptive_quantization: "H264TemporalAdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Inserts timecode for each frame as 4 bytes of an unregistered SEI message.
    unregistered_sei_timecode: "H264UnregisteredSeiTimecode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["H264Settings", None, None]:
        yield from super().paginate()
...
class H265QvbrSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["H265QvbrSettings", None, None]:
        yield from super().paginate()
...
class H265Settings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "adaptive_quantization",
                "AdaptiveQuantization",
                TypeInfo(H265AdaptiveQuantization),
            ),
            (
                "alternate_transfer_function_sei",
                "AlternateTransferFunctionSei",
                TypeInfo(H265AlternateTransferFunctionSei),
            ),
            (
                "bitrate",
                "Bitrate",
            ...
            (
                "codec_level",
                "CodecLevel",
                TypeInfo(H265CodecLevel),
            ),
            (
                "codec_profile",
                "CodecProfile",
                TypeInfo(H265CodecProfile),
            ),
            (
                "dynamic_sub_gop",
                "DynamicSubGop",
                TypeInfo(H265DynamicSubGop),
            ),
            (
                "flicker_adaptive_quantization",
                "FlickerAdaptiveQuantization",
                TypeInfo(H265FlickerAdaptiveQuantization),
            ),
            (
                "framerate_control",
                "FramerateControl",
                TypeInfo(H265FramerateControl),
            ),
            (
                "framerate_conversion_algorithm",
                "FramerateConversionAlgorithm",
                TypeInfo(H265FramerateConversionAlgorithm),
            ),
            (
                "framerate_denominator",
                "FramerateDenominator",
            ...
            (
                "quality_tuning_level",
                "QualityTuningLevel",
                TypeInfo(H265QualityTuningLevel),
            ),
            (
                "qvbr_settings",
                "QvbrSettings",
            ...
            (
                "rate_control_mode",
                "RateControlMode",
                TypeInfo(H265RateControlMode),
            ),
            (
                "sample_adaptive_offset_filter_mode",
                "SampleAdaptiveOffsetFilterMode",
                TypeInfo(H265SampleAdaptiveOffsetFilterMode),
            ),
            (
                "scene_change_detect",
                "SceneChangeDetect",
                TypeInfo(H265SceneChangeDetect),
            ),
            (
                "slices",
                "Slices",
            ...
            (
                "slow_pal",
                "SlowPal",
                TypeInfo(H265SlowPal),
            ),
            (
                "spatial_adaptive_quantization",
                "SpatialAdaptiveQuantization",
                TypeInfo(H265SpatialAdaptiveQuantization),
            ),
            (
                "telecine",
                "Telecine",
                TypeInfo(H265Telecine),
            ),
            (
                "temporal_adaptive_quantization",
                "TemporalAdaptiveQuantization",
                TypeInfo(H265TemporalAdaptiveQuantization),
            ),
            (
                "temporal_ids",
                "TemporalIds",
                TypeInfo(H265TemporalIds),
            ),
            (
                "tiles",
                "Tiles",
            ...
            (
                "unregistered_sei_timecode",
                "UnregisteredSeiTimecode",
                TypeInfo(H265UnregisteredSeiTimecode),
            ),
            (
                "write_mp4_packaging_type",
                "WriteMp4PackagingType",
                TypeInfo(H265WriteMp4PackagingType),
            ),
        ]

    # Adaptive quantization. Allows intra-frame quantizers to vary to improve
    # visual quality.
    adaptive_quantization: "H265AdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    alternate_transfer_function_sei: "H265AlternateTransferFunctionSei" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # H.265 Level.
    codec_level: "H265CodecLevel" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # HEVC 4:2:2 License.
    codec_profile: "H265CodecProfile" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # is limited by the value you provide for the setting B frames between
    # reference frames (numberBFramesBetweenReferenceFrames).
    dynamic_sub_gop: "H265DynamicSubGop" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Adjust quantization within each frame to reduce flicker or 'pop' on
    # I-frames.
    flicker_adaptive_quantization: "H265FlickerAdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # to use the framerate you specify in the settings FramerateNumerator and
    # FramerateDenominator.
    framerate_control: "H265FramerateControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When set to INTERPOLATE, produces smoother motion during framerate
    # conversion.
    framerate_conversion_algorithm: "H265FramerateConversionAlgorithm" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # If enable, use reference B frames for GOP structures that have B frames >
    # 1.
    gop_b_reference: "H265GopBReference" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # seconds the system will convert the GOP Size into a frame count at run
    # time.
    gop_size_units: "H265GopSizeUnits" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # you chose.
    interlace_mode: "H265InterlaceMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # pixel aspect ratio from the input. Using the console, do this by choosing
    # Follow source for Pixel aspect ratio.
    par_control: "H265ParControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # use fast single-pass, high-quality singlepass, or high-quality multipass
    # video encoding.
    quality_tuning_level: "H265QualityTuningLevel" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Use this setting to specify whether this output has a variable bitrate
    # (VBR), constant bitrate (CBR) or quality-defined variable bitrate (QVBR).
    rate_control_mode: "H265RateControlMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Specify Sample Adaptive Offset (SAO) filter strength. Adaptive mode
    # dynamically selects best strength based on content
    sample_adaptive_offset_filter_mode: "H265SampleAdaptiveOffsetFilterMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Scene change detection (inserts I-frames on scene changes).
    scene_change_detect: "H265SceneChangeDetect" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Enables Slow PAL rate conversion. 23.976fps and 24fps input is relabeled as
    # 25fps, and audio is sped up correspondingly.
    slow_pal: "H265SlowPal" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Adjust quantization within each frame based on spatial variation of content
    # complexity.
    spatial_adaptive_quantization: "H265SpatialAdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Hard: produces 29.97i output from 23.976 input. - Soft: produces 23.976;
    # the player converts this output to 29.97i.
    telecine: "H265Telecine" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Adjust quantization within each frame based on temporal variation of
    # content complexity.
    temporal_adaptive_quantization: "H265TemporalAdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # output.
    temporal_ids: "H265TemporalIds" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Enable use of tiles, allowing horizontal as well as vertical subdivision of
    # the encoded pictures.
    tiles: "H265Tiles" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Inserts timecode for each frame as 4 bytes of an unregistered SEI message.
    unregistered_sei_timecode: "H265UnregisteredSeiTimecode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    write_mp4_packaging_type: "H265WriteMp4PackagingType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["H265Settings", None, None]:
        yield from super().paginate()
...
class Hdr10Metadata(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Hdr10Metadata", None, None]:
        yield from super().paginate()
...
class HlsCaptionLanguageMapping(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["HlsCaptionLanguageMapping", None, None]:
        yield from super().paginate()
...
class HlsEncryptionSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "encryption_method",
                "EncryptionMethod",
                TypeInfo(HlsEncryptionType),
            ),
            (
                "initialization_vector_in_manifest",
                "InitializationVectorInManifest",
                TypeInfo(HlsInitializationVectorInManifest),
            ),
            (
                "speke_key_provider",
                "SpekeKeyProvider",
    ...
    # disable. Selecting 'Disabled' in the web interface also disables
    # encryption.
    encryption_method: "HlsEncryptionType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # listed in the manifest. Otherwise Initialization Vector is not in the
    # manifest.
    initialization_vector_in_manifest: "HlsInitializationVectorInManifest" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Indicates which type of key provider is used for encryption.
    type: "HlsKeyProviderType" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self,
                ) -> typing.Generator["HlsEncryptionSettings", None, None]:
        yield from super().paginate()
...
class HlsGroupSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "ad_markers",
                "AdMarkers",
                TypeInfo(typing.List[HlsAdMarkers]),
            ),
            (
                "base_url",
                "BaseUrl",
            ...
            (
                ...
                TypeInfo(HlsCaptionLanguageSetting),
            ),
            (
                "client_cache",
                "ClientCache",
                TypeInfo(HlsClientCache),
            ),
            (
                "codec_specification",
                "CodecSpecification",
                TypeInfo(HlsCodecSpecification),
            ),
            (
                "destination",
                "Destination",
            ...
            (
                "directory_structure",
                "DirectoryStructure",
                TypeInfo(HlsDirectoryStructure),
            ),
            (
                "encryption",
                "Encryption",
            ...
            (
                "manifest_compression",
                "ManifestCompression",
                TypeInfo(HlsManifestCompression),
            ),
            (
                "manifest_duration_format",
                "ManifestDurationFormat",
                TypeInfo(HlsManifestDurationFormat),
            ),
            (
                "min_final_segment_length",
                "MinFinalSegmentLength",
            ...
            (
                "output_selection",
                "OutputSelection",
                TypeInfo(HlsOutputSelection),
            ),
            (
                "program_date_time",
                "ProgramDateTime",
                TypeInfo(HlsProgramDateTime),
            ),
            (
            ...
            (
                "stream_inf_resolution",
                "StreamInfResolution",
                TypeInfo(HlsStreamInfResolution),
            ),
            (
                "timed_metadata_id3_frame",
                "TimedMetadataId3Frame",
                TypeInfo(HlsTimedMetadataId3Frame),
            ),
            (
    ...
    ad_markers: typing.List["HlsAdMarkers"] = dataclasses.field(
        default_factory=list,
    )
    ...
    caption_language_setting: "HlsCaptionLanguageSetting" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When set to ENABLED, sets #EXT-X-ALLOW-CACHE:no tag, which prevents client
    # from saving media segments for later replay.
    client_cache: "HlsClientCache" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Specification to use (RFC-6381 or the default RFC-4281) during m3u8
    # playlist generation.
    codec_specification: "HlsCodecSpecification" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Indicates whether segments should be placed in subdirectories.
    directory_structure: "HlsDirectoryStructure" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # When set to GZIP, compresses HLS playlist.
    manifest_compression: "HlsManifestCompression" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Indicates whether the output manifest should use floating point values for
    # segment duration.
    manifest_duration_format: "HlsManifestDurationFormat" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # output group.
    output_selection: "HlsOutputSelection" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # timestamp_offset.
    program_date_time: "HlsProgramDateTime" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    segment_control: "HlsSegmentControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Include or exclude RESOLUTION attribute for video in EXT-X-STREAM-INF tag
    # of variant manifest.
    stream_inf_resolution: "HlsStreamInfResolution" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Indicates ID3 frame that has the timecode.
    timed_metadata_id3_frame: "HlsTimedMetadataId3Frame" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["HlsGroupSettings", None, None]:
        yield from super().paginate()
...
class HlsSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "audio_track_type",
                "AudioTrackType",
                TypeInfo(HlsAudioTrackType),
            ),
            (
                "i_frame_only_manifest",
                "IFrameOnlyManifest",
                TypeInfo(HlsIFrameOnlyManifest),
            ),
            (
                "segment_modifier",
                "SegmentModifier",
    ...
    audio_track_type: "HlsAudioTrackType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When set to INCLUDE, writes I-Frame Only Manifest in addition to the HLS
    # manifest
    i_frame_only_manifest: "HlsIFrameOnlyManifest" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["HlsSettings", None, None]:
        yield from super().paginate()
...
class Id3Insertion(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Id3Insertion", None, None]:
        yield from super().paginate()
...
class ImageInserter(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ImageInserter", None, None]:
        yield from super().paginate()
...
class Input(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "deblock_filter",
                "DeblockFilter",
                TypeInfo(InputDeblockFilter),
            ),
            (
                "denoise_filter",
                "DenoiseFilter",
                TypeInfo(InputDenoiseFilter),
            ),
            (
                "file_input",
                "FileInput",
            ...
            (
                "psi_control",
                "PsiControl",
                TypeInfo(InputPsiControl),
            ),
            (
                "timecode_source",
                "TimecodeSource",
                TypeInfo(InputTimecodeSource),
            ),
            (
                "video_selector",
                "VideoSelector",
    ...
    deblock_filter: "InputDeblockFilter" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # inputs.
    denoise_filter: "InputDenoiseFilter" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    filter_enable: "InputFilterEnable" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    psi_control: "InputPsiControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # embedded timecodes.
    timecode_source: "InputTimecodeSource" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Selector for video.
    video_selector: "VideoSelector" = dataclasses.field(default_factory=dict, )
...
class InputClipping(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InputClipping", None, None]:
        yield from super().paginate()
...
class InputTemplate(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InputTemplate", None, None]:
        yield from super().paginate()
...
class InsertableImage(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InsertableImage", None, None]:
        yield from super().paginate()
...
class InternalServerErrorException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InternalServerErrorException", None, None]:
        yield from super().paginate()
...
class Job(ShapeBase):
    ...
    status: "JobStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Information about when jobs are submitted, started, and finished is
    # specified in Unix epoch format in seconds.
    timing: "Timing" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["Job", None, None]:
        yield from super().paginate()
...
class JobSettings(ShapeBase):
    ...
    avail_blanking: "AvailBlanking" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["JobSettings", None, None]:
        yield from super().paginate()
...
class JobTemplate(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["JobTemplate", None, None]:
        yield from super().paginate()
...
class JobTemplateSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["JobTemplateSettings", None, None]:
        yield from super().paginate()
...
class ListJobTemplatesRequest(ShapeBase):
    ...
    list_by: "JobTemplateListBy" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # resource.
    order: "Order" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self,
                ) -> typing.Generator["ListJobTemplatesRequest", None, None]:
        yield from super().paginate()
...
class ListJobTemplatesResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListJobTemplatesResponse", None, None]:
        yield from super().paginate()
...
class ListJobsRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListJobsRequest", None, None]:
        yield from super().paginate()
...
class ListJobsResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListJobsResponse", None, None]:
        yield from super().paginate()
...
class ListPresetsRequest(ShapeBase):
    ...
    # alphabetically by NAME or chronologically by CREATION_DATE. If you don't
    # specify, the service will list them by name.
    list_by: "PresetListBy" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["ListPresetsRequest", None, None]:
        yield from super().paginate()
...
class ListPresetsResponse(OutputShapeBase):
    ...
    # List of presets
    presets: typing.List["Preset"] = dataclasses.field(default_factory=list, )
...
class ListQueuesRequest(ShapeBase):
    ...
    list_by: "QueueListBy" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["ListQueuesRequest", None, None]:
        yield from super().paginate()
...
class ListQueuesResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ListQueuesResponse", None, None]:
        yield from super().paginate()
...
class ListTagsForResourceResponse(OutputShapeBase):
    ...
    # resource.
    resource_tags: "ResourceTags" = dataclasses.field(default_factory=dict, )
...
class M2tsSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "ebp_audio_interval",
                "EbpAudioInterval",
                TypeInfo(M2tsEbpAudioInterval),
            ),
            (
                "ebp_placement",
                "EbpPlacement",
                TypeInfo(M2tsEbpPlacement),
            ),
            (
                "es_rate_in_pes",
                "EsRateInPes",
                TypeInfo(M2tsEsRateInPes),
            ),
            (
                "fragment_time",
                "FragmentTime",
            ...
            (
                "scte35_source",
                "Scte35Source",
                TypeInfo(M2tsScte35Source),
            ),
            (
                "segmentation_markers",
                "SegmentationMarkers",
                TypeInfo(M2tsSegmentationMarkers),
            ),
            (
                "segmentation_style",
                "SegmentationStyle",
                TypeInfo(M2tsSegmentationStyle),
            ),
            (
                "segmentation_time",
                "SegmentationTime",
    ...
    # Selects between the DVB and ATSC buffer models for Dolby Digital audio.
    audio_buffer_model: "M2tsAudioBufferModel" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # by comma separation.
    audio_pids: typing.List[int] = dataclasses.field(default_factory=list, )
    ...
    buffer_model: "M2tsBufferModel" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # separation.
    dvb_sub_pids: typing.List[int] = dataclasses.field(default_factory=list, )
    ...
    ebp_audio_interval: "M2tsEbpAudioInterval" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # (segmentationMarkers is EBP or EBP_LEGACY).
    ebp_placement: "M2tsEbpPlacement" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Controls whether to include the ES Rate field in the PES header.
    es_rate_in_pes: "M2tsEsRateInPes" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    nielsen_id3: "M2tsNielsenId3" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # elementary stream.
    pcr_control: "M2tsPcrControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    rate_mode: "M2tsRateMode" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # Enables SCTE-35 passthrough (scte35Source) to pass any SCTE-35 signals from
    # input to output.
    scte35_source: "M2tsScte35Source" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    segmentation_markers: "M2tsSegmentationMarkers" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    segmentation_style: "M2tsSegmentationStyle" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["M2tsSettings", None, None]:
        yield from super().paginate()
...
class M3u8Settings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "scte35_source",
                "Scte35Source",
                TypeInfo(M3u8Scte35Source),
            ),
            (
                "timed_metadata",
                "TimedMetadata",
                TypeInfo(TimedMetadata),
            ),
            (
                "timed_metadata_pid",
                "TimedMetadataPid",
    ...
    # If INSERT, Nielsen inaudible tones for media tracking will be detected in
    # the input audio and an equivalent ID3 tag will be inserted in the output.
    nielsen_id3: "M3u8NielsenId3" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    pcr_control: "M3u8PcrControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Enables SCTE-35 passthrough (scte35Source) to pass any SCTE-35 signals from
    # input to output.
    scte35_source: "M3u8Scte35Source" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    timed_metadata: "TimedMetadata" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["M3u8Settings", None, None]:
        yield from super().paginate()
...
class MovSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "clap_atom",
                "ClapAtom",
                TypeInfo(MovClapAtom),
            ),
            (
                "cslg_atom",
                "CslgAtom",
                TypeInfo(MovCslgAtom),
            ),
            (
                "mpeg2_four_cc_control",
                "Mpeg2FourCCControl",
                TypeInfo(MovMpeg2FourCCControl),
            ),
            (
                "padding_control",
                "PaddingControl",
                TypeInfo(MovPaddingControl),
            ),
            (
                "reference",
                "Reference",
                TypeInfo(MovReference),
            ),
        ]

    # When enabled, include 'clap' atom if appropriate for the video output
    # settings.
    clap_atom: "MovClapAtom" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # players and tools.
    cslg_atom: "MovCslgAtom" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    mpeg2_four_cc_control: "MovMpeg2FourCCControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # If set to OMNEON, inserts Omneon-compatible padding
    padding_control: "MovPaddingControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # all of the media.
    reference: "MovReference" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["MovSettings", None, None]:
        yield from super().paginate()
...
class Mp2Settings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Mp2Settings", None, None]:
        yield from super().paginate()
...
class Mp4Settings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "cslg_atom",
                "CslgAtom",
                TypeInfo(Mp4CslgAtom),
            ),
            (
                "free_space_box",
                "FreeSpaceBox",
                TypeInfo(Mp4FreeSpaceBox),
            ),
            (
                "moov_placement",
                "MoovPlacement",
                TypeInfo(Mp4MoovPlacement),
            ),
            (
                "mp4_major_brand",
                "Mp4MajorBrand",
    ...
    # included per 14496-1 amendment 1. This improves compatibility with Apple
    # players and tools.
    cslg_atom: "Mp4CslgAtom" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Inserts a free-space box immediately after the moov box.
    free_space_box: "Mp4FreeSpaceBox" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # of the archive as required for progressive downloading. Otherwise it is
    # placed normally at the end.
    moov_placement: "Mp4MoovPlacement" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["Mp4Settings", None, None]:
        yield from super().paginate()
...
class Mpeg2Settings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "adaptive_quantization",
                "AdaptiveQuantization",
                TypeInfo(Mpeg2AdaptiveQuantization),
            ),
            (
                "bitrate",
                "Bitrate",
            ...
            (
                "codec_level",
                "CodecLevel",
                TypeInfo(Mpeg2CodecLevel),
            ),
            (
                "codec_profile",
                "CodecProfile",
                TypeInfo(Mpeg2CodecProfile),
            ),
            (
                "dynamic_sub_gop",
                "DynamicSubGop",
                TypeInfo(Mpeg2DynamicSubGop),
            ),
            (
                "framerate_control",
                "FramerateControl",
                TypeInfo(Mpeg2FramerateControl),
            ),
            (
                "framerate_conversion_algorithm",
                "FramerateConversionAlgorithm",
                TypeInfo(Mpeg2FramerateConversionAlgorithm),
            ),
            (
                "framerate_denominator",
                "FramerateDenominator",
            ...
            (
                "interlace_mode",
                "InterlaceMode",
                TypeInfo(Mpeg2InterlaceMode),
            ),
            (
                "intra_dc_precision",
                "IntraDcPrecision",
                TypeInfo(Mpeg2IntraDcPrecision),
            ),
            (
                "max_bitrate",
                "MaxBitrate",
            ...
            (
                "quality_tuning_level",
                "QualityTuningLevel",
                TypeInfo(Mpeg2QualityTuningLevel),
            ),
            (
                "rate_control_mode",
                "RateControlMode",
                TypeInfo(Mpeg2RateControlMode),
            ),
            (
                "scene_change_detect",
                "SceneChangeDetect",
                TypeInfo(Mpeg2SceneChangeDetect),
            ),
            (
                "slow_pal",
                "SlowPal",
                TypeInfo(Mpeg2SlowPal),
            ),
            (
                "softness",
                "Softness",
            ...
            (
                "spatial_adaptive_quantization",
                "SpatialAdaptiveQuantization",
                TypeInfo(Mpeg2SpatialAdaptiveQuantization),
            ),
            (
                "syntax",
                "Syntax",
                TypeInfo(Mpeg2Syntax),
            ),
            (
                "telecine",
                "Telecine",
                TypeInfo(Mpeg2Telecine),
            ),
            (
                "temporal_adaptive_quantization",
                "TemporalAdaptiveQuantization",
                TypeInfo(Mpeg2TemporalAdaptiveQuantization),
            ),
        ]

    # Adaptive quantization. Allows intra-frame quantizers to vary to improve
    # visual quality.
    adaptive_quantization: "Mpeg2AdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Use Level (Mpeg2CodecLevel) to set the MPEG-2 level for the video output.
    codec_level: "Mpeg2CodecLevel" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Use Profile (Mpeg2CodecProfile) to set the MPEG-2 profile for the video
    # output.
    codec_profile: "Mpeg2CodecProfile" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # is limited by the value you provide for the setting B frames between
    # reference frames (numberBFramesBetweenReferenceFrames).
    dynamic_sub_gop: "Mpeg2DynamicSubGop" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # to use the framerate you specify in the settings FramerateNumerator and
    # FramerateDenominator.
    framerate_control: "Mpeg2FramerateControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When set to INTERPOLATE, produces smoother motion during framerate
    # conversion.
    framerate_conversion_algorithm: "Mpeg2FramerateConversionAlgorithm" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # seconds the system will convert the GOP Size into a frame count at run
    # time.
    gop_size_units: "Mpeg2GopSizeUnits" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # or "bottom field first" polarity, depending on which of the Follow options
    # you chose.
    interlace_mode: "Mpeg2InterlaceMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # compression ratio.
    intra_dc_precision: "Mpeg2IntraDcPrecision" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # pixel aspect ratio from the input. Using the console, do this by choosing
    # Follow source for Pixel aspect ratio.
    par_control: "Mpeg2ParControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    quality_tuning_level: "Mpeg2QualityTuningLevel" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Use Rate control mode (Mpeg2RateControlMode) to specifiy whether the
    # bitrate is variable (vbr) or constant (cbr).
    rate_control_mode: "Mpeg2RateControlMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Scene change detection (inserts I-frames on scene changes).
    scene_change_detect: "Mpeg2SceneChangeDetect" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Enables Slow PAL rate conversion. 23.976fps and 24fps input is relabeled as
    # 25fps, and audio is sped up correspondingly.
    slow_pal: "Mpeg2SlowPal" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # Adjust quantization within each frame based on spatial variation of content
    # complexity.
    spatial_adaptive_quantization: "Mpeg2SpatialAdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # Produces a Type D-10 compatible bitstream (SMPTE 356M-2001).
    syntax: "Mpeg2Syntax" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    telecine: "Mpeg2Telecine" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Adjust quantization within each frame based on temporal variation of
    # content complexity.
    temporal_adaptive_quantization: "Mpeg2TemporalAdaptiveQuantization" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self, ) -> typing.Generator["Mpeg2Settings", None, None]:
        yield from super().paginate()
...
class MsSmoothEncryptionSettings(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["MsSmoothEncryptionSettings", None, None]:
        yield from super().paginate()
...
class MsSmoothGroupSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "audio_deduplication",
                "AudioDeduplication",
                TypeInfo(MsSmoothAudioDeduplication),
            ),
            (
                "destination",
                "Destination",
            ...
            (
                "manifest_encoding",
                "ManifestEncoding",
                TypeInfo(MsSmoothManifestEncoding),
            ),
        ]
    ...
    audio_deduplication: "MsSmoothAudioDeduplication" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # utf16.
    manifest_encoding: "MsSmoothManifestEncoding" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self,
                ) -> typing.Generator["MsSmoothGroupSettings", None, None]:
        yield from super().paginate()
...
class NielsenConfiguration(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["NielsenConfiguration", None, None]:
        yield from super().paginate()
...
class NoiseReducer(ShapeBase):
    ...
    filter: "NoiseReducerFilter" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["NoiseReducer", None, None]:
        yield from super().paginate()
...
class NoiseReducerFilterSettings(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["NoiseReducerFilterSettings", None, None]:
        yield from super().paginate()
...
class NoiseReducerSpatialFilterSettings(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["NoiseReducerSpatialFilterSettings", None, None]:
        yield from super().paginate()
...
class OutputChannelMapping(ShapeBase):
    ...
    input_channels: typing.List[int] = dataclasses.field(default_factory=list, )

    def paginate(self,
                ) -> typing.Generator["OutputChannelMapping", None, None]:
        yield from super().paginate()
...
class OutputDetail(ShapeBase):
    ...
    video_details: "VideoDetail" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["OutputDetail", None, None]:
        yield from super().paginate()
...
class OutputGroup(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["OutputGroup", None, None]:
        yield from super().paginate()
...
class OutputGroupDetail(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["OutputGroupDetail", None, None]:
        yield from super().paginate()
...
class OutputGroupSettings(ShapeBase):
    ...
    # Streaming, CMAF)
    type: "OutputGroupType" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["OutputGroupSettings", None, None]:
        yield from super().paginate()
...
class OutputSettings(ShapeBase):
    ...
    # Settings for HLS output groups
    hls_settings: "HlsSettings" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["OutputSettings", None, None]:
        yield from super().paginate()
...
class Preset(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Preset", None, None]:
        yield from super().paginate()
...
class PresetSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PresetSettings", None, None]:
        yield from super().paginate()
...
class ProresSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "codec_profile",
                "CodecProfile",
                TypeInfo(ProresCodecProfile),
            ),
            (
                "framerate_control",
                "FramerateControl",
                TypeInfo(ProresFramerateControl),
            ),
            (
                "framerate_conversion_algorithm",
                "FramerateConversionAlgorithm",
                TypeInfo(ProresFramerateConversionAlgorithm),
            ),
            (
                "framerate_denominator",
                "FramerateDenominator",
            ...
            (
                "interlace_mode",
                "InterlaceMode",
                TypeInfo(ProresInterlaceMode),
            ),
            (
                "par_control",
                "ParControl",
                TypeInfo(ProresParControl),
            ),
            (
                "par_denominator",
                "ParDenominator",
            ...
            (
                "slow_pal",
                "SlowPal",
                TypeInfo(ProresSlowPal),
            ),
            (
                "telecine",
                "Telecine",
                TypeInfo(ProresTelecine),
            ),
        ]

    # Use Profile (ProResCodecProfile) to specifiy the type of Apple ProRes codec
    # to use for this output.
    codec_profile: "ProresCodecProfile" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # to use the framerate you specify in the settings FramerateNumerator and
    # FramerateDenominator.
    framerate_control: "ProresFramerateControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    # When set to INTERPOLATE, produces smoother motion during framerate
    # conversion.
    framerate_conversion_algorithm: "ProresFramerateConversionAlgorithm" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # or "bottom field first" polarity, depending on which of the Follow options
    # you chose.
    interlace_mode: "ProresInterlaceMode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # (ParDenominator).
    par_control: "ProresParControl" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # Enables Slow PAL rate conversion. 23.976fps and 24fps input is relabeled as
    # 25fps, and audio is sped up correspondingly.
    slow_pal: "ProresSlowPal" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # output from a 23.976 input. Set it to Soft (soft) to produce 23.976 output
    # and leave converstion to the player.
    telecine: "ProresTelecine" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["ProresSettings", None, None]:
        yield from super().paginate()
...
class Queue(ShapeBase):
    ...
    # finish or error out.
    status: "QueueStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["Queue", None, None]:
        yield from super().paginate()
...
class Rectangle(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Rectangle", None, None]:
        yield from super().paginate()
...
class RemixSettings(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["RemixSettings", None, None]:
        yield from super().paginate()
...
class ResourceTags(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ResourceTags", None, None]:
        yield from super().paginate()
...
class SccDestinationSettings(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "framerate",
                "Framerate",
                TypeInfo(SccDestinationFramerate),
            ),
        ]
    ...
    framerate: "SccDestinationFramerate" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self,
                ) -> typing.Generator["SccDestinationSettings", None, None]:
        yield from super().paginate()
...
class SpekeKeyProvider(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SpekeKeyProvider", None, None]:
        yield from super().paginate()
...
class StaticKeyProvider(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["StaticKeyProvider", None, None]:
        yield from super().paginate()
...
class TeletextDestinationSettings(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["TeletextDestinationSettings", None, None]:
        yield from super().paginate()
...
class TeletextSourceSettings(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["TeletextSourceSettings", None, None]:
        yield from super().paginate()
...
class TimecodeBurnin(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "position",
                "Position",
                TypeInfo(TimecodeBurninPosition),
            ),
            (
                "prefix",
                "Prefix",
    ...
    position: "TimecodeBurninPosition" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["TimecodeBurnin", None, None]:
        yield from super().paginate()
...
class TimecodeConfig(ShapeBase):
    ...
    source: "TimecodeSource" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["TimecodeConfig", None, None]:
        yield from super().paginate()
...
class TimedMetadataInsertion(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["TimedMetadataInsertion", None, None]:
        yield from super().paginate()
...
class Timing(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Timing", None, None]:
        yield from super().paginate()
...
class TtmlDestinationSettings(ShapeBase):
    ...
    style_passthrough: "TtmlStylePassthrough" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self,
                ) -> typing.Generator["TtmlDestinationSettings", None, None]:
        yield from super().paginate()
...
class UpdateJobTemplateRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateJobTemplateRequest", None, None]:
        yield from super().paginate()
...
class UpdateJobTemplateResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateJobTemplateResponse", None, None]:
        yield from super().paginate()
...
class UpdatePresetRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdatePresetRequest", None, None]:
        yield from super().paginate()
...
class UpdatePresetResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdatePresetResponse", None, None]:
        yield from super().paginate()
...
class UpdateQueueRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdateQueueRequest", None, None]:
        yield from super().paginate()
...
class UpdateQueueResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UpdateQueueResponse", None, None]:
        yield from super().paginate()
...
class VideoCodecSettings(ShapeBase):
    ...
    # Type of video codec
    codec: "VideoCodec" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # Required when you set (Codec) under (VideoDescription)>(CodecSettings) to
    # the value H_264.
    h264_settings: "H264Settings" = dataclasses.field(default_factory=dict, )

    # Settings for H265 codec
    h265_settings: "H265Settings" = dataclasses.field(default_factory=dict, )

    # Required when you set (Codec) under (VideoDescription)>(CodecSettings) to
    # the value MPEG2.
    mpeg2_settings: "Mpeg2Settings" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["VideoCodecSettings", None, None]:
        yield from super().paginate()
...
class VideoDescription(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "respond_to_afd",
                "RespondToAfd",
                TypeInfo(RespondToAfd),
            ),
            (
                "scaling_behavior",
                "ScalingBehavior",
                TypeInfo(ScalingBehavior),
            ),
            (
                "sharpness",
                "Sharpness",
            ...
            (
                "timecode_insertion",
                "TimecodeInsertion",
                TypeInfo(VideoTimecodeInsertion),
            ),
            (
                "video_preprocessors",
                "VideoPreprocessors",
    ...
    afd_signaling: "AfdSignaling" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # is enabled.
    anti_alias: "AntiAlias" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    color_metadata: "ColorMetadata" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    # settings.
    crop: "Rectangle" = dataclasses.field(default_factory=dict, )
    ...
    # is enabled.
    drop_frame_timecode: "DropFrameTimecode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    position: "Rectangle" = dataclasses.field(default_factory=dict, )
    ...
    respond_to_afd: "RespondToAfd" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    scaling_behavior: "ScalingBehavior" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    timecode_insertion: "VideoTimecodeInsertion" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["VideoDescription", None, None]:
        yield from super().paginate()
...
class VideoDetail(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["VideoDetail", None, None]:
        yield from super().paginate()
...
class VideoPreprocessor(ShapeBase):
    ...
    # picture.
    deinterlacer: "Deinterlacer" = dataclasses.field(default_factory=dict, )
    ...
    image_inserter: "ImageInserter" = dataclasses.field(default_factory=dict, )
    ...
    # individually. This setting is disabled by default.
    noise_reducer: "NoiseReducer" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["VideoPreprocessor", None, None]:
        yield from super().paginate()
...
class VideoSelector(ShapeBase):
    ...
    color_space: "ColorSpace" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    color_space_usage: "ColorSpaceUsage" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["VideoSelector", None, None]:
        yield from super().paginate()
...
class WavSettings(ShapeBase):
    ...
    # likely to exceed 4 GB in file size, or if you otherwise need the extended
    # support of the RF64 format, set your output WAV file format to RF64.
    format: "WavFormat" = dataclasses.field(default=ShapeBase.NOT_SET, )

    # Sample rate in Hz.
    sample_rate: int = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["WavSettings", None, None]:
        yield from super().paginate()
