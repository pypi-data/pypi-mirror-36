...
class Client(ClientBase):
    ...
    def authorize_cache_security_group_ingress(
        ...
        *,
        ...
        return shapes.AuthorizeCacheSecurityGroupIngressResult.from_boto_dict(
            response
        )
    ...
    def create_cache_cluster(
        ...
        *,
        ...
        az_mode: shapes.AZMode = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_cache_cluster(
            **_request.to_boto_dict()
        )

        return shapes.CreateCacheClusterResult.from_boto_dict(response)
    ...
    def create_cache_parameter_group(
        ...
        *,
        ...
        return shapes.CreateCacheParameterGroupResult.from_boto_dict(response)
    ...
    def create_cache_security_group(
        ...
        *,
        ...
        return shapes.CreateCacheSecurityGroupResult.from_boto_dict(response)
    ...
    def create_cache_subnet_group(
        ...
        *,
        ...
        return shapes.CreateCacheSubnetGroupResult.from_boto_dict(response)
    ...
    def create_replication_group(
        ...
        *,
        ...
        return shapes.CreateReplicationGroupResult.from_boto_dict(response)
    ...
    def delete_cache_cluster(
        ...
        *,
        ...
        response = self._boto_client.delete_cache_cluster(
            **_request.to_boto_dict()
        )

        return shapes.DeleteCacheClusterResult.from_boto_dict(response)
    ...
    def delete_replication_group(
        ...
        *,
        ...
        return shapes.DeleteReplicationGroupResult.from_boto_dict(response)
    ...
    def describe_cache_clusters(
        ...
        *,
        ...
        result = shapes.CacheClusterMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.CacheClusterMessage.from_boto_dict(response)
    ...
    def describe_cache_engine_versions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.CacheEngineVersionMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.CacheEngineVersionMessage.from_boto_dict(response)
    ...
    def describe_cache_parameter_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.CacheParameterGroupsMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.CacheParameterGroupsMessage.from_boto_dict(response)
    ...
    def describe_cache_parameters(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.CacheParameterGroupDetails.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.CacheParameterGroupDetails.from_boto_dict(response)
    ...
    def describe_cache_security_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.CacheSecurityGroupMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.CacheSecurityGroupMessage.from_boto_dict(response)
    ...
    def describe_cache_subnet_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.CacheSubnetGroupMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.CacheSubnetGroupMessage.from_boto_dict(response)
    ...
    def describe_replication_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ReplicationGroupMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ReplicationGroupMessage.from_boto_dict(response)
    ...
    def describe_reserved_cache_nodes(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ReservedCacheNodeMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ReservedCacheNodeMessage.from_boto_dict(response)
    ...
    def describe_reserved_cache_nodes_offerings(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ReservedCacheNodesOfferingMessage.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ReservedCacheNodesOfferingMessage.from_boto_dict(response)
    ...
    def describe_snapshots(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeSnapshotsListMessage.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeSnapshotsListMessage.from_boto_dict(response)
    ...
    def list_allowed_node_type_modifications(
        ...
        *,
        ...
        return shapes.AllowedNodeTypeModificationsMessage.from_boto_dict(
            response
        )
    ...
    def modify_cache_cluster(
        ...
        *,
        ...
        response = self._boto_client.modify_cache_cluster(
            **_request.to_boto_dict()
        )

        return shapes.ModifyCacheClusterResult.from_boto_dict(response)
    ...
    def modify_cache_parameter_group(
        ...
        *,
        ...
        return shapes.CacheParameterGroupNameMessage.from_boto_dict(response)
    ...
    def modify_cache_subnet_group(
        ...
        *,
        ...
        return shapes.ModifyCacheSubnetGroupResult.from_boto_dict(response)
    ...
    def modify_replication_group(
        ...
        *,
        ...
        return shapes.ModifyReplicationGroupResult.from_boto_dict(response)
    ...
    def modify_replication_group_shard_configuration(
        ...
        *,
        ...
        return shapes.ModifyReplicationGroupShardConfigurationResult.from_boto_dict(
            response
        )
    ...
    def purchase_reserved_cache_nodes_offering(
        ...
        *,
        ...
        return shapes.PurchaseReservedCacheNodesOfferingResult.from_boto_dict(
            response
        )
    ...
    def reboot_cache_cluster(
        ...
        *,
        ...
        response = self._boto_client.reboot_cache_cluster(
            **_request.to_boto_dict()
        )

        return shapes.RebootCacheClusterResult.from_boto_dict(response)
    ...
    def revoke_cache_security_group_ingress(
        ...
        *,
        ...
        return shapes.RevokeCacheSecurityGroupIngressResult.from_boto_dict(
            response
        )
    ...
    def test_failover(
        ...
        **Note the following**
        ...
        response = self._boto_client.test_failover(**_request.to_boto_dict())

        return shapes.TestFailoverResult.from_boto_dict(response)
