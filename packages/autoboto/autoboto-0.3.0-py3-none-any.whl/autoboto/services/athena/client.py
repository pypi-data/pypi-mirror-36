...
class Client(ClientBase):
    ...
    def get_query_results(
        ...
        *,
        ...
        result = shapes.GetQueryResultsOutput.from_boto_dict(first_page)
    ...
    def list_named_queries(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListNamedQueriesOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_query_executions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListQueryExecutionsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
