...
class Client(ClientBase):
    ...
    def describe_batch_predictions(
        ...
        *,
        ...
        result = shapes.DescribeBatchPredictionsOutput.from_boto_dict(
            first_page
        )
    ...
    def describe_data_sources(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeDataSourcesOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def describe_evaluations(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeEvaluationsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def describe_ml_models(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeMLModelsOutput.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
