...
class Client(ClientBase):
    ...
    def list_endpoints_by_platform_application(
        ...
        *,
        ...
        result = shapes.ListEndpointsByPlatformApplicationResponse.from_boto_dict(
            first_page
        )
    ...
    def list_platform_applications(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPlatformApplicationsResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result
    ...
    def list_subscriptions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSubscriptionsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
    ...
    def list_subscriptions_by_topic(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSubscriptionsByTopicResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result
    ...
    def list_topics(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTopicsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result
