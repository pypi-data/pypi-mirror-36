...
class Client(ClientBase):
    ...
    def create_device_pool(
        ...
        *,
        ...
        response = self._boto_client.create_device_pool(
            **_request.to_boto_dict()
        )

        return shapes.CreateDevicePoolResult.from_boto_dict(response)
    ...
    def create_instance_profile(
        ...
        *,
        ...
        return shapes.CreateInstanceProfileResult.from_boto_dict(response)
    ...
    def create_network_profile(
        ...
        *,
        ...
        name: str,
        description: str = ShapeBase.NOT_SET,
        type: shapes.NetworkProfileType = ShapeBase.NOT_SET,
        ...
        return shapes.CreateNetworkProfileResult.from_boto_dict(response)
    ...
    def create_project(
        ...
        *,
        ...
        response = self._boto_client.create_project(**_request.to_boto_dict())

        return shapes.CreateProjectResult.from_boto_dict(response)
    ...
    def create_remote_access_session(
        ...
        *,
        ...
        interaction_mode: shapes.InteractionMode = ShapeBase.NOT_SET,
        ...
        return shapes.CreateRemoteAccessSessionResult.from_boto_dict(response)
    ...
    def create_upload(
        ...
        *,
        ...
        response = self._boto_client.create_upload(**_request.to_boto_dict())

        return shapes.CreateUploadResult.from_boto_dict(response)
    ...
    def create_vpce_configuration(
        ...
        *,
        ...
        return shapes.CreateVPCEConfigurationResult.from_boto_dict(response)
    ...
    def delete_device_pool(
        ...
        *,
        ...
        response = self._boto_client.delete_device_pool(
            **_request.to_boto_dict()
        )

        return shapes.DeleteDevicePoolResult.from_boto_dict(response)
    ...
    def delete_instance_profile(
        ...
        *,
        ...
        return shapes.DeleteInstanceProfileResult.from_boto_dict(response)
    ...
    def delete_network_profile(
        ...
        *,
        ...
        return shapes.DeleteNetworkProfileResult.from_boto_dict(response)
    ...
    def delete_project(
        ...
        **Note** Deleting this resource does not stop an in-progress run.
        ...
        response = self._boto_client.delete_project(**_request.to_boto_dict())

        return shapes.DeleteProjectResult.from_boto_dict(response)
    ...
    def delete_remote_access_session(
        ...
        *,
        ...
        return shapes.DeleteRemoteAccessSessionResult.from_boto_dict(response)
    ...
    def delete_run(
        ...
        **Note** Deleting this resource does not stop an in-progress run.
        ...
        response = self._boto_client.delete_run(**_request.to_boto_dict())

        return shapes.DeleteRunResult.from_boto_dict(response)
    ...
    def delete_upload(
        ...
        *,
        ...
        response = self._boto_client.delete_upload(**_request.to_boto_dict())

        return shapes.DeleteUploadResult.from_boto_dict(response)
    ...
    def delete_vpce_configuration(
        ...
        *,
        ...
        return shapes.DeleteVPCEConfigurationResult.from_boto_dict(response)
    ...
    def get_account_settings(
        ...
        response = self._boto_client.get_account_settings(
            **_request.to_boto_dict()
        )

        return shapes.GetAccountSettingsResult.from_boto_dict(response)
    ...
    def get_device(
        ...
        *,
        ...
        return shapes.GetDeviceResult.from_boto_dict(response)
    ...
    def get_device_instance(
        ...
        *,
        ...
        response = self._boto_client.get_device_instance(
            **_request.to_boto_dict()
        )

        return shapes.GetDeviceInstanceResult.from_boto_dict(response)
    ...
    def get_device_pool(
        ...
        *,
        ...
        response = self._boto_client.get_device_pool(**_request.to_boto_dict())

        return shapes.GetDevicePoolResult.from_boto_dict(response)
    ...
    def get_device_pool_compatibility(
        ...
        *,
        ...
        test_type: shapes.TestType = ShapeBase.NOT_SET,
        ...
        return shapes.GetDevicePoolCompatibilityResult.from_boto_dict(response)
    ...
    def get_instance_profile(
        ...
        *,
        ...
        return shapes.GetInstanceProfileResult.from_boto_dict(response)
    ...
    def get_job(
        ...
        *,
        ...
        return shapes.GetJobResult.from_boto_dict(response)
    ...
    def get_network_profile(
        ...
        *,
        ...
        response = self._boto_client.get_network_profile(
            **_request.to_boto_dict()
        )

        return shapes.GetNetworkProfileResult.from_boto_dict(response)
    ...
    def get_offering_status(
        ...
        *,
        ...
        result = shapes.GetOfferingStatusResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.GetOfferingStatusResult.from_boto_dict(response)
    ...
    def get_project(
        ...
        *,
        ...
        response = self._boto_client.get_project(**_request.to_boto_dict())

        return shapes.GetProjectResult.from_boto_dict(response)
    ...
    def get_remote_access_session(
        ...
        *,
        ...
        return shapes.GetRemoteAccessSessionResult.from_boto_dict(response)
    ...
    def get_run(
        ...
        *,
        ...
        response = self._boto_client.get_run(**_request.to_boto_dict())

        return shapes.GetRunResult.from_boto_dict(response)
    ...
    def get_suite(
        ...
        *,
        ...
        response = self._boto_client.get_suite(**_request.to_boto_dict())

        return shapes.GetSuiteResult.from_boto_dict(response)
    ...
    def get_test(
        ...
        *,
        ...
        response = self._boto_client.get_test(**_request.to_boto_dict())

        return shapes.GetTestResult.from_boto_dict(response)
    ...
    def get_upload(
        ...
        *,
        ...
        response = self._boto_client.get_upload(**_request.to_boto_dict())

        return shapes.GetUploadResult.from_boto_dict(response)
    ...
    def get_vpce_configuration(
        ...
        *,
        ...
        return shapes.GetVPCEConfigurationResult.from_boto_dict(response)
    ...
    def install_to_remote_access_session(
        ...
        *,
        ...
        return shapes.InstallToRemoteAccessSessionResult.from_boto_dict(
            response
        )
    ...
    def list_artifacts(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListArtifactsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListArtifactsResult.from_boto_dict(response)
    ...
    def list_device_instances(
        ...
        *,
        ...
        response = self._boto_client.list_device_instances(
            **_request.to_boto_dict()
        )

        return shapes.ListDeviceInstancesResult.from_boto_dict(response)
    ...
    def list_device_pools(
        ...
        *,
        arn: str,
        type: shapes.DevicePoolType = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDevicePoolsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListDevicePoolsResult.from_boto_dict(response)
    ...
    def list_devices(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListDevicesResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListDevicesResult.from_boto_dict(response)
    ...
    def list_instance_profiles(
        ...
        *,
        ...
        return shapes.ListInstanceProfilesResult.from_boto_dict(response)
    ...
    def list_jobs(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListJobsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListJobsResult.from_boto_dict(response)
    ...
    def list_network_profiles(
        ...
        *,
        ...
        response = self._boto_client.list_network_profiles(
            **_request.to_boto_dict()
        )

        return shapes.ListNetworkProfilesResult.from_boto_dict(response)
    ...
    def list_offering_promotions(
        ...
        *,
        ...
        return shapes.ListOfferingPromotionsResult.from_boto_dict(response)
    ...
    def list_offering_transactions(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListOfferingTransactionsResult.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListOfferingTransactionsResult.from_boto_dict(response)
    ...
    def list_offerings(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListOfferingsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListOfferingsResult.from_boto_dict(response)
    ...
    def list_projects(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListProjectsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListProjectsResult.from_boto_dict(response)
    ...
    def list_remote_access_sessions(
        ...
        *,
        ...
        return shapes.ListRemoteAccessSessionsResult.from_boto_dict(response)
    ...
    def list_runs(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListRunsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListRunsResult.from_boto_dict(response)
    ...
    def list_samples(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSamplesResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListSamplesResult.from_boto_dict(response)
    ...
    def list_suites(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListSuitesResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListSuitesResult.from_boto_dict(response)
    ...
    def list_tests(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTestsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListTestsResult.from_boto_dict(response)
    ...
    def list_unique_problems(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListUniqueProblemsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListUniqueProblemsResult.from_boto_dict(response)
    ...
    def list_uploads(
        ...
        *,
        arn: str,
        type: shapes.UploadType = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListUploadsResult.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListUploadsResult.from_boto_dict(response)
    ...
    def list_vpce_configurations(
        ...
        *,
        ...
        return shapes.ListVPCEConfigurationsResult.from_boto_dict(response)
    ...
    def purchase_offering(
        ...
        *,
        ...
        response = self._boto_client.purchase_offering(
            **_request.to_boto_dict()
        )

        return shapes.PurchaseOfferingResult.from_boto_dict(response)
    ...
    def renew_offering(
        ...
        *,
        ...
        response = self._boto_client.renew_offering(**_request.to_boto_dict())

        return shapes.RenewOfferingResult.from_boto_dict(response)
    ...
    def schedule_run(
        ...
        *,
        ...
        response = self._boto_client.schedule_run(**_request.to_boto_dict())

        return shapes.ScheduleRunResult.from_boto_dict(response)
    ...
    def stop_job(
        ...
        *,
        ...
        response = self._boto_client.stop_job(**_request.to_boto_dict())

        return shapes.StopJobResult.from_boto_dict(response)
    ...
    def stop_remote_access_session(
        ...
        *,
        ...
        return shapes.StopRemoteAccessSessionResult.from_boto_dict(response)
    ...
    def stop_run(
        ...
        *,
        ...
        response = self._boto_client.stop_run(**_request.to_boto_dict())

        return shapes.StopRunResult.from_boto_dict(response)
    ...
    def update_device_instance(
        ...
        *,
        ...
        return shapes.UpdateDeviceInstanceResult.from_boto_dict(response)
    ...
    def update_device_pool(
        ...
        *,
        ...
        response = self._boto_client.update_device_pool(
            **_request.to_boto_dict()
        )

        return shapes.UpdateDevicePoolResult.from_boto_dict(response)
    ...
    def update_instance_profile(
        ...
        *,
        ...
        return shapes.UpdateInstanceProfileResult.from_boto_dict(response)
    ...
    def update_network_profile(
        ...
        *,
        ...
        return shapes.UpdateNetworkProfileResult.from_boto_dict(response)
    ...
    def update_project(
        ...
        *,
        ...
        response = self._boto_client.update_project(**_request.to_boto_dict())

        return shapes.UpdateProjectResult.from_boto_dict(response)
    ...
    def update_upload(
        ...
        *,
        ...
        response = self._boto_client.update_upload(**_request.to_boto_dict())

        return shapes.UpdateUploadResult.from_boto_dict(response)
    ...
    def update_vpce_configuration(
        ...
        *,
        ...
        return shapes.UpdateVPCEConfigurationResult.from_boto_dict(response)
