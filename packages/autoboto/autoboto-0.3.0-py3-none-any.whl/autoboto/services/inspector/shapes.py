...
class AccessDeniedErrorCode(Enum):
...
class AccessDeniedException(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "error_code",
                "errorCode",
                TypeInfo(AccessDeniedErrorCode),
            ),
            (
                "can_retry",
                "canRetry",
    ...
    error_code: "AccessDeniedErrorCode" = dataclasses.field(
...
class AddAttributesToFindingsRequest(ShapeBase):
    ...
    finding_arns: typing.List[str] = dataclasses.field(default_factory=list, )
    ...
    def paginate(
        self,
    ) -> typing.Generator["AddAttributesToFindingsRequest", None, None]:
        yield from super().paginate()
...
class AddAttributesToFindingsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AddAttributesToFindingsResponse", None, None]:
        yield from super().paginate()
...
class AgentAlreadyRunningAssessment(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AgentAlreadyRunningAssessment", None, None]:
        yield from super().paginate()
...
class AgentFilter(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "agent_healths",
                "agentHealths",
                TypeInfo(typing.List[AgentHealth]),
            ),
            (
                "agent_health_codes",
                "agentHealthCodes",
                TypeInfo(typing.List[AgentHealthCode]),
            ),
        ]

    # The current health state of the agent. Values can be set to **HEALTHY** or
    # **UNHEALTHY**.
    agent_healths: typing.List["AgentHealth"] = dataclasses.field(
        default_factory=list,
    )
    ...
    # **UNKNOWN**.
    agent_health_codes: typing.List["AgentHealthCode"] = dataclasses.field(
        default_factory=list,
    )

    def paginate(self, ) -> typing.Generator["AgentFilter", None, None]:
        yield from super().paginate()
...
class AgentPreview(ShapeBase):
    ...
    agent_health: "AgentHealth" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["AgentPreview", None, None]:
        yield from super().paginate()
...
class AgentsAlreadyRunningAssessmentException(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "AgentsAlreadyRunningAssessmentException", None, None]:
        yield from super().paginate()
...
class AssessmentRun(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "finding_counts",
                "findingCounts",
                TypeInfo(typing.Dict[Severity, int]),
            ),
            (
                "started_at",
                "startedAt",
    ...
    state: "AssessmentRunState" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    finding_counts: typing.Dict["Severity", int] = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["AssessmentRun", None, None]:
        yield from super().paginate()
...
class AssessmentRunAgent(ShapeBase):
    ...
    agent_health_code: "AgentHealthCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["AssessmentRunAgent", None, None]:
        yield from super().paginate()
...
class AssessmentRunFilter(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "states",
                "states",
                TypeInfo(typing.List[AssessmentRunState]),
            ),
            (
                "duration_range",
                "durationRange",
    ...
    states: typing.List["AssessmentRunState"] = dataclasses.field(
        default_factory=list,
    )
    ...
    duration_range: "DurationRange" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["AssessmentRunFilter", None, None]:
        yield from super().paginate()
...
class AssessmentRunInProgressException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AssessmentRunInProgressException", None, None]:
        yield from super().paginate()
...
class AssessmentRunNotification(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                TypeInfo(AssessmentRunNotificationSnsStatusCode),
            ),
        ]
    ...
    event: "InspectorEvent" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    sns_publish_status_code: "AssessmentRunNotificationSnsStatusCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )

    def paginate(self,
                ) -> typing.Generator["AssessmentRunNotification", None, None]:
        yield from super().paginate()
...
class AssessmentRunStateChange(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AssessmentRunStateChange", None, None]:
        yield from super().paginate()
...
class AssessmentTarget(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AssessmentTarget", None, None]:
        yield from super().paginate()
...
class AssessmentTargetFilter(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AssessmentTargetFilter", None, None]:
        yield from super().paginate()
...
class AssessmentTemplate(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AssessmentTemplate", None, None]:
        yield from super().paginate()
...
class AssessmentTemplateFilter(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AssessmentTemplateFilter", None, None]:
        yield from super().paginate()
...
class AssetAttributes(ShapeBase):
    ...
    # generated.
    ipv4_addresses: typing.List[str] = dataclasses.field(default_factory=list, )

    def paginate(self, ) -> typing.Generator["AssetAttributes", None, None]:
        yield from super().paginate()
...
class CreateAssessmentTargetRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateAssessmentTargetRequest", None, None]:
        yield from super().paginate()
...
class CreateAssessmentTargetResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateAssessmentTargetResponse", None, None]:
        yield from super().paginate()
...
class CreateAssessmentTemplateRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateAssessmentTemplateRequest", None, None]:
        yield from super().paginate()
...
class CreateAssessmentTemplateResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateAssessmentTemplateResponse", None, None]:
        yield from super().paginate()
...
class CreateExclusionsPreviewRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateExclusionsPreviewRequest", None, None]:
        yield from super().paginate()
...
class CreateExclusionsPreviewResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateExclusionsPreviewResponse", None, None]:
        yield from super().paginate()
...
class CreateResourceGroupRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CreateResourceGroupRequest", None, None]:
        yield from super().paginate()
...
class CreateResourceGroupResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateResourceGroupResponse", None, None]:
        yield from super().paginate()
...
class DeleteAssessmentRunRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteAssessmentRunRequest", None, None]:
        yield from super().paginate()
...
class DeleteAssessmentTargetRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteAssessmentTargetRequest", None, None]:
        yield from super().paginate()
...
class DeleteAssessmentTemplateRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteAssessmentTemplateRequest", None, None]:
        yield from super().paginate()
...
class DescribeAssessmentRunsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeAssessmentRunsRequest", None, None]:
        yield from super().paginate()
...
class DescribeAssessmentRunsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeAssessmentRunsResponse", None, None]:
        yield from super().paginate()
...
class DescribeAssessmentTargetsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeAssessmentTargetsRequest", None, None]:
        yield from super().paginate()
...
class DescribeAssessmentTargetsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeAssessmentTargetsResponse", None, None]:
        yield from super().paginate()
...
class DescribeAssessmentTemplatesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeAssessmentTemplatesRequest", None, None]:
        yield from super().paginate()
...
class DescribeAssessmentTemplatesResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeAssessmentTemplatesResponse", None, None]:
        yield from super().paginate()
...
class DescribeCrossAccountAccessRoleResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeCrossAccountAccessRoleResponse", None, None]:
        yield from super().paginate()
...
class DescribeExclusionsRequest(ShapeBase):
    ...
    exclusion_arns: typing.List[str] = dataclasses.field(default_factory=list, )

    # The locale into which you want to translate the exclusion's title,
    # description, and recommendation.
    locale: "Locale" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self,
                ) -> typing.Generator["DescribeExclusionsRequest", None, None]:
        yield from super().paginate()
...
class DescribeExclusionsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeExclusionsResponse", None, None]:
        yield from super().paginate()
...
class DescribeFindingsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeFindingsRequest", None, None]:
        yield from super().paginate()
...
class DescribeFindingsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeFindingsResponse", None, None]:
        yield from super().paginate()
...
class DescribeResourceGroupsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeResourceGroupsRequest", None, None]:
        yield from super().paginate()
...
class DescribeResourceGroupsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeResourceGroupsResponse", None, None]:
        yield from super().paginate()
...
class DescribeRulesPackagesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeRulesPackagesRequest", None, None]:
        yield from super().paginate()
...
class DescribeRulesPackagesResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeRulesPackagesResponse", None, None]:
        yield from super().paginate()
...
class DurationRange(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DurationRange", None, None]:
        yield from super().paginate()
...
class Exclusion(ShapeBase):
    ...
    scopes: typing.List["Scope"] = dataclasses.field(default_factory=list, )
    ...
    def paginate(self, ) -> typing.Generator["Exclusion", None, None]:
        yield from super().paginate()
...
class ExclusionPreview(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ExclusionPreview", None, None]:
        yield from super().paginate()
...
class FailedItemDetails(ShapeBase):
    ...
    failure_code: "FailedItemErrorCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self, ) -> typing.Generator["FailedItemDetails", None, None]:
        yield from super().paginate()
...
class Finding(ShapeBase):
    ...
    asset_type: "AssetType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    # Informational.
    severity: "Severity" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["Finding", None, None]:
        yield from super().paginate()
...
class FindingFilter(ShapeBase):
    ...
    severities: typing.List["Severity"] = dataclasses.field(
        default_factory=list,
    )
    ...
    def paginate(self, ) -> typing.Generator["FindingFilter", None, None]:
        yield from super().paginate()
...
class GetAssessmentReportRequest(ShapeBase):
    ...
    # want to generate.
    report_file_format: "ReportFileFormat" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(self,
                ) -> typing.Generator["GetAssessmentReportRequest", None, None]:
        yield from super().paginate()
...
class GetAssessmentReportResponse(OutputShapeBase):
    ...
    status: "ReportStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetAssessmentReportResponse", None, None]:
        yield from super().paginate()
...
class GetExclusionsPreviewRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetExclusionsPreviewRequest", None, None]:
        yield from super().paginate()
...
class GetExclusionsPreviewResponse(OutputShapeBase):
    ...
    preview_status: "PreviewStatus" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetExclusionsPreviewResponse", None, None]:
        yield from super().paginate()
...
class GetTelemetryMetadataRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetTelemetryMetadataRequest", None, None]:
        yield from super().paginate()
...
class GetTelemetryMetadataResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetTelemetryMetadataResponse", None, None]:
        yield from super().paginate()
...
class InspectorServiceAttributes(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["InspectorServiceAttributes", None, None]:
        yield from super().paginate()
...
class InvalidCrossAccountRoleErrorCode(Enum):
...
class InvalidCrossAccountRoleException(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "error_code",
                "errorCode",
                TypeInfo(InvalidCrossAccountRoleErrorCode),
            ),
            (
                "can_retry",
                "canRetry",
    ...
    # Code that indicates the type of error that is generated.
    error_code: "InvalidCrossAccountRoleErrorCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidCrossAccountRoleException", None, None]:
        yield from super().paginate()


class InvalidInputErrorCode(Enum):
...
class InvalidInputException(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "error_code",
                "errorCode",
                TypeInfo(InvalidInputErrorCode),
            ),
            (
                "can_retry",
                "canRetry",
    ...
    # Code that indicates the type of error that is generated.
    error_code: "InvalidInputErrorCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class LimitExceededErrorCode(Enum):
...
class LimitExceededException(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "error_code",
                "errorCode",
                TypeInfo(LimitExceededErrorCode),
            ),
            (
                "can_retry",
                "canRetry",
    ...
    # Code that indicates the type of error that is generated.
    error_code: "LimitExceededErrorCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class ListAssessmentRunAgentsRequest(ShapeBase):
    ...
    # values can match.
    filter: "AgentFilter" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListAssessmentRunAgentsRequest", None, None]:
        yield from super().paginate()
...
class ListAssessmentRunsRequest(ShapeBase):
    ...
    # When multiple values are specified for a filter attribute, any of the
    # values can match.
    filter: "AssessmentRunFilter" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self,
                ) -> typing.Generator["ListAssessmentRunsRequest", None, None]:
        yield from super().paginate()
...
class ListAssessmentTargetsRequest(ShapeBase):
    ...
    # When multiple values are specified for a filter attribute, any of the
    # values can match.
    filter: "AssessmentTargetFilter" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListAssessmentTargetsRequest", None, None]:
        yield from super().paginate()
...
class ListAssessmentTemplatesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListAssessmentTemplatesRequest", None, None]:
        yield from super().paginate()
...
class ListEventSubscriptionsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListEventSubscriptionsRequest", None, None]:
        yield from super().paginate()
...
class ListExclusionsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListExclusionsRequest", None, None]:
        yield from super().paginate()
...
class ListExclusionsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListExclusionsResponse", None, None]:
        yield from super().paginate()
...
class ListFindingsRequest(ShapeBase):
    ...
    # When multiple values are specified for a filter attribute, any of the
    # values can match.
    filter: "FindingFilter" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["ListFindingsRequest", None, None]:
        yield from super().paginate()
...
class ListRulesPackagesRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListRulesPackagesRequest", None, None]:
        yield from super().paginate()
...
class NoSuchEntityErrorCode(Enum):
...
class NoSuchEntityException(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "error_code",
                "errorCode",
                TypeInfo(NoSuchEntityErrorCode),
            ),
            (
                "can_retry",
                "canRetry",
    ...
    # Code that indicates the type of error that is generated.
    error_code: "NoSuchEntityErrorCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class PreviewAgentsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PreviewAgentsRequest", None, None]:
        yield from super().paginate()
...
class PreviewGenerationInProgressException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["PreviewGenerationInProgressException", None, None]:
        yield from super().paginate()
...
class RegisterCrossAccountAccessRoleRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["RegisterCrossAccountAccessRoleRequest", None, None]:
        yield from super().paginate()
...
class RemoveAttributesFromFindingsRequest(ShapeBase):
    ...
    # findings.
    attribute_keys: typing.List[str] = dataclasses.field(default_factory=list, )

    def paginate(
        self,
    ) -> typing.Generator["RemoveAttributesFromFindingsRequest", None, None]:
        yield from super().paginate()
...
class RemoveAttributesFromFindingsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["RemoveAttributesFromFindingsResponse", None, None]:
        yield from super().paginate()
...
class ResourceGroup(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ResourceGroup", None, None]:
        yield from super().paginate()
...
class ResourceGroupTag(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ResourceGroupTag", None, None]:
        yield from super().paginate()
...
class RulesPackage(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["RulesPackage", None, None]:
        yield from super().paginate()
...
class Scope(ShapeBase):
    ...
    key: "ScopeType" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class ServiceTemporarilyUnavailableException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ServiceTemporarilyUnavailableException", None, None]:
        yield from super().paginate()
...
class SetTagsForResourceRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SetTagsForResourceRequest", None, None]:
        yield from super().paginate()
...
class StartAssessmentRunRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["StartAssessmentRunRequest", None, None]:
        yield from super().paginate()
...
class StartAssessmentRunResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["StartAssessmentRunResponse", None, None]:
        yield from super().paginate()
...
class StopAssessmentRunRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["StopAssessmentRunRequest", None, None]:
        yield from super().paginate()
...
class SubscribeToEventRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["SubscribeToEventRequest", None, None]:
        yield from super().paginate()
...
class TelemetryMetadata(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TelemetryMetadata", None, None]:
        yield from super().paginate()
...
class TimestampRange(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TimestampRange", None, None]:
        yield from super().paginate()
...
class UnsubscribeFromEventRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnsubscribeFromEventRequest", None, None]:
        yield from super().paginate()
...
class UpdateAssessmentTargetRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateAssessmentTargetRequest", None, None]:
        yield from super().paginate()
