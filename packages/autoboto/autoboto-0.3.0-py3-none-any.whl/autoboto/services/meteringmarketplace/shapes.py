...
class BatchMeterUsageRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["BatchMeterUsageRequest", None, None]:
...
class BatchMeterUsageResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["BatchMeterUsageResult", None, None]:
        yield from super().paginate()
...
class InvalidCustomerIdentifierException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidCustomerIdentifierException", None, None]:
        yield from super().paginate()
...
class InvalidEndpointRegionException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidEndpointRegionException", None, None]:
        yield from super().paginate()
...
class InvalidProductCodeException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidProductCodeException", None, None]:
        yield from super().paginate()
...
class InvalidUsageDimensionException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidUsageDimensionException", None, None]:
        yield from super().paginate()
...
class MeterUsageRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["MeterUsageRequest", None, None]:
        yield from super().paginate()
...
class MeterUsageResult(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["MeterUsageResult", None, None]:
        yield from super().paginate()
...
class ResolveCustomerRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ResolveCustomerRequest", None, None]:
        yield from super().paginate()
...
class ResolveCustomerResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ResolveCustomerResult", None, None]:
        yield from super().paginate()
...
class TimestampOutOfBoundsException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["TimestampOutOfBoundsException", None, None]:
        yield from super().paginate()
...
class UsageRecord(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["UsageRecord", None, None]:
        yield from super().paginate()
...
class UsageRecordResult(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status",
                "Status",
                TypeInfo(UsageRecordResultStatus),
            ),
        ]
    ...
    def paginate(self, ) -> typing.Generator["UsageRecordResult", None, None]:
        yield from super().paginate()
