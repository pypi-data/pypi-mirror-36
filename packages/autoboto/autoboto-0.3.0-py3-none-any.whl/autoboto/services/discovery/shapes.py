...
class AgentConfigurationStatus(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AgentConfigurationStatus", None, None]:
...
class AgentInfo(ShapeBase):
    ...
    health: "AgentStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["AgentInfo", None, None]:
        yield from super().paginate()
...
class AgentNetworkInfo(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AgentNetworkInfo", None, None]:
        yield from super().paginate()
...
class AssociateConfigurationItemsToApplicationRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "AssociateConfigurationItemsToApplicationRequest", None, None]:
        yield from super().paginate()
...
class AssociateConfigurationItemsToApplicationResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "AssociateConfigurationItemsToApplicationResponse", None, None]:
        yield from super().paginate()
...
class ConfigurationTag(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "configuration_type",
                "configurationType",
                TypeInfo(ConfigurationItemType),
            ),
            (
                "configuration_id",
                "configurationId",
    ...
    def paginate(self, ) -> typing.Generator["ConfigurationTag", None, None]:
        yield from super().paginate()
...
class ConflictErrorException(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ConflictErrorException", None, None]:
        yield from super().paginate()
...
class ContinuousExportDescription(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status",
                "status",
                TypeInfo(ContinuousExportStatus),
            ),
            (
                "status_detail",
                "statusDetail",
    ...
    def paginate(
        self,
    ) -> typing.Generator["ContinuousExportDescription", None, None]:
        yield from super().paginate()
...
class CreateTagsResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CreateTagsResponse", None, None]:
        yield from super().paginate()
...
class CustomerAgentInfo(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CustomerAgentInfo", None, None]:
        yield from super().paginate()
...
class CustomerConnectorInfo(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["CustomerConnectorInfo", None, None]:
        yield from super().paginate()
...
class DeleteApplicationsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteApplicationsRequest", None, None]:
        yield from super().paginate()
...
class DeleteApplicationsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteApplicationsResponse", None, None]:
        yield from super().paginate()
...
class DeleteTagsResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DeleteTagsResponse", None, None]:
        yield from super().paginate()
...
class DescribeAgentsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeAgentsRequest", None, None]:
        yield from super().paginate()
...
class DescribeAgentsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeAgentsResponse", None, None]:
        yield from super().paginate()
...
class DescribeConfigurationsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeConfigurationsRequest", None, None]:
        yield from super().paginate()
...
class DescribeConfigurationsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeConfigurationsResponse", None, None]:
        yield from super().paginate()
...
class DescribeContinuousExportsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeContinuousExportsRequest", None, None]:
        yield from super().paginate()
...
class DescribeContinuousExportsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeContinuousExportsResponse", None, None]:
        yield from super().paginate()
...
class DescribeExportConfigurationsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeExportConfigurationsRequest", None, None]:
        yield from super().paginate()
...
class DescribeExportConfigurationsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DescribeExportConfigurationsResponse", None, None]:
        yield from super().paginate()
...
class DisassociateConfigurationItemsFromApplicationRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "DisassociateConfigurationItemsFromApplicationRequest", None, None]:
        yield from super().paginate()
...
class DisassociateConfigurationItemsFromApplicationResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator[
        "DisassociateConfigurationItemsFromApplicationResponse", None, None]:
        yield from super().paginate()
...
class ExportConfigurationsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ExportConfigurationsResponse", None, None]:
        yield from super().paginate()
...
class ExportFilter(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ExportFilter", None, None]:
        yield from super().paginate()
...
class ExportInfo(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ExportInfo", None, None]:
        yield from super().paginate()
...
class GetDiscoverySummaryRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetDiscoverySummaryRequest", None, None]:
        yield from super().paginate()
...
class GetDiscoverySummaryResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["GetDiscoverySummaryResponse", None, None]:
        yield from super().paginate()
...
class ListServerNeighborsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListServerNeighborsRequest", None, None]:
        yield from super().paginate()
...
class ListServerNeighborsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListServerNeighborsResponse", None, None]:
        yield from super().paginate()
...
class NeighborConnectionDetail(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["NeighborConnectionDetail", None, None]:
        yield from super().paginate()
...
class OrderByElement(ShapeBase):
    ...
    # Ordering direction.
    sort_order: "orderString" = dataclasses.field(default=ShapeBase.NOT_SET, )

    def paginate(self, ) -> typing.Generator["OrderByElement", None, None]:
        yield from super().paginate()
...
class ServerInternalErrorException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ServerInternalErrorException", None, None]:
        yield from super().paginate()
...
class StartContinuousExportRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StartContinuousExportRequest", None, None]:
        yield from super().paginate()
...
class StartContinuousExportResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StartContinuousExportResponse", None, None]:
        yield from super().paginate()
...
class StartDataCollectionByAgentIdsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StartDataCollectionByAgentIdsRequest", None, None]:
        yield from super().paginate()
...
class StartDataCollectionByAgentIdsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StartDataCollectionByAgentIdsResponse", None, None]:
        yield from super().paginate()
...
class StartExportTaskRequest(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "export_data_format",
                "exportDataFormat",
                TypeInfo(typing.List[ExportDataFormat]),
            ),
            (
                "filters",
                "filters",
    ...
    def paginate(self,
                ) -> typing.Generator["StartExportTaskRequest", None, None]:
        yield from super().paginate()
...
class StartExportTaskResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["StartExportTaskResponse", None, None]:
        yield from super().paginate()
...
class StopContinuousExportRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StopContinuousExportRequest", None, None]:
        yield from super().paginate()
...
class StopContinuousExportResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StopContinuousExportResponse", None, None]:
        yield from super().paginate()
...
class StopDataCollectionByAgentIdsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StopDataCollectionByAgentIdsRequest", None, None]:
        yield from super().paginate()
...
class StopDataCollectionByAgentIdsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StopDataCollectionByAgentIdsResponse", None, None]:
        yield from super().paginate()
