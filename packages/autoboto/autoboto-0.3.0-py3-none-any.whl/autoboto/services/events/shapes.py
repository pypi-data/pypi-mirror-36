...
class BatchArrayProperties(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["BatchArrayProperties", None, None]:
        yield from super().paginate()
...
class BatchParameters(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["BatchParameters", None, None]:
        yield from super().paginate()
...
class BatchRetryStrategy(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["BatchRetryStrategy", None, None]:
        yield from super().paginate()
...
class DescribeEventBusRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeEventBusRequest", None, None]:
        yield from super().paginate()
...
class DescribeEventBusResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeEventBusResponse", None, None]:
        yield from super().paginate()
...
class DescribeRuleRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DescribeRuleRequest", None, None]:
        yield from super().paginate()
...
class DescribeRuleResponse(OutputShapeBase):
    ...
    state: "RuleState" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self,
                ) -> typing.Generator["DescribeRuleResponse", None, None]:
        yield from super().paginate()
...
class DisableRuleRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DisableRuleRequest", None, None]:
        yield from super().paginate()
...
class EcsParameters(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EcsParameters", None, None]:
        yield from super().paginate()
...
class EnableRuleRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["EnableRuleRequest", None, None]:
        yield from super().paginate()
...
class InputTransformer(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InputTransformer", None, None]:
        yield from super().paginate()
...
class InvalidEventPatternException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["InvalidEventPatternException", None, None]:
        yield from super().paginate()
...
class KinesisParameters(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["KinesisParameters", None, None]:
        yield from super().paginate()
...
class ListRuleNamesByTargetRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListRuleNamesByTargetRequest", None, None]:
        yield from super().paginate()
...
class ListRuleNamesByTargetResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ListRuleNamesByTargetResponse", None, None]:
        yield from super().paginate()
...
class ListTargetsByRuleRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListTargetsByRuleRequest", None, None]:
        yield from super().paginate()
...
class ListTargetsByRuleResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListTargetsByRuleResponse", None, None]:
        yield from super().paginate()
...
class PutEventsRequestEntry(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutEventsRequestEntry", None, None]:
        yield from super().paginate()
...
class PutEventsResultEntry(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutEventsResultEntry", None, None]:
        yield from super().paginate()
...
class PutPermissionRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutPermissionRequest", None, None]:
        yield from super().paginate()
...
class PutRuleRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutRuleRequest", None, None]:
        yield from super().paginate()
...
class PutRuleResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutRuleResponse", None, None]:
        yield from super().paginate()
...
class PutTargetsRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutTargetsRequest", None, None]:
        yield from super().paginate()
...
class PutTargetsResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PutTargetsResponse", None, None]:
        yield from super().paginate()
...
class PutTargetsResultEntry(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PutTargetsResultEntry", None, None]:
        yield from super().paginate()
...
class RemoveTargetsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RemoveTargetsRequest", None, None]:
        yield from super().paginate()
...
class RemoveTargetsResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RemoveTargetsResponse", None, None]:
        yield from super().paginate()
...
class RemoveTargetsResultEntry(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RemoveTargetsResultEntry", None, None]:
        yield from super().paginate()
...
class RunCommandParameters(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["RunCommandParameters", None, None]:
        yield from super().paginate()
...
class RunCommandTarget(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["RunCommandTarget", None, None]:
        yield from super().paginate()
...
class SqsParameters(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["SqsParameters", None, None]:
        yield from super().paginate()
...
class TestEventPatternRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["TestEventPatternRequest", None, None]:
        yield from super().paginate()
...
class TestEventPatternResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["TestEventPatternResponse", None, None]:
        yield from super().paginate()
