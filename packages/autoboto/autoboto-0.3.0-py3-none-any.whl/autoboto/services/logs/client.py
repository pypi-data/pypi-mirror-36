...
class Client(ClientBase):
    ...
    def associate_kms_key(
        ...
        *,
        ...
        response = self._boto_client.associate_kms_key(
    ...
    def create_export_task(
        ...
        *,
        ...
        response = self._boto_client.create_export_task(
            **_request.to_boto_dict()
        )

        return shapes.CreateExportTaskResponse.from_boto_dict(response)
    ...
    def create_log_group(
        ...
        *,
        ...
        response = self._boto_client.create_log_group(**_request.to_boto_dict())
    ...
    def create_log_stream(
        ...
        *,
        ...
        response = self._boto_client.create_log_stream(
            **_request.to_boto_dict()
        )
    ...
    def delete_destination(
        ...
        *,
        ...
        response = self._boto_client.delete_destination(
            **_request.to_boto_dict()
        )
    ...
    def delete_log_group(
        ...
        *,
        ...
        response = self._boto_client.delete_log_group(**_request.to_boto_dict())
    ...
    def delete_log_stream(
        ...
        *,
        ...
        response = self._boto_client.delete_log_stream(
            **_request.to_boto_dict()
        )
    ...
    def delete_metric_filter(
        ...
        *,
        ...
        response = self._boto_client.delete_metric_filter(
            **_request.to_boto_dict()
        )
    ...
    def describe_destinations(
        ...
        *,
        ...
        result = shapes.DescribeDestinationsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeDestinationsResponse.from_boto_dict(response)
    ...
    def describe_export_tasks(
        ...
        *,
        ...
        status_code: shapes.ExportTaskStatusCode = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        ...
        return shapes.DescribeExportTasksResponse.from_boto_dict(response)
    ...
    def describe_log_groups(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeLogGroupsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeLogGroupsResponse.from_boto_dict(response)
    ...
    def describe_log_streams(
        ...
        *,
        log_group_name: str,
        log_stream_name_prefix: str = ShapeBase.NOT_SET,
        order_by: shapes.OrderBy = ShapeBase.NOT_SET,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeLogStreamsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeLogStreamsResponse.from_boto_dict(response)
    ...
    def describe_metric_filters(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeMetricFiltersResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.DescribeMetricFiltersResponse.from_boto_dict(response)
    ...
    def describe_resource_policies(
        ...
        *,
        ...
        return shapes.DescribeResourcePoliciesResponse.from_boto_dict(response)
    ...
    def describe_subscription_filters(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.DescribeSubscriptionFiltersResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.DescribeSubscriptionFiltersResponse.from_boto_dict(
            response
        )
    ...
    def disassociate_kms_key(
        ...
        *,
        ...
        response = self._boto_client.disassociate_kms_key(
            **_request.to_boto_dict()
        )
    ...
    def filter_log_events(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.FilterLogEventsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.FilterLogEventsResponse.from_boto_dict(response)
    ...
    def get_log_events(
        ...
        *,
        ...
        response = self._boto_client.get_log_events(**_request.to_boto_dict())

        return shapes.GetLogEventsResponse.from_boto_dict(response)
    ...
    def list_tags_log_group(
        ...
        *,
        ...
        response = self._boto_client.list_tags_log_group(
            **_request.to_boto_dict()
        )

        return shapes.ListTagsLogGroupResponse.from_boto_dict(response)
    ...
    def put_destination(
        ...
        *,
        ...
        response = self._boto_client.put_destination(**_request.to_boto_dict())

        return shapes.PutDestinationResponse.from_boto_dict(response)
    ...
    def put_log_events(
        ...
        *,
        ...
        response = self._boto_client.put_log_events(**_request.to_boto_dict())

        return shapes.PutLogEventsResponse.from_boto_dict(response)
    ...
    def put_metric_filter(
        ...
        *,
        ...
        response = self._boto_client.put_metric_filter(
            **_request.to_boto_dict()
        )
    ...
    def put_resource_policy(
        ...
        *,
        ...
        response = self._boto_client.put_resource_policy(
            **_request.to_boto_dict()
        )

        return shapes.PutResourcePolicyResponse.from_boto_dict(response)
    ...
    def put_retention_policy(
        ...
        *,
        ...
        response = self._boto_client.put_retention_policy(
            **_request.to_boto_dict()
        )
    ...
    def put_subscription_filter(
        ...
        *,
        ...
        distribution: shapes.Distribution = ShapeBase.NOT_SET,
    ) -> None:
        """
    ...
    def tag_log_group(
        ...
        *,
        ...
        response = self._boto_client.tag_log_group(**_request.to_boto_dict())
    ...
    def test_metric_filter(
        ...
        *,
        ...
        response = self._boto_client.test_metric_filter(
            **_request.to_boto_dict()
        )

        return shapes.TestMetricFilterResponse.from_boto_dict(response)
    ...
    def untag_log_group(
        ...
        *,
        ...
        response = self._boto_client.untag_log_group(**_request.to_boto_dict())
