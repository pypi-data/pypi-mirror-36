...
class Connector(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status",
                "status",
                TypeInfo(ConnectorStatus),
            ),
            (
                "capability_list",
                "capabilityList",
                TypeInfo(typing.List[ConnectorCapability]),
            ),
            (
                "vm_manager_name",
                "vmManagerName",
    ...
    status: "ConnectorStatus" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["Connector", None, None]:
...
class CreateReplicationJobRequest(ShapeBase):
    ...
    license_type: "LicenseType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateReplicationJobRequest", None, None]:
        yield from super().paginate()
...
class CreateReplicationJobResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["CreateReplicationJobResponse", None, None]:
        yield from super().paginate()
...
class DeleteReplicationJobRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteReplicationJobRequest", None, None]:
        yield from super().paginate()
...
class DeleteReplicationJobResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteReplicationJobResponse", None, None]:
        yield from super().paginate()
...
class DeleteServerCatalogRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeleteServerCatalogRequest", None, None]:
        yield from super().paginate()
...
class DeleteServerCatalogResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DeleteServerCatalogResponse", None, None]:
        yield from super().paginate()
...
class DisassociateConnectorRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DisassociateConnectorRequest", None, None]:
        yield from super().paginate()
...
class DisassociateConnectorResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DisassociateConnectorResponse", None, None]:
        yield from super().paginate()
...
class GetConnectorsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetConnectorsRequest", None, None]:
        yield from super().paginate()
...
class GetReplicationJobsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetReplicationJobsRequest", None, None]:
        yield from super().paginate()
...
class GetReplicationRunsRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["GetReplicationRunsRequest", None, None]:
        yield from super().paginate()
...
class GetServersRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["GetServersRequest", None, None]:
        yield from super().paginate()
...
class ImportServerCatalogRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ImportServerCatalogRequest", None, None]:
        yield from super().paginate()
...
class ImportServerCatalogResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ImportServerCatalogResponse", None, None]:
        yield from super().paginate()
...
class InternalError(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InternalError", None, None]:
        yield from super().paginate()
...
class NoConnectorsAvailableException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["NoConnectorsAvailableException", None, None]:
        yield from super().paginate()
...
class ReplicationJob(ShapeBase):
    ...
    # Type of server.
    server_type: "ServerType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["ReplicationJob", None, None]:
        yield from super().paginate()
...
class ReplicationJobAlreadyExistsException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ReplicationJobAlreadyExistsException", None, None]:
        yield from super().paginate()
...
class ReplicationJobNotFoundException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ReplicationJobNotFoundException", None, None]:
        yield from super().paginate()
...
class ReplicationRun(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "state",
                "state",
                TypeInfo(ReplicationRunState),
            ),
            (
                "type",
                "type",
                TypeInfo(ReplicationRunType),
            ),
            (
                "status_message",
                "statusMessage",
    ...
    type: "ReplicationRunType" = dataclasses.field(default=ShapeBase.NOT_SET, )
    ...
    def paginate(self, ) -> typing.Generator["ReplicationRun", None, None]:
        yield from super().paginate()
...
class ReplicationRunLimitExceededException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ReplicationRunLimitExceededException", None, None]:
        yield from super().paginate()
...
class ServerCannotBeReplicatedException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["ServerCannotBeReplicatedException", None, None]:
        yield from super().paginate()
...
class StartOnDemandReplicationRunRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StartOnDemandReplicationRunRequest", None, None]:
        yield from super().paginate()
...
class StartOnDemandReplicationRunResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["StartOnDemandReplicationRunResponse", None, None]:
        yield from super().paginate()
...
class UpdateReplicationJobRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateReplicationJobRequest", None, None]:
        yield from super().paginate()
...
class UpdateReplicationJobResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdateReplicationJobResponse", None, None]:
        yield from super().paginate()
...
class VmServer(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["VmServer", None, None]:
        yield from super().paginate()
...
class VmServerAddress(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["VmServerAddress", None, None]:
        yield from super().paginate()
