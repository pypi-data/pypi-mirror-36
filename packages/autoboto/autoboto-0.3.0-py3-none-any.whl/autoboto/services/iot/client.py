...
class Client(ClientBase):
    ...
    def add_thing_to_thing_group(
        ...
        *,
        ...
        return shapes.AddThingToThingGroupResponse.from_boto_dict(response)
    ...
    def associate_targets_with_job(
        ...
        *,
        ...
        return shapes.AssociateTargetsWithJobResponse.from_boto_dict(response)
    ...
    def attach_policy(
        ...
        *,
        ...
        response = self._boto_client.attach_policy(**_request.to_boto_dict())
    ...
    def attach_security_profile(
        ...
        *,
        ...
        return shapes.AttachSecurityProfileResponse.from_boto_dict(response)
    ...
    def attach_thing_principal(
        ...
        *,
        ...
        return shapes.AttachThingPrincipalResponse.from_boto_dict(response)
    ...
    def cancel_audit_task(
        ...
        *,
        ...
        response = self._boto_client.cancel_audit_task(
            **_request.to_boto_dict()
        )

        return shapes.CancelAuditTaskResponse.from_boto_dict(response)
    ...
    def cancel_job_execution(
        ...
        *,
        ...
        response = self._boto_client.cancel_job_execution(
            **_request.to_boto_dict()
        )
    ...
    def clear_default_authorizer(
        ...
        return shapes.ClearDefaultAuthorizerResponse.from_boto_dict(response)
    ...
    def create_authorizer(
        ...
        *,
        ...
        status: shapes.AuthorizerStatus = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_authorizer(
            **_request.to_boto_dict()
        )

        return shapes.CreateAuthorizerResponse.from_boto_dict(response)
    ...
    def create_certificate_from_csr(
        ...
        **Note:** Reusing the same certificate signing request (CSR) results in a
        ...
        return shapes.CreateCertificateFromCsrResponse.from_boto_dict(response)
    ...
    def create_job(
        ...
        *,
        ...
        target_selection: shapes.TargetSelection = ShapeBase.NOT_SET,
    ...
    def create_keys_and_certificate(
        ...
        **Note** This is the only time AWS IoT issues the private key for this
        ...
        return shapes.CreateKeysAndCertificateResponse.from_boto_dict(response)
    ...
    def create_ota_update(
        ...
        *,
        ...
        response = self._boto_client.create_ota_update(
            **_request.to_boto_dict()
        )

        return shapes.CreateOTAUpdateResponse.from_boto_dict(response)
    ...
    def create_policy(
        ...
        *,
        ...
        response = self._boto_client.create_policy(**_request.to_boto_dict())

        return shapes.CreatePolicyResponse.from_boto_dict(response)
    ...
    def create_policy_version(
        ...
        *,
        ...
        response = self._boto_client.create_policy_version(
            **_request.to_boto_dict()
        )

        return shapes.CreatePolicyVersionResponse.from_boto_dict(response)
    ...
    def create_role_alias(
        ...
        *,
        ...
        response = self._boto_client.create_role_alias(
            **_request.to_boto_dict()
        )

        return shapes.CreateRoleAliasResponse.from_boto_dict(response)

    def create_scheduled_audit(
        self,
        _request: shapes.CreateScheduledAuditRequest = None,
        *,
        frequency: shapes.AuditFrequency,
        target_check_names: typing.List[str],
        scheduled_audit_name: str,
        day_of_month: str = ShapeBase.NOT_SET,
        day_of_week: shapes.DayOfWeek = ShapeBase.NOT_SET,
        ...
        return shapes.CreateScheduledAuditResponse.from_boto_dict(response)
    ...
    def create_security_profile(
        ...
        *,
        ...
        alert_targets: typing.Dict[shapes.AlertTargetType, shapes.
                                   AlertTarget] = ShapeBase.NOT_SET,
        ...
        return shapes.CreateSecurityProfileResponse.from_boto_dict(response)
    ...
    def create_stream(
        ...
        *,
        ...
        return shapes.CreateStreamResponse.from_boto_dict(response)
    ...
    def create_thing(
        ...
        *,
        ...
        response = self._boto_client.create_thing(**_request.to_boto_dict())

        return shapes.CreateThingResponse.from_boto_dict(response)
    ...
    def create_thing_group(
        ...
        *,
        ...
        response = self._boto_client.create_thing_group(
            **_request.to_boto_dict()
        )

        return shapes.CreateThingGroupResponse.from_boto_dict(response)
    ...
    def create_thing_type(
        ...
        *,
        ...
        response = self._boto_client.create_thing_type(
            **_request.to_boto_dict()
        )

        return shapes.CreateThingTypeResponse.from_boto_dict(response)
    ...
    def create_topic_rule(
        ...
        *,
        ...
        response = self._boto_client.create_topic_rule(
            **_request.to_boto_dict()
        )
    ...
    def delete_account_audit_configuration(
        ...
        *,
        ...
        return shapes.DeleteAccountAuditConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def delete_authorizer(
        ...
        *,
        ...
        response = self._boto_client.delete_authorizer(
            **_request.to_boto_dict()
        )

        return shapes.DeleteAuthorizerResponse.from_boto_dict(response)
    ...
    def delete_ca_certificate(
        ...
        *,
        ...
        response = self._boto_client.delete_ca_certificate(
            **_request.to_boto_dict()
        )

        return shapes.DeleteCACertificateResponse.from_boto_dict(response)
    ...
    def delete_certificate(
        ...
        *,
        ...
        response = self._boto_client.delete_certificate(
            **_request.to_boto_dict()
        )
    ...
    def delete_job(
        ...
        *,
        ...
        response = self._boto_client.delete_job(**_request.to_boto_dict())
    ...
    def delete_job_execution(
        ...
        *,
        ...
        response = self._boto_client.delete_job_execution(
            **_request.to_boto_dict()
        )
    ...
    def delete_ota_update(
        ...
        *,
        ...
        response = self._boto_client.delete_ota_update(
            **_request.to_boto_dict()
        )

        return shapes.DeleteOTAUpdateResponse.from_boto_dict(response)
    ...
    def delete_policy(
        ...
        *,
        ...
        response = self._boto_client.delete_policy(**_request.to_boto_dict())
    ...
    def delete_policy_version(
        ...
        *,
        ...
        response = self._boto_client.delete_policy_version(
            **_request.to_boto_dict()
        )
    ...
    def delete_registration_code(
        ...
        return shapes.DeleteRegistrationCodeResponse.from_boto_dict(response)
    ...
    def delete_role_alias(
        ...
        *,
        ...
        response = self._boto_client.delete_role_alias(
            **_request.to_boto_dict()
        )

        return shapes.DeleteRoleAliasResponse.from_boto_dict(response)
    ...
    def delete_scheduled_audit(
        ...
        *,
        ...
        return shapes.DeleteScheduledAuditResponse.from_boto_dict(response)
    ...
    def delete_security_profile(
        ...
        *,
        ...
        return shapes.DeleteSecurityProfileResponse.from_boto_dict(response)
    ...
    def delete_stream(
        ...
        *,
        ...
        return shapes.DeleteStreamResponse.from_boto_dict(response)
    ...
    def delete_thing(
        ...
        *,
        ...
        response = self._boto_client.delete_thing(**_request.to_boto_dict())

        return shapes.DeleteThingResponse.from_boto_dict(response)
    ...
    def delete_thing_group(
        ...
        *,
        ...
        response = self._boto_client.delete_thing_group(
            **_request.to_boto_dict()
        )

        return shapes.DeleteThingGroupResponse.from_boto_dict(response)
    ...
    def delete_thing_type(
        ...
        *,
        ...
        response = self._boto_client.delete_thing_type(
            **_request.to_boto_dict()
        )

        return shapes.DeleteThingTypeResponse.from_boto_dict(response)
    ...
    def delete_topic_rule(
        ...
        *,
        ...
        response = self._boto_client.delete_topic_rule(
            **_request.to_boto_dict()
        )
    ...
    def delete_v2_logging_level(
        ...
        *,
        target_type: shapes.LogTargetType,
        target_name: str,
    ) -> None:
        """
    ...
    def deprecate_thing_type(
        ...
        *,
        ...
        response = self._boto_client.deprecate_thing_type(
            **_request.to_boto_dict()
        )

        return shapes.DeprecateThingTypeResponse.from_boto_dict(response)
    ...
    def describe_account_audit_configuration(
        ...
        return shapes.DescribeAccountAuditConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def describe_audit_task(
        ...
        *,
        ...
        response = self._boto_client.describe_audit_task(
            **_request.to_boto_dict()
        )

        return shapes.DescribeAuditTaskResponse.from_boto_dict(response)
    ...
    def describe_authorizer(
        ...
        *,
        ...
        response = self._boto_client.describe_authorizer(
            **_request.to_boto_dict()
        )

        return shapes.DescribeAuthorizerResponse.from_boto_dict(response)
    ...
    def describe_ca_certificate(
        ...
        *,
        ...
        return shapes.DescribeCACertificateResponse.from_boto_dict(response)
    ...
    def describe_certificate(
        ...
        *,
        ...
        response = self._boto_client.describe_certificate(
            **_request.to_boto_dict()
        )

        return shapes.DescribeCertificateResponse.from_boto_dict(response)
    ...
    def describe_default_authorizer(
        ...
        return shapes.DescribeDefaultAuthorizerResponse.from_boto_dict(response)
    ...
    def describe_endpoint(
        ...
        *,
        ...
        return shapes.DescribeEndpointResponse.from_boto_dict(response)
    ...
    def describe_event_configurations(
        ...
        return shapes.DescribeEventConfigurationsResponse.from_boto_dict(
            response
        )
    ...
    def describe_index(
        ...
        *,
        ...
        response = self._boto_client.describe_index(**_request.to_boto_dict())

        return shapes.DescribeIndexResponse.from_boto_dict(response)
    ...
    def describe_job(
        ...
        *,
        ...
        return shapes.DescribeJobResponse.from_boto_dict(response)
    ...
    def describe_job_execution(
        ...
        *,
        ...
        return shapes.DescribeJobExecutionResponse.from_boto_dict(response)
    ...
    def describe_role_alias(
        ...
        *,
        ...
        response = self._boto_client.describe_role_alias(
            **_request.to_boto_dict()
        )

        return shapes.DescribeRoleAliasResponse.from_boto_dict(response)
    ...
    def describe_scheduled_audit(
        ...
        *,
        ...
        return shapes.DescribeScheduledAuditResponse.from_boto_dict(response)
    ...
    def describe_security_profile(
        ...
        *,
        ...
        return shapes.DescribeSecurityProfileResponse.from_boto_dict(response)
    ...
    def describe_stream(
        ...
        *,
        ...
        return shapes.DescribeStreamResponse.from_boto_dict(response)
    ...
    def describe_thing(
        ...
        *,
        ...
        response = self._boto_client.describe_thing(**_request.to_boto_dict())

        return shapes.DescribeThingResponse.from_boto_dict(response)
    ...
    def describe_thing_group(
        ...
        *,
        ...
        response = self._boto_client.describe_thing_group(
            **_request.to_boto_dict()
        )

        return shapes.DescribeThingGroupResponse.from_boto_dict(response)
    ...
    def describe_thing_registration_task(
        ...
        *,
        ...
        return shapes.DescribeThingRegistrationTaskResponse.from_boto_dict(
            response
        )
    ...
    def describe_thing_type(
        ...
        *,
        ...
        response = self._boto_client.describe_thing_type(
            **_request.to_boto_dict()
        )

        return shapes.DescribeThingTypeResponse.from_boto_dict(response)
    ...
    def detach_policy(
        ...
        *,
        ...
        response = self._boto_client.detach_policy(**_request.to_boto_dict())
    ...
    def detach_security_profile(
        ...
        *,
        ...
        return shapes.DetachSecurityProfileResponse.from_boto_dict(response)
    ...
    def detach_thing_principal(
        ...
        *,
        ...
        return shapes.DetachThingPrincipalResponse.from_boto_dict(response)
    ...
    def disable_topic_rule(
        ...
        *,
        ...
        response = self._boto_client.disable_topic_rule(
            **_request.to_boto_dict()
        )
    ...
    def enable_topic_rule(
        ...
        *,
        ...
        response = self._boto_client.enable_topic_rule(
            **_request.to_boto_dict()
        )
    ...
    def get_effective_policies(
        ...
        *,
        ...
        return shapes.GetEffectivePoliciesResponse.from_boto_dict(response)
    ...
    def get_indexing_configuration(
        ...
        return shapes.GetIndexingConfigurationResponse.from_boto_dict(response)
    ...
    def get_job_document(
        ...
        *,
        ...
        response = self._boto_client.get_job_document(**_request.to_boto_dict())

        return shapes.GetJobDocumentResponse.from_boto_dict(response)
    ...
    def get_logging_options(
        ...
        response = self._boto_client.get_logging_options(
            **_request.to_boto_dict()
        )

        return shapes.GetLoggingOptionsResponse.from_boto_dict(response)
    ...
    def get_ota_update(
        ...
        *,
        ...
        response = self._boto_client.get_ota_update(**_request.to_boto_dict())

        return shapes.GetOTAUpdateResponse.from_boto_dict(response)
    ...
    def get_policy(
        ...
        *,
        ...
        response = self._boto_client.get_policy(**_request.to_boto_dict())

        return shapes.GetPolicyResponse.from_boto_dict(response)
    ...
    def get_policy_version(
        ...
        *,
        ...
        response = self._boto_client.get_policy_version(
            **_request.to_boto_dict()
        )

        return shapes.GetPolicyVersionResponse.from_boto_dict(response)
    ...
    def get_registration_code(
        ...
        response = self._boto_client.get_registration_code(
            **_request.to_boto_dict()
        )

        return shapes.GetRegistrationCodeResponse.from_boto_dict(response)
    ...
    def get_topic_rule(
        ...
        *,
        ...
        response = self._boto_client.get_topic_rule(**_request.to_boto_dict())

        return shapes.GetTopicRuleResponse.from_boto_dict(response)
    ...
    def get_v2_logging_options(
        ...
        return shapes.GetV2LoggingOptionsResponse.from_boto_dict(response)
    ...
    def list_active_violations(
        ...
        *,
        ...
        return shapes.ListActiveViolationsResponse.from_boto_dict(response)
    ...
    def list_attached_policies(
        ...
        *,
        ...
        return shapes.ListAttachedPoliciesResponse.from_boto_dict(response)
    ...
    def list_audit_findings(
        ...
        *,
        ...
        response = self._boto_client.list_audit_findings(
            **_request.to_boto_dict()
        )

        return shapes.ListAuditFindingsResponse.from_boto_dict(response)
    ...
    def list_audit_tasks(
        ...
        *,
        ...
        task_type: shapes.AuditTaskType = ShapeBase.NOT_SET,
        task_status: shapes.AuditTaskStatus = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_audit_tasks(**_request.to_boto_dict())

        return shapes.ListAuditTasksResponse.from_boto_dict(response)
    ...
    def list_authorizers(
        ...
        *,
        ...
        response = self._boto_client.list_authorizers(**_request.to_boto_dict())

        return shapes.ListAuthorizersResponse.from_boto_dict(response)
    ...
    def list_ca_certificates(
        ...
        *,
        ...
        result = shapes.ListCACertificatesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListCACertificatesResponse.from_boto_dict(response)
    ...
    def list_certificates(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListCertificatesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListCertificatesResponse.from_boto_dict(response)
    ...
    def list_certificates_by_ca(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListCertificatesByCAResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListCertificatesByCAResponse.from_boto_dict(response)
    ...
    def list_indices(
        ...
        *,
        ...
        response = self._boto_client.list_indices(**_request.to_boto_dict())

        return shapes.ListIndicesResponse.from_boto_dict(response)
    ...
    def list_job_executions_for_job(
        ...
        *,
        job_id: str,
        status: shapes.JobExecutionStatus = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        return shapes.ListJobExecutionsForJobResponse.from_boto_dict(response)
    ...
    def list_job_executions_for_thing(
        ...
        *,
        ...
        return shapes.ListJobExecutionsForThingResponse.from_boto_dict(response)
    ...
    def list_ota_updates(
        ...
        *,
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ota_update_status: shapes.OTAUpdateStatus = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_ota_updates(**_request.to_boto_dict())

        return shapes.ListOTAUpdatesResponse.from_boto_dict(response)
    ...
    def list_outgoing_certificates(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListOutgoingCertificatesResponse.from_boto_dict(
            first_page
        )
        result._page_iterator = page_generator
        return result

        return shapes.ListOutgoingCertificatesResponse.from_boto_dict(response)
    ...
    def list_policies(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPoliciesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListPoliciesResponse.from_boto_dict(response)
    ...
    def list_policy_principals(
        ...
        **Note:** This API is deprecated. Please use ListTargetsForPolicy instead.
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPolicyPrincipalsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListPolicyPrincipalsResponse.from_boto_dict(response)
    ...
    def list_policy_versions(
        ...
        *,
        ...
        response = self._boto_client.list_policy_versions(
            **_request.to_boto_dict()
        )

        return shapes.ListPolicyVersionsResponse.from_boto_dict(response)
    ...
    def list_principal_policies(
        ...
        **Note:** This API is deprecated. Please use ListAttachedPolicies instead.
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPrincipalPoliciesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListPrincipalPoliciesResponse.from_boto_dict(response)
    ...
    def list_principal_things(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListPrincipalThingsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListPrincipalThingsResponse.from_boto_dict(response)
    ...
    def list_role_aliases(
        ...
        *,
        ...
        response = self._boto_client.list_role_aliases(
            **_request.to_boto_dict()
        )

        return shapes.ListRoleAliasesResponse.from_boto_dict(response)
    ...
    def list_scheduled_audits(
        ...
        *,
        ...
        response = self._boto_client.list_scheduled_audits(
            **_request.to_boto_dict()
        )

        return shapes.ListScheduledAuditsResponse.from_boto_dict(response)
    ...
    def list_security_profiles(
        ...
        *,
        ...
        return shapes.ListSecurityProfilesResponse.from_boto_dict(response)
    ...
    def list_security_profiles_for_target(
        ...
        *,
        ...
        return shapes.ListSecurityProfilesForTargetResponse.from_boto_dict(
            response
        )
    ...
    def list_streams(
        ...
        *,
        ...
        return shapes.ListStreamsResponse.from_boto_dict(response)
    ...
    def list_targets_for_policy(
        ...
        *,
        ...
        return shapes.ListTargetsForPolicyResponse.from_boto_dict(response)
    ...
    def list_targets_for_security_profile(
        ...
        *,
        ...
        return shapes.ListTargetsForSecurityProfileResponse.from_boto_dict(
            response
        )
    ...
    def list_thing_groups(
        ...
        *,
        ...
        response = self._boto_client.list_thing_groups(
            **_request.to_boto_dict()
        )

        return shapes.ListThingGroupsResponse.from_boto_dict(response)
    ...
    def list_thing_groups_for_thing(
        ...
        *,
        ...
        return shapes.ListThingGroupsForThingResponse.from_boto_dict(response)
    ...
    def list_thing_principals(
        ...
        *,
        ...
        response = self._boto_client.list_thing_principals(
            **_request.to_boto_dict()
        )

        return shapes.ListThingPrincipalsResponse.from_boto_dict(response)
    ...
    def list_thing_registration_task_reports(
        ...
        *,
        ...
        return shapes.ListThingRegistrationTaskReportsResponse.from_boto_dict(
            response
        )
    ...
    def list_thing_registration_tasks(
        ...
        *,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        status: shapes.Status = ShapeBase.NOT_SET,
        ...
        return shapes.ListThingRegistrationTasksResponse.from_boto_dict(
            response
        )
    ...
    def list_thing_types(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListThingTypesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListThingTypesResponse.from_boto_dict(response)
    ...
    def list_things(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListThingsResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListThingsResponse.from_boto_dict(response)
    ...
    def list_things_in_thing_group(
        ...
        *,
        ...
        return shapes.ListThingsInThingGroupResponse.from_boto_dict(response)
    ...
    def list_topic_rules(
        ...
        *,
        ...
        page_generator = (page for page in paginator)
        first_page = next(page_generator)
        result = shapes.ListTopicRulesResponse.from_boto_dict(first_page)
        result._page_iterator = page_generator
        return result

        return shapes.ListTopicRulesResponse.from_boto_dict(response)

    def list_v2_logging_levels(
        self,
        _request: shapes.ListV2LoggingLevelsRequest = None,
        *,
        target_type: shapes.LogTargetType = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        ...
        return shapes.ListV2LoggingLevelsResponse.from_boto_dict(response)
    ...
    def list_violation_events(
        ...
        *,
        ...
        response = self._boto_client.list_violation_events(
            **_request.to_boto_dict()
        )

        return shapes.ListViolationEventsResponse.from_boto_dict(response)
    ...
    def register_ca_certificate(
        ...
        *,
        ...
        return shapes.RegisterCACertificateResponse.from_boto_dict(response)
    ...
    def register_certificate(
        ...
        *,
        ...
        set_as_active: bool = ShapeBase.NOT_SET,
        status: shapes.CertificateStatus = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.register_certificate(
            **_request.to_boto_dict()
        )

        return shapes.RegisterCertificateResponse.from_boto_dict(response)
    ...
    def register_thing(
        ...
        *,
        ...
        response = self._boto_client.register_thing(**_request.to_boto_dict())

        return shapes.RegisterThingResponse.from_boto_dict(response)
    ...
    def remove_thing_from_thing_group(
        ...
        *,
        ...
        return shapes.RemoveThingFromThingGroupResponse.from_boto_dict(response)
    ...
    def replace_topic_rule(
        ...
        *,
        ...
        response = self._boto_client.replace_topic_rule(
            **_request.to_boto_dict()
        )
    ...
    def search_index(
        ...
        *,
        ...
        response = self._boto_client.search_index(**_request.to_boto_dict())

        return shapes.SearchIndexResponse.from_boto_dict(response)
    ...
    def set_default_authorizer(
        ...
        *,
        ...
        return shapes.SetDefaultAuthorizerResponse.from_boto_dict(response)
    ...
    def set_logging_options(
        ...
        *,
        ...
        response = self._boto_client.set_logging_options(
            **_request.to_boto_dict()
        )
    ...
    def set_v2_logging_level(
        ...
        *,
        ...
        response = self._boto_client.set_v2_logging_level(
            **_request.to_boto_dict()
        )
    ...
    def set_v2_logging_options(
        ...
        *,
        ...
        default_log_level: shapes.LogLevel = ShapeBase.NOT_SET,
    ...
    def start_on_demand_audit_task(
        ...
        *,
        ...
        return shapes.StartOnDemandAuditTaskResponse.from_boto_dict(response)
    ...
    def start_thing_registration_task(
        ...
        *,
        ...
        return shapes.StartThingRegistrationTaskResponse.from_boto_dict(
            response
        )
    ...
    def stop_thing_registration_task(
        ...
        *,
        ...
        return shapes.StopThingRegistrationTaskResponse.from_boto_dict(response)
    ...
    def test_authorization(
        ...
        *,
        ...
        response = self._boto_client.test_authorization(
            **_request.to_boto_dict()
        )

        return shapes.TestAuthorizationResponse.from_boto_dict(response)
    ...
    def test_invoke_authorizer(
        ...
        *,
        ...
        return shapes.TestInvokeAuthorizerResponse.from_boto_dict(response)
    ...
    def transfer_certificate(
        ...
        *,
        ...
        response = self._boto_client.transfer_certificate(
            **_request.to_boto_dict()
        )

        return shapes.TransferCertificateResponse.from_boto_dict(response)
    ...
    def update_account_audit_configuration(
        ...
        *,
        ...
        Dict[shapes.AuditNotificationType, shapes.
        ...
        return shapes.UpdateAccountAuditConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def update_authorizer(
        ...
        *,
        ...
        response = self._boto_client.update_authorizer(
            **_request.to_boto_dict()
        )

        return shapes.UpdateAuthorizerResponse.from_boto_dict(response)
    ...
    def update_ca_certificate(
        ...
        *,
        certificate_id: str,
        new_status: shapes.CACertificateStatus = ShapeBase.NOT_SET,
        new_auto_registration_status: shapes.AutoRegistrationStatus = ShapeBase.
        NOT_SET,
        registration_config: shapes.RegistrationConfig = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.update_ca_certificate(
            **_request.to_boto_dict()
        )
    ...
    def update_certificate(
        ...
        *,
        certificate_id: str,
        new_status: shapes.CertificateStatus,
    ) -> None:
        """
        ...
        response = self._boto_client.update_certificate(
            **_request.to_boto_dict()
        )
    ...
    def update_event_configurations(
        ...
        *,
        event_configurations: typing.Dict[shapes.EventType, shapes.
        ...
        return shapes.UpdateEventConfigurationsResponse.from_boto_dict(response)
    ...
    def update_indexing_configuration(
        ...
        *,
        ...
        return shapes.UpdateIndexingConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def update_role_alias(
        ...
        *,
        ...
        response = self._boto_client.update_role_alias(
            **_request.to_boto_dict()
        )

        return shapes.UpdateRoleAliasResponse.from_boto_dict(response)
    ...
    def update_scheduled_audit(
        ...
        *,
        scheduled_audit_name: str,
        frequency: shapes.AuditFrequency = ShapeBase.NOT_SET,
        day_of_month: str = ShapeBase.NOT_SET,
        day_of_week: shapes.DayOfWeek = ShapeBase.NOT_SET,
        ...
        return shapes.UpdateScheduledAuditResponse.from_boto_dict(response)
    ...
    def update_security_profile(
        ...
        *,
        ...
        return shapes.UpdateSecurityProfileResponse.from_boto_dict(response)
    ...
    def update_stream(
        ...
        *,
        ...
        response = self._boto_client.update_stream(**_request.to_boto_dict())

        return shapes.UpdateStreamResponse.from_boto_dict(response)
    ...
    def update_thing(
        ...
        *,
        ...
        response = self._boto_client.update_thing(**_request.to_boto_dict())

        return shapes.UpdateThingResponse.from_boto_dict(response)
    ...
    def update_thing_group(
        ...
        *,
        ...
        response = self._boto_client.update_thing_group(
            **_request.to_boto_dict()
        )

        return shapes.UpdateThingGroupResponse.from_boto_dict(response)
    ...
    def update_thing_groups_for_thing(
        ...
        *,
        ...
        return shapes.UpdateThingGroupsForThingResponse.from_boto_dict(response)
    ...
    def validate_security_profile_behaviors(
        ...
        *,
        ...
        return shapes.ValidateSecurityProfileBehaviorsResponse.from_boto_dict(
            response
        )
