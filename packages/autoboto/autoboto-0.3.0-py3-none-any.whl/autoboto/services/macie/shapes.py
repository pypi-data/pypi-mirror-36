...
class AssociateMemberAccountRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AssociateMemberAccountRequest", None, None]:
        yield from super().paginate()
...
class AssociateS3ResourcesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["AssociateS3ResourcesRequest", None, None]:
        yield from super().paginate()
...
class AssociateS3ResourcesResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["AssociateS3ResourcesResult", None, None]:
        yield from super().paginate()
...
class ClassificationType(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "one_time",
                "oneTime",
                TypeInfo(S3OneTimeClassificationType),
            ),
            (
                "continuous",
                "continuous",
                TypeInfo(S3ContinuousClassificationType),
            ),
        ]
    ...
    def paginate(self, ) -> typing.Generator["ClassificationType", None, None]:
        yield from super().paginate()
...
class ClassificationTypeUpdate(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ClassificationTypeUpdate", None, None]:
        yield from super().paginate()
...
class DisassociateMemberAccountRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DisassociateMemberAccountRequest", None, None]:
        yield from super().paginate()
...
class DisassociateS3ResourcesRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DisassociateS3ResourcesRequest", None, None]:
        yield from super().paginate()
...
class DisassociateS3ResourcesResult(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DisassociateS3ResourcesResult", None, None]:
        yield from super().paginate()
...
class FailedS3Resource(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["FailedS3Resource", None, None]:
        yield from super().paginate()
...
class ListMemberAccountsResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListMemberAccountsResult", None, None]:
        yield from super().paginate()
...
class ListS3ResourcesRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListS3ResourcesRequest", None, None]:
        yield from super().paginate()
...
class ListS3ResourcesResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListS3ResourcesResult", None, None]:
        yield from super().paginate()
...
class MemberAccount(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["MemberAccount", None, None]:
        yield from super().paginate()
...
class S3ResourceClassification(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["S3ResourceClassification", None, None]:
        yield from super().paginate()
...
class S3ResourceClassificationUpdate(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["S3ResourceClassificationUpdate", None, None]:
        yield from super().paginate()
...
class UpdateS3ResourcesRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateS3ResourcesRequest", None, None]:
        yield from super().paginate()
...
class UpdateS3ResourcesResult(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdateS3ResourcesResult", None, None]:
        yield from super().paginate()
