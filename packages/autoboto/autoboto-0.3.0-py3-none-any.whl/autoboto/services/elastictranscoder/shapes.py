...
class Artwork(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Artwork", None, None]:
        yield from super().paginate()
...
class AudioCodecOptions(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AudioCodecOptions", None, None]:
        yield from super().paginate()
...
class AudioParameters(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["AudioParameters", None, None]:
        yield from super().paginate()
...
class CaptionFormat(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CaptionFormat", None, None]:
        yield from super().paginate()
...
class CaptionSource(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["CaptionSource", None, None]:
        yield from super().paginate()
...
class Captions(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Captions", None, None]:
        yield from super().paginate()
...
class Clip(ShapeBase):
    ...
    time_span: "TimeSpan" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["Clip", None, None]:
        yield from super().paginate()
...
class CreateJobOutput(ShapeBase):
    ...
    # the current output.
    album_art: "JobAlbumArt" = dataclasses.field(default_factory=dict, )
    ...
    composition: typing.List["Clip"] = dataclasses.field(default_factory=list, )
    ...
    captions: "Captions" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["CreateJobOutput", None, None]:
        yield from super().paginate()
...
class CreateJobPlaylist(ShapeBase):
    ...
    output_keys: typing.List[str] = dataclasses.field(default_factory=list, )
    ...
    play_ready_drm: "PlayReadyDrm" = dataclasses.field(default_factory=dict, )

    def paginate(self, ) -> typing.Generator["CreateJobPlaylist", None, None]:
        yield from super().paginate()
...
class CreatePipelineRequest(ShapeBase):
    ...
    notifications: "Notifications" = dataclasses.field(default_factory=dict, )
...
class CreatePipelineResponse(OutputShapeBase):
    ...
    warnings: typing.List["Warning"] = dataclasses.field(default_factory=list, )
...
class CreatePresetRequest(ShapeBase):
    ...
    video: "VideoParameters" = dataclasses.field(default_factory=dict, )

    # A section of the request body that specifies the audio parameters.
    audio: "AudioParameters" = dataclasses.field(default_factory=dict, )

    # A section of the request body that specifies the thumbnail parameters, if
    # any.
    thumbnails: "Thumbnails" = dataclasses.field(default_factory=dict, )
...
class DeletePipelineResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["DeletePipelineResponse", None, None]:
        yield from super().paginate()
...
class DetectedProperties(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["DetectedProperties", None, None]:
        yield from super().paginate()
...
class HlsContentProtection(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["HlsContentProtection", None, None]:
        yield from super().paginate()
...
class IncompatibleVersionException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["IncompatibleVersionException", None, None]:
        yield from super().paginate()
...
class InputCaptions(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["InputCaptions", None, None]:
        yield from super().paginate()
...
class Job(ShapeBase):
    ...
    output: "JobOutput" = dataclasses.field(default_factory=dict, )
...
class JobAlbumArt(ShapeBase):
    ...
    artwork: typing.List["Artwork"] = dataclasses.field(default_factory=list, )

    def paginate(self, ) -> typing.Generator["JobAlbumArt", None, None]:
        yield from super().paginate()
...
class JobInput(ShapeBase):
    ...
    # For more information on sidecar files, see the Extensible Metadata Platform
    # and Sidecar file Wikipedia pages.
    input_captions: "InputCaptions" = dataclasses.field(default_factory=dict, )
    ...
    def paginate(self, ) -> typing.Generator["JobInput", None, None]:
        yield from super().paginate()
...
class JobOutput(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["JobOutput", None, None]:
        yield from super().paginate()
...
class JobWatermark(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["JobWatermark", None, None]:
        yield from super().paginate()
...
class ListJobsByPipelineRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListJobsByPipelineRequest", None, None]:
        yield from super().paginate()
...
class ListJobsByStatusRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ListJobsByStatusRequest", None, None]:
        yield from super().paginate()
...
class Notifications(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Notifications", None, None]:
        yield from super().paginate()
...
class Permission(ShapeBase):
    ...
    #   * `FULL_CONTROL`: The grantee has READ, READ_ACP, and WRITE_ACP permissions for the thumbnails that Elastic Transcoder adds to the Amazon S3 bucket.
    access: typing.List[str] = dataclasses.field(default_factory=list, )
...
class PipelineOutputConfig(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["PipelineOutputConfig", None, None]:
        yield from super().paginate()
...
class PlayReadyDrm(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PlayReadyDrm", None, None]:
        yield from super().paginate()
...
class Playlist(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Playlist", None, None]:
        yield from super().paginate()
...
class PresetWatermark(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["PresetWatermark", None, None]:
        yield from super().paginate()
...
class ReadJobRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ReadJobRequest", None, None]:
        yield from super().paginate()
...
class ReadJobResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ReadJobResponse", None, None]:
        yield from super().paginate()
...
class ReadPipelineRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ReadPipelineRequest", None, None]:
        yield from super().paginate()
...
class ReadPipelineResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["ReadPipelineResponse", None, None]:
        yield from super().paginate()
...
class ReadPresetRequest(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ReadPresetRequest", None, None]:
        yield from super().paginate()
...
class ReadPresetResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["ReadPresetResponse", None, None]:
        yield from super().paginate()
...
class TestRoleRequest(ShapeBase):
    ...
    topics: typing.List[str] = dataclasses.field(default_factory=list, )

    def paginate(self, ) -> typing.Generator["TestRoleRequest", None, None]:
        yield from super().paginate()
...
class TestRoleResponse(OutputShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TestRoleResponse", None, None]:
        yield from super().paginate()
...
class Thumbnails(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Thumbnails", None, None]:
        yield from super().paginate()
...
class TimeSpan(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["TimeSpan", None, None]:
        yield from super().paginate()
...
class UpdatePipelineNotificationsRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdatePipelineNotificationsRequest", None, None]:
        yield from super().paginate()
...
class UpdatePipelineNotificationsResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdatePipelineNotificationsResponse", None, None]:
        yield from super().paginate()
...
class UpdatePipelineResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["UpdatePipelineResponse", None, None]:
        yield from super().paginate()
...
class UpdatePipelineStatusRequest(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdatePipelineStatusRequest", None, None]:
        yield from super().paginate()
...
class UpdatePipelineStatusResponse(OutputShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UpdatePipelineStatusResponse", None, None]:
        yield from super().paginate()
...
class VideoParameters(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["VideoParameters", None, None]:
        yield from super().paginate()
...
class Warning(ShapeBase):
    ...
    def paginate(self, ) -> typing.Generator["Warning", None, None]:
        yield from super().paginate()
