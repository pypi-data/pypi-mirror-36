...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("route53domains", *args, **kwargs)
    ...
    def check_domain_availability(
        ...
        *,
        ...
        return shapes.CheckDomainAvailabilityResponse.from_boto_dict(response)
    ...
    def check_domain_transferability(
        ...
        *,
        ...
        return shapes.CheckDomainTransferabilityResponse.from_boto_dict(
            response
        )
    ...
    def delete_tags_for_domain(
        ...
        *,
        ...
        return shapes.DeleteTagsForDomainResponse.from_boto_dict(response)
    ...
    def disable_domain_auto_renew(
        ...
        *,
        ...
        return shapes.DisableDomainAutoRenewResponse.from_boto_dict(response)
    ...
    def disable_domain_transfer_lock(
        ...
        *,
        ...
        return shapes.DisableDomainTransferLockResponse.from_boto_dict(response)
    ...
    def enable_domain_auto_renew(
        ...
        *,
        ...
        return shapes.EnableDomainAutoRenewResponse.from_boto_dict(response)
    ...
    def enable_domain_transfer_lock(
        ...
        *,
        ...
        return shapes.EnableDomainTransferLockResponse.from_boto_dict(response)
    ...
    def get_contact_reachability_status(
        ...
        *,
        ...
        return shapes.GetContactReachabilityStatusResponse.from_boto_dict(
            response
        )
    ...
    def get_domain_detail(
        ...
        *,
        ...
        response = self._boto_client.get_domain_detail(
            **_request.to_boto_dict()
        )

        return shapes.GetDomainDetailResponse.from_boto_dict(response)
    ...
    def get_domain_suggestions(
        ...
        *,
        ...
        return shapes.GetDomainSuggestionsResponse.from_boto_dict(response)
    ...
    def get_operation_detail(
        ...
        *,
        ...
        response = self._boto_client.get_operation_detail(
            **_request.to_boto_dict()
        )

        return shapes.GetOperationDetailResponse.from_boto_dict(response)
    ...
    def list_domains(
        ...
        *,
        ...
        response = self._boto_client.list_domains(**_request.to_boto_dict())

        return shapes.ListDomainsResponse.from_boto_dict(response)
    ...
    def list_operations(
        ...
        *,
        ...
        response = self._boto_client.list_operations(**_request.to_boto_dict())

        return shapes.ListOperationsResponse.from_boto_dict(response)
    ...
    def list_tags_for_domain(
        ...
        *,
        ...
        response = self._boto_client.list_tags_for_domain(
            **_request.to_boto_dict()
        )

        return shapes.ListTagsForDomainResponse.from_boto_dict(response)
    ...
    def register_domain(
        ...
        *,
        ...
        response = self._boto_client.register_domain(**_request.to_boto_dict())

        return shapes.RegisterDomainResponse.from_boto_dict(response)
    ...
    def renew_domain(
        ...
        *,
        ...
        response = self._boto_client.renew_domain(**_request.to_boto_dict())

        return shapes.RenewDomainResponse.from_boto_dict(response)
    ...
    def resend_contact_reachability_email(
        ...
        *,
        ...
        return shapes.ResendContactReachabilityEmailResponse.from_boto_dict(
            response
        )
    ...
    def retrieve_domain_auth_code(
        ...
        *,
        ...
        return shapes.RetrieveDomainAuthCodeResponse.from_boto_dict(response)
    ...
    def transfer_domain(
        ...
        *,
        ...
        response = self._boto_client.transfer_domain(**_request.to_boto_dict())

        return shapes.TransferDomainResponse.from_boto_dict(response)
    ...
    def update_domain_contact(
        ...
        *,
        ...
        response = self._boto_client.update_domain_contact(
            **_request.to_boto_dict()
        )

        return shapes.UpdateDomainContactResponse.from_boto_dict(response)
    ...
    def update_domain_contact_privacy(
        ...
        *,
        ...
        return shapes.UpdateDomainContactPrivacyResponse.from_boto_dict(
            response
        )
    ...
    def update_domain_nameservers(
        ...
        *,
        ...
        return shapes.UpdateDomainNameserversResponse.from_boto_dict(response)
    ...
    def update_tags_for_domain(
        ...
        *,
        ...
        return shapes.UpdateTagsForDomainResponse.from_boto_dict(response)
    ...
    def view_billing(
        ...
        *,
        ...
        response = self._boto_client.view_billing(**_request.to_boto_dict())

        return shapes.ViewBillingResponse.from_boto_dict(response)
