...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("inspector", *args, **kwargs)
    ...
    def list_assessment_run_agents(
        ...
        *,
        ...
        response = self._boto_client.list_assessment_run_agents(
            **_request.to_boto_dict()
        )
    ...
    def list_assessment_runs(
        ...
        *,
        ...
        response = self._boto_client.list_assessment_runs(
            **_request.to_boto_dict()
        )
    ...
    def list_assessment_targets(
        ...
        *,
        ...
        response = self._boto_client.list_assessment_targets(
            **_request.to_boto_dict()
        )
    ...
    def list_assessment_templates(
        ...
        *,
        ...
        response = self._boto_client.list_assessment_templates(
            **_request.to_boto_dict()
        )
    ...
    def list_event_subscriptions(
        ...
        *,
        ...
        response = self._boto_client.list_event_subscriptions(
            **_request.to_boto_dict()
        )
    ...
    def list_rules_packages(
        ...
        *,
        ...
        response = self._boto_client.list_rules_packages(
            **_request.to_boto_dict()
        )
    ...
    def preview_agents(
        ...
        *,
        ...
        response = self._boto_client.preview_agents(**_request.to_boto_dict())
