...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("servicecatalog", *args, **kwargs)
    ...
    def copy_product(
        ...
        *,
        ...
        source_provisioning_artifact_identifiers: typing.List[
            typing.Dict[shapes.ProvisioningArtifactPropertyName, str]
        ] = ShapeBase.NOT_SET,
    ...
    def list_accepted_portfolio_shares(
        ...
        *,
        ...
        response = self._boto_client.list_accepted_portfolio_shares(
            **_request.to_boto_dict()
        )
    ...
    def list_constraints_for_portfolio(
        ...
        *,
        ...
        response = self._boto_client.list_constraints_for_portfolio(
            **_request.to_boto_dict()
        )
    ...
    def list_launch_paths(
        ...
        *,
        ...
        response = self._boto_client.list_launch_paths(
            **_request.to_boto_dict()
        )
    ...
    def list_portfolios(
        ...
        *,
        ...
        response = self._boto_client.list_portfolios(**_request.to_boto_dict())
    ...
    def list_portfolios_for_product(
        ...
        *,
        ...
        response = self._boto_client.list_portfolios_for_product(
            **_request.to_boto_dict()
        )
    ...
    def list_principals_for_portfolio(
        ...
        *,
        ...
        response = self._boto_client.list_principals_for_portfolio(
            **_request.to_boto_dict()
        )
    ...
    def list_resources_for_tag_option(
        ...
        *,
        ...
        response = self._boto_client.list_resources_for_tag_option(
            **_request.to_boto_dict()
        )
    ...
    def list_tag_options(
        ...
        *,
        ...
        response = self._boto_client.list_tag_options(**_request.to_boto_dict())
    ...
    def search_products(
        ...
        *,
        accept_language: str = ShapeBase.NOT_SET,
        filters: typing.Dict[shapes.ProductViewFilterBy, typing.List[str]
                            ] = ShapeBase.NOT_SET,
        page_size: int = ShapeBase.NOT_SET,
    ...
    def search_products_as_admin(
        ...
        *,
        ...
        response = self._boto_client.search_products_as_admin(
            **_request.to_boto_dict()
        )
    ...
    def search_provisioned_products(
        ...
        *,
        accept_language: str = ShapeBase.NOT_SET,
        access_level_filter: shapes.AccessLevelFilter = ShapeBase.NOT_SET,
        filters: typing.Dict[shapes.ProvisionedProductViewFilterBy,
