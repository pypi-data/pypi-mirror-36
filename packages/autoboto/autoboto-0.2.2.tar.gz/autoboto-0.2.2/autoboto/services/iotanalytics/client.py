...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("iotanalytics", *args, **kwargs)
    ...
    def batch_put_message(
        ...
        *,
        ...
        response = self._boto_client.batch_put_message(
            **_request.to_boto_dict()
        )

        return shapes.BatchPutMessageResponse.from_boto_dict(response)
    ...
    def cancel_pipeline_reprocessing(
        ...
        *,
        ...
        return shapes.CancelPipelineReprocessingResponse.from_boto_dict(
            response
        )
    ...
    def create_dataset(
        ...
        *,
        ...
        response = self._boto_client.create_dataset(**_request.to_boto_dict())

        return shapes.CreateDatasetResponse.from_boto_dict(response)
    ...
    def create_dataset_content(
        ...
        *,
        ...
        return shapes.CreateDatasetContentResponse.from_boto_dict(response)
    ...
    def create_datastore(
        ...
        *,
        ...
        response = self._boto_client.create_datastore(**_request.to_boto_dict())

        return shapes.CreateDatastoreResponse.from_boto_dict(response)
    ...
    def delete_dataset(
        ...
        *,
        ...
        response = self._boto_client.delete_dataset(**_request.to_boto_dict())
    ...
    def delete_datastore(
        ...
        *,
        ...
        response = self._boto_client.delete_datastore(**_request.to_boto_dict())
    ...
    def describe_dataset(
        ...
        *,
        ...
        response = self._boto_client.describe_dataset(**_request.to_boto_dict())

        return shapes.DescribeDatasetResponse.from_boto_dict(response)
    ...
    def describe_datastore(
        ...
        *,
        ...
        response = self._boto_client.describe_datastore(
            **_request.to_boto_dict()
        )

        return shapes.DescribeDatastoreResponse.from_boto_dict(response)
    ...
    def describe_logging_options(
        ...
        return shapes.DescribeLoggingOptionsResponse.from_boto_dict(response)
    ...
    def describe_pipeline(
        ...
        *,
        ...
        response = self._boto_client.describe_pipeline(
            **_request.to_boto_dict()
        )

        return shapes.DescribePipelineResponse.from_boto_dict(response)
    ...
    def get_dataset_content(
        ...
        *,
        ...
        response = self._boto_client.get_dataset_content(
            **_request.to_boto_dict()
        )

        return shapes.GetDatasetContentResponse.from_boto_dict(response)
    ...
    def list_dataset_contents(
        ...
        *,
        ...
        response = self._boto_client.list_dataset_contents(
            **_request.to_boto_dict()
        )

        return shapes.ListDatasetContentsResponse.from_boto_dict(response)
    ...
    def list_datasets(
        ...
        *,
        ...
        response = self._boto_client.list_datasets(**_request.to_boto_dict())

        return shapes.ListDatasetsResponse.from_boto_dict(response)
    ...
    def list_datastores(
        ...
        *,
        ...
        response = self._boto_client.list_datastores(**_request.to_boto_dict())

        return shapes.ListDatastoresResponse.from_boto_dict(response)
    ...
    def put_logging_options(
        ...
        *,
        ...
        response = self._boto_client.put_logging_options(
            **_request.to_boto_dict()
        )
    ...
    def run_pipeline_activity(
        ...
        *,
        ...
        response = self._boto_client.run_pipeline_activity(
            **_request.to_boto_dict()
        )

        return shapes.RunPipelineActivityResponse.from_boto_dict(response)
    ...
    def sample_channel_data(
        ...
        *,
        ...
        response = self._boto_client.sample_channel_data(
            **_request.to_boto_dict()
        )

        return shapes.SampleChannelDataResponse.from_boto_dict(response)
    ...
    def start_pipeline_reprocessing(
        ...
        *,
        ...
        return shapes.StartPipelineReprocessingResponse.from_boto_dict(response)
    ...
    def update_dataset(
        ...
        *,
        ...
        response = self._boto_client.update_dataset(**_request.to_boto_dict())
    ...
    def update_datastore(
        ...
        *,
        ...
        response = self._boto_client.update_datastore(**_request.to_boto_dict())
