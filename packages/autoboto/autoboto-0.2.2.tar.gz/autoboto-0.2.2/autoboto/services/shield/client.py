...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("shield", *args, **kwargs)
    ...
    def associate_drt_log_bucket(
        ...
        *,
        ...
        return shapes.AssociateDRTLogBucketResponse.from_boto_dict(response)
    ...
    def associate_drt_role(
        ...
        *,
        ...
        response = self._boto_client.associate_drt_role(
            **_request.to_boto_dict()
        )

        return shapes.AssociateDRTRoleResponse.from_boto_dict(response)
    ...
    def create_protection(
        ...
        *,
        ...
        response = self._boto_client.create_protection(
            **_request.to_boto_dict()
        )

        return shapes.CreateProtectionResponse.from_boto_dict(response)
    ...
    def create_subscription(
        ...
        response = self._boto_client.create_subscription(
            **_request.to_boto_dict()
        )

        return shapes.CreateSubscriptionResponse.from_boto_dict(response)
    ...
    def delete_protection(
        ...
        *,
        ...
        response = self._boto_client.delete_protection(
            **_request.to_boto_dict()
        )

        return shapes.DeleteProtectionResponse.from_boto_dict(response)
    ...
    def delete_subscription(
        ...
        response = self._boto_client.delete_subscription(
            **_request.to_boto_dict()
        )

        return shapes.DeleteSubscriptionResponse.from_boto_dict(response)
    ...
    def describe_attack(
        ...
        *,
        ...
        response = self._boto_client.describe_attack(**_request.to_boto_dict())

        return shapes.DescribeAttackResponse.from_boto_dict(response)
    ...
    def describe_drt_access(
        ...
        response = self._boto_client.describe_drt_access(
            **_request.to_boto_dict()
        )

        return shapes.DescribeDRTAccessResponse.from_boto_dict(response)
    ...
    def describe_emergency_contact_settings(
        ...
        return shapes.DescribeEmergencyContactSettingsResponse.from_boto_dict(
            response
        )
    ...
    def describe_protection(
        ...
        *,
        ...
        response = self._boto_client.describe_protection(
            **_request.to_boto_dict()
        )

        return shapes.DescribeProtectionResponse.from_boto_dict(response)
    ...
    def describe_subscription(
        ...
        response = self._boto_client.describe_subscription(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSubscriptionResponse.from_boto_dict(response)
    ...
    def disassociate_drt_log_bucket(
        ...
        *,
        ...
        return shapes.DisassociateDRTLogBucketResponse.from_boto_dict(response)
    ...
    def disassociate_drt_role(
        ...
        response = self._boto_client.disassociate_drt_role(
            **_request.to_boto_dict()
        )

        return shapes.DisassociateDRTRoleResponse.from_boto_dict(response)
    ...
    def get_subscription_state(
        ...
        return shapes.GetSubscriptionStateResponse.from_boto_dict(response)
    ...
    def list_attacks(
        ...
        *,
        ...
        response = self._boto_client.list_attacks(**_request.to_boto_dict())

        return shapes.ListAttacksResponse.from_boto_dict(response)
    ...
    def list_protections(
        ...
        *,
        ...
        response = self._boto_client.list_protections(**_request.to_boto_dict())

        return shapes.ListProtectionsResponse.from_boto_dict(response)
    ...
    def update_emergency_contact_settings(
        ...
        *,
        ...
        return shapes.UpdateEmergencyContactSettingsResponse.from_boto_dict(
            response
        )
    ...
    def update_subscription(
        ...
        *,
        auto_renew: shapes.AutoRenew = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.update_subscription(
            **_request.to_boto_dict()
        )

        return shapes.UpdateSubscriptionResponse.from_boto_dict(response)
