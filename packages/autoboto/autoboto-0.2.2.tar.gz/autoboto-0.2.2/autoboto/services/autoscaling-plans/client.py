...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("autoscaling-plans", *args, **kwargs)
    ...
    def create_scaling_plan(
        ...
        *,
        ...
        response = self._boto_client.create_scaling_plan(
            **_request.to_boto_dict()
        )

        return shapes.CreateScalingPlanResponse.from_boto_dict(response)
    ...
    def delete_scaling_plan(
        ...
        *,
        ...
        response = self._boto_client.delete_scaling_plan(
            **_request.to_boto_dict()
        )

        return shapes.DeleteScalingPlanResponse.from_boto_dict(response)
    ...
    def describe_scaling_plan_resources(
        ...
        *,
        ...
        return shapes.DescribeScalingPlanResourcesResponse.from_boto_dict(
            response
        )
    ...
    def describe_scaling_plans(
        ...
        *,
        ...
        return shapes.DescribeScalingPlansResponse.from_boto_dict(response)
    ...
    def update_scaling_plan(
        ...
        *,
        ...
        response = self._boto_client.update_scaling_plan(
            **_request.to_boto_dict()
        )

        return shapes.UpdateScalingPlanResponse.from_boto_dict(response)
