...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("lambda", *args, **kwargs)
    ...
    def add_permission(
        ...
        *,
        ...
        return shapes.AddPermissionResponse.from_boto_dict(response)
    ...
    def create_alias(
        ...
        *,
        ...
        return shapes.AliasConfiguration.from_boto_dict(response)
    ...
    def create_event_source_mapping(
        ...
        *,
        ...
        starting_position: shapes.EventSourcePosition = ShapeBase.NOT_SET,
        ...
        return shapes.EventSourceMappingConfiguration.from_boto_dict(response)
    ...
    def create_function(
        ...
        *,
        ...
        response = self._boto_client.create_function(**_request.to_boto_dict())

        return shapes.FunctionConfiguration.from_boto_dict(response)
    ...
    def delete_function(
        ...
        *,
        ...
        response = self._boto_client.delete_function(**_request.to_boto_dict())
    ...
    def get_account_settings(
        ...
        return shapes.GetAccountSettingsResponse.from_boto_dict(response)
    ...
    def get_alias(
        ...
        *,
        ...
        response = self._boto_client.get_alias(**_request.to_boto_dict())
    ...
    def get_function(
        ...
        *,
        ...
        response = self._boto_client.get_function(**_request.to_boto_dict())

        return shapes.GetFunctionResponse.from_boto_dict(response)
    ...
    def invoke(
        ...
        *,
        function_name: str,
        invocation_type: shapes.InvocationType = ShapeBase.NOT_SET,
        log_type: shapes.LogType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.invoke(**_request.to_boto_dict())

        return shapes.InvocationResponse.from_boto_dict(response)
    ...
    def invoke_async(
        ...
        *,
        ...
        response = self._boto_client.invoke_async(**_request.to_boto_dict())

        return shapes.InvokeAsyncResponse.from_boto_dict(response)
    ...
    def list_event_source_mappings(
        ...
        *,
        ...
        response = self._boto_client.list_event_source_mappings(
            **_request.to_boto_dict()
        )

        return shapes.ListEventSourceMappingsResponse.from_boto_dict(response)
    ...
    def list_functions(
        ...
        *,
        ...
        function_version: shapes.FunctionVersion = ShapeBase.NOT_SET,
        marker: str = ShapeBase.NOT_SET,
        max_items: int = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_functions(**_request.to_boto_dict())

        return shapes.ListFunctionsResponse.from_boto_dict(response)
    ...
    def list_versions_by_function(
        ...
        *,
        ...
        return shapes.ListVersionsByFunctionResponse.from_boto_dict(response)
    ...
    def publish_version(
        ...
        *,
        ...
        response = self._boto_client.publish_version(**_request.to_boto_dict())
    ...
    def put_function_concurrency(
        ...
        *,
        ...
        return shapes.Concurrency.from_boto_dict(response)
    ...
    def update_function_code(
        ...
        *,
        ...
        response = self._boto_client.update_function_code(
            **_request.to_boto_dict()
        )
    ...
    def update_function_configuration(
        ...
        *,
        ...
        vpc_config: shapes.VpcConfig = ShapeBase.NOT_SET,
        environment: shapes.Environment = ShapeBase.NOT_SET,
        runtime: shapes.Runtime = ShapeBase.NOT_SET,
        dead_letter_config: shapes.DeadLetterConfig = ShapeBase.NOT_SET,
        kms_key_arn: str = ShapeBase.NOT_SET,
        tracing_config: shapes.TracingConfig = ShapeBase.NOT_SET,
        revision_id: str = ShapeBase.NOT_SET,
