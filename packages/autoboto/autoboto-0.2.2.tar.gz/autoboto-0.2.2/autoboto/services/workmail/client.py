...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("workmail", *args, **kwargs)
    ...
    def list_group_members(
        ...
        *,
        ...
        response = self._boto_client.list_group_members(
            **_request.to_boto_dict()
        )
    ...
    def list_organizations(
        ...
        *,
        ...
        response = self._boto_client.list_organizations(
            **_request.to_boto_dict()
        )
    ...
    def list_resources(
        ...
        *,
        ...
        response = self._boto_client.list_resources(**_request.to_boto_dict())
