...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("guardduty", *args, **kwargs)
    ...
    def accept_invitation(
        ...
        *,
        ...
        response = self._boto_client.accept_invitation(
            **_request.to_boto_dict()
        )

        return shapes.AcceptInvitationResponse.from_boto_dict(response)
    ...
    def archive_findings(
        ...
        *,
        ...
        response = self._boto_client.archive_findings(**_request.to_boto_dict())

        return shapes.ArchiveFindingsResponse.from_boto_dict(response)
    ...
    def create_detector(
        ...
        *,
        ...
        response = self._boto_client.create_detector(**_request.to_boto_dict())

        return shapes.CreateDetectorResponse.from_boto_dict(response)
    ...
    def create_filter(
        ...
        *,
        detector_id: str,
        action: shapes.FilterAction = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_filter(**_request.to_boto_dict())

        return shapes.CreateFilterResponse.from_boto_dict(response)
    ...
    def create_ip_set(
        ...
        *,
        ...
        format: shapes.IpSetFormat = ShapeBase.NOT_SET,
    ...
    def create_members(
        ...
        *,
        ...
        response = self._boto_client.create_members(**_request.to_boto_dict())

        return shapes.CreateMembersResponse.from_boto_dict(response)
    ...
    def create_sample_findings(
        ...
        *,
        ...
        return shapes.CreateSampleFindingsResponse.from_boto_dict(response)
    ...
    def create_threat_intel_set(
        ...
        *,
        detector_id: str,
        activate: bool = ShapeBase.NOT_SET,
        format: shapes.ThreatIntelSetFormat = ShapeBase.NOT_SET,
        location: str = ShapeBase.NOT_SET,
        name: str = ShapeBase.NOT_SET,
        ...
        return shapes.CreateThreatIntelSetResponse.from_boto_dict(response)
    ...
    def decline_invitations(
        ...
        *,
        ...
        response = self._boto_client.decline_invitations(
            **_request.to_boto_dict()
        )

        return shapes.DeclineInvitationsResponse.from_boto_dict(response)
    ...
    def delete_detector(
        ...
        *,
        ...
        response = self._boto_client.delete_detector(**_request.to_boto_dict())

        return shapes.DeleteDetectorResponse.from_boto_dict(response)
    ...
    def delete_filter(
        ...
        *,
        ...
        response = self._boto_client.delete_filter(**_request.to_boto_dict())

        return shapes.DeleteFilterResponse.from_boto_dict(response)
    ...
    def delete_invitations(
        ...
        *,
        ...
        response = self._boto_client.delete_invitations(
            **_request.to_boto_dict()
        )

        return shapes.DeleteInvitationsResponse.from_boto_dict(response)
    ...
    def delete_members(
        ...
        *,
        ...
        response = self._boto_client.delete_members(**_request.to_boto_dict())

        return shapes.DeleteMembersResponse.from_boto_dict(response)
    ...
    def delete_threat_intel_set(
        ...
        *,
        ...
        return shapes.DeleteThreatIntelSetResponse.from_boto_dict(response)
    ...
    def disassociate_from_master_account(
        ...
        *,
        ...
        return shapes.DisassociateFromMasterAccountResponse.from_boto_dict(
            response
        )
    ...
    def disassociate_members(
        ...
        *,
        ...
        response = self._boto_client.disassociate_members(
            **_request.to_boto_dict()
        )

        return shapes.DisassociateMembersResponse.from_boto_dict(response)
    ...
    def get_detector(
        ...
        *,
        ...
        response = self._boto_client.get_detector(**_request.to_boto_dict())

        return shapes.GetDetectorResponse.from_boto_dict(response)
    ...
    def get_filter(
        ...
        *,
        ...
        response = self._boto_client.get_filter(**_request.to_boto_dict())

        return shapes.GetFilterResponse.from_boto_dict(response)
    ...
    def get_findings(
        ...
        *,
        ...
        response = self._boto_client.get_findings(**_request.to_boto_dict())

        return shapes.GetFindingsResponse.from_boto_dict(response)
    ...
    def get_findings_statistics(
        ...
        *,
        detector_id: str,
        finding_criteria: shapes.FindingCriteria = ShapeBase.NOT_SET,
        finding_statistic_types: typing.List[shapes.FindingStatisticType
                                            ] = ShapeBase.NOT_SET,
        ...
        return shapes.GetFindingsStatisticsResponse.from_boto_dict(response)
    ...
    def get_invitations_count(
        ...
        response = self._boto_client.get_invitations_count(
            **_request.to_boto_dict()
        )

        return shapes.GetInvitationsCountResponse.from_boto_dict(response)
    ...
    def get_master_account(
        ...
        *,
        ...
        response = self._boto_client.get_master_account(
            **_request.to_boto_dict()
        )

        return shapes.GetMasterAccountResponse.from_boto_dict(response)
    ...
    def get_members(
        ...
        *,
        ...
        response = self._boto_client.get_members(**_request.to_boto_dict())

        return shapes.GetMembersResponse.from_boto_dict(response)
    ...
    def get_threat_intel_set(
        ...
        *,
        ...
        response = self._boto_client.get_threat_intel_set(
            **_request.to_boto_dict()
        )

        return shapes.GetThreatIntelSetResponse.from_boto_dict(response)
    ...
    def invite_members(
        ...
        *,
        ...
        response = self._boto_client.invite_members(**_request.to_boto_dict())

        return shapes.InviteMembersResponse.from_boto_dict(response)
    ...
    def list_detectors(
        ...
        *,
        ...
        response = self._boto_client.list_detectors(**_request.to_boto_dict())

        return shapes.ListDetectorsResponse.from_boto_dict(response)
    ...
    def list_filters(
        ...
        *,
        ...
        response = self._boto_client.list_filters(**_request.to_boto_dict())

        return shapes.ListFiltersResponse.from_boto_dict(response)
    ...
    def list_findings(
        ...
        *,
        ...
        response = self._boto_client.list_findings(**_request.to_boto_dict())
    ...
    def list_invitations(
        ...
        *,
        ...
        response = self._boto_client.list_invitations(**_request.to_boto_dict())

        return shapes.ListInvitationsResponse.from_boto_dict(response)
    ...
    def list_members(
        ...
        *,
        ...
        response = self._boto_client.list_members(**_request.to_boto_dict())

        return shapes.ListMembersResponse.from_boto_dict(response)
    ...
    def list_threat_intel_sets(
        ...
        *,
        ...
        response = self._boto_client.list_threat_intel_sets(
            **_request.to_boto_dict()
        )

        return shapes.ListThreatIntelSetsResponse.from_boto_dict(response)
    ...
    def start_monitoring_members(
        ...
        *,
        ...
        return shapes.StartMonitoringMembersResponse.from_boto_dict(response)
    ...
    def stop_monitoring_members(
        ...
        *,
        ...
        return shapes.StopMonitoringMembersResponse.from_boto_dict(response)
    ...
    def unarchive_findings(
        ...
        *,
        ...
        response = self._boto_client.unarchive_findings(
            **_request.to_boto_dict()
        )

        return shapes.UnarchiveFindingsResponse.from_boto_dict(response)
    ...
    def update_detector(
        ...
        *,
        ...
        response = self._boto_client.update_detector(**_request.to_boto_dict())

        return shapes.UpdateDetectorResponse.from_boto_dict(response)
    ...
    def update_filter(
        ...
        *,
        ...
        response = self._boto_client.update_filter(**_request.to_boto_dict())

        return shapes.UpdateFilterResponse.from_boto_dict(response)
    ...
    def update_findings_feedback(
        ...
        *,
        ...
        feedback: shapes.Feedback = ShapeBase.NOT_SET,
        finding_ids: typing.List[str] = ShapeBase.NOT_SET,
        ...
        return shapes.UpdateFindingsFeedbackResponse.from_boto_dict(response)
    ...
    def update_threat_intel_set(
        ...
        *,
        ...
        return shapes.UpdateThreatIntelSetResponse.from_boto_dict(response)
