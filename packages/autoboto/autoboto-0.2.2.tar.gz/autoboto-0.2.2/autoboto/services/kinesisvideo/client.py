...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("kinesisvideo", *args, **kwargs)
    ...
    def create_stream(
        ...
        *,
        ...
        return shapes.CreateStreamOutput.from_boto_dict(response)
    ...
    def delete_stream(
        ...
        *,
        ...
        return shapes.DeleteStreamOutput.from_boto_dict(response)
    ...
    def get_data_endpoint(
        ...
        *,
        ...
        response = self._boto_client.get_data_endpoint(
            **_request.to_boto_dict()
        )

        return shapes.GetDataEndpointOutput.from_boto_dict(response)
    ...
    def tag_stream(
        ...
        *,
        ...
        response = self._boto_client.tag_stream(**_request.to_boto_dict())

        return shapes.TagStreamOutput.from_boto_dict(response)
    ...
    def untag_stream(
        ...
        *,
        ...
        response = self._boto_client.untag_stream(**_request.to_boto_dict())

        return shapes.UntagStreamOutput.from_boto_dict(response)
    ...
    def update_data_retention(
        ...
        *,
        current_version: str,
        operation: shapes.UpdateDataRetentionOperation,
        ...
        response = self._boto_client.update_data_retention(
            **_request.to_boto_dict()
        )

        return shapes.UpdateDataRetentionOutput.from_boto_dict(response)
    ...
    def update_stream(
        ...
        *,
        ...
        return shapes.UpdateStreamOutput.from_boto_dict(response)
