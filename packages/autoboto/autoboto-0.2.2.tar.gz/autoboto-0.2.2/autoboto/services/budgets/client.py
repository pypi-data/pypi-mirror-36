...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("budgets", *args, **kwargs)
    ...
    def create_budget(
        ...
        *,
        ...
        notifications_with_subscribers: typing.List[
            shapes.NotificationWithSubscribers
        ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_budget(**_request.to_boto_dict())

        return shapes.CreateBudgetResponse.from_boto_dict(response)
    ...
    def create_notification(
        ...
        *,
        ...
        response = self._boto_client.create_notification(
            **_request.to_boto_dict()
        )

        return shapes.CreateNotificationResponse.from_boto_dict(response)
    ...
    def create_subscriber(
        ...
        *,
        ...
        response = self._boto_client.create_subscriber(
            **_request.to_boto_dict()
        )

        return shapes.CreateSubscriberResponse.from_boto_dict(response)
    ...
    def delete_budget(
        ...
        **Deleting a budget also deletes the notifications and subscribers associated
        ...
        response = self._boto_client.delete_budget(**_request.to_boto_dict())

        return shapes.DeleteBudgetResponse.from_boto_dict(response)
    ...
    def delete_notification(
        ...
        **Deleting a notification also deletes the subscribers associated with the
        ...
        response = self._boto_client.delete_notification(
            **_request.to_boto_dict()
        )

        return shapes.DeleteNotificationResponse.from_boto_dict(response)
    ...
    def delete_subscriber(
        ...
        **Deleting the last subscriber to a notification also deletes the
        ...
        response = self._boto_client.delete_subscriber(
            **_request.to_boto_dict()
        )

        return shapes.DeleteSubscriberResponse.from_boto_dict(response)
    ...
    def describe_budget(
        ...
        *,
        ...
        response = self._boto_client.describe_budget(**_request.to_boto_dict())

        return shapes.DescribeBudgetResponse.from_boto_dict(response)
    ...
    def describe_budgets(
        ...
        *,
        ...
        response = self._boto_client.describe_budgets(**_request.to_boto_dict())

        return shapes.DescribeBudgetsResponse.from_boto_dict(response)
    ...
    def describe_notifications_for_budget(
        ...
        *,
        ...
        return shapes.DescribeNotificationsForBudgetResponse.from_boto_dict(
            response
        )
    ...
    def describe_subscribers_for_notification(
        ...
        *,
        ...
        return shapes.DescribeSubscribersForNotificationResponse.from_boto_dict(
            response
        )
    ...
    def update_budget(
        ...
        *,
        ...
        response = self._boto_client.update_budget(**_request.to_boto_dict())

        return shapes.UpdateBudgetResponse.from_boto_dict(response)
    ...
    def update_notification(
        ...
        *,
        ...
        response = self._boto_client.update_notification(
            **_request.to_boto_dict()
        )

        return shapes.UpdateNotificationResponse.from_boto_dict(response)
    ...
    def update_subscriber(
        ...
        *,
        ...
        response = self._boto_client.update_subscriber(
            **_request.to_boto_dict()
        )

        return shapes.UpdateSubscriberResponse.from_boto_dict(response)
