...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("cloudtrail", *args, **kwargs)
    ...
    def add_tags(
        ...
        *,
        ...
        return shapes.AddTagsResponse.from_boto_dict(response)
    ...
    def create_trail(
        ...
        *,
        ...
        response = self._boto_client.create_trail(**_request.to_boto_dict())

        return shapes.CreateTrailResponse.from_boto_dict(response)
    ...
    def delete_trail(
        ...
        *,
        ...
        response = self._boto_client.delete_trail(**_request.to_boto_dict())

        return shapes.DeleteTrailResponse.from_boto_dict(response)
    ...
    def describe_trails(
        ...
        *,
        ...
        response = self._boto_client.describe_trails(**_request.to_boto_dict())

        return shapes.DescribeTrailsResponse.from_boto_dict(response)
    ...
    def get_event_selectors(
        ...
        *,
        ...
        response = self._boto_client.get_event_selectors(
            **_request.to_boto_dict()
        )

        return shapes.GetEventSelectorsResponse.from_boto_dict(response)
    ...
    def get_trail_status(
        ...
        *,
        ...
        response = self._boto_client.get_trail_status(**_request.to_boto_dict())

        return shapes.GetTrailStatusResponse.from_boto_dict(response)
    ...
    def list_public_keys(
        ...
        *,
        ...
        return shapes.ListPublicKeysResponse.from_boto_dict(response)
    ...
    def lookup_events(
        ...
        *,
        ...
        response = self._boto_client.lookup_events(**_request.to_boto_dict())

        return shapes.LookupEventsResponse.from_boto_dict(response)
    ...
    def put_event_selectors(
        ...
        *,
        ...
        response = self._boto_client.put_event_selectors(
            **_request.to_boto_dict()
        )

        return shapes.PutEventSelectorsResponse.from_boto_dict(response)
    ...
    def remove_tags(
        ...
        *,
        ...
        return shapes.RemoveTagsResponse.from_boto_dict(response)
    ...
    def start_logging(
        ...
        *,
        ...
        response = self._boto_client.start_logging(**_request.to_boto_dict())

        return shapes.StartLoggingResponse.from_boto_dict(response)
    ...
    def stop_logging(
        ...
        *,
        ...
        response = self._boto_client.stop_logging(**_request.to_boto_dict())

        return shapes.StopLoggingResponse.from_boto_dict(response)
    ...
    def update_trail(
        ...
        *,
        ...
        response = self._boto_client.update_trail(**_request.to_boto_dict())

        return shapes.UpdateTrailResponse.from_boto_dict(response)
