...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("sdb", *args, **kwargs)
    ...
    def batch_put_attributes(
        ...
        *,
        ...
        response = self._boto_client.batch_put_attributes(
            **_request.to_boto_dict()
        )
    ...
    def domain_metadata(
        ...
        *,
        ...
        response = self._boto_client.domain_metadata(**_request.to_boto_dict())

        return shapes.DomainMetadataResult.from_boto_dict(response)
    ...
    def get_attributes(
        ...
        *,
        ...
        response = self._boto_client.get_attributes(**_request.to_boto_dict())

        return shapes.GetAttributesResult.from_boto_dict(response)
    ...
    def list_domains(
        ...
        *,
        ...
        return shapes.ListDomainsResult.from_boto_dict(response)
    ...
    def select(
        ...
        *,
        ...
        response = self._boto_client.select(**_request.to_boto_dict())

        return shapes.SelectResult.from_boto_dict(response)
