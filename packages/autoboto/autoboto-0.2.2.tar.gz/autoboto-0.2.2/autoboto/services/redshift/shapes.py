...
class Cluster(ShapeBase):
    ...
    # snapshot.
    restore_status: "RestoreStatus" = dataclasses.field(default_factory=dict, )
    ...
    hsm_status: "HsmStatus" = dataclasses.field(default_factory=dict, )
...
class CreateClusterMessage(ShapeBase):
    ...
    iam_roles: typing.List[str] = dataclasses.field(default_factory=list, )
...
class GetClusterCredentialsMessage(ShapeBase):
    ...
    #   * Cannot be a reserved word. A list of reserved words can be found in [Reserved Words](http://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html) in the Amazon Redshift Database Developer Guide.
    db_groups: typing.List[str] = dataclasses.field(default_factory=list, )
...
class ModifyClusterIamRolesMessage(ShapeBase):
    ...
    add_iam_roles: typing.List[str] = dataclasses.field(default_factory=list, )
...
class Parameter(ShapeBase):
    ...
    # Guide_.
    apply_type: "ParameterApplyType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class PurchaseReservedNodeOfferingResult(OutputShapeBase):
    ...
    # Describes a reserved node. You can call the DescribeReservedNodeOfferings
    # API to obtain the available reserved node offerings.
    reserved_node: "ReservedNode" = dataclasses.field(default_factory=dict, )
...
class ReservedNode(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                TypeInfo(ReservedNodeOfferingType),
            ),
        ]
    ...
    reserved_node_offering_type: "ReservedNodeOfferingType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class TableRestoreStatus(ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status",
                "Status",
                TypeInfo(TableRestoreStatusType),
            ),
            (
                "message",
                "Message",
    ...
    status: "TableRestoreStatusType" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
