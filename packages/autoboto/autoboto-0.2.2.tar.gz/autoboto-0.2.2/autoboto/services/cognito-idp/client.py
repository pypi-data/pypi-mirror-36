...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("cognito-idp", *args, **kwargs)
    ...
    def add_custom_attributes(
        ...
        *,
        ...
        response = self._boto_client.add_custom_attributes(
            **_request.to_boto_dict()
        )

        return shapes.AddCustomAttributesResponse.from_boto_dict(response)
    ...
    def admin_confirm_sign_up(
        ...
        *,
        ...
        response = self._boto_client.admin_confirm_sign_up(
            **_request.to_boto_dict()
        )

        return shapes.AdminConfirmSignUpResponse.from_boto_dict(response)
    ...
    def admin_create_user(
        ...
        *,
        ...
        message_action: shapes.MessageActionType = ShapeBase.NOT_SET,
        desired_delivery_mediums: typing.List[shapes.DeliveryMediumType
                                             ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.admin_create_user(
            **_request.to_boto_dict()
        )

        return shapes.AdminCreateUserResponse.from_boto_dict(response)
    ...
    def admin_delete_user(
        ...
        *,
        ...
        response = self._boto_client.admin_delete_user(
            **_request.to_boto_dict()
        )
    ...
    def admin_delete_user_attributes(
        ...
        *,
        ...
        return shapes.AdminDeleteUserAttributesResponse.from_boto_dict(response)
    ...
    def admin_disable_provider_for_user(
        ...
        *,
        ...
        return shapes.AdminDisableProviderForUserResponse.from_boto_dict(
            response
        )
    ...
    def admin_disable_user(
        ...
        *,
        ...
        response = self._boto_client.admin_disable_user(
            **_request.to_boto_dict()
        )

        return shapes.AdminDisableUserResponse.from_boto_dict(response)
    ...
    def admin_enable_user(
        ...
        *,
        ...
        response = self._boto_client.admin_enable_user(
            **_request.to_boto_dict()
        )

        return shapes.AdminEnableUserResponse.from_boto_dict(response)
    ...
    def admin_forget_device(
        ...
        *,
        ...
        response = self._boto_client.admin_forget_device(
            **_request.to_boto_dict()
        )
    ...
    def admin_get_device(
        ...
        *,
        ...
        response = self._boto_client.admin_get_device(**_request.to_boto_dict())

        return shapes.AdminGetDeviceResponse.from_boto_dict(response)
    ...
    def admin_get_user(
        ...
        *,
        ...
        response = self._boto_client.admin_get_user(**_request.to_boto_dict())

        return shapes.AdminGetUserResponse.from_boto_dict(response)
    ...
    def admin_initiate_auth(
        ...
        *,
        ...
        response = self._boto_client.admin_initiate_auth(
            **_request.to_boto_dict()
        )

        return shapes.AdminInitiateAuthResponse.from_boto_dict(response)
    ...
    def admin_link_provider_for_user(
        ...
        *,
        ...
        return shapes.AdminLinkProviderForUserResponse.from_boto_dict(response)
    ...
    def admin_list_devices(
        ...
        *,
        ...
        response = self._boto_client.admin_list_devices(
            **_request.to_boto_dict()
        )

        return shapes.AdminListDevicesResponse.from_boto_dict(response)
    ...
    def admin_list_groups_for_user(
        ...
        *,
        ...
        return shapes.AdminListGroupsForUserResponse.from_boto_dict(response)
    ...
    def admin_list_user_auth_events(
        ...
        *,
        ...
        return shapes.AdminListUserAuthEventsResponse.from_boto_dict(response)
    ...
    def admin_reset_user_password(
        ...
        *,
        ...
        return shapes.AdminResetUserPasswordResponse.from_boto_dict(response)
    ...
    def admin_respond_to_auth_challenge(
        ...
        *,
        user_pool_id: str,
        client_id: str,
        challenge_name: shapes.ChallengeNameType,
        ...
        return shapes.AdminRespondToAuthChallengeResponse.from_boto_dict(
            response
        )
    ...
    def admin_set_user_mfa_preference(
        ...
        *,
        ...
        return shapes.AdminSetUserMFAPreferenceResponse.from_boto_dict(response)
    ...
    def admin_set_user_settings(
        ...
        *,
        ...
        return shapes.AdminSetUserSettingsResponse.from_boto_dict(response)
    ...
    def admin_update_auth_event_feedback(
        ...
        *,
        ...
        username: str,
        event_id: str,
        feedback_value: shapes.FeedbackValueType,
        ...
        return shapes.AdminUpdateAuthEventFeedbackResponse.from_boto_dict(
            response
        )
    ...
    def admin_update_device_status(
        ...
        *,
        ...
        username: str,
        device_key: str,
        device_remembered_status: shapes.DeviceRememberedStatusType = ShapeBase.
        NOT_SET,
        ...
        return shapes.AdminUpdateDeviceStatusResponse.from_boto_dict(response)
    ...
    def admin_update_user_attributes(
        ...
        *,
        ...
        return shapes.AdminUpdateUserAttributesResponse.from_boto_dict(response)
    ...
    def admin_user_global_sign_out(
        ...
        *,
        ...
        return shapes.AdminUserGlobalSignOutResponse.from_boto_dict(response)
    ...
    def associate_software_token(
        ...
        *,
        ...
        return shapes.AssociateSoftwareTokenResponse.from_boto_dict(response)
    ...
    def change_password(
        ...
        *,
        ...
        return shapes.ChangePasswordResponse.from_boto_dict(response)
    ...
    def confirm_device(
        ...
        *,
        ...
        response = self._boto_client.confirm_device(**_request.to_boto_dict())

        return shapes.ConfirmDeviceResponse.from_boto_dict(response)
    ...
    def confirm_forgot_password(
        ...
        *,
        ...
        return shapes.ConfirmForgotPasswordResponse.from_boto_dict(response)
    ...
    def confirm_sign_up(
        ...
        *,
        ...
        response = self._boto_client.confirm_sign_up(**_request.to_boto_dict())

        return shapes.ConfirmSignUpResponse.from_boto_dict(response)
    ...
    def create_identity_provider(
        ...
        *,
        user_pool_id: str,
        provider_name: str,
        provider_type: shapes.IdentityProviderTypeType,
        ...
        return shapes.CreateIdentityProviderResponse.from_boto_dict(response)
    ...
    def create_resource_server(
        ...
        *,
        ...
        return shapes.CreateResourceServerResponse.from_boto_dict(response)
    ...
    def create_user_import_job(
        ...
        *,
        ...
        return shapes.CreateUserImportJobResponse.from_boto_dict(response)
    ...
    def create_user_pool(
        ...
        *,
        ...
        auto_verified_attributes: typing.List[shapes.VerifiedAttributeType
                                             ] = ShapeBase.NOT_SET,
        alias_attributes: typing.List[shapes.AliasAttributeType
                                     ] = ShapeBase.NOT_SET,
        username_attributes: typing.List[shapes.UsernameAttributeType
                                        ] = ShapeBase.NOT_SET,
        ...
        mfa_configuration: shapes.UserPoolMfaType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_user_pool(**_request.to_boto_dict())

        return shapes.CreateUserPoolResponse.from_boto_dict(response)
    ...
    def create_user_pool_client(
        ...
        *,
        ...
        explicit_auth_flows: typing.List[shapes.ExplicitAuthFlowsType
                                        ] = ShapeBase.NOT_SET,
        ...
        allowed_o_auth_flows: typing.List[shapes.OAuthFlowType
                                         ] = ShapeBase.NOT_SET,
        ...
        return shapes.CreateUserPoolClientResponse.from_boto_dict(response)
    ...
    def create_user_pool_domain(
        ...
        *,
        ...
        return shapes.CreateUserPoolDomainResponse.from_boto_dict(response)
    ...
    def delete_user_attributes(
        ...
        *,
        ...
        return shapes.DeleteUserAttributesResponse.from_boto_dict(response)
    ...
    def delete_user_pool(
        ...
        *,
        ...
        response = self._boto_client.delete_user_pool(**_request.to_boto_dict())
    ...
    def delete_user_pool_domain(
        ...
        *,
        ...
        return shapes.DeleteUserPoolDomainResponse.from_boto_dict(response)
    ...
    def describe_identity_provider(
        ...
        *,
        ...
        return shapes.DescribeIdentityProviderResponse.from_boto_dict(response)
    ...
    def describe_resource_server(
        ...
        *,
        ...
        return shapes.DescribeResourceServerResponse.from_boto_dict(response)
    ...
    def describe_risk_configuration(
        ...
        *,
        ...
        return shapes.DescribeRiskConfigurationResponse.from_boto_dict(response)
    ...
    def describe_user_import_job(
        ...
        *,
        ...
        return shapes.DescribeUserImportJobResponse.from_boto_dict(response)
    ...
    def describe_user_pool(
        ...
        *,
        ...
        response = self._boto_client.describe_user_pool(
            **_request.to_boto_dict()
        )

        return shapes.DescribeUserPoolResponse.from_boto_dict(response)
    ...
    def describe_user_pool_client(
        ...
        *,
        ...
        return shapes.DescribeUserPoolClientResponse.from_boto_dict(response)
    ...
    def describe_user_pool_domain(
        ...
        *,
        ...
        return shapes.DescribeUserPoolDomainResponse.from_boto_dict(response)
    ...
    def forget_device(
        ...
        *,
        ...
        response = self._boto_client.forget_device(**_request.to_boto_dict())
    ...
    def forgot_password(
        ...
        *,
        ...
        response = self._boto_client.forgot_password(**_request.to_boto_dict())

        return shapes.ForgotPasswordResponse.from_boto_dict(response)
    ...
    def get_csv_header(
        ...
        *,
        ...
        response = self._boto_client.get_csv_header(**_request.to_boto_dict())

        return shapes.GetCSVHeaderResponse.from_boto_dict(response)
    ...
    def get_device(
        ...
        *,
        ...
        response = self._boto_client.get_device(**_request.to_boto_dict())

        return shapes.GetDeviceResponse.from_boto_dict(response)
    ...
    def get_identity_provider_by_identifier(
        ...
        *,
        ...
        return shapes.GetIdentityProviderByIdentifierResponse.from_boto_dict(
            response
        )
    ...
    def get_signing_certificate(
        ...
        *,
        ...
        return shapes.GetSigningCertificateResponse.from_boto_dict(response)
    ...
    def get_ui_customization(
        ...
        *,
        ...
        response = self._boto_client.get_ui_customization(
            **_request.to_boto_dict()
        )

        return shapes.GetUICustomizationResponse.from_boto_dict(response)
    ...
    def get_user_attribute_verification_code(
        ...
        *,
        ...
        return shapes.GetUserAttributeVerificationCodeResponse.from_boto_dict(
            response
        )
    ...
    def get_user_pool_mfa_config(
        ...
        *,
        ...
        return shapes.GetUserPoolMfaConfigResponse.from_boto_dict(response)
    ...
    def global_sign_out(
        ...
        *,
        ...
        response = self._boto_client.global_sign_out(**_request.to_boto_dict())

        return shapes.GlobalSignOutResponse.from_boto_dict(response)
    ...
    def initiate_auth(
        ...
        *,
        ...
        response = self._boto_client.initiate_auth(**_request.to_boto_dict())

        return shapes.InitiateAuthResponse.from_boto_dict(response)
    ...
    def list_devices(
        ...
        *,
        ...
        response = self._boto_client.list_devices(**_request.to_boto_dict())

        return shapes.ListDevicesResponse.from_boto_dict(response)
    ...
    def list_identity_providers(
        ...
        *,
        ...
        return shapes.ListIdentityProvidersResponse.from_boto_dict(response)
    ...
    def list_resource_servers(
        ...
        *,
        ...
        response = self._boto_client.list_resource_servers(
            **_request.to_boto_dict()
        )

        return shapes.ListResourceServersResponse.from_boto_dict(response)
    ...
    def list_user_import_jobs(
        ...
        *,
        ...
        response = self._boto_client.list_user_import_jobs(
            **_request.to_boto_dict()
        )

        return shapes.ListUserImportJobsResponse.from_boto_dict(response)
    ...
    def list_user_pool_clients(
        ...
        *,
        ...
        return shapes.ListUserPoolClientsResponse.from_boto_dict(response)
    ...
    def list_user_pools(
        ...
        *,
        ...
        response = self._boto_client.list_user_pools(**_request.to_boto_dict())

        return shapes.ListUserPoolsResponse.from_boto_dict(response)
    ...
    def list_users_in_group(
        ...
        *,
        ...
        response = self._boto_client.list_users_in_group(
            **_request.to_boto_dict()
        )

        return shapes.ListUsersInGroupResponse.from_boto_dict(response)
    ...
    def resend_confirmation_code(
        ...
        *,
        ...
        return shapes.ResendConfirmationCodeResponse.from_boto_dict(response)
    ...
    def respond_to_auth_challenge(
        ...
        *,
        ...
        return shapes.RespondToAuthChallengeResponse.from_boto_dict(response)
    ...
    def set_risk_configuration(
        ...
        *,
        ...
        return shapes.SetRiskConfigurationResponse.from_boto_dict(response)
    ...
    def set_ui_customization(
        ...
        *,
        ...
        response = self._boto_client.set_ui_customization(
            **_request.to_boto_dict()
        )

        return shapes.SetUICustomizationResponse.from_boto_dict(response)
    ...
    def set_user_mfa_preference(
        ...
        *,
        ...
        return shapes.SetUserMFAPreferenceResponse.from_boto_dict(response)
    ...
    def set_user_pool_mfa_config(
        ...
        *,
        ...
        return shapes.SetUserPoolMfaConfigResponse.from_boto_dict(response)
    ...
    def set_user_settings(
        ...
        *,
        ...
        response = self._boto_client.set_user_settings(
            **_request.to_boto_dict()
        )

        return shapes.SetUserSettingsResponse.from_boto_dict(response)
    ...
    def sign_up(
        ...
        *,
        ...
        response = self._boto_client.sign_up(**_request.to_boto_dict())

        return shapes.SignUpResponse.from_boto_dict(response)
    ...
    def start_user_import_job(
        ...
        *,
        ...
        response = self._boto_client.start_user_import_job(
            **_request.to_boto_dict()
        )

        return shapes.StartUserImportJobResponse.from_boto_dict(response)
    ...
    def stop_user_import_job(
        ...
        *,
        ...
        response = self._boto_client.stop_user_import_job(
            **_request.to_boto_dict()
        )

        return shapes.StopUserImportJobResponse.from_boto_dict(response)
    ...
    def update_auth_event_feedback(
        ...
        *,
        ...
        return shapes.UpdateAuthEventFeedbackResponse.from_boto_dict(response)
    ...
    def update_device_status(
        ...
        *,
        ...
        response = self._boto_client.update_device_status(
            **_request.to_boto_dict()
        )

        return shapes.UpdateDeviceStatusResponse.from_boto_dict(response)
    ...
    def update_group(
        ...
        *,
        ...
        return shapes.UpdateGroupResponse.from_boto_dict(response)
    ...
    def update_identity_provider(
        ...
        *,
        ...
        return shapes.UpdateIdentityProviderResponse.from_boto_dict(response)
    ...
    def update_resource_server(
        ...
        *,
        ...
        return shapes.UpdateResourceServerResponse.from_boto_dict(response)
    ...
    def update_user_attributes(
        ...
        *,
        ...
        return shapes.UpdateUserAttributesResponse.from_boto_dict(response)
    ...
    def update_user_pool(
        ...
        *,
        ...
        response = self._boto_client.update_user_pool(**_request.to_boto_dict())

        return shapes.UpdateUserPoolResponse.from_boto_dict(response)
    ...
    def update_user_pool_client(
        ...
        *,
        ...
        return shapes.UpdateUserPoolClientResponse.from_boto_dict(response)
    ...
    def verify_software_token(
        ...
        *,
        ...
        response = self._boto_client.verify_software_token(
            **_request.to_boto_dict()
        )

        return shapes.VerifySoftwareTokenResponse.from_boto_dict(response)
    ...
    def verify_user_attribute(
        ...
        *,
        ...
        response = self._boto_client.verify_user_attribute(
            **_request.to_boto_dict()
        )

        return shapes.VerifyUserAttributeResponse.from_boto_dict(response)
