...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("iot-jobs-data", *args, **kwargs)
    ...
    def get_pending_job_executions(
        ...
        *,
        ...
        return shapes.GetPendingJobExecutionsResponse.from_boto_dict(response)
    ...
    def start_next_pending_job_execution(
        ...
        *,
        ...
        return shapes.StartNextPendingJobExecutionResponse.from_boto_dict(
            response
        )
    ...
    def update_job_execution(
        ...
        *,
        job_id: str,
        thing_name: str,
        status: shapes.JobExecutionStatus,
        status_details: typing.Dict[str, str] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.update_job_execution(
            **_request.to_boto_dict()
        )

        return shapes.UpdateJobExecutionResponse.from_boto_dict(response)
