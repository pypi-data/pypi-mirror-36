...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("iot-data", *args, **kwargs)
    ...
    def delete_thing_shadow(
        ...
        *,
        ...
        response = self._boto_client.delete_thing_shadow(
            **_request.to_boto_dict()
        )

        return shapes.DeleteThingShadowResponse.from_boto_dict(response)
    ...
    def get_thing_shadow(
        ...
        *,
        ...
        response = self._boto_client.get_thing_shadow(**_request.to_boto_dict())

        return shapes.GetThingShadowResponse.from_boto_dict(response)
    ...
    def update_thing_shadow(
        ...
        *,
        ...
        response = self._boto_client.update_thing_shadow(
            **_request.to_boto_dict()
        )

        return shapes.UpdateThingShadowResponse.from_boto_dict(response)
