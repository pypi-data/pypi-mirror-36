...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("macie", *args, **kwargs)
    ...
    def associate_s3_resources(
        ...
        *,
        ...
        return shapes.AssociateS3ResourcesResult.from_boto_dict(response)
    ...
    def disassociate_s3_resources(
        ...
        *,
        ...
        return shapes.DisassociateS3ResourcesResult.from_boto_dict(response)
    ...
    def list_member_accounts(
        ...
        *,
        ...
        return shapes.ListMemberAccountsResult.from_boto_dict(response)
    ...
    def list_s3_resources(
        ...
        *,
        ...
        response = self._boto_client.list_s3_resources(
            **_request.to_boto_dict()
        )

        return shapes.ListS3ResourcesResult.from_boto_dict(response)
    ...
    def update_s3_resources(
        ...
        *,
        ...
        response = self._boto_client.update_s3_resources(
            **_request.to_boto_dict()
        )

        return shapes.UpdateS3ResourcesResult.from_boto_dict(response)
