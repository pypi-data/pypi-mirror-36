...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client(
            "kinesis-video-archived-media", *args, **kwargs
        )
    ...
    def get_hls_streaming_session_url(
        ...
        *,
        ...
        playback_mode: shapes.PlaybackMode = ShapeBase.NOT_SET,
        hls_fragment_selector: shapes.HLSFragmentSelector = ShapeBase.NOT_SET,
        discontinuity_mode: shapes.DiscontinuityMode = ShapeBase.NOT_SET,
        ...
        return shapes.GetHLSStreamingSessionURLOutput.from_boto_dict(response)
    ...
    def get_media_for_fragment_list(
        ...
        *,
        ...
        return shapes.GetMediaForFragmentListOutput.from_boto_dict(response)
    ...
    def list_fragments(
        ...
        *,
        ...
        response = self._boto_client.list_fragments(**_request.to_boto_dict())

        return shapes.ListFragmentsOutput.from_boto_dict(response)
