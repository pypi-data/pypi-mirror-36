...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("apigateway", *args, **kwargs)
    ...
    def create_api_key(
        ...
        *,
        ...
        response = self._boto_client.create_api_key(**_request.to_boto_dict())

        return shapes.ApiKey.from_boto_dict(response)
    ...
    def create_authorizer(
        ...
        *,
        ...
        return shapes.Authorizer.from_boto_dict(response)
    ...
    def create_base_path_mapping(
        ...
        *,
        ...
        return shapes.BasePathMapping.from_boto_dict(response)
    ...
    def create_deployment(
        ...
        *,
        ...
        cache_cluster_size: shapes.CacheClusterSize = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_deployment(
            **_request.to_boto_dict()
        )

        return shapes.Deployment.from_boto_dict(response)
    ...
    def create_documentation_part(
        ...
        *,
        ...
        return shapes.DocumentationPart.from_boto_dict(response)
    ...
    def create_documentation_version(
        ...
        *,
        ...
        return shapes.DocumentationVersion.from_boto_dict(response)
    ...
    def create_domain_name(
        ...
        *,
        ...
        response = self._boto_client.create_domain_name(
            **_request.to_boto_dict()
        )

        return shapes.DomainName.from_boto_dict(response)
    ...
    def create_model(
        ...
        *,
        ...
        return shapes.Model.from_boto_dict(response)
    ...
    def create_request_validator(
        ...
        *,
        ...
        return shapes.RequestValidator.from_boto_dict(response)
    ...
    def create_resource(
        ...
        *,
        ...
        response = self._boto_client.create_resource(**_request.to_boto_dict())

        return shapes.Resource.from_boto_dict(response)
    ...
    def create_rest_api(
        ...
        *,
        ...
        api_key_source: shapes.ApiKeySourceType = ShapeBase.NOT_SET,
        endpoint_configuration: shapes.EndpointConfiguration = ShapeBase.
        NOT_SET,
        ...
        response = self._boto_client.create_rest_api(**_request.to_boto_dict())

        return shapes.RestApi.from_boto_dict(response)
    ...
    def create_stage(
        ...
        *,
        ...
        response = self._boto_client.create_stage(**_request.to_boto_dict())

        return shapes.Stage.from_boto_dict(response)
    ...
    def create_usage_plan(
        ...
        *,
        ...
        response = self._boto_client.create_usage_plan(
            **_request.to_boto_dict()
        )

        return shapes.UsagePlan.from_boto_dict(response)
    ...
    def create_usage_plan_key(
        ...
        *,
        ...
        response = self._boto_client.create_usage_plan_key(
            **_request.to_boto_dict()
        )

        return shapes.UsagePlanKey.from_boto_dict(response)
    ...
    def create_vpc_link(
        ...
        *,
        ...
        response = self._boto_client.create_vpc_link(**_request.to_boto_dict())

        return shapes.VpcLink.from_boto_dict(response)
    ...
    def delete_api_key(
        ...
        *,
        ...
        response = self._boto_client.delete_api_key(**_request.to_boto_dict())
    ...
    def delete_deployment(
        ...
        *,
        ...
        response = self._boto_client.delete_deployment(
            **_request.to_boto_dict()
        )
    ...
    def delete_domain_name(
        ...
        *,
        ...
        response = self._boto_client.delete_domain_name(
            **_request.to_boto_dict()
        )
    ...
    def delete_gateway_response(
        ...
        *,
        rest_api_id: str,
        response_type: shapes.GatewayResponseType,
    ) -> None:
        """
    ...
    def delete_integration(
        ...
        *,
        ...
        response = self._boto_client.delete_integration(
            **_request.to_boto_dict()
        )
    ...
    def delete_method(
        ...
        *,
        ...
        response = self._boto_client.delete_method(**_request.to_boto_dict())
    ...
    def delete_resource(
        ...
        *,
        ...
        response = self._boto_client.delete_resource(**_request.to_boto_dict())
    ...
    def delete_rest_api(
        ...
        *,
        ...
        response = self._boto_client.delete_rest_api(**_request.to_boto_dict())
    ...
    def delete_stage(
        ...
        *,
        ...
        response = self._boto_client.delete_stage(**_request.to_boto_dict())
    ...
    def delete_usage_plan(
        ...
        *,
        ...
        response = self._boto_client.delete_usage_plan(
            **_request.to_boto_dict()
        )
    ...
    def delete_usage_plan_key(
        ...
        *,
        ...
        response = self._boto_client.delete_usage_plan_key(
            **_request.to_boto_dict()
        )
    ...
    def delete_vpc_link(
        ...
        *,
        ...
        response = self._boto_client.delete_vpc_link(**_request.to_boto_dict())
    ...
    def flush_stage_cache(
        ...
        *,
        ...
        response = self._boto_client.flush_stage_cache(
            **_request.to_boto_dict()
        )
    ...
    def generate_client_certificate(
        ...
        *,
        ...
        return shapes.ClientCertificate.from_boto_dict(response)
    ...
    def get_account(
        ...
        response = self._boto_client.get_account(**_request.to_boto_dict())

        return shapes.Account.from_boto_dict(response)
    ...
    def get_api_key(
        ...
        *,
        ...
        response = self._boto_client.get_api_key(**_request.to_boto_dict())
    ...
    def get_api_keys(
        ...
        *,
        ...
        response = self._boto_client.get_api_keys(**_request.to_boto_dict())

        return shapes.ApiKeys.from_boto_dict(response)
    ...
    def get_authorizer(
        ...
        *,
        ...
        response = self._boto_client.get_authorizer(**_request.to_boto_dict())
    ...
    def get_authorizers(
        ...
        *,
        ...
        response = self._boto_client.get_authorizers(**_request.to_boto_dict())

        return shapes.Authorizers.from_boto_dict(response)
    ...
    def get_base_path_mapping(
        ...
        *,
        ...
        response = self._boto_client.get_base_path_mapping(
            **_request.to_boto_dict()
        )
    ...
    def get_base_path_mappings(
        ...
        *,
        ...
        response = self._boto_client.get_base_path_mappings(
            **_request.to_boto_dict()
        )

        return shapes.BasePathMappings.from_boto_dict(response)
    ...
    def get_client_certificates(
        ...
        *,
        ...
        response = self._boto_client.get_client_certificates(
            **_request.to_boto_dict()
        )

        return shapes.ClientCertificates.from_boto_dict(response)
    ...
    def get_deployment(
        ...
        *,
        ...
        response = self._boto_client.get_deployment(**_request.to_boto_dict())
    ...
    def get_deployments(
        ...
        *,
        ...
        response = self._boto_client.get_deployments(**_request.to_boto_dict())

        return shapes.Deployments.from_boto_dict(response)
    ...
    def get_documentation_parts(
        ...
        *,
        rest_api_id: str,
        type: shapes.DocumentationPartType = ShapeBase.NOT_SET,
        name_query: str = ShapeBase.NOT_SET,
        path: str = ShapeBase.NOT_SET,
        position: str = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        location_status: shapes.LocationStatusType = ShapeBase.NOT_SET,
        ...
        return shapes.DocumentationParts.from_boto_dict(response)
    ...
    def get_documentation_versions(
        ...
        *,
        ...
        return shapes.DocumentationVersions.from_boto_dict(response)
    ...
    def get_domain_name(
        ...
        *,
        ...
        response = self._boto_client.get_domain_name(**_request.to_boto_dict())
    ...
    def get_domain_names(
        ...
        *,
        ...
        response = self._boto_client.get_domain_names(**_request.to_boto_dict())

        return shapes.DomainNames.from_boto_dict(response)
    ...
    def get_export(
        ...
        *,
        ...
        response = self._boto_client.get_export(**_request.to_boto_dict())

        return shapes.ExportResponse.from_boto_dict(response)
    ...
    def get_gateway_response(
        ...
        *,
        ...
        response = self._boto_client.get_gateway_response(
            **_request.to_boto_dict()
        )

        return shapes.GatewayResponse.from_boto_dict(response)
    ...
    def get_gateway_responses(
        ...
        *,
        ...
        response = self._boto_client.get_gateway_responses(
            **_request.to_boto_dict()
        )

        return shapes.GatewayResponses.from_boto_dict(response)
    ...
    def get_integration(
        ...
        *,
        ...
        response = self._boto_client.get_integration(**_request.to_boto_dict())

        return shapes.Integration.from_boto_dict(response)
    ...
    def get_integration_response(
        ...
        *,
        ...
        return shapes.IntegrationResponse.from_boto_dict(response)
    ...
    def get_method(
        ...
        *,
        ...
        response = self._boto_client.get_method(**_request.to_boto_dict())

        return shapes.Method.from_boto_dict(response)
    ...
    def get_method_response(
        ...
        *,
        ...
        response = self._boto_client.get_method_response(
            **_request.to_boto_dict()
        )

        return shapes.MethodResponse.from_boto_dict(response)
    ...
    def get_model(
        ...
        *,
        ...
        response = self._boto_client.get_model(**_request.to_boto_dict())
    ...
    def get_model_template(
        ...
        *,
        ...
        response = self._boto_client.get_model_template(
            **_request.to_boto_dict()
        )

        return shapes.Template.from_boto_dict(response)
    ...
    def get_models(
        ...
        *,
        ...
        response = self._boto_client.get_models(**_request.to_boto_dict())

        return shapes.Models.from_boto_dict(response)
    ...
    def get_request_validator(
        ...
        *,
        ...
        response = self._boto_client.get_request_validator(
            **_request.to_boto_dict()
        )
    ...
    def get_request_validators(
        ...
        *,
        ...
        return shapes.RequestValidators.from_boto_dict(response)
    ...
    def get_resource(
        ...
        *,
        ...
        response = self._boto_client.get_resource(**_request.to_boto_dict())
    ...
    def get_resources(
        ...
        *,
        ...
        response = self._boto_client.get_resources(**_request.to_boto_dict())

        return shapes.Resources.from_boto_dict(response)
    ...
    def get_rest_api(
        ...
        *,
        ...
        response = self._boto_client.get_rest_api(**_request.to_boto_dict())
    ...
    def get_rest_apis(
        ...
        *,
        ...
        response = self._boto_client.get_rest_apis(**_request.to_boto_dict())

        return shapes.RestApis.from_boto_dict(response)
    ...
    def get_sdk(
        ...
        *,
        ...
        response = self._boto_client.get_sdk(**_request.to_boto_dict())

        return shapes.SdkResponse.from_boto_dict(response)
    ...
    def get_sdk_type(
        ...
        *,
        ...
        response = self._boto_client.get_sdk_type(**_request.to_boto_dict())

        return shapes.SdkType.from_boto_dict(response)
    ...
    def get_sdk_types(
        ...
        *,
        ...
        response = self._boto_client.get_sdk_types(**_request.to_boto_dict())

        return shapes.SdkTypes.from_boto_dict(response)
    ...
    def get_stage(
        ...
        *,
        ...
        response = self._boto_client.get_stage(**_request.to_boto_dict())
    ...
    def get_stages(
        ...
        *,
        ...
        response = self._boto_client.get_stages(**_request.to_boto_dict())

        return shapes.Stages.from_boto_dict(response)
    ...
    def get_tags(
        ...
        *,
        ...
        return shapes.Tags.from_boto_dict(response)
    ...
    def get_usage(
        ...
        *,
        ...
        response = self._boto_client.get_usage(**_request.to_boto_dict())

        return shapes.Usage.from_boto_dict(response)
    ...
    def get_usage_plan(
        ...
        *,
        ...
        response = self._boto_client.get_usage_plan(**_request.to_boto_dict())
    ...
    def get_usage_plan_key(
        ...
        *,
        ...
        response = self._boto_client.get_usage_plan_key(
            **_request.to_boto_dict()
        )
    ...
    def get_usage_plan_keys(
        ...
        *,
        ...
        response = self._boto_client.get_usage_plan_keys(
            **_request.to_boto_dict()
        )

        return shapes.UsagePlanKeys.from_boto_dict(response)
    ...
    def get_usage_plans(
        ...
        *,
        ...
        response = self._boto_client.get_usage_plans(**_request.to_boto_dict())

        return shapes.UsagePlans.from_boto_dict(response)
    ...
    def get_vpc_link(
        ...
        *,
        ...
        response = self._boto_client.get_vpc_link(**_request.to_boto_dict())
    ...
    def get_vpc_links(
        ...
        *,
        ...
        response = self._boto_client.get_vpc_links(**_request.to_boto_dict())

        return shapes.VpcLinks.from_boto_dict(response)
    ...
    def import_api_keys(
        ...
        *,
        ...
        response = self._boto_client.import_api_keys(**_request.to_boto_dict())

        return shapes.ApiKeyIds.from_boto_dict(response)
    ...
    def import_documentation_parts(
        ...
        *,
        rest_api_id: str,
        body: typing.Any,
        mode: shapes.PutMode = ShapeBase.NOT_SET,
        fail_on_warnings: bool = ShapeBase.NOT_SET,
        ...
        return shapes.DocumentationPartIds.from_boto_dict(response)
    ...
    def import_rest_api(
        ...
        *,
        ...
        response = self._boto_client.import_rest_api(**_request.to_boto_dict())
    ...
    def put_gateway_response(
        ...
        *,
        ...
        response = self._boto_client.put_gateway_response(
            **_request.to_boto_dict()
        )
    ...
    def put_integration(
        ...
        *,
        ...
        resource_id: str,
        http_method: str,
        type: shapes.IntegrationType,
        integration_http_method: str = ShapeBase.NOT_SET,
        uri: str = ShapeBase.NOT_SET,
        connection_type: shapes.ConnectionType = ShapeBase.NOT_SET,
        ...
        content_handling: shapes.ContentHandlingStrategy = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.put_integration(**_request.to_boto_dict())
    ...
    def put_method(
        ...
        *,
        ...
        response = self._boto_client.put_method(**_request.to_boto_dict())
    ...
    def put_method_response(
        ...
        *,
        ...
        response = self._boto_client.put_method_response(
            **_request.to_boto_dict()
        )
    ...
    def put_rest_api(
        ...
        *,
        ...
        response = self._boto_client.put_rest_api(**_request.to_boto_dict())
    ...
    def test_invoke_method(
        ...
        *,
        ...
        response = self._boto_client.test_invoke_method(
            **_request.to_boto_dict()
        )

        return shapes.TestInvokeMethodResponse.from_boto_dict(response)
    ...
    def update_account(
        ...
        *,
        ...
        response = self._boto_client.update_account(**_request.to_boto_dict())
    ...
    def update_api_key(
        ...
        *,
        ...
        response = self._boto_client.update_api_key(**_request.to_boto_dict())
    ...
    def update_deployment(
        ...
        *,
        ...
        response = self._boto_client.update_deployment(
            **_request.to_boto_dict()
        )
    ...
    def update_domain_name(
        ...
        *,
        ...
        response = self._boto_client.update_domain_name(
            **_request.to_boto_dict()
        )
    ...
    def update_integration(
        ...
        *,
        ...
        response = self._boto_client.update_integration(
            **_request.to_boto_dict()
        )
    ...
    def update_method(
        ...
        *,
        ...
        response = self._boto_client.update_method(**_request.to_boto_dict())
    ...
    def update_model(
        ...
        *,
        ...
        response = self._boto_client.update_model(**_request.to_boto_dict())
    ...
    def update_resource(
        ...
        *,
        ...
        response = self._boto_client.update_resource(**_request.to_boto_dict())
    ...
    def update_rest_api(
        ...
        *,
        ...
        response = self._boto_client.update_rest_api(**_request.to_boto_dict())
    ...
    def update_stage(
        ...
        *,
        ...
        response = self._boto_client.update_stage(**_request.to_boto_dict())
    ...
    def update_usage(
        ...
        *,
        ...
        response = self._boto_client.update_usage(**_request.to_boto_dict())
    ...
    def update_usage_plan(
        ...
        *,
        ...
        response = self._boto_client.update_usage_plan(
            **_request.to_boto_dict()
        )
    ...
    def update_vpc_link(
        ...
        *,
        ...
        response = self._boto_client.update_vpc_link(**_request.to_boto_dict())
