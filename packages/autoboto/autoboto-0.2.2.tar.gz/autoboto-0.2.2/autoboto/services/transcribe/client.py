...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("transcribe", *args, **kwargs)
    ...
    def create_vocabulary(
        ...
        *,
        ...
        response = self._boto_client.create_vocabulary(
            **_request.to_boto_dict()
        )

        return shapes.CreateVocabularyResponse.from_boto_dict(response)
    ...
    def delete_vocabulary(
        ...
        *,
        ...
        response = self._boto_client.delete_vocabulary(
            **_request.to_boto_dict()
        )
    ...
    def get_transcription_job(
        ...
        *,
        ...
        response = self._boto_client.get_transcription_job(
            **_request.to_boto_dict()
        )

        return shapes.GetTranscriptionJobResponse.from_boto_dict(response)
    ...
    def get_vocabulary(
        ...
        *,
        ...
        response = self._boto_client.get_vocabulary(**_request.to_boto_dict())

        return shapes.GetVocabularyResponse.from_boto_dict(response)

    def list_transcription_jobs(
        self,
        _request: shapes.ListTranscriptionJobsRequest = None,
        *,
        status: shapes.TranscriptionJobStatus = ShapeBase.NOT_SET,
        ...
        return shapes.ListTranscriptionJobsResponse.from_boto_dict(response)
    ...
    def list_vocabularies(
        ...
        *,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        state_equals: shapes.VocabularyState = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_vocabularies(
            **_request.to_boto_dict()
        )

        return shapes.ListVocabulariesResponse.from_boto_dict(response)
    ...
    def start_transcription_job(
        ...
        *,
        transcription_job_name: str,
        language_code: shapes.LanguageCode,
        media_format: shapes.MediaFormat,
        media: shapes.Media,
        ...
        return shapes.StartTranscriptionJobResponse.from_boto_dict(response)
    ...
    def update_vocabulary(
        ...
        *,
        ...
        response = self._boto_client.update_vocabulary(
            **_request.to_boto_dict()
        )

        return shapes.UpdateVocabularyResponse.from_boto_dict(response)
