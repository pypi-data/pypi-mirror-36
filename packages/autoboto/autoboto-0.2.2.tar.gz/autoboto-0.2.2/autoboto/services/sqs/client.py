...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("sqs", *args, **kwargs)
    ...
    def change_message_visibility_batch(
        ...
        *,
        ...
        return shapes.ChangeMessageVisibilityBatchResult.from_boto_dict(
            response
        )
    ...
    def create_queue(
        ...
        *,
        queue_name: str,
        attributes: typing.Dict[shapes.QueueAttributeName, str
                               ] = ShapeBase.NOT_SET,
        ...
        return shapes.CreateQueueResult.from_boto_dict(response)
    ...
    def delete_message(
        ...
        *,
        ...
        response = self._boto_client.delete_message(**_request.to_boto_dict())
    ...
    def delete_message_batch(
        ...
        *,
        ...
        response = self._boto_client.delete_message_batch(
            **_request.to_boto_dict()
        )

        return shapes.DeleteMessageBatchResult.from_boto_dict(response)
    ...
    def get_queue_attributes(
        ...
        *,
        queue_url: str,
        attribute_names: typing.List[shapes.QueueAttributeName
                                    ] = ShapeBase.NOT_SET,
        ...
        return shapes.GetQueueAttributesResult.from_boto_dict(response)
    ...
    def get_queue_url(
        ...
        *,
        ...
        response = self._boto_client.get_queue_url(**_request.to_boto_dict())

        return shapes.GetQueueUrlResult.from_boto_dict(response)
    ...
    def list_dead_letter_source_queues(
        ...
        *,
        ...
        return shapes.ListDeadLetterSourceQueuesResult.from_boto_dict(response)
    ...
    def list_queue_tags(
        ...
        *,
        ...
        response = self._boto_client.list_queue_tags(**_request.to_boto_dict())

        return shapes.ListQueueTagsResult.from_boto_dict(response)
    ...
    def list_queues(
        ...
        *,
        ...
        return shapes.ListQueuesResult.from_boto_dict(response)
    ...
    def purge_queue(
        ...
        *,
        ...
        response = self._boto_client.purge_queue(**_request.to_boto_dict())
    ...
    def receive_message(
        ...
        *,
        ...
        response = self._boto_client.receive_message(**_request.to_boto_dict())

        return shapes.ReceiveMessageResult.from_boto_dict(response)
    ...
    def send_message(
        ...
        *,
        ...
        response = self._boto_client.send_message(**_request.to_boto_dict())

        return shapes.SendMessageResult.from_boto_dict(response)
    ...
    def send_message_batch(
        ...
        *,
        ...
        return shapes.SendMessageBatchResult.from_boto_dict(response)
    ...
    def set_queue_attributes(
        ...
        *,
        ...
        response = self._boto_client.set_queue_attributes(
            **_request.to_boto_dict()
        )
    ...
    def tag_queue(
        ...
        *,
        ...
        response = self._boto_client.tag_queue(**_request.to_boto_dict())
    ...
    def untag_queue(
        ...
        *,
        ...
        response = self._boto_client.untag_queue(**_request.to_boto_dict())
