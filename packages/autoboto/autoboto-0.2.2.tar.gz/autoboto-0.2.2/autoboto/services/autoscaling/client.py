...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("autoscaling", *args, **kwargs)
    ...
    def create_auto_scaling_group(
        ...
        *,
        ...
        lifecycle_hook_specification_list: typing.List[
            shapes.LifecycleHookSpecification
        ] = ShapeBase.NOT_SET,
    ...
    def describe_auto_scaling_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_auto_scaling_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_auto_scaling_instances(
        ...
        *,
        ...
        response = self._boto_client.describe_auto_scaling_instances(
            **_request.to_boto_dict()
        )
    ...
    def describe_launch_configurations(
        ...
        *,
        ...
        response = self._boto_client.describe_launch_configurations(
            **_request.to_boto_dict()
        )
    ...
    def describe_notification_configurations(
        ...
        *,
        ...
        response = self._boto_client.describe_notification_configurations(
            **_request.to_boto_dict()
        )
    ...
    def describe_policies(
        ...
        *,
        ...
        response = self._boto_client.describe_policies(
            **_request.to_boto_dict()
        )
    ...
    def describe_scaling_activities(
        ...
        *,
        ...
        response = self._boto_client.describe_scaling_activities(
            **_request.to_boto_dict()
        )
