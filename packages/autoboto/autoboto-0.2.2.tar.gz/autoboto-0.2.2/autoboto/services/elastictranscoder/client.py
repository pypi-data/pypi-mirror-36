...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("elastictranscoder", *args, **kwargs)
    ...
    def list_jobs_by_pipeline(
        ...
        *,
        ...
        response = self._boto_client.list_jobs_by_pipeline(
    ...
    def list_jobs_by_status(
        ...
        *,
        ...
        response = self._boto_client.list_jobs_by_status(
            **_request.to_boto_dict()
        )
