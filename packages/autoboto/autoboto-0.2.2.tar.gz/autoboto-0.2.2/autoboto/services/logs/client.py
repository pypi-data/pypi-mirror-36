...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("logs", *args, **kwargs)
    ...
    def describe_destinations(
        ...
        *,
        ...
        response = self._boto_client.describe_destinations(
            **_request.to_boto_dict()
        )
    ...
    def describe_log_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_log_groups(
            **_request.to_boto_dict()
        )
    ...
    def describe_log_streams(
        ...
        *,
        ...
        response = self._boto_client.describe_log_streams(
            **_request.to_boto_dict()
        )
    ...
    def describe_metric_filters(
        ...
        *,
        ...
        response = self._boto_client.describe_metric_filters(
            **_request.to_boto_dict()
        )
    ...
    def describe_subscription_filters(
        ...
        *,
        ...
        response = self._boto_client.describe_subscription_filters(
            **_request.to_boto_dict()
        )
    ...
    def filter_log_events(
        ...
        *,
        ...
        response = self._boto_client.filter_log_events(
            **_request.to_boto_dict()
        )
