...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("mturk", *args, **kwargs)
    ...
    def list_assignments_for_hit(
        ...
        *,
        ...
        response = self._boto_client.list_assignments_for_hit(
            **_request.to_boto_dict()
        )
    ...
    def list_bonus_payments(
        ...
        *,
        ...
        response = self._boto_client.list_bonus_payments(
            **_request.to_boto_dict()
        )
    ...
    def list_hits(
        ...
        *,
        ...
        response = self._boto_client.list_hits(**_request.to_boto_dict())
    ...
    def list_hits_for_qualification_type(
        ...
        *,
        ...
        response = self._boto_client.list_hits_for_qualification_type(
            **_request.to_boto_dict()
        )
    ...
    def list_qualification_requests(
        ...
        *,
        ...
        response = self._boto_client.list_qualification_requests(
            **_request.to_boto_dict()
        )
    ...
    def list_qualification_types(
        ...
        *,
        ...
        response = self._boto_client.list_qualification_types(
            **_request.to_boto_dict()
        )
    ...
    def list_reviewable_hits(
        ...
        *,
        ...
        response = self._boto_client.list_reviewable_hits(
            **_request.to_boto_dict()
        )
    ...
    def list_worker_blocks(
        ...
        *,
        ...
        response = self._boto_client.list_worker_blocks(
            **_request.to_boto_dict()
        )
    ...
    def list_workers_with_qualification_type(
        ...
        *,
        ...
        response = self._boto_client.list_workers_with_qualification_type(
            **_request.to_boto_dict()
        )
