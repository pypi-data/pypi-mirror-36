...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("datapipeline", *args, **kwargs)
    ...
    def activate_pipeline(
        ...
        *,
        ...
        response = self._boto_client.activate_pipeline(
            **_request.to_boto_dict()
        )

        return shapes.ActivatePipelineOutput.from_boto_dict(response)
    ...
    def deactivate_pipeline(
        ...
        *,
        ...
        response = self._boto_client.deactivate_pipeline(
            **_request.to_boto_dict()
        )

        return shapes.DeactivatePipelineOutput.from_boto_dict(response)
    ...
    def describe_objects(
        ...
        *,
        ...
        response = self._boto_client.describe_objects(**_request.to_boto_dict())

        return shapes.DescribeObjectsOutput.from_boto_dict(response)
    ...
    def describe_pipelines(
        ...
        *,
        ...
        response = self._boto_client.describe_pipelines(
            **_request.to_boto_dict()
        )

        return shapes.DescribePipelinesOutput.from_boto_dict(response)
    ...
    def evaluate_expression(
        ...
        *,
        ...
        response = self._boto_client.evaluate_expression(
            **_request.to_boto_dict()
        )

        return shapes.EvaluateExpressionOutput.from_boto_dict(response)
    ...
    def get_pipeline_definition(
        ...
        *,
        ...
        return shapes.GetPipelineDefinitionOutput.from_boto_dict(response)
    ...
    def poll_for_task(
        ...
        *,
        ...
        response = self._boto_client.poll_for_task(**_request.to_boto_dict())

        return shapes.PollForTaskOutput.from_boto_dict(response)
    ...
    def put_pipeline_definition(
        ...
        *,
        ...
        return shapes.PutPipelineDefinitionOutput.from_boto_dict(response)
    ...
    def query_objects(
        ...
        *,
        ...
        response = self._boto_client.query_objects(**_request.to_boto_dict())

        return shapes.QueryObjectsOutput.from_boto_dict(response)
    ...
    def report_task_progress(
        ...
        *,
        ...
        response = self._boto_client.report_task_progress(
            **_request.to_boto_dict()
        )

        return shapes.ReportTaskProgressOutput.from_boto_dict(response)
    ...
    def report_task_runner_heartbeat(
        ...
        *,
        ...
        return shapes.ReportTaskRunnerHeartbeatOutput.from_boto_dict(response)
    ...
    def set_status(
        ...
        *,
        ...
        response = self._boto_client.set_status(**_request.to_boto_dict())
    ...
    def set_task_status(
        ...
        *,
        ...
        response = self._boto_client.set_task_status(**_request.to_boto_dict())

        return shapes.SetTaskStatusOutput.from_boto_dict(response)
    ...
    def validate_pipeline_definition(
        ...
        *,
        ...
        return shapes.ValidatePipelineDefinitionOutput.from_boto_dict(response)
