...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("meteringmarketplace", *args, **kwargs)
    ...
    def batch_meter_usage(
        ...
        *,
        ...
        response = self._boto_client.batch_meter_usage(
            **_request.to_boto_dict()
        )

        return shapes.BatchMeterUsageResult.from_boto_dict(response)
    ...
    def meter_usage(
        ...
        *,
        ...
        response = self._boto_client.meter_usage(**_request.to_boto_dict())

        return shapes.MeterUsageResult.from_boto_dict(response)
    ...
    def resolve_customer(
        ...
        *,
        ...
        response = self._boto_client.resolve_customer(**_request.to_boto_dict())

        return shapes.ResolveCustomerResult.from_boto_dict(response)
