...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("workdocs", *args, **kwargs)
    ...
    def activate_user(
        ...
        *,
        ...
        response = self._boto_client.activate_user(**_request.to_boto_dict())

        return shapes.ActivateUserResponse.from_boto_dict(response)
    ...
    def add_resource_permissions(
        ...
        *,
        ...
        return shapes.AddResourcePermissionsResponse.from_boto_dict(response)
    ...
    def create_comment(
        ...
        *,
        ...
        visibility: shapes.CommentVisibilityType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_comment(**_request.to_boto_dict())

        return shapes.CreateCommentResponse.from_boto_dict(response)
    ...
    def create_custom_metadata(
        ...
        *,
        ...
        return shapes.CreateCustomMetadataResponse.from_boto_dict(response)
    ...
    def create_folder(
        ...
        *,
        ...
        response = self._boto_client.create_folder(**_request.to_boto_dict())

        return shapes.CreateFolderResponse.from_boto_dict(response)
    ...
    def create_labels(
        ...
        *,
        ...
        response = self._boto_client.create_labels(**_request.to_boto_dict())

        return shapes.CreateLabelsResponse.from_boto_dict(response)
    ...
    def create_notification_subscription(
        ...
        *,
        organization_id: str,
        endpoint: str,
        protocol: shapes.SubscriptionProtocolType,
        subscription_type: shapes.SubscriptionType,
        ...
        return shapes.CreateNotificationSubscriptionResponse.from_boto_dict(
            response
        )
    ...
    def deactivate_user(
        ...
        *,
        ...
        response = self._boto_client.deactivate_user(**_request.to_boto_dict())
    ...
    def delete_comment(
        ...
        *,
        ...
        response = self._boto_client.delete_comment(**_request.to_boto_dict())
    ...
    def delete_custom_metadata(
        ...
        *,
        ...
        return shapes.DeleteCustomMetadataResponse.from_boto_dict(response)
    ...
    def delete_folder(
        ...
        *,
        ...
        response = self._boto_client.delete_folder(**_request.to_boto_dict())
    ...
    def delete_labels(
        ...
        *,
        ...
        response = self._boto_client.delete_labels(**_request.to_boto_dict())

        return shapes.DeleteLabelsResponse.from_boto_dict(response)
    ...
    def describe_activities(
        ...
        *,
        ...
        response = self._boto_client.describe_activities(
            **_request.to_boto_dict()
        )

        return shapes.DescribeActivitiesResponse.from_boto_dict(response)
    ...
    def describe_comments(
        ...
        *,
        ...
        response = self._boto_client.describe_comments(
            **_request.to_boto_dict()
        )

        return shapes.DescribeCommentsResponse.from_boto_dict(response)
    ...
    def describe_document_versions(
        ...
        *,
        ...
        response = self._boto_client.describe_document_versions(
            **_request.to_boto_dict()
        )

        return shapes.DescribeDocumentVersionsResponse.from_boto_dict(response)
    ...
    def describe_folder_contents(
        ...
        *,
        folder_id: str,
        authentication_token: str = ShapeBase.NOT_SET,
        sort: shapes.ResourceSortType = ShapeBase.NOT_SET,
        order: shapes.OrderType = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        marker: str = ShapeBase.NOT_SET,
        type: shapes.FolderContentType = ShapeBase.NOT_SET,
        include: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_folder_contents(
            **_request.to_boto_dict()
        )

        return shapes.DescribeFolderContentsResponse.from_boto_dict(response)
    ...
    def describe_groups(
        ...
        *,
        ...
        response = self._boto_client.describe_groups(**_request.to_boto_dict())

        return shapes.DescribeGroupsResponse.from_boto_dict(response)
    ...
    def describe_notification_subscriptions(
        ...
        *,
        ...
        return shapes.DescribeNotificationSubscriptionsResponse.from_boto_dict(
            response
        )
    ...
    def describe_resource_permissions(
        ...
        *,
        ...
        return shapes.DescribeResourcePermissionsResponse.from_boto_dict(
            response
        )
    ...
    def describe_root_folders(
        ...
        *,
        ...
        response = self._boto_client.describe_root_folders(
            **_request.to_boto_dict()
        )

        return shapes.DescribeRootFoldersResponse.from_boto_dict(response)
    ...
    def describe_users(
        ...
        *,
        ...
        include: shapes.UserFilterType = ShapeBase.NOT_SET,
        order: shapes.OrderType = ShapeBase.NOT_SET,
        sort: shapes.UserSortType = ShapeBase.NOT_SET,
        marker: str = ShapeBase.NOT_SET,
        limit: int = ShapeBase.NOT_SET,
        fields: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_users(**_request.to_boto_dict())

        return shapes.DescribeUsersResponse.from_boto_dict(response)
    ...
    def get_current_user(
        ...
        *,
        ...
        response = self._boto_client.get_current_user(**_request.to_boto_dict())

        return shapes.GetCurrentUserResponse.from_boto_dict(response)
    ...
    def get_document(
        ...
        *,
        ...
        return shapes.GetDocumentResponse.from_boto_dict(response)
    ...
    def get_document_path(
        ...
        *,
        ...
        response = self._boto_client.get_document_path(
            **_request.to_boto_dict()
        )

        return shapes.GetDocumentPathResponse.from_boto_dict(response)
    ...
    def get_document_version(
        ...
        *,
        ...
        response = self._boto_client.get_document_version(
            **_request.to_boto_dict()
        )

        return shapes.GetDocumentVersionResponse.from_boto_dict(response)
    ...
    def get_folder(
        ...
        *,
        ...
        response = self._boto_client.get_folder(**_request.to_boto_dict())

        return shapes.GetFolderResponse.from_boto_dict(response)
    ...
    def get_folder_path(
        ...
        *,
        ...
        response = self._boto_client.get_folder_path(**_request.to_boto_dict())

        return shapes.GetFolderPathResponse.from_boto_dict(response)
    ...
    def initiate_document_version_upload(
        ...
        *,
        ...
        return shapes.InitiateDocumentVersionUploadResponse.from_boto_dict(
            response
        )
    ...
    def remove_resource_permission(
        ...
        *,
        ...
        principal_id: str,
        authentication_token: str = ShapeBase.NOT_SET,
        principal_type: shapes.PrincipalType = ShapeBase.NOT_SET,
    ) -> None:
        """
    ...
    def update_document(
        ...
        *,
        ...
        resource_state: shapes.ResourceStateType = ShapeBase.NOT_SET,
    ) -> None:
        """
    ...
    def update_document_version(
        ...
        *,
        ...
        version_id: str,
        authentication_token: str = ShapeBase.NOT_SET,
        version_status: shapes.DocumentVersionStatus = ShapeBase.NOT_SET,
    ) -> None:
        """
    ...
    def update_folder(
        ...
        *,
        ...
        response = self._boto_client.update_folder(**_request.to_boto_dict())
    ...
    def update_user(
        ...
        *,
        ...
        type: shapes.UserType = ShapeBase.NOT_SET,
        storage_rule: shapes.StorageRuleType = ShapeBase.NOT_SET,
        time_zone_id: str = ShapeBase.NOT_SET,
        locale: shapes.LocaleType = ShapeBase.NOT_SET,
        grant_poweruser_privileges: shapes.BooleanEnumType = ShapeBase.NOT_SET,
        ...
        return shapes.UpdateUserResponse.from_boto_dict(response)
