...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("stepfunctions", *args, **kwargs)
    ...
    def create_activity(
        ...
        *,
        ...
        response = self._boto_client.create_activity(**_request.to_boto_dict())

        return shapes.CreateActivityOutput.from_boto_dict(response)
    ...
    def create_state_machine(
        ...
        *,
        ...
        response = self._boto_client.create_state_machine(
            **_request.to_boto_dict()
        )

        return shapes.CreateStateMachineOutput.from_boto_dict(response)
    ...
    def delete_activity(
        ...
        *,
        ...
        response = self._boto_client.delete_activity(**_request.to_boto_dict())

        return shapes.DeleteActivityOutput.from_boto_dict(response)
    ...
    def delete_state_machine(
        ...
        *,
        ...
        response = self._boto_client.delete_state_machine(
            **_request.to_boto_dict()
        )

        return shapes.DeleteStateMachineOutput.from_boto_dict(response)
    ...
    def describe_activity(
        ...
        *,
        ...
        response = self._boto_client.describe_activity(
            **_request.to_boto_dict()
        )

        return shapes.DescribeActivityOutput.from_boto_dict(response)
    ...
    def describe_execution(
        ...
        *,
        ...
        response = self._boto_client.describe_execution(
            **_request.to_boto_dict()
        )

        return shapes.DescribeExecutionOutput.from_boto_dict(response)
    ...
    def describe_state_machine(
        ...
        *,
        ...
        return shapes.DescribeStateMachineOutput.from_boto_dict(response)
    ...
    def describe_state_machine_for_execution(
        ...
        *,
        ...
        return shapes.DescribeStateMachineForExecutionOutput.from_boto_dict(
            response
        )
    ...
    def get_activity_task(
        ...
        *,
        ...
        response = self._boto_client.get_activity_task(
            **_request.to_boto_dict()
        )

        return shapes.GetActivityTaskOutput.from_boto_dict(response)
    ...
    def get_execution_history(
        ...
        *,
        ...
        response = self._boto_client.get_execution_history(
            **_request.to_boto_dict()
        )

        return shapes.GetExecutionHistoryOutput.from_boto_dict(response)
    ...
    def list_activities(
        ...
        *,
        ...
        response = self._boto_client.list_activities(**_request.to_boto_dict())

        return shapes.ListActivitiesOutput.from_boto_dict(response)
    ...
    def list_executions(
        ...
        *,
        state_machine_arn: str,
        status_filter: shapes.ExecutionStatus = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_executions(**_request.to_boto_dict())

        return shapes.ListExecutionsOutput.from_boto_dict(response)
    ...
    def list_state_machines(
        ...
        *,
        ...
        response = self._boto_client.list_state_machines(
            **_request.to_boto_dict()
        )

        return shapes.ListStateMachinesOutput.from_boto_dict(response)
    ...
    def send_task_failure(
        ...
        *,
        ...
        response = self._boto_client.send_task_failure(
            **_request.to_boto_dict()
        )

        return shapes.SendTaskFailureOutput.from_boto_dict(response)
    ...
    def send_task_heartbeat(
        ...
        *,
        ...
        response = self._boto_client.send_task_heartbeat(
            **_request.to_boto_dict()
        )

        return shapes.SendTaskHeartbeatOutput.from_boto_dict(response)
    ...
    def send_task_success(
        ...
        *,
        ...
        response = self._boto_client.send_task_success(
            **_request.to_boto_dict()
        )

        return shapes.SendTaskSuccessOutput.from_boto_dict(response)
    ...
    def start_execution(
        ...
        *,
        ...
        response = self._boto_client.start_execution(**_request.to_boto_dict())

        return shapes.StartExecutionOutput.from_boto_dict(response)
    ...
    def stop_execution(
        ...
        *,
        ...
        response = self._boto_client.stop_execution(**_request.to_boto_dict())

        return shapes.StopExecutionOutput.from_boto_dict(response)
    ...
    def update_state_machine(
        ...
        *,
        ...
        response = self._boto_client.update_state_machine(
            **_request.to_boto_dict()
        )

        return shapes.UpdateStateMachineOutput.from_boto_dict(response)
