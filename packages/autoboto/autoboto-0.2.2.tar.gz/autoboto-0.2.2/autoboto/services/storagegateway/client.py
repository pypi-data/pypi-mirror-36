...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("storagegateway", *args, **kwargs)
    ...
    def activate_gateway(
        ...
        *,
        ...
        response = self._boto_client.activate_gateway(**_request.to_boto_dict())

        return shapes.ActivateGatewayOutput.from_boto_dict(response)
    ...
    def add_cache(
        ...
        *,
        ...
        response = self._boto_client.add_cache(**_request.to_boto_dict())

        return shapes.AddCacheOutput.from_boto_dict(response)
    ...
    def add_tags_to_resource(
        ...
        *,
        ...
        return shapes.AddTagsToResourceOutput.from_boto_dict(response)
    ...
    def add_upload_buffer(
        ...
        *,
        ...
        response = self._boto_client.add_upload_buffer(
            **_request.to_boto_dict()
        )

        return shapes.AddUploadBufferOutput.from_boto_dict(response)
    ...
    def add_working_storage(
        ...
        *,
        ...
        response = self._boto_client.add_working_storage(
            **_request.to_boto_dict()
        )

        return shapes.AddWorkingStorageOutput.from_boto_dict(response)
    ...
    def cancel_archival(
        ...
        *,
        ...
        response = self._boto_client.cancel_archival(**_request.to_boto_dict())

        return shapes.CancelArchivalOutput.from_boto_dict(response)
    ...
    def cancel_retrieval(
        ...
        *,
        ...
        response = self._boto_client.cancel_retrieval(**_request.to_boto_dict())

        return shapes.CancelRetrievalOutput.from_boto_dict(response)
    ...
    def create_cached_iscsi_volume(
        ...
        *,
        ...
        return shapes.CreateCachediSCSIVolumeOutput.from_boto_dict(response)
    ...
    def create_nfs_file_share(
        ...
        *,
        ...
        object_acl: shapes.ObjectACL = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_nfs_file_share(
            **_request.to_boto_dict()
        )

        return shapes.CreateNFSFileShareOutput.from_boto_dict(response)
    ...
    def create_smb_file_share(
        ...
        *,
        ...
        response = self._boto_client.create_smb_file_share(
            **_request.to_boto_dict()
        )

        return shapes.CreateSMBFileShareOutput.from_boto_dict(response)
    ...
    def create_snapshot(
        ...
        *,
        ...
        return shapes.CreateSnapshotOutput.from_boto_dict(response)
    ...
    def create_snapshot_from_volume_recovery_point(
        ...
        *,
        ...
        return shapes.CreateSnapshotFromVolumeRecoveryPointOutput.from_boto_dict(
            response
        )
    ...
    def create_stored_iscsi_volume(
        ...
        *,
        ...
        return shapes.CreateStorediSCSIVolumeOutput.from_boto_dict(response)
    ...
    def create_tape_with_barcode(
        ...
        *,
        ...
        return shapes.CreateTapeWithBarcodeOutput.from_boto_dict(response)
    ...
    def create_tapes(
        ...
        *,
        ...
        response = self._boto_client.create_tapes(**_request.to_boto_dict())

        return shapes.CreateTapesOutput.from_boto_dict(response)
    ...
    def delete_bandwidth_rate_limit(
        ...
        *,
        ...
        return shapes.DeleteBandwidthRateLimitOutput.from_boto_dict(response)
    ...
    def delete_chap_credentials(
        ...
        *,
        ...
        return shapes.DeleteChapCredentialsOutput.from_boto_dict(response)
    ...
    def delete_file_share(
        ...
        *,
        ...
        response = self._boto_client.delete_file_share(
            **_request.to_boto_dict()
        )

        return shapes.DeleteFileShareOutput.from_boto_dict(response)
    ...
    def delete_gateway(
        ...
        *,
        ...
        response = self._boto_client.delete_gateway(**_request.to_boto_dict())

        return shapes.DeleteGatewayOutput.from_boto_dict(response)
    ...
    def delete_snapshot_schedule(
        ...
        *,
        ...
        return shapes.DeleteSnapshotScheduleOutput.from_boto_dict(response)
    ...
    def delete_tape(
        ...
        *,
        ...
        response = self._boto_client.delete_tape(**_request.to_boto_dict())

        return shapes.DeleteTapeOutput.from_boto_dict(response)
    ...
    def delete_tape_archive(
        ...
        *,
        ...
        response = self._boto_client.delete_tape_archive(
            **_request.to_boto_dict()
        )

        return shapes.DeleteTapeArchiveOutput.from_boto_dict(response)
    ...
    def delete_volume(
        ...
        *,
        ...
        return shapes.DeleteVolumeOutput.from_boto_dict(response)
    ...
    def describe_bandwidth_rate_limit(
        ...
        *,
        ...
        return shapes.DescribeBandwidthRateLimitOutput.from_boto_dict(response)
    ...
    def describe_cache(
        ...
        *,
        ...
        response = self._boto_client.describe_cache(**_request.to_boto_dict())

        return shapes.DescribeCacheOutput.from_boto_dict(response)
    ...
    def describe_cached_iscsi_volumes(
        ...
        *,
        ...
        return shapes.DescribeCachediSCSIVolumesOutput.from_boto_dict(response)
    ...
    def describe_chap_credentials(
        ...
        *,
        ...
        return shapes.DescribeChapCredentialsOutput.from_boto_dict(response)
    ...
    def describe_gateway_information(
        ...
        *,
        ...
        return shapes.DescribeGatewayInformationOutput.from_boto_dict(response)
    ...
    def describe_maintenance_start_time(
        ...
        *,
        ...
        return shapes.DescribeMaintenanceStartTimeOutput.from_boto_dict(
            response
        )
    ...
    def describe_nfs_file_shares(
        ...
        *,
        ...
        return shapes.DescribeNFSFileSharesOutput.from_boto_dict(response)
    ...
    def describe_smb_file_shares(
        ...
        *,
        ...
        return shapes.DescribeSMBFileSharesOutput.from_boto_dict(response)
    ...
    def describe_smb_settings(
        ...
        *,
        ...
        response = self._boto_client.describe_smb_settings(
            **_request.to_boto_dict()
        )

        return shapes.DescribeSMBSettingsOutput.from_boto_dict(response)
    ...
    def describe_snapshot_schedule(
        ...
        *,
        ...
        return shapes.DescribeSnapshotScheduleOutput.from_boto_dict(response)
    ...
    def describe_stored_iscsi_volumes(
        ...
        *,
        ...
        return shapes.DescribeStorediSCSIVolumesOutput.from_boto_dict(response)
    ...
    def describe_tape_archives(
        ...
        *,
        ...
        response = self._boto_client.describe_tape_archives(
            **_request.to_boto_dict()
        )

        return shapes.DescribeTapeArchivesOutput.from_boto_dict(response)
    ...
    def describe_tape_recovery_points(
        ...
        *,
        ...
        response = self._boto_client.describe_tape_recovery_points(
            **_request.to_boto_dict()
        )

        return shapes.DescribeTapeRecoveryPointsOutput.from_boto_dict(response)
    ...
    def describe_tapes(
        ...
        *,
        ...
        response = self._boto_client.describe_tapes(**_request.to_boto_dict())

        return shapes.DescribeTapesOutput.from_boto_dict(response)
    ...
    def describe_upload_buffer(
        ...
        *,
        ...
        return shapes.DescribeUploadBufferOutput.from_boto_dict(response)
    ...
    def describe_vtl_devices(
        ...
        *,
        ...
        response = self._boto_client.describe_vtl_devices(
            **_request.to_boto_dict()
        )

        return shapes.DescribeVTLDevicesOutput.from_boto_dict(response)
    ...
    def describe_working_storage(
        ...
        *,
        ...
        return shapes.DescribeWorkingStorageOutput.from_boto_dict(response)
    ...
    def disable_gateway(
        ...
        *,
        ...
        response = self._boto_client.disable_gateway(**_request.to_boto_dict())

        return shapes.DisableGatewayOutput.from_boto_dict(response)
    ...
    def join_domain(
        ...
        *,
        ...
        response = self._boto_client.join_domain(**_request.to_boto_dict())

        return shapes.JoinDomainOutput.from_boto_dict(response)
    ...
    def list_file_shares(
        ...
        *,
        ...
        response = self._boto_client.list_file_shares(**_request.to_boto_dict())

        return shapes.ListFileSharesOutput.from_boto_dict(response)
    ...
    def list_gateways(
        ...
        *,
        ...
        response = self._boto_client.list_gateways(**_request.to_boto_dict())

        return shapes.ListGatewaysOutput.from_boto_dict(response)
    ...
    def list_local_disks(
        ...
        *,
        ...
        response = self._boto_client.list_local_disks(**_request.to_boto_dict())

        return shapes.ListLocalDisksOutput.from_boto_dict(response)
    ...
    def list_tags_for_resource(
        ...
        *,
        ...
        return shapes.ListTagsForResourceOutput.from_boto_dict(response)
    ...
    def list_tapes(
        ...
        *,
        ...
        response = self._boto_client.list_tapes(**_request.to_boto_dict())

        return shapes.ListTapesOutput.from_boto_dict(response)
    ...
    def list_volume_initiators(
        ...
        *,
        ...
        return shapes.ListVolumeInitiatorsOutput.from_boto_dict(response)
    ...
    def list_volume_recovery_points(
        ...
        *,
        ...
        return shapes.ListVolumeRecoveryPointsOutput.from_boto_dict(response)
    ...
    def list_volumes(
        ...
        *,
        ...
        response = self._boto_client.list_volumes(**_request.to_boto_dict())

        return shapes.ListVolumesOutput.from_boto_dict(response)
    ...
    def notify_when_uploaded(
        ...
        *,
        ...
        response = self._boto_client.notify_when_uploaded(
            **_request.to_boto_dict()
        )

        return shapes.NotifyWhenUploadedOutput.from_boto_dict(response)
    ...
    def refresh_cache(
        ...
        *,
        ...
        response = self._boto_client.refresh_cache(**_request.to_boto_dict())

        return shapes.RefreshCacheOutput.from_boto_dict(response)
    ...
    def remove_tags_from_resource(
        ...
        *,
        ...
        return shapes.RemoveTagsFromResourceOutput.from_boto_dict(response)
    ...
    def reset_cache(
        ...
        *,
        ...
        response = self._boto_client.reset_cache(**_request.to_boto_dict())

        return shapes.ResetCacheOutput.from_boto_dict(response)
    ...
    def retrieve_tape_archive(
        ...
        *,
        ...
        response = self._boto_client.retrieve_tape_archive(
            **_request.to_boto_dict()
        )

        return shapes.RetrieveTapeArchiveOutput.from_boto_dict(response)
    ...
    def retrieve_tape_recovery_point(
        ...
        *,
        ...
        return shapes.RetrieveTapeRecoveryPointOutput.from_boto_dict(response)
    ...
    def set_local_console_password(
        ...
        *,
        ...
        return shapes.SetLocalConsolePasswordOutput.from_boto_dict(response)
    ...
    def set_smb_guest_password(
        ...
        *,
        ...
        return shapes.SetSMBGuestPasswordOutput.from_boto_dict(response)
    ...
    def shutdown_gateway(
        ...
        *,
        ...
        response = self._boto_client.shutdown_gateway(**_request.to_boto_dict())

        return shapes.ShutdownGatewayOutput.from_boto_dict(response)
    ...
    def start_gateway(
        ...
        *,
        ...
        response = self._boto_client.start_gateway(**_request.to_boto_dict())

        return shapes.StartGatewayOutput.from_boto_dict(response)
    ...
    def update_bandwidth_rate_limit(
        ...
        *,
        ...
        return shapes.UpdateBandwidthRateLimitOutput.from_boto_dict(response)
    ...
    def update_chap_credentials(
        ...
        *,
        ...
        return shapes.UpdateChapCredentialsOutput.from_boto_dict(response)
    ...
    def update_gateway_information(
        ...
        *,
        ...
        return shapes.UpdateGatewayInformationOutput.from_boto_dict(response)
    ...
    def update_gateway_software_now(
        ...
        *,
        ...
        return shapes.UpdateGatewaySoftwareNowOutput.from_boto_dict(response)
    ...
    def update_maintenance_start_time(
        ...
        *,
        ...
        return shapes.UpdateMaintenanceStartTimeOutput.from_boto_dict(response)
    ...
    def update_nfs_file_share(
        ...
        *,
        ...
        response = self._boto_client.update_nfs_file_share(
            **_request.to_boto_dict()
        )

        return shapes.UpdateNFSFileShareOutput.from_boto_dict(response)
    ...
    def update_smb_file_share(
        ...
        *,
        ...
        response = self._boto_client.update_smb_file_share(
            **_request.to_boto_dict()
        )

        return shapes.UpdateSMBFileShareOutput.from_boto_dict(response)
    ...
    def update_snapshot_schedule(
        ...
        *,
        ...
        return shapes.UpdateSnapshotScheduleOutput.from_boto_dict(response)
    ...
    def update_vtl_device_type(
        ...
        *,
        ...
        return shapes.UpdateVTLDeviceTypeOutput.from_boto_dict(response)
