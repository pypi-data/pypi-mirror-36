...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("greengrass", *args, **kwargs)
    ...
    def associate_role_to_group(
        ...
        *,
        ...
        return shapes.AssociateRoleToGroupResponse.from_boto_dict(response)
    ...
    def associate_service_role_to_account(
        ...
        *,
        ...
        return shapes.AssociateServiceRoleToAccountResponse.from_boto_dict(
            response
        )
    ...
    def create_core_definition(
        ...
        *,
        ...
        return shapes.CreateCoreDefinitionResponse.from_boto_dict(response)
    ...
    def create_core_definition_version(
        ...
        *,
        ...
        return shapes.CreateCoreDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def create_deployment(
        ...
        *,
        ...
        deployment_type: shapes.DeploymentType = ShapeBase.NOT_SET,
        ...
        return shapes.CreateDeploymentResponse.from_boto_dict(response)
    ...
    def create_device_definition(
        ...
        *,
        ...
        return shapes.CreateDeviceDefinitionResponse.from_boto_dict(response)
    ...
    def create_device_definition_version(
        ...
        *,
        ...
        return shapes.CreateDeviceDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def create_function_definition(
        ...
        *,
        ...
        return shapes.CreateFunctionDefinitionResponse.from_boto_dict(response)
    ...
    def create_function_definition_version(
        ...
        *,
        ...
        return shapes.CreateFunctionDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def create_group_certificate_authority(
        ...
        *,
        ...
        return shapes.CreateGroupCertificateAuthorityResponse.from_boto_dict(
            response
        )
    ...
    def create_group_version(
        ...
        *,
        ...
        response = self._boto_client.create_group_version(
            **_request.to_boto_dict()
        )

        return shapes.CreateGroupVersionResponse.from_boto_dict(response)
    ...
    def create_logger_definition(
        ...
        *,
        ...
        return shapes.CreateLoggerDefinitionResponse.from_boto_dict(response)
    ...
    def create_logger_definition_version(
        ...
        *,
        ...
        return shapes.CreateLoggerDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def create_resource_definition(
        ...
        *,
        ...
        return shapes.CreateResourceDefinitionResponse.from_boto_dict(response)
    ...
    def create_resource_definition_version(
        ...
        *,
        ...
        return shapes.CreateResourceDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def create_software_update_job(
        ...
        *,
        ...
        software_to_update: shapes.SoftwareToUpdate = ShapeBase.NOT_SET,
        update_agent_log_level: shapes.UpdateAgentLogLevel = ShapeBase.NOT_SET,
        update_targets: typing.List[str] = ShapeBase.NOT_SET,
        update_targets_architecture: shapes.
        UpdateTargetsArchitecture = ShapeBase.NOT_SET,
        update_targets_operating_system: shapes.
        UpdateTargetsOperatingSystem = ShapeBase.NOT_SET,
        ...
        return shapes.CreateSoftwareUpdateJobResponse.from_boto_dict(response)
    ...
    def create_subscription_definition(
        ...
        *,
        ...
        return shapes.CreateSubscriptionDefinitionResponse.from_boto_dict(
            response
        )
    ...
    def create_subscription_definition_version(
        ...
        *,
        ...
        return shapes.CreateSubscriptionDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def delete_core_definition(
        ...
        *,
        ...
        return shapes.DeleteCoreDefinitionResponse.from_boto_dict(response)
    ...
    def delete_device_definition(
        ...
        *,
        ...
        return shapes.DeleteDeviceDefinitionResponse.from_boto_dict(response)
    ...
    def delete_function_definition(
        ...
        *,
        ...
        return shapes.DeleteFunctionDefinitionResponse.from_boto_dict(response)
    ...
    def delete_group(
        ...
        *,
        ...
        return shapes.DeleteGroupResponse.from_boto_dict(response)
    ...
    def delete_logger_definition(
        ...
        *,
        ...
        return shapes.DeleteLoggerDefinitionResponse.from_boto_dict(response)
    ...
    def delete_resource_definition(
        ...
        *,
        ...
        return shapes.DeleteResourceDefinitionResponse.from_boto_dict(response)
    ...
    def delete_subscription_definition(
        ...
        *,
        ...
        return shapes.DeleteSubscriptionDefinitionResponse.from_boto_dict(
            response
        )
    ...
    def disassociate_role_from_group(
        ...
        *,
        ...
        return shapes.DisassociateRoleFromGroupResponse.from_boto_dict(response)
    ...
    def disassociate_service_role_from_account(
        ...
        return shapes.DisassociateServiceRoleFromAccountResponse.from_boto_dict(
            response
        )
    ...
    def get_associated_role(
        ...
        *,
        ...
        response = self._boto_client.get_associated_role(
            **_request.to_boto_dict()
        )

        return shapes.GetAssociatedRoleResponse.from_boto_dict(response)
    ...
    def get_connectivity_info(
        ...
        *,
        ...
        response = self._boto_client.get_connectivity_info(
            **_request.to_boto_dict()
        )

        return shapes.GetConnectivityInfoResponse.from_boto_dict(response)
    ...
    def get_core_definition(
        ...
        *,
        ...
        response = self._boto_client.get_core_definition(
            **_request.to_boto_dict()
        )

        return shapes.GetCoreDefinitionResponse.from_boto_dict(response)
    ...
    def get_core_definition_version(
        ...
        *,
        ...
        return shapes.GetCoreDefinitionVersionResponse.from_boto_dict(response)
    ...
    def get_deployment_status(
        ...
        *,
        ...
        response = self._boto_client.get_deployment_status(
            **_request.to_boto_dict()
        )

        return shapes.GetDeploymentStatusResponse.from_boto_dict(response)
    ...
    def get_device_definition(
        ...
        *,
        ...
        response = self._boto_client.get_device_definition(
            **_request.to_boto_dict()
        )

        return shapes.GetDeviceDefinitionResponse.from_boto_dict(response)
    ...
    def get_device_definition_version(
        ...
        *,
        ...
        return shapes.GetDeviceDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def get_function_definition(
        ...
        *,
        ...
        return shapes.GetFunctionDefinitionResponse.from_boto_dict(response)
    ...
    def get_function_definition_version(
        ...
        *,
        ...
        return shapes.GetFunctionDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def get_group_certificate_authority(
        ...
        *,
        ...
        return shapes.GetGroupCertificateAuthorityResponse.from_boto_dict(
            response
        )
    ...
    def get_group_certificate_configuration(
        ...
        *,
        ...
        return shapes.GetGroupCertificateConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def get_group_version(
        ...
        *,
        ...
        response = self._boto_client.get_group_version(
            **_request.to_boto_dict()
        )

        return shapes.GetGroupVersionResponse.from_boto_dict(response)
    ...
    def get_logger_definition(
        ...
        *,
        ...
        response = self._boto_client.get_logger_definition(
            **_request.to_boto_dict()
        )

        return shapes.GetLoggerDefinitionResponse.from_boto_dict(response)
    ...
    def get_logger_definition_version(
        ...
        *,
        ...
        return shapes.GetLoggerDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def get_resource_definition(
        ...
        *,
        ...
        return shapes.GetResourceDefinitionResponse.from_boto_dict(response)
    ...
    def get_resource_definition_version(
        ...
        *,
        ...
        return shapes.GetResourceDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def get_service_role_for_account(
        ...
        return shapes.GetServiceRoleForAccountResponse.from_boto_dict(response)
    ...
    def get_subscription_definition(
        ...
        *,
        ...
        return shapes.GetSubscriptionDefinitionResponse.from_boto_dict(response)
    ...
    def get_subscription_definition_version(
        ...
        *,
        ...
        return shapes.GetSubscriptionDefinitionVersionResponse.from_boto_dict(
            response
        )
    ...
    def list_core_definition_versions(
        ...
        *,
        ...
        return shapes.ListCoreDefinitionVersionsResponse.from_boto_dict(
            response
        )
    ...
    def list_core_definitions(
        ...
        *,
        ...
        response = self._boto_client.list_core_definitions(
            **_request.to_boto_dict()
        )

        return shapes.ListCoreDefinitionsResponse.from_boto_dict(response)
    ...
    def list_deployments(
        ...
        *,
        ...
        response = self._boto_client.list_deployments(**_request.to_boto_dict())

        return shapes.ListDeploymentsResponse.from_boto_dict(response)
    ...
    def list_device_definition_versions(
        ...
        *,
        ...
        return shapes.ListDeviceDefinitionVersionsResponse.from_boto_dict(
            response
        )
    ...
    def list_device_definitions(
        ...
        *,
        ...
        return shapes.ListDeviceDefinitionsResponse.from_boto_dict(response)
    ...
    def list_function_definition_versions(
        ...
        *,
        ...
        return shapes.ListFunctionDefinitionVersionsResponse.from_boto_dict(
            response
        )
    ...
    def list_function_definitions(
        ...
        *,
        ...
        return shapes.ListFunctionDefinitionsResponse.from_boto_dict(response)
    ...
    def list_group_certificate_authorities(
        ...
        *,
        ...
        return shapes.ListGroupCertificateAuthoritiesResponse.from_boto_dict(
            response
        )
    ...
    def list_group_versions(
        ...
        *,
        ...
        response = self._boto_client.list_group_versions(
            **_request.to_boto_dict()
        )

        return shapes.ListGroupVersionsResponse.from_boto_dict(response)
    ...
    def list_logger_definition_versions(
        ...
        *,
        ...
        return shapes.ListLoggerDefinitionVersionsResponse.from_boto_dict(
            response
        )
    ...
    def list_logger_definitions(
        ...
        *,
        ...
        return shapes.ListLoggerDefinitionsResponse.from_boto_dict(response)
    ...
    def list_resource_definition_versions(
        ...
        *,
        ...
        return shapes.ListResourceDefinitionVersionsResponse.from_boto_dict(
            response
        )
    ...
    def list_resource_definitions(
        ...
        *,
        ...
        return shapes.ListResourceDefinitionsResponse.from_boto_dict(response)
    ...
    def list_subscription_definition_versions(
        ...
        *,
        ...
        return shapes.ListSubscriptionDefinitionVersionsResponse.from_boto_dict(
            response
        )
    ...
    def list_subscription_definitions(
        ...
        *,
        ...
        return shapes.ListSubscriptionDefinitionsResponse.from_boto_dict(
            response
        )
    ...
    def reset_deployments(
        ...
        *,
        ...
        response = self._boto_client.reset_deployments(
            **_request.to_boto_dict()
        )

        return shapes.ResetDeploymentsResponse.from_boto_dict(response)
    ...
    def update_connectivity_info(
        ...
        *,
        ...
        return shapes.UpdateConnectivityInfoResponse.from_boto_dict(response)
    ...
    def update_core_definition(
        ...
        *,
        ...
        return shapes.UpdateCoreDefinitionResponse.from_boto_dict(response)
    ...
    def update_device_definition(
        ...
        *,
        ...
        return shapes.UpdateDeviceDefinitionResponse.from_boto_dict(response)
    ...
    def update_function_definition(
        ...
        *,
        ...
        return shapes.UpdateFunctionDefinitionResponse.from_boto_dict(response)
    ...
    def update_group_certificate_configuration(
        ...
        *,
        ...
        return shapes.UpdateGroupCertificateConfigurationResponse.from_boto_dict(
            response
        )
    ...
    def update_logger_definition(
        ...
        *,
        ...
        return shapes.UpdateLoggerDefinitionResponse.from_boto_dict(response)
    ...
    def update_resource_definition(
        ...
        *,
        ...
        return shapes.UpdateResourceDefinitionResponse.from_boto_dict(response)
    ...
    def update_subscription_definition(
        ...
        *,
        ...
        return shapes.UpdateSubscriptionDefinitionResponse.from_boto_dict(
            response
        )
