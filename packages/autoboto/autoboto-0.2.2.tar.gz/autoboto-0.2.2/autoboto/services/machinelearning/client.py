...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("machinelearning", *args, **kwargs)
    ...
    def add_tags(
        ...
        *,
        ...
        resource_id: str,
        resource_type: shapes.TaggableResourceType,
    ...
    def create_batch_prediction(
        ...
        *,
        ...
        return shapes.CreateBatchPredictionOutput.from_boto_dict(response)
    ...
    def create_data_source_from_rds(
        ...
        *,
        ...
        return shapes.CreateDataSourceFromRDSOutput.from_boto_dict(response)
    ...
    def create_data_source_from_redshift(
        ...
        *,
        ...
        return shapes.CreateDataSourceFromRedshiftOutput.from_boto_dict(
            response
        )
    ...
    def create_data_source_from_s3(
        ...
        *,
        ...
        return shapes.CreateDataSourceFromS3Output.from_boto_dict(response)
    ...
    def create_evaluation(
        ...
        *,
        ...
        response = self._boto_client.create_evaluation(
            **_request.to_boto_dict()
        )

        return shapes.CreateEvaluationOutput.from_boto_dict(response)
    ...
    def create_ml_model(
        ...
        *,
        ml_model_id: str,
        ml_model_type: shapes.MLModelType,
        ...
        response = self._boto_client.create_ml_model(**_request.to_boto_dict())

        return shapes.CreateMLModelOutput.from_boto_dict(response)
    ...
    def create_realtime_endpoint(
        ...
        *,
        ...
        return shapes.CreateRealtimeEndpointOutput.from_boto_dict(response)
    ...
    def delete_batch_prediction(
        ...
        **Caution:** The result of the `DeleteBatchPrediction` operation is
        ...
        return shapes.DeleteBatchPredictionOutput.from_boto_dict(response)
    ...
    def delete_data_source(
        ...
        **Caution:** The results of the `DeleteDataSource` operation are irreversible.
        ...
        return shapes.DeleteDataSourceOutput.from_boto_dict(response)
    ...
    def delete_evaluation(
        ...
        *,
        ...
        response = self._boto_client.delete_evaluation(
            **_request.to_boto_dict()
        )

        return shapes.DeleteEvaluationOutput.from_boto_dict(response)
    ...
    def delete_ml_model(
        ...
        **Caution:** The result of the `DeleteMLModel` operation is irreversible.
        ...
        response = self._boto_client.delete_ml_model(**_request.to_boto_dict())

        return shapes.DeleteMLModelOutput.from_boto_dict(response)
    ...
    def delete_realtime_endpoint(
        ...
        *,
        ...
        return shapes.DeleteRealtimeEndpointOutput.from_boto_dict(response)
    ...
    def describe_batch_predictions(
        ...
        *,
        filter_variable: shapes.BatchPredictionFilterVariable = ShapeBase.
        NOT_SET,
        ...
        response = self._boto_client.describe_batch_predictions(
            **_request.to_boto_dict()
        )

        return shapes.DescribeBatchPredictionsOutput.from_boto_dict(response)

    def describe_data_sources(
        self,
        _request: shapes.DescribeDataSourcesInput = None,
        *,
        filter_variable: shapes.DataSourceFilterVariable = ShapeBase.NOT_SET,
        eq: str = ShapeBase.NOT_SET,
        gt: str = ShapeBase.NOT_SET,
        lt: str = ShapeBase.NOT_SET,
        ge: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_data_sources(
            **_request.to_boto_dict()
        )

        return shapes.DescribeDataSourcesOutput.from_boto_dict(response)

    def describe_evaluations(
        self,
        _request: shapes.DescribeEvaluationsInput = None,
        *,
        filter_variable: shapes.EvaluationFilterVariable = ShapeBase.NOT_SET,
        eq: str = ShapeBase.NOT_SET,
        gt: str = ShapeBase.NOT_SET,
        lt: str = ShapeBase.NOT_SET,
        ge: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_evaluations(
            **_request.to_boto_dict()
        )

        return shapes.DescribeEvaluationsOutput.from_boto_dict(response)

    def describe_ml_models(
        self,
        _request: shapes.DescribeMLModelsInput = None,
        *,
        filter_variable: shapes.MLModelFilterVariable = ShapeBase.NOT_SET,
        eq: str = ShapeBase.NOT_SET,
        gt: str = ShapeBase.NOT_SET,
        lt: str = ShapeBase.NOT_SET,
        ge: str = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.describe_ml_models(
            **_request.to_boto_dict()
        )

        return shapes.DescribeMLModelsOutput.from_boto_dict(response)
    ...
    def get_batch_prediction(
        ...
        *,
        ...
        response = self._boto_client.get_batch_prediction(
            **_request.to_boto_dict()
        )

        return shapes.GetBatchPredictionOutput.from_boto_dict(response)
    ...
    def get_data_source(
        ...
        *,
        ...
        return shapes.GetDataSourceOutput.from_boto_dict(response)
    ...
    def get_evaluation(
        ...
        *,
        ...
        response = self._boto_client.get_evaluation(**_request.to_boto_dict())

        return shapes.GetEvaluationOutput.from_boto_dict(response)
    ...
    def get_ml_model(
        ...
        *,
        ...
        response = self._boto_client.get_ml_model(**_request.to_boto_dict())

        return shapes.GetMLModelOutput.from_boto_dict(response)
    ...
    def predict(
        ...
        *,
        ...
        response = self._boto_client.predict(**_request.to_boto_dict())

        return shapes.PredictOutput.from_boto_dict(response)
    ...
    def update_batch_prediction(
        ...
        *,
        ...
        return shapes.UpdateBatchPredictionOutput.from_boto_dict(response)
    ...
    def update_data_source(
        ...
        *,
        ...
        return shapes.UpdateDataSourceOutput.from_boto_dict(response)
    ...
    def update_evaluation(
        ...
        *,
        ...
        response = self._boto_client.update_evaluation(
            **_request.to_boto_dict()
        )

        return shapes.UpdateEvaluationOutput.from_boto_dict(response)
    ...
    def update_ml_model(
        ...
        *,
        ...
        response = self._boto_client.update_ml_model(**_request.to_boto_dict())

        return shapes.UpdateMLModelOutput.from_boto_dict(response)
