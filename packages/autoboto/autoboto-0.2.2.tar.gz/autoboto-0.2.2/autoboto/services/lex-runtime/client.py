...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("lex-runtime", *args, **kwargs)
    ...
    def post_content(
        ...
        *,
        ...
        response = self._boto_client.post_content(**_request.to_boto_dict())

        return shapes.PostContentResponse.from_boto_dict(response)
    ...
    def post_text(
        ...
        *,
        ...
        response = self._boto_client.post_text(**_request.to_boto_dict())

        return shapes.PostTextResponse.from_boto_dict(response)
