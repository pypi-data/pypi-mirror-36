...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("dax", *args, **kwargs)
    ...
    def create_parameter_group(
        ...
        *,
        ...
        return shapes.CreateParameterGroupResponse.from_boto_dict(response)
    ...
    def create_subnet_group(
        ...
        *,
        ...
        response = self._boto_client.create_subnet_group(
            **_request.to_boto_dict()
        )

        return shapes.CreateSubnetGroupResponse.from_boto_dict(response)
    ...
    def decrease_replication_factor(
        ...
        *,
        ...
        return shapes.DecreaseReplicationFactorResponse.from_boto_dict(response)
    ...
    def delete_parameter_group(
        ...
        *,
        ...
        return shapes.DeleteParameterGroupResponse.from_boto_dict(response)
    ...
    def delete_subnet_group(
        ...
        *,
        ...
        response = self._boto_client.delete_subnet_group(
            **_request.to_boto_dict()
        )

        return shapes.DeleteSubnetGroupResponse.from_boto_dict(response)
    ...
    def describe_default_parameters(
        ...
        *,
        ...
        return shapes.DescribeDefaultParametersResponse.from_boto_dict(response)
    ...
    def describe_parameter_groups(
        ...
        *,
        ...
        return shapes.DescribeParameterGroupsResponse.from_boto_dict(response)
    ...
    def describe_parameters(
        ...
        *,
        ...
        return shapes.DescribeParametersResponse.from_boto_dict(response)
    ...
    def describe_subnet_groups(
        ...
        *,
        ...
        return shapes.DescribeSubnetGroupsResponse.from_boto_dict(response)
    ...
    def increase_replication_factor(
        ...
        *,
        ...
        return shapes.IncreaseReplicationFactorResponse.from_boto_dict(response)
    ...
    def reboot_node(
        ...
        *,
        ...
        response = self._boto_client.reboot_node(**_request.to_boto_dict())

        return shapes.RebootNodeResponse.from_boto_dict(response)
    ...
    def update_cluster(
        ...
        *,
        ...
        return shapes.UpdateClusterResponse.from_boto_dict(response)
    ...
    def update_parameter_group(
        ...
        *,
        ...
        return shapes.UpdateParameterGroupResponse.from_boto_dict(response)
    ...
    def update_subnet_group(
        ...
        *,
        ...
        response = self._boto_client.update_subnet_group(
            **_request.to_boto_dict()
        )

        return shapes.UpdateSubnetGroupResponse.from_boto_dict(response)
