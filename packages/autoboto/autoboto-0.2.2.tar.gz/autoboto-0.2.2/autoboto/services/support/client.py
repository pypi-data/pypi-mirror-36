...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("support", *args, **kwargs)
    ...
    def add_attachments_to_set(
        ...
        *,
        ...
        return shapes.AddAttachmentsToSetResponse.from_boto_dict(response)
    ...
    def add_communication_to_case(
        ...
        *,
        ...
        return shapes.AddCommunicationToCaseResponse.from_boto_dict(response)
    ...
    def create_case(
        ...
        *,
        ...
        response = self._boto_client.create_case(**_request.to_boto_dict())

        return shapes.CreateCaseResponse.from_boto_dict(response)
    ...
    def describe_attachment(
        ...
        *,
        ...
        response = self._boto_client.describe_attachment(
            **_request.to_boto_dict()
        )

        return shapes.DescribeAttachmentResponse.from_boto_dict(response)
    ...
    def describe_cases(
        ...
        *,
        ...
        response = self._boto_client.describe_cases(**_request.to_boto_dict())

        return shapes.DescribeCasesResponse.from_boto_dict(response)
    ...
    def describe_communications(
        ...
        *,
        ...
        response = self._boto_client.describe_communications(
            **_request.to_boto_dict()
        )

        return shapes.DescribeCommunicationsResponse.from_boto_dict(response)
    ...
    def describe_severity_levels(
        ...
        *,
        ...
        return shapes.DescribeSeverityLevelsResponse.from_boto_dict(response)
    ...
    def describe_trusted_advisor_check_refresh_statuses(
        ...
        *,
        ...
        return shapes.DescribeTrustedAdvisorCheckRefreshStatusesResponse.from_boto_dict(
            response
        )
    ...
    def describe_trusted_advisor_check_result(
        ...
        *,
        ...
        return shapes.DescribeTrustedAdvisorCheckResultResponse.from_boto_dict(
            response
        )
    ...
    def describe_trusted_advisor_check_summaries(
        ...
        *,
        ...
        return shapes.DescribeTrustedAdvisorCheckSummariesResponse.from_boto_dict(
            response
        )
    ...
    def describe_trusted_advisor_checks(
        ...
        *,
        ...
        return shapes.DescribeTrustedAdvisorChecksResponse.from_boto_dict(
            response
        )
    ...
    def refresh_trusted_advisor_check(
        ...
        *,
        ...
        return shapes.RefreshTrustedAdvisorCheckResponse.from_boto_dict(
            response
        )
    ...
    def resolve_case(
        ...
        *,
        ...
        response = self._boto_client.resolve_case(**_request.to_boto_dict())

        return shapes.ResolveCaseResponse.from_boto_dict(response)
