...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("acm-pca", *args, **kwargs)
    ...
    def create_certificate_authority(
        ...
        *,
        ...
        certificate_authority_type: shapes.CertificateAuthorityType,
        ...
        return shapes.CreateCertificateAuthorityResponse.from_boto_dict(
            response
        )
    ...
    def create_certificate_authority_audit_report(
        ...
        *,
        ...
        s3_bucket_name: str,
        audit_report_response_format: shapes.AuditReportResponseFormat,
        ...
        return shapes.CreateCertificateAuthorityAuditReportResponse.from_boto_dict(
            response
        )
    ...
    def describe_certificate_authority(
        ...
        *,
        ...
        return shapes.DescribeCertificateAuthorityResponse.from_boto_dict(
            response
        )
    ...
    def describe_certificate_authority_audit_report(
        ...
        *,
        ...
        return shapes.DescribeCertificateAuthorityAuditReportResponse.from_boto_dict(
            response
        )
    ...
    def get_certificate(
        ...
        **ISSUED** state. You can call the CreateCertificateAuthorityAuditReport
        ...
        response = self._boto_client.get_certificate(**_request.to_boto_dict())

        return shapes.GetCertificateResponse.from_boto_dict(response)
    ...
    def get_certificate_authority_certificate(
        ...
        *,
        ...
        return shapes.GetCertificateAuthorityCertificateResponse.from_boto_dict(
            response
        )
    ...
    def get_certificate_authority_csr(
        ...
        *,
        ...
        return shapes.GetCertificateAuthorityCsrResponse.from_boto_dict(
            response
        )
    ...
    def issue_certificate(
        ...
        *,
        certificate_authority_arn: str,
        csr: typing.Any,
        signing_algorithm: shapes.SigningAlgorithm,
        ...
        response = self._boto_client.issue_certificate(
            **_request.to_boto_dict()
        )

        return shapes.IssueCertificateResponse.from_boto_dict(response)
    ...
    def list_certificate_authorities(
        ...
        *,
        ...
        return shapes.ListCertificateAuthoritiesResponse.from_boto_dict(
            response
        )
    ...
    def revoke_certificate(
        ...
        *,
        ...
        revocation_reason: shapes.RevocationReason,
    ) -> None:
        """
        ...
        response = self._boto_client.revoke_certificate(
            **_request.to_boto_dict()
        )
    ...
    def update_certificate_authority(
        ...
        *,
        ...
        revocation_configuration: shapes.RevocationConfiguration = ShapeBase.
        NOT_SET,
        status: shapes.CertificateAuthorityStatus = ShapeBase.NOT_SET,
    ) -> None:
        """
