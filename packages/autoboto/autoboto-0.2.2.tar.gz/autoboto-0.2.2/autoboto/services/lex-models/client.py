...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("lex-models", *args, **kwargs)
    ...
    def get_bot_aliases(
        ...
        *,
        ...
        response = self._boto_client.get_bot_aliases(**_request.to_boto_dict())
    ...
    def get_bot_channel_associations(
        ...
        *,
        ...
        response = self._boto_client.get_bot_channel_associations(
            **_request.to_boto_dict()
        )
    ...
    def get_bot_versions(
        ...
        *,
        ...
        response = self._boto_client.get_bot_versions(**_request.to_boto_dict())
    ...
    def get_bots(
        ...
        *,
        ...
        response = self._boto_client.get_bots(**_request.to_boto_dict())
    ...
    def get_builtin_intents(
        ...
        *,
        ...
        response = self._boto_client.get_builtin_intents(
            **_request.to_boto_dict()
        )
    ...
    def get_builtin_slot_types(
        ...
        *,
        ...
        response = self._boto_client.get_builtin_slot_types(
            **_request.to_boto_dict()
        )
    ...
    def get_intent_versions(
        ...
        *,
        ...
        response = self._boto_client.get_intent_versions(
            **_request.to_boto_dict()
        )
    ...
    def get_intents(
        ...
        *,
        ...
        response = self._boto_client.get_intents(**_request.to_boto_dict())
    ...
    def get_slot_type_versions(
        ...
        *,
        ...
        response = self._boto_client.get_slot_type_versions(
            **_request.to_boto_dict()
        )
    ...
    def get_slot_types(
        ...
        *,
        ...
        response = self._boto_client.get_slot_types(**_request.to_boto_dict())
