...
class BatchDetectDominantLanguageRequest(ShapeBase):
    ...
    # characters.
    text_list: typing.List[str] = dataclasses.field(default_factory=list, )
...
class BatchDetectSentimentItemResult(ShapeBase):
    ...
    sentiment: "SentimentType" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class BatchDetectSyntaxRequest(ShapeBase):
    ...
    # The language of the input documents. You can specify English ("en") or
    # Spanish ("es"). All documents must be in the same language.
    language_code: "SyntaxLanguageCode" = dataclasses.field(
        default=ShapeBase.NOT_SET,
    )
...
class Entity(ShapeBase):
    ...
    # The entity's type.
    type: "EntityType" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class InputDataConfig(ShapeBase):
    ...
    input_format: "InputFormat" = dataclasses.field(default=ShapeBase.NOT_SET, )
...
class PartOfSpeechTag(ShapeBase):
    ...
    tag: "PartOfSpeechTagType" = dataclasses.field(default=ShapeBase.NOT_SET, )
