...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("es", *args, **kwargs)
    ...
    def create_elasticsearch_domain(
        ...
        *,
        ...
        Dict[shapes.LogType, shapes.LogPublishingOption] = ShapeBase.NOT_SET,
        ...
        return shapes.CreateElasticsearchDomainResponse.from_boto_dict(response)
    ...
    def delete_elasticsearch_domain(
        ...
        *,
        ...
        return shapes.DeleteElasticsearchDomainResponse.from_boto_dict(response)
    ...
    def describe_elasticsearch_domain(
        ...
        *,
        ...
        return shapes.DescribeElasticsearchDomainResponse.from_boto_dict(
            response
        )
    ...
    def describe_elasticsearch_domain_config(
        ...
        *,
        ...
        return shapes.DescribeElasticsearchDomainConfigResponse.from_boto_dict(
            response
        )
    ...
    def describe_elasticsearch_domains(
        ...
        *,
        ...
        return shapes.DescribeElasticsearchDomainsResponse.from_boto_dict(
            response
        )
    ...
    def describe_elasticsearch_instance_type_limits(
        ...
        *,
        instance_type: shapes.ESPartitionInstanceType,
        ...
        return shapes.DescribeElasticsearchInstanceTypeLimitsResponse.from_boto_dict(
            response
        )
    ...
    def describe_reserved_elasticsearch_instance_offerings(
        ...
        *,
        ...
        return shapes.DescribeReservedElasticsearchInstanceOfferingsResponse.from_boto_dict(
            response
        )
    ...
    def describe_reserved_elasticsearch_instances(
        ...
        *,
        ...
        return shapes.DescribeReservedElasticsearchInstancesResponse.from_boto_dict(
            response
        )
    ...
    def get_compatible_elasticsearch_versions(
        ...
        *,
        ...
        return shapes.GetCompatibleElasticsearchVersionsResponse.from_boto_dict(
            response
        )
    ...
    def get_upgrade_history(
        ...
        *,
        ...
        response = self._boto_client.get_upgrade_history(
            **_request.to_boto_dict()
        )

        return shapes.GetUpgradeHistoryResponse.from_boto_dict(response)
    ...
    def get_upgrade_status(
        ...
        *,
        ...
        response = self._boto_client.get_upgrade_status(
            **_request.to_boto_dict()
        )

        return shapes.GetUpgradeStatusResponse.from_boto_dict(response)
    ...
    def list_elasticsearch_instance_types(
        ...
        *,
        ...
        response = self._boto_client.list_elasticsearch_instance_types(
            **_request.to_boto_dict()
        )

        return shapes.ListElasticsearchInstanceTypesResponse.from_boto_dict(
            response
        )
    ...
    def list_elasticsearch_versions(
        ...
        *,
        ...
        response = self._boto_client.list_elasticsearch_versions(
            **_request.to_boto_dict()
        )

        return shapes.ListElasticsearchVersionsResponse.from_boto_dict(response)
    ...
    def purchase_reserved_elasticsearch_instance_offering(
        ...
        *,
        ...
        return shapes.PurchaseReservedElasticsearchInstanceOfferingResponse.from_boto_dict(
            response
        )
    ...
    def update_elasticsearch_domain_config(
        ...
        *,
        ...
        return shapes.UpdateElasticsearchDomainConfigResponse.from_boto_dict(
            response
        )
    ...
    def upgrade_elasticsearch_domain(
        ...
        *,
        ...
        return shapes.UpgradeElasticsearchDomainResponse.from_boto_dict(
            response
        )
