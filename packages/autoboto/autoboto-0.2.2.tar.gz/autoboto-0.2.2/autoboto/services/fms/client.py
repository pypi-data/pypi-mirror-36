...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("fms", *args, **kwargs)
    ...
    def associate_admin_account(
        ...
        *,
        ...
        be associated with a master account in AWS Organizations or associated with a
    ...
    def get_admin_account(
        ...
        response = self._boto_client.get_admin_account(
            **_request.to_boto_dict()
        )

        return shapes.GetAdminAccountResponse.from_boto_dict(response)
    ...
    def get_compliance_detail(
        ...
        *,
        ...
        response = self._boto_client.get_compliance_detail(
            **_request.to_boto_dict()
        )

        return shapes.GetComplianceDetailResponse.from_boto_dict(response)
    ...
    def get_notification_channel(
        ...
        return shapes.GetNotificationChannelResponse.from_boto_dict(response)
    ...
    def list_compliance_status(
        ...
        *,
        ...
        return shapes.ListComplianceStatusResponse.from_boto_dict(response)
    ...
    def put_policy(
        ...
        *,
        ...
        response = self._boto_client.put_policy(**_request.to_boto_dict())

        return shapes.PutPolicyResponse.from_boto_dict(response)
