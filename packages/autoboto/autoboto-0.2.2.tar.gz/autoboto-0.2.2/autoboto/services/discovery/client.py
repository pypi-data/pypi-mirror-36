...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("discovery", *args, **kwargs)
    ...
    def associate_configuration_items_to_application(
        ...
        *,
        ...
        return shapes.AssociateConfigurationItemsToApplicationResponse.from_boto_dict(
            response
        )
    ...
    def create_application(
        ...
        *,
        ...
        return shapes.CreateApplicationResponse.from_boto_dict(response)
    ...
    def create_tags(
        ...
        *,
        ...
        return shapes.CreateTagsResponse.from_boto_dict(response)
    ...
    def delete_applications(
        ...
        *,
        ...
        response = self._boto_client.delete_applications(
            **_request.to_boto_dict()
        )

        return shapes.DeleteApplicationsResponse.from_boto_dict(response)
    ...
    def delete_tags(
        ...
        *,
        ...
        return shapes.DeleteTagsResponse.from_boto_dict(response)
    ...
    def describe_agents(
        ...
        *,
        ...
        response = self._boto_client.describe_agents(**_request.to_boto_dict())

        return shapes.DescribeAgentsResponse.from_boto_dict(response)
    ...
    def describe_configurations(
        ...
        *,
        ...
        return shapes.DescribeConfigurationsResponse.from_boto_dict(response)
    ...
    def describe_continuous_exports(
        ...
        *,
        ...
        return shapes.DescribeContinuousExportsResponse.from_boto_dict(response)
    ...
    def describe_export_configurations(
        ...
        *,
        ...
        return shapes.DescribeExportConfigurationsResponse.from_boto_dict(
            response
        )
    ...
    def disassociate_configuration_items_from_application(
        ...
        *,
        ...
        return shapes.DisassociateConfigurationItemsFromApplicationResponse.from_boto_dict(
            response
        )
    ...
    def export_configurations(self, ) -> shapes.ExportConfigurationsResponse:
        ...
        return shapes.ExportConfigurationsResponse.from_boto_dict(response)
    ...
    def get_discovery_summary(
        ...
        response = self._boto_client.get_discovery_summary(
            **_request.to_boto_dict()
        )

        return shapes.GetDiscoverySummaryResponse.from_boto_dict(response)

    def list_configurations(
        self,
        _request: shapes.ListConfigurationsRequest = None,
        *,
        configuration_type: shapes.ConfigurationItemType,
        filters: typing.List[shapes.Filter] = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        next_token: str = ShapeBase.NOT_SET,
    ...
    def list_server_neighbors(
        ...
        *,
        ...
        response = self._boto_client.list_server_neighbors(
            **_request.to_boto_dict()
        )

        return shapes.ListServerNeighborsResponse.from_boto_dict(response)
    ...
    def start_continuous_export(
        ...
        return shapes.StartContinuousExportResponse.from_boto_dict(response)
    ...
    def start_data_collection_by_agent_ids(
        ...
        *,
        ...
        return shapes.StartDataCollectionByAgentIdsResponse.from_boto_dict(
            response
        )
    ...
    def start_export_task(
        ...
        *,
        export_data_format: typing.List[shapes.ExportDataFormat
                                       ] = ShapeBase.NOT_SET,
        filters: typing.List[shapes.ExportFilter] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.start_export_task(
            **_request.to_boto_dict()
        )

        return shapes.StartExportTaskResponse.from_boto_dict(response)
    ...
    def stop_continuous_export(
        ...
        *,
        ...
        return shapes.StopContinuousExportResponse.from_boto_dict(response)
    ...
    def stop_data_collection_by_agent_ids(
        ...
        *,
        ...
        return shapes.StopDataCollectionByAgentIdsResponse.from_boto_dict(
            response
        )
    ...
    def update_application(
        ...
        *,
        ...
        return shapes.UpdateApplicationResponse.from_boto_dict(response)
