...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("mq", *args, **kwargs)
    ...
    def create_broker(
        ...
        *,
        ...
        deployment_mode: shapes.DeploymentMode = ShapeBase.NOT_SET,
        engine_type: shapes.EngineType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_broker(**_request.to_boto_dict())

        return shapes.CreateBrokerResponse.from_boto_dict(response)
    ...
    def create_configuration(
        ...
        *,
        ...
        response = self._boto_client.create_configuration(
            **_request.to_boto_dict()
        )

        return shapes.CreateConfigurationResponse.from_boto_dict(response)
    ...
    def delete_broker(
        ...
        *,
        ...
        response = self._boto_client.delete_broker(**_request.to_boto_dict())

        return shapes.DeleteBrokerResponse.from_boto_dict(response)
    ...
    def describe_broker(
        ...
        *,
        ...
        response = self._boto_client.describe_broker(**_request.to_boto_dict())

        return shapes.DescribeBrokerResponse.from_boto_dict(response)
    ...
    def describe_configuration(
        ...
        *,
        ...
        return shapes.DescribeConfigurationResponse.from_boto_dict(response)
    ...
    def describe_configuration_revision(
        ...
        *,
        ...
        return shapes.DescribeConfigurationRevisionResponse.from_boto_dict(
            response
        )
    ...
    def list_brokers(
        ...
        *,
        ...
        response = self._boto_client.list_brokers(**_request.to_boto_dict())

        return shapes.ListBrokersResponse.from_boto_dict(response)
    ...
    def list_configuration_revisions(
        ...
        *,
        ...
        return shapes.ListConfigurationRevisionsResponse.from_boto_dict(
            response
        )
    ...
    def list_configurations(
        ...
        *,
        ...
        response = self._boto_client.list_configurations(
            **_request.to_boto_dict()
        )

        return shapes.ListConfigurationsResponse.from_boto_dict(response)
    ...
    def reboot_broker(
        ...
        *,
        ...
        response = self._boto_client.reboot_broker(**_request.to_boto_dict())

        return shapes.RebootBrokerResponse.from_boto_dict(response)
    ...
    def update_broker(
        ...
        *,
        ...
        response = self._boto_client.update_broker(**_request.to_boto_dict())

        return shapes.UpdateBrokerResponse.from_boto_dict(response)
    ...
    def update_configuration(
        ...
        *,
        ...
        response = self._boto_client.update_configuration(
            **_request.to_boto_dict()
        )

        return shapes.UpdateConfigurationResponse.from_boto_dict(response)
