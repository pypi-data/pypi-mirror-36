...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("cloudformation", *args, **kwargs)
    ...
    def cancel_update_stack(
        ...
        *,
        ...
        response = self._boto_client.cancel_update_stack(
    ...
    def continue_update_rollback(
        ...
        *,
        ...
        return shapes.ContinueUpdateRollbackOutput.from_boto_dict(response)
    ...
    def create_change_set(
        ...
        *,
        ...
        capabilities: typing.List[shapes.Capability] = ShapeBase.NOT_SET,
        ...
        change_set_type: shapes.ChangeSetType = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.create_change_set(
            **_request.to_boto_dict()
        )

        return shapes.CreateChangeSetOutput.from_boto_dict(response)
    ...
    def create_stack(
        ...
        *,
        ...
        resource_types: typing.List[str] = ShapeBase.NOT_SET,
        role_arn: str = ShapeBase.NOT_SET,
        on_failure: shapes.OnFailure = ShapeBase.NOT_SET,
        ...
        return shapes.CreateStackOutput.from_boto_dict(response)
    ...
    def create_stack_instances(
        ...
        *,
        ...
        return shapes.CreateStackInstancesOutput.from_boto_dict(response)
    ...
    def create_stack_set(
        ...
        *,
        ...
        response = self._boto_client.create_stack_set(**_request.to_boto_dict())

        return shapes.CreateStackSetOutput.from_boto_dict(response)
    ...
    def delete_change_set(
        ...
        *,
        ...
        response = self._boto_client.delete_change_set(
            **_request.to_boto_dict()
        )

        return shapes.DeleteChangeSetOutput.from_boto_dict(response)
    ...
    def delete_stack_instances(
        ...
        *,
        ...
        return shapes.DeleteStackInstancesOutput.from_boto_dict(response)
    ...
    def delete_stack_set(
        ...
        *,
        ...
        response = self._boto_client.delete_stack_set(**_request.to_boto_dict())

        return shapes.DeleteStackSetOutput.from_boto_dict(response)
    ...
    def describe_account_limits(
        ...
        *,
        ...
        return shapes.DescribeAccountLimitsOutput.from_boto_dict(response)
    ...
    def describe_change_set(
        ...
        *,
        ...
        response = self._boto_client.describe_change_set(
            **_request.to_boto_dict()
        )

        return shapes.DescribeChangeSetOutput.from_boto_dict(response)
    ...
    def describe_stack_events(
        ...
        *,
        ...
        response = self._boto_client.describe_stack_events(
            **_request.to_boto_dict()
        )

        return shapes.DescribeStackEventsOutput.from_boto_dict(response)
    ...
    def describe_stack_instance(
        ...
        *,
        ...
        return shapes.DescribeStackInstanceOutput.from_boto_dict(response)
    ...
    def describe_stack_resource(
        ...
        *,
        ...
        return shapes.DescribeStackResourceOutput.from_boto_dict(response)
    ...
    def describe_stack_resources(
        ...
        *,
        ...
        return shapes.DescribeStackResourcesOutput.from_boto_dict(response)
    ...
    def describe_stack_set(
        ...
        *,
        ...
        response = self._boto_client.describe_stack_set(
            **_request.to_boto_dict()
        )

        return shapes.DescribeStackSetOutput.from_boto_dict(response)
    ...
    def describe_stack_set_operation(
        ...
        *,
        ...
        return shapes.DescribeStackSetOperationOutput.from_boto_dict(response)
    ...
    def describe_stacks(
        ...
        *,
        ...
        return shapes.DescribeStacksOutput.from_boto_dict(response)
    ...
    def estimate_template_cost(
        ...
        *,
        ...
        return shapes.EstimateTemplateCostOutput.from_boto_dict(response)
    ...
    def execute_change_set(
        ...
        *,
        ...
        response = self._boto_client.execute_change_set(
            **_request.to_boto_dict()
        )

        return shapes.ExecuteChangeSetOutput.from_boto_dict(response)
    ...
    def get_stack_policy(
        ...
        *,
        ...
        response = self._boto_client.get_stack_policy(**_request.to_boto_dict())

        return shapes.GetStackPolicyOutput.from_boto_dict(response)
    ...
    def get_template(
        ...
        *,
        ...
        template_stage: shapes.TemplateStage = ShapeBase.NOT_SET,
        ...
        return shapes.GetTemplateOutput.from_boto_dict(response)
    ...
    def get_template_summary(
        ...
        *,
        ...
        response = self._boto_client.get_template_summary(
            **_request.to_boto_dict()
        )

        return shapes.GetTemplateSummaryOutput.from_boto_dict(response)
    ...
    def list_change_sets(
        ...
        *,
        ...
        response = self._boto_client.list_change_sets(**_request.to_boto_dict())

        return shapes.ListChangeSetsOutput.from_boto_dict(response)
    ...
    def list_exports(
        ...
        *,
        ...
        response = self._boto_client.list_exports(**_request.to_boto_dict())

        return shapes.ListExportsOutput.from_boto_dict(response)
    ...
    def list_imports(
        ...
        *,
        ...
        response = self._boto_client.list_imports(**_request.to_boto_dict())

        return shapes.ListImportsOutput.from_boto_dict(response)
    ...
    def list_stack_instances(
        ...
        *,
        ...
        response = self._boto_client.list_stack_instances(
            **_request.to_boto_dict()
        )

        return shapes.ListStackInstancesOutput.from_boto_dict(response)
    ...
    def list_stack_resources(
        ...
        *,
        ...
        response = self._boto_client.list_stack_resources(
            **_request.to_boto_dict()
        )

        return shapes.ListStackResourcesOutput.from_boto_dict(response)
    ...
    def list_stack_set_operation_results(
        ...
        *,
        ...
        return shapes.ListStackSetOperationResultsOutput.from_boto_dict(
            response
        )
    ...
    def list_stack_set_operations(
        ...
        *,
        ...
        return shapes.ListStackSetOperationsOutput.from_boto_dict(response)
    ...
    def list_stack_sets(
        ...
        *,
        next_token: str = ShapeBase.NOT_SET,
        max_results: int = ShapeBase.NOT_SET,
        status: shapes.StackSetStatus = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_stack_sets(**_request.to_boto_dict())

        return shapes.ListStackSetsOutput.from_boto_dict(response)
    ...
    def list_stacks(
        ...
        *,
        next_token: str = ShapeBase.NOT_SET,
        stack_status_filter: typing.List[shapes.StackStatus
                                        ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.list_stacks(**_request.to_boto_dict())

        return shapes.ListStacksOutput.from_boto_dict(response)
    ...
    def set_stack_policy(
        ...
        *,
        ...
        response = self._boto_client.set_stack_policy(**_request.to_boto_dict())
    ...
    def signal_resource(
        ...
        *,
        ...
        logical_resource_id: str,
        unique_id: str,
        status: shapes.ResourceSignalStatus,
    ) -> None:
        """
        ...
        response = self._boto_client.signal_resource(**_request.to_boto_dict())
    ...
    def stop_stack_set_operation(
        ...
        *,
        ...
        return shapes.StopStackSetOperationOutput.from_boto_dict(response)
    ...
    def update_stack(
        ...
        *,
        ...
        return shapes.UpdateStackOutput.from_boto_dict(response)
    ...
    def update_stack_instances(
        ...
        *,
        ...
        return shapes.UpdateStackInstancesOutput.from_boto_dict(response)
    ...
    def update_stack_set(
        ...
        *,
        ...
        response = self._boto_client.update_stack_set(**_request.to_boto_dict())

        return shapes.UpdateStackSetOutput.from_boto_dict(response)
    ...
    def update_termination_protection(
        ...
        *,
        ...
        return shapes.UpdateTerminationProtectionOutput.from_boto_dict(response)
    ...
    def validate_template(
        ...
        *,
        ...
        response = self._boto_client.validate_template(
            **_request.to_boto_dict()
        )

        return shapes.ValidateTemplateOutput.from_boto_dict(response)
