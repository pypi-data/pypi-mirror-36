...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("serverlessrepo", *args, **kwargs)
    ...
    def create_application_version(
        ...
        *,
        ...
        return shapes.CreateApplicationVersionResponse.from_boto_dict(response)
    ...
    def create_cloud_formation_change_set(
        ...
        *,
        ...
        return shapes.CreateCloudFormationChangeSetResponse.from_boto_dict(
            response
        )
    ...
    def get_application(
        ...
        *,
        ...
        return shapes.GetApplicationResponse.from_boto_dict(response)
    ...
    def get_application_policy(
        ...
        *,
        ...
        return shapes.GetApplicationPolicyResponse.from_boto_dict(response)
    ...
    def list_application_versions(
        ...
        *,
        ...
        return shapes.ListApplicationVersionsResponse.from_boto_dict(response)
    ...
    def put_application_policy(
        ...
        *,
        ...
        return shapes.PutApplicationPolicyResponse.from_boto_dict(response)
