...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("cloudhsm", *args, **kwargs)
    ...
    def create_hapg(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.create_hapg(**_request.to_boto_dict())

        return shapes.CreateHapgResponse.from_boto_dict(response)
    ...
    def create_hsm(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.create_hsm(**_request.to_boto_dict())

        return shapes.CreateHsmResponse.from_boto_dict(response)
    ...
    def create_luna_client(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.create_luna_client(
            **_request.to_boto_dict()
        )

        return shapes.CreateLunaClientResponse.from_boto_dict(response)
    ...
    def delete_hapg(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.delete_hapg(**_request.to_boto_dict())

        return shapes.DeleteHapgResponse.from_boto_dict(response)
    ...
    def delete_hsm(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.delete_hsm(**_request.to_boto_dict())

        return shapes.DeleteHsmResponse.from_boto_dict(response)
    ...
    def delete_luna_client(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.delete_luna_client(
            **_request.to_boto_dict()
        )

        return shapes.DeleteLunaClientResponse.from_boto_dict(response)
    ...
    def describe_hapg(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.describe_hapg(**_request.to_boto_dict())

        return shapes.DescribeHapgResponse.from_boto_dict(response)
    ...
    def describe_hsm(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.describe_hsm(**_request.to_boto_dict())

        return shapes.DescribeHsmResponse.from_boto_dict(response)
    ...
    def describe_luna_client(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.describe_luna_client(
            **_request.to_boto_dict()
        )

        return shapes.DescribeLunaClientResponse.from_boto_dict(response)
    ...
    def get_config(
        ...
        *,
        client_arn: str,
        client_version: shapes.ClientVersion,
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.get_config(**_request.to_boto_dict())

        return shapes.GetConfigResponse.from_boto_dict(response)
    ...
    def list_available_zones(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.list_available_zones(
            **_request.to_boto_dict()
        )

        return shapes.ListAvailableZonesResponse.from_boto_dict(response)
    ...
    def list_hapgs(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.list_hapgs(**_request.to_boto_dict())

        return shapes.ListHapgsResponse.from_boto_dict(response)
    ...
    def list_hsms(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.list_hsms(**_request.to_boto_dict())

        return shapes.ListHsmsResponse.from_boto_dict(response)
    ...
    def list_luna_clients(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.list_luna_clients(
            **_request.to_boto_dict()
        )

        return shapes.ListLunaClientsResponse.from_boto_dict(response)
    ...
    def modify_hapg(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.modify_hapg(**_request.to_boto_dict())

        return shapes.ModifyHapgResponse.from_boto_dict(response)
    ...
    def modify_hsm(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.modify_hsm(**_request.to_boto_dict())

        return shapes.ModifyHsmResponse.from_boto_dict(response)
    ...
    def modify_luna_client(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        response = self._boto_client.modify_luna_client(
            **_request.to_boto_dict()
        )

        return shapes.ModifyLunaClientResponse.from_boto_dict(response)
