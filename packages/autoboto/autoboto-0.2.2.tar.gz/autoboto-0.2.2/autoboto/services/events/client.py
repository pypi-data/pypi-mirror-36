...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("events", *args, **kwargs)
    ...
    def describe_event_bus(
        ...
        response = self._boto_client.describe_event_bus(
            **_request.to_boto_dict()
        )

        return shapes.DescribeEventBusResponse.from_boto_dict(response)
    ...
    def describe_rule(
        ...
        *,
        ...
        response = self._boto_client.describe_rule(**_request.to_boto_dict())

        return shapes.DescribeRuleResponse.from_boto_dict(response)
    ...
    def disable_rule(
        ...
        *,
        ...
        response = self._boto_client.disable_rule(**_request.to_boto_dict())
    ...
    def enable_rule(
        ...
        *,
        ...
        response = self._boto_client.enable_rule(**_request.to_boto_dict())
    ...
    def list_rule_names_by_target(
        ...
        *,
        ...
        return shapes.ListRuleNamesByTargetResponse.from_boto_dict(response)
    ...
    def list_targets_by_rule(
        ...
        *,
        ...
        response = self._boto_client.list_targets_by_rule(
            **_request.to_boto_dict()
        )

        return shapes.ListTargetsByRuleResponse.from_boto_dict(response)
    ...
    def put_permission(
        ...
        *,
        ...
        response = self._boto_client.put_permission(**_request.to_boto_dict())
    ...
    def put_rule(
        ...
        *,
        ...
        state: shapes.RuleState = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.put_rule(**_request.to_boto_dict())

        return shapes.PutRuleResponse.from_boto_dict(response)
    ...
    def put_targets(
        ...
        **Input** , **InputPath** , and **InputTransformer** are mutually exclusive and
        ...
        response = self._boto_client.put_targets(**_request.to_boto_dict())

        return shapes.PutTargetsResponse.from_boto_dict(response)
    ...
    def remove_targets(
        ...
        *,
        ...
        response = self._boto_client.remove_targets(**_request.to_boto_dict())

        return shapes.RemoveTargetsResponse.from_boto_dict(response)
    ...
    def test_event_pattern(
        ...
        *,
        ...
        response = self._boto_client.test_event_pattern(
            **_request.to_boto_dict()
        )

        return shapes.TestEventPatternResponse.from_boto_dict(response)
