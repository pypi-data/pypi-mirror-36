...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("sns", *args, **kwargs)
    ...
    def add_permission(
        ...
        *,
        ...
        response = self._boto_client.add_permission(**_request.to_boto_dict())
    ...
    def check_if_phone_number_is_opted_out(
        ...
        *,
        ...
        return shapes.CheckIfPhoneNumberIsOptedOutResponse.from_boto_dict(
            response
        )
    ...
    def confirm_subscription(
        ...
        *,
        ...
        response = self._boto_client.confirm_subscription(
            **_request.to_boto_dict()
        )

        return shapes.ConfirmSubscriptionResponse.from_boto_dict(response)
    ...
    def create_platform_application(
        ...
        *,
        ...
        return shapes.CreatePlatformApplicationResponse.from_boto_dict(response)
    ...
    def create_topic(
        ...
        *,
        ...
        response = self._boto_client.create_topic(**_request.to_boto_dict())

        return shapes.CreateTopicResponse.from_boto_dict(response)
    ...
    def delete_topic(
        ...
        *,
        ...
        response = self._boto_client.delete_topic(**_request.to_boto_dict())
    ...
    def get_endpoint_attributes(
        ...
        *,
        ...
        return shapes.GetEndpointAttributesResponse.from_boto_dict(response)
    ...
    def get_platform_application_attributes(
        ...
        *,
        ...
        return shapes.GetPlatformApplicationAttributesResponse.from_boto_dict(
            response
        )
    ...
    def get_sms_attributes(
        ...
        *,
        ...
        response = self._boto_client.get_sms_attributes(
            **_request.to_boto_dict()
        )

        return shapes.GetSMSAttributesResponse.from_boto_dict(response)
    ...
    def get_subscription_attributes(
        ...
        *,
        ...
        return shapes.GetSubscriptionAttributesResponse.from_boto_dict(response)
    ...
    def get_topic_attributes(
        ...
        *,
        ...
        response = self._boto_client.get_topic_attributes(
            **_request.to_boto_dict()
        )

        return shapes.GetTopicAttributesResponse.from_boto_dict(response)
    ...
    def list_endpoints_by_platform_application(
        ...
        *,
        ...
        response = self._boto_client.list_endpoints_by_platform_application(
            **_request.to_boto_dict()
        )

        return shapes.ListEndpointsByPlatformApplicationResponse.from_boto_dict(
            response
        )
    ...
    def list_phone_numbers_opted_out(
        ...
        *,
        ...
        return shapes.ListPhoneNumbersOptedOutResponse.from_boto_dict(response)
    ...
    def list_platform_applications(
        ...
        *,
        ...
        response = self._boto_client.list_platform_applications(
            **_request.to_boto_dict()
        )

        return shapes.ListPlatformApplicationsResponse.from_boto_dict(response)
    ...
    def list_subscriptions(
        ...
        *,
        ...
        response = self._boto_client.list_subscriptions(
            **_request.to_boto_dict()
        )

        return shapes.ListSubscriptionsResponse.from_boto_dict(response)
    ...
    def list_subscriptions_by_topic(
        ...
        *,
        ...
        response = self._boto_client.list_subscriptions_by_topic(
            **_request.to_boto_dict()
        )

        return shapes.ListSubscriptionsByTopicResponse.from_boto_dict(response)
    ...
    def list_topics(
        ...
        *,
        ...
        response = self._boto_client.list_topics(**_request.to_boto_dict())

        return shapes.ListTopicsResponse.from_boto_dict(response)
    ...
    def opt_in_phone_number(
        ...
        *,
        ...
        response = self._boto_client.opt_in_phone_number(
            **_request.to_boto_dict()
        )

        return shapes.OptInPhoneNumberResponse.from_boto_dict(response)
    ...
    def publish(
        ...
        *,
        ...
        message_attributes: typing.Dict[str, shapes.MessageAttributeValue
                                       ] = ShapeBase.NOT_SET,
        ...
        response = self._boto_client.publish(**_request.to_boto_dict())

        return shapes.PublishResponse.from_boto_dict(response)
    ...
    def remove_permission(
        ...
        *,
        ...
        response = self._boto_client.remove_permission(
            **_request.to_boto_dict()
        )
    ...
    def set_sms_attributes(
        ...
        *,
        ...
        response = self._boto_client.set_sms_attributes(
            **_request.to_boto_dict()
        )

        return shapes.SetSMSAttributesResponse.from_boto_dict(response)
    ...
    def set_topic_attributes(
        ...
        *,
        ...
        response = self._boto_client.set_topic_attributes(
            **_request.to_boto_dict()
        )
    ...
    def subscribe(
        ...
        *,
        ...
        response = self._boto_client.subscribe(**_request.to_boto_dict())

        return shapes.SubscribeResponse.from_boto_dict(response)
    ...
    def unsubscribe(
        ...
        *,
        ...
        response = self._boto_client.unsubscribe(**_request.to_boto_dict())
