...
class Client:
    def __init__(self, *args, **kwargs):
        self._boto_client = boto3.client("alexaforbusiness", *args, **kwargs)
    ...
    def list_skills(
        ...
        *,
        ...
        response = self._boto_client.list_skills(**_request.to_boto_dict())
    ...
    def search_devices(
        ...
        *,
        ...
        response = self._boto_client.search_devices(**_request.to_boto_dict())
    ...
    def search_profiles(
        ...
        *,
        ...
        response = self._boto_client.search_profiles(**_request.to_boto_dict())
    ...
    def search_rooms(
        ...
        *,
        ...
        response = self._boto_client.search_rooms(**_request.to_boto_dict())
    ...
    def search_skill_groups(
        ...
        *,
        ...
        response = self._boto_client.search_skill_groups(
            **_request.to_boto_dict()
        )
    ...
    def search_users(
        ...
        *,
        ...
        response = self._boto_client.search_users(**_request.to_boto_dict())
