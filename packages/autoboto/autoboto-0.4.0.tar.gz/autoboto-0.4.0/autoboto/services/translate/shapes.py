...
class DetectedLanguageLowConfidenceException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["DetectedLanguageLowConfidenceException", None, None]:
...
class TranslateTextRequest(ShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["TranslateTextRequest", None, None]:
        yield from super().paginate()
...
class TranslateTextResponse(OutputShapeBase):
    ...
    def paginate(self,
                ) -> typing.Generator["TranslateTextResponse", None, None]:
        yield from super().paginate()
...
class UnsupportedLanguagePairException(ShapeBase):
    ...
    def paginate(
        self,
    ) -> typing.Generator["UnsupportedLanguagePairException", None, None]:
        yield from super().paginate()
