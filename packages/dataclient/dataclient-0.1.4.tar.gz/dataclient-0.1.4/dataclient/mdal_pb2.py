...
_VALUEARRAY = _descriptor.Descriptor(
  name='ValueArray',
  full_name='mdalgrpc.ValueArray',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='mdalgrpc.ValueArray.value', index=0,
...
_DATAQUERYRESPONSE.fields_by_name['values'].message_type = _VALUEARRAY
...
ValueArray = _reflection.GeneratedProtocolMessageType('ValueArray', (_message.Message,), dict(
  ...
  __module__ = 'mdal_pb2'
  # @@protoc_insertion_point(class_scope:mdalgrpc.ValueArray)
  ))
