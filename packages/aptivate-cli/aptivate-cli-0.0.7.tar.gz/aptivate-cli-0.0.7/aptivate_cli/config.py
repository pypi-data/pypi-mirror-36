...
class Config():
    ...
    def sanity_checks(self) -> None:
        ...
        MANDATORY_ENVIRONMENT_VARIABLES = [
            settings.APTIVATE_CLI_PASS_DIR,
        ]

        for env_var in MANDATORY_ENVIRONMENT_VARIABLES:
            if not environ.get(env_var, False):
                message = "No '{}' exposed in environment".format(env_var)
