...
def _cond(*data, **kwargs):
    ...
    From:c:\jenkins\workspace\mxnet-tag\mxnet\src\operator\control_flow.cc:1380
...
def _foreach(*data, **kwargs):
    ...
    From:c:\jenkins\workspace\mxnet-tag\mxnet\src\operator\control_flow.cc:1257
    This function support variable length of positional input.
...
def _while_loop(*data, **kwargs):
    ...
    From:c:\jenkins\workspace\mxnet-tag\mxnet\src\operator\control_flow.cc:1318
    This function support variable length of positional input.
