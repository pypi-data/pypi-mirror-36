...
def track_pageview(client_id, page, hostname=None, title=None):
    ...
    return make_request(params=st.track_pageview_dict)


def track_event(client_id, category, action, label=None, value=None):
    ...
    return make_request(params=st.track_event_dict)
...
def track_transaction(
    ...
    return make_request(params=st.track_transaction_dict)
...
def track_item(
    ...
    return make_request(params=st.track_item_dict)


def track_social(client_id, action, network, target):
    ...
    return make_request(params=st.track_social_dict)
