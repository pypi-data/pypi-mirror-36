...
def init():
	"""
	Initializes the GUI thread and pops up the Control window. Closing 
	...
	If the graphical thread is already running calling :func:`init` has no 
	effect. 
	"""
	global GUIctl
...
def figure(*args, **kwargs):
	...
	*figsize*. 
	...
	:class:`pyopus.plotter.plotwidget.QPPlotWindow` object which passes them on 
	to the constructor of the :class:`pyopus.plotter.plotwidget.QPFigureCanvas` 
	object. 
	
	Returns the tag of the newly created plot window which is actually the 
