...
class QPEditCBDDesignPar(QPEditBase):
	def __init__(self, treePath=None, logger=None, parent=None, *args):
		...
		layout.addWidget(QLabel("Parameters with specified Low and High are subject to optimization.", self))
