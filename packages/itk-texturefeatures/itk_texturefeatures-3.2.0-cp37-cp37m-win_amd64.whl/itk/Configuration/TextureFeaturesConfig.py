...
snake_case_functions = ('image_source', 'image_file_writer', 'image_to_image_filter', 'image_file_reader', 'run_length_texture_features_image_filter', 'coocurrence_texture_features_image_filter', )
