...
snake_case_functions = ('image_to_image_filter', 'image_file_writer', 'image_file_reader', 'coocurrence_texture_features_image_filter', 'image_source', 'run_length_texture_features_image_filter', )
