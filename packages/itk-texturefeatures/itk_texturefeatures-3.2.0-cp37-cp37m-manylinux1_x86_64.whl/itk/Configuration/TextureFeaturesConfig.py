...
snake_case_functions = ('image_file_writer', 'run_length_texture_features_image_filter', 'image_source', 'coocurrence_texture_features_image_filter', 'image_to_image_filter', 'image_file_reader', )
