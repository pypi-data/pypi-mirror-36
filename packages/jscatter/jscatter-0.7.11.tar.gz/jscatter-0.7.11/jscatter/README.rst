...
5. **Models**
 ...
 Contribution by new models is welcome (please not trivial ones).
...
- :py:func:`~.formel.sedimentationProfile` -> solution to the Lamm equation of sedimenting particles
