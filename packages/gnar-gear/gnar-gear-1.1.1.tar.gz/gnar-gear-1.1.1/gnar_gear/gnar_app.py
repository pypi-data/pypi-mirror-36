...
class GnarApp:
    ...
    def get_sqs_queue_url(self, queue_name):
        ...
        if not queue_url:
            ...
            queue_url = sqs_client.get_queue_url(QueueName='gnar-queue')['QueueUrl']
    ...
    def recieve_sqs_messages(self, queue_url, callback, kwargs):
        sqs_client = self.get_sqs_client()
        while True:
    ...
    def configure_sqs_polls(self):
        if self.sqs:
            ...
            for sqs_queue in sqs_queues:
                ...
                PerpetualTimer(interval_seconds, self.recieve_sqs_messages, [queue_url, callback, kwargs])
