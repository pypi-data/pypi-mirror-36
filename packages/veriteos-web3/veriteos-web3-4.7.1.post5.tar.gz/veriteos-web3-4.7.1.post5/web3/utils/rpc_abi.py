...
RPC_ABIS = {
    ...
    'eth_getBlockByHash': ['bytes64', 'bool'],
    'eth_getBlockTransactionCountByHash': ['bytes64'],
    'eth_getCode': ['address', None],
    'eth_getLogs': FILTER_PARAMS_ABIS,
    'eth_getStorageAt': ['address', 'uint', None],
    'eth_getTransactionByBlockHashAndIndex': ['bytes64', 'uint'],
    'eth_getTransactionByHash': ['bytes64'],
    'eth_getTransactionCount': ['address', None],
    'eth_getTransactionReceipt': ['bytes64'],
    'eth_getUncleCountByBlockHash': ['bytes64'],
