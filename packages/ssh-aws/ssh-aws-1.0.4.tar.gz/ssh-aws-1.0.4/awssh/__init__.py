...
def display_instances(instances):
    details_fmt = "{:2} - {name:<30}{id:<21}{public_ip_address:<44}{private_dns_name:<30}{type:<12}({state})"
...
def create_parser():
    ...
    parser.add_argument('--region', help='AWS region (us-east-2 by default).', default='us-east-2')
    ...
    parser.add_argument('-r', '--remote-host',
                        help='Open a tunnel. Equivalent to ssh -L <local-port>:<remote-host>:<remote-port> '
                             '<selected-aws-host>')
