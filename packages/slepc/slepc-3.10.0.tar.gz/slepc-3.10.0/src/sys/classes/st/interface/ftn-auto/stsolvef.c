...
PETSC_EXTERN void PETSC_STDCALL  stgetoperator_(ST st,Mat *Op, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  stisinjective_(ST st,PetscBool* is, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  stsetworkvecs_(ST st,PetscInt *nw, int *__ierr){
