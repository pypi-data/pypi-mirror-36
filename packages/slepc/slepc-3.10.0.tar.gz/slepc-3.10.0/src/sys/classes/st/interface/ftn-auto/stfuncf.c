...
PETSC_EXTERN void PETSC_STDCALL  stsetmatrices_(ST st,PetscInt *n,Mat A[], int *__ierr){
*__ierr = STSetMatrices(
	(ST)PetscToPointer((st) ),*n,A);
}
PETSC_EXTERN void PETSC_STDCALL  stgetmatrix_(ST st,PetscInt *k,Mat *A, int *__ierr){
*__ierr = STGetMatrix(
	(ST)PetscToPointer((st) ),*k,A);
}
PETSC_EXTERN void PETSC_STDCALL  stgetmatrixtransformed_(ST st,PetscInt *k,Mat *T, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  stresetmatrixstate_(ST st, int *__ierr){
