...
PETSC_EXTERN void PETSC_STDCALL  bvsetbuffervec_(BV bv,Vec buffer, int *__ierr){
*__ierr = BVSetBufferVec(
	(BV)PetscToPointer((bv) ),
	(Vec)PetscToPointer((buffer) ));
}
PETSC_EXTERN void PETSC_STDCALL  bvgetbuffervec_(BV bv,Vec *buffer, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  bvcreatemat_(BV bv,Mat *A, int *__ierr){
*__ierr = BVCreateMat(
	(BV)PetscToPointer((bv) ),A);
}
PETSC_EXTERN void PETSC_STDCALL  bvgetmat_(BV bv,Mat *A, int *__ierr){
*__ierr = BVGetMat(
	(BV)PetscToPointer((bv) ),A);
}
PETSC_EXTERN void PETSC_STDCALL  bvrestoremat_(BV bv,Mat *A, int *__ierr){
*__ierr = BVRestoreMat(
	(BV)PetscToPointer((bv) ),A);
}
...
PETSC_EXTERN void PETSC_STDCALL  bvgetsplit_(BV bv,BV *L,BV *R, int *__ierr){
*__ierr = BVGetSplit(
	(BV)PetscToPointer((bv) ),L,R);
}
PETSC_EXTERN void PETSC_STDCALL  bvrestoresplit_(BV bv,BV *L,BV *R, int *__ierr){
