...
PETSC_EXTERN void PETSC_STDCALL  dsmatgetsize_(DS ds,DSMatType *t,PetscInt *m,PetscInt *n, int *__ierr){
*__ierr = DSMatGetSize(
	(DS)PetscToPointer((ds) ),*t,m,n);
}
PETSC_EXTERN void PETSC_STDCALL  dsmatishermitian_(DS ds,DSMatType *t,PetscBool *flg, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  dssynchronize_(DS ds,PetscScalar eigr[],PetscScalar eigi[], int *__ierr){
