...
PETSC_EXTERN void PETSC_STDCALL  dssetparallel_(DS ds,DSParallelType *pmode, int *__ierr){
*__ierr = DSSetParallel(
	(DS)PetscToPointer((ds) ),*pmode);
}
PETSC_EXTERN void PETSC_STDCALL  dsgetparallel_(DS ds,DSParallelType *pmode, int *__ierr){
