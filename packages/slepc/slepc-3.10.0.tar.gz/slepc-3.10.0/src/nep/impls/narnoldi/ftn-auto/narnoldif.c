...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  nepnarnoldisetlagpreconditioner_(NEP nep,PetscInt *lag, int *__ierr){
*__ierr = NEPNArnoldiSetLagPreconditioner(
	(NEP)PetscToPointer((nep) ),*lag);
}
PETSC_EXTERN void PETSC_STDCALL  nepnarnoldigetlagpreconditioner_(NEP nep,PetscInt *lag, int *__ierr){
