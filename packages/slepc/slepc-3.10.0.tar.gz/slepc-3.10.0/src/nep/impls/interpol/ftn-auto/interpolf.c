...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  nepinterpolsetinterpolation_(NEP nep,PetscReal *tol,PetscInt *deg, int *__ierr){
*__ierr = NEPInterpolSetInterpolation(
	(NEP)PetscToPointer((nep) ),*tol,*deg);
}
PETSC_EXTERN void PETSC_STDCALL  nepinterpolgetinterpolation_(NEP nep,PetscReal *tol,PetscInt *deg, int *__ierr){
