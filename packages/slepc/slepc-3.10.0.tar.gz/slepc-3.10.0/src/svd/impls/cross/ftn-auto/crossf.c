...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  svdcrosssetexplicitmatrix_(SVD svd,PetscBool *explicitmatrix, int *__ierr){
*__ierr = SVDCrossSetExplicitMatrix(
	(SVD)PetscToPointer((svd) ),*explicitmatrix);
}
PETSC_EXTERN void PETSC_STDCALL  svdcrossgetexplicitmatrix_(SVD svd,PetscBool *explicitmatrix, int *__ierr){
