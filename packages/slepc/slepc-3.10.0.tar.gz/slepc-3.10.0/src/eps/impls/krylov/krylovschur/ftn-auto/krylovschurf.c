...
PETSC_EXTERN void PETSC_STDCALL  epskrylovschurgetsubcommpairs_(EPS eps,PetscInt *i,PetscScalar *eig,Vec v, int *__ierr){
*__ierr = EPSKrylovSchurGetSubcommPairs(
	(EPS)PetscToPointer((eps) ),*i,eig,
	(Vec)PetscToPointer((v) ));
}
PETSC_EXTERN void PETSC_STDCALL  epskrylovschurupdatesubcommmats_(EPS eps,PetscScalar *s,PetscScalar *a,Mat Au,PetscScalar *t,PetscScalar *b,Mat Bu,MatStructure *str,PetscBool *globalup, int *__ierr){
