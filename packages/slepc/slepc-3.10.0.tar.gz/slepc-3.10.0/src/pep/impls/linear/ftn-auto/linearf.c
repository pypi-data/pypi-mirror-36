...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  peplinearsetlinearization_(PEP pep,PetscReal *alpha,PetscReal *beta, int *__ierr){
*__ierr = PEPLinearSetLinearization(
	(PEP)PetscToPointer((pep) ),*alpha,*beta);
}
PETSC_EXTERN void PETSC_STDCALL  peplineargetlinearization_(PEP pep,PetscReal *alpha,PetscReal *beta, int *__ierr){
