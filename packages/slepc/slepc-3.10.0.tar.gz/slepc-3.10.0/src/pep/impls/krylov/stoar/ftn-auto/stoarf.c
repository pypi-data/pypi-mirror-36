...
PETSC_EXTERN void PETSC_STDCALL  pepstoarsetlinearization_(PEP pep,PetscReal *alpha,PetscReal *beta, int *__ierr){
*__ierr = PEPSTOARSetLinearization(
	(PEP)PetscToPointer((pep) ),*alpha,*beta);
}
PETSC_EXTERN void PETSC_STDCALL  pepstoargetlinearization_(PEP pep,PetscReal *alpha,PetscReal *beta, int *__ierr){
