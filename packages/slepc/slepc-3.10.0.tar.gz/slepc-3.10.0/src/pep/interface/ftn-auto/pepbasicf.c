...
PETSC_EXTERN void PETSC_STDCALL  pepsetinterval_(PEP pep,PetscReal *inta,PetscReal *intb, int *__ierr){
*__ierr = PEPSetInterval(
	(PEP)PetscToPointer((pep) ),*inta,*intb);
}
PETSC_EXTERN void PETSC_STDCALL  pepgetinterval_(PEP pep,PetscReal* inta,PetscReal* intb, int *__ierr){
