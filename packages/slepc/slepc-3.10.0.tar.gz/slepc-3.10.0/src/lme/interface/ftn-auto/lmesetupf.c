...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  lmesetup_(LME lme, int *__ierr){
*__ierr = LMESetUp(
	(LME)PetscToPointer((lme) ));
}
PETSC_EXTERN void PETSC_STDCALL  lmesetcoefficients_(LME lme,Mat A,Mat B,Mat D,Mat E, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  lmegetcoefficients_(LME lme,Mat *A,Mat *B,Mat *D,Mat *E, int *__ierr){
*__ierr = LMEGetCoefficients(
	(LME)PetscToPointer((lme) ),A,B,D,E);
}
PETSC_EXTERN void PETSC_STDCALL  lmesetrhs_(LME lme,Mat C, int *__ierr){
*__ierr = LMESetRHS(
	(LME)PetscToPointer((lme) ),
	(Mat)PetscToPointer((C) ));
}
PETSC_EXTERN void PETSC_STDCALL  lmegetrhs_(LME lme,Mat *C, int *__ierr){
*__ierr = LMEGetRHS(
	(LME)PetscToPointer((lme) ),C);
}
PETSC_EXTERN void PETSC_STDCALL  lmesetsolution_(LME lme,Mat X, int *__ierr){
*__ierr = LMESetSolution(
	(LME)PetscToPointer((lme) ),
	(Mat)PetscToPointer((X) ));
}
PETSC_EXTERN void PETSC_STDCALL  lmegetsolution_(LME lme,Mat *X, int *__ierr){
*__ierr = LMEGetSolution(
	(LME)PetscToPointer((lme) ),X);
}
PETSC_EXTERN void PETSC_STDCALL  lmeallocatesolution_(LME lme,PetscInt *extra, int *__ierr){
