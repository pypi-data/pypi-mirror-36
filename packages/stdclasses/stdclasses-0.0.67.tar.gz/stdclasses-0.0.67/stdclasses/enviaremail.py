    ...
    for em in rcpt:
      ...
      if(len(e)>1 and e not in enviados):
        ...
        if(body.upper().find('<HTML>')>=0):
          ...
          body_type = RemoverAcentos(self, body_type)
...
#      
#  
#  params = {"from":"gmartino@santander.com.br"
#            , "to":"gmartino@santander.com.br;flguedes@santander.com.br"
#            , "bcc":"gmartino@santander.com.br"
#            , "subject":"Testando"
#            , "ip":"180.128.170.65"
...
#  params2 = {
#            "ip":"180.128.170.65",
#            "from":"gmartino@santander.com.br",
#            "to":"gmartino@santander.com.br;alsarmento@santander.com.br;gmartino@santander.com.br",
#            "cc":"gmartino@santander.com.br",
#            "subject":"Base contestacao desatualizada!",
#            "content":'conteudo',
#            }
#  Enviar('',params2)