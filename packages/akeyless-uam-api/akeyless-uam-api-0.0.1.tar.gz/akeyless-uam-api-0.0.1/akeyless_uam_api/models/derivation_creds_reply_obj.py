...
class DerivationCredsReplyObj(object):
    ...
    def __init__(self, kf_ms_hosts_dns_map=None, credential=None, expiry=None, item_id=None, item_name=None, item_size=None, item_type=None, item_version=None):  # noqa: E501
