...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    description='Tryton module to add a duration-column to the list of projects',
    ...
    keywords='tryton project duration column',
    ...
    package_data={
        'trytond.modules.%s' % MODULE: (info.get('xml', [])
            + ['tryton.cfg', 'versiondep.txt', 'view/*.xml', 
               'README.rst']),
        },
