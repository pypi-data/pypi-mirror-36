...
from dpaypybase.account import PrivateKey, GraphenePrivateKey
...
class Wallet():
    """ The wallet is meant to maintain access to private keys for
        ...
        * **Wallet Database**: Here, dpay-libs loads the keys from the
    ...
    def addPrivateKey(self, wif):
        ...
        """
        # it could be either graphenebase or dpaypybase so we can't check the type directly
