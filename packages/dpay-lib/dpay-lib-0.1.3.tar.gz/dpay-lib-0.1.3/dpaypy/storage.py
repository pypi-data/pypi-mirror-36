...
class DataDir(object):
    ...
    def check_legacy_v1(self):
        ...
        if os.path.isdir(data_dir) and not os.path.isdir(self.data_dir):
            ...
            # Copy dpaypy.sql to dpay.sql (no deletion!)
    ...
    def check_legacy_v2(self):
        ...
        """
        appname = "dpay"
        appauthor = "Jared Rice Sr."
        storageDatabase = "dpay.sqlite"
        data_dir = user_data_dir(appname, appauthor)
        sqlDataBaseFile = os.path.join(data_dir, storageDatabase)
...
class Configuration(DataDir):
    ...
    config_defaults = {
        ...
        "node": "wss://d.dpays.io,wss://d.dpays.io,wss://d.dsite.io",
        "post_category": "dpay",
        "rpcpassword": "",
        "rpcuser": "",
        "web:port": 5054,
