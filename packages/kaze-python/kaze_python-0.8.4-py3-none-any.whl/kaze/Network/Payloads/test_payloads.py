...
from kaze.Network.Payloads.NetworkAddressWithTime import NetworkAddressWithTime
...
class PayloadTestCase(kazeTestCase):
    ...
    def test_version_serialization(self):
        ...
        deserialized_version = IOHelper.AsSerializableWithType(serialized, 'kaze.Network.Payloads.VersionPayload.VersionPayload')
    ...
    def test_message_serialization(self):
        ...
        deserialized_version = IOHelper.AsSerializableWithType(dm.Payload, 'kaze.Network.Payloads.VersionPayload.VersionPayload')
