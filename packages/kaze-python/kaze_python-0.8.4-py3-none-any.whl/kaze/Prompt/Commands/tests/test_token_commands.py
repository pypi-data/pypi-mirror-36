...
from kaze.Prompt.Commands.Wallet import ImportToken
from kaze.Prompt.Commands.Tokens import token_get_allowance, \
...
class UserWalletTestCase(WalletFixtureTestCase):
    ...
    def test_8_mint(self):
        ...
        args = [token.symbol, addr_to, '--attach-kaze=10']
