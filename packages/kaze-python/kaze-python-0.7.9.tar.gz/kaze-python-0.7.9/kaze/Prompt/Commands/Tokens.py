from kaze.Prompt.Commands.Invoke import InvokeContract, InvokeWithTokenVerificationScript
from kaze.Prompt.Utils import get_asset_id, get_from_addr, get_tx_attr_from_args
...
def do_token_transfer(token, wallet, from_address, to_address, amount, prompt_passwd=True, tx_attributes=None):
    ...
    # for verification by default to the transaction attributes. See PR/Issue: https://github.com/KAZEBLOCKCHAIN/kaze-python/pull/491
