...
from kaze.api.utils import json_response, cors_header
...
from kaze.VM.VMState import VMStateStr
from kaze.Implementations.Wallets.peewee.Models import Account
from kaze.Prompt.Utils import get_asset_id
...
class JsonRpcError(Exception):
    ...
    to be compliant with kaze-cli responses
    """
...
class JsonRpcApi:
    ...
    def get_invoke_result(self, script):
        ...
        return {
            ...
            "stream_consumed": appengine.streamConsumed().ToString(),
