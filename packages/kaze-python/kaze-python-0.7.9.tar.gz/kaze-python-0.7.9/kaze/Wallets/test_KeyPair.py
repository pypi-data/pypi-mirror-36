...
class ConstructorTestCase(kazeTestCase):
    ...
    @patch('kazecore.KeyPair.bitcoin.privkey_to_pubkey')
...
class PrivateKeyFromWIFTestCase(kazeTestCase):
...
class PrivateKeyFromNEP2TestCase(kazeTestCase):
...
class GetAddressTestCase(kazeTestCase):
...
class ExportNEP2TestCase(kazeTestCase):
...
class ExportWIFTestCase(kazeTestCase):
