...
The result of `ctypes.sizeof` is not equivalent to C# or what we expect. See https://github.com/KAZEBLOCKCHAIN/kaze-python/pull/418#issuecomment-389803377
    ...
    # internal static int GetVarSize<T>(this T[] value)
        ...
        if value_length > 0:
            if isinstance(value[0], SerializableMixin):
                ...
                # Note: currently all Enum's in kaze core (C#) are of type Byte. Only porting that part of the code
