...
from kaze.Implementations.Wallets.peewee.PWDatabase import PWDatabase
from kaze.Implementations.Wallets.peewee.Models import Key
...
def main():
    ...
    if reset_password(new_path, password):
        print("A new wallet was created with your master key encrypted with the new password, with the name %s. You can now open this new wallet with the new version of kaze-python" % new_path)
    else:
