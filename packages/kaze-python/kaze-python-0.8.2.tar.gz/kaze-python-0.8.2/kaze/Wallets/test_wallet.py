...
class WalletTestCase(kazeTestCase):
    ...
    kazen_sig = 'ea0b16eacce905984ca82852d40030f6bf3f5440bf06c0b632043de9b2a95b8f3ea497c2d7702aad5be5c7463610ee58eb92ba6c39d6e86affd5cb7dec028ee9'

    hashhex = '18b7bfca2a4a81ae72f4ad766a6f7aded1c7155118e3679d1b37a2d66d92bd77'

    def test_kazen_sig(self):
        ...
        self.assertEqual(sig.hex(), self.kazen_sig)
    ...
    def test_privnet_wallet(self):
        ...
        wallet = UserWallet.Open(os.path.join(ROOT_INSTALL_PATH, "kaze/data/kaze-privnet.sample.wallet"), to_aes_key("coz"))
