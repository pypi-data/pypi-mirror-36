...
Run only thse tests:
    ...
    $ python -m unittest kaze.api.JSONRPC.test_json_rpc_api
"""
import json
import binascii
import os
...
from kaze.api.JSONRPC.JsonRpcApi import JsonRpcApi
...
from kaze.IO.Helper import Helper
...
from kaze.Settings import ROOT_INSTALL_PATH
...
class JsonRpcApiTestCase(BlockchainFixtureTestCase):
    ...
    def test_account_state(self):
        ...
        mock_req = mock_request(json.dumps(req).encode("utf-8"))
        res = json.loads(self.app.home(mock_req))
        self.assertEqual(res['result']['balances']['0xf1fee7945e5ba7fed56272b916094ed8f384a94e63d5f8d81214dfde489ffb17'], '4061.0')
    ...
    def test_get_asset_state(self):
        asset_str = '9d2593e23db5e8946969a16d1980ee57e04bb25904bb0ca0d181257eb48a5398'
    ...
    def test_get_asset_state_0x(self):
        asset_str = '0x9d2593e23db5e8946969a16d1980ee57e04bb25904bb0ca0d181257eb48a5398'
        req = self._gen_rpc_req("getassetstate", params=[asset_str])
        mock_req = mock_request(json.dumps(req).encode("utf-8"))
        res = json.loads(self.app.home(mock_req))
    ...
    def test_block_non_verbose(self):
        ...
        block = Helper.AsSerializableWithType(output, 'kaze.Core.Block.Block')
    ...
    def test_get_version(self):
        ...
        self.assertEqual(res["result"]["useragent"], "/kaze-PYTHON:%s/" % __version__)

    def test_validate_address(self):
        # example from docs.kaze.org
    ...
    def test_gettxout(self):
        ...
        expected_asset = '0x9d2593e23db5e8946969a16d1980ee57e04bb25904bb0ca0d181257eb48a5398'
        expected_value = "25"
    ...
    def test_getwalletheight(self):
        self.app.wallet = UserWallet.Open(os.path.join(ROOT_INSTALL_PATH, "kaze/data/kaze-privnet.sample.wallet"), to_aes_key("coz"))
    ...
    def test_getbalance_kaze_with_wallet(self):
        ...
        kaze_id = "f1fee7945e5ba7fed56272b916094ed8f384a94e63d5f8d81214dfde489ffb17"
        req = self._gen_rpc_req("getbalance", params=[kaze_id])
        mock_req = mock_request(json.dumps(req).encode("utf-8"))
        res = json.loads(self.app.home(mock_req))
