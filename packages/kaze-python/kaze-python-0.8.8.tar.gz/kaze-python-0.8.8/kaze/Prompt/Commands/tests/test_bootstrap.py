...
from kaze.Prompt.Commands.Bootstrap import BootstrapBlockchainFile
import os
import shutil
...
class BootstrapTestCase(TestCase):
    ...
    bootstrap_file_good = 'https://s3.us-east-2.amazonaws.com/KAZEBLOCKCHAIN/bootstrap_testnet/bootstraptest.tar.gz'
