...
from kaze.Core.State.SpentCoinState import SpentCoinState
...
class StateTestCase(kazeTestCase):
...
#        print("account 1 %s " % json.dumps(account1.ToJson(), indent=4))
    ...
    assetkey = b'9d2593e23db5e8946969a16d1980ee57e04bb25904bb0ca0d181257eb48a5398'
    ...
    def test_asset_state(self):
        ...
        self.assertEqual(asset.GetName(), 'kazestream')
