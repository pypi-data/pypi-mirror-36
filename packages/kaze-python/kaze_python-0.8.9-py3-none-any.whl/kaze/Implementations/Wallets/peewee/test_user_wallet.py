...
from kaze.Prompt.Commands.Wallet import AddAlias
from kaze.Prompt.Utils import parse_param, lookup_addr_str
...
from kaze.Core.TX.Transaction import ContractTransaction, TransactionOutput
...
class UserWalletTestCase(WalletFixtureTestCase):
    ...
    def test_1_initial_setup(self):
        ...
        stream_balance = wallet.GetBalance(self.stream)

        self.assertEqual(balance_should_be, stream_balance)

        kaze_balance = wallet.GetBalance(self.kaze)

        self.assertEqual(balance_should_be, kaze_balance)
