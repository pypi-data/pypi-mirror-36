...
Another option is to setup a Linux Subsystem with Ubuntu (see also `here <https://medium.com/@gubanotorious/installing-and-running-kaze-python-on-windows-10-284fb518b213>`_ for more infos and a guide).
...
::
    ...
    conda create -n kaze python=3.6.4
    activate kaze
...
Navigate into the kaze-python directory and install other dependencies via
...
Navigate into package directory of your python distribution e.g. ``e:\Programs\Anaconda3\envs\kaze\Lib\site-packages``.
