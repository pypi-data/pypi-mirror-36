...
from kaze.SmartContract.tests.test_vm_error_output import StringIn
...
#        self.assertEqual(deserialized, my_integer)
    ...
    def test_cant_serialize_iop_item(self, mocked_logger):
        ...
        mocked_logger.assert_called_with(StringIn('Cannot serialize item IOp Interface: <kaze.Core.Block.Block object'))
