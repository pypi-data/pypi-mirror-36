...
from kaze.Prompt.Commands.BuildNRun import BuildAndRun
...
class UserWalletTestCase(WalletFixtureTestCase):
    ...
    def test_build_contract(self):
        ...
        'stack': [{'type': 'Integer', 'value': '1'}], 'stream_consumed': '1.056'}
        """

        wallet = self.GetWallet1()

        arguments = ["kaze/SmartContract/tests/StorageTest.py", "test", "070705", "05", "True", "False", "True", "put", "key1", "b'ab'", "--from-addr=" + self.wallet_1_addr]
        ...
        self.assertEqual(expected_cost, engine.streamConsumed())
        self.assertEqual(tx.stream, expected_fee)
    ...
    def test_build_contract_2(self):
        ...
        'stack': [{'type': 'Integer', 'value': '1'}], 'stream_consumed':'6.151'}
        """

        wallet = self.GetWallet1()

        arguments = ["kaze/SmartContract/tests/StorageTest.py", "test", "070705", "05", "True", "False", "True", "put_5", "key1", "b'abababababab'"]
    ...
    def test_build_contract_3(self):
        ...
        {'state': 'HALT, BREAK',
         ...
         'stack': [{'type': 'ByteArray', 'value': 'abababababab'}], 'stream_consumed': '1.18'}
        """
        wallet = self.GetWallet1()

        arguments = ["kaze/SmartContract/tests/StorageTest.py", "test", "070705", "05", "True", "False", "True", "put_and_get", "key1", "b'abababababab'"]
    ...
    def test_build_contract_4(self):
        ...
        arguments = ["kaze/SmartContract/tests/StorageTest.py", "test", "070705", "05", "True", "False", "True", "put_and_get", "key1", self.big_str]
    ...
    def test_build_contract_5(self):
        ...
        ca3434', 'stack': [{'type': 'Integer', 'value': '1'}], 'stream_consumed': '11.151'}
        """
        wallet = self.GetWallet1()

        arguments = ["kaze/SmartContract/tests/StorageTest.py", "test", "070705", "05", "True", "False", "True", "put_5", "key1", self.big_str]

        tx, result, total_ops, engine = BuildAndRun(arguments, wallet, False)

        expected_cost = Fixed8(1046600000)
        expected_stream = Fixed8.FromDecimal(1.0)
        self.assertEqual(expected_cost, engine.streamConsumed())
        self.assertEqual(tx.stream, expected_stream)
    ...
    def test_build_contract_6(self):
        ...
        "stream_consumed":"9.715","stack":[{"type":"Integer","value":"1"}]}}
        """
        wallet = self.GetWallet1()

        arguments = ["kaze/SmartContract/tests/StorageTest.py", "test", "070705", "05", "True", "False", "True", "put_9", "key1", "b'ababababab'"]

        tx, result, total_ops, engine = BuildAndRun(arguments, wallet, False)

        expected_cost = Fixed8.FromDecimal(9.762)
        expected_stream = Fixed8.FromDecimal(.0001)
        self.assertEqual(expected_cost, engine.streamConsumed())
        self.assertEqual(tx.stream, expected_stream)
    ...
    def test_build_contract_7(self):
        ...
        arguments = ["kaze/SmartContract/tests/StorageTest.py", "test", "070705", "05", "True", "False", "put_5", "key1", self.big_str]
