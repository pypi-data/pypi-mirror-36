...
from kaze.Core.TX.RegisterTransaction import RegisterTransaction
...
from kaze.VM.OpCode import PUSHF, PUSHT
from kaze.Core.State.SpentCoinState import SpentCoin
...
class Blockchain:
    ...
    def SystemShare():
        ...
        return RegisterTransaction([], [], AssetType.GoverningToken,
              "[{\"lang\":\"de-CH\",\"name\":\"KazeMünze\"},{\"lang\":\"en\",\"name\":\"KazeCoin\"}]",
    ...
    def SystemCoin():
        ...
        "[{\"lang\":\"de-CH\",\"name\":\"KazeStream\"},{\"lang\":\"en\",\"name\":\"KazeStream\"}]",
    ...
    def GenesisBlock():
        ...
        timestamp = int(datetime(2018, 2, 27, 23, 30, 21, tzinfo=pytz.utc).timestamp())
        index = 0
