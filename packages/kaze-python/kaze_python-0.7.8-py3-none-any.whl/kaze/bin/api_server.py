...
Uses kaze.api.JSONRPC.JsonRpcApi and kaze.api.REST.RestApi
...
* If you encounter any issues, please report them here: https://github.com/KAZEBLOCKCHAIN/kaze-python/issues/273
* Server setup
...
from kaze.api.REST.RestApi import RestApi
...
PID_FILE = os.getenv("PID_FILE", "/tmp/kazepython-api-server.pid")
...
def main():
    ...
    if args.wallet:
        ...
        passwd = os.environ.get('kaze_PYTHON_JSONRPC_WALLET_PASSWORD', None)
        if not passwd:
