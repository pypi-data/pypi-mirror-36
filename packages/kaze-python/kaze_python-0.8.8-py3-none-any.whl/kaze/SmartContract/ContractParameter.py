...
from kaze.VM.InteropService import StackItem, Array, ByteArray, Struct, Boolean, Integer, InteropInterface
...
class ContractParameter:
    ...
    def __init__(self, type, value):
        ...
        Args:
            type (kaze.SmartContract.ContractParameterType.ContractParameterType): The type of the parameter
    ...
    def ToParameter(item: StackItem):
        ...
        Args:
            item (kaze.VM.InteropService.StackItem) The item to convert to a ContractParameter object
    ...
    def AsParameterType(type: ContractParameterType, item: StackItem):
        ...
        Args:
            type (kaze.SmartContract.ContractParameterType): The ContractParameterType to convert to
            item (kaze.VM.InteropService.StackItem): The item to convert to a ContractParameter object
