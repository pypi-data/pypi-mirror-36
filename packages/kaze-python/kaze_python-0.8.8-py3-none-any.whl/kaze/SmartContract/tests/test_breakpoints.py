...
from kaze.Prompt.vm_debugger import VMDebugger, DebugContext
...
class UserWalletTestCase(WalletFixtureTestCase):
    ...
    def test_debug_contract_1(self):
        ...
        arguments = ["kaze/SmartContract/tests/BreakpointTest.py", "test", "02", "01", "True", "False", "True", "1", ]
        dbg = VMDebugger
#        dbg.end = MagicMock(return_value=None)
    ...
    def test_debug_contract_2(self):
        ...
        arguments = ["kaze/SmartContract/tests/BreakpointTest.py", "test", "02", "01", "True", "False", "True", "4", ]
        dbg = VMDebugger
        #        dbg.end = MagicMock(return_value=None)
        dbg.start = MagicMock(return_value=None)
        tx, result, total_ops, engine = BuildAndRun(arguments, wallet, False, min_fee=Fixed8.FromDecimal(.0004))
