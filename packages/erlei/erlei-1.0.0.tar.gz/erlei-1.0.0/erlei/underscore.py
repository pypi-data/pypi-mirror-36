"""
anoyfunc(anonymous function) makes the function definition more wonderful.
...
__all__ = ['underscore', 'uunderscore']
...
class Underscore(object):
    ...
    def __str__(self):
        ...
        return "<class 'Underscore':a callable object roughly equivalent to function: %s>" % str_func
    ...
    def __getitem__(self, k):
        return self.__class__(self._format + '[%s]' % k, self._format_args)

    def __getattr__(self, name):
        return self.__class__(self._format + '.%s' % name,
                              self._format_args)
