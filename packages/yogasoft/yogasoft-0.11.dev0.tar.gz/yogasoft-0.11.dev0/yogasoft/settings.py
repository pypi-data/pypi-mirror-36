...
DEBUG = False
ALLOWED_HOSTS = ['yogasoft.codernetwork.ga',
                 'localhost',
                 'dev.yogasoft.codernetwork.ga']
...
CRON_CLASSES = [
    'app.cron.JustWriteTimeJob'
]

#taras here
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = '857493534650-5fmb4l4gfj5ipr6uka5879uo9qpkbps7.apps.googleusercontent.com'  # For auth in google +
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = 'XLSVagmDK4Ok8Z17DfpfaaKp'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'nfhfcdfcmrsd@gmail.com'
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD')
DEFAULT_FROM_EMAIL = 'nfhfcdfcmrsd@gmail.com'

# twilio for sms
TWILIO_ACCOUNT_SID = config('TWILIO_ACCOUNT_SID')
TWILIO_AUTH_TOKEN = config('TWILIO_AUTH_TOKEN')
TWILIO_NUMBER = '+18317774536'
