...
class Calendar(Field):
    ...
    def __init__(self, eventTypes=None, eventNameMethod=None,
      ...
      colors=None, showUncolored=False, columnColors=None, preCompute=None,
      ...
      selectableEmptyCells=False, legend=None, view=None, cell=None, xml=None,
      translations=None, delete=True, selectableMonths=6,
      createEventLabel='which_event', style='calTable'):
        ...
        Field.__init__(self, validator, (0,1), default, show, page, group,
          ...
          None, None, True, False, view, cell, xml, translations)
