...
class Switch(Field):
    ...
    def __init__(self, fields, validator=None, show=True, page='main',
      ...
      inlineEdit=False, view=None, cell=None, xml=None, translations=None):
        ...
        Field.__init__(self, validator, (0,1), None, show, page, group, layouts,
          ...
          scolspan, swidth, sheight, True, inlineEdit, view, cell, xml,
          translations)
