...
class Ref(Field):
    ...
    def __init__(self, klass=None, attribute=None, validator=None,
      ...
      menuUrlMethod=None, menuCss=None, view=None, cell=None, xml=None,
      translations=None, showActions='all', actionsDisplay='block',
      collapsible=False, links=True, viewAdded=True,
