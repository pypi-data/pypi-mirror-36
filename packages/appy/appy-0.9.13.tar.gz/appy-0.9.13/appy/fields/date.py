...
class Date(Field):
    ...
    def __init__(self, validator=None, multiplicity=(0,1), default=None,
      ...
      swidth=None, sheight=None, persist=True, view=None, cell=None, xml=None,
      translations=None, showDay=True, searchHour=False):
        ...
        Field.__init__(self, validator, multiplicity, default, show, page,
          ...
          False, view, cell, xml, translations)
    ...
    def getDateFromSearchValue(self, year, month, day, setMin):
    ...
    def getSearchValue(self, form):
        ...
        fromDate = self.getDateFromSearchValue(year, month, day, True)
        # Get the "to" value"
        year  = form['%s_to_year' % name]
        month = form['%s_to_month' % name]
        day   = form['%s_to_day' % name]
        toDate = self.getDateFromSearchValue(year, month, day, False)
