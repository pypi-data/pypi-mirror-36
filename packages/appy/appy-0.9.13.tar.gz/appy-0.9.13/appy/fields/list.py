...
class List(Field):
    ...
    def __init__(self, fields, validator=None, multiplicity=(0,1), default=None,
      ...
      label=None, subLayouts=Table('f;r;v', width=None), widths=None, view=None,
      cell=None, xml=None, translations=None, deleteConfirm=False,
      totalRows=None):
        Field.__init__(self, validator, multiplicity, default, show, page,
         ...
         None, None, None, True, False, view, cell, xml, translations)
        self.validable = True
