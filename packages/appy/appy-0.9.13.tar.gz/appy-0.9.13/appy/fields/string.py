...
class String(Field):
    ...
    def __init__(self, validator=None, multiplicity=(0,1), default=None,
      ...
      styles=('p','h1','h2','h3','h4'), allowImageUpload=True, spellcheck=False,
      languages=('en',), languagesLayouts=None, inlineEdit=False,
      toolbar='Standard', view=None, cell=None, xml=None, translations=None,
    ...
    def getValue(self, obj, name=None, noListIfSingleObj=False):
