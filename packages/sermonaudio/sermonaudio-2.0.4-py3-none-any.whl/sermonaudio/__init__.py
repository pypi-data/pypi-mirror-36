...
def create_or_configure_session_with_retry(retries=3,
                                           backoff_factor=0.3,
...
class API:
    ...
    put = functools.partialmethod(_request,
                                  method='put',
                                  parse_func=lambda res: res.status_code in {HTTPStatus.OK,
                                                                             HTTPStatus.CREATED,
                                                                             HTTPStatus.NO_CONTENT})
    patch = functools.partialmethod(_request,
                                    method='patch',
                                    parse_func=lambda res: res.status_code in {HTTPStatus.OK,
                                                                               HTTPStatus.ACCEPTED,
                                                                               HTTPStatus.NO_CONTENT})
    delete = functools.partialmethod(_request,
                                     method='delete',
                                     parse_func=lambda res: res.status_code in {HTTPStatus.OK,
                                                                                HTTPStatus.ACCEPTED,
                                                                                HTTPStatus.NO_CONTENT})
