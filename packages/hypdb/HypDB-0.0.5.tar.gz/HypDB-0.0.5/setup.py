...
package_data = \
{'': ['*'],
 'hypdb': ['modules/*', 'modules/lpsolve_dev/*', 'utils/*'],
 'hypdb.modules.kbutil': ['build/*', 'build/lib/*'],
 'hypdb.modules.pyrankagg': ['build/*', 'build/lib/*']}
...
setup_kwargs = {
    ...
    'url': 'https://github.com/CoreyCole/HypDB',
    'packages': packages,
