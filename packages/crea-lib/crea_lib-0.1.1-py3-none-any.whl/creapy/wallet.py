...
from creapybase.account import PrivateKey, GraphenePrivateKey
...
class Wallet():
    """ The wallet is meant to maintain access to private keys for
        ...
        :param CreaNodeRPC rpc: RPC connection to a Crea node
        :param array,dict,string keys: Predefine the wif keys to shortcut the wallet database

        Three wallet operation modes are possible:

        * **Wallet Database**: Here, crea-libs loads the keys from the
    ...
    def addPrivateKey(self, wif):
        ...
        """
        # it could be either graphenebase or creapybase so we can't check the type directly
