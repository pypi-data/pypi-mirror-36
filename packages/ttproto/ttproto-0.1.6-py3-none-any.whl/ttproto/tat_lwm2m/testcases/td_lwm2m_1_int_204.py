...
class TD_LWM2M_1_INT_204(CoAPTestCase):
    """
---
...
objective: 
  - Quering the Resources values of Device Object (ID:3) on the Client in JSON format
...
sequence:
  ...
  - step_id: 'TD_LWM2M_1.0_INT_204_step_04'
    ...
    def run(self):
        ...
        validation = validate(str(self.coap['pl']),'3')
