...
Triz2sce versión 1.0.4 180915 (c) 2018 Pedro Fernández
...
Triz2sce version 1.0.3 180723 (c) 2018 Pedro Fernández

Trizio2sce is a Python 3.x script that transforms a file generated with the text-adventure mapping tool Trizbort into a source code compatible with the DAAD compilator.
