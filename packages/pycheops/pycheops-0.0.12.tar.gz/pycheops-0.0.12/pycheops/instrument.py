...
_data_path = join(dirname(abspath(__file__)),'data','instrument')

with open(join(_data_path,'visibility_interpolator.p'),'rb') as fp:
    _visibility_interpolator = load(fp)

with open(join(_data_path,'exposure_time.p'),'rb') as fp:
