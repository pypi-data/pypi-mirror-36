...
positionRow = "id , account , strategy , symbol , start_base_coin as startBaseCoin, base_coin as baseCoin, base_coin_frozen as baseCoinFrozen , trade_coin as tradeCoin, trade_coin_frozen as tradeCoinFrozen, null_coin as nullCoin, null_coin_frozen as nullCoinFrozen "
conf = cf.configer()
