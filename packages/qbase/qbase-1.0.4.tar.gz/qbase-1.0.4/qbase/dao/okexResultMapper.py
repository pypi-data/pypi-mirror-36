...
def insertOkexResult(positionId ,okexResultJson):
    sql = "insert into okex_result ("+okexResultInsert+") VALUES ('"+str(getTimeStamp())+"' , "+str(positionId)+", '"+str(okexResultJson[u'order_id'])+"', '"+str(okexResultJson[u'amount'])+"', '"+str(okexResultJson[u'contract_name'])+"', '"+str(okexResultJson[u'create_date'])+"', '"+str(okexResultJson[u'deal_amount'])+"', '"+str(okexResultJson[u'fee'])+"', "+str(okexResultJson[u'price'])+", '"+str(okexResultJson[u'price_avg'])+"', '"+str(okexResultJson[u'symbol'])+"', '"+str(okexResultJson[u'type'])+"', '"+str(okexResultJson[u'status'])+"', '"+str(okexResultJson[u'unit_amount'])+"', "+str(okexResultJson[u'lever_rate'])+")"
    # 链接数据库
