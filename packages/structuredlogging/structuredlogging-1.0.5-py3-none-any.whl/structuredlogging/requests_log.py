...
"""
def log_http_request(self, level, http_response,
                     ...
                     messageStats_P99=None, operationType=None,
    ...
    self.log(level, http_response, args)


def log_request(self, level, additionalCorrelationIds=None, correlationId=None,
    ...
    self.log(level, {"@type": "request", "messageArguments": args})
