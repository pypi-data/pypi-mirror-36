...
from djangokarat.utils import (has_karat_fields, convert__all__to_fields, get_karat_id_field, filter_relational_fields)
...
class KaratModel(Model):
    ...
    # create related connections with __ like user__email
    ...
    def _prepare_karat_fields(self):
        if isinstance(self._meta.karat_fields, dict):
            ...
            lookup_fields = filter_relational_fields(self._meta.karat_fields.keys())
            ...
            for field in lookup_fields:
                ...
                karat_name = self._meta.karat_fields[field]
