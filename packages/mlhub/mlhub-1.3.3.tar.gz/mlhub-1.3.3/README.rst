...
is available as `mlhub_1.3.3.tar.gz
<https://mlhub.ai/dist/mlhub_1.3.3.tar.gz>`_ within the `distribution
<https://mlhub.ai/dist/>`_ folder of the MLHub.

To install from the tar.gz file::
  
  $ wget https://mlhub.ai/dist/mlhub_1.3.3.tar.gz
  $ pip install mlhub_1.3.3.tar.gz
  $ ml

Or extract the above downloaded .tar.gz and install::

  $ wget https://mlhub.ai/dist/mlhub_1.3.3.tar.gz
  $ tar xvf mlhub_1.3.3.tar.gz
  $ cd mlhub
