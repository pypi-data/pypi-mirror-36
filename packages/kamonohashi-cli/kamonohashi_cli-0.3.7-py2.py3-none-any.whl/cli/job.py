...
@click.option('--count', type=int, help='Maximum number of jobs to list')
...
@job.command(help='Get details of a job by ID')
...
@job.command('delete-file', help='Delete an attached file of the job of ID')
@click.argument('id', type=int)
