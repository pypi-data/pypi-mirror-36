...
def filename_column(**kwargs):
    """
    Return a SQLAlchemy Column object suitable for defining a model field.  It
    is hoped this will be useful for standardization and/or readability..?
    """
    kwargs.setdefault('nullable', True)
    kwargs.setdefault('doc', "Base name of the data file.")
    return sa.Column(sa.String(length=255), **kwargs)
