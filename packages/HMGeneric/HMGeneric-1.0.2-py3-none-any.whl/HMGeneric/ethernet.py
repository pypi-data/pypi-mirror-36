...
from HMGenericPackage.terminal import get_terminal_lines
from HMGenericPackage.array import get_phrase_from_list, split_list_by_phrase
from HMGenericPackage.registry import get_all_values, get_where, get_column, get_values, search_attribute
...
def get_my_interface():
    if(os.name == "nt"): #windows
        ...
        return {'mac':mac, 'ip':ip, 'interface':interface }
