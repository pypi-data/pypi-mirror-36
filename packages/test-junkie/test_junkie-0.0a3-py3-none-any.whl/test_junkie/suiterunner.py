...
class TestRunner:
    ...
    @staticmethod
    def __execute_test(suite_object, decorated_function, suite_listener, suite_rules,
    ...
    def __process_decorators(suite_object, **kwargs):
        ...
        suite_rules = suite_object["test_rules"](class_meta=suite_object["class_meta"])
