from ajunit.suiterunner import TestCategories
...
class StatsJunkie:
    ...
    def __get_tests(self, category):
        ...
        __mapping = {TestCategories.SUCCESS: self.__successful_tests,
                     TestCategories.FAIL: self.__failed_tests,
                     TestCategories.ERROR: self.__errored_tests,
                     TestCategories.SKIP: self.__skipped_tests,
                     TestCategories.IGNORE: self.__ignored_tests}
    ...
    def get_failed_tests(self):
        ...
        return self.__get_tests(TestCategories.FAIL)

    def get_errored_tests(self):

        return self.__get_tests(TestCategories.ERROR)

    def get_ignored_tests(self):

        return self.__get_tests(TestCategories.IGNORE)

    def get_skipped_tests(self):

        return self.__get_tests(TestCategories.SKIP)

    def get_passed_tests(self):

        return self.__get_tests(TestCategories.SUCCESS)

    def get_unsuccessful_tests(self):

        unsuccessful_tests = {TestCategories.FAIL: self.get_failed_tests(),
                              TestCategories.ERROR: self.get_errored_tests(),
                              TestCategories.IGNORE: self.get_ignored_tests()}
    ...
    def get_all_tests(self):
        ...
        unsuccessful_tests = {TestCategories.FAIL: self.get_failed_tests(),
                              TestCategories.ERROR: self.get_errored_tests(),
                              TestCategories.IGNORE: self.get_ignored_tests(),
                              TestCategories.SKIP: self.get_skipped_tests(),
                              TestCategories.SUCCESS: self.get_passed_tests()}
    ...
    def get_performance_metrics(self):
        ...
        if self.__performance_metrics is None:
            __per_category = {TestCategories.SUCCESS: {"total": 0, "average": 0, "min": 0, "mean": 0, "max": 0},
                              TestCategories.FAIL: {"total": 0, "average": 0, "min": 0, "mean": 0, "max": 0},
                              TestCategories.ERROR: {"total": 0, "average": 0, "min": 0, "mean": 0, "max": 0},
                              TestCategories.IGNORE: {"total": 0, "average": 0, "min": 0, "mean": 0, "max": 0}}
