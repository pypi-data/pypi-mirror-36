...
class Restore(Base):
    ...
    def _restore_domain_extract_backup(self, domain):
        ...
        if not os.path.isdir(self.backup_folder) or self.single_domain:
            ...
            os.system('chown -h ' + domain.ftp_username + ':' + domain.ftp_username + ' /domains/' + domain.domain_name)
            os.system('chmod 711 /home/' + domain.ftp_username)
            os.system('chmod 755 /home/' + domain.ftp_username + '/' + domain.domain_name)
