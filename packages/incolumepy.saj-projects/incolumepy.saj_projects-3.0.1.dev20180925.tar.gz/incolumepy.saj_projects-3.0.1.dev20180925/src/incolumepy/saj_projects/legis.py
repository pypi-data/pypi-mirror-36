...
class Legis:
    ...
    def meta(self, **kwargs):
        itens = {'numero':None, 'tipo':'decreto', 'ano':datetime.today().strftime('%Y'),
            'situacao':"vigente ou revogado", 'origem':'Poder Executivo', 'chefe_de_governo':'',
            'referenda':'','correlacao': '', 'veto':'', 'fonte':'', 'dataassinatura':'',
            "generator_user":"@britodfbr", 'publisher':'Centro de Estudos Jurídicos da Presidência da República',
            ...
            'revised':datetime.today().strftime('%Y-%m-%d %X %z'),
