...
class PipelineRun(Run):
    ...
    def publish_pipeline(self, name, description, version):
        """
        Publish a pipeline and make it available for rerunning. The original pipeline associated with the
        pipeline_run is used as the base for the published pipeline.
