...
class TemplateReader:
    ...
    def __init__(self, config=None, input_file=io.StringIO(),
        ...
        # we will generate a dataframe which will contain as many columns
        ...
        # for_lines_indexed: each dataframe should have its own for_line_indexed dictionary.
        # We have a number of station, each of which CAN POTENTIALLY have different observables..
    ...
    def __handle_station_column__(self):
        ...
        # Now let's check if we have the columns' case
