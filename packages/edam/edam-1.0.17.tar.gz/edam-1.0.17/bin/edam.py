...
from edam.reader.utilities import check_if_path_exists, identify_input_type, determine_storage_type, backup_ontology
...
@click.option('--metadata', required=True, help='metadata file to annotate data with')
