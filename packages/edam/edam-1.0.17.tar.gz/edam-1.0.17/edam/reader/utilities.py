...
def parse_observables_with_reasoner(observables, template_name):
    ...
    with onto:
        quantity, _, _ = check_if_ontology_class_exists_and_create(ontology=onto.load(), term="http://edam.gr#Observables",
                                                                   belongsTo=Thing)
        gtemplate, _, _ = check_if_ontology_class_exists_and_create(ontology=onto.load(), term="http://edam.gr#Templates",
                                                                    belongsTo=Thing)
            ...
            try:
                ...
                try:
                    ...
                    if qualifier_names_as_string:
                        ...
                        observable_qualifiers_class, _, _ = check_if_ontology_class_exists_and_create(ontology=onto.load(),
                                                                                                      term=combined_class,
...
def check_compatibility_among_templates(source_template, target_template):
    ...
    try:
        ...
        error_to_return = InvalidUsage(status_code=500,
                     message='*%s* template does not exist' % (
                         source_template))
