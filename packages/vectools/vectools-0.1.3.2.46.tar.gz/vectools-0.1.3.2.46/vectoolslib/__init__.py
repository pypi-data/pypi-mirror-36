...
'''
    "Graph Operations": {
        "edges":       "vectoolslib.graph.list_edges",
        "gsearch":     "vectoolslib.graph.graph_search",
        "addedge":     "vectoolslib.graph.add_edge",
        "addnode":     "vectoolslib.graph.add_node",
        "paths":       "vectoolslib.graph.list_paths",
        "graphformat": "vectoolslib.graph.graph_format",
    }
'''