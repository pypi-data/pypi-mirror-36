...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'be-tarask', 'bn', 'ml', 'af', 'jv', 'lb', 'ht', 'sco', 'mr', 'ga',
        'pnb', 'is', 'sw', 'ba', 'cv', 'fy', 'su', 'my', 'lmo', 'an', 'yo',
        'nds', 'ne', 'pa', 'gu', 'io', 'bar', 'scn', 'bpy', 'als', 'kn', 'ku',
        'ckb', 'qu', 'ia', 'arz', 'mn', 'bat-smg', 'si', 'gd', 'wa', 'nap',
        'yi', 'am', 'or', 'bug', 'cdo', 'map-bms', 'hsb', 'mai', 'fo', 'mzn',
        'xmf', 'wuu', 'li', 'sah', 'ilo', 'sa', 'vec', 'eml', 'os', 'sd',
        'mrj', 'mhr', 'hif', 'roa-tara', 'ps', 'diq', 'hak', 'pam',
        'zh-classical', 'bcl', 'nso', 'frr', 'bh', 'szl', 'ace', 'se', 'mi',
        'nah', 'nds-nl', 'km', 'rue', 'vls', 'gan', 'nv', 'crh', 'sc', 'bo',
        'vep', 'so', 'glk', 'co', 'tk', 'fiu-vro', 'lrc', 'myv', 'kv', 'csb',
        'as', 'gv', 'udm', 'zea', 'ay', 'ug', 'ie', 'nrm', 'stq', 'lez', 'sn',
        'kw', 'lad', 'pcd', 'mwl', 'gn', 'rm', 'gom', 'koi', 'ab', 'lij', 'mt',
        'fur', 'dsb', 'frp', 'ln', 'ang', 'dv', 'ext', 'cbk-zam', 'lo', 'haw',
        'dty', 'kab', 'lfn', 'ksh', 'gag', 'olo', 'pag', 'pi', 'av', 'pfl',
        'bxr', 'xal', 'krc', 'pap', 'ha', 'kaa', 'za', 'bjn', 'pdc', 'rw',
        'gor', 'tyv', 'to', 'nov', 'kl', 'jam', 'arc', 'kbd', 'tpi', 'kbp',
        'tet', 'ki', 'ig', 'na', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf', 'kg',
        'bi', 'wo', 'lg', 'srn', 'zu', 'tcy', 'chr', 'ltg', 'sm', 'inh', 'om',
        'xh', 'pih', 'cu', 'rmy', 'tw', 'bm', 'tn', 'rn', 'chy', 'atj', 'got',
        'tum', 'ts', 'ak', 'st', 'ch', 'pnt', 'ss', 'fj', 'ny', 'ady', 'iu',
        'sat', 'ee', 'ks', 've', 'ik', 'sg', 'ff', 'dz', 'ti', 'cr', 'din',
    ]
