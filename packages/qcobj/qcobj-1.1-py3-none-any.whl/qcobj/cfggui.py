...
from qcobj.qconfigobj import (QConfigObj, Certifier, ValidateError, Q_,
...
#==============================================================================
class CfgGui(QtWidgets.QMainWindow):
    def __init__(self, opts):
        ...
        if opts.configspec is None:
            # Load configspec
            self._configSpec = getOpenFileNames(self,
    ...
    def _loadQCobjs(self, pn):
        ...
        allCfgWidget = QtWidgets.QWidget()
