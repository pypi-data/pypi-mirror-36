...
def enqueue_tpu_embedding_integer_batch(batch, device_ordinal=-1, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx._post_execution_callbacks, batch, "device_ordinal",
        device_ordinal)
      return _result
    except _core._FallbackException:
      return enqueue_tpu_embedding_integer_batch_eager_fallback(
          batch, device_ordinal=device_ordinal, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
      else:
...
def enqueue_tpu_embedding_integer_batch_eager_fallback(batch, device_ordinal=-1, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def enqueue_tpu_embedding_sparse_batch(sample_indices, embedding_indices, aggregation_weights, device_ordinal=-1, combiners=[], name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        aggregation_weights, "device_ordinal", device_ordinal, "combiners",
        combiners)
      return _result
    except _core._FallbackException:
...
def enqueue_tpu_embedding_sparse_batch_eager_fallback(sample_indices, embedding_indices, aggregation_weights, device_ordinal=-1, combiners=[], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def enqueue_tpu_embedding_sparse_tensor_batch(sample_indices, embedding_indices, aggregation_weights, table_ids, device_ordinal=-1, combiners=[], name=None):
  ...
  Args:
    sample_indices: A list of at least 1 `Tensor` objects with type `int32`.
      A list of Rank 1 Tensors, corresponds to sp_ids.indices[:,0] in
      embedding_lookup_sparse().
    embedding_indices: A list with the same length as `sample_indices` of `Tensor` objects with type `int32`.
      A list of Rank 1 Tensors, corresponds to sp_ids.values
      in embedding_lookup_sparse().
    aggregation_weights: A list with the same length as `sample_indices` of `Tensor` objects with type `float32`.
      A list of Rank 1 Tensors, corresponds to sp_weights.values
      in embedding_lookup_sparse().
    table_ids: A list of `ints`.
      A list of int. table_ids[i] indicates which embedding table to look
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        embedding_indices=embedding_indices,
        aggregation_weights=aggregation_weights, table_ids=table_ids,
        device_ordinal=device_ordinal, combiners=combiners, name=name)
    return _op
    _result = None
    return _result
...
def enqueue_tpu_embedding_sparse_tensor_batch_eager_fallback(sample_indices, embedding_indices, aggregation_weights, table_ids, device_ordinal=-1, combiners=[], name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_adam_parameters(parameters, momenta, velocities, table_name, num_shards, shard_id, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        momenta=momenta, velocities=velocities, table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    return _op
    _result = None
    return _result
    ...
    try:
      ...
      return load_tpu_embedding_adam_parameters_eager_fallback(
          parameters, momenta, velocities, table_name=table_name,
...
def load_tpu_embedding_adam_parameters_eager_fallback(parameters, momenta, velocities, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  ...
  _attrs = ("table_name", table_name, "num_shards", num_shards, "shard_id",
  shard_id)
...
def load_tpu_embedding_adam_parameters_grad_accum_debug(parameters, momenta, velocities, gradient_accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        gradient_accumulators=gradient_accumulators, table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    return _op
    _result = None
    return _result
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx._post_execution_callbacks, parameters, momenta, velocities,
        gradient_accumulators, "table_name", table_name, "num_shards",
...
def load_tpu_embedding_adam_parameters_grad_accum_debug_eager_fallback(parameters, momenta, velocities, gradient_accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_adadelta_parameters(parameters, accumulators, updates, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        accumulators=accumulators, updates=updates, table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    return _op
    _result = None
    return _result
    ...
    try:
      ...
      return load_tpu_embedding_adadelta_parameters_eager_fallback(
          parameters, accumulators, updates, table_name=table_name,
          num_shards=num_shards, shard_id=shard_id, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def load_tpu_embedding_adadelta_parameters_eager_fallback(parameters, accumulators, updates, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_adadelta_parameters_grad_accum_debug(parameters, accumulators, updates, gradient_accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
...
def load_tpu_embedding_adadelta_parameters_grad_accum_debug_eager_fallback(parameters, accumulators, updates, gradient_accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_adagrad_parameters(parameters, accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        accumulators=accumulators, table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    return _op
    _result = None
    return _result
    ...
    try:
      ...
      return load_tpu_embedding_adagrad_parameters_eager_fallback(
          parameters, accumulators, table_name=table_name,
          num_shards=num_shards, shard_id=shard_id, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def load_tpu_embedding_adagrad_parameters_eager_fallback(parameters, accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_adagrad_parameters_grad_accum_debug(parameters, accumulators, gradient_accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
...
def load_tpu_embedding_adagrad_parameters_grad_accum_debug_eager_fallback(parameters, accumulators, gradient_accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_centered_rms_prop_parameters(parameters, ms, mom, mg, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        ms=ms, mom=mom, mg=mg, table_name=table_name, num_shards=num_shards,
...
def load_tpu_embedding_centered_rms_prop_parameters_eager_fallback(parameters, ms, mom, mg, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_ftrl_parameters(parameters, accumulators, linears, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        accumulators=accumulators, linears=linears, table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    return _op
    _result = None
    return _result
    ...
    try:
      ...
      return load_tpu_embedding_ftrl_parameters_eager_fallback(
          parameters, accumulators, linears, table_name=table_name,
          num_shards=num_shards, shard_id=shard_id, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def load_tpu_embedding_ftrl_parameters_eager_fallback(parameters, accumulators, linears, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_ftrl_parameters_grad_accum_debug(parameters, accumulators, linears, gradient_accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
...
def load_tpu_embedding_ftrl_parameters_grad_accum_debug_eager_fallback(parameters, accumulators, linears, gradient_accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_mdl_adagrad_light_parameters(parameters, accumulators, weights, benefits, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        benefits, "table_name", table_name, "num_shards", num_shards,
        "shard_id", shard_id)
      return _result
    except _core._FallbackException:
      return load_tpu_embedding_mdl_adagrad_light_parameters_eager_fallback(
          parameters, accumulators, weights, benefits, table_name=table_name,
          num_shards=num_shards, shard_id=shard_id, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def load_tpu_embedding_mdl_adagrad_light_parameters_eager_fallback(parameters, accumulators, weights, benefits, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_momentum_parameters(parameters, momenta, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        momenta=momenta, table_name=table_name, num_shards=num_shards,
        shard_id=shard_id, name=name)
    return _op
    _result = None
    return _result
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx._post_execution_callbacks, parameters, momenta, "table_name",
        table_name, "num_shards", num_shards, "shard_id", shard_id)
      return _result
    except _core._FallbackException:
      return load_tpu_embedding_momentum_parameters_eager_fallback(
          parameters, momenta, table_name=table_name, num_shards=num_shards,
...
def load_tpu_embedding_momentum_parameters_eager_fallback(parameters, momenta, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_momentum_parameters_grad_accum_debug(parameters, momenta, gradient_accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      ...
      return load_tpu_embedding_momentum_parameters_grad_accum_debug_eager_fallback(
          parameters, momenta, gradient_accumulators, table_name=table_name,
          num_shards=num_shards, shard_id=shard_id, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def load_tpu_embedding_momentum_parameters_grad_accum_debug_eager_fallback(parameters, momenta, gradient_accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_proximal_adagrad_parameters(parameters, accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
...
def load_tpu_embedding_proximal_adagrad_parameters_eager_fallback(parameters, accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_proximal_adagrad_parameters_grad_accum_debug(parameters, accumulators, gradient_accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
...
def load_tpu_embedding_proximal_adagrad_parameters_grad_accum_debug_eager_fallback(parameters, accumulators, gradient_accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_rms_prop_parameters(parameters, ms, mom, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        mom=mom, table_name=table_name, num_shards=num_shards,
        shard_id=shard_id, name=name)
    return _op
    _result = None
    return _result
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx._post_execution_callbacks, parameters, ms, mom, "table_name",
        table_name, "num_shards", num_shards, "shard_id", shard_id)
      return _result
    except _core._FallbackException:
      return load_tpu_embedding_rms_prop_parameters_eager_fallback(
          parameters, ms, mom, table_name=table_name, num_shards=num_shards,
          shard_id=shard_id, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def load_tpu_embedding_rms_prop_parameters_eager_fallback(parameters, ms, mom, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_rms_prop_parameters_grad_accum_debug(parameters, ms, mom, gradient_accumulators, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    try:
      ...
      return load_tpu_embedding_rms_prop_parameters_grad_accum_debug_eager_fallback(
          parameters, ms, mom, gradient_accumulators, table_name=table_name,
          num_shards=num_shards, shard_id=shard_id, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def load_tpu_embedding_rms_prop_parameters_grad_accum_debug_eager_fallback(parameters, ms, mom, gradient_accumulators, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def load_tpu_embedding_stochastic_gradient_descent_parameters(parameters, table_name, num_shards, shard_id, name=None):
  r"""Load embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    _, _, _op = _op_def_lib._apply_op_helper(
        ...
        parameters=parameters, table_name=table_name, num_shards=num_shards,
        shard_id=shard_id, name=name)
    return _op
    _result = None
    return _result
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx._post_execution_callbacks, parameters, "table_name", table_name,
        "num_shards", num_shards, "shard_id", shard_id)
      return _result
    except _core._FallbackException:
      return load_tpu_embedding_stochastic_gradient_descent_parameters_eager_fallback(
          parameters, table_name=table_name, num_shards=num_shards,
          shard_id=shard_id, name=name, ctx=_ctx)
    except _core._NotOkStatusException as e:
      if name is not None:
        message = e.message + " name: " + name
...
def load_tpu_embedding_stochastic_gradient_descent_parameters_eager_fallback(parameters, table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_adam_parameters(table_name, num_shards, shard_id, name=None):
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    shard_id = _execute.make_int(shard_id, "shard_id")
    _, _, _op = _op_def_lib._apply_op_helper(
        "RetrieveTPUEmbeddingADAMParameters", table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("table_name", _op.get_attr("table_name"), "num_shards",
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx._post_execution_callbacks, "table_name", table_name,
        "num_shards", num_shards, "shard_id", shard_id)
      _result = _RetrieveTPUEmbeddingADAMParametersOutput._make(_result)
      return _result
    except _core._FallbackException:
...
def retrieve_tpu_embedding_adam_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_adam_parameters_grad_accum_debug(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_adam_parameters_grad_accum_debug_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_adadelta_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    shard_id = _execute.make_int(shard_id, "shard_id")
    _, _, _op = _op_def_lib._apply_op_helper(
        "RetrieveTPUEmbeddingAdadeltaParameters", table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("table_name", _op.get_attr("table_name"), "num_shards",
...
def retrieve_tpu_embedding_adadelta_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_adadelta_parameters_grad_accum_debug(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_adadelta_parameters_grad_accum_debug_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_adagrad_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    shard_id = _execute.make_int(shard_id, "shard_id")
    _, _, _op = _op_def_lib._apply_op_helper(
        "RetrieveTPUEmbeddingAdagradParameters", table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("table_name", _op.get_attr("table_name"), "num_shards",
...
def retrieve_tpu_embedding_adagrad_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_adagrad_parameters_grad_accum_debug(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_adagrad_parameters_grad_accum_debug_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_centered_rms_prop_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_centered_rms_prop_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_ftrl_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    shard_id = _execute.make_int(shard_id, "shard_id")
    _, _, _op = _op_def_lib._apply_op_helper(
        "RetrieveTPUEmbeddingFTRLParameters", table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("table_name", _op.get_attr("table_name"), "num_shards",
...
def retrieve_tpu_embedding_ftrl_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_ftrl_parameters_grad_accum_debug(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_ftrl_parameters_grad_accum_debug_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_mdl_adagrad_light_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_mdl_adagrad_light_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_momentum_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    shard_id = _execute.make_int(shard_id, "shard_id")
    _, _, _op = _op_def_lib._apply_op_helper(
        "RetrieveTPUEmbeddingMomentumParameters", table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("table_name", _op.get_attr("table_name"), "num_shards",
...
def retrieve_tpu_embedding_momentum_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_momentum_parameters_grad_accum_debug(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_momentum_parameters_grad_accum_debug_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_proximal_adagrad_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_proximal_adagrad_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_proximal_adagrad_parameters_grad_accum_debug(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_proximal_adagrad_parameters_grad_accum_debug_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_rms_prop_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
  ...
  if _ctx is None or not _ctx._eager_context.is_eager:
    ...
    shard_id = _execute.make_int(shard_id, "shard_id")
    _, _, _op = _op_def_lib._apply_op_helper(
        "RetrieveTPUEmbeddingRMSPropParameters", table_name=table_name,
        num_shards=num_shards, shard_id=shard_id, name=name)
    _result = _op.outputs[:]
    _inputs_flat = _op.inputs
    _attrs = ("table_name", _op.get_attr("table_name"), "num_shards",
...
def retrieve_tpu_embedding_rms_prop_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_rms_prop_parameters_grad_accum_debug(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_rms_prop_parameters_grad_accum_debug_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def retrieve_tpu_embedding_stochastic_gradient_descent_parameters(table_name, num_shards, shard_id, name=None):
  r"""Retrieve embedding parameters for a single table.
...
def retrieve_tpu_embedding_stochastic_gradient_descent_parameters_eager_fallback(table_name, num_shards, shard_id, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
