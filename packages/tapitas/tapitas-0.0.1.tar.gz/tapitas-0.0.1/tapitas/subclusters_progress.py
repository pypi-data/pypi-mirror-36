...
class Point_Diffusion(object):
    def __init__(self, ptdataframe, pts_setting=None, s_radius=500, T1=12, T2=27, resample_time=99, confidence_level=0.8, critical_value=None):
        ...
        self.progression = Diffusion_Progress( self.ptdataframe, self.pts_setting, self.s_radius, self.T1, self.T2, self.resample_time, self.confidence_level, self.critical_value )
