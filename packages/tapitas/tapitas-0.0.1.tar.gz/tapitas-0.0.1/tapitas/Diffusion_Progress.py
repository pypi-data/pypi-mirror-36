...
class Diffusion_Progress(object):
    def __init__(self, ptdataframe, pts_setting, s_radius, T1, T2, resample_time, confidence_level, critical_value):
        self.T1 = T1
        self.T2 = T2
        ...
        self._subcluster_detection() # can run after nlinks are finalized
        self._find_progression_links() # can run after slinks are finalized
        self.chain_list_full = None
        self.long_chains = None
        self.isolated_clusters = None
        self._get_progression_chain()
    ...
    def _get_points(self, pts, pts_setting):
    ...
    def _make_links(self, s_radius, T1, T2):
        self.sg.prepare(s_radius, T2)
        self.sg.find_links(s_radius, T1, T2)

    def _subcluster_detection(self):
    ...
    def _find_progression_links(self):
    ...
    def _get_progression_chain(self):
