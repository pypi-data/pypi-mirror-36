...
class APIHelper(object):
    ...
    def smtp_mailer(self,mailhost, port, username, password, fromaddr, toaddrs, msg,isthread = False):  
        """
        ...
        email becuase the handler picks up the error and it causes an error loop
        """
    ...
    def create_message_with_attachment(self,fromaddr,toaddr,subject,htmlbody,plainbody,documents,ccaddr=None,bccaddr=None,replytoaddr=None):  
        """
        ...
        #Create the 'alternative' message container for the html and alternate text
    ...
    def generic_get(self,url):
        ...
        try:
            response = self.api_client.call_api(resource_path, 'GET',
                ...
                post_params=form_params,files=local_var_files,
