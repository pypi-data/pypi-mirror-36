...
class CRMTools(object):
    ...
    def process_changed_work_requests(self):
        ...
        Returned: 0=success, else error
        """
        # get CRM's from CRM that are still active - this should be efficient
        ...
        chk = self.apply_wo_status_comment(crms, active_crm_wr_guid_list)
        ...
        for wr in wrs:
            ...
            if wr["WRCreatedDateTime"] != wr["WRLastModified"]:
                ...
                if wr["WRStatus"] in self._close_crm_statuses:
                    ...
                    # is returned - removed - not sure of this logic
                ...
                if self._wr_supporting_info_to_crm:
                    ...
                    try:
                        info = self.get_wr_comments_in_range(
                ...
                if crm:
                    if new_note is not None:
                        ...
                        self.crm_tools.add_task_note_to_crm(
                            new_note, crm.crm_representation)
            ...
            for wr in wo["LinkedWorkRequests"]:
                ...
                if wo["Id"] in wos_new_status or len(new_comments) > 0:
                    ...
                    if new_note is not None:
                        ...
                        new_note = "[{0}]".format(new_note)
                        self.crm_tools.add_task_note_to_crm(
                            new_note.strip(), crm.crm_representation)
