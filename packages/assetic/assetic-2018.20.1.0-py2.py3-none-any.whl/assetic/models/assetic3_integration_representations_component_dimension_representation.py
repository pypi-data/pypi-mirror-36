...
class Assetic3IntegrationRepresentationsComponentDimensionRepresentation(object):
    ...
    def __init__(self, id=None, dimension_id=None, record_type=None, network_measure=None, unit=None, multiplier=None, network_measure_type=None, comments=None, network_measure_sub_total=None, message=None, component_id=None, asset_id=None, last_modified_on=None, last_modified_by=None, links=None, embedded=None):  # noqa: E501
