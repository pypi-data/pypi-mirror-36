...
from bayes_opt.evaluators import FunctionEvaluator, AsyncLocalEvaluator, AsyncSbatchEvaluator
...
if __name__ == "__main__":
    ...
    fh = logging.FileHandler('example3_log_{}.log'.format(time.strftime("%Y.%m.%d-%H%M%S")), mode='a')
