...
def convert_to_uint160(value):
    ...
    Note: the return value is not really 160 bits, nor is it of the kazecore.UInt160 type
...
def convert_to_uint256(value):
    ...
    Note: the return value is not really 256 bits, nor is it of the kazecore.UInt256 type
...
class BinaryWriter(object):
    ...
    def __init__(self, stream):
        ...
        Args:
            stream (BytesIO): a stream to operate on. i.e. a kaze.IO.MemoryStream or raw BytesIO.
        """
    ...
    def WriteUInt160(self, value):
        ...
        Raises:
            Exception: when `value` is not of kazecore.UInt160 type.
        """
    ...
    def WriteUInt256(self, value):
        ...
        Raises:
            Exception: when `value` is not of kazecore.UInt256 type.
        """
    ...
    def WriteVarInt(self, value, endian="<"):
        ...
        Read more about variable size encoding here: http://docs.kaze.org/en-us/node/network-protocol.html#convention
    ...
    def WriteSerializableArray(self, array):
        ...
        Args:
            array(list): a list of serializable objects. i.e. extending kaze.IO.Mixins.SerializableMixin
        """
        if array is None:
            self.WriteByte(0)
        else:
