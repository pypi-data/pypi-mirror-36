...
from kazecore import __version__
...
def address_to_scripthash(address):
    ...
    is_correct_signature = data[0] != 0x2d if isinstance(data[0], bytes) else b'\x2d'
...
def main():
    ...
    parser.add_argument("--version", action="version",
                        version="kazecore v{version}".format(version=__version__))
    ...
    if args.address_to_scripthash:
        try:
            ...
            print("Scripthash kaze-python format: {!r}".format(scripthash))
