...
from kazecore.UIntBase import UIntBase
...
class Fixed8TestCase(TestCase):
    ...
    def test_fixed8_tojsonstring(self):
        ...
        self.assertEqual("1", f8.ToKazeJsonString())
        f8 = Fixed8.FromDecimal(1.10)
        self.assertEqual("1.1", f8.ToKazeJsonString())
        f8 = Fixed8.FromDecimal(10)
        self.assertEqual("10", f8.ToKazeJsonString())
        f8 = Fixed8.FromDecimal(100)
        self.assertEqual("100", f8.ToKazeJsonString())

        f8 = Fixed8.FromDecimal(2609.997813)
        self.assertEqual("2609.997813", f8.ToKazeJsonString())
