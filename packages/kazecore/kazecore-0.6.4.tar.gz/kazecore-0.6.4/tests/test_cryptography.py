...
from kazecore.Cryptography import Helper
...
class TestCrypto(TestCase):
    ...
    def test_script_hash(self):
        ...
        # using https://github.com/KAZEBLOCKCHAIN/kazen-wallet-react-native/blob/master/app/api/crypto/index.js
    ...
    @patch('kazecore.Cryptography.Crypto.logger')
