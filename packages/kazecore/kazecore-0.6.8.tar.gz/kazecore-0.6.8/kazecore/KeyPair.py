...
from kazecore.Cryptography.Helper import xor_bytes

# NEP-2 constants
# https://github.com/kaze-project/proposals/blob/master/nep-2.mediawiki
...
class KeyPair(object):
    ...
    def GetAddress(self):
        """
        Returns the public KAZE address for this KeyPair
