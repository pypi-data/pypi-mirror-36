# -*- coding: utf8 -*-
import click
from missinglink.commands.commons import add_to_data_if_not_none, create_validate_length, output_result
...
@CommonOptions.alert_type_option(required=True, multiple=True)
@click.pass_context
def unsubscribe_alert(ctx, project_id, alert_type):
    data = {
        'alert_types': alert_type,
...
@click.option(
    '--display-name', required=True, callback=create_validate_length(min_project_display_name, max_project_display_name))
@click.option(
