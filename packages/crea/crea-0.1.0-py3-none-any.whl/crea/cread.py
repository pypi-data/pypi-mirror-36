...
from creabase.chains import known_chains
from creabase.http_client import HttpClient
from creabase.storage import configStorage
from creabase.transactions import SignedTransaction
from creabase.types import PointInTime
...
class Cread(HttpClient):
    ...
    def __init__(self, nodes=None, **kwargs):
        if not nodes:
            nodes = get_config_node_list() or ['https://cread.creativechain.net']

        super(Cread, self).__init__(nodes, **kwargs)
    ...
    def get_replies(self, author, skip_own=True):
        ...
        for reply in replies:
            ...
            if skip_own and post["author"] == author:
                continue
            discussions.append(Post(post, cread_instance=self))
        return discussions
    ...
    def get_promoted(self):
        ...
        for p in promoted:
            ...
            r.append(Post(post, cread_instance=self))
        return r
    ...
    def get_posts(self, limit=10, sort="hot", category=None, start=None):
        ...
        for p in func(discussion_query):
            r.append(Post(p, cread_instance=self))
        return r
    ...
    def stream_comments(self, *args, **kwargs):
        ...
        for c in Blockchain(
            ...
            yield Post(c, cread_instance=self)
    ...
    def get_account(self, account):
        ...
        Args:
            account (str): CREA username that we are looking up.
    ...
    def get_all_usernames(self, last_user=''):
        """ Fetch the full list of CREA usernames. """
    ...
    def _get_blocks(self, blocks):
        """ Fetch multiple blocks from cread at once.
    ...
    def get_blocks(self, block_nums):
        """ Fetch multiple blocks from cread at once, given a range.
        ...
        Example:
            ...
            ::
                ...
                {'content_constant': '2000000000000',
                 ...
                 'reward_balance': '555660.895 CREA'}
    ...
    def get_chain_properties(self):
        ...
        ::
            ...
            {'account_creation_fee': '30.000 CREA',
             ...
             'cbd_interest_rate': 250}

        """
        return self.call('get_chain_properties', api='database_api')

    def get_feed_history(self):
        """ Get the hourly averages of witness reported CREA/CBD prices.

        ::

            {'current_median_history':
                {'base': '0.093 CBD', 'quote': '1.010 CREA'},
             'id': 0,
             'price_history': [{'base': '0.092 CBD', 'quote': '1.010 CREA'},
              {'base': '0.093 CBD', 'quote': '1.020 CREA'},
              {'base': '0.093 CBD', 'quote': '1.010 CREA'},
              {'base': '0.094 CBD', 'quote': '1.020 CREA'},
              {'base': '0.093 CBD', 'quote': '1.010 CREA'},
    ...
    def get_current_median_history_price(self):
        """ Get the average CREA/CBD price.
    ...
    def get_account_count(self):
        """ How many accounts are currently registered on CREA? """
    ...
    def get_account_history(self, account, index_from, limit):
        ...
        Example:
           ...
           ``jared``, we should set the ``index_from`` to -1.  This is the
           same as saying `give me the highest index there is`.

           .. code-block :: python

              s.get_account_history('jared', index_from=-1, limit=3)
           ...
           .. code-block:: python
              ...
              s.get_account_history('jared', index_from=100, limit=100)

           We can get the next 100 items by running:

           .. code-block:: python

              s.get_account_history('jared', index_from=200, limit=100)
    ...
    def get_active_votes(self, author, permlink):
        ...
        Example:
            .. code-block:: python
               ...
               s.get_active_votes('freedomfirst',
               'test-post')
    ...
    def get_version(self):
        """ Get cread version of the node currently connected to. """
    ...
    def get_ticker(self):
        """ Returns the market ticker for the internal CBD:CREA market. """
    ...
    def get_trade_history(self, start, end,
                          limit):
        """ Returns the trade history for the internal CBD:CREA market. """
        return self.call(
            'get_trade_history', start, end, limit, api='market_history_api')

    def get_recent_trades(self, limit):
        """ Returns the N most recent trades for the internal CBD:CREA
        market. """
    ...
    def get_market_history(self, bucket_seconds, start,
        ...
        """ Returns the market history for the internal CBD:CREA market. """
        return self.call(
            'get_market_history',
            bucket_seconds,
            start,
