...
from .Run import Model_Runner_Main,Model_Runner_Funcional_Web
    ...
    def __init__(self,Server):
        ...
        if(jsons["tipo"]=="Funcional-web"):
            ...
            for jsos in jsons:
                if jsos=='path':
                    path=jsons[jsos]
            modelo=Model_Runner_Main.preparar_main(jsons,path=path)
            Model_Runner_Main.runner(modelo,jsons["tipo"])
...
class Controler_Runner():
    def __init__(self,Folder,Imagem):
        self.container=Model_Runner_Funcional_Web(Folder,Imagem)