...
class Nadam(Optimizer):
    ...
    def __init__(self, # pylint: disable=too-many-arguments,too-many-locals
                 params, lr=2e-3, betas=(0.9, 0.999), eps=1e-8,
    ...
    def step(self, closure=None): # pylint: disable=too-many-locals
        ...
        for group in self.param_groups:
            for param in group['params']:
                ...
                if len(state) == 0: # pylint: disable=len-as-condition
                    state['step'] = 0
                    state['m_schedule'] = 1.
                ...
                momentum_cache_t = beta1 * \
                    (1. - 0.5 * (0.96 ** (step * schedule_decay)))
                momentum_cache_t_1 = beta1 * \
                    (1. - 0.5 * (0.96 ** ((step + 1) * schedule_decay)))
                ...
                exp_avg_sq_prime = exp_avg_sq / (1. - beta2 ** step)
