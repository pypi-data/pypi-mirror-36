...
class ContextBroker(models.Model):
    ...
    url = models.URLField()
    oauth_enable = models.BooleanField()
    oauth_url = models.URLField()
    oauth_user = models.CharField(unique=True, max_length=50)
    oauth_password = models.CharField(unique=True, max_length=50)
    oauth_client_id = models.CharField(unique=True, max_length=50)
    oauth_client_secret = models.CharField(unique=True, max_length=50)
    oauth_access_token = models.CharField(unique=True, max_length=50)
    oauth_refresh_token = models.CharField(unique=True, max_length=50)

    @property
    def oauth_manager(self):
        return self.oauth_enable or OAuthManager(
