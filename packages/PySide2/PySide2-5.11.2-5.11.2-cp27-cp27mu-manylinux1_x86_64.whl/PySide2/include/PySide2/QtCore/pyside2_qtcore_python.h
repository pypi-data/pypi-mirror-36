...
#define SBK_QUINTPTR_IDX                                             6
#define SBK_QSTRINGREF_IDX                                           7
...
#define SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                          38 // const QHash<int,QByteArray > &
#define SBK_QTCORE_QMAP_INT_QVARIANT_IDX                             39 // QMap<int,QVariant >
#define SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX                   40 // const QList<QPersistentModelIndex > &
#define SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX      41 // QList<QAbstractEventDispatcher::TimerInfo >
