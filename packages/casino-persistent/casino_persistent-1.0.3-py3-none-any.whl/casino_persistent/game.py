...
from sqlalchemy import String, Column, JSON, BigInteger, ForeignKey, Integer, ARRAY, Text
...
class Game(BaseEntity, CasinoPersistent.get_db().Model):
    ...
    panels = relationship("Panel", backref=CasinoPersistent.get_db().backref('games', lazy=True))
