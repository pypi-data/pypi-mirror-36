...
>>> m
MsgTestCaseSkip(_api_version = 1.2.9, description = Skip testcase, node = someNode, testcase_id = some_testcase_id, )
>>> m.routing_key
...
>>> m
MsgTestCaseSkip(_api_version = 1.2.9, description = Skip testcase, node = someNode, testcase_id = TD_COAP_CORE_03, )
>>> m.testcase_id
'TD_COAP_CORE_03'

# and even export the message in json format (for example for sending the message though the amqp event bus)
>>> m.to_json()
'{"_api_version": "1.2.9", "description": "Skip testcase", "node": "someNode", "testcase_id": "TD_COAP_CORE_03"}'
...
'testsuite.start'
>>> m.to_json()
'{"_api_version": "1.2.9", "description": "Test suite START command"}'
>>> json_message = m.to_json()
>>> obj=Message.load(json_message,'testsuite.start', None )
>>> obj
MsgTestSuiteStart(_api_version = 1.2.9, description = Test suite START command, )
...
>>> err = MsgErrorReply(m)
>>> err
MsgErrorReply(_api_version = 1.2.9, error_code = None, error_message = None, ok = False, )
...
>>> m.to_json()
'{"_api_version": "1.2.9", "capture_id": "TD_COAP_CORE_01"}'
>>> json_message = m.to_json()
>>> json_message
'{"_api_version": "1.2.9", "capture_id": "TD_COAP_CORE_01"}'
>>> obj=Message.load(json_message,'testsuite.start', None )
...
[User input] trying to send message: MsgTestSuiteGetTestCases(_api_version = 1.2.9, )
Sending message..
...
[log][test_coordinator|amqp_connector] PUBLISHING to routing_key: testsuite.testcases.list.reply, msg: MsgReply(_api_version = 1.2.9, ok = True, tc_list = [OrderedDict([('te
...
[User input] trying to send message: MsgAgentTunStart(_api_version = 1.2.9, ipv4_host = None, ipv4_netmask = None, ipv4_network = None, ipv6_host = :3, ipv6_no_forwarding = False, ipv6_prefix = bbbb, name = agent_TT, re_route_packets_host = None, re_route_packets_if = None, re_route_packets_prefix = None, )
Sending message..
...
------------------------------------------------------------------------------------------------------------------------
{
    ...
    "component": "test_coordinator|amqp_connector",
    "content_type": "application/json",
    "message": "PUBLISHING to routing_key: testsuite.testcases.list.reply, msg: MsgReply(_api_version = 1.2.9, ok = True, tc_list = [OrderedDict([('te"
}
------------------------------------------------------------------------------------------------------------------------
