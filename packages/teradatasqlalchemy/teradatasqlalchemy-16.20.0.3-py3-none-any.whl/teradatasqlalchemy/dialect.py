...
from teradatasqlalchemy.compiler import TeradataCompiler, TeradataDDLCompiler, TeradataTypeCompiler
from teradatasqlalchemy.base import TeradataIdentifierPreparer, TeradataExecutionContext
#from teradatasqlalchemy.data_type_converter import TDDataTypeConverter
...
class TeradataDialect(default.DefaultDialect):
    ...
    def get_columns(self, connection, table_name, schema=None, **kw):
        ...
        # If this is a view, get types for individual columns
        if helpView:
