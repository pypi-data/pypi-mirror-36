...
def class_builder():
    ...
    eta_class = [f.bold("ETA CLASS, FALL 2019: "), 'Ajay Merchia', 'Anand Chandra', 'Andres Medrano', 'Anika Bagga', 'Anmol Parande', 'Austin Davis', 'Brandon David', 'Isabella Lau', 'Jaiveer Singh', 'Kayli Jiang', 'Kiana Go', 'Michelle Mao', 'Sai Yandapalli', 'Shomil Jain', 'Shuba Javannatha', 'Vaibhav Gattani']
