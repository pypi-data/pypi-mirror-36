// Transcrypt'ed from Python, 2018-09-16 20:42:04
...
export var run = function (autoTester) {
	...
	__call__ (autoTester.check, autoTester, __truediv__ (m0, m1));
	__call__ (autoTester.check, autoTester, __floordiv__ (m0, m1));
	var fast2 = 16 * y + 1;
	fast *= 2;
