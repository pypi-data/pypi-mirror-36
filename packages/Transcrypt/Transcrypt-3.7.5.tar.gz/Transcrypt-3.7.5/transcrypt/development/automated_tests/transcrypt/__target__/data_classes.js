// Transcrypt'ed from Python, 2018-09-16 20:42:08
...
export var run = function (autoTester) {
	...
	__call__ (autoTester.check, autoTester, __eq__ (c, cc));
	__call__ (autoTester.check, autoTester, __ne__ (c, cc));
	__call__ (autoTester.check, autoTester, __lt__ (c, cc));
	__call__ (autoTester.check, autoTester, __gt__ (c, cc));
	__call__ (autoTester.check, autoTester, __le__ (c, cc));
	__call__ (autoTester.check, autoTester, __ge__ (c, cc));
	__call__ (autoTester.check, autoTester, __eq__ (c, c));
	__call__ (autoTester.check, autoTester, __ne__ (c, c));
	__call__ (autoTester.check, autoTester, __lt__ (c, c));
	__call__ (autoTester.check, autoTester, __gt__ (c, c));
	__call__ (autoTester.check, autoTester, __le__ (c, c));
	__call__ (autoTester.check, autoTester, __ge__ (c, c));
	var d3 = __call__ (D, null);
	var d1 = __call__ (D, null);
	var d2 = __call__ (D, null);
	__call__ (autoTester.check, autoTester, __call__ (repr, null, d1));
	__call__ (autoTester.check, autoTester, d3, d1, __gt__ (d3, d1));
	__call__ (autoTester.check, autoTester, d2, d1, __gt__ (d2, d1));
	__call__ (autoTester.check, autoTester, d3, d2, __gt__ (d3, d2));
	var ccc = __call__ (C.CC, C);
	__call__ (autoTester.check, autoTester, ccc.n, ccc.p, ccc.q, ccc.k, ccc.l);
};
export {};
