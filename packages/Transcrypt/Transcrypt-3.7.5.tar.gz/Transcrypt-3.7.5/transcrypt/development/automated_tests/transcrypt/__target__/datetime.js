// Transcrypt'ed from Python, 2018-09-16 20:42:05
...
export var _check_utc_offset = function (py_name, offset) {
	...
	if (!((__lt__ (__neg__ (__call__ (timedelta, null, 1)), offset) && __lt__ (offset, __call__ (timedelta, null, 1))))) {
		var __except0__ = __call__ (ValueError, null, __call__ ('{}()={}, must be must be strictly between -timedelta(hours=24) and timedelta(hours=24)'.format, '{}()={}, must be must be strictly between -timedelta(hours=24) and timedelta(hours=24)', py_name, offset));
		__except0__.__cause__ = null;
		throw __except0__;
	}
};
...
export var datetime =  __class__ ('datetime', [date], {
	...
	get timestamp () {return __get__ (this, function (self) {
		if (self._tzinfo === null) {
			...
			return __call__ ((__sub__ (self, _EPOCH)).total_seconds, __sub__ (self, _EPOCH));
		}
	});},
	...
	get astimezone () {return __get__ (this, function (self, tz) {
		...
		if (tz === null) {
			...
			if (len (localtm) > 9) {
				...
				var delta = __sub__ (local, __call__ (datetime, null, ...__getslice__ (__call__ (_time.gmtime, _time, ts), 0, 6, 1)));
		...
		var utc = __call__ ((__sub__ (self, myoffset)).py_replace, __sub__ (self, myoffset), __kwargtrans__ ({tzinfo: tz}));
