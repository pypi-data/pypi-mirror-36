...
class DashboardUrlTest(unittest.TestCase):
  ...
  def test_add_latest_job_post_query(self):
    self.dburl.add_latest_job('libvpx_vp9','ml-ref','hevc_conformance_suite.txt')

    self.assertEqual(self.dburl._jobIds, [''])