...
class senseBoxSensorData(ReprObject):
    """
    Class holding data of a :cls:`senseBoxSensor`
    ...
    def from_csv(cls, fh, **kwargs):
        """
        Create a :cls:`senseBoxSensorData` object from a CSV string

        Args:
            fh (file-like object): file-like object (e.g. :cls:`io.StringIO`)
    ...
    def series(self):
        """
        Convert the data to a :cls:`pandas.Series`
    ...
    def __len__(self):
        ...
        if l1 == l2:
            ...
            raise ValueError("'createdAt' has {} elements "
