...
class IDirectory(BaseEndpoint):
    ...
    def searchLight (self, query ):
        postUri = "/_searchLight";
        __data__ = None
        from netbluemind.directory.api.BaseDirEntryQuery import BaseDirEntryQuery
        from netbluemind.directory.api.BaseDirEntryQuery import __BaseDirEntryQuerySerDer__
        __data__ = __BaseDirEntryQuerySerDer__().encode(query)
        ...
        return self.handleResult__(__ListResultSerDer__(__BaseDirEntrySerDer__()), response)
