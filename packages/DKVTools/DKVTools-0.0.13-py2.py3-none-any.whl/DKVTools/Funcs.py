...
def copyTree(srcDir, targetDir, removeBefor=False, suffix='.*', skipDirs=()) :
    '''Copy the srcDir to targetDir.
    参数: srcDir, targetDir, removeBefor=False, suffix='.*', skipDirs=()
    ...
    if removeBefor and os.path.isdir(targetDir):
