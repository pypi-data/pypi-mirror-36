...
learners=[SVM,DT,RF]
learners_para_dic={'SVM':OrderedDict([("C", 1.0), ("kernel", 'linear'), ("degree", 3),("coef0", 0.1),("gamma", 0.1)]),
                    ...
                    'RF':OrderedDict([("n_estimators", 10), ("criterion",'entropy'), ("min_samples_split", 2), 
                                 ("min_samples_leaf", 1)])}
learners_para_bounds={'SVM': [(0.1,100), ("linear","poly","rbf","sigmoid"), (1,20), (0.0,1), (0.0,1)],
                       'DT': [("gini","entropy"),("best","random"),(2,50),(1,20)],
                       'RF': [(10,100),("gini","entropy"),(2,50),(1,20)]}
learners_para_categories={'SVM': ["continuous", "categorical", "integer", "continuous", "continuous"],
...
def _test(res='',_learners = [SVM,DT,RF],file_path = ''):
    learners = []
    learners = _learners
#    print(_learners)
#    for _learner in _learners:
#        if _learner == 'SVM':
#            learners.append(SVM)
#        elif _learner == 'DT':
#            learners.append(DT)
...
#                        print('Start DE')
#                        print(learners[j], OrderedDict(learners_para_dic[le.__name__]))
                        ML_de = DE(Goal="Max", GEN=5, NP=10,termination="Early")
                        mlv, _ = ML_de.solve(learners[j], OrderedDict(learners_para_dic[le.__name__]),
