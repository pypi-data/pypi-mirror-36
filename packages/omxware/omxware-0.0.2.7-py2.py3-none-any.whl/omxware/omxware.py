...
class omxware:
    ...
    def all_genera(self, fromCache=True):
        ...
        params = json.dumps({'fromCache': str.lower(str(fromCache))})
    ...
    def genome(self, accession_number, fromCache=True):
    ...
    def genomes_by_genus(self, genus_name, fromCache=True):
    ...
    def genes_by_genome(self, accession_number, fromCache=True):
    ...
    def resistant_genes_by_genome(self, accession_number, fromCache=True):
    ...
    def genera_with_resistant_genes_by_genome(self, accession_number, fromCache=True):
    ...
    def genomes_with_resistant_genes_by_genome(self, accession_number, fromCache=True):
    ...
    def proteins_by_genome(self, accession_number, fromCache=True):
    ...
    def genes_by_name(self, GENE_FULLNAME, fromCache=True):
        '''
        Genes by name
        :param GENE_FULLNAME:
        :return: List<Gene>
    ...
    def resistant_genes(self, fromCache=True):
        '''
    ...
    def genera_by_gene_name(self, GENE_FULLNAME, fromCache=True):
        '''
    ...
    def genomes_by_gene_name(self, GENE_FULLNAME, fromCache=True):
        '''
    ...
    def proteins_by_name(self, PROTEIN_FULLNAME, fromCache=True):
        '''
        Proteins by name
    ...
    def genera_by_protein_name(self, PROTEIN_FULLNAME, fromCache=True):
        '''
    ...
    def genomes_by_protein_name(self, PROTEIN_FULLNAME, fromCache=True):
        '''
    ...
    def domains_by_go(self, GENUS_NAME, GO_CODE, fromCache=True):
        '''
        ...
        params = {'fromCache': str.lower(str(fromCache)), 'genus': str.lower(str(GENUS_NAME)), 'go_code': str.lower(str(GO_CODE)) }
        domainsResp = self.connection.get(methodurl=methodurl, headers=headers, payload=params)
        if domainsResp is not None:
            sqlRepJ = domainsResp.json()
            if len(sqlRepJ["result"]) <= 0:
                return None
            else:
                return sqlRepJ["result"]
