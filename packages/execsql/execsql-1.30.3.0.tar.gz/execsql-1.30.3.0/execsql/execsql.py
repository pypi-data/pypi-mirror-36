...
class CompareUI(object):
	def __init__(self, title, message, button_list, headers1, rows1, 
		...
		cbframe = ttk.Frame(master=self.win, padding="3 3 3 3")
		hl_cb = ttk.Checkbutton(cbframe, text = "Highlight matching rows in table clicked.", variable=self.hl_both_var, onvalue=1, offvalue=0)
		...
		# Put the frames and other widgets in place.
		msgframe.grid(column=0, row=0, sticky=tk.EW)
		cbframe.grid(column=0, row=1, sticky=tk.EW)
