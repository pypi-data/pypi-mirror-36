...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBotInlineResult, TypeDocument, TypeStickerPack, TypeMessage, TypeStickerSet, TypeFoundGif, TypeChat, TypeUser, TypeChatFull, TypeHighScore, TypeInlineBotSwitchPM, TypeEncryptedFile, TypeStickerSetCovered, TypeDialog
