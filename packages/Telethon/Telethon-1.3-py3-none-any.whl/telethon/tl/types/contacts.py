...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypeTopPeerCategoryPeers, TypeContactBlocked, TypeImportedContact, TypePeer, TypePopularContact, TypeChat, TypeUser, TypeContact
