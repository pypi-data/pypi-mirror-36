...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminRights, TypeInputChatPhoto, TypeInputUser, TypeInputMessage, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeInputChannel, TypeBool, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights
