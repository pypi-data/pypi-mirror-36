...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChatPhoto, TypeInputBotInlineResult, TypeInputMessage, TypeInputDocument, TypeBool, TypeInputEncryptedChat, TypeInputMedia, TypeInputGeoPoint, TypeReportReason, TypeReplyMarkup, TypeInputEncryptedFile, TypeInputStickeredMedia, TypeInputSingleMedia, TypeMessagesFilter, TypeSendMessageAction, TypeInputStickerSet, TypeInputDialogPeer, TypeShippingOption, TypeInputUser, TypeInputPeer, TypeMessageEntity, TypeInputBotInlineMessageID, TypeInlineBotSwitchPM
