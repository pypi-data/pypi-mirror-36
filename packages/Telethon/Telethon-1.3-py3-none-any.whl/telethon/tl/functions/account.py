...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureCredentialsEncrypted, TypeReportReason, TypeSecureValueHash, TypeInputPeer, TypeSecureValueType, TypeInputPrivacyKey, TypeInputPeerNotifySettings, TypeInputPrivacyRule, TypeBool, TypeInputNotifyPeer, TypeAccountDaysTTL, TypeInputSecureValue
