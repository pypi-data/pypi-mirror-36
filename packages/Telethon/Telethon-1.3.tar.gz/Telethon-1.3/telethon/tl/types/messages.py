...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessage, TypeStickerSet, TypeBotInlineResult, TypeDialog, TypeDocument, TypeHighScore, TypeFoundGif, TypeStickerSetCovered, TypeInlineBotSwitchPM, TypeEncryptedFile, TypeChat, TypeStickerPack, TypeChatFull, TypeUser
