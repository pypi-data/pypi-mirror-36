...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypePopularContact, TypeContactBlocked, TypeTopPeerCategoryPeers, TypePeer, TypeImportedContact, TypeContactLink, TypeChat, TypeUser
