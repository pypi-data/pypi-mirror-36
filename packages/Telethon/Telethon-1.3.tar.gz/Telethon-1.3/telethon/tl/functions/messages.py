...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputBotInlineMessageID, TypeMessagesFilter, TypeInputPeer, TypeReportReason, TypeInputUser, TypeReplyMarkup, TypeInputBotInlineResult, TypeInputDialogPeer, TypeInputMessage, TypeInputChatPhoto, TypeInputGeoPoint, TypeShippingOption, TypeInputMedia, TypeInputDocument, TypeInputEncryptedChat, TypeMessageEntity, TypeSendMessageAction, TypeInputStickerSet, TypeInlineBotSwitchPM, TypeInputSingleMedia, TypeInputStickeredMedia, TypeInputEncryptedFile
