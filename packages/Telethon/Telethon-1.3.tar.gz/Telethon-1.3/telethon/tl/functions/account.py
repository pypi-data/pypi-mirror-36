...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputNotifyPeer, TypeBool, TypeInputPeerNotifySettings, TypeAccountDaysTTL, TypeInputSecureValue, TypeInputPeer, TypeReportReason, TypeInputPrivacyRule, TypeSecureValueHash, TypeInputPrivacyKey, TypeSecureCredentialsEncrypted, TypeSecureValueType
