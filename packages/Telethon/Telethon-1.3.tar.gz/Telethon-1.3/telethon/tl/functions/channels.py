...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeInputChannel, TypeBool, TypeChannelAdminLogEventsFilter, TypeInputStickerSet, TypeInputMessage, TypeChannelBannedRights, TypeChannelAdminRights, TypeInputChatPhoto, TypeInputUser
