...
class Greoipv6(Base):
	...
	@property
	def Nglacp(self):
		"""An instance of the Nglacp class.
	...
	def Ngstaticlag(self):
		"""An instance of the Ngstaticlag class.
	...
	def find(self, ConnectedVia=None, Count=None, DescriptiveName=None, Errors=None, Multiplier=None, Name=None, SessionStatus=None, StackedLayers=None, StateCounts=None, Status=None):
		...
		Returns:
			self: This instance with found greoipv6 data from the server available through an iterator or index
