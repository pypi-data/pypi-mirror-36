...
class Dhcpv4server(Base):
	...
	def find(self, ConnectedVia=None, Count=None, DescriptiveName=None, Errors=None, Multiplier=None, Name=None, SessionStatus=None, StackedLayers=None, StateCounts=None, Status=None):
		...
		Returns:
			self: This instance with found dhcpv4server data from the server available through an iterator or index
	...
	def ForceRenew(self):
		...
		"""
		Arg1 = self.href
		return self._execute('ForceRenew', payload=locals(), response_object=None)

	def ForceRenew(self, SessionIndices):
		"""Executes the forceRenew operation on the server.
