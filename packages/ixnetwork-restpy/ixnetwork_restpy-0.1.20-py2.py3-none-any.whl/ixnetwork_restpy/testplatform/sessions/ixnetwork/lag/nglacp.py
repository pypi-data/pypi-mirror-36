...
class Nglacp(Base):
	"""The Nglacp class encapsulates a user managed nglacp node in the ixnetwork hierarchy.
	...
	def add(self, ConnectedVia=None, Multiplier=None, Name=None, StackedLayers=None):
		"""Adds a new nglacp node on the server and retrieves it in this instance.
		...
		Returns:
			self: This instance with all currently retrieved nglacp data using find and the newly added nglacp data available through an iterator or index
	...
	def remove(self):
		"""Deletes all the nglacp data in this instance from server.
	...
	def find(self, ConnectedVia=None, Count=None, DescriptiveName=None, Errors=None, Multiplier=None, Name=None, SessionStatus=None, SourceMac=None, StackedLayers=None, StateCounts=None, Status=None):
		"""Finds and retrieves nglacp data from the server.

		All named parameters support regex and can be used to selectively retrieve nglacp data from the server.
		By default the find method takes no parameters and will retrieve all nglacp data from the server.
		...
		Returns:
			self: This instance with found nglacp data from the server available through an iterator or index
	...
	def SendMarkerRequest(self, Arg2):
		...
		Args:
			Arg1 (str(None|/api/v1/sessions/1/ixnetwork/lag)): The method internally set Arg1 to the current href for this instance
