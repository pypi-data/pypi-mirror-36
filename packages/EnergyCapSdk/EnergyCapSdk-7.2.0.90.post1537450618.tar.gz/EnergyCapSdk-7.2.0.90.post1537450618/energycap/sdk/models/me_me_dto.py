...
class MeMeDto(Model):
    ...
    :param claim:
    :type claim: list[~energycap.sdk.models.MeClaimDto]
    :param preference:
    :type preference: ~energycap.sdk.models.MePreferenceDto
    :param date_formats:
    :type date_formats: list[str]
    :param time_formats:
    :type time_formats: list[~energycap.sdk.models.MeTimeFormatResponseDTO]
    :param currency_unit:
    :type currency_unit: ~energycap.sdk.models.UnitUnitChildDTO
    ...
    :param permissions:
    :type permissions:
     ~energycap.sdk.models.EnergyCapSharedIdentityPermissions
    :param feature_flags:
    ...
    _attribute_map = {
        ...
        'claim': {'key': 'claim', 'type': '[MeClaimDto]'},
        'preference': {'key': 'preference', 'type': 'MePreferenceDto'},
        'date_formats': {'key': 'dateFormats', 'type': '[str]'},
        'time_formats': {'key': 'timeFormats', 'type': '[MeTimeFormatResponseDTO]'},
        'currency_unit': {'key': 'currencyUnit', 'type': 'UnitUnitChildDTO'},
        'current_accounting_period': {'key': 'currentAccountingPeriod', 'type': 'int'},
        'user_role_name': {'key': 'userRoleName', 'type': 'str'},
        'permissions': {'key': 'permissions', 'type': 'EnergyCapSharedIdentityPermissions'},
