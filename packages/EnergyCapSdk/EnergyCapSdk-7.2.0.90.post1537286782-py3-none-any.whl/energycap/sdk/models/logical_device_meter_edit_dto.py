...
class LogicalDeviceMeterEditDTO(Model):
    ...
    :param address: The address of the meter
    ...
    :param meter_time_zone_id: The identifier for the meter's time zone.
    ...
    def __init__(self, meter_code, meter_info, place_id, commodity_id, address=None, bill_entry_note=None, include_in_energy_star=None, primary_use_id=None, meter_time_zone_id=None, properties=None):
        super(LogicalDeviceMeterEditDTO, self).__init__()
