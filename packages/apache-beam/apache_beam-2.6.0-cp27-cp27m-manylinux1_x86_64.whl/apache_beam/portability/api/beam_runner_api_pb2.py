...
_EXECUTABLESTAGEPAYLOAD = _descriptor.Descriptor(
  ...
  nested_types=[_EXECUTABLESTAGEPAYLOAD_SIDEINPUTID, _EXECUTABLESTAGEPAYLOAD_USERSTATEID, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
