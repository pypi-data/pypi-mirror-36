...
class AbstractDensenet121(BrainwaveModel):
    """Abstract base class for densenet. This model is in RGB format."""
...
class Densenet121(AbstractDensenet121):
    """
    Float-32 Version of Densenet. This model is in RGB format.
    """
    _modelname = "dn121"
    _modelver = "1.1.0"
    ...
    def __init__(self, model_base_path):
        """
        Create a Float-32 version of VGG 16. This model is in RGB format.
        ...
        super().__init__(model_base_path, self._modelname, self._modelver,
                         "https://go.microsoft.com/fwlink/?linkid=2020906&clcid=0x409", self._save_name)
...
class QuantizedDensenet121(AbstractDensenet121):
    ...
    def __init__(self, model_base_path, is_frozen=False, custom_weights_directory=None):
        ...
        super().__init__(model_base_path,
                         self._modelname,
                         self._modelver,
                         "https://go.microsoft.com/fwlink/?linkid=2020676&clcid=0x409",
                         self._save_name,
                         is_frozen=is_frozen,
