...
def preprocess_array(in_images, order='BGR'):
    """
...
def _preprocess_tensor(tensor, order):
    ...
    if order == 'BGR':
        ...
        return tf.concat([sub_red, sub_green, sub_blue], 3)
