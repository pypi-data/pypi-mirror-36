...
class Vgg16(AbstractVgg16):
    ...
    def __init__(self, model_base_path):
        ...
        super().__init__(model_base_path, self._modelname, self._modelver,
                         "https://go.microsoft.com/fwlink/?linkid=2020212&clcid=0x409", self._save_name)
...
class QuantizedVgg16(AbstractVgg16):
    ...
    def __init__(self, model_base_path, is_frozen=False, custom_weights_directory=None):
        """
        Create a version of VGG 16 quantized for Project Brainwave. This model is in BGR format.
        :param model_base_path: Path to download the model into. Used as a cache locally.
        ...
        super().__init__(model_base_path,
                         self._modelname,
                         self._modelver,
                         "https://go.microsoft.com/fwlink/?linkid=2020300&clcid=0x409",
                         self._save_name,
                         is_frozen=is_frozen,
