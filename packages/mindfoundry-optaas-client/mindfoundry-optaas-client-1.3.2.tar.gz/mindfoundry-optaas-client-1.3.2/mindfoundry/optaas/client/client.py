...
class OPTaaSClient:
    ...
    def __init__(self, server_url: str, api_key: str,
        ...
        self._tasks_endpoint = self._get_tasks_endpoint()

    def _get_tasks_endpoint(self):
        try:
            return self._session.get(API_ROOT).body['_links']['tasks']['href']
        except BaseException:
            return API_ROOT + '/tasks'
    ...
    def create_task(self, title: str, parameters: List[Parameter], constraints: List[Constraint] = None,
                    ...
                    user_defined_data: Any = None, target_score=None) -> Task:
        ...
        Args:
            ...
            target_score: Deprecated (replaced by min_known_score and max_known_score)
        ...
        if target_score is not None:
            raise ValueError('target_score has been replaced by min_known_score and max_known_score')
    ...
    def create_sklearn_task(self, title: str, pipeline: 'OptimizablePipeline',
                            ...
                            random_seed: int = None, initial_configurations: int = None, objectives: List[Objective] = None,
                            goal: Goal = None, min_known_score: float = None, max_known_score: float = None,
                            user_defined_data: Any = None, target_score=None, **kwargs) -> 'SklearnTask':
        ...
        task = self.create_task(title=title, parameters=parameters, constraints=constraints, objectives=objectives,
                                ...
                                min_known_score=min_known_score, max_known_score=max_known_score, target_score=target_score,
