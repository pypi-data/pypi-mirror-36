...
class _Base:
    ...
    def __setitem__(self, key, value):
        ...
        if key not in self.TYPE_PROPERTIES:
...
class Object(_Base):
    TYPE_PROPERTIES = ('id', 'attachment', 'attributed_to', 'audience',
                       'content', 'context', 'name', 'endTime', 'generator',
                       'icon', 'image', 'in_reply_to', 'location', 'preview',
                       'published', 'replies', 'start_time', 'summary', 'tag',
                       'updated', 'url', 'to', 'bto', 'cc', 'bcc',
                       'media_type', 'duration',  # ActivityPub extensions
                       'endpoints', 'following', 'followers', 'inbox',
                       'shares', 'likes', 'oauth_authorization_endpoint',
                       'oauth_token_endpoint', 'outbox', 'preferred_username',
                       'provide_client_key', 'proxy_url', 'shared_inbox',
                       'sign_client_key', 'source', 'streams', 'upload_media')


class Link(_Base):
    TYPE_PROPERTIES = ('id', 'href', 'rel', 'media_type', 'name', 'hreflang',
