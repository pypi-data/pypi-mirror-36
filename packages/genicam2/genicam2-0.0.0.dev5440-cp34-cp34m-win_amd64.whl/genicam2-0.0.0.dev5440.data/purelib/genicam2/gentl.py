...
if version_info >= (2, 6, 0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_gentl', [dirname(__file__)])
        except ImportError:
            import _gentl
            return _gentl
        if fp is not None:
            try:
                _mod = imp.load_module('_gentl', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _gentl = swig_import_helper()
...
_gentl.SHARED_PTR_DISOWN_swigconstant(_gentl)
...
class SwigPyIterator(_object):
    ...
    def __iter__(self):
        return self
SwigPyIterator_swigregister = _gentl.SwigPyIterator_swigregister
...
class StringList(_object):
    ...
    def __init__(self, *args):
        this = _gentl.new_StringList(*args)
        try:
    ...
    __del__ = lambda self: None
StringList_swigregister = _gentl.StringList_swigregister
StringList_swigregister(StringList)

class IEventManager(_object):
    """
    ...
    """
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IEventManager, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IEventManager, name)
    ...
    def _get_num_fired(self):
        ...
        Returns the number of events those have been fired since the registration of the target event. A fired event is either still in the internal queue or already delivered to the user or discarded :meth:`~gentl.IEventManager.flush_event_queue` method.
...
IEventManager_swigregister = _gentl.IEventManager_swigregister
IEventManager_swigregister(IEventManager)

class EventToken(_object):
    """

    Is used as a token to instantiate the corresponding event manager object.

    The instantiated object is used to construct EventManager classes those derived from :class:`~gentl.AbstractEventManager` class.

    """
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, EventToken, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, EventToken, name)
    __repr__ = _swig_repr

    def __init__(self, parent_module, event_id, h_event, h_event_src):
        this = _gentl.new_EventToken(parent_module, event_id, h_event, h_event_src)
        try:
            self.this.append(this)
        except:
            self.this = this
...
EventToken_swigregister = _gentl.EventToken_swigregister
EventToken_swigregister(EventToken)
...
class AbstractEventManager(IEventManager):
    ...
    Args:
        event (EventToken): Set an :class:`~gentl.EventToken` object.

    """
    __swig_setmethods__ = {}
    for _s in [IEventManager]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, AbstractEventManager, name, value)
    __swig_getmethods__ = {}
    for _s in [IEventManager]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, AbstractEventManager, name)
    ...
    def update_event_data(self, timeout):
        ...
        Raises:
            :class:`~gentl.TimeoutException`: If any event happens within the duration defined by :data:`timeout`.
...
AbstractEventManager_swigregister = _gentl.AbstractEventManager_swigregister
AbstractEventManager_swigregister(AbstractEventManager)

class BaseEventManagerGenApiEvent(AbstractEventManager):
    """

    Represents the event manager class which handles :const:`~gentl.EVENT_TYPE_LIST.EVENT_FEATURE_CHANGE` event.

    Args:
        event_token (EventToken): Set an :class:`~gentl.EventToken` object.

    """
    __swig_setmethods__ = {}
    for _s in [AbstractEventManager]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, BaseEventManagerGenApiEvent, name, value)
    __swig_getmethods__ = {}
    for _s in [AbstractEventManager]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, BaseEventManagerGenApiEvent, name)
    __repr__ = _swig_repr

    def __init__(self, event_token):
        this = _gentl.new_BaseEventManagerGenApiEvent(event_token)
        try:
            self.this.append(this)
        except:
            self.this = this
...
BaseEventManagerGenApiEvent_swigregister = _gentl.BaseEventManagerGenApiEvent_swigregister
BaseEventManagerGenApiEvent_swigregister(BaseEventManagerGenApiEvent)

class EventManagerError(AbstractEventManager):
    """

    Represents the event manager class which handles :const:`~gentl.EVENT_TYPE_LIST.EVENT_ERROR`.
    ...
    for _s in [AbstractEventManager]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, EventManagerError, name, value)
    __swig_getmethods__ = {}
    for _s in [AbstractEventManager]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EventManagerError, name)
    __repr__ = _swig_repr

    def __init__(self, event_token):
        this = _gentl.new_EventManagerError(event_token)
        try:
            self.this.append(this)
        except:
            self.this = this
...
EventManagerError_swigregister = _gentl.EventManagerError_swigregister
EventManagerError_swigregister(EventManagerError)
...
class EventManagerFeatureChange(AbstractEventManager):
    ...
    for _s in [AbstractEventManager]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, EventManagerFeatureChange, name, value)
    __swig_getmethods__ = {}
    for _s in [AbstractEventManager]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EventManagerFeatureChange, name)
    __repr__ = _swig_repr

    def __init__(self, event_token):
        this = _gentl.new_EventManagerFeatureChange(event_token)
        try:
            self.this.append(this)
        except:
            self.this = this
...
EventManagerFeatureChange_swigregister = _gentl.EventManagerFeatureChange_swigregister
EventManagerFeatureChange_swigregister(EventManagerFeatureChange)

class EventManagerFeatureInvalidate(AbstractEventManager):
    """

    Represents the event manager class which handles :const:`~gentl.EVENT_TYPE_LIST.EVENT_FEATURE_INVALIDATE`.
    ...
    for _s in [AbstractEventManager]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, EventManagerFeatureInvalidate, name, value)
    __swig_getmethods__ = {}
    for _s in [AbstractEventManager]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EventManagerFeatureInvalidate, name)
    __repr__ = _swig_repr

    def __init__(self, event_token):
        this = _gentl.new_EventManagerFeatureInvalidate(event_token)
        try:
            self.this.append(this)
        except:
            self.this = this
...
EventManagerFeatureInvalidate_swigregister = _gentl.EventManagerFeatureInvalidate_swigregister
EventManagerFeatureInvalidate_swigregister(EventManagerFeatureInvalidate)

class EventManagerModule(BaseEventManagerGenApiEvent):
    """

    Represents the event manager class which handles :const:`~gentl.EVENT_TYPE_LIST.EVENT_MODULE`.
    ...
    """
    __swig_setmethods__ = {}
    for _s in [BaseEventManagerGenApiEvent]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, EventManagerModule, name, value)
    __swig_getmethods__ = {}
    for _s in [BaseEventManagerGenApiEvent]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EventManagerModule, name)
    __repr__ = _swig_repr

    def __init__(self, event_token):
        this = _gentl.new_EventManagerModule(event_token)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
EventManagerModule_swigregister = _gentl.EventManagerModule_swigregister
EventManagerModule_swigregister(EventManagerModule)

class EventManagerNewBuffer(AbstractEventManager):
    """

    Represents the event manager class which handles :const:`~gentl.EVENT_TYPE_LIST.EVENT_NEW_BUFFER`.
    ...
    for _s in [AbstractEventManager]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, EventManagerNewBuffer, name, value)
    __swig_getmethods__ = {}
    for _s in [AbstractEventManager]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EventManagerNewBuffer, name)
    __repr__ = _swig_repr

    def __init__(self, event_token):
        this = _gentl.new_EventManagerNewBuffer(event_token)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def _get_buffer(self):
        ...
        Returns the :class:`~gentl.Buffer` object that has been filled up with acquired data.
...
EventManagerNewBuffer_swigregister = _gentl.EventManagerNewBuffer_swigregister
EventManagerNewBuffer_swigregister(EventManagerNewBuffer)

class EventManagerRemoteDevice(BaseEventManagerGenApiEvent):
    """

    Represents the event manager class which handles :const:`~gentl.EVENT_TYPE_LIST.EVENT_REMOTE_DEVICE`.
    ...
    for _s in [BaseEventManagerGenApiEvent]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, EventManagerRemoteDevice, name, value)
    __swig_getmethods__ = {}
    for _s in [BaseEventManagerGenApiEvent]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, EventManagerRemoteDevice, name)
    __repr__ = _swig_repr

    def __init__(self, event_token):
        this = _gentl.new_EventManagerRemoteDevice(event_token)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
EventManagerRemoteDevice_swigregister = _gentl.EventManagerRemoteDevice_swigregister
EventManagerRemoteDevice_swigregister(EventManagerRemoteDevice)

class SEVENTNEWBUFFER(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SEVENTNEWBUFFER, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SEVENTNEWBUFFER, name)
    __repr__ = _swig_repr
    __swig_getmethods__["buffer_handle"] = _gentl.SEVENTNEWBUFFER_buffer_handle_get
    if _newclass:
        buffer_handle = _swig_property(_gentl.SEVENTNEWBUFFER_buffer_handle_get)
    __swig_getmethods__["user_data"] = _gentl.SEVENTNEWBUFFER_user_data_get
    if _newclass:
        user_data = _swig_property(_gentl.SEVENTNEWBUFFER_user_data_get)

    def __init__(self):
        this = _gentl.new_SEVENTNEWBUFFER()
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
SEVENTNEWBUFFER_swigregister = _gentl.SEVENTNEWBUFFER_swigregister
SEVENTNEWBUFFER_swigregister(SEVENTNEWBUFFER)

class LibraryManager(_object):
    """
    ...
    """
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, LibraryManager, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, LibraryManager, name)
    __repr__ = _swig_repr

    def __init__(self):
        this = _gentl.new_LibraryManager()
        try:
            self.this.append(this)
        except:
            self.this = this
...
LibraryManager_swigregister = _gentl.LibraryManager_swigregister
LibraryManager_swigregister(LibraryManager)

class IEventCapableModule(_object):
    """
    ...
    """
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, IEventCapableModule, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, IEventCapableModule, name)
...
IEventCapableModule_swigregister = _gentl.IEventCapableModule_swigregister
IEventCapableModule_swigregister(IEventCapableModule)

class GenTLProducer(_object):
    """

    Is a proxy class of a GenTL Producer. You can manipulate a GenTL Producer through this object.

    To instantiate a :class:`~gentl.GenTLProducer` object, call its factory method :meth:`~gentl.GenTLProducer.create_producer`.
    ...
    """
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, GenTLProducer, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, GenTLProducer, name)
    ...
    __del__ = lambda self: None
    __swig_getmethods__["get_compliant_version"] = lambda x: _gentl.GenTLProducer_get_compliant_version
    if _newclass:
        get_compliant_version = staticmethod(_gentl.GenTLProducer_get_compliant_version)

    def create_producer():
        """

        Creates and returns a :class:`~gentl.GenTLProducer` object.

        Do not forget to call its :meth:`~gentl.GenTLProducer.close` method or consider to use ``with`` statement to let :class:`~gentl.GenTLProducer` objects release the CTI file. If you didn't take any of the tricks the CTI file might be keeping held even if your :class:`~gentl.GenTLProducer` object had been already discarded.

        """
        return _gentl.GenTLProducer_create_producer()

    if _newclass:
        create_producer = staticmethod(create_producer)
    __swig_getmethods__["create_producer"] = lambda x: create_producer
    ...
    def is_open(self):
        ...
        Returns the truth value of the following proposition: The :class:`~gentl.GenTLProducer` object has kept opening a CTI file.
    ...
    def create_system(self):
        ...
        Creates and returns the :class:`~gentl.System` object that belongs to the GenTL Producer.
...
GenTLProducer_swigregister = _gentl.GenTLProducer_swigregister
GenTLProducer_swigregister(GenTLProducer)

def GenTLProducer_get_compliant_version():
    return _gentl.GenTLProducer_get_compliant_version()
GenTLProducer_get_compliant_version = _gentl.GenTLProducer_get_compliant_version
...
class InterfaceInfoList(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, InterfaceInfoList, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, InterfaceInfoList, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _gentl.new_InterfaceInfoList(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
InterfaceInfoList_swigregister = _gentl.InterfaceInfoList_swigregister
InterfaceInfoList_swigregister(InterfaceInfoList)
...
class System(IEventCapableModule):
    ...
    def __init__(self, producer):
        this = _gentl.new_System(producer)
        try:
            self.this.append(this)
        except:
            self.this = this
...
System_swigregister = _gentl.System_swigregister
System_swigregister(System)

class DeviceInfoList(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, DeviceInfoList, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, DeviceInfoList, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _gentl.new_DeviceInfoList(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
DeviceInfoList_swigregister = _gentl.DeviceInfoList_swigregister
DeviceInfoList_swigregister(DeviceInfoList)
...
class Interface(IEventCapableModule):
    ...
    def __init__(self, transport_layer, iface_id):
        this = _gentl.new_Interface(transport_layer, iface_id)
        try:
            self.this.append(this)
        except:
            self.this = this
...
Interface_swigregister = _gentl.Interface_swigregister
Interface_swigregister(Interface)

class InterfaceInfo(_object):
    """
    ...
    """
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, InterfaceInfo, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, InterfaceInfo, name)
    __repr__ = _swig_repr

    def __init__(self, transport_layer, iface_id):
        this = _gentl.new_InterfaceInfo(transport_layer, iface_id)
        try:
            self.this.append(this)
        except:
            self.this = this
...
InterfaceInfo_swigregister = _gentl.InterfaceInfo_swigregister
InterfaceInfo_swigregister(InterfaceInfo)
...
class Device(IEventCapableModule):
    ...
    def __init__(self, iface, device_id):
        this = _gentl.new_Device(iface, device_id)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def open(self, accessFlags):
        ...
        Args:
            access_flags (DEVICE_ACCESS_FLAGS_LIST): Set a flag that you apply when opening the :class:`~gentl.Device` object.
    ...
    def _get_local_port(self):
        ...
        Returns its local :class:`~gentl.Port` object.
    ...
    def _get_remote_port(self):
        ...
        Returns its remote :class:`~gentl.Port` object.
    ...
    def _get_id_(self):
        ...
        Returns unique ID of the :class:`~gentl.Device` object.
    ...
    def _get_vendor(self):
        ...
        Returns vendor name of the :class:`~gentl.Device` object.
    ...
    def _get_model(self):
        ...
        Returns model name of the :class:`~gentl.Device` object.
    ...
    def _get_tl_type(self):
        ...
        Returns transport layer technology that is supported by the :class:`~gentl.Device` object.
    ...
    def _get_display_name(self):
        ...
        Returns user readable name of the :class:`~gentl.Device` object. If this is not defined by the device this should be "VENDOR MODEL (ID)".
    ...
    def _get_access_status(self):
        ...
        Returns access status of the :class:`~gentl.Device` object.
    ...
    def _get_user_defined_name(self):
        ...
        Returns user defined name of the :class:`~gentl.Device` object.
    ...
    def _get_serial_number(self):
        ...
        Returns serial number of the :class:`~gentl.Device` object.
    ...
    def _get_version(self):
        ...
        Returns device version of the :class:`~gentl.Device` object.
    ...
    def create_data_stream(self):
        ...
        This is the factory method of the GenTL Data Stream module. Returns a :class:`~gentl.DataStream` object.
    ...
    def _get_data_stream_ids(self):
        ...
        Returns the data stream IDs of the :class:`~gentl.DataStream` objects those belong to the :class:`~gentl.Device` object.
    ...
    def node_map(self):
    #
        if not hasattr(Device, '_node_map'):
            setattr(Device, '_node_map', None)
    #
...
Device_swigregister = _gentl.Device_swigregister
...
class DeviceInfo(_object):
    ...
    This class can create a :class:`~gentl.Device` object. 
    ...
    def __init__(self, iface, device_id):
        this = _gentl.new_DeviceInfo(iface, device_id)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def _get_vendor(self):
        ...
        Returns device vendor name of the :class:`~gentl.Device` object.
    ...
    def _get_model(self):
        ...
        Returns device model name of the :class:`~gentl.Device` object.
    ...
    def create_device(self):
        ...
        This is the factory method of the GenTL Device module. Returns a :class:`~gentl.Device` object.
    ...
    def __repr__(self):
        ...
        for property in properties:
            if property is '':
                ...
                try:
                    result = eval('self.' + property)
                except (InvalidIdException, NotAvailableException):
                    result = None
...
DeviceInfo_swigregister = _gentl.DeviceInfo_swigregister
DeviceInfo_swigregister(DeviceInfo)


class BufferToken():
    """
    Is used as a token to tell a :class:`~gentl.DataStream` object a raw buffer where the acquired data is filled in.

    Args:
        raw_buffer (bytes): Set a :class:`bytes` object. It is used as a buffer where the acquired data is filled in.
        context (object): Set an arbitrary object which derives from Python's built-in :class:`object` class. This object is attached to the raw buffer and a client can get it back later once the announced :class:`~gentl.Buffer` object is delivered.
    """
...
class DataStream(IEventCapableModule):
    ...
    for _s in [IEventCapableModule]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, DataStream, name, value)
    __swig_getmethods__ = {}
    for _s in [IEventCapableModule]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, DataStream, name)
    __repr__ = _swig_repr

    def __init__(self, device):
        this = _gentl.new_DataStream(device)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def open(self, dataStreamID):
        ...
        Args:
            data_stream_id (str): Set a data stream ID that you want to open. The available IDs are listed in an object that is returned by :meth:`~gentl.Device.get_data_stream_ids` property.
    ...
    def queue_buffer(self, buffer, clear_buffer=True):
        ...
        Queues a particular :class:`~gentl.Buffer` object for acquisition. A :class:`~gentl.Buffer` object can be queued for acquisition any time after the buffer was announced (before or after the acquisition has been started) if it is not currently queued. Furthermore, a buffer which is already waiting to be delivered cannot be queued for acquisition. A queued buffer cannot be revoked. The order of the delivered buffers is not necessarily the same as the order in which they have been queued.

        Args:
            buffer (Buffer): Set a :class:`~gentl.Buffer` object to queue.
    ...
    def flush_buffer_queue(self, operation):
        ...
        Flushes the by operation defined internal buffer pool or queue to another one as defined by :class:`~gentl.ACQ_QUEUE_TYPE_LIST`.

        Args:
            operation (ACQ_QUEUE_TYPE_LIST): Set a flush operation to perform as defined by :class:`~gentl.ACQ_QUEUE_TYPE_LIST`.
    ...
    def start_acquisition(self, *args):
        ...
        Starts the acquisition engine on the host. Each call to :meth:`~gent.DataStream.start_acquisition` method must be accompanied by a call to :meth:`~gentl.DataStream.stop_acquisition` method.

        Args:
            start_flags (ACQ_START_FLAGS_LIST): Set a flag that you apply when starting acquisition.
            num_to_acquire (int): Set the number of filled/delivered buffers after which the acquisition engine stops automatically. Buffers which are internally discarded or missed are not counted. If you omit passing this parameter, the acquisition continues until a call to :meth:`~gentl.DataStream.stop_acquisition` method is called.
    ...
    def stop_acquisition(self, stop_flags):
        ...
        Stops the acquisition engine on the host. There must be a call to :meth:`~gentl.DataStream.stop_acquisition` method accompanying each call to :meth:`~gentl.DataStream.start_acquisition` method even though the stream already stopped because the number of frames to acquire was reached. This is also independent of the acquisition modes.
    ...
    def _get_id_(self):
        ...
        Returns unique ID of the :class:`~gentl.DataStream` object.
    ...
    def _get_num_chunks_max(self):
        ...
        Raises:
            NotAvailableException: If the :class:`~gentl.DataStream` object doesn't support the feature.
    ...
    def _get_buffer_alignment(self):
        ...
        Returns the alignment size in bytes of the buffer passed to the :meth:`~gentl.DataStream.announce_buffer` method.
    ...
    def announce_buffer(self, buffer_token):
        """
        Announces a GenTL Consumer allocated buffer to the :class:`~gentl.DataStream` module to let it know the place where the acquired data is filled in.

        Note that announcing a buffer to a :class:`~gentl.DataStream` object does not mean that the buffer will be automatically queued for acquisition. This is done through a separate call to the :meth:`~gentl.DataStream.queue_buffer` method.

        Args:
            buffer_token (BufferToken): Set a :class:`~gentl.BufferToken` object which holds a :class:`bytes` object as raw buffer where you want to ask the :class:`~gentl.DataStream` object fills acquired data in.
        """
...
DataStream_swigregister = _gentl.DataStream_swigregister
DataStream_swigregister(DataStream)

class Parts(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Parts, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Parts, name)
    __repr__ = _swig_repr
    ...
    __del__ = lambda self: None
Parts_swigregister = _gentl.Parts_swigregister
Parts_swigregister(Parts)
...
class Buffer(_object):
    ...
    A :class:`~gentl.Buffer` object is created when a raw buffer is announced on a :class:`~gentl.DataStream` object.
    ...
    def __init__(self, data_stream, h_buffer, context):
        this = _gentl.new_Buffer(data_stream, h_buffer, context)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def _get_payload_type(self):
        ...
        Returns the payload type of the :class:`~gentl.Buffer` object that is defined as an entry of :class:`~gentl.PAYLOADTYPE_INFO_IDS`.
    ...
    def has_new_data(self):
        ...
        Returns the truth value of the given proposition: The :class:`~gentl.Buffer` object has one or more newly delivered data.
    ...
    def has_been_queued(self):
        ...
        Returns the truth value of the given proposition: The :class:`~gentl.Buffer` object has been queued in a :class:`~gentl.DataStream` object.
    ...
    def is_acquiring(self):
        ...
        Returns the truth value of the given proposition: The :class:`~gentl.Buffer` object is currently being filled with data.
    ...
    def _is_incomplete(self):
        ...
        Returns the truth value of the given proposition: The :class:`~gentl.Buffer` object was filled but an error occurred during that process.
    ...
    def _get_tl_type(self):
        ...
        Returns the transport layer technology that is supported by the :class:`~gentl.Buffer` object.
    ...
    def _get__num_buffer_parts(self):
        ...
        Returns the number of independent data parts in the :class:`~gentl.Buffer` object.
    ...
    def _get_parts(self):
        ...
        Returns a :class:`list` object containing :class:`~gentl.Part` objects. If the target doesn't support multi-part buffer, the list object is not ``None`` but the length will be zero.

        Returns:
            (list): A :class:`list` object containing :class:`~gentl.Part` objects.
    ...
    def clear(self):
        ...
        Clears the content of the raw buffer that has been attached to the :class:`~gentl.Buffer` object. Every data element of the raw buffer will be overwritten with value 0.
...
Buffer_swigregister = _gentl.Buffer_swigregister
...
class Part(_object):
    ...
    def __init__(self, buffer, part_index):
        this = _gentl.new_Part(buffer, part_index)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    def _get_data_offset(self):
        ...
        Returns the offset address to the specified buffer part of the :class:`~gentl.Buffer` object.
    ...
    def _get_data_type(self):
        ...
        Returns the type of the data in given part. This information refers to the constants defined by :class:`~gentl.PARTDATATYPE_IDS`.
    ...
    def _get_data_format_namespace(self):
        ...
        Returns:
            PIXELFORMAT_NAMESPACE_IDS: Information refers to the constants defined by :class:`~gentl.PIXELFORMAT_NAMESPACE_IDS` to allow interpretation of :class:`~gentl.BUFFER_PART_INFO_CMD_LIST.BUFFER_PART_INFO_DATA_FORMAT`.
...
Part_swigregister = _gentl.Part_swigregister
Part_swigregister(Part)

class URLInfoList(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, URLInfoList, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, URLInfoList, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        this = _gentl.new_URLInfoList(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
URLInfoList_swigregister = _gentl.URLInfoList_swigregister
URLInfoList_swigregister(URLInfoList)
...
Port_swigregister = _gentl.Port_swigregister
Port_swigregister(Port)

class URLInfo(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, URLInfo, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, URLInfo, name)
    __repr__ = _swig_repr

    def __init__(self, port, url_index):
        this = _gentl.new_URLInfo(port, url_index)
        try:
            self.this.append(this)
        except:
            self.this = this
...
URLInfo_swigregister = _gentl.URLInfo_swigregister
URLInfo_swigregister(URLInfo)


def start_redirection():
    return _gentl.start_redirection()
start_redirection = _gentl.start_redirection

def stop_redirection():
    return _gentl.stop_redirection()
stop_redirection = _gentl.stop_redirection

def trace(arg1):
    return _gentl.trace(arg1)
trace = _gentl.trace
...
class Helper():
    ...
    @classmethod
    def get_gentl_paths(self):
        """
        Having a proper environment variable, either ``GENICAM_GENTL32_PATH`` or
        ``GENICAM_GENTL64_PATH``, returns file paths where it's assumed that GenTL
        Producer files (*.cti) are located.

        Returns:
            str: A set of paths where GenTL Producer files are located.
    ...
    @classmethod
    def retrieve_file_name(self, file_name):
        """
        Retrieving a file name specified by ``file_name``, returns the
        full path name if it exists in the path specified by
        GENICAM_GENTL32/64_PATH. If it doesn't exist ``None`` will be
        returned.

        """

        result = None
        for path in self.get_gentl_paths():
            path_name = self._get_path_name(file_name, path)
            if path_name:
                result = self.format_path(path_name)
                break
        return result
    @classmethod
    def _get_path_name(self, pattern, path):
        """
        Having a target path, this methods checks if a file or a directory
        exists in the path, then returns a truth value for a proposition: A
        file or a directory exists in the specified directory.

        Args:
            pattern (str): Set a regular expression pattern to apply for
                the search.
            path (str): Set a path to the target directory.
