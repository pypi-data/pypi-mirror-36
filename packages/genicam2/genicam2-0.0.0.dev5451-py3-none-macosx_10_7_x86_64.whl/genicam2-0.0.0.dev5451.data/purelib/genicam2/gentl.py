...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_gentl')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_gentl')
...
class GenTLProducer(_object):
    ...
    if _newclass:
        ...
        get_compliant_version = _gentl.GenTLProducer_get_compliant_version
    ...
    def __repr__(self):
        ...
        for property in properties:
            if property is '':
                ...
                except (InvalidIdException, NotAvailableException, NotImplementedException):
                    result = None
