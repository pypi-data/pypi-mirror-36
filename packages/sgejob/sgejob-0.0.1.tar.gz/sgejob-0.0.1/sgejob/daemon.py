...
which is licensed under the Apache License, Version 2.0.
    ...
    parser.add_argument('-qstat', metavar='<str>', default='qstatt',
...
def job_recording(qstat=None, user=None, sge_infor_file=None, sge_usage_file=None, interval=300):
    # 需要执行的主体任务
    sys.path.append('/hwfssz1/ST_DIVERSITY/F16HQSB1SY2806_InsectTrans/USER/mengguanliang/test/sgejob/source/v0.0.1')
