...
def train(spark, inputDF, algorithm, hyperparams={}, metric='areaUnderROC', numFolds=3, seed=None, numInitPoints=5, numIterations=2, acquisitionFunction='poi', gpParams={'alpha': 1e-5}, baseDir='output', workDir='output', outputDir=uuid.uuid4(), idx=1, binary=True, smart=False, optimize=False, persist=True, s3=False):
    """
