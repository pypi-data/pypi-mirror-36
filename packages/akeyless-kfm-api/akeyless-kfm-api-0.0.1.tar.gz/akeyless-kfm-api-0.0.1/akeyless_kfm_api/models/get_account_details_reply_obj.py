...
class GetAccountDetailsReplyObj(object):
    ...
    def __init__(self, account_id=None, admin_user_policy_id=None, customer_address=None, customer_email=None, customer_id=None, customer_name=None, customer_phone=None, num_of_items=None, num_of_roles=None, num_of_users=None):  # noqa: E501
