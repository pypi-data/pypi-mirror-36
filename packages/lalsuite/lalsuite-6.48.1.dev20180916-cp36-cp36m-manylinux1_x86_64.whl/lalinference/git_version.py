...
id = "a8555a803b30d840338d639497dae948f278cb67"
date = "2018-09-15 18:58:34 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "a8555a803b30d840338d639497dae948f278cb67":
        return
    msg = "Program id (a8555a803b30d840338d639497dae948f278cb67) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
