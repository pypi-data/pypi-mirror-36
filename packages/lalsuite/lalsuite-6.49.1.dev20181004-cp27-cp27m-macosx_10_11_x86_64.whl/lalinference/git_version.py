...
id = "3abfc0ceffcd3fb82a38371ae4c01170c6eeaa90"
date = "2018-10-4 17:08:40 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "3abfc0ceffcd3fb82a38371ae4c01170c6eeaa90":
        return
    msg = "Program id (3abfc0ceffcd3fb82a38371ae4c01170c6eeaa90) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
