...
id = "349dead4a2d235a4f42068e0cf25d39d75e9ec85"
date = "2018-09-25 23:32:25 +0000"
branch = "None"
tag = "lalsuite-v6.49a"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "349dead4a2d235a4f42068e0cf25d39d75e9ec85":
        return
    msg = "Program id (349dead4a2d235a4f42068e0cf25d39d75e9ec85) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
