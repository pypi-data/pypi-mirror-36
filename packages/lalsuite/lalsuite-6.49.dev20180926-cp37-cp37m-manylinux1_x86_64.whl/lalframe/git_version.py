...
id = "b01f8500b1a241008eaa3158d9bfa3f65e2f667d"
date = "2018-09-26 10:58:05 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "b01f8500b1a241008eaa3158d9bfa3f65e2f667d":
        return
    msg = "Program id (b01f8500b1a241008eaa3158d9bfa3f65e2f667d) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
