...
def arm_deploy_template_new_resources(auth, resource_group_name,
    ...
    :param str account_name: The name of team account
    ...
    if batchai_workspace is None:
        ...
        batchai_workspace_dict = {}
        batchai_workspace_dict["eastus2euap"] = "eastus"
        batchai_workspace_dict["eastus"] = "eastus"
        batchai_workspace_dict["centraluseuap"] = "eastus"
        batchai_workspace_dict["australiaeast"] = "australiaeast"
        batchai_workspace_dict["eastus2"] = "eastus"
        batchai_workspace_dict["westus2"] = "westus2"
        batchai_workspace_dict["westcentralus"] = "eastus"
        batchai_workspace_dict["southeastasia"] = "eastus"
        batchai_workspace_dict["westeurope"] = "westeurope"
        batchai_workspace_dict["southcentralus"] = "eastus"
        batchai_workspace_dict["northeurope"] = "northeurope"

        normalized_location = location.lower().replace(" ", "")
        if normalized_location in batchai_workspace_dict:
            batchai_workspace_location = batchai_workspace_dict[normalized_location]
        else:
    ...
    poller = _arm_deploy_template(auth._get_service_client(
        ResourceManagementClient, subscription_id).deployments,
        resource_group_name,
        deployment_name,
        properties)
    LongRunningOperation(get_default_cli())(poller)
