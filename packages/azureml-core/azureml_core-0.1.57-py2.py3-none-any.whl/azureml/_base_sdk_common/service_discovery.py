...
def get_experiment_graphs_url(auth, account_scope):
    """
    ...
    :rtype: str
    """
    return CachedServiceDiscovery(auth).get_service_url(account_scope, 'experimentgraphs', AppSettings().get_flight())
