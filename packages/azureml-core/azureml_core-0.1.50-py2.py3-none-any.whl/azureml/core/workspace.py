...
class Workspace(object):
    ...
    def _initialize_folder(self, experiment_name, directory=".", auth=None, _location=None):
        """
        ...
        return Project.attach(self, experiment_name, directory=directory, _location=_location, auth=auth)
    ...
    def compute_targets(self):
        ...
        :return: List of compute targets
    ...
    def datastores(self):
        """
        Lists all datastores in the workspace. List operation does not return credentials of the datastores.

        :return: List of datastores
        :rtype: list[AzureFileDatastore] or list[AzureBlobDatastore] or list[AzureDataLakeDatastore]
        return _DatastoreClient.list(self)
        """
        return _DatastoreClient.list(self)
    ...
    def experiments(self):
        ...
        :return: List of experiments in the workspace
        :rtype: list[azureml.core.experiment.Experiment]
        """
    ...
    def images(self, image_name=None, model_name=None, model_id=None, tags=None, properties=None):
        """
        ...
        """
        return Image.list(self, image_name, model_name, model_id, tags, properties)

    def models(self, name=None, tags=None, properties=None):
        """
        ...
        :raises: WebserviceException
        """
        return Model.list(self, name, tags, properties)

    def webservices(self, compute_type=None, image_name=None, image_id=None, model_name=None, model_id=None,
        ...
        :raises: WebserviceException
        """
        return Webservice.list(self, compute_type, image_name, image_id, model_name, model_id, tags, properties)
