...
TENSORFLOW_DEFAULT_VERSION = '1.9.0'
...
class CondaDependencies(object):
    """
    A class for conda dependencies.
    """
    ...
    def __init__(self, conda_dependencies_file_path=None, _underlying_structure=None):
        """
        :param conda_dependencies_file_path: the conda dependencies file full path.
    ...
    def create(pip_indexurl=None, pip_packages=None, conda_packages=None,
        ...
        cd.set_pip_index_url(
            "--index-url {}".format(pip_indexurl if pip_indexurl else CondaDependencies.sdk_origin_url()))
    ...
    def get_default_number_of_packages(self):
        """
        TODO: This is a public method that needs documentation.
        :return:
        """
    ...
    def add_tensorflow_conda_package(self, core_type=CPU, version=None):
        ...
        Add a tensorflow package
        :param core_type: 'cpu' or 'gpu'.
        :type core_type: string
        """
        self._validate_core_type(core_type)
        self.add_channel('anaconda')
    ...
    def serialize_to_string(self):
        """
        Serialize the conda dependencies object to string
        """
    ...
    def _has_python_package(self):
        ...
        Returns bool and index of the python package.
        :return:
        """
        has_python = False
        index = -1
