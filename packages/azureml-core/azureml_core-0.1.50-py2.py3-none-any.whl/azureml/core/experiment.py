...
class Experiment(ChainedIdentity, HasExperimentPortal):
    ...
    .. remarks:
        ...
        In AzureML, an experiment is represented by the **:class:`experiment`** class and a trial is
        ...
        If the experiment is not found in the workspace, a new experiment is created when an experiement trial
        is executed.
        ...
        In both cases you can use query methods like *:func:`azureml.core.Run.get_metric`* to retrieve the current
        value, if any, of any trial measurements and metrics.
    ...
    def submit(self, config, tags=None, **kwargs):
        ...
        .. remarks:
            ...
            * Script - :class:`azureml.core.ScriptRunConfig`
            * Hyperdrive - :class:`azureml.train.hyperdrive.HyperdriveRunConfig`
            * AutoML - :class:`azureml.train.automl.AutoMLConfig`
            * Pipeline - :class:`azureml.core.ScriptRunConfig`
    ...
    def get_docs_url(cls):
        """
        Return the url to the documentation for this class
    ...
    def __repr__(self):
        """ Return the string form of the experiment object """
        return self.__str__()

    def _repr_html_(self):
        """ Return an html table representing this experiment """
        info = self._get_base_info_dict()
        info.update([
