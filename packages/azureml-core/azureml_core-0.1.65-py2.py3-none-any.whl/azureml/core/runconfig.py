...
DEFAULT_CPU_IMAGE = "mcr.microsoft.com/azureml/base:0.1.3"
DEFAULT_GPU_IMAGE = "mcr.microsoft.com/azureml/base-gpu:0.1.3"
...
class DockerEnvironment(AbstractRunConfigElement):
    ...
    def __setattr__(self, name, value):
        ...
        if name in self._field_to_info_dict or name == "_loaded_commented_map":
            super(DockerEnvironment, self).__setattr__(name, value)
        else:
            raise AttributeError("%s isn't an attribute of RunConfiguration.environment.docker" % name)
