...
class Image(ABC):
    ...
    _expected_payload_keys = ['createdTime', 'creationState', 'description', 'id',
                              'imageLocation', 'imageType', 'modelIds', 'name', 'tags',
                              'properties', 'version']
            ...
            if get_response_payload:
                ...
                for child in Image.__subclasses__():
                    if image_type == child._image_type:
                        ...
                        return image
                raise WebserviceException("This SDK doesn't support images of type {0}".format(image_type))
            else:
    ...
    def create(workspace, name, models, image_config):
        ...
        :type models: azureml.core.model.Model
