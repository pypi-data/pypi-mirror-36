...
from pyrqa.operators.create_matrix.fixed_radius.uniform_grid.sorting_row_materialisation_uncompressed_bit import create_matrix
...
class SortingRowMaterialisationUncompressedBitNoRecycling(BaseSettings):
    """
