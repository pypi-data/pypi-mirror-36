...
from pyrqa.operators.create_matrix.fixed_radius.tree.kdtree_materialisation_byte import create_matrix
...
class KDTreeMaterialisationCompressedByteNoRecycling(BaseSettings):
    """"
