...
from pyrqa.operators.create_matrix.fixed_radius.uniform_grid.sorting_column_materialisation_uncompressed_bit import create_matrix
...
class SortingColumnMaterialisationUncompressedBitNoRecycling(BaseSettings):
    """
