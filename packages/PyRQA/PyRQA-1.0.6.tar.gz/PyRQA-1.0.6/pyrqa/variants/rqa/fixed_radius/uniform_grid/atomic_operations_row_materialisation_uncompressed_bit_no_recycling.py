...
from pyrqa.operators.create_matrix.fixed_radius.uniform_grid.atomic_operations_row_materialisation_uncompressed_bit import create_matrix
...
class AtomicOperationsRowMaterialisationUncompressedBitNoRecycling(BaseSettings):
    """
