...
from pyrqa.operators.create_uniform_grid.sorting_row import create_uniform_grid
from pyrqa.operators.create_matrix.fixed_radius.uniform_grid.sorting_row_materialisation_uncompressed_byte import create_matrix


class SortingRowMaterialisationUncompressedByte(BaseSettings):
    """
