...
from pyrqa.variants.recurrence_plot.fixed_radius.brute_force.column_materialisation_uncompressed_byte import ColumnMaterialisationUncompressedByte
...
class ExecutionEngine(RecurrencePlotSubMatrices,
    ...
    :ivar selector_kwargs: Selector keyword arguments.
    ...
    def __init__(self,
        ...
        :param selector_kwargs: Selector keyword arguments.
