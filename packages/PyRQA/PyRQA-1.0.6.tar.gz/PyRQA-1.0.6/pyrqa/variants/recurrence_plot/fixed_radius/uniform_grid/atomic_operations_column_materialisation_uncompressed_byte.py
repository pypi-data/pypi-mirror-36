...
from pyrqa.operators.create_matrix.fixed_radius.uniform_grid.atomic_operations_column_materialisation_uncompressed_byte import create_matrix


class AtomicOperationsColumnMaterialisationUncompressedByte(BaseSettings):
    """
