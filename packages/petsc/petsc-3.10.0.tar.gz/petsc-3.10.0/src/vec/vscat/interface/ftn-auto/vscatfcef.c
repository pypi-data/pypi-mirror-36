...
PETSC_EXTERN void PETSC_STDCALL  vecscatterremap_(VecScatter scat,PetscInt *tomap,PetscInt *frommap, int *__ierr){
*__ierr = VecScatterRemap(
	(VecScatter)PetscToPointer((scat) ),tomap,frommap);
}
#if defined(__cplusplus)
}
#endif
