...
class XML(models.Model):
    ...
    url_callback = models.CharField(db_column='xml_url_callback', max_length=255, null=True)
    auth_token = models.CharField(db_column='xml_auth_token', max_length=255, null=True)
...
class Tag(models.Model):
    ...
    url_callback = models.CharField(db_column="tag_url_callback", max_length=255, null=True)
    auth_token = models.CharField(db_column="tag_auth_token", max_length=255, null=True)
