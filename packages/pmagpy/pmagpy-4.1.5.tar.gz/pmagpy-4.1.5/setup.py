...
setup(
    ...
    #
    # oh, this might be because of trying with testpypi
    # pandas, appdirs, future, cartopy (b/c cython), cause problems
    #install_requires=['cython', 'numpy', 'matplotlib', 'future', 'appdirs', 'pandas', 'scipy', 'cartopy'], # cartopy fails because of cython dependency, https://github.com/SciTools/cartopy/issues/1035
