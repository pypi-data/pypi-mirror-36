...
def caerFrameUtilsDemosaic(framePacket, demosaicType):
    r"""caerFrameUtilsDemosaic(caer_frame_event_packet framePacket, enum caer_frame_utils_demosaic_types demosaicType) -> caer_frame_event_packet"""
    return _libcaer_wrap.caerFrameUtilsDemosaic(framePacket, demosaicType)

def caerFrameUtilsContrast(framePacket, contrastType):
    r"""caerFrameUtilsContrast(caer_frame_event_packet framePacket, enum caer_frame_utils_contrast_types contrastType)"""
...
class caer_davis_info(_object):
    ...
    if _newclass:
        logicClock = property(_libcaer_wrap.caer_davis_info_logicClock_get, _libcaer_wrap.caer_davis_info_logicClock_set)
    ...
    if _newclass:
        adcClock = property(_libcaer_wrap.caer_davis_info_adcClock_get, _libcaer_wrap.caer_davis_info_adcClock_set)
    ...
    if _newclass:
        dvsHasTestEventGenerator = property(_libcaer_wrap.caer_davis_info_dvsHasTestEventGenerator_get, _libcaer_wrap.caer_davis_info_dvsHasTestEventGenerator_set)
    ...
    if _newclass:
        apsHasQuadROI = property(_libcaer_wrap.caer_davis_info_apsHasQuadROI_get, _libcaer_wrap.caer_davis_info_apsHasQuadROI_set)
    ...
    if _newclass:
        apsHasExternalADC = property(_libcaer_wrap.caer_davis_info_apsHasExternalADC_get, _libcaer_wrap.caer_davis_info_apsHasExternalADC_set)
    ...
    if _newclass:
        apsHasInternalADC = property(_libcaer_wrap.caer_davis_info_apsHasInternalADC_get, _libcaer_wrap.caer_davis_info_apsHasInternalADC_set)
    ...
    if _newclass:
        extInputHasExtraDetectors = property(_libcaer_wrap.caer_davis_info_extInputHasExtraDetectors_get, _libcaer_wrap.caer_davis_info_extInputHasExtraDetectors_set)
...
def caerDavisROIConfigure(handle, roiRegion, enable, startX, startY, endX, endY):
    r"""caerDavisROIConfigure(caerDeviceHandle handle, uint8_t roiRegion, bool enable, uint16_t startX, uint16_t startY, uint16_t endX, uint16_t endY) -> bool"""
