...
class ModelMetaNames(MetaNamesBase):
    ...
    _meta_props_definitions = [
        ...
        MetaProp('OUTPUT_DATA_SCHEMA',      OUTPUT_DATA_SCHEMA,          dict,       False,  {'fields': [{'metadata': {}, 'type': 'string', 'name': 'GENDER', 'nullable': True}, {'metadata': {'modeling_role': 'transformed-target'}, 'type': 'double', 'name': 'PRODUCT_LINE_IX', 'nullable': False}], 'type': 'struct'}, path="/output_data_schema"),
