...
class TestWMLClientWithKeras(unittest.TestCase):
    ...
    def test_14_create_deployment(self):
    ...
    def test_15_create_learning_system(self):
        ...
        # meta_prop = {
        #     self.client.learning_system.ConfigurationMetaNames.EVALUATION_DEFINITION: {
        #         "method": "binary",
        #         "metrics": [{
        #           "name": "accuracy",
        #           "threshold": 0.70
    ...
    def test_16_update_learning_system(self):
        meta_prop = {
            self.client.learning_system.ConfigurationMetaNames.EVALUATION_DEFINITION: {
                "method": "binary",
                "metrics": [{
        ...
        details = self.client.learning_system.update(TestWMLClientWithKeras.trained_model_uid, meta_prop)
        self.assertIsNotNone(details)

    def test_17_list(self):
        self.client.learning_system.list()  # Call function.
        self.assertTrue(TestWMLClientWithKeras.trained_model_uid in captured_output.getvalue())

        self.client.learning_system.list()

    def test_18_run_learning_system(self):
    ...
    def test_20_get_deployment_status(self):
