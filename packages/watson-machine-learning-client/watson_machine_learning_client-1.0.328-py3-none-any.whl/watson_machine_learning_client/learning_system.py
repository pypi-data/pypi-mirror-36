...
class LearningSystem(WMLResource):
    ...
    def setup(self, model_uid, meta_props):
        ...
        model_details = self._handle_response(200, u'creating new model', model_details_response)
        training_data_reference = model_details['entity']['training_data_reference']
        training_result_reference = model_details['entity']['model_version']['content_location']
        execution = {}
