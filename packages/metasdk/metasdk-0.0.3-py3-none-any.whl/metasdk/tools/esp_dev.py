...
if __name__ == '__main__':
    ...
    parser.add_argument('--frontend_grpc_port', help='ESP Frontend port for GRPC request. Default: 8083', type=int, required=False, default=8083)
    parser.add_argument('--frontend_http_port', help='ESP Frontend port for HTTP(REST) requests. Default: 8084', type=int, required=False, default=8084)
    parser.add_argument('--service_account_key_file', help='Service account json file for trace and log google cloud api. Default: test-esp-service-account-creds.json', type=str, required=False, default="test-esp-service-account-creds.json")
