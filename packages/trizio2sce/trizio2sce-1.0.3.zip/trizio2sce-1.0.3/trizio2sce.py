...
print('Trizio2sce version 1.0.3 180916 (c) 2018 Pedro Fernández')	
...
if listObjects==[]:
	if english:
		listObjects.append({'name':'TORCH', 'description':'a torch (lit)', 'loc':1})
	else:
		listObjects.append({'name':'LINTERNA', 'description':'una linterna (encendida)', 'loc':1})
