...
from punica.utils.handle_config import (
    ...
    handle_deploy_information_config
)
...
class TestUtils(unittest.TestCase):
    ...
    def test_handle_deploy_information_config(self):
        config_dir_path = os.path.join(os.getcwd(), 'test_file', 'test_config')
        deploy_information = handle_deploy_information_config(config_dir_path)
        ...
        self.assertRaises(PunicaException, handle_deploy_information_config, os.getcwd())
