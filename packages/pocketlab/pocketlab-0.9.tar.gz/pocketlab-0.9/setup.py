...
pip wheel --no-index --no-deps --wheel-dir dist dist/pocketlab-0.9.tar.gz

Upload (or Register) Distributions to PyPi:
twine upload dist/pocketlab-0.9*
...
pip install dist/pocketlab-0.9-py3-none-any.whl # when possessing wheel file
