...
class TabularExplainer(BaseExplainer):
    ...
    def explain_model(self, model, initialization_examples, evaluation_examples=None,
        ...
        Parameters:
            ...
            create_scoring_model : bool
                Creates a model that can be used for scoring to approximate the feature importance values of
                data faster than SHAP.  See explain_from_scoring_model for more details.
