...
_STRATEGYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002!\032\034/v3/strategies/{strategy_id}:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='DelStrategies',
