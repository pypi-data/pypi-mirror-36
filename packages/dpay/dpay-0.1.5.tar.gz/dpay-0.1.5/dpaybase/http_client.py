...
import certifi
import urllib3
from dpaybase.exceptions import RPCError, RPCErrorRecoverable
...
class HttpClient(object):
    ...
    This class serves as an abstraction layer for easy use of the dPay API.

    Args:
      nodes (list): A list of dPay HTTP RPC nodes to connect to.

    .. code-block:: python

       from dpay.http_client import HttpClient

       rpc = HttpClient(['https://d.dpays.io',
       'https://d.dpaydev.io'])
    ...
    def json_rpc_body(name, *args, **kwargs):
        """ Build request body for dpayd RPC requests.
    ...
    def call(self,
             ...
             *args,
             **kwargs):
        """ Call a remote procedure in dpayd.
        ...
        while True:
            ...
            #       define exceptions for which we refuse to retry.
                ...
                logger.error('Unexpected exception! Please report at ' +
                             'https://github.com/dpays/dpay-python/issues' +
    ...
    def sanitize_nodes(self, nodes):
        ...
        1. a string of a single node url. ie nodes='https://d.dpays.io'
        2. a comma separated string of several node url's.
            nodes='https://d.dpays.io,<<community node>>,<<your personal node>>'
