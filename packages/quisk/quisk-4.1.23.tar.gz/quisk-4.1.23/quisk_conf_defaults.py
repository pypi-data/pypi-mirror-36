...
Hermes_BandDictTx = {'160':0, '80':0, '60':0, '40':0, '30':0, '20':0, '15':0}
...
# Changes are immediate (no need to restart).
#split_rxtx = 1		# Play both, higher frequency on the right
split_rxtx = 2		# Play both, lower frequency on the right
...
# For the Hermes protocol including the Hermes-Lite2, this is the CW hang time,
# the time in milliseconds 0 to 1023 to hold the T/R relay after key up. For all
