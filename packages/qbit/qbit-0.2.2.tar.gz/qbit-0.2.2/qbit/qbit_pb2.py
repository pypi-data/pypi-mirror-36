...
_FUJITSUDASOLVER_GUIDANCECONFIGENTRY.has_options = True
_FUJITSUDASOLVER_GUIDANCECONFIGENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_FUJITSUDAMIXEDMODESOLVER_GUIDANCECONFIGENTRY.has_options = True
_FUJITSUDAMIXEDMODESOLVER_GUIDANCECONFIGENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_FUJITSUDAPTSOLVER_GUIDANCECONFIGENTRY.has_options = True
_FUJITSUDAPTSOLVER_GUIDANCECONFIGENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
...
_QUBORESPONSE_SOLVERINPUTPARAMETERSENTRY.has_options = True
_QUBORESPONSE_SOLVERINPUTPARAMETERSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
...
_QBIT = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\024\"\017/v1/gms/compare:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='Hobo2Qubo',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\027\"\022/v1/qubo/hobo2qubo:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='SolveQubo',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\023\"\016/v1/qubo/solve:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='Knapsack',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\021\"\014/v1/knapsack:\001*')),
  ),
  _descriptor.MethodDescriptor(
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\034\"\027/v1/MinKCutPartitioning:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='HealthCheck',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\021\022\017/v1/healthcheck')),
  ),
  _descriptor.MethodDescriptor(
    name='AuthCheck',
    ...
    input_type=_HEALTHCHECKREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\017\022\r/v1/authcheck')),
  ),
])
