...
def Z3_mk_atleast(a0, a1, a2, a3):
  r = lib().Z3_mk_atleast(a0, a1, a2, a3)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_pbge(a0, a1, a2, a3, a4):
  r = lib().Z3_mk_pbge(a0, a1, a2, a3, a4)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_get_lower_as_vector(a0, a1, a2):
  r = lib().Z3_optimize_get_lower_as_vector(a0, a1, a2)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_get_upper_as_vector(a0, a1, a2):
  r = lib().Z3_optimize_get_upper_as_vector(a0, a1, a2)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg(a0, err))
  return r
