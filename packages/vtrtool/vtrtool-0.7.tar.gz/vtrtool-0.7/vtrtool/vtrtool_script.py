...
Usage:
    ...
    vtrtool from_binary [<num_props>] <nx1> <nx2> <nx3> <bin_filename> <vtr_filename>
...
def main():
    ...
    if arguments["info"]:
        ...
        if arguments["num_props"]:
            num_props = int(arguments["num_props"])
        else:
            num_props = 1  # model is single-property
