from src.util.ConfigurationParser import ConfigurationParser
from src.retrievel.GooglePlus import GooglePlusDataRetrievel
from src.retrievel.Twitter import TwitterDataRetrievel
import sys
