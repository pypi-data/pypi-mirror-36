...
class ExtractTimeSeriesInputSpec(BaseInterfaceInputSpec):
    ...
    prefix = trait.traits.Str(mandatory=True, desc="Prefix of the file to write the time series in")
...
class ExtractTimeSeries(NilearnBaseInterface, SimpleInterface):
    ...
    def _run_interface(self, runtime):
        ...
        outFile = os.path.join(directory, self.inputs.prefix+self.inputs.confoundsName+"_TimeSeriesRoI.tsv")
