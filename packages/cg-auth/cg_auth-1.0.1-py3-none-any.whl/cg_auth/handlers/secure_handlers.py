...
from cg_tornado import BaseApiHandler, BaseWebHandler
from app.cg_auth.controllers import Sessions
...
class SecureApiHandler(BaseApiHandler):
    def prepare(self):
        ...
        # decode session
        sess_ctrl = Sessions(gdb=self.gdb, data=self.Data, request=self.request,
