...
from cg_auth.models.data_models import User, User, UserDevice, AuthSession
...
class AuthCtrl(CGDbLogic):
    ...
    def Login(self):
        ...
        log_ctrl = AuthLogs(gdb=self.gdb, data=self.Data, request=self.request, user=self.User, app=self.application)
