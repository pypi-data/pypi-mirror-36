...
from .factory import AclApiTestCase, Request, DatabaseBind
...
class TaskHelpersTest(AclApiTestCase):
    ...
    def test_get_bind_env_and_vlan(self):
        database_bind = DatabaseBind('192.168.1.10/32')
        self.assertEqual(
            ['192.168.1.10', '32'], helpers.get_bind_env_and_vlan(database_bind)
        )
