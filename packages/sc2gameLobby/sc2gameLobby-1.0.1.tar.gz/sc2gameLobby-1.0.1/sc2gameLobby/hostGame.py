...
#        
#        ### added
#        if amHosting and config.startCondition:
#              simulationSetup(controller, config.startCondition)
#        else: timeToWait = 0
#        
...
#            
#            ### added
#            if newNow - scenarioStart > timeToWait: # scenario time has elapsed
#                testCase = config.setup
#                if not simulationSetup(config.startConditions)
#            
