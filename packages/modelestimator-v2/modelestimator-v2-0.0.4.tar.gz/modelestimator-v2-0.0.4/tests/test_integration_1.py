...
def test_integration_1():
    ...
    reference_output_string_path = "tests\\test_integration_1\\reference-output-string.txt"
    ...
    reference_input_string_path = "\\tests\\test_integration_1\\test_integration_1_20seqs_1000long_50pam.fa"
