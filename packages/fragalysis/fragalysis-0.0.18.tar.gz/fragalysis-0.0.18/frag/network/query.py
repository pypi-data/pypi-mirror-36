...
def find_triple_edge_growth(tx, input_str, heavy_atom_diff_min=4, heavy_atom_diff_max=8,
                            mid_heavy_atom_diff_min=-1, mid_heavy_atom_diff_max=3):
    return tx.run(
        ...
        " and mid.chac-sta.hac > $chacmin and mid.hac-sta.hac <= $chacmax"
        ...
        chacmin=mid_heavy_atom_diff_min, chacmax=mid_heavy_atom_diff_max
    )
