...
def GetScriptContainer():
    ...
    This will be a ``boa.blockchain.vm.kaze.Transaction`` object.

    - Note: This method is implemented inside the kaze Virtual Machine.

    :return: the current ScriptContainer of a smart contract execution.
    :rtype: ``boa.blockchain.vm.kaze.Transaction``
    """
