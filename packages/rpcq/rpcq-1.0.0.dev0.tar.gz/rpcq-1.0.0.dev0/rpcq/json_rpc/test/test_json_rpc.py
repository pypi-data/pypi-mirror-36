...
from rpcq.json_rpc.utils import rpc_request, RPCErrorError
...
logging.getLogger('rpcq.json_rpc.json_rpc_spec').setLevel(logging.CRITICAL)
...
# PIDGIN-63: Buildup of requests to Pidgin Server until Client is closed and reopened
