    ...
    def restore_model(sess,
        ...
        if log:
            print('Log: '
                  '[%s.%s] '
                  'restore model:\n'
                  '    %s' % (UtilityTf.__name__,
                              UtilityTf.restore_model.__name__,
                              checkpoint_path))
...
if __name__ == '__main__':
    ...
    cp_path = UtilityTf.select_checkpoint(hint='Select a checkpoint file')
    variables = UtilityTf.get_variables(checkpoint_path=cp_path)
