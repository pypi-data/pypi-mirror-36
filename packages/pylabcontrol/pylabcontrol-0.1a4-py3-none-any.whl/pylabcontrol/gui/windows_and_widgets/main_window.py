...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def save_config(self, filepath):
        ...
        try:
            ...
            msg = QtWidgets.QMessageBox()
            msg.setText("Saving failed. Please give a valid path to save the gui, or cancel to quit without saving.")
            msg.exec_()
            filepath, _ = QtWidgets.QFileDialog.getSaveFileName(self, 'Save gui settings to file', self.config_filepath,
                                                                filter='*.b26')
