...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Computing the full feature set took 118.683s, plus 1.256s training, for an AUC of 1.00. Computing the restricted feature set took 0.145s, plus 1.196s training, for an AUC of 1.00.


**Total running time of the script:** ( 2 minutes  3.531 seconds)
