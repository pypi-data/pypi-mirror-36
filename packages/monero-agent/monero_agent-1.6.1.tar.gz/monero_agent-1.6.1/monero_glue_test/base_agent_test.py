...
class BaseAgentTest(aiounittest.AsyncTestCase):
    ...
    def get_trezor_tsx_tests(self):
        ...
        # return [('tsx_t_uns_%02d.txt' % i) for i in [17]]
        # return [('tsx_t_uns_%02d.txt' % i) for i in [12, 13]]
        # return [('tsx_t_uns_%02d.txt' % i) for i in [5,6,7,8,9,10]]
        # return [('tsx_t_uns_%02d.txt' % i) for i in [1,2,14]]
        # return [('tsx_t_uns_%02d.txt' % i) for i in [12]]
        # return [('tsx_t_uns_%02d.txt' % i) for i in [8]]
        # return [('tsx_t_uns_%02d.txt' % i) for i in [12,13,14,15,16,17]]
