...
### 3.Create Account
After the key pair generation, you have already got the address, but it is not activated until someone transfers at least 1.01 lumen into it.
[fees](https://www.stellar.org/developers/guides/concepts/fees.html#minimum-account-balance)
...
```
To get Lumens in live checkout 
[binance.com](https://binance.com)
[kraken.com](https://kraken.com)
[tempo.eu.com](https://tempo.eu.com)
#### 3.2 Livenet
