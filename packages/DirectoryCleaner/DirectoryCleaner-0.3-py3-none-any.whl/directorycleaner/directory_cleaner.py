...
class DirectoryCleaner(Settings):
    ...
    def register_args(self, parser):
        ...
        parser.add_argument('--ignore_dotfiles', '-idf', action='store_const', const=True, help="Set this flag if instead of placing dotfiles in an 'Unknowns' folder, you simply want them ignored.")
    ...
    def set_vars(self, args):
        ...
        if args.ignore_dotfiles:
            self.ignore_dotfiles = True
        elif args.ignore_dotfiles == None:
            self.ignore_dotfiles = False
