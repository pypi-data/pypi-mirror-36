...
def _is_custom_repr_obj(obj: typing.Any) -> bool:
    ...
    if not isinstance(obj, ReprMixin):
        ...
        if not default_repr.endswith(f'object at {hex(id(obj))}>'):
            return True
    return False
...
class _ReprFormatter:
    ...
    def _format_default_repr_obj(self, obj: typing.Any, *, indent: str) -> str:
        ...
        # Data to represent
        attributes = {k: getattr(obj, k) for k in non_self_bound}
        # Lines
...
FrozenMixinSubType = typing.TypeVar('FrozenMixinSubType', bound='FrozenMixin')
...
class FrozenMixin:
    ...
    def copy_with(self: FrozenMixinSubType, **kwargs: typing.Any) -> FrozenMixinSubType:
