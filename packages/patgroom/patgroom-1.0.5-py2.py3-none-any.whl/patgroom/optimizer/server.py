...
def serve(barFeed, strategyParameters,nums, address, port,batchsize=5,excelfile='Result.csv'):
    ...
    s = xmlrpcserver.Server(paramSource,nums, resultSinc, barFeed, address, port)
