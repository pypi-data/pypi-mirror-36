...
#
#  $ bin/test -s rer.subsites -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src rer.subsites.testing.RER_SUBSITES_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot rer/subsites/tests/robot/test_example.robot
#
