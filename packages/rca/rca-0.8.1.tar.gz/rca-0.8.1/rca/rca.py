...
# Third-party module: attrs, create data classes until Python 3.7 goes mainstream
try: import attr
except ImportError:
  print('CRITICAL: This script requires the attrs module, '
        'install it with "sudo pip3 install attrs"')
  sys.exit(1)
