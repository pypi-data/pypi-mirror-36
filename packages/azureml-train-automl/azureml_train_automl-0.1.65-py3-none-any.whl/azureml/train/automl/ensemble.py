...
class Ensemble(BaseEstimator):
    ...
    def __init__(self,
        ...
        self._automl_settings = _automl_settings._AutoMLSettings.from_string_or_dict(automl_settings, experiment)
    ...
    def fit_ensemble(self, training_type: constants.TrainingType, dataset: _datasets._ClientDatasets, **kwargs):
        """
        ...
        :type dataset: _datasets._ClientDatasets
        ...
        algo_names, fitted_models = self._fetch_fitted_pipelines(logger, child_runs)
    ...
    def _fetch_fitted_pipelines(self, logger, child_runs):
        ...
        for child_run in child_runs:
            ...
            try:
                ...
                child_run.download_file(name=model_name, output_file_path=local_model_file)
                with open(local_model_file, "rb") as model_file:
                    fitted_pipeline = pickle.load(model_file)

                fitted_pipelines.append(self._transform_fitted_pipeline(fitted_pipeline))
