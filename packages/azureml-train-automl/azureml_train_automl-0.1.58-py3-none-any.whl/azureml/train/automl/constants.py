...
class Metric:
    ...
    CLASSIFICATION_PRIMARY_SET = {
        Accuracy, AUCWeighted, BalancedAccuracy, AvgPrecisionWeighted, PrecisionWeighted
    }
    REGRESSION_PRIMARY_SET = {
        Spearman, NormRMSE, R2Score, NormMeanAbsError, NormRMSLE
    }
...
class TrainingType:
    ...
    FULL_SET = {TrainFull, TrainAndValidation, CrossValidation, MeanCrossValidation}
