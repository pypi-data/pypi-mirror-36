...
class AdlaStep(PipelineStep):
    """Adds a node to run U-SQL script using Azure Data Lake Analytics.
    ...
    def __init__(self, name=None, inputs=None, outputs=None, script_name=None, params=None, degree_of_parallelism=None,
    ...
    def _get_adla_config(adla_resource_id):
        ...
        match = re.search(resource_id_regex, adla_resource_id)
