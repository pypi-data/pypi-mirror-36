...
class TestClusterService(object):
  ...
  def test_connected_clusters(self, cluster_service):
    cluster_service.services.kubernetes_service.get_config_map.return_value = None
    assert cluster_service.connected_clusters() == []
    cluster_service.services.kubernetes_service.get_config_map.return_value = []
    assert cluster_service.connected_clusters() == []
    cluster_service.services.kubernetes_service.get_config_map.return_value = dict(foo=None)
    assert cluster_service.connected_clusters() == ['foo']
    cluster_service.services.kubernetes_service.get_config_map.return_value = dict(foo=None, bar=None)
