...
def get_domain(url):
    """
    Given the following a url extract domain ignoring scheme and params.
    Using urlparse->netloc seems to fail

    >>> get_domain(http://www.contosdo.com)
    www.contosdo.com
    >>> get_domain(www.contosdo.com)
    www.contosdo.com
    >>> get_domain(http://www.contosdo.com/example/?filter=test)
    www.contosdo.com
    >>> get_domain(http://contosdo.com/example/?filter=test)
    contosdo.com
