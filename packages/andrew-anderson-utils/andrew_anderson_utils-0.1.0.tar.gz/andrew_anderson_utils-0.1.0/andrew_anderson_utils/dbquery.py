...
table = Table(db, 'entry')

db.execute('CREATE TABLE entry(key TEXT, value TEXT);')
table.insert('key1', 'value1')
table.insert('key1', 'value2')
table.insert('key2', 'value3')

print(table(key='key1').value)
table(key='key1').value = 'xxx'
table(value='xxx').update(value='yyy')
print(table(key='key1').value)

print(table.where(key='key1').select('value', 'key'))
