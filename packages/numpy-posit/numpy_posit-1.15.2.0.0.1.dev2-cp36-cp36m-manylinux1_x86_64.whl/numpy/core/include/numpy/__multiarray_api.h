...
NPY_NO_EXPORT  int PyArray_SetWritebackIfCopyBase \
       (PyArrayObject *, PyArrayObject *);
extern NPY_NO_EXPORT PyTypeObject PyPosit8ArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PyPosit16ArrType_Type;

extern NPY_NO_EXPORT PyTypeObject PyPosit32ArrType_Type;
...
#define PyArray_SetWritebackIfCopyBase \
        (*(int (*)(PyArrayObject *, PyArrayObject *)) \
         PyArray_API[303])
#define PyPosit8ArrType_Type (*(PyTypeObject *)PyArray_API[304])
#define PyPosit16ArrType_Type (*(PyTypeObject *)PyArray_API[305])
#define PyPosit32ArrType_Type (*(PyTypeObject *)PyArray_API[306])
