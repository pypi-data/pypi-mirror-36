...
class Combinations(object):
    ...
    def number_combinaties_max_n():
        """number_combinaties_max_n() -> int"""
        return _oalib.Combinations_number_combinaties_max_n()

    number_combinaties_max_n = staticmethod(number_combinaties_max_n)
...
def Combinations_number_combinaties_max_n():
    """Combinations_number_combinaties_max_n() -> int"""
    return _oalib.Combinations_number_combinaties_max_n()
...
def printdoubleasbits(double_value):
    """
    ...
    """
    return _oalib.printdoubleasbits(double_value)
...
class CandidateGeneratorBase(object):
    ...
    def candidates(self, k):
        """
        candidates(CandidateGeneratorBase self, int k) -> cpermVector
...
def generateConferenceExtensions(al, conference_type, zero_index, verbose=1, filtersymm=1, filterj2=1):
    """
    generateConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1, int filterj2=1) -> cpermVector
    generateConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1) -> cpermVector
    generateConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1) -> cpermVector
    generateConferenceExtensions(array_link al, conference_t conference_type, int zero_index) -> cpermVector
...
def generateConferenceRestrictedExtensions(al, conference_type, zero_index, verbose=1, filtersymm=1, filterip=1):
    """
    generateConferenceRestrictedExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1, int filterip=1) -> cpermVector
    generateConferenceRestrictedExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1, int filtersymm=1) -> cpermVector
    generateConferenceRestrictedExtensions(array_link al, conference_t conference_type, int zero_index, int verbose=1) -> cpermVector
    generateConferenceRestrictedExtensions(array_link al, conference_t conference_type, int zero_index) -> cpermVector
...
def generateDoubleConferenceExtensions(al, conference_type, verbose=1, filtersymm=1, filterip=1, filterJ3=0, filtersymminline=1):
    """
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1, int filterJ3=0, int filtersymminline=1) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1, int filterJ3=0) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1, int filtersymm=1, int filterip=1) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1, int filtersymm=1) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type, int verbose=1) -> cpermVector
    generateDoubleConferenceExtensions(array_link al, conference_t conference_type) -> cpermVector
...
def generateSingleConferenceExtensions(al, conference_type, zero_index, verbose, filtersymm, filterj2, filterj3, filtersymminline=0):
    """
    generateSingleConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose, int filtersymm, int filterj2, int filterj3, int filtersymminline=0) -> cpermVector
    generateSingleConferenceExtensions(array_link al, conference_t conference_type, int zero_index, int verbose, int filtersymm, int filterj2, int filterj3) -> cpermVector
