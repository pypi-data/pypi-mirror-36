...
project = u'freeart'
from freeart._version import strictversion, version, __date__ as _date
year = _date.split("/")[-1]
...
# of the sidebar.
# html_logo = "img/silx.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# html_favicon = "_static/silx.ico"
...
# latex_documents = [
#   ('index', 'tomogui.tex', u'tomogui Documentation',
#    u'Data analysis unit', 'manual'),
# ]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
# latex_logo = "img/silx.png"
...
man_pages = [
    ('index', 'freeart', u'freeART Documentation',
...
texinfo_documents = [
  ('index', 'freeart', u'freeart Documentation',
   u'Data analysis unit', 'freeart', 'One line description of project.',
   'Miscellaneous'),
]
